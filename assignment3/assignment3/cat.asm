...
main(int argc, char *argv[])
{
  ...
  c9:	c7 44 24 04 00 09 00 	movl   $0x900,0x4(%esp)
  d0:	00 
...
0000044c <get_share_memory_address>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c2:	0f b6 90 78 0b 00 00 	movzbl 0xb78(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 621:	75 27                	jne    64a <printf+0x11f>
          s = "(null)";
 623:	c7 45 f4 15 09 00 00 	movl   $0x915,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ef:	a1 a8 0b 00 00       	mov    0xba8,%eax
...
free(void *ap)
{
 ...
 7b0:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 7b5:	c9                   	leave  
 7b6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 821:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 824:	a1 a8 0b 00 00       	mov    0xba8,%eax
 829:	89 45 f0             	mov    %eax,-0x10(%ebp)
 82c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 830:	75 23                	jne    855 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 832:	c7 45 f0 a0 0b 00 00 	movl   $0xba0,-0x10(%ebp)
 839:	8b 45 f0             	mov    -0x10(%ebp),%eax
 83c:	a3 a8 0b 00 00       	mov    %eax,0xba8
 841:	a1 a8 0b 00 00       	mov    0xba8,%eax
 846:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 ...
 8a8:	a3 a8 0b 00 00       	mov    %eax,0xba8
      return (void*)(p + 1);
 ...
 8b3:	eb 38                	jmp    8ed <malloc+0xde>
    ...
    if(p == freep)
 8b5:	a1 a8 0b 00 00       	mov    0xba8,%eax
