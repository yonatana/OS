...
8010003a:	c7 44 24 04 ac 97 10 	movl   $0x801097ac,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 c0 e6 10 80 	movl   $0x8010e6c0,(%esp)
80100049:	e8 80 5f 00 00       	call   80105fce <initlock>
...
801000bd:	e8 2d 5f 00 00       	call   80105fef <acquire>
...
80100104:	e8 5e 5f 00 00       	call   80106067 <release>
        return b;
...
8010017c:	e8 e6 5e 00 00       	call   80106067 <release>
      return b;
...
80100198:	c7 04 24 b3 97 10 80 	movl   $0x801097b3,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 c4 97 10 80 	movl   $0x801097c4,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 cb 97 10 80 	movl   $0x801097cb,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 c0 e6 10 80 	movl   $0x8010e6c0,(%esp)
8010023c:	e8 ae 5d 00 00       	call   80105fef <acquire>
...
801002a9:	e8 b9 5d 00 00       	call   80106067 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 2e 5c 00 00       	call   80105fef <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 d2 97 10 80 	movl   $0x801097d2,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec db 97 10 80 	movl   $0x801097db,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 2c 5b 00 00       	call   80106067 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 e2 97 10 80 	movl   $0x801097e2,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 f1 97 10 80 	movl   $0x801097f1,(%esp)
...
80100592:	e8 1f 5b 00 00       	call   801060b6 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 f3 97 10 80 	movl   $0x801097f3,(%esp)
...
801006b2:	e8 6e 5c 00 00       	call   80106325 <memmove>
    pos -= 80;
...
801006e1:	e8 6c 5b 00 00       	call   80106252 <memset>
  }
...
80100776:	e8 a2 76 00 00       	call   80107e1d <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 96 76 00 00       	call   80107e1d <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 8a 76 00 00       	call   80107e1d <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 7d 76 00 00       	call   80107e1d <uartputc>
  cgaputc(c);
...
801007ba:	e8 30 58 00 00       	call   80105fef <acquire>
  while((c = getc()) >= 0){
...
8010091e:	e8 44 57 00 00       	call   80106067 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 a7 56 00 00       	call   80105fef <acquire>
  while(n > 0){
...
80100961:	e8 01 57 00 00       	call   80106067 <release>
        ilock(ip);
...
80100a08:	e8 5a 56 00 00       	call   80106067 <release>
  ilock(ip);
...
80100a3e:	e8 ac 55 00 00       	call   80105fef <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 ea 55 00 00       	call   80106067 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 f7 97 10 	movl   $0x801097f7,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 20 d6 10 80 	movl   $0x8010d620,(%esp)
80100aa2:	e8 27 55 00 00       	call   80105fce <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 ff 97 10 	movl   $0x801097ff,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 00 fe 10 80 	movl   $0x8010fe00,(%esp)
80100ab6:	e8 13 55 00 00       	call   80105fce <initlock>
...
80100b7b:	e8 e1 83 00 00       	call   80108f61 <setupkvm>
...
80100c14:	e8 1a 87 00 00       	call   80109333 <allocuvm>
...
80100c51:	e8 ee 85 00 00       	call   80109244 <loaduvm>
...
80100cbc:	e8 72 86 00 00       	call   80109333 <allocuvm>
...
80100ce0:	e8 66 88 00 00       	call   8010954b <clearpteu>
  sp = sz;
...
80100d0f:	e8 bc 57 00 00       	call   801064d0 <strlen>
...
80100d2d:	e8 9e 57 00 00       	call   801064d0 <strlen>
...
80100d57:	e8 a3 89 00 00       	call   801096ff <copyout>
...
80100df7:	e8 03 89 00 00       	call   801096ff <copyout>
...
80100e4e:	e8 2f 56 00 00       	call   80106482 <safestrcpy>
...
80100ea0:	e8 ad 81 00 00       	call   80109052 <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 0d 86 00 00       	call   801094bd <freevm>
  return 0;
...
80100ee2:	e8 d6 85 00 00       	call   801094bd <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 05 98 10 	movl   $0x80109805,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 c0 fe 10 80 	movl   $0x8010fec0,(%esp)
80100f15:	e8 b4 50 00 00       	call   80105fce <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 c1 50 00 00       	call   80105fef <acquire>
...
80100f52:	e8 10 51 00 00       	call   80106067 <release>
      return f;
...
80100f70:	e8 f2 50 00 00       	call   80106067 <release>
  return 0;
...
80100f89:	e8 61 50 00 00       	call   80105fef <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 0c 98 10 80 	movl   $0x8010980c,(%esp)
...
80100fba:	e8 a8 50 00 00       	call   80106067 <release>
  return f;
...
80100fd1:	e8 19 50 00 00       	call   80105fef <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 14 98 10 80 	movl   $0x80109814,(%esp)
...
8010100c:	e8 56 50 00 00       	call   80106067 <release>
    return;
...
80101056:	e8 0c 50 00 00       	call   80106067 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 1e 98 10 80 	movl   $0x8010981e,(%esp)
...
801012a3:	c7 04 24 27 98 10 80 	movl   $0x80109827,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 37 98 10 80 	movl   $0x80109837,(%esp)
...
80101320:	e8 00 50 00 00       	call   80106325 <memmove>
  brelse(bp);
...
80101366:	e8 e7 4e 00 00       	call   80106252 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 41 98 10 80 	movl   $0x80109841,(%esp)
...
80101565:	c7 04 24 57 98 10 80 	movl   $0x80109857,(%esp)
...
801015b9:	c7 44 24 04 6a 98 10 	movl   $0x8010986a,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 c0 08 11 80 	movl   $0x801108c0,(%esp)
801015c8:	e8 01 4a 00 00       	call   80105fce <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 03 4c 00 00       	call   80106252 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 71 98 10 80 	movl   $0x80109871,(%esp)
...
80101747:	e8 d9 4b 00 00       	call   80106325 <memmove>
  log_write(bp);
...
80101771:	e8 79 48 00 00       	call   80105fef <acquire>
...
801017bb:	e8 a7 48 00 00       	call   80106067 <release>
      return ip;
...
801017ee:	c7 04 24 83 98 10 80 	movl   $0x80109883,(%esp)
...
8010182c:	e8 36 48 00 00       	call   80106067 <release>
...
80101843:	e8 a7 47 00 00       	call   80105fef <acquire>
  ip->ref++;
...
8010185e:	e8 04 48 00 00       	call   80106067 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 93 98 10 80 	movl   $0x80109893,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 c0 08 11 80 	movl   $0x801108c0,(%esp)
80101891:	e8 59 47 00 00       	call   80105fef <acquire>
...
801018d0:	e8 92 47 00 00       	call   80106067 <release>
...
8010197b:	e8 a5 49 00 00       	call   80106325 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 99 98 10 80 	movl   $0x80109899,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 a8 98 10 80 	movl   $0x801098a8,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 c0 08 11 80 	movl   $0x801108c0,(%esp)
801019ec:	e8 fe 45 00 00       	call   80105fef <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 4e 46 00 00       	call   80106067 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 c2 45 00 00       	call   80105fef <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 b0 98 10 80 	movl   $0x801098b0,(%esp)
...
80101a8a:	e8 d8 45 00 00       	call   80106067 <release>
    itrunc(ip);
...
80101ab5:	e8 35 45 00 00       	call   80105fef <acquire>
    ip->flags = 0;
...
80101ae5:	e8 7d 45 00 00       	call   80106067 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 ba 98 10 80 	movl   $0x801098ba,(%esp)
...
80101e92:	e8 8e 44 00 00       	call   80106325 <memmove>
    brelse(bp);
...
80101ff8:	e8 28 43 00 00       	call   80106325 <memmove>
    log_write(bp);
...
8010207a:	e8 4a 43 00 00       	call   801063c9 <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 cd 98 10 80 	movl   $0x801098cd,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 df 98 10 80 	movl   $0x801098df,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 df 98 10 80 	movl   $0x801098df,(%esp)
...
801021fc:	e8 20 42 00 00       	call   80106421 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 ec 98 10 80 	movl   $0x801098ec,(%esp)
...
801022b5:	e8 6b 40 00 00       	call   80106325 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 50 40 00 00       	call   80106325 <memmove>
    name[len] = 0;
...
80102538:	c7 44 24 04 f4 98 10 	movl   $0x801098f4,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 60 d6 10 80 	movl   $0x8010d660,(%esp)
80102547:	e8 82 3a 00 00       	call   80105fce <initlock>
  picenable(IRQ_IDE);
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 f8 98 10 80 	movl   $0x801098f8,(%esp)
...
8010270a:	e8 e0 38 00 00       	call   80105fef <acquire>
  if((b = idequeue) == 0){
...
80102724:	e8 3e 39 00 00       	call   80106067 <release>
...
801027ae:	e8 b4 38 00 00       	call   80106067 <release>
}
801027b3:	c9                   	leave  
801027b4:	c3                   	ret    
...
801027c7:	c7 04 24 01 99 10 80 	movl   $0x80109901,(%esp)
...
801027e0:	c7 04 24 15 99 10 80 	movl   $0x80109915,(%esp)
...
80102862:	e8 00 38 00 00       	call   80106067 <release>
  sti();
...
8010290a:	c7 04 24 48 99 10 80 	movl   $0x80109948,(%esp)
...
801029cb:	c7 44 24 04 7a 99 10 	movl   $0x8010997a,0x4(%esp)
801029d2:	80 
801029d3:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
801029da:	e8 ef 35 00 00       	call   80105fce <initlock>
  kmem.use_lock = 0;
...
80102a6c:	81 7d 08 9c 6a 14 80 	cmpl   $0x80146a9c,0x8(%ebp)
...
80102a85:	76 0c                	jbe    80102a93 <kfree+0x39>
    panic("kfree");
80102a87:	c7 04 24 7f 99 10 80 	movl   $0x8010997f,(%esp)
...
80102aa9:	e8 a4 37 00 00       	call   80106252 <memset>
...
80102abe:	e8 2c 35 00 00       	call   80105fef <acquire>
  r = (struct run*)v;
...
80102aec:	e8 76 35 00 00       	call   80106067 <release>
}
80102af1:	c9                   	leave  
80102af2:	c3                   	ret    
...
80102b09:	e8 e1 34 00 00       	call   80105fef <acquire>
  r = kmem.freelist;
...
80102b36:	e8 2c 35 00 00       	call   80106067 <release>
  return (char*)r;
...
80102eb2:	c7 04 24 88 99 10 80 	movl   $0x80109988,(%esp)
...
80103016:	c7 44 24 04 b4 99 10 	movl   $0x801099b4,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103025:	e8 a4 2f 00 00       	call   80105fce <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 48 32 00 00       	call   80106325 <memmove>
...
8010326f:	e8 7b 2d 00 00       	call   80105fef <acquire>
  log.busy = 0;
...
80103285:	e8 dd 2d 00 00       	call   80106067 <release>
}
8010328a:	c9                   	leave  
8010328b:	c3                   	ret    
...
801032ae:	c7 04 24 b8 99 10 80 	movl   $0x801099b8,(%esp)
...
801032c3:	c7 04 24 ce 99 10 80 	movl   $0x801099ce,(%esp)
...
80103352:	e8 ce 2f 00 00       	call   80106325 <memmove>
  bwrite(lbuf);
...
801033e7:	80 
801033e8:	c7 04 24 9c 6a 14 80 	movl   $0x80146a9c,(%esp)
801033ef:	e8 d1 f5 ff ff       	call   801029c5 <kinit1>
  kvmalloc();      // kernel page table
801033f4:	e8 25 5c 00 00       	call   8010901e <kvmalloc>
...
8010340b:	e8 b1 55 00 00       	call   801089c1 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103420:	c7 04 24 e5 99 10 80 	movl   $0x801099e5,(%esp)
...
8010343b:	e8 cc 48 00 00       	call   80107d0c <uartinit>
  pinit();         // process table
80103440:	e8 b0 0b 00 00       	call   80103ff5 <pinit>
  tvinit();        // trap vectors
80103445:	e8 65 44 00 00       	call   801078af <tvinit>
  binit();         // buffer cache
...
80103467:	e8 86 43 00 00       	call   801077f2 <timerinit>
...
80103492:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
80103495:	e8 9b 5b 00 00       	call   80109035 <switchkvm>
  seginit();
8010349a:	e8 22 55 00 00       	call   801089c1 <seginit>
  lapicinit(cpunum());
...
801034c7:	c7 04 24 fc 99 10 80 	movl   $0x801099fc,(%esp)
801034ce:	e8 ce ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801034d3:	e8 4b 45 00 00       	call   80107a23 <idtinit>
...
80103525:	e8 fb 2d 00 00       	call   80106325 <memmove>
...
801036b3:	00 
801036b4:	c7 44 24 04 10 9a 10 	movl   $0x80109a10,0x4(%esp)
801036bb:	80 
801036bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036bf:	89 04 24             	mov    %eax,(%esp)
801036c2:	e8 02 2c 00 00       	call   801062c9 <memcmp>
...
801037f4:	00 
801037f5:	c7 44 24 04 15 9a 10 	movl   $0x80109a15,0x4(%esp)
801037fc:	80 
801037fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103800:	89 04 24             	mov    %eax,(%esp)
80103803:	e8 c1 2a 00 00       	call   801062c9 <memcmp>
...
801038ce:	8b 04 85 58 9a 10 80 	mov    -0x7fef65a8(,%eax,4),%eax
...
80103907:	c7 04 24 1a 9a 10 80 	movl   $0x80109a1a,(%esp)
...
8010399a:	c7 04 24 38 9a 10 80 	movl   $0x80109a38,(%esp)
...
80103c9f:	c7 44 24 04 6c 9a 10 	movl   $0x80109a6c,0x4(%esp)
80103ca6:	80 
80103ca7:	89 04 24             	mov    %eax,(%esp)
80103caa:	e8 1f 23 00 00       	call   80105fce <initlock>
  (*f0)->type = FD_PIPE;
...
80103d57:	e8 93 22 00 00       	call   80105fef <acquire>
  if(writable){
...
80103dbe:	e8 a4 22 00 00       	call   80106067 <release>
    kfree((char*)p);
...
80103dd6:	e8 8c 22 00 00       	call   80106067 <release>
}
80103ddb:	c9                   	leave  
80103ddc:	c3                   	ret    
...
80103dea:	e8 00 22 00 00       	call   80105fef <acquire>
  for(i = 0; i < n; i++){
...
80103e1b:	e8 47 22 00 00       	call   80106067 <release>
        return -1;
...
80103ebf:	e8 a3 21 00 00       	call   80106067 <release>
  return n;
...
80103eda:	e8 10 21 00 00       	call   80105fef <acquire>
...
80103ef4:	e8 6e 21 00 00       	call   80106067 <release>
      return -1;
...
80103fb1:	e8 b1 20 00 00       	call   80106067 <release>
  return i;
...
80103ffb:	c7 44 24 04 74 9a 10 	movl   $0x80109a74,0x4(%esp)
80104002:	80 
80104003:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010400a:	e8 bf 1f 00 00       	call   80105fce <initlock>
}
8010400f:	c9                   	leave  
80104010:	c3                   	ret    
...
80104014:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104017:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010401e:	e8 cc 1f 00 00       	call   80105fef <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104023:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
80104034:	74 26                	je     8010405c <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104036:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
8010403d:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
80104044:	72 e6                	jb     8010402c <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104046:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010404d:	e8 15 20 00 00       	call   80106067 <release>
  return 0;
...
80104075:	a3 20 d0 10 80       	mov    %eax,0x8010d020
  release(&ptable.lock);
8010407a:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104081:	e8 e1 1f 00 00       	call   80106067 <release>
...
801040cb:	ba 64 78 10 80       	mov    $0x80107864,%edx
...
801040fb:	e8 52 21 00 00       	call   80106252 <memset>
...
80104130:	e8 2c 4e 00 00       	call   80108f61 <setupkvm>
...
80104145:	c7 04 24 7b 9a 10 80 	movl   $0x80109a7b,(%esp)
...
8010416b:	e8 49 50 00 00       	call   801091b9 <inituvm>
  p->sz = PGSIZE;
...
80104192:	e8 bb 20 00 00       	call   80106252 <memset>
...
8010420b:	00 
8010420c:	c7 44 24 04 94 9a 10 	movl   $0x80109a94,0x4(%esp)
80104213:	80 
80104214:	89 04 24             	mov    %eax,(%esp)
80104217:	e8 66 22 00 00       	call   80106482 <safestrcpy>
  p->cwd = namei("/");
8010421c:	c7 04 24 9d 9a 10 80 	movl   $0x80109a9d,(%esp)
...
8010423f:	80 
80104240:	c7 04 24 9f 9a 10 80 	movl   $0x80109a9f,(%esp)
...
80104284:	e8 aa 50 00 00       	call   80109333 <allocuvm>
...
801042be:	e8 3e 51 00 00       	call   80109401 <deallocuvm>
...
801042e7:	e8 66 4d 00 00       	call   80109052 <switchuvm>
  return 0;
...
8010432c:	e8 60 52 00 00       	call   80109591 <copyuvm>
...
80104446:	e8 37 20 00 00       	call   80106482 <safestrcpy>
  return pid;
...
8010446a:	75 0c                	jne    80104478 <exit+0x22>
    panic("init exiting");
8010446c:	c7 04 24 a9 9a 10 80 	movl   $0x80109aa9,(%esp)
...
801044e2:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  acquire(&ptable.lock);
801044e9:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801044f0:	e8 fa 1a 00 00       	call   80105fef <acquire>
...
80104501:	e8 3a 05 00 00       	call   80104a40 <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104506:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
8010453e:	e8 fd 04 00 00       	call   80104a40 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104543:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
8010454a:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
...
80104560:	e8 e4 02 00 00       	call   80104849 <sched>
  panic("zombie exit");
80104565:	c7 04 24 b6 9a 10 80 	movl   $0x80109ab6,(%esp)
...
80104574:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104577:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010457e:	e8 6c 1a 00 00       	call   80105fef <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104583:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010458a:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
801045e6:	e8 d2 4e 00 00       	call   801094bd <freevm>
        p->state = UNUSED;
...
80104613:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
8010461a:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104621:	e8 41 1a 00 00       	call   80106067 <release>
        return pid;
...
8010462b:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010462c:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104633:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
...
80104651:	74 13                	je     80104666 <wait+0xf5>
      release(&ptable.lock);
80104653:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010465a:	e8 08 1a 00 00       	call   80106067 <release>
      return -1;
...
8010466c:	c7 44 24 04 c0 3f 14 	movl   $0x80143fc0,0x4(%esp)
80104673:	80 
...
801046a7:	e8 f6 4f 00 00       	call   801096a2 <uva2ka>
...
801046c2:	75 0c                	jne    801046d0 <register_handler+0x4d>
    panic("esp_offset == 0");
801046c4:	c7 04 24 c2 9a 10 80 	movl   $0x80109ac2,(%esp)
...
80104726:	83 ec 28             	sub    $0x28,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104729:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
8010473f:	00 
80104740:	c7 44 24 04 9f 9a 10 	movl   $0x80109a9f,0x4(%esp)
80104747:	80 
80104748:	89 04 24             	mov    %eax,(%esp)
8010474b:	e8 79 1c 00 00       	call   801063c9 <strncmp>
...
struct proc* find_inswapper(){
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104759:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104760:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
80104767:	72 c9                	jb     80104732 <find_inswapper+0xf>
    if(strncmp(p->name,"inSwapper",9) == 0) //found inSwapper
      return p;
  }
  cprintf("unable to find inSwapper\n");
80104769:	c7 04 24 d2 9a 10 80 	movl   $0x80109ad2,(%esp)
...
80104782:	e8 68 f8 ff ff       	call   80103fef <sti>
    ...
    acquire(&ptable.lock);
80104787:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010478e:	e8 5c 18 00 00       	call   80105fef <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104793:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
801047e3:	e8 6a 48 00 00       	call   80109052 <switchuvm>
      p->state = RUNNING;
...
8010480c:	e8 e7 1c 00 00       	call   801064f8 <swtch>
      switchkvm();
80104811:	e8 1f 48 00 00       	call   80109035 <switchkvm>
...
80104823:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104824:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
8010482b:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
80104832:	0f 82 67 ff ff ff    	jb     8010479f <scheduler+0x23>
    ...
    release(&ptable.lock);
80104838:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010483f:	e8 23 18 00 00       	call   80106067 <release>
...
8010484f:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104856:	e8 c8 18 00 00       	call   80106123 <holding>
8010485b:	85 c0                	test   %eax,%eax
8010485d:	75 0c                	jne    8010486b <sched+0x22>
    panic("sched ptable.lock");
8010485f:	c7 04 24 ec 9a 10 80 	movl   $0x80109aec,(%esp)
...
8010487a:	74 0c                	je     80104888 <sched+0x3f>
    panic("sched locks");
8010487c:	c7 04 24 fe 9a 10 80 	movl   $0x80109afe,(%esp)
...
80104894:	75 0c                	jne    801048a2 <sched+0x59>
    panic("sched running");
80104896:	c7 04 24 0a 9b 10 80 	movl   $0x80109b0a,(%esp)
...
801048b0:	c7 04 24 18 9b 10 80 	movl   $0x80109b18,(%esp)
...
801048e5:	e8 0e 1c 00 00       	call   801064f8 <swtch>
  cpu->intena = intena;
...
80104901:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104908:	e8 e2 16 00 00       	call   80105fef <acquire>
  proc->state = RUNNABLE;
...
8010491a:	e8 2a ff ff ff       	call   80104849 <sched>
  release(&ptable.lock);
8010491f:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104926:	e8 3c 17 00 00       	call   80106067 <release>
}
8010492b:	c9                   	leave  
8010492c:	c3                   	ret    
...
80104930:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104933:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010493a:	e8 28 17 00 00       	call   80106067 <release>
...
80104967:	75 0c                	jne    80104975 <sleep+0x1c>
    panic("sleep");
80104969:	c7 04 24 2c 9b 10 80 	movl   $0x80109b2c,(%esp)
...
8010497b:	c7 04 24 32 9b 10 80 	movl   $0x80109b32,(%esp)
...
80104987:	81 7d 0c c0 3f 14 80 	cmpl   $0x80143fc0,0xc(%ebp)
8010498e:	74 17                	je     801049a7 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104990:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104997:	e8 53 16 00 00       	call   80105fef <acquire>
    release(lk);
8010499c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010499f:	89 04 24             	mov    %eax,(%esp)
801049a2:	e8 c0 16 00 00       	call   80106067 <release>
  }
...
801049d5:	74 28                	je     801049ff <sleep+0xa6>
    release(&ptable.lock);
801049d7:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801049de:	e8 84 16 00 00       	call   80106067 <release>
    swapOut(proc);
801049e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049e9:	89 04 24             	mov    %eax,(%esp)
801049ec:	e8 2a 0a 00 00       	call   8010541b <swapOut>
    acquire(&ptable.lock);
801049f1:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801049f8:	e8 f2 15 00 00       	call   80105fef <acquire>
...
80104a1e:	81 7d 0c c0 3f 14 80 	cmpl   $0x80143fc0,0xc(%ebp)
80104a25:	74 17                	je     80104a3e <sleep+0xe5>
    release(&ptable.lock);
80104a27:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104a2e:	e8 34 16 00 00       	call   80106067 <release>
    acquire(lk);
80104a33:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a36:	89 04 24             	mov    %eax,(%esp)
80104a39:	e8 b1 15 00 00       	call   80105fef <acquire>
  }
}
80104a3e:	c9                   	leave  
80104a3f:	c3                   	ret    
...
80104a43:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a46:	c7 45 fc f4 3f 14 80 	movl   $0x80143ff4,-0x4(%ebp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a86:	81 45 fc 88 00 00 00 	addl   $0x88,-0x4(%ebp)
80104a8d:	81 7d fc f4 61 14 80 	cmpl   $0x801461f4,-0x4(%ebp)
...
80104a9b:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104a9e:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104aa5:	e8 45 15 00 00       	call   80105fef <acquire>
  wakeup1(chan);
80104aaa:	8b 45 08             	mov    0x8(%ebp),%eax
80104aad:	89 04 24             	mov    %eax,(%esp)
80104ab0:	e8 8b ff ff ff       	call   80104a40 <wakeup1>
  release(&ptable.lock);
80104ab5:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104abc:	e8 a6 15 00 00       	call   80106067 <release>
}
80104ac1:	c9                   	leave  
80104ac2:	c3                   	ret    
...
80104ac6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104ac9:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104ad0:	e8 1a 15 00 00       	call   80105fef <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ad5:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
80104b18:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      ...
      release(&ptable.lock);
80104b1f:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104b26:	e8 3c 15 00 00       	call   80106067 <release>
      return 0;
...
kill(int pid)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b32:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104b39:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
80104b40:	72 9c                	jb     80104ade <kill+0x1b>
  ...
  release(&ptable.lock);
80104b42:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80104b49:	e8 19 15 00 00       	call   80106067 <release>
  return -1;
...
80104b58:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b5b:	c7 45 f0 f4 3f 14 80 	movl   $0x80143ff4,-0x10(%ebp)
...
80104ba1:	eb 07                	jmp    80104baa <procdump+0x55>
      ...
      state = "???";
80104ba3:	c7 45 ec 43 9b 10 80 	movl   $0x80109b43,-0x14(%ebp)
...
80104bc5:	c7 04 24 47 9b 10 80 	movl   $0x80109b47,(%esp)
...
80104bf2:	e8 bf 14 00 00       	call   801060b6 <getcallerpcs>
...
80104c0b:	c7 04 24 50 9b 10 80 	movl   $0x80109b50,(%esp)
...
80104c2a:	75 d4                	jne    80104c00 <procdump+0xab>
    ...
    cprintf("\n");
80104c2c:	c7 04 24 54 9b 10 80 	movl   $0x80109b54,(%esp)
...
80104c3a:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c3b:	81 45 f0 88 00 00 00 	addl   $0x88,-0x10(%ebp)
80104c42:	81 7d f0 f4 61 14 80 	cmpl   $0x801461f4,-0x10(%ebp)
...
80104c68:	c7 04 24 58 9b 10 80 	movl   $0x80109b58,(%esp)
...
80104c7b:	e8 e1 42 00 00       	call   80108f61 <setupkvm>
...
80104c90:	c7 04 24 84 9b 10 80 	movl   $0x80109b84,(%esp)
...
80104cb5:	e8 98 15 00 00       	call   80106252 <memset>
...
80104d3a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  ...
  np->cwd = namei("/");
80104d3c:	c7 04 24 9d 9a 10 80 	movl   $0x80109a9d,(%esp)
...
80104d6a:	e8 61 17 00 00       	call   801064d0 <strlen>
...
80104d86:	e8 f7 16 00 00       	call   80106482 <safestrcpy>
...
80104dce:	c7 44 24 04 ad 9b 10 	movl   $0x80109bad,0x4(%esp)
80104dd5:	80 
...
80104de9:	c7 44 24 04 af 9b 10 	movl   $0x80109baf,0x4(%esp)
80104df0:	80 
...
80104e41:	c7 04 24 b2 9b 10 80 	movl   $0x80109bb2,(%esp)
...
80104e63:	e8 ea 13 00 00       	call   80106252 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104e8c:	74 0c                	je     80104e9a <kernel_unlink+0x107>
    panic("unlink: writei");
80104e8e:	c7 04 24 c4 9b 10 80 	movl   $0x80109bc4,(%esp)
...
80105035:	75 0c                	jne    80105043 <kernel_create+0xde>
    panic("create: ialloc");
80105037:	c7 04 24 d3 9b 10 80 	movl   $0x80109bd3,(%esp)
...
801050a5:	c7 44 24 04 ad 9b 10 	movl   $0x80109bad,0x4(%esp)
801050ac:	80 
...
801050c6:	c7 44 24 04 af 9b 10 	movl   $0x80109baf,0x4(%esp)
801050cd:	80 
...
801050db:	79 0c                	jns    801050e9 <kernel_create+0x184>
      panic("create dots");
801050dd:	c7 04 24 e2 9b 10 80 	movl   $0x80109be2,(%esp)
...
80105109:	c7 04 24 ee 9b 10 80 	movl   $0x80109bee,(%esp)
...
8010539d:	e8 2e 11 00 00       	call   801064d0 <strlen>
...
801053ab:	e8 20 11 00 00       	call   801064d0 <strlen>
...
80105441:	e8 8a 10 00 00       	call   801064d0 <strlen>
...
80105483:	c7 44 24 0c fe 9b 10 	movl   $0x80109bfe,0xc(%esp)
8010548a:	80 
...
//   cprintf("path %s\n",path);
  //TODO maybe release and acquire  ptable.lock just for kernel_open
...
80105505:	c7 04 24 1e 9c 10 80 	movl   $0x80109c1e,(%esp)
...
80105547:	c7 04 24 38 9c 10 80 	movl   $0x80109c38,(%esp)
...
801055fe:	e8 fe 3d 00 00       	call   80109401 <deallocuvm>
...
8010563a:	e8 91 0e 00 00       	call   801064d0 <strlen>
...
80105683:	c7 44 24 0c fe 9b 10 	movl   $0x80109bfe,0xc(%esp)
8010568a:	80 
...
8010569d:	e8 ee fc ff ff       	call   80105390 <strcat>
  ...
  release(&ptable.lock);
801056a2:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801056a9:	e8 b9 09 00 00       	call   80106067 <release>
  int test;
...
//   cprintf("swapIn - passed open pid %d p->sz %d\n",p->pid,p->sz);
  p->pgdir = setupkvm();
801056c7:	e8 95 38 00 00       	call   80108f61 <setupkvm>
...
801056ec:	e8 42 3c 00 00       	call   80109333 <allocuvm>
...
80105723:	e8 1c 3b 00 00       	call   80109244 <loaduvm>
...
//   cprintf("swapIn - passed kernel_unlink pid %d returned %d\n",p->pid,test);
  acquire(&ptable.lock);
801057aa:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801057b1:	e8 39 08 00 00       	call   80105fef <acquire>
...
801057c0:	83 ec 28             	sub    $0x28,%esp
  release(&ptable.lock);
801057c3:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801057ca:	e8 98 08 00 00       	call   80106067 <release>
  for(;;){
    struct proc *p;
    acquire(&ptable.lock);
801057cf:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
801057d6:	e8 14 08 00 00       	call   80105fef <acquire>
    //cprintf("inSwapper\n");
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801057db:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
80105817:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  for(;;){
    ...
    //cprintf("inSwapper\n");
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010581e:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80105825:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
...
8010583b:	e8 09 f0 ff ff       	call   80104849 <sched>
    release(&ptable.lock);
80105840:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80105847:	e8 1b 08 00 00       	call   80106067 <release>
  }
...
8010587c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  acquire(&ptable.lock);
80105883:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
8010588a:	e8 60 07 00 00       	call   80105fef <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010588f:	c7 45 f4 f4 3f 14 80 	movl   $0x80143ff4,-0xc(%ebp)
...
int num_of_pages(int proc_pid){
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801058a6:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
...
int num_of_pages(int proc_pid){
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105943:	81 7d f4 f4 61 14 80 	cmpl   $0x801461f4,-0xc(%ebp)
8010594a:	0f 82 4b ff ff ff    	jb     8010589b <num_of_pages+0x25>
  ...
  release(&ptable.lock);
80105950:	c7 04 24 c0 3f 14 80 	movl   $0x80143fc0,(%esp)
80105957:	e8 0b 07 00 00       	call   80106067 <release>
  return counter; 
...
80105964:	57                   	push   %edi
80105965:	56                   	push   %esi
80105966:	53                   	push   %ebx
80105967:	81 ec fc 00 00 00    	sub    $0xfc,%esp
  int rounded_size;
  struct shmobj newShmObj;
  acquire(&shmtable.lock);
8010596d:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105974:	e8 76 06 00 00       	call   80105fef <acquire>
  if(shmflg == GET){
80105979:	83 7d 10 02          	cmpl   $0x2,0x10(%ebp)
8010597d:	75 5d                	jne    801059dc <shmget+0x7b>
   if((!&shmtable.shmarray[key])||shmtable.shmarray[key].shmstate == UNINITIALIZED){ //no shared memory object with that key
8010597f:	8b 45 08             	mov    0x8(%ebp),%eax
80105982:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105988:	05 b4 1f 11 80       	add    $0x80111fb4,%eax
8010598d:	85 c0                	test   %eax,%eax
8010598f:	74 15                	je     801059a6 <shmget+0x45>
80105991:	8b 45 08             	mov    0x8(%ebp),%eax
80105994:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
8010599a:	05 60 20 11 80       	add    $0x80112060,%eax
8010599f:	8b 40 10             	mov    0x10(%eax),%eax
801059a2:	85 c0                	test   %eax,%eax
801059a4:	75 22                	jne    801059c8 <shmget+0x67>
    cprintf("shmget(GET)-shmarray failure\n");
801059a6:	c7 04 24 54 9c 10 80 	movl   $0x80109c54,(%esp)
801059ad:	e8 ef a9 ff ff       	call   801003a1 <cprintf>
    release(&shmtable.lock);
801059b2:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
801059b9:	e8 a9 06 00 00       	call   80106067 <release>
    return -1; 
801059be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059c3:	e9 47 01 00 00       	jmp    80105b0f <shmget+0x1ae>
   }else{
     release(&shmtable.lock);
801059c8:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
801059cf:	e8 93 06 00 00       	call   80106067 <release>
     return key;
801059d4:	8b 45 08             	mov    0x8(%ebp),%eax
801059d7:	e9 33 01 00 00       	jmp    80105b0f <shmget+0x1ae>
   } 
  }
  if(shmflg == CREAT){
801059dc:	83 7d 10 01          	cmpl   $0x1,0x10(%ebp)
801059e0:	0f 85 1a 01 00 00    	jne    80105b00 <shmget+0x19f>
...
801059e9:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
801059ef:	05 60 20 11 80       	add    $0x80112060,%eax
801059f4:	8b 40 10             	mov    0x10(%eax),%eax
801059f7:	85 c0                	test   %eax,%eax
801059f9:	74 16                	je     80105a11 <shmget+0xb0>
      release(&shmtable.lock);
801059fb:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105a02:	e8 60 06 00 00       	call   80106067 <release>
      return -1;
80105a07:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a0c:	e9 fe 00 00 00       	jmp    80105b0f <shmget+0x1ae>
    }
    int i = 0;
80105a11:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    int k;
    shmtable.shmarray[key].pages_amount = 0;
80105a18:	8b 45 08             	mov    0x8(%ebp),%eax
80105a1b:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105a21:	05 70 20 11 80       	add    $0x80112070,%eax
80105a26:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    shmtable.shmarray[key].key = key;
80105a2d:	8b 45 08             	mov    0x8(%ebp),%eax
80105a30:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105a36:	8d 90 e0 1f 11 80    	lea    -0x7feee020(%eax),%edx
80105a3c:	8b 45 08             	mov    0x8(%ebp),%eax
80105a3f:	89 42 08             	mov    %eax,0x8(%edx)
    rounded_size = PGROUNDUP(size);
80105a42:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a45:	05 ff 0f 00 00       	add    $0xfff,%eax
80105a4a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105a4f:	89 45 dc             	mov    %eax,-0x24(%ebp)
    shmtable.shmarray[key].size = rounded_size;
80105a52:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105a55:	8b 55 08             	mov    0x8(%ebp),%edx
80105a58:	69 d2 c8 00 00 00    	imul   $0xc8,%edx,%edx
80105a5e:	81 c2 e0 1f 11 80    	add    $0x80111fe0,%edx
80105a64:	89 42 0c             	mov    %eax,0xc(%edx)
    shmtable.shmarray[key].shmstate = UNLINKED;
80105a67:	8b 45 08             	mov    0x8(%ebp),%eax
80105a6a:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105a70:	05 60 20 11 80       	add    $0x80112060,%eax
80105a75:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)
    shmtable.shmarray[key] = newShmObj;
80105a7c:	8b 45 08             	mov    0x8(%ebp),%eax
80105a7f:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105a85:	05 b0 1f 11 80       	add    $0x80111fb0,%eax
80105a8a:	8d 58 04             	lea    0x4(%eax),%ebx
80105a8d:	8d 95 14 ff ff ff    	lea    -0xec(%ebp),%edx
80105a93:	b8 32 00 00 00       	mov    $0x32,%eax
80105a98:	89 df                	mov    %ebx,%edi
80105a9a:	89 d6                	mov    %edx,%esi
80105a9c:	89 c1                	mov    %eax,%ecx
80105a9e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    for(k = 0; k < rounded_size; k+= PGSIZE){
80105aa0:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80105aa7:	eb 4f                	jmp    80105af8 <shmget+0x197>
	if(!(shmtable.shmarray[key].addr[i] = kalloc())){
80105aa9:	e8 45 d0 ff ff       	call   80102af3 <kalloc>
80105aae:	8b 55 08             	mov    0x8(%ebp),%edx
80105ab1:	6b d2 32             	imul   $0x32,%edx,%edx
80105ab4:	03 55 e4             	add    -0x1c(%ebp),%edx
80105ab7:	83 c2 18             	add    $0x18,%edx
80105aba:	89 04 95 90 1f 11 80 	mov    %eax,-0x7feee070(,%edx,4)
80105ac1:	8b 45 08             	mov    0x8(%ebp),%eax
80105ac4:	6b c0 32             	imul   $0x32,%eax,%eax
80105ac7:	03 45 e4             	add    -0x1c(%ebp),%eax
80105aca:	83 c0 18             	add    $0x18,%eax
80105acd:	8b 04 85 90 1f 11 80 	mov    -0x7feee070(,%eax,4),%eax
80105ad4:	85 c0                	test   %eax,%eax
80105ad6:	75 0c                	jne    80105ae4 <shmget+0x183>
	cprintf("shmget(create)-kalloc failure\n");
80105ad8:	c7 04 24 74 9c 10 80 	movl   $0x80109c74,(%esp)
80105adf:	e8 bd a8 ff ff       	call   801003a1 <cprintf>
	}
	newShmObj.pages_amount++;
80105ae4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105ae7:	83 c0 01             	add    $0x1,%eax
80105aea:	89 45 d4             	mov    %eax,-0x2c(%ebp)
	i++;
80105aed:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    shmtable.shmarray[key].key = key;
    rounded_size = PGROUNDUP(size);
    shmtable.shmarray[key].size = rounded_size;
    shmtable.shmarray[key].shmstate = UNLINKED;
    shmtable.shmarray[key] = newShmObj;
    for(k = 0; k < rounded_size; k+= PGSIZE){
80105af1:	81 45 e0 00 10 00 00 	addl   $0x1000,-0x20(%ebp)
80105af8:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105afb:	3b 45 dc             	cmp    -0x24(%ebp),%eax
80105afe:	7c a9                	jl     80105aa9 <shmget+0x148>
	newShmObj.pages_amount++;
	i++;
    }
  ...
  release(&shmtable.lock);
80105b00:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105b07:	e8 5b 05 00 00       	call   80106067 <release>
  //TODO explain- we return the addrees of the memmory- dont know if it a good idea
  return key; 
80105b0c:	8b 45 08             	mov    0x8(%ebp),%eax
  //return (int) shmtable.shmarray[key].addr[0];
}
80105b0f:	81 c4 fc 00 00 00    	add    $0xfc,%esp
80105b15:	5b                   	pop    %ebx
80105b16:	5e                   	pop    %esi
80105b17:	5f                   	pop    %edi
80105b18:	5d                   	pop    %ebp
...
80105b1d:	83 ec 28             	sub    $0x28,%esp
  acquire(&shmtable.lock);
80105b20:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105b27:	e8 c3 04 00 00       	call   80105fef <acquire>
  //TODO check this test
  if(shmtable.shmarray[shmid].shmstate == UNLINKED && !shmtable.shmarray[shmid].linkcounter){
80105b2c:	8b 45 08             	mov    0x8(%ebp),%eax
80105b2f:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105b35:	05 60 20 11 80       	add    $0x80112060,%eax
80105b3a:	8b 40 10             	mov    0x10(%eax),%eax
80105b3d:	83 f8 01             	cmp    $0x1,%eax
80105b40:	0f 85 aa 00 00 00    	jne    80105bf0 <shmdel+0xd6>
80105b46:	8b 45 08             	mov    0x8(%ebp),%eax
80105b49:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105b4f:	05 70 20 11 80       	add    $0x80112070,%eax
80105b54:	8b 40 08             	mov    0x8(%eax),%eax
80105b57:	85 c0                	test   %eax,%eax
80105b59:	0f 85 91 00 00 00    	jne    80105bf0 <shmdel+0xd6>
    int i;
    for(i = 0; i < shmtable.shmarray[shmid].pages_amount;i++){
80105b5f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105b66:	eb 1f                	jmp    80105b87 <shmdel+0x6d>
      kfree(shmtable.shmarray[shmid].addr[i]);
80105b68:	8b 45 08             	mov    0x8(%ebp),%eax
80105b6b:	6b c0 32             	imul   $0x32,%eax,%eax
80105b6e:	03 45 f4             	add    -0xc(%ebp),%eax
80105b71:	83 c0 18             	add    $0x18,%eax
80105b74:	8b 04 85 90 1f 11 80 	mov    -0x7feee070(,%eax,4),%eax
80105b7b:	89 04 24             	mov    %eax,(%esp)
80105b7e:	e8 d7 ce ff ff       	call   80102a5a <kfree>
int shmdel(int shmid){
  acquire(&shmtable.lock);
  //TODO check this test
  if(shmtable.shmarray[shmid].shmstate == UNLINKED && !shmtable.shmarray[shmid].linkcounter){
    int i;
    for(i = 0; i < shmtable.shmarray[shmid].pages_amount;i++){
80105b83:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105b87:	8b 45 08             	mov    0x8(%ebp),%eax
80105b8a:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105b90:	05 70 20 11 80       	add    $0x80112070,%eax
80105b95:	8b 40 04             	mov    0x4(%eax),%eax
80105b98:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80105b9b:	7f cb                	jg     80105b68 <shmdel+0x4e>
      kfree(shmtable.shmarray[shmid].addr[i]);
    }
    shmtable.shmarray[shmid].pages_amount = 0;
80105b9d:	8b 45 08             	mov    0x8(%ebp),%eax
80105ba0:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105ba6:	05 70 20 11 80       	add    $0x80112070,%eax
80105bab:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    shmtable.shmarray[shmid].size = 0;
80105bb2:	8b 45 08             	mov    0x8(%ebp),%eax
80105bb5:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105bbb:	05 e0 1f 11 80       	add    $0x80111fe0,%eax
80105bc0:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    shmtable.shmarray[shmid].shmstate = UNINITIALIZED;
80105bc7:	8b 45 08             	mov    0x8(%ebp),%eax
80105bca:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105bd0:	05 60 20 11 80       	add    $0x80112060,%eax
80105bd5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
}
...
80105bdc:	90                   	nop
  ...
  release(&shmtable.lock);
80105bdd:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105be4:	e8 7e 04 00 00       	call   80106067 <release>
 return 0; 
80105be9:	b8 00 00 00 00       	mov    $0x0,%eax
80105bee:	eb 05                	jmp    80105bf5 <shmdel+0xdb>
    }
    shmtable.shmarray[shmid].pages_amount = 0;
    shmtable.shmarray[shmid].size = 0;
    shmtable.shmarray[shmid].shmstate = UNINITIALIZED;
...
/*void deallocshm(int key){
  shmtable.shmarray[key];
}
*/
int find_key(const void *shmaddr ){
80105bf7:	55                   	push   %ebp
80105bf8:	89 e5                	mov    %esp,%ebp
80105bfa:	83 ec 10             	sub    $0x10,%esp
  int ret =-1;
80105bfd:	c7 45 fc ff ff ff ff 	movl   $0xffffffff,-0x4(%ebp)
  int i,j;
  for(j=0;j<SHM_TABLE_SIZE;j++){
80105c04:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105c0b:	eb 37                	jmp    80105c44 <find_key+0x4d>
    for(i = 0;i<NUM_OF_SEGMENTS;i++){
80105c0d:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105c14:	eb 24                	jmp    80105c3a <find_key+0x43>
      if(shmtable.shmarray[j].addr[i] == shmaddr){
80105c16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c19:	6b c0 32             	imul   $0x32,%eax,%eax
80105c1c:	03 45 f8             	add    -0x8(%ebp),%eax
80105c1f:	83 c0 18             	add    $0x18,%eax
80105c22:	8b 04 85 90 1f 11 80 	mov    -0x7feee070(,%eax,4),%eax
80105c29:	3b 45 08             	cmp    0x8(%ebp),%eax
80105c2c:	75 08                	jne    80105c36 <find_key+0x3f>
	ret = j;
80105c2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c31:	89 45 fc             	mov    %eax,-0x4(%ebp)
	break;
80105c34:	eb 0a                	jmp    80105c40 <find_key+0x49>
*/
int find_key(const void *shmaddr ){
  int ret =-1;
  int i,j;
...
80105c3a:	83 7d f8 1f          	cmpl   $0x1f,-0x8(%ebp)
80105c3e:	7e d6                	jle    80105c16 <find_key+0x1f>
}
*/
int find_key(const void *shmaddr ){
  int ret =-1;
  int i,j;
  for(j=0;j<SHM_TABLE_SIZE;j++){
80105c40:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105c44:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80105c4b:	7e c0                	jle    80105c0d <find_key+0x16>
	ret = j;
	break;
      }
    }
...
//TODO maybe the proc should know if he is linked and where
void *shmat(int shmid, int shmflg){ 
80105c52:	55                   	push   %ebp
80105c53:	89 e5                	mov    %esp,%ebp
80105c55:	83 ec 48             	sub    $0x48,%esp
  char * memory;
  uint size;
  void* ret = (void*) -1;
80105c58:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
  int i;
  int flag_for =0;
80105c5f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  acquire(&shmtable.lock);
80105c66:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105c6d:	e8 7d 03 00 00       	call   80105fef <acquire>
  //TODO test this if
  if(shmtable.shmarray[shmid].size > 0){
80105c72:	8b 45 08             	mov    0x8(%ebp),%eax
80105c75:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105c7b:	05 e0 1f 11 80       	add    $0x80111fe0,%eax
80105c80:	8b 40 0c             	mov    0xc(%eax),%eax
80105c83:	85 c0                	test   %eax,%eax
80105c85:	0f 84 87 01 00 00    	je     80105e12 <shmat+0x1c0>
    size = PGROUNDUP(proc->sz);
80105c8b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c91:	8b 00                	mov    (%eax),%eax
80105c93:	05 ff 0f 00 00       	add    $0xfff,%eax
80105c98:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80105ca9:	05 00 10 00 00       	add    $0x1000,%eax
80105cae:	85 c0                	test   %eax,%eax
80105cb0:	79 22                	jns    80105cd4 <shmat+0x82>
      cprintf("shmat:not enogh memory\n");
80105cb2:	c7 04 24 93 9c 10 80 	movl   $0x80109c93,(%esp)
80105cb9:	e8 e3 a6 ff ff       	call   801003a1 <cprintf>
      release(&shmtable.lock);
80105cbe:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105cc5:	e8 9d 03 00 00       	call   80106067 <release>
      return (void*)-1;
80105cca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ccf:	e9 6c 01 00 00       	jmp    80105e40 <shmat+0x1ee>
    }
    //all is fine
    for(i = 0;shmtable.shmarray[shmid].addr[i] && size < KERNBASE;i++,size += PGSIZE){
80105cd4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80105cdb:	e9 af 00 00 00       	jmp    80105d8f <shmat+0x13d>
      //find the adress of the memory
      memory = shmtable.shmarray[shmid].addr[i];
80105ce0:	8b 45 08             	mov    0x8(%ebp),%eax
80105ce3:	6b c0 32             	imul   $0x32,%eax,%eax
80105ce6:	03 45 ec             	add    -0x14(%ebp),%eax
80105ce9:	83 c0 18             	add    $0x18,%eax
80105cec:	8b 04 85 90 1f 11 80 	mov    -0x7feee070(,%eax,4),%eax
80105cf3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      flag_for =1; //we did at least one page
80105cf6:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
      if(shmflg == SHM_RDONLY){
80105cfd:	83 7d 0c 16          	cmpl   $0x16,0xc(%ebp)
80105d01:	75 3a                	jne    80105d3d <shmat+0xeb>
	mappages(proc->pgdir, (char*)size, PGSIZE, v2p(memory), PTE_U);
80105d03:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d06:	89 04 24             	mov    %eax,(%esp)
80105d09:	e8 b2 e2 ff ff       	call   80103fc0 <v2p>
80105d0e:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80105d11:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105d18:	8b 52 04             	mov    0x4(%edx),%edx
80105d1b:	c7 44 24 10 04 00 00 	movl   $0x4,0x10(%esp)
80105d22:	00 
80105d23:	89 44 24 0c          	mov    %eax,0xc(%esp)
80105d27:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80105d2e:	00 
80105d2f:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105d33:	89 14 24             	mov    %edx,(%esp)
80105d36:	e8 92 31 00 00       	call   80108ecd <mappages>
	break;
80105d3b:	eb 74                	jmp    80105db1 <shmat+0x15f>
      }
      else if(shmflg == SHM_RDWR){
80105d3d:	83 7d 0c 17          	cmpl   $0x17,0xc(%ebp)
80105d41:	75 3a                	jne    80105d7d <shmat+0x12b>
...
80105d49:	e8 72 e2 ff ff       	call   80103fc0 <v2p>
80105d4e:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80105d51:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105d58:	8b 52 04             	mov    0x4(%edx),%edx
80105d5b:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80105d62:	00 
80105d63:	89 44 24 0c          	mov    %eax,0xc(%esp)
80105d67:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80105d6e:	00 
80105d6f:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105d73:	89 14 24             	mov    %edx,(%esp)
80105d76:	e8 52 31 00 00       	call   80108ecd <mappages>
	break;
80105d7b:	eb 34                	jmp    80105db1 <shmat+0x15f>
      }
      else{//default
	flag_for = 0;
80105d7d:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
      cprintf("shmat:not enogh memory\n");
      release(&shmtable.lock);
      return (void*)-1;
    }
    //all is fine
    for(i = 0;shmtable.shmarray[shmid].addr[i] && size < KERNBASE;i++,size += PGSIZE){
80105d84:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
80105d88:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80105d8f:	8b 45 08             	mov    0x8(%ebp),%eax
80105d92:	6b c0 32             	imul   $0x32,%eax,%eax
80105d95:	03 45 ec             	add    -0x14(%ebp),%eax
80105d98:	83 c0 18             	add    $0x18,%eax
80105d9b:	8b 04 85 90 1f 11 80 	mov    -0x7feee070(,%eax,4),%eax
80105da2:	85 c0                	test   %eax,%eax
80105da4:	74 0b                	je     80105db1 <shmat+0x15f>
80105da6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105da9:	85 c0                	test   %eax,%eax
80105dab:	0f 89 2f ff ff ff    	jns    80105ce0 <shmat+0x8e>
      }
      else{//default
	flag_for = 0;
      }
    ...
    if(flag_for){
80105db1:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80105db5:	74 46                	je     80105dfd <shmat+0x1ab>
      proc->sz =size;
80105db7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105dbd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105dc0:	89 10                	mov    %edx,(%eax)
      ret = shmtable.shmarray[shmid].addr[0];
80105dc2:	8b 45 08             	mov    0x8(%ebp),%eax
80105dc5:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105dcb:	05 e0 1f 11 80       	add    $0x80111fe0,%eax
80105dd0:	8b 40 10             	mov    0x10(%eax),%eax
80105dd3:	89 45 f0             	mov    %eax,-0x10(%ebp)
      shmtable.shmarray[shmid].linkcounter++;
80105dd6:	8b 45 08             	mov    0x8(%ebp),%eax
80105dd9:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105ddf:	05 70 20 11 80       	add    $0x80112070,%eax
80105de4:	8b 40 08             	mov    0x8(%eax),%eax
80105de7:	8d 50 01             	lea    0x1(%eax),%edx
80105dea:	8b 45 08             	mov    0x8(%ebp),%eax
80105ded:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105df3:	05 70 20 11 80       	add    $0x80112070,%eax
80105df8:	89 50 08             	mov    %edx,0x8(%eax)
80105dfb:	eb 34                	jmp    80105e31 <shmat+0x1df>
    }
    else{
    ret =(void*) -1;
80105dfd:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
    cprintf("shmat: no shmflg (flag_for = 0\n");
80105e04:	c7 04 24 ac 9c 10 80 	movl   $0x80109cac,(%esp)
80105e0b:	e8 91 a5 ff ff       	call   801003a1 <cprintf>
80105e10:	eb 1f                	jmp    80105e31 <shmat+0x1df>
    }
  }
  else{ 
    cprintf("shmat: the memory isn't there\n");
80105e12:	c7 04 24 cc 9c 10 80 	movl   $0x80109ccc,(%esp)
80105e19:	e8 83 a5 ff ff       	call   801003a1 <cprintf>
    release(&shmtable.lock);
80105e1e:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105e25:	e8 3d 02 00 00       	call   80106067 <release>
    return (void*)-1;
80105e2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e2f:	eb 0f                	jmp    80105e40 <shmat+0x1ee>
  }
  release(&shmtable.lock);
80105e31:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105e38:	e8 2a 02 00 00       	call   80106067 <release>
  return ret; 
...
80105e48:	8b 45 08             	mov    0x8(%ebp),%eax
80105e4b:	89 04 24             	mov    %eax,(%esp)
80105e4e:	e8 a4 fd ff ff       	call   80105bf7 <find_key>
80105e53:	89 45 f0             	mov    %eax,-0x10(%ebp)
  pte = walkpgdir(proc->pgdir, (char*)shmaddr, 0);
80105e56:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e5c:	8b 40 04             	mov    0x4(%eax),%eax
80105e5f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e66:	00 
80105e67:	8b 55 08             	mov    0x8(%ebp),%edx
80105e6a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e6e:	89 04 24             	mov    %eax,(%esp)
80105e71:	e8 c1 2f 00 00       	call   80108e37 <walkpgdir>
80105e76:	89 45 ec             	mov    %eax,-0x14(%ebp)
  //mem = (int)p2v(PTE_ADDR(*pte));//TODO not sure we need
  acquire(&shmtable.lock);
80105e79:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105e80:	e8 6a 01 00 00       	call   80105fef <acquire>
  shmtable.shmarray[shmid].linkcounter--;
80105e85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e88:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105e8e:	05 70 20 11 80       	add    $0x80112070,%eax
80105e93:	8b 40 08             	mov    0x8(%eax),%eax
80105e96:	8d 50 ff             	lea    -0x1(%eax),%edx
80105e99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e9c:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105ea2:	05 70 20 11 80       	add    $0x80112070,%eax
80105ea7:	89 50 08             	mov    %edx,0x8(%eax)
  numOfPages = shmtable.shmarray[shmid].pages_amount;
80105eaa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ead:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105eb3:	05 70 20 11 80       	add    $0x80112070,%eax
80105eb8:	8b 40 04             	mov    0x4(%eax),%eax
80105ebb:	89 45 e8             	mov    %eax,-0x18(%ebp)
...
80105ec4:	eb 40                	jmp    80105f06 <shmdt+0xc4>
  {
    pte = walkpgdir(proc->pgdir, (char*)shmaddr2, 0);
80105ec6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ecc:	8b 40 04             	mov    0x4(%eax),%eax
80105ecf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105ed6:	00 
80105ed7:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105eda:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ede:	89 04 24             	mov    %eax,(%esp)
80105ee1:	e8 51 2f 00 00       	call   80108e37 <walkpgdir>
80105ee6:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(!pte)
80105ee9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105eed:	75 07                	jne    80105ef6 <shmdt+0xb4>
      shmaddr2 += (NPTENTRIES - 1) * PGSIZE;
80105eef:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
    *pte = 0;
80105ef6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105ef9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  acquire(&shmtable.lock);
  shmtable.shmarray[shmid].linkcounter--;
  numOfPages = shmtable.shmarray[shmid].pages_amount;
  void *shmaddr2 = (void*)shmaddr;
  ...
  for(; shmaddr2  < shmaddr + numOfPages*PGSIZE; shmaddr2 += PGSIZE)
80105eff:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80105f06:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f09:	c1 e0 0c             	shl    $0xc,%eax
80105f0c:	03 45 08             	add    0x8(%ebp),%eax
80105f0f:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80105f12:	77 b2                	ja     80105ec6 <shmdt+0x84>
    if(!pte)
      shmaddr2 += (NPTENTRIES - 1) * PGSIZE;
    *pte = 0;
  }
...
80105f17:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105f1d:	05 70 20 11 80       	add    $0x80112070,%eax
80105f22:	8b 40 08             	mov    0x8(%eax),%eax
80105f25:	85 c0                	test   %eax,%eax
80105f27:	75 0b                	jne    80105f34 <shmdt+0xf2>
    //cprintf("freeing all the memory\n");
    shmdel(shmid);
80105f29:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2c:	89 04 24             	mov    %eax,(%esp)
80105f2f:	e8 e6 fb ff ff       	call   80105b1a <shmdel>
  }
 release(&shmtable.lock);
80105f34:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105f3b:	e8 27 01 00 00       	call   80106067 <release>
 return 0; 
80105f40:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105f45:	c9                   	leave  
80105f46:	c3                   	ret    

80105f47 <get_share_memory_address>:
void* get_share_memory_address(int key){
80105f47:	55                   	push   %ebp
80105f48:	89 e5                	mov    %esp,%ebp
80105f4a:	83 ec 28             	sub    $0x28,%esp
  void * ret =0;
80105f4d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  acquire(&shmtable.lock);
80105f54:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105f5b:	e8 8f 00 00 00       	call   80105fef <acquire>
  ret = shmtable.shmarray[key].addr[0];
80105f60:	8b 45 08             	mov    0x8(%ebp),%eax
80105f63:	69 c0 c8 00 00 00    	imul   $0xc8,%eax,%eax
80105f69:	05 e0 1f 11 80       	add    $0x80111fe0,%eax
80105f6e:	8b 40 10             	mov    0x10(%eax),%eax
80105f71:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&shmtable.lock);
80105f74:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
80105f7b:	e8 e7 00 00 00       	call   80106067 <release>
 return ret;
80105f80:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80105f83:	c9                   	leave  
80105f84:	c3                   	ret    
80105f85:	00 00                	add    %al,(%eax)
	...
...
80105f8f:	9c                   	pushf  
80105f90:	5b                   	pop    %ebx
80105f91:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80105fad:	83 ec 10             	sub    $0x10,%esp
  ...
  asm volatile("lock; xchgl %0, %1" :
               "+m" (*addr), "=a" (result) :
80105fb0:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80105fb3:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80105fb6:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80105fbb:	89 d8                	mov    %ebx,%eax
80105fbd:	f0 87 02             	lock xchg %eax,(%edx)
80105fc0:	89 c3                	mov    %eax,%ebx
80105fc2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80105fd4:	8b 55 0c             	mov    0xc(%ebp),%edx
80105fd7:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105fda:	8b 45 08             	mov    0x8(%ebp),%eax
80105fdd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80105fe3:	8b 45 08             	mov    0x8(%ebp),%eax
80105fe6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105fed:	5d                   	pop    %ebp
80105fee:	c3                   	ret    
...
80105ff5:	e8 53 01 00 00       	call   8010614d <pushcli>
  if(holding(lk)){
80105ffa:	8b 45 08             	mov    0x8(%ebp),%eax
80105ffd:	89 04 24             	mov    %eax,(%esp)
80106000:	e8 1e 01 00 00       	call   80106123 <holding>
80106005:	85 c0                	test   %eax,%eax
80106007:	74 22                	je     8010602b <acquire+0x3c>
    cprintf("acquire spinlock.c->lk: %s\n",lk->name);
80106009:	8b 45 08             	mov    0x8(%ebp),%eax
8010600c:	8b 40 04             	mov    0x4(%eax),%eax
8010600f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106013:	c7 04 24 3b 9d 10 80 	movl   $0x80109d3b,(%esp)
8010601a:	e8 82 a3 ff ff       	call   801003a1 <cprintf>
    panic("acquire");
8010601f:	c7 04 24 57 9d 10 80 	movl   $0x80109d57,(%esp)
80106026:	e8 12 a5 ff ff       	call   8010053d <panic>
  }
...
8010603a:	e8 6a ff ff ff       	call   80105fa9 <xchg>
8010603f:	85 c0                	test   %eax,%eax
80106041:	75 e9                	jne    8010602c <acquire+0x3d>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80106043:	8b 45 08             	mov    0x8(%ebp),%eax
80106046:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010604d:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80106050:	8b 45 08             	mov    0x8(%ebp),%eax
80106053:	83 c0 0c             	add    $0xc,%eax
80106056:	89 44 24 04          	mov    %eax,0x4(%esp)
8010605a:	8d 45 08             	lea    0x8(%ebp),%eax
8010605d:	89 04 24             	mov    %eax,(%esp)
80106060:	e8 51 00 00 00       	call   801060b6 <getcallerpcs>
}
80106065:	c9                   	leave  
80106066:	c3                   	ret    
...
8010606a:	83 ec 18             	sub    $0x18,%esp
  if(!holding(lk))
8010606d:	8b 45 08             	mov    0x8(%ebp),%eax
80106070:	89 04 24             	mov    %eax,(%esp)
80106073:	e8 ab 00 00 00       	call   80106123 <holding>
80106078:	85 c0                	test   %eax,%eax
8010607a:	75 0c                	jne    80106088 <release+0x21>
    panic("release");
8010607c:	c7 04 24 5f 9d 10 80 	movl   $0x80109d5f,(%esp)
80106083:	e8 b5 a4 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80106088:	8b 45 08             	mov    0x8(%ebp),%eax
8010608b:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80106092:	8b 45 08             	mov    0x8(%ebp),%eax
80106095:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
801060aa:	e8 fa fe ff ff       	call   80105fa9 <xchg>

  popcli();
801060af:	e8 e1 00 00 00       	call   80106195 <popcli>
}
801060b4:	c9                   	leave  
801060b5:	c3                   	ret    

801060b6 <getcallerpcs>:
...
801060bf:	83 e8 08             	sub    $0x8,%eax
801060c2:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801060c5:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
801060cc:	eb 32                	jmp    80106100 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801060ce:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801060d2:	74 47                	je     8010611b <getcallerpcs+0x65>
801060d4:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801060db:	76 3e                	jbe    8010611b <getcallerpcs+0x65>
801060dd:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801060e1:	74 38                	je     8010611b <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801060e3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801060e6:	c1 e0 02             	shl    $0x2,%eax
801060e9:	03 45 0c             	add    0xc(%ebp),%eax
801060ec:	8b 55 fc             	mov    -0x4(%ebp),%edx
801060ef:	8b 52 04             	mov    0x4(%edx),%edx
801060f2:	89 10                	mov    %edx,(%eax)
...
801060f9:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801060fc:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80106100:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80106104:	7e c8                	jle    801060ce <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80106106:	eb 13                	jmp    8010611b <getcallerpcs+0x65>
    pcs[i] = 0;
80106108:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010610b:	c1 e0 02             	shl    $0x2,%eax
8010610e:	03 45 0c             	add    0xc(%ebp),%eax
80106111:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80106117:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010611b:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010611f:	7e e7                	jle    80106108 <getcallerpcs+0x52>
    pcs[i] = 0;
}
80106121:	c9                   	leave  
80106122:	c3                   	ret    
...
8010612d:	74 17                	je     80106146 <holding+0x23>
8010612f:	8b 45 08             	mov    0x8(%ebp),%eax
80106132:	8b 50 08             	mov    0x8(%eax),%edx
80106135:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010613b:	39 c2                	cmp    %eax,%edx
8010613d:	75 07                	jne    80106146 <holding+0x23>
8010613f:	b8 01 00 00 00       	mov    $0x1,%eax
80106144:	eb 05                	jmp    8010614b <holding+0x28>
...
80106150:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80106153:	e8 30 fe ff ff       	call   80105f88 <readeflags>
80106158:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010615b:	e8 3d fe ff ff       	call   80105f9d <cli>
  if(cpu->ncli++ == 0)
80106160:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106166:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010616c:	85 d2                	test   %edx,%edx
8010616e:	0f 94 c1             	sete   %cl
80106171:	83 c2 01             	add    $0x1,%edx
80106174:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010617a:	84 c9                	test   %cl,%cl
8010617c:	74 15                	je     80106193 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
8010617e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106184:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106187:	81 e2 00 02 00 00    	and    $0x200,%edx
8010618d:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80106193:	c9                   	leave  
80106194:	c3                   	ret    
...
80106198:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010619b:	e8 e8 fd ff ff       	call   80105f88 <readeflags>
801061a0:	25 00 02 00 00       	and    $0x200,%eax
801061a5:	85 c0                	test   %eax,%eax
801061a7:	74 0c                	je     801061b5 <popcli+0x20>
    panic("popcli - interruptible");
801061a9:	c7 04 24 67 9d 10 80 	movl   $0x80109d67,(%esp)
801061b0:	e8 88 a3 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
801061b5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801061bb:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801061c1:	83 ea 01             	sub    $0x1,%edx
801061c4:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801061ca:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801061d0:	85 c0                	test   %eax,%eax
801061d2:	79 0c                	jns    801061e0 <popcli+0x4b>
    panic("popcli");
801061d4:	c7 04 24 7e 9d 10 80 	movl   $0x80109d7e,(%esp)
801061db:	e8 5d a3 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
801061e0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801061e6:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801061ec:	85 c0                	test   %eax,%eax
801061ee:	75 15                	jne    80106205 <popcli+0x70>
801061f0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801061f6:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801061fc:	85 c0                	test   %eax,%eax
801061fe:	74 05                	je     80106205 <popcli+0x70>
    sti();
80106200:	e8 9e fd ff ff       	call   80105fa3 <sti>
}
80106205:	c9                   	leave  
80106206:	c3                   	ret    
	...
...
8010620d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106210:	8b 55 10             	mov    0x10(%ebp),%edx
80106213:	8b 45 0c             	mov    0xc(%ebp),%eax
80106216:	89 cb                	mov    %ecx,%ebx
80106218:	89 df                	mov    %ebx,%edi
8010621a:	89 d1                	mov    %edx,%ecx
8010621c:	fc                   	cld    
8010621d:	f3 aa                	rep stos %al,%es:(%edi)
8010621f:	89 ca                	mov    %ecx,%edx
80106221:	89 fb                	mov    %edi,%ebx
80106223:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106226:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80106231:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
80106232:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106235:	8b 55 10             	mov    0x10(%ebp),%edx
80106238:	8b 45 0c             	mov    0xc(%ebp),%eax
8010623b:	89 cb                	mov    %ecx,%ebx
8010623d:	89 df                	mov    %ebx,%edi
8010623f:	89 d1                	mov    %edx,%ecx
80106241:	fc                   	cld    
80106242:	f3 ab                	rep stos %eax,%es:(%edi)
80106244:	89 ca                	mov    %ecx,%edx
80106246:	89 fb                	mov    %edi,%ebx
80106248:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010624b:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
8010625b:	83 e0 03             	and    $0x3,%eax
8010625e:	85 c0                	test   %eax,%eax
80106260:	75 49                	jne    801062ab <memset+0x59>
80106262:	8b 45 10             	mov    0x10(%ebp),%eax
80106265:	83 e0 03             	and    $0x3,%eax
80106268:	85 c0                	test   %eax,%eax
8010626a:	75 3f                	jne    801062ab <memset+0x59>
    c &= 0xFF;
8010626c:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80106273:	8b 45 10             	mov    0x10(%ebp),%eax
80106276:	c1 e8 02             	shr    $0x2,%eax
80106279:	89 c2                	mov    %eax,%edx
8010627b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010627e:	89 c1                	mov    %eax,%ecx
80106280:	c1 e1 18             	shl    $0x18,%ecx
80106283:	8b 45 0c             	mov    0xc(%ebp),%eax
80106286:	c1 e0 10             	shl    $0x10,%eax
80106289:	09 c1                	or     %eax,%ecx
8010628b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010628e:	c1 e0 08             	shl    $0x8,%eax
80106291:	09 c8                	or     %ecx,%eax
80106293:	0b 45 0c             	or     0xc(%ebp),%eax
80106296:	89 54 24 08          	mov    %edx,0x8(%esp)
8010629a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010629e:	8b 45 08             	mov    0x8(%ebp),%eax
801062a1:	89 04 24             	mov    %eax,(%esp)
801062a4:	e8 84 ff ff ff       	call   8010622d <stosl>
801062a9:	eb 19                	jmp    801062c4 <memset+0x72>
  } else
    stosb(dst, c, n);
801062ab:	8b 45 10             	mov    0x10(%ebp),%eax
801062ae:	89 44 24 08          	mov    %eax,0x8(%esp)
801062b2:	8b 45 0c             	mov    0xc(%ebp),%eax
801062b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b9:	8b 45 08             	mov    0x8(%ebp),%eax
801062bc:	89 04 24             	mov    %eax,(%esp)
801062bf:	e8 44 ff ff ff       	call   80106208 <stosb>
  return dst;
...
801062d2:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
801062d5:	8b 45 0c             	mov    0xc(%ebp),%eax
801062d8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801062db:	eb 32                	jmp    8010630f <memcmp+0x46>
    if(*s1 != *s2)
801062dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
801062e0:	0f b6 10             	movzbl (%eax),%edx
801062e3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801062e6:	0f b6 00             	movzbl (%eax),%eax
801062e9:	38 c2                	cmp    %al,%dl
801062eb:	74 1a                	je     80106307 <memcmp+0x3e>
      return *s1 - *s2;
801062ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
801062f0:	0f b6 00             	movzbl (%eax),%eax
801062f3:	0f b6 d0             	movzbl %al,%edx
801062f6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801062f9:	0f b6 00             	movzbl (%eax),%eax
801062fc:	0f b6 c0             	movzbl %al,%eax
801062ff:	89 d1                	mov    %edx,%ecx
80106301:	29 c1                	sub    %eax,%ecx
80106303:	89 c8                	mov    %ecx,%eax
80106305:	eb 1c                	jmp    80106323 <memcmp+0x5a>
    s1++, s2++;
80106307:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010630b:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
8010630f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106313:	0f 95 c0             	setne  %al
80106316:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010631a:	84 c0                	test   %al,%al
8010631c:	75 bf                	jne    801062dd <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
8010632e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80106331:	8b 45 08             	mov    0x8(%ebp),%eax
80106334:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80106337:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010633a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010633d:	73 54                	jae    80106393 <memmove+0x6e>
8010633f:	8b 45 10             	mov    0x10(%ebp),%eax
80106342:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106345:	01 d0                	add    %edx,%eax
80106347:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010634a:	76 47                	jbe    80106393 <memmove+0x6e>
    s += n;
8010634c:	8b 45 10             	mov    0x10(%ebp),%eax
8010634f:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80106352:	8b 45 10             	mov    0x10(%ebp),%eax
80106355:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80106358:	eb 13                	jmp    8010636d <memmove+0x48>
      *--d = *--s;
8010635a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010635e:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80106362:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106365:	0f b6 10             	movzbl (%eax),%edx
80106368:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010636b:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
    d += n;
    while(n-- > 0)
8010636d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106371:	0f 95 c0             	setne  %al
80106374:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80106378:	84 c0                	test   %al,%al
8010637a:	75 de                	jne    8010635a <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010637c:	eb 25                	jmp    801063a3 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80106381:	0f b6 10             	movzbl (%eax),%edx
80106384:	8b 45 f8             	mov    -0x8(%ebp),%eax
80106387:	88 10                	mov    %dl,(%eax)
80106389:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010638d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80106391:	eb 01                	jmp    80106394 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80106393:	90                   	nop
80106394:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106398:	0f 95 c0             	setne  %al
8010639b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010639f:	84 c0                	test   %al,%al
801063a1:	75 db                	jne    8010637e <memmove+0x59>
      *d++ = *s++;
...
801063ae:	8b 45 10             	mov    0x10(%ebp),%eax
...
801063c2:	e8 5e ff ff ff       	call   80106325 <memmove>
}
801063c7:	c9                   	leave  
801063c8:	c3                   	ret    
...
801063ca:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801063cc:	eb 0c                	jmp    801063da <strncmp+0x11>
    n--, p++, q++;
801063ce:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801063d2:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801063d6:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801063de:	74 1a                	je     801063fa <strncmp+0x31>
801063e0:	8b 45 08             	mov    0x8(%ebp),%eax
801063e3:	0f b6 00             	movzbl (%eax),%eax
801063e6:	84 c0                	test   %al,%al
801063e8:	74 10                	je     801063fa <strncmp+0x31>
801063ea:	8b 45 08             	mov    0x8(%ebp),%eax
801063ed:	0f b6 10             	movzbl (%eax),%edx
801063f0:	8b 45 0c             	mov    0xc(%ebp),%eax
801063f3:	0f b6 00             	movzbl (%eax),%eax
801063f6:	38 c2                	cmp    %al,%dl
801063f8:	74 d4                	je     801063ce <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801063fa:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801063fe:	75 07                	jne    80106407 <strncmp+0x3e>
    return 0;
80106400:	b8 00 00 00 00       	mov    $0x0,%eax
80106405:	eb 18                	jmp    8010641f <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80106407:	8b 45 08             	mov    0x8(%ebp),%eax
8010640a:	0f b6 00             	movzbl (%eax),%eax
8010640d:	0f b6 d0             	movzbl %al,%edx
80106410:	8b 45 0c             	mov    0xc(%ebp),%eax
80106413:	0f b6 00             	movzbl (%eax),%eax
80106416:	0f b6 c0             	movzbl %al,%eax
80106419:	89 d1                	mov    %edx,%ecx
8010641b:	29 c1                	sub    %eax,%ecx
8010641d:	89 c8                	mov    %ecx,%eax
}
8010641f:	5d                   	pop    %ebp
80106420:	c3                   	ret    
...
8010642a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
8010642d:	90                   	nop
8010642e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106432:	0f 9f c0             	setg   %al
80106435:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80106439:	84 c0                	test   %al,%al
8010643b:	74 30                	je     8010646d <strncpy+0x4c>
8010643d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106440:	0f b6 10             	movzbl (%eax),%edx
80106443:	8b 45 08             	mov    0x8(%ebp),%eax
80106446:	88 10                	mov    %dl,(%eax)
80106448:	8b 45 08             	mov    0x8(%ebp),%eax
8010644b:	0f b6 00             	movzbl (%eax),%eax
8010644e:	84 c0                	test   %al,%al
80106450:	0f 95 c0             	setne  %al
80106453:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80106457:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010645b:	84 c0                	test   %al,%al
8010645d:	75 cf                	jne    8010642e <strncpy+0xd>
    ;
  while(n-- > 0)
8010645f:	eb 0c                	jmp    8010646d <strncpy+0x4c>
    *s++ = 0;
80106461:	8b 45 08             	mov    0x8(%ebp),%eax
80106464:	c6 00 00             	movb   $0x0,(%eax)
80106467:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010646b:	eb 01                	jmp    8010646e <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
8010646d:	90                   	nop
8010646e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106472:	0f 9f c0             	setg   %al
80106475:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80106479:	84 c0                	test   %al,%al
8010647b:	75 e4                	jne    80106461 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80106485:	83 ec 10             	sub    $0x10,%esp
  char *os;
  
  os = s;
80106488:	8b 45 08             	mov    0x8(%ebp),%eax
8010648b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
8010648e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80106492:	7f 05                	jg     80106499 <safestrcpy+0x17>
    return os;
80106494:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106497:	eb 35                	jmp    801064ce <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80106499:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010649d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801064a1:	7e 22                	jle    801064c5 <safestrcpy+0x43>
801064a3:	8b 45 0c             	mov    0xc(%ebp),%eax
801064a6:	0f b6 10             	movzbl (%eax),%edx
801064a9:	8b 45 08             	mov    0x8(%ebp),%eax
801064ac:	88 10                	mov    %dl,(%eax)
801064ae:	8b 45 08             	mov    0x8(%ebp),%eax
801064b1:	0f b6 00             	movzbl (%eax),%eax
801064b4:	84 c0                	test   %al,%al
801064b6:	0f 95 c0             	setne  %al
801064b9:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801064bd:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801064c1:	84 c0                	test   %al,%al
801064c3:	75 d4                	jne    80106499 <safestrcpy+0x17>
    ;
  *s = 0;
801064c5:	8b 45 08             	mov    0x8(%ebp),%eax
801064c8:	c6 00 00             	movb   $0x0,(%eax)
  return os;
801064cb:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801064ce:	c9                   	leave  
801064cf:	c3                   	ret    
...
801064d3:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
801064d6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801064dd:	eb 04                	jmp    801064e3 <strlen+0x13>
801064df:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801064e3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801064e6:	03 45 08             	add    0x8(%ebp),%eax
801064e9:	0f b6 00             	movzbl (%eax),%eax
801064ec:	84 c0                	test   %al,%al
801064ee:	75 ef                	jne    801064df <strlen+0xf>
    ;
  return n;
801064f0:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801064f3:	c9                   	leave  
801064f4:	c3                   	ret    
801064f5:	00 00                	add    %al,(%eax)
	...
...
swtch:
  movl 4(%esp), %eax
801064f8:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801064fc:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80106503:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80106504:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80106506:	89 d4                	mov    %edx,%esp
...
80106518:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010651b:	76 0f                	jbe    8010652c <fetchint+0x1c>
...
80106528:	39 c2                	cmp    %eax,%edx
8010652a:	76 07                	jbe    80106533 <fetchint+0x23>
    return -1;
8010652c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106531:	eb 0f                	jmp    80106542 <fetchint+0x32>
  *ip = *(int*)(addr);
80106533:	8b 45 0c             	mov    0xc(%ebp),%eax
80106536:	8b 10                	mov    (%eax),%edx
80106538:	8b 45 10             	mov    0x10(%ebp),%eax
8010653b:	89 10                	mov    %edx,(%eax)
  return 0;
...
80106547:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;

  if(addr >= p->sz)
8010654a:	8b 45 08             	mov    0x8(%ebp),%eax
8010654d:	8b 00                	mov    (%eax),%eax
8010654f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80106552:	77 07                	ja     8010655b <fetchstr+0x17>
    return -1;
80106554:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106559:	eb 45                	jmp    801065a0 <fetchstr+0x5c>
  *pp = (char*)addr;
8010655b:	8b 55 0c             	mov    0xc(%ebp),%edx
8010655e:	8b 45 10             	mov    0x10(%ebp),%eax
80106561:	89 10                	mov    %edx,(%eax)
  ep = (char*)p->sz;
80106563:	8b 45 08             	mov    0x8(%ebp),%eax
80106566:	8b 00                	mov    (%eax),%eax
80106568:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
8010656b:	8b 45 10             	mov    0x10(%ebp),%eax
8010656e:	8b 00                	mov    (%eax),%eax
80106570:	89 45 fc             	mov    %eax,-0x4(%ebp)
80106573:	eb 1e                	jmp    80106593 <fetchstr+0x4f>
    if(*s == 0)
80106575:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106578:	0f b6 00             	movzbl (%eax),%eax
8010657b:	84 c0                	test   %al,%al
8010657d:	75 10                	jne    8010658f <fetchstr+0x4b>
      return s - *pp;
8010657f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80106582:	8b 45 10             	mov    0x10(%ebp),%eax
80106585:	8b 00                	mov    (%eax),%eax
80106587:	89 d1                	mov    %edx,%ecx
80106589:	29 c1                	sub    %eax,%ecx
8010658b:	89 c8                	mov    %ecx,%eax
8010658d:	eb 11                	jmp    801065a0 <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
8010658f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80106593:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106596:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80106599:	72 da                	jb     80106575 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801065ae:	8b 40 18             	mov    0x18(%eax),%eax
801065b1:	8b 50 44             	mov    0x44(%eax),%edx
801065b4:	8b 45 08             	mov    0x8(%ebp),%eax
801065b7:	c1 e0 02             	shl    $0x2,%eax
801065ba:	01 d0                	add    %edx,%eax
801065bc:	8d 48 04             	lea    0x4(%eax),%ecx
801065bf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065c5:	8b 55 0c             	mov    0xc(%ebp),%edx
801065c8:	89 54 24 08          	mov    %edx,0x8(%esp)
801065cc:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801065d0:	89 04 24             	mov    %eax,(%esp)
801065d3:	e8 38 ff ff ff       	call   80106510 <fetchint>
}
801065d8:	c9                   	leave  
801065d9:	c3                   	ret    
...
801065dd:	83 ec 18             	sub    $0x18,%esp
  int i;
  
  if(argint(n, &i) < 0)
801065e0:	8d 45 fc             	lea    -0x4(%ebp),%eax
801065e3:	89 44 24 04          	mov    %eax,0x4(%esp)
801065e7:	8b 45 08             	mov    0x8(%ebp),%eax
801065ea:	89 04 24             	mov    %eax,(%esp)
801065ed:	e8 b0 ff ff ff       	call   801065a2 <argint>
801065f2:	85 c0                	test   %eax,%eax
801065f4:	79 07                	jns    801065fd <argptr+0x23>
    return -1;
801065f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065fb:	eb 3d                	jmp    8010663a <argptr+0x60>
...
8010660a:	39 c2                	cmp    %eax,%edx
8010660c:	73 16                	jae    80106624 <argptr+0x4a>
8010660e:	8b 45 fc             	mov    -0x4(%ebp),%eax
...
80106622:	76 07                	jbe    8010662b <argptr+0x51>
    return -1;
80106624:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106629:	eb 0f                	jmp    8010663a <argptr+0x60>
  *pp = (char*)i;
8010662b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010662e:	89 c2                	mov    %eax,%edx
80106630:	8b 45 0c             	mov    0xc(%ebp),%eax
80106633:	89 10                	mov    %edx,(%eax)
  return 0;
...
8010663f:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
80106642:	8d 45 fc             	lea    -0x4(%ebp),%eax
80106645:	89 44 24 04          	mov    %eax,0x4(%esp)
80106649:	8b 45 08             	mov    0x8(%ebp),%eax
8010664c:	89 04 24             	mov    %eax,(%esp)
8010664f:	e8 4e ff ff ff       	call   801065a2 <argint>
80106654:	85 c0                	test   %eax,%eax
80106656:	79 07                	jns    8010665f <argstr+0x23>
    return -1;
80106658:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010665d:	eb 1e                	jmp    8010667d <argstr+0x41>
  return fetchstr(proc, addr, pp);
8010665f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106662:	89 c2                	mov    %eax,%edx
80106664:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010666a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010666d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106671:	89 54 24 04          	mov    %edx,0x4(%esp)
80106675:	89 04 24             	mov    %eax,(%esp)
80106678:	e8 c7 fe ff ff       	call   80106544 <fetchstr>
}
8010667d:	c9                   	leave  
8010667e:	c3                   	ret    
...
80106683:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80106686:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010668c:	8b 40 18             	mov    0x18(%eax),%eax
8010668f:	8b 40 1c             	mov    0x1c(%eax),%eax
80106692:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80106695:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106699:	78 2e                	js     801066c9 <syscall+0x4a>
8010669b:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
8010669f:	7f 28                	jg     801066c9 <syscall+0x4a>
801066a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a4:	8b 04 85 80 d0 10 80 	mov    -0x7fef2f80(,%eax,4),%eax
801066ab:	85 c0                	test   %eax,%eax
801066ad:	74 1a                	je     801066c9 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
801066af:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066b5:	8b 58 18             	mov    0x18(%eax),%ebx
801066b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066bb:	8b 04 85 80 d0 10 80 	mov    -0x7fef2f80(,%eax,4),%eax
801066c2:	ff d0                	call   *%eax
801066c4:	89 43 1c             	mov    %eax,0x1c(%ebx)
801066c7:	eb 73                	jmp    8010673c <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
801066c9:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
801066cd:	7e 30                	jle    801066ff <syscall+0x80>
801066cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d2:	83 f8 1d             	cmp    $0x1d,%eax
801066d5:	77 28                	ja     801066ff <syscall+0x80>
801066d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066da:	8b 04 85 80 d0 10 80 	mov    -0x7fef2f80(,%eax,4),%eax
801066e1:	85 c0                	test   %eax,%eax
801066e3:	74 1a                	je     801066ff <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801066e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066eb:	8b 58 18             	mov    0x18(%eax),%ebx
801066ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f1:	8b 04 85 80 d0 10 80 	mov    -0x7fef2f80(,%eax,4),%eax
801066f8:	ff d0                	call   *%eax
801066fa:	89 43 1c             	mov    %eax,0x1c(%ebx)
801066fd:	eb 3d                	jmp    8010673c <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801066ff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106705:	8d 48 6c             	lea    0x6c(%eax),%ecx
80106708:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
8010670e:	8b 40 10             	mov    0x10(%eax),%eax
80106711:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106714:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106718:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010671c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106720:	c7 04 24 85 9d 10 80 	movl   $0x80109d85,(%esp)
80106727:	e8 75 9c ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
8010672c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106732:	8b 40 18             	mov    0x18(%eax),%eax
80106735:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
8010673c:	83 c4 24             	add    $0x24,%esp
8010673f:	5b                   	pop    %ebx
80106740:	5d                   	pop    %ebp
80106741:	c3                   	ret    
	...
...
80106757:	e8 46 fe ff ff       	call   801065a2 <argint>
8010675c:	85 c0                	test   %eax,%eax
8010675e:	79 07                	jns    80106767 <argfd+0x23>
    return -1;
80106760:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106765:	eb 50                	jmp    801067b7 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80106767:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010676a:	85 c0                	test   %eax,%eax
8010676c:	78 21                	js     8010678f <argfd+0x4b>
8010676e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106771:	83 f8 0f             	cmp    $0xf,%eax
80106774:	7f 19                	jg     8010678f <argfd+0x4b>
80106776:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010677c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010677f:	83 c2 08             	add    $0x8,%edx
80106782:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80106786:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106789:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010678d:	75 07                	jne    80106796 <argfd+0x52>
    return -1;
8010678f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106794:	eb 21                	jmp    801067b7 <argfd+0x73>
  if(pfd)
80106796:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010679a:	74 08                	je     801067a4 <argfd+0x60>
    *pfd = fd;
8010679c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010679f:	8b 45 0c             	mov    0xc(%ebp),%eax
801067a2:	89 10                	mov    %edx,(%eax)
  if(pf)
801067a4:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801067a8:	74 08                	je     801067b2 <argfd+0x6e>
    *pf = f;
801067aa:	8b 45 10             	mov    0x10(%ebp),%eax
801067ad:	8b 55 f4             	mov    -0xc(%ebp),%edx
801067b0:	89 10                	mov    %edx,(%eax)
  return 0;
...
801067bc:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801067bf:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801067c6:	eb 30                	jmp    801067f8 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801067c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067ce:	8b 55 fc             	mov    -0x4(%ebp),%edx
801067d1:	83 c2 08             	add    $0x8,%edx
801067d4:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801067d8:	85 c0                	test   %eax,%eax
801067da:	75 18                	jne    801067f4 <fdalloc+0x3b>
      proc->ofile[fd] = f;
801067dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067e2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801067e5:	8d 4a 08             	lea    0x8(%edx),%ecx
801067e8:	8b 55 08             	mov    0x8(%ebp),%edx
801067eb:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801067ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
801067f2:	eb 0f                	jmp    80106803 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801067f4:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801067f8:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801067fc:	7e ca                	jle    801067c8 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80106808:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, 0, &f) < 0)
8010680b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010680e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106812:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106819:	00 
8010681a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106821:	e8 1e ff ff ff       	call   80106744 <argfd>
80106826:	85 c0                	test   %eax,%eax
80106828:	79 07                	jns    80106831 <sys_dup+0x2c>
    return -1;
8010682a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010682f:	eb 29                	jmp    8010685a <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80106831:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106834:	89 04 24             	mov    %eax,(%esp)
80106837:	e8 7d ff ff ff       	call   801067b9 <fdalloc>
8010683c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010683f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106843:	79 07                	jns    8010684c <sys_dup+0x47>
    return -1;
80106845:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010684a:	eb 0e                	jmp    8010685a <sys_dup+0x55>
  filedup(f);
8010684c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010684f:	89 04 24             	mov    %eax,(%esp)
80106852:	e8 25 a7 ff ff       	call   80100f7c <filedup>
  return fd;
...
80106865:	89 44 24 08          	mov    %eax,0x8(%esp)
80106869:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106870:	00 
80106871:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106878:	e8 c7 fe ff ff       	call   80106744 <argfd>
8010687d:	85 c0                	test   %eax,%eax
8010687f:	78 35                	js     801068b6 <sys_read+0x5a>
80106881:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106884:	89 44 24 04          	mov    %eax,0x4(%esp)
80106888:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010688f:	e8 0e fd ff ff       	call   801065a2 <argint>
80106894:	85 c0                	test   %eax,%eax
80106896:	78 1e                	js     801068b6 <sys_read+0x5a>
80106898:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010689b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010689f:	8d 45 ec             	lea    -0x14(%ebp),%eax
801068a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801068a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801068ad:	e8 28 fd ff ff       	call   801065da <argptr>
801068b2:	85 c0                	test   %eax,%eax
801068b4:	79 07                	jns    801068bd <sys_read+0x61>
    return -1;
801068b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068bb:	eb 19                	jmp    801068d6 <sys_read+0x7a>
  return fileread(f, p, n);
801068bd:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801068c0:	8b 55 ec             	mov    -0x14(%ebp),%edx
801068c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068c6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801068ca:	89 54 24 04          	mov    %edx,0x4(%esp)
801068ce:	89 04 24             	mov    %eax,(%esp)
801068d1:	e8 13 a8 ff ff       	call   801010e9 <fileread>
}
801068d6:	c9                   	leave  
801068d7:	c3                   	ret    
...
801068e1:	89 44 24 08          	mov    %eax,0x8(%esp)
801068e5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068ec:	00 
801068ed:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068f4:	e8 4b fe ff ff       	call   80106744 <argfd>
801068f9:	85 c0                	test   %eax,%eax
801068fb:	78 35                	js     80106932 <sys_write+0x5a>
801068fd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106900:	89 44 24 04          	mov    %eax,0x4(%esp)
80106904:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010690b:	e8 92 fc ff ff       	call   801065a2 <argint>
80106910:	85 c0                	test   %eax,%eax
80106912:	78 1e                	js     80106932 <sys_write+0x5a>
80106914:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106917:	89 44 24 08          	mov    %eax,0x8(%esp)
8010691b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010691e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106922:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106929:	e8 ac fc ff ff       	call   801065da <argptr>
8010692e:	85 c0                	test   %eax,%eax
80106930:	79 07                	jns    80106939 <sys_write+0x61>
    return -1;
80106932:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106937:	eb 19                	jmp    80106952 <sys_write+0x7a>
  return filewrite(f, p, n);
80106939:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010693c:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010693f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106942:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106946:	89 54 24 04          	mov    %edx,0x4(%esp)
8010694a:	89 04 24             	mov    %eax,(%esp)
8010694d:	e8 53 a8 ff ff       	call   801011a5 <filewrite>
}
80106952:	c9                   	leave  
80106953:	c3                   	ret    
...
80106957:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
8010695a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010695d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106961:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106964:	89 44 24 04          	mov    %eax,0x4(%esp)
80106968:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010696f:	e8 d0 fd ff ff       	call   80106744 <argfd>
80106974:	85 c0                	test   %eax,%eax
80106976:	79 07                	jns    8010697f <sys_close+0x2b>
    return -1;
80106978:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010697d:	eb 24                	jmp    801069a3 <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010697f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106985:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106988:	83 c2 08             	add    $0x8,%edx
8010698b:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106992:	00 
  fileclose(f);
80106993:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106996:	89 04 24             	mov    %eax,(%esp)
80106999:	e8 26 a6 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
801069ae:	89 44 24 08          	mov    %eax,0x8(%esp)
801069b2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069b9:	00 
801069ba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069c1:	e8 7e fd ff ff       	call   80106744 <argfd>
801069c6:	85 c0                	test   %eax,%eax
801069c8:	78 1f                	js     801069e9 <sys_fstat+0x44>
801069ca:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801069d1:	00 
801069d2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069e0:	e8 f5 fb ff ff       	call   801065da <argptr>
801069e5:	85 c0                	test   %eax,%eax
801069e7:	79 07                	jns    801069f0 <sys_fstat+0x4b>
    return -1;
801069e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ee:	eb 12                	jmp    80106a02 <sys_fstat+0x5d>
...
801069fd:	e8 98 a6 ff ff       	call   8010109a <filestat>
}
80106a02:	c9                   	leave  
80106a03:	c3                   	ret    
...
80106a07:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80106a0a:	8d 45 d8             	lea    -0x28(%ebp),%eax
80106a0d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a11:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a18:	e8 1f fc ff ff       	call   8010663c <argstr>
80106a1d:	85 c0                	test   %eax,%eax
80106a1f:	78 17                	js     80106a38 <sys_link+0x34>
80106a21:	8d 45 dc             	lea    -0x24(%ebp),%eax
80106a24:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a2f:	e8 08 fc ff ff       	call   8010663c <argstr>
80106a34:	85 c0                	test   %eax,%eax
80106a36:	79 0a                	jns    80106a42 <sys_link+0x3e>
    return -1;
80106a38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a3d:	e9 3c 01 00 00       	jmp    80106b7e <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80106a42:	8b 45 d8             	mov    -0x28(%ebp),%eax
80106a45:	89 04 24             	mov    %eax,(%esp)
80106a48:	e8 bd b9 ff ff       	call   8010240a <namei>
80106a4d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106a50:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106a54:	75 0a                	jne    80106a60 <sys_link+0x5c>
    return -1;
80106a56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a5b:	e9 1e 01 00 00       	jmp    80106b7e <sys_link+0x17a>

  begin_trans();
80106a60:	e8 b8 c7 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80106a65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a68:	89 04 24             	mov    %eax,(%esp)
80106a6b:	e8 f8 ad ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80106a70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a73:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106a77:	66 83 f8 01          	cmp    $0x1,%ax
80106a7b:	75 1a                	jne    80106a97 <sys_link+0x93>
    iunlockput(ip);
80106a7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a80:	89 04 24             	mov    %eax,(%esp)
80106a83:	e8 64 b0 ff ff       	call   80101aec <iunlockput>
    commit_trans();
80106a88:	e8 b3 c7 ff ff       	call   80103240 <commit_trans>
    return -1;
80106a8d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a92:	e9 e7 00 00 00       	jmp    80106b7e <sys_link+0x17a>
  }
...
80106aae:	e8 f9 ab ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80106ab3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ab6:	89 04 24             	mov    %eax,(%esp)
80106ab9:	e8 f8 ae ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80106abe:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106ac1:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80106ac4:	89 54 24 04          	mov    %edx,0x4(%esp)
80106ac8:	89 04 24             	mov    %eax,(%esp)
80106acb:	e8 5c b9 ff ff       	call   8010242c <nameiparent>
80106ad0:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106ad3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106ad7:	74 68                	je     80106b41 <sys_link+0x13d>
    goto bad;
  ilock(dp);
80106ad9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106adc:	89 04 24             	mov    %eax,(%esp)
80106adf:	e8 84 ad ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80106ae4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ae7:	8b 10                	mov    (%eax),%edx
80106ae9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aec:	8b 00                	mov    (%eax),%eax
80106aee:	39 c2                	cmp    %eax,%edx
80106af0:	75 20                	jne    80106b12 <sys_link+0x10e>
80106af2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106af5:	8b 40 04             	mov    0x4(%eax),%eax
80106af8:	89 44 24 08          	mov    %eax,0x8(%esp)
80106afc:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80106aff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b03:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b06:	89 04 24             	mov    %eax,(%esp)
80106b09:	e8 3b b6 ff ff       	call   80102149 <dirlink>
80106b0e:	85 c0                	test   %eax,%eax
80106b10:	79 0d                	jns    80106b1f <sys_link+0x11b>
    iunlockput(dp);
80106b12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b15:	89 04 24             	mov    %eax,(%esp)
80106b18:	e8 cf af ff ff       	call   80101aec <iunlockput>
    goto bad;
80106b1d:	eb 23                	jmp    80106b42 <sys_link+0x13e>
  }
  iunlockput(dp);
80106b1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b22:	89 04 24             	mov    %eax,(%esp)
80106b25:	e8 c2 af ff ff       	call   80101aec <iunlockput>
  iput(ip);
80106b2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b2d:	89 04 24             	mov    %eax,(%esp)
80106b30:	e8 e6 ae ff ff       	call   80101a1b <iput>

  commit_trans();
80106b35:	e8 06 c7 ff ff       	call   80103240 <commit_trans>

  return 0;
80106b3a:	b8 00 00 00 00       	mov    $0x0,%eax
80106b3f:	eb 3d                	jmp    80106b7e <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80106b45:	89 04 24             	mov    %eax,(%esp)
80106b48:	e8 1b ad ff ff       	call   80101868 <ilock>
  ip->nlink--;
80106b4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b50:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106b54:	8d 50 ff             	lea    -0x1(%eax),%edx
80106b57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b5a:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106b5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b61:	89 04 24             	mov    %eax,(%esp)
80106b64:	e8 43 ab ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106b69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b6c:	89 04 24             	mov    %eax,(%esp)
80106b6f:	e8 78 af ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106b74:	e8 c7 c6 ff ff       	call   80103240 <commit_trans>
  return -1;
...
80106b83:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80106b86:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106b8d:	eb 4b                	jmp    80106bda <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106b8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b92:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106b99:	00 
80106b9a:	89 44 24 08          	mov    %eax,0x8(%esp)
80106b9e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106ba1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ba5:	8b 45 08             	mov    0x8(%ebp),%eax
80106ba8:	89 04 24             	mov    %eax,(%esp)
80106bab:	e8 ae b1 ff ff       	call   80101d5e <readi>
80106bb0:	83 f8 10             	cmp    $0x10,%eax
80106bb3:	74 0c                	je     80106bc1 <isdirempty+0x41>
      panic("isdirempty: readi");
80106bb5:	c7 04 24 a1 9d 10 80 	movl   $0x80109da1,(%esp)
80106bbc:	e8 7c 99 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80106bc1:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80106bc5:	66 85 c0             	test   %ax,%ax
80106bc8:	74 07                	je     80106bd1 <isdirempty+0x51>
      return 0;
80106bca:	b8 00 00 00 00       	mov    $0x0,%eax
80106bcf:	eb 1b                	jmp    80106bec <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80106bd4:	83 c0 10             	add    $0x10,%eax
80106bd7:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106bda:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106bdd:	8b 45 08             	mov    0x8(%ebp),%eax
80106be0:	8b 40 18             	mov    0x18(%eax),%eax
80106be3:	39 c2                	cmp    %eax,%edx
80106be5:	72 a8                	jb     80106b8f <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80106be7:	b8 01 00 00 00       	mov    $0x1,%eax
}
80106bec:	c9                   	leave  
80106bed:	c3                   	ret    
...
80106bf1:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80106bf4:	8d 45 cc             	lea    -0x34(%ebp),%eax
80106bf7:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bfb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c02:	e8 35 fa ff ff       	call   8010663c <argstr>
80106c07:	85 c0                	test   %eax,%eax
80106c09:	79 0a                	jns    80106c15 <sys_unlink+0x27>
    return -1;
80106c0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c10:	e9 aa 01 00 00       	jmp    80106dbf <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80106c15:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106c18:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106c1b:	89 54 24 04          	mov    %edx,0x4(%esp)
80106c1f:	89 04 24             	mov    %eax,(%esp)
80106c22:	e8 05 b8 ff ff       	call   8010242c <nameiparent>
80106c27:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106c2a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106c2e:	75 0a                	jne    80106c3a <sys_unlink+0x4c>
    return -1;
80106c30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c35:	e9 85 01 00 00       	jmp    80106dbf <sys_unlink+0x1d1>

  begin_trans();
80106c3a:	e8 de c5 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
80106c3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c42:	89 04 24             	mov    %eax,(%esp)
80106c45:	e8 1e ac ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106c4a:	c7 44 24 04 b3 9d 10 	movl   $0x80109db3,0x4(%esp)
80106c51:	80 
80106c52:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106c55:	89 04 24             	mov    %eax,(%esp)
80106c58:	e8 02 b4 ff ff       	call   8010205f <namecmp>
80106c5d:	85 c0                	test   %eax,%eax
80106c5f:	0f 84 45 01 00 00    	je     80106daa <sys_unlink+0x1bc>
80106c65:	c7 44 24 04 b5 9d 10 	movl   $0x80109db5,0x4(%esp)
80106c6c:	80 
80106c6d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106c70:	89 04 24             	mov    %eax,(%esp)
80106c73:	e8 e7 b3 ff ff       	call   8010205f <namecmp>
80106c78:	85 c0                	test   %eax,%eax
80106c7a:	0f 84 2a 01 00 00    	je     80106daa <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106c80:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106c83:	89 44 24 08          	mov    %eax,0x8(%esp)
80106c87:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106c8a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c91:	89 04 24             	mov    %eax,(%esp)
80106c94:	e8 e8 b3 ff ff       	call   80102081 <dirlookup>
80106c99:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106c9c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106ca0:	0f 84 03 01 00 00    	je     80106da9 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80106ca6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ca9:	89 04 24             	mov    %eax,(%esp)
80106cac:	e8 b7 ab ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80106cb1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cb4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106cb8:	66 85 c0             	test   %ax,%ax
80106cbb:	7f 0c                	jg     80106cc9 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80106cbd:	c7 04 24 b8 9d 10 80 	movl   $0x80109db8,(%esp)
80106cc4:	e8 74 98 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106cc9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ccc:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106cd0:	66 83 f8 01          	cmp    $0x1,%ax
80106cd4:	75 1f                	jne    80106cf5 <sys_unlink+0x107>
80106cd6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cd9:	89 04 24             	mov    %eax,(%esp)
80106cdc:	e8 9f fe ff ff       	call   80106b80 <isdirempty>
80106ce1:	85 c0                	test   %eax,%eax
80106ce3:	75 10                	jne    80106cf5 <sys_unlink+0x107>
    iunlockput(ip);
80106ce5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ce8:	89 04 24             	mov    %eax,(%esp)
80106ceb:	e8 fc ad ff ff       	call   80101aec <iunlockput>
    goto bad;
80106cf0:	e9 b5 00 00 00       	jmp    80106daa <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80106cf5:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80106cfc:	00 
80106cfd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d04:	00 
80106d05:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106d08:	89 04 24             	mov    %eax,(%esp)
80106d0b:	e8 42 f5 ff ff       	call   80106252 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106d10:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106d13:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106d1a:	00 
80106d1b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106d1f:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106d22:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d29:	89 04 24             	mov    %eax,(%esp)
80106d2c:	e8 98 b1 ff ff       	call   80101ec9 <writei>
80106d31:	83 f8 10             	cmp    $0x10,%eax
80106d34:	74 0c                	je     80106d42 <sys_unlink+0x154>
    panic("unlink: writei");
80106d36:	c7 04 24 ca 9d 10 80 	movl   $0x80109dca,(%esp)
80106d3d:	e8 fb 97 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106d42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d45:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106d49:	66 83 f8 01          	cmp    $0x1,%ax
80106d4d:	75 1c                	jne    80106d6b <sys_unlink+0x17d>
    dp->nlink--;
80106d4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d52:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106d56:	8d 50 ff             	lea    -0x1(%eax),%edx
80106d59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d5c:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106d60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d63:	89 04 24             	mov    %eax,(%esp)
80106d66:	e8 41 a9 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80106d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d6e:	89 04 24             	mov    %eax,(%esp)
80106d71:	e8 76 ad ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
80106d76:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d79:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106d7d:	8d 50 ff             	lea    -0x1(%eax),%edx
80106d80:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d83:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106d87:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d8a:	89 04 24             	mov    %eax,(%esp)
80106d8d:	e8 1a a9 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106d92:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d95:	89 04 24             	mov    %eax,(%esp)
80106d98:	e8 4f ad ff ff       	call   80101aec <iunlockput>

  commit_trans();
80106d9d:	e8 9e c4 ff ff       	call   80103240 <commit_trans>

  return 0;
80106da2:	b8 00 00 00 00       	mov    $0x0,%eax
80106da7:	eb 16                	jmp    80106dbf <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106db0:	e8 37 ad ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106db5:	e8 86 c4 ff ff       	call   80103240 <commit_trans>
  return -1;
...
80106dc4:	83 ec 48             	sub    $0x48,%esp
80106dc7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106dca:	8b 55 10             	mov    0x10(%ebp),%edx
80106dcd:	8b 45 14             	mov    0x14(%ebp),%eax
80106dd0:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106dd4:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106dd8:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80106de9:	e8 3e b6 ff ff       	call   8010242c <nameiparent>
80106dee:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106df1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106df5:	75 0a                	jne    80106e01 <create+0x40>
    return 0;
80106df7:	b8 00 00 00 00       	mov    $0x0,%eax
80106dfc:	e9 7e 01 00 00       	jmp    80106f7f <create+0x1be>
  ilock(dp);
80106e01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e04:	89 04 24             	mov    %eax,(%esp)
80106e07:	e8 5c aa ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80106e0c:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106e0f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106e13:	8d 45 de             	lea    -0x22(%ebp),%eax
80106e16:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e1d:	89 04 24             	mov    %eax,(%esp)
80106e20:	e8 5c b2 ff ff       	call   80102081 <dirlookup>
80106e25:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106e28:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106e2c:	74 47                	je     80106e75 <create+0xb4>
    iunlockput(dp);
80106e2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e31:	89 04 24             	mov    %eax,(%esp)
80106e34:	e8 b3 ac ff ff       	call   80101aec <iunlockput>
    ilock(ip);
80106e39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e3c:	89 04 24             	mov    %eax,(%esp)
80106e3f:	e8 24 aa ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106e44:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106e49:	75 15                	jne    80106e60 <create+0x9f>
80106e4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e4e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106e52:	66 83 f8 02          	cmp    $0x2,%ax
80106e56:	75 08                	jne    80106e60 <create+0x9f>
      return ip;
80106e58:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e5b:	e9 1f 01 00 00       	jmp    80106f7f <create+0x1be>
    iunlockput(ip);
80106e60:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e63:	89 04 24             	mov    %eax,(%esp)
80106e66:	e8 81 ac ff ff       	call   80101aec <iunlockput>
    return 0;
80106e6b:	b8 00 00 00 00       	mov    $0x0,%eax
80106e70:	e9 0a 01 00 00       	jmp    80106f7f <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106e75:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80106e85:	e8 45 a7 ff ff       	call   801015cf <ialloc>
80106e8a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106e8d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106e91:	75 0c                	jne    80106e9f <create+0xde>
    panic("create: ialloc");
80106e93:	c7 04 24 d9 9d 10 80 	movl   $0x80109dd9,(%esp)
80106e9a:	e8 9e 96 ff ff       	call   8010053d <panic>

  ilock(ip);
80106e9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ea2:	89 04 24             	mov    %eax,(%esp)
80106ea5:	e8 be a9 ff ff       	call   80101868 <ilock>
  ip->major = major;
80106eaa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ead:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106eb1:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106eb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106eb8:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106ebc:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106ec0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ec3:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106ec9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ecc:	89 04 24             	mov    %eax,(%esp)
80106ecf:	e8 d8 a7 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106ed4:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106ed9:	75 6a                	jne    80106f45 <create+0x184>
    dp->nlink++;  // for ".."
80106edb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ede:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106ee2:	8d 50 01             	lea    0x1(%eax),%edx
80106ee5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ee8:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106eec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eef:	89 04 24             	mov    %eax,(%esp)
80106ef2:	e8 b5 a7 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106ef7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106efa:	8b 40 04             	mov    0x4(%eax),%eax
80106efd:	89 44 24 08          	mov    %eax,0x8(%esp)
80106f01:	c7 44 24 04 b3 9d 10 	movl   $0x80109db3,0x4(%esp)
80106f08:	80 
80106f09:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106f0c:	89 04 24             	mov    %eax,(%esp)
80106f0f:	e8 35 b2 ff ff       	call   80102149 <dirlink>
80106f14:	85 c0                	test   %eax,%eax
80106f16:	78 21                	js     80106f39 <create+0x178>
80106f18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f1b:	8b 40 04             	mov    0x4(%eax),%eax
80106f1e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106f22:	c7 44 24 04 b5 9d 10 	movl   $0x80109db5,0x4(%esp)
80106f29:	80 
80106f2a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106f2d:	89 04 24             	mov    %eax,(%esp)
80106f30:	e8 14 b2 ff ff       	call   80102149 <dirlink>
80106f35:	85 c0                	test   %eax,%eax
80106f37:	79 0c                	jns    80106f45 <create+0x184>
      panic("create dots");
80106f39:	c7 04 24 e8 9d 10 80 	movl   $0x80109de8,(%esp)
80106f40:	e8 f8 95 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106f45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106f48:	8b 40 04             	mov    0x4(%eax),%eax
80106f4b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106f4f:	8d 45 de             	lea    -0x22(%ebp),%eax
80106f52:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f59:	89 04 24             	mov    %eax,(%esp)
80106f5c:	e8 e8 b1 ff ff       	call   80102149 <dirlink>
80106f61:	85 c0                	test   %eax,%eax
80106f63:	79 0c                	jns    80106f71 <create+0x1b0>
    panic("create: dirlink");
80106f65:	c7 04 24 f4 9d 10 80 	movl   $0x80109df4,(%esp)
80106f6c:	e8 cc 95 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106f71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f74:	89 04 24             	mov    %eax,(%esp)
80106f77:	e8 70 ab ff ff       	call   80101aec <iunlockput>
...
80106f84:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106f87:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106f8a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f8e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106f95:	e8 a2 f6 ff ff       	call   8010663c <argstr>
80106f9a:	85 c0                	test   %eax,%eax
80106f9c:	78 17                	js     80106fb5 <sys_open+0x34>
80106f9e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106fa1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106fa5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106fac:	e8 f1 f5 ff ff       	call   801065a2 <argint>
80106fb1:	85 c0                	test   %eax,%eax
80106fb3:	79 0a                	jns    80106fbf <sys_open+0x3e>
    return -1;
80106fb5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106fba:	e9 46 01 00 00       	jmp    80107105 <sys_open+0x184>
  if(omode & O_CREATE){
80106fbf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fc2:	25 00 02 00 00       	and    $0x200,%eax
80106fc7:	85 c0                	test   %eax,%eax
80106fc9:	74 40                	je     8010700b <sys_open+0x8a>
    begin_trans();
80106fcb:	e8 4d c2 ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106fd0:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106fd3:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106fda:	00 
80106fdb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106fe2:	00 
80106fe3:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106fea:	00 
80106feb:	89 04 24             	mov    %eax,(%esp)
80106fee:	e8 ce fd ff ff       	call   80106dc1 <create>
80106ff3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80106ff6:	e8 45 c2 ff ff       	call   80103240 <commit_trans>
    if(ip == 0)
80106ffb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106fff:	75 5c                	jne    8010705d <sys_open+0xdc>
      return -1;
80107001:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107006:	e9 fa 00 00 00       	jmp    80107105 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
8010700b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010700e:	89 04 24             	mov    %eax,(%esp)
80107011:	e8 f4 b3 ff ff       	call   8010240a <namei>
80107016:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107019:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010701d:	75 0a                	jne    80107029 <sys_open+0xa8>
      return -1;
8010701f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107024:	e9 dc 00 00 00       	jmp    80107105 <sys_open+0x184>
    ilock(ip);
80107029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010702c:	89 04 24             	mov    %eax,(%esp)
8010702f:	e8 34 a8 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80107034:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107037:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010703b:	66 83 f8 01          	cmp    $0x1,%ax
8010703f:	75 1c                	jne    8010705d <sys_open+0xdc>
80107041:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107044:	85 c0                	test   %eax,%eax
80107046:	74 15                	je     8010705d <sys_open+0xdc>
      iunlockput(ip);
80107048:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010704b:	89 04 24             	mov    %eax,(%esp)
8010704e:	e8 99 aa ff ff       	call   80101aec <iunlockput>
      return -1;
80107053:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107058:	e9 a8 00 00 00       	jmp    80107105 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010705d:	e8 ba 9e ff ff       	call   80100f1c <filealloc>
80107062:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107065:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107069:	74 14                	je     8010707f <sys_open+0xfe>
8010706b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010706e:	89 04 24             	mov    %eax,(%esp)
80107071:	e8 43 f7 ff ff       	call   801067b9 <fdalloc>
80107076:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107079:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010707d:	79 23                	jns    801070a2 <sys_open+0x121>
    if(f)
8010707f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107083:	74 0b                	je     80107090 <sys_open+0x10f>
      fileclose(f);
80107085:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107088:	89 04 24             	mov    %eax,(%esp)
8010708b:	e8 34 9f ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
80107090:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107093:	89 04 24             	mov    %eax,(%esp)
80107096:	e8 51 aa ff ff       	call   80101aec <iunlockput>
    return -1;
8010709b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070a0:	eb 63                	jmp    80107105 <sys_open+0x184>
  }
  iunlock(ip);
801070a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801070a5:	89 04 24             	mov    %eax,(%esp)
801070a8:	e8 09 a9 ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
801070ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070b0:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801070b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070b9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801070bc:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
801070bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070c2:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
801070c9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801070cc:	83 e0 01             	and    $0x1,%eax
801070cf:	85 c0                	test   %eax,%eax
801070d1:	0f 94 c2             	sete   %dl
801070d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070d7:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801070da:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801070dd:	83 e0 01             	and    $0x1,%eax
801070e0:	84 c0                	test   %al,%al
801070e2:	75 0a                	jne    801070ee <sys_open+0x16d>
801070e4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801070e7:	83 e0 02             	and    $0x2,%eax
801070ea:	85 c0                	test   %eax,%eax
801070ec:	74 07                	je     801070f5 <sys_open+0x174>
801070ee:	b8 01 00 00 00       	mov    $0x1,%eax
801070f3:	eb 05                	jmp    801070fa <sys_open+0x179>
801070f5:	b8 00 00 00 00       	mov    $0x0,%eax
801070fa:	89 c2                	mov    %eax,%edx
801070fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801070ff:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80107102:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80107105:	c9                   	leave  
80107106:	c3                   	ret    
...
8010710a:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
8010710d:	e8 0b c1 ff ff       	call   8010321d <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80107112:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107115:	89 44 24 04          	mov    %eax,0x4(%esp)
80107119:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107120:	e8 17 f5 ff ff       	call   8010663c <argstr>
80107125:	85 c0                	test   %eax,%eax
80107127:	78 2c                	js     80107155 <sys_mkdir+0x4e>
80107129:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010712c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80107133:	00 
80107134:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010713b:	00 
8010713c:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107143:	00 
80107144:	89 04 24             	mov    %eax,(%esp)
80107147:	e8 75 fc ff ff       	call   80106dc1 <create>
8010714c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010714f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107153:	75 0c                	jne    80107161 <sys_mkdir+0x5a>
    commit_trans();
80107155:	e8 e6 c0 ff ff       	call   80103240 <commit_trans>
    return -1;
8010715a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010715f:	eb 15                	jmp    80107176 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80107161:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107164:	89 04 24             	mov    %eax,(%esp)
80107167:	e8 80 a9 ff ff       	call   80101aec <iunlockput>
  commit_trans();
8010716c:	e8 cf c0 ff ff       	call   80103240 <commit_trans>
  return 0;
...
8010717b:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
8010717e:	e8 9a c0 ff ff       	call   8010321d <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80107183:	8d 45 ec             	lea    -0x14(%ebp),%eax
80107186:	89 44 24 04          	mov    %eax,0x4(%esp)
8010718a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107191:	e8 a6 f4 ff ff       	call   8010663c <argstr>
80107196:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107199:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010719d:	78 5e                	js     801071fd <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010719f:	8d 45 e8             	lea    -0x18(%ebp),%eax
801071a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801071a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801071ad:	e8 f0 f3 ff ff       	call   801065a2 <argint>
  char *path;
  int len;
  int major, minor;
...
801071b4:	78 47                	js     801071fd <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801071b6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801071b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801071bd:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801071c4:	e8 d9 f3 ff ff       	call   801065a2 <argint>
  int len;
  int major, minor;
...
801071cb:	78 30                	js     801071fd <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801071cd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801071d0:	0f bf c8             	movswl %ax,%ecx
801071d3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801071d6:	0f bf d0             	movswl %ax,%edx
801071d9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
...
801071e4:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801071eb:	00 
801071ec:	89 04 24             	mov    %eax,(%esp)
801071ef:	e8 cd fb ff ff       	call   80106dc1 <create>
801071f4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801071f7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801071fb:	75 0c                	jne    80107209 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801071fd:	e8 3e c0 ff ff       	call   80103240 <commit_trans>
    return -1;
80107202:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107207:	eb 15                	jmp    8010721e <sys_mknod+0xa6>
  }
  iunlockput(ip);
80107209:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010720c:	89 04 24             	mov    %eax,(%esp)
8010720f:	e8 d8 a8 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80107214:	e8 27 c0 ff ff       	call   80103240 <commit_trans>
  return 0;
80107219:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010721e:	c9                   	leave  
8010721f:	c3                   	ret    
...
80107223:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0)
80107226:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107229:	89 44 24 04          	mov    %eax,0x4(%esp)
8010722d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107234:	e8 03 f4 ff ff       	call   8010663c <argstr>
80107239:	85 c0                	test   %eax,%eax
8010723b:	78 14                	js     80107251 <sys_chdir+0x31>
8010723d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107240:	89 04 24             	mov    %eax,(%esp)
80107243:	e8 c2 b1 ff ff       	call   8010240a <namei>
80107248:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010724b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010724f:	75 07                	jne    80107258 <sys_chdir+0x38>
    return -1;
80107251:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107256:	eb 57                	jmp    801072af <sys_chdir+0x8f>
  ilock(ip);
80107258:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010725b:	89 04 24             	mov    %eax,(%esp)
8010725e:	e8 05 a6 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
80107263:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107266:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010726a:	66 83 f8 01          	cmp    $0x1,%ax
8010726e:	74 12                	je     80107282 <sys_chdir+0x62>
    iunlockput(ip);
80107270:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107273:	89 04 24             	mov    %eax,(%esp)
80107276:	e8 71 a8 ff ff       	call   80101aec <iunlockput>
    return -1;
8010727b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107280:	eb 2d                	jmp    801072af <sys_chdir+0x8f>
  }
  iunlock(ip);
80107282:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107285:	89 04 24             	mov    %eax,(%esp)
80107288:	e8 29 a7 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
8010728d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107293:	8b 40 68             	mov    0x68(%eax),%eax
80107296:	89 04 24             	mov    %eax,(%esp)
80107299:	e8 7d a7 ff ff       	call   80101a1b <iput>
  proc->cwd = ip;
8010729e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801072a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801072a7:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
801072aa:	b8 00 00 00 00       	mov    $0x0,%eax
}
801072af:	c9                   	leave  
801072b0:	c3                   	ret    
...
801072b4:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801072ba:	8d 45 f0             	lea    -0x10(%ebp),%eax
801072bd:	89 44 24 04          	mov    %eax,0x4(%esp)
801072c1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801072c8:	e8 6f f3 ff ff       	call   8010663c <argstr>
801072cd:	85 c0                	test   %eax,%eax
801072cf:	78 1a                	js     801072eb <sys_exec+0x3a>
801072d1:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801072d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801072db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801072e2:	e8 bb f2 ff ff       	call   801065a2 <argint>
801072e7:	85 c0                	test   %eax,%eax
801072e9:	79 0a                	jns    801072f5 <sys_exec+0x44>
    return -1;
801072eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801072f0:	e9 e2 00 00 00       	jmp    801073d7 <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
801072f5:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801072fc:	00 
801072fd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107304:	00 
80107305:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010730b:	89 04 24             	mov    %eax,(%esp)
8010730e:	e8 3f ef ff ff       	call   80106252 <memset>
  for(i=0;; i++){
80107313:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010731a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010731d:	83 f8 1f             	cmp    $0x1f,%eax
80107320:	76 0a                	jbe    8010732c <sys_exec+0x7b>
      return -1;
80107322:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107327:	e9 ab 00 00 00       	jmp    801073d7 <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
8010732c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010732f:	c1 e0 02             	shl    $0x2,%eax
80107332:	89 c2                	mov    %eax,%edx
80107334:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010733a:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
8010733d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107343:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
80107349:	89 54 24 08          	mov    %edx,0x8(%esp)
8010734d:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80107351:	89 04 24             	mov    %eax,(%esp)
80107354:	e8 b7 f1 ff ff       	call   80106510 <fetchint>
80107359:	85 c0                	test   %eax,%eax
8010735b:	79 07                	jns    80107364 <sys_exec+0xb3>
      return -1;
8010735d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107362:	eb 73                	jmp    801073d7 <sys_exec+0x126>
    if(uarg == 0){
80107364:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010736a:	85 c0                	test   %eax,%eax
8010736c:	75 26                	jne    80107394 <sys_exec+0xe3>
      argv[i] = 0;
8010736e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107371:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80107378:	00 00 00 00 
      break;
8010737c:	90                   	nop
    }
...
8010737d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107380:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80107386:	89 54 24 04          	mov    %edx,0x4(%esp)
8010738a:	89 04 24             	mov    %eax,(%esp)
8010738d:	e8 6a 97 ff ff       	call   80100afc <exec>
80107392:	eb 43                	jmp    801073d7 <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80107397:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010739e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801073a4:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
801073a7:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
801073ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801073b3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801073b7:	89 54 24 04          	mov    %edx,0x4(%esp)
801073bb:	89 04 24             	mov    %eax,(%esp)
801073be:	e8 81 f1 ff ff       	call   80106544 <fetchstr>
801073c3:	85 c0                	test   %eax,%eax
801073c5:	79 07                	jns    801073ce <sys_exec+0x11d>
      return -1;
801073c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073cc:	eb 09                	jmp    801073d7 <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801073ce:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
801073d2:	e9 43 ff ff ff       	jmp    8010731a <sys_exec+0x69>
  return exec(path, argv);
}
801073d7:	c9                   	leave  
801073d8:	c3                   	ret    
...
801073dc:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801073df:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801073e6:	00 
801073e7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801073ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801073ee:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801073f5:	e8 e0 f1 ff ff       	call   801065da <argptr>
801073fa:	85 c0                	test   %eax,%eax
801073fc:	79 0a                	jns    80107408 <sys_pipe+0x2f>
    return -1;
801073fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107403:	e9 9b 00 00 00       	jmp    801074a3 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80107408:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010740b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010740f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80107412:	89 04 24             	mov    %eax,(%esp)
80107415:	e8 ee c7 ff ff       	call   80103c08 <pipealloc>
8010741a:	85 c0                	test   %eax,%eax
8010741c:	79 07                	jns    80107425 <sys_pipe+0x4c>
    return -1;
8010741e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107423:	eb 7e                	jmp    801074a3 <sys_pipe+0xca>
  fd0 = -1;
80107425:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010742c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010742f:	89 04 24             	mov    %eax,(%esp)
80107432:	e8 82 f3 ff ff       	call   801067b9 <fdalloc>
80107437:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010743a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010743e:	78 14                	js     80107454 <sys_pipe+0x7b>
80107440:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107443:	89 04 24             	mov    %eax,(%esp)
80107446:	e8 6e f3 ff ff       	call   801067b9 <fdalloc>
8010744b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010744e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107452:	79 37                	jns    8010748b <sys_pipe+0xb2>
    if(fd0 >= 0)
80107454:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107458:	78 14                	js     8010746e <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010745a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107460:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107463:	83 c2 08             	add    $0x8,%edx
80107466:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010746d:	00 
    fileclose(rf);
8010746e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107471:	89 04 24             	mov    %eax,(%esp)
80107474:	e8 4b 9b ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
80107479:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010747c:	89 04 24             	mov    %eax,(%esp)
8010747f:	e8 40 9b ff ff       	call   80100fc4 <fileclose>
    return -1;
80107484:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107489:	eb 18                	jmp    801074a3 <sys_pipe+0xca>
  }
  fd[0] = fd0;
8010748b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010748e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107491:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80107493:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107496:	8d 50 04             	lea    0x4(%eax),%edx
80107499:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010749c:	89 02                	mov    %eax,(%edx)
  return 0;
8010749e:	b8 00 00 00 00       	mov    $0x0,%eax
}
801074a3:	c9                   	leave  
801074a4:	c3                   	ret    
...
801074ab:	83 ec 08             	sub    $0x8,%esp
  return fork();
801074ae:	e8 40 ce ff ff       	call   801042f3 <fork>
}
801074b3:	c9                   	leave  
801074b4:	c3                   	ret    
...
801074b8:	83 ec 08             	sub    $0x8,%esp
  exit();
801074bb:	e8 96 cf ff ff       	call   80104456 <exit>
...
801074ca:	83 ec 08             	sub    $0x8,%esp
  return wait();
801074cd:	e8 9f d0 ff ff       	call   80104571 <wait>
}
801074d2:	c9                   	leave  
801074d3:	c3                   	ret    
...
801074d7:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
801074da:	8d 45 f4             	lea    -0xc(%ebp),%eax
801074dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801074e1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801074e8:	e8 b5 f0 ff ff       	call   801065a2 <argint>
801074ed:	85 c0                	test   %eax,%eax
801074ef:	79 07                	jns    801074f8 <sys_kill+0x24>
    return -1;
801074f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801074f6:	eb 0b                	jmp    80107503 <sys_kill+0x2f>
  return kill(pid);
801074f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074fb:	89 04 24             	mov    %eax,(%esp)
801074fe:	e8 c0 d5 ff ff       	call   80104ac3 <kill>
}
80107503:	c9                   	leave  
80107504:	c3                   	ret    
...
8010750e:	8b 40 10             	mov    0x10(%eax),%eax
}
80107511:	5d                   	pop    %ebp
80107512:	c3                   	ret    
...
80107516:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80107519:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010751c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107520:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107527:	e8 76 f0 ff ff       	call   801065a2 <argint>
8010752c:	85 c0                	test   %eax,%eax
8010752e:	79 07                	jns    80107537 <sys_sbrk+0x24>
    return -1;
80107530:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107535:	eb 24                	jmp    8010755b <sys_sbrk+0x48>
  addr = proc->sz;
80107537:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010753d:	8b 00                	mov    (%eax),%eax
8010753f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80107542:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107545:	89 04 24             	mov    %eax,(%esp)
80107548:	e8 01 cd ff ff       	call   8010424e <growproc>
8010754d:	85 c0                	test   %eax,%eax
8010754f:	79 07                	jns    80107558 <sys_sbrk+0x45>
    return -1;
80107551:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107556:	eb 03                	jmp    8010755b <sys_sbrk+0x48>
  return addr;
...
80107560:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
80107563:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107566:	89 44 24 04          	mov    %eax,0x4(%esp)
8010756a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107571:	e8 2c f0 ff ff       	call   801065a2 <argint>
80107576:	85 c0                	test   %eax,%eax
80107578:	79 07                	jns    80107581 <sys_sleep+0x24>
    return -1;
8010757a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010757f:	eb 6c                	jmp    801075ed <sys_sleep+0x90>
  acquire(&tickslock);
80107581:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
80107588:	e8 62 ea ff ff       	call   80105fef <acquire>
  ticks0 = ticks;
8010758d:	a1 40 6a 14 80       	mov    0x80146a40,%eax
80107592:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80107595:	eb 34                	jmp    801075cb <sys_sleep+0x6e>
    if(proc->killed){
80107597:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010759d:	8b 40 24             	mov    0x24(%eax),%eax
801075a0:	85 c0                	test   %eax,%eax
801075a2:	74 13                	je     801075b7 <sys_sleep+0x5a>
      release(&tickslock);
801075a4:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
801075ab:	e8 b7 ea ff ff       	call   80106067 <release>
      return -1;
801075b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801075b5:	eb 36                	jmp    801075ed <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801075b7:	c7 44 24 04 00 62 14 	movl   $0x80146200,0x4(%esp)
801075be:	80 
801075bf:	c7 04 24 40 6a 14 80 	movl   $0x80146a40,(%esp)
801075c6:	e8 8e d3 ff ff       	call   80104959 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801075cb:	a1 40 6a 14 80       	mov    0x80146a40,%eax
801075d0:	89 c2                	mov    %eax,%edx
801075d2:	2b 55 f4             	sub    -0xc(%ebp),%edx
801075d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801075d8:	39 c2                	cmp    %eax,%edx
801075da:	72 bb                	jb     80107597 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801075dc:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
801075e3:	e8 7f ea ff ff       	call   80106067 <release>
  return 0;
...
801075f2:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
801075f5:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
801075fc:	e8 ee e9 ff ff       	call   80105fef <acquire>
  xticks = ticks;
80107601:	a1 40 6a 14 80       	mov    0x80146a40,%eax
80107606:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80107609:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
80107610:	e8 52 ea ff ff       	call   80106067 <release>
  return xticks;
...
80107620:	e8 29 e2 ff ff       	call   8010584e <enableSwapping>
}
80107625:	c9                   	leave  
80107626:	c3                   	ret    

80107627 <sys_disableSwapping>:
...
8010762d:	e8 30 e2 ff ff       	call   80105862 <disableSwapping>
}
80107632:	c9                   	leave  
80107633:	c3                   	ret    

80107634 <sys_num_of_pages>:
int sys_num_of_pages(void){
80107634:	55                   	push   %ebp
80107635:	89 e5                	mov    %esp,%ebp
80107637:	83 ec 28             	sub    $0x28,%esp
  int proc_pid;
  if(argint(0, &proc_pid) < 0)
8010763a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010763d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107641:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107648:	e8 55 ef ff ff       	call   801065a2 <argint>
8010764d:	85 c0                	test   %eax,%eax
8010764f:	79 07                	jns    80107658 <sys_num_of_pages+0x24>
    return -1;
80107651:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107656:	eb 0b                	jmp    80107663 <sys_num_of_pages+0x2f>
  return num_of_pages(proc_pid);
80107658:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010765b:	89 04 24             	mov    %eax,(%esp)
8010765e:	e8 13 e2 ff ff       	call   80105876 <num_of_pages>
}
80107663:	c9                   	leave  
80107664:	c3                   	ret    
...
80107668:	83 ec 28             	sub    $0x28,%esp
 int key;
 int size;
 int shmflg;
 
 if(argint(0, &key) < 0)
8010766b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010766e:	89 44 24 04          	mov    %eax,0x4(%esp)
80107672:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107679:	e8 24 ef ff ff       	call   801065a2 <argint>
8010767e:	85 c0                	test   %eax,%eax
80107680:	79 07                	jns    80107689 <sys_shmget+0x24>
    return -1;
80107682:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107687:	eb 57                	jmp    801076e0 <sys_shmget+0x7b>
 if(argint(1, &size) < 0)
80107689:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010768c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107690:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80107697:	e8 06 ef ff ff       	call   801065a2 <argint>
8010769c:	85 c0                	test   %eax,%eax
8010769e:	79 07                	jns    801076a7 <sys_shmget+0x42>
    return -1;
801076a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801076a5:	eb 39                	jmp    801076e0 <sys_shmget+0x7b>
 if(argint(2, &shmflg) < 0)
801076a7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801076aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801076ae:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801076b5:	e8 e8 ee ff ff       	call   801065a2 <argint>
801076ba:	85 c0                	test   %eax,%eax
801076bc:	79 07                	jns    801076c5 <sys_shmget+0x60>
    return -1;
801076be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801076c3:	eb 1b                	jmp    801076e0 <sys_shmget+0x7b>
 
 return shmget(key,size,shmflg);
801076c5:	8b 4d ec             	mov    -0x14(%ebp),%ecx
801076c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801076cb:	89 c2                	mov    %eax,%edx
801076cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076d0:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801076d4:	89 54 24 04          	mov    %edx,0x4(%esp)
801076d8:	89 04 24             	mov    %eax,(%esp)
801076db:	e8 81 e2 ff ff       	call   80105961 <shmget>
}
801076e0:	c9                   	leave  
801076e1:	c3                   	ret    
...
801076e5:	83 ec 28             	sub    $0x28,%esp
  int shmid;
  if(argint(0, &shmid) < 0)
801076e8:	8d 45 f4             	lea    -0xc(%ebp),%eax
801076eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801076ef:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801076f6:	e8 a7 ee ff ff       	call   801065a2 <argint>
801076fb:	85 c0                	test   %eax,%eax
801076fd:	79 07                	jns    80107706 <sys_shmdel+0x24>
    return -1;
801076ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107704:	eb 0b                	jmp    80107711 <sys_shmdel+0x2f>
  return shmdel(shmid);
80107706:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107709:	89 04 24             	mov    %eax,(%esp)
8010770c:	e8 09 e4 ff ff       	call   80105b1a <shmdel>
}
80107711:	c9                   	leave  
80107712:	c3                   	ret    
...
80107716:	83 ec 28             	sub    $0x28,%esp
 ...
 int shmflg;
  if(argint(0, &shmid) < 0)
80107719:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010771c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107720:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107727:	e8 76 ee ff ff       	call   801065a2 <argint>
8010772c:	85 c0                	test   %eax,%eax
8010772e:	79 07                	jns    80107737 <sys_shmat+0x24>
    return (void*)-1;
80107730:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107735:	eb 30                	jmp    80107767 <sys_shmat+0x54>
   if(argint(1, &shmflg) < 0)
80107737:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010773a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010773e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80107745:	e8 58 ee ff ff       	call   801065a2 <argint>
8010774a:	85 c0                	test   %eax,%eax
8010774c:	79 07                	jns    80107755 <sys_shmat+0x42>
    return (void*)-1;
8010774e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107753:	eb 12                	jmp    80107767 <sys_shmat+0x54>
 
   
 return shmat(shmid,shmflg);
80107755:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107758:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010775f:	89 04 24             	mov    %eax,(%esp)
80107762:	e8 eb e4 ff ff       	call   80105c52 <shmat>
...
8010776c:	83 ec 28             	sub    $0x28,%esp
   char *shmaddr;
   if(argptr(0, &shmaddr, sizeof(shmaddr)) < 0)
8010776f:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80107776:	00 
80107777:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010777a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010777e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107785:	e8 50 ee ff ff       	call   801065da <argptr>
8010778a:	85 c0                	test   %eax,%eax
8010778c:	79 07                	jns    80107795 <sys_shmdt+0x2c>
     return -1;
8010778e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107793:	eb 0b                	jmp    801077a0 <sys_shmdt+0x37>
   
   return shmdt((const void*)shmaddr);
80107795:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107798:	89 04 24             	mov    %eax,(%esp)
8010779b:	e8 a2 e6 ff ff       	call   80105e42 <shmdt>
}
801077a0:	c9                   	leave  
801077a1:	c3                   	ret    

801077a2 <sys_get_share_memory_address>:

void* sys_get_share_memory_address(void){
801077a2:	55                   	push   %ebp
801077a3:	89 e5                	mov    %esp,%ebp
801077a5:	83 ec 28             	sub    $0x28,%esp
  int key;
  if(argint(0, &key) < 0)
801077a8:	8d 45 f4             	lea    -0xc(%ebp),%eax
801077ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801077af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801077b6:	e8 e7 ed ff ff       	call   801065a2 <argint>
801077bb:	85 c0                	test   %eax,%eax
801077bd:	79 07                	jns    801077c6 <sys_get_share_memory_address+0x24>
    return (void*)-1;
801077bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801077c4:	eb 0b                	jmp    801077d1 <sys_get_share_memory_address+0x2f>
  return get_share_memory_address(key);
801077c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c9:	89 04 24             	mov    %eax,(%esp)
801077cc:	e8 76 e7 ff ff       	call   80105f47 <get_share_memory_address>
801077d1:	c9                   	leave  
801077d2:	c3                   	ret    
	...
...
801077da:	8b 55 08             	mov    0x8(%ebp),%edx
801077dd:	8b 45 0c             	mov    0xc(%ebp),%eax
801077e0:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801077e4:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801077e7:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801077eb:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801077ef:	ee                   	out    %al,(%dx)
}
801077f0:	c9                   	leave  
801077f1:	c3                   	ret    
...
801077f5:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
801077f8:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801077ff:	00 
80107800:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80107807:	e8 c8 ff ff ff       	call   801077d4 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010780c:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80107813:	00 
80107814:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010781b:	e8 b4 ff ff ff       	call   801077d4 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80107820:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80107827:	00 
80107828:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010782f:	e8 a0 ff ff ff       	call   801077d4 <outb>
  picenable(IRQ_TIMER);
80107834:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010783b:	e8 51 c2 ff ff       	call   80103a91 <picenable>
}
80107840:	c9                   	leave  
80107841:	c3                   	ret    
	...
...
80107845:	06                   	push   %es
  pushl %fs
80107846:	0f a0                	push   %fs
  pushl %gs
80107848:	0f a8                	push   %gs
  pushal
8010784a:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010784b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010784f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80107851:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80107853:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80107857:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80107859:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
8010785b:	54                   	push   %esp
  call trap
8010785c:	e8 de 01 00 00       	call   80107a3f <trap>
  addl $4, %esp
80107861:	83 c4 04             	add    $0x4,%esp
...
80107864:	61                   	popa   
  popl %gs
80107865:	0f a9                	pop    %gs
  popl %fs
80107867:	0f a1                	pop    %fs
  popl %es
80107869:	07                   	pop    %es
  popl %ds
8010786a:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010786b:	83 c4 08             	add    $0x8,%esp
  iret
8010786e:	cf                   	iret   
	...
...
8010789d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
801078a0:	0f 20 d3             	mov    %cr2,%ebx
801078a3:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
801078a6:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
801078b2:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
801078b5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801078bc:	e9 c3 00 00 00       	jmp    80107984 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801078c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c4:	8b 04 85 f8 d0 10 80 	mov    -0x7fef2f08(,%eax,4),%eax
801078cb:	89 c2                	mov    %eax,%edx
801078cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d0:	66 89 14 c5 40 62 14 	mov    %dx,-0x7feb9dc0(,%eax,8)
801078d7:	80 
801078d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078db:	66 c7 04 c5 42 62 14 	movw   $0x8,-0x7feb9dbe(,%eax,8)
801078e2:	80 08 00 
801078e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e8:	0f b6 14 c5 44 62 14 	movzbl -0x7feb9dbc(,%eax,8),%edx
801078ef:	80 
801078f0:	83 e2 e0             	and    $0xffffffe0,%edx
801078f3:	88 14 c5 44 62 14 80 	mov    %dl,-0x7feb9dbc(,%eax,8)
801078fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078fd:	0f b6 14 c5 44 62 14 	movzbl -0x7feb9dbc(,%eax,8),%edx
80107904:	80 
80107905:	83 e2 1f             	and    $0x1f,%edx
80107908:	88 14 c5 44 62 14 80 	mov    %dl,-0x7feb9dbc(,%eax,8)
8010790f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107912:	0f b6 14 c5 45 62 14 	movzbl -0x7feb9dbb(,%eax,8),%edx
80107919:	80 
8010791a:	83 e2 f0             	and    $0xfffffff0,%edx
8010791d:	83 ca 0e             	or     $0xe,%edx
80107920:	88 14 c5 45 62 14 80 	mov    %dl,-0x7feb9dbb(,%eax,8)
80107927:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010792a:	0f b6 14 c5 45 62 14 	movzbl -0x7feb9dbb(,%eax,8),%edx
80107931:	80 
80107932:	83 e2 ef             	and    $0xffffffef,%edx
80107935:	88 14 c5 45 62 14 80 	mov    %dl,-0x7feb9dbb(,%eax,8)
8010793c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010793f:	0f b6 14 c5 45 62 14 	movzbl -0x7feb9dbb(,%eax,8),%edx
80107946:	80 
80107947:	83 e2 9f             	and    $0xffffff9f,%edx
8010794a:	88 14 c5 45 62 14 80 	mov    %dl,-0x7feb9dbb(,%eax,8)
80107951:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107954:	0f b6 14 c5 45 62 14 	movzbl -0x7feb9dbb(,%eax,8),%edx
8010795b:	80 
8010795c:	83 ca 80             	or     $0xffffff80,%edx
8010795f:	88 14 c5 45 62 14 80 	mov    %dl,-0x7feb9dbb(,%eax,8)
80107966:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107969:	8b 04 85 f8 d0 10 80 	mov    -0x7fef2f08(,%eax,4),%eax
80107970:	c1 e8 10             	shr    $0x10,%eax
80107973:	89 c2                	mov    %eax,%edx
80107975:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107978:	66 89 14 c5 46 62 14 	mov    %dx,-0x7feb9dba(,%eax,8)
8010797f:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80107980:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107984:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010798b:	0f 8e 30 ff ff ff    	jle    801078c1 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107991:	a1 f8 d1 10 80       	mov    0x8010d1f8,%eax
80107996:	66 a3 40 64 14 80    	mov    %ax,0x80146440
8010799c:	66 c7 05 42 64 14 80 	movw   $0x8,0x80146442
801079a3:	08 00 
801079a5:	0f b6 05 44 64 14 80 	movzbl 0x80146444,%eax
801079ac:	83 e0 e0             	and    $0xffffffe0,%eax
801079af:	a2 44 64 14 80       	mov    %al,0x80146444
801079b4:	0f b6 05 44 64 14 80 	movzbl 0x80146444,%eax
801079bb:	83 e0 1f             	and    $0x1f,%eax
801079be:	a2 44 64 14 80       	mov    %al,0x80146444
801079c3:	0f b6 05 45 64 14 80 	movzbl 0x80146445,%eax
801079ca:	83 c8 0f             	or     $0xf,%eax
801079cd:	a2 45 64 14 80       	mov    %al,0x80146445
801079d2:	0f b6 05 45 64 14 80 	movzbl 0x80146445,%eax
801079d9:	83 e0 ef             	and    $0xffffffef,%eax
801079dc:	a2 45 64 14 80       	mov    %al,0x80146445
801079e1:	0f b6 05 45 64 14 80 	movzbl 0x80146445,%eax
801079e8:	83 c8 60             	or     $0x60,%eax
801079eb:	a2 45 64 14 80       	mov    %al,0x80146445
801079f0:	0f b6 05 45 64 14 80 	movzbl 0x80146445,%eax
801079f7:	83 c8 80             	or     $0xffffff80,%eax
801079fa:	a2 45 64 14 80       	mov    %al,0x80146445
801079ff:	a1 f8 d1 10 80       	mov    0x8010d1f8,%eax
80107a04:	c1 e8 10             	shr    $0x10,%eax
80107a07:	66 a3 46 64 14 80    	mov    %ax,0x80146446
  
  initlock(&tickslock, "time");
80107a0d:	c7 44 24 04 04 9e 10 	movl   $0x80109e04,0x4(%esp)
80107a14:	80 
80107a15:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
80107a1c:	e8 ad e5 ff ff       	call   80105fce <initlock>
}
80107a21:	c9                   	leave  
80107a22:	c3                   	ret    
...
80107a26:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80107a29:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80107a30:	00 
80107a31:	c7 04 24 40 62 14 80 	movl   $0x80146240,(%esp)
80107a38:	e8 33 fe ff ff       	call   80107870 <lidt>
}
80107a3d:	c9                   	leave  
80107a3e:	c3                   	ret    
...
80107a45:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80107a48:	8b 45 08             	mov    0x8(%ebp),%eax
80107a4b:	8b 40 30             	mov    0x30(%eax),%eax
80107a4e:	83 f8 40             	cmp    $0x40,%eax
80107a51:	75 3e                	jne    80107a91 <trap+0x52>
    if(proc->killed)
80107a53:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a59:	8b 40 24             	mov    0x24(%eax),%eax
80107a5c:	85 c0                	test   %eax,%eax
80107a5e:	74 05                	je     80107a65 <trap+0x26>
      exit();
80107a60:	e8 f1 c9 ff ff       	call   80104456 <exit>
    proc->tf = tf;
80107a65:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a6b:	8b 55 08             	mov    0x8(%ebp),%edx
80107a6e:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80107a71:	e8 09 ec ff ff       	call   8010667f <syscall>
    if(proc->killed)
80107a76:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a7c:	8b 40 24             	mov    0x24(%eax),%eax
80107a7f:	85 c0                	test   %eax,%eax
80107a81:	0f 84 34 02 00 00    	je     80107cbb <trap+0x27c>
      exit();
80107a87:	e8 ca c9 ff ff       	call   80104456 <exit>
    return;
80107a8c:	e9 2a 02 00 00       	jmp    80107cbb <trap+0x27c>
  }

  switch(tf->trapno){
80107a91:	8b 45 08             	mov    0x8(%ebp),%eax
80107a94:	8b 40 30             	mov    0x30(%eax),%eax
80107a97:	83 e8 20             	sub    $0x20,%eax
80107a9a:	83 f8 1f             	cmp    $0x1f,%eax
80107a9d:	0f 87 bc 00 00 00    	ja     80107b5f <trap+0x120>
80107aa3:	8b 04 85 ac 9e 10 80 	mov    -0x7fef6154(,%eax,4),%eax
80107aaa:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107aac:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ab2:	0f b6 00             	movzbl (%eax),%eax
80107ab5:	84 c0                	test   %al,%al
80107ab7:	75 31                	jne    80107aea <trap+0xab>
      acquire(&tickslock);
80107ab9:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
80107ac0:	e8 2a e5 ff ff       	call   80105fef <acquire>
      ticks++;
80107ac5:	a1 40 6a 14 80       	mov    0x80146a40,%eax
80107aca:	83 c0 01             	add    $0x1,%eax
80107acd:	a3 40 6a 14 80       	mov    %eax,0x80146a40
      wakeup(&ticks);
80107ad2:	c7 04 24 40 6a 14 80 	movl   $0x80146a40,(%esp)
80107ad9:	e8 ba cf ff ff       	call   80104a98 <wakeup>
      release(&tickslock);
80107ade:	c7 04 24 00 62 14 80 	movl   $0x80146200,(%esp)
80107ae5:	e8 7d e5 ff ff       	call   80106067 <release>
    }
    lapiceoi();
80107aea:	e8 ee b3 ff ff       	call   80102edd <lapiceoi>
    break;
80107aef:	e9 41 01 00 00       	jmp    80107c35 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107af4:	e8 04 ac ff ff       	call   801026fd <ideintr>
    lapiceoi();
80107af9:	e8 df b3 ff ff       	call   80102edd <lapiceoi>
    break;
80107afe:	e9 32 01 00 00       	jmp    80107c35 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80107b03:	e8 b3 b1 ff ff       	call   80102cbb <kbdintr>
    lapiceoi();
80107b08:	e8 d0 b3 ff ff       	call   80102edd <lapiceoi>
    break;
80107b0d:	e9 23 01 00 00       	jmp    80107c35 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80107b12:	e8 a9 03 00 00       	call   80107ec0 <uartintr>
    lapiceoi();
80107b17:	e8 c1 b3 ff ff       	call   80102edd <lapiceoi>
    break;
80107b1c:	e9 14 01 00 00       	jmp    80107c35 <trap+0x1f6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
            cpu->id, tf->cs, tf->eip);
80107b21:	8b 45 08             	mov    0x8(%ebp),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107b24:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80107b27:	8b 45 08             	mov    0x8(%ebp),%eax
80107b2a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107b2e:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80107b31:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107b37:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107b3a:	0f b6 c0             	movzbl %al,%eax
80107b3d:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107b41:	89 54 24 08          	mov    %edx,0x8(%esp)
80107b45:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b49:	c7 04 24 0c 9e 10 80 	movl   $0x80109e0c,(%esp)
80107b50:	e8 4c 88 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107b55:	e8 83 b3 ff ff       	call   80102edd <lapiceoi>
    break;
80107b5a:	e9 d6 00 00 00       	jmp    80107c35 <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80107b5f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107b65:	85 c0                	test   %eax,%eax
80107b67:	74 11                	je     80107b7a <trap+0x13b>
80107b69:	8b 45 08             	mov    0x8(%ebp),%eax
80107b6c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107b70:	0f b7 c0             	movzwl %ax,%eax
80107b73:	83 e0 03             	and    $0x3,%eax
80107b76:	85 c0                	test   %eax,%eax
80107b78:	75 46                	jne    80107bc0 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b7a:	e8 1a fd ff ff       	call   80107899 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b7f:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b82:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b85:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107b8c:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b8f:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b92:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b95:	8b 52 30             	mov    0x30(%edx),%edx
80107b98:	89 44 24 10          	mov    %eax,0x10(%esp)
80107b9c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107ba0:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107ba4:	89 54 24 04          	mov    %edx,0x4(%esp)
80107ba8:	c7 04 24 30 9e 10 80 	movl   $0x80109e30,(%esp)
80107baf:	e8 ed 87 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80107bb4:	c7 04 24 62 9e 10 80 	movl   $0x80109e62,(%esp)
80107bbb:	e8 7d 89 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107bc0:	e8 d4 fc ff ff       	call   80107899 <rcr2>
...
80107bc7:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107bca:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107bcd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107bd3:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107bd6:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107bd9:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107bdc:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107bdf:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107be2:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107be5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107beb:	83 c0 6c             	add    $0x6c,%eax
80107bee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107bf1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107bf7:	8b 40 10             	mov    0x10(%eax),%eax
80107bfa:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80107bfe:	89 7c 24 18          	mov    %edi,0x18(%esp)
80107c02:	89 74 24 14          	mov    %esi,0x14(%esp)
80107c06:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107c0a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107c0e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107c11:	89 54 24 08          	mov    %edx,0x8(%esp)
80107c15:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c19:	c7 04 24 68 9e 10 80 	movl   $0x80109e68,(%esp)
80107c20:	e8 7c 87 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107c25:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c2b:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107c32:	eb 01                	jmp    80107c35 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107c35:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c3b:	85 c0                	test   %eax,%eax
80107c3d:	74 24                	je     80107c63 <trap+0x224>
80107c3f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c45:	8b 40 24             	mov    0x24(%eax),%eax
80107c48:	85 c0                	test   %eax,%eax
80107c4a:	74 17                	je     80107c63 <trap+0x224>
80107c4c:	8b 45 08             	mov    0x8(%ebp),%eax
80107c4f:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107c53:	0f b7 c0             	movzwl %ax,%eax
80107c56:	83 e0 03             	and    $0x3,%eax
80107c59:	83 f8 03             	cmp    $0x3,%eax
80107c5c:	75 05                	jne    80107c63 <trap+0x224>
    exit();
80107c5e:	e8 f3 c7 ff ff       	call   80104456 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80107c63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c69:	85 c0                	test   %eax,%eax
80107c6b:	74 1e                	je     80107c8b <trap+0x24c>
80107c6d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c73:	8b 40 0c             	mov    0xc(%eax),%eax
80107c76:	83 f8 04             	cmp    $0x4,%eax
80107c79:	75 10                	jne    80107c8b <trap+0x24c>
80107c7b:	8b 45 08             	mov    0x8(%ebp),%eax
80107c7e:	8b 40 30             	mov    0x30(%eax),%eax
80107c81:	83 f8 20             	cmp    $0x20,%eax
80107c84:	75 05                	jne    80107c8b <trap+0x24c>
    yield();
80107c86:	e8 70 cc ff ff       	call   801048fb <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107c8b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c91:	85 c0                	test   %eax,%eax
80107c93:	74 27                	je     80107cbc <trap+0x27d>
80107c95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c9b:	8b 40 24             	mov    0x24(%eax),%eax
80107c9e:	85 c0                	test   %eax,%eax
80107ca0:	74 1a                	je     80107cbc <trap+0x27d>
80107ca2:	8b 45 08             	mov    0x8(%ebp),%eax
80107ca5:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107ca9:	0f b7 c0             	movzwl %ax,%eax
80107cac:	83 e0 03             	and    $0x3,%eax
80107caf:	83 f8 03             	cmp    $0x3,%eax
80107cb2:	75 08                	jne    80107cbc <trap+0x27d>
    exit();
80107cb4:	e8 9d c7 ff ff       	call   80104456 <exit>
80107cb9:	eb 01                	jmp    80107cbc <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80107cbc:	83 c4 3c             	add    $0x3c,%esp
80107cbf:	5b                   	pop    %ebx
80107cc0:	5e                   	pop    %esi
80107cc1:	5f                   	pop    %edi
80107cc2:	5d                   	pop    %ebp
...
80107cc8:	83 ec 14             	sub    $0x14,%esp
80107ccb:	8b 45 08             	mov    0x8(%ebp),%eax
80107cce:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107cd2:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107cd6:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80107cda:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80107cde:	ec                   	in     (%dx),%al
80107cdf:	89 c3                	mov    %eax,%ebx
80107ce1:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107ce4:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107ce8:	83 c4 14             	add    $0x14,%esp
80107ceb:	5b                   	pop    %ebx
80107cec:	5d                   	pop    %ebp
80107ced:	c3                   	ret    
...
80107cf4:	8b 55 08             	mov    0x8(%ebp),%edx
80107cf7:	8b 45 0c             	mov    0xc(%ebp),%eax
80107cfa:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80107cfe:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107d01:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107d05:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80107d09:	ee                   	out    %al,(%dx)
}
80107d0a:	c9                   	leave  
80107d0b:	c3                   	ret    
...
80107d0f:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
80107d19:	00 
80107d1a:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107d21:	e8 c8 ff ff ff       	call   80107cee <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107d26:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107d2d:	00 
80107d2e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107d35:	e8 b4 ff ff ff       	call   80107cee <outb>
  outb(COM1+0, 115200/9600);
80107d3a:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80107d41:	00 
80107d42:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107d49:	e8 a0 ff ff ff       	call   80107cee <outb>
  outb(COM1+1, 0);
80107d4e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d55:	00 
80107d56:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107d5d:	e8 8c ff ff ff       	call   80107cee <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107d62:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107d69:	00 
80107d6a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107d71:	e8 78 ff ff ff       	call   80107cee <outb>
  outb(COM1+4, 0);
80107d76:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d7d:	00 
80107d7e:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107d85:	e8 64 ff ff ff       	call   80107cee <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80107d8a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107d91:	00 
80107d92:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107d99:	e8 50 ff ff ff       	call   80107cee <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107d9e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107da5:	e8 1a ff ff ff       	call   80107cc4 <inb>
80107daa:	3c ff                	cmp    $0xff,%al
80107dac:	74 6c                	je     80107e1a <uartinit+0x10e>
    return;
  uart = 1;
80107dae:	c7 05 b0 d6 10 80 01 	movl   $0x1,0x8010d6b0
80107db5:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107db8:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107dbf:	e8 00 ff ff ff       	call   80107cc4 <inb>
  inb(COM1+0);
80107dc4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107dcb:	e8 f4 fe ff ff       	call   80107cc4 <inb>
  picenable(IRQ_COM1);
80107dd0:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107dd7:	e8 b5 bc ff ff       	call   80103a91 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107ddc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107de3:	00 
80107de4:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107deb:	e8 7a ab ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107df0:	c7 45 f4 2c 9f 10 80 	movl   $0x80109f2c,-0xc(%ebp)
80107df7:	eb 15                	jmp    80107e0e <uartinit+0x102>
    uartputc(*p);
80107df9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dfc:	0f b6 00             	movzbl (%eax),%eax
80107dff:	0f be c0             	movsbl %al,%eax
80107e02:	89 04 24             	mov    %eax,(%esp)
80107e05:	e8 13 00 00 00       	call   80107e1d <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107e0a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107e0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e11:	0f b6 00             	movzbl (%eax),%eax
80107e14:	84 c0                	test   %al,%al
80107e16:	75 e1                	jne    80107df9 <uartinit+0xed>
80107e18:	eb 01                	jmp    80107e1b <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80107e20:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80107e23:	a1 b0 d6 10 80       	mov    0x8010d6b0,%eax
80107e28:	85 c0                	test   %eax,%eax
80107e2a:	74 4d                	je     80107e79 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107e2c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107e33:	eb 10                	jmp    80107e45 <uartputc+0x28>
    microdelay(10);
80107e35:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107e3c:	e8 c1 b0 ff ff       	call   80102f02 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107e41:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107e45:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107e49:	7f 16                	jg     80107e61 <uartputc+0x44>
80107e4b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107e52:	e8 6d fe ff ff       	call   80107cc4 <inb>
80107e57:	0f b6 c0             	movzbl %al,%eax
80107e5a:	83 e0 20             	and    $0x20,%eax
80107e5d:	85 c0                	test   %eax,%eax
80107e5f:	74 d4                	je     80107e35 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80107e61:	8b 45 08             	mov    0x8(%ebp),%eax
80107e64:	0f b6 c0             	movzbl %al,%eax
80107e67:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e6b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107e72:	e8 77 fe ff ff       	call   80107cee <outb>
80107e77:	eb 01                	jmp    80107e7a <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80107e7f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107e82:	a1 b0 d6 10 80       	mov    0x8010d6b0,%eax
80107e87:	85 c0                	test   %eax,%eax
80107e89:	75 07                	jne    80107e92 <uartgetc+0x16>
    return -1;
80107e8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107e90:	eb 2c                	jmp    80107ebe <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107e92:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107e99:	e8 26 fe ff ff       	call   80107cc4 <inb>
80107e9e:	0f b6 c0             	movzbl %al,%eax
80107ea1:	83 e0 01             	and    $0x1,%eax
80107ea4:	85 c0                	test   %eax,%eax
80107ea6:	75 07                	jne    80107eaf <uartgetc+0x33>
    return -1;
80107ea8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ead:	eb 0f                	jmp    80107ebe <uartgetc+0x42>
  return inb(COM1+0);
80107eaf:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107eb6:	e8 09 fe ff ff       	call   80107cc4 <inb>
...
80107ec6:	c7 04 24 7c 7e 10 80 	movl   $0x80107e7c,(%esp)
80107ecd:	e8 db 88 ff ff       	call   801007ad <consoleintr>
}
80107ed2:	c9                   	leave  
80107ed3:	c3                   	ret    
...
80107ed6:	6a 00                	push   $0x0
  jmp alltraps
80107ed8:	e9 67 f9 ff ff       	jmp    80107844 <alltraps>
...
80107edd:	6a 00                	push   $0x0
  pushl $1
80107edf:	6a 01                	push   $0x1
  jmp alltraps
80107ee1:	e9 5e f9 ff ff       	jmp    80107844 <alltraps>
...
80107ee6:	6a 00                	push   $0x0
  pushl $2
80107ee8:	6a 02                	push   $0x2
  jmp alltraps
80107eea:	e9 55 f9 ff ff       	jmp    80107844 <alltraps>
...
80107eef:	6a 00                	push   $0x0
  pushl $3
80107ef1:	6a 03                	push   $0x3
  jmp alltraps
80107ef3:	e9 4c f9 ff ff       	jmp    80107844 <alltraps>
...
80107ef8:	6a 00                	push   $0x0
  pushl $4
80107efa:	6a 04                	push   $0x4
  jmp alltraps
80107efc:	e9 43 f9 ff ff       	jmp    80107844 <alltraps>
...
80107f01:	6a 00                	push   $0x0
  pushl $5
80107f03:	6a 05                	push   $0x5
  jmp alltraps
80107f05:	e9 3a f9 ff ff       	jmp    80107844 <alltraps>
...
80107f0a:	6a 00                	push   $0x0
  pushl $6
80107f0c:	6a 06                	push   $0x6
  jmp alltraps
80107f0e:	e9 31 f9 ff ff       	jmp    80107844 <alltraps>
...
80107f13:	6a 00                	push   $0x0
  pushl $7
80107f15:	6a 07                	push   $0x7
  jmp alltraps
80107f17:	e9 28 f9 ff ff       	jmp    80107844 <alltraps>

80107f1c <vector8>:
.globl vector8
vector8:
  pushl $8
80107f1c:	6a 08                	push   $0x8
  jmp alltraps
80107f1e:	e9 21 f9 ff ff       	jmp    80107844 <alltraps>
...
80107f23:	6a 00                	push   $0x0
  pushl $9
80107f25:	6a 09                	push   $0x9
  jmp alltraps
80107f27:	e9 18 f9 ff ff       	jmp    80107844 <alltraps>

80107f2c <vector10>:
.globl vector10
vector10:
  pushl $10
80107f2c:	6a 0a                	push   $0xa
  jmp alltraps
80107f2e:	e9 11 f9 ff ff       	jmp    80107844 <alltraps>

80107f33 <vector11>:
.globl vector11
vector11:
  pushl $11
80107f33:	6a 0b                	push   $0xb
  jmp alltraps
80107f35:	e9 0a f9 ff ff       	jmp    80107844 <alltraps>
...
80107f3a:	6a 0c                	push   $0xc
  jmp alltraps
80107f3c:	e9 03 f9 ff ff       	jmp    80107844 <alltraps>

80107f41 <vector13>:
.globl vector13
vector13:
  pushl $13
80107f41:	6a 0d                	push   $0xd
  jmp alltraps
80107f43:	e9 fc f8 ff ff       	jmp    80107844 <alltraps>

80107f48 <vector14>:
.globl vector14
vector14:
  pushl $14
80107f48:	6a 0e                	push   $0xe
  jmp alltraps
80107f4a:	e9 f5 f8 ff ff       	jmp    80107844 <alltraps>
...
80107f4f:	6a 00                	push   $0x0
  pushl $15
80107f51:	6a 0f                	push   $0xf
  jmp alltraps
80107f53:	e9 ec f8 ff ff       	jmp    80107844 <alltraps>
...
80107f58:	6a 00                	push   $0x0
  pushl $16
80107f5a:	6a 10                	push   $0x10
  jmp alltraps
80107f5c:	e9 e3 f8 ff ff       	jmp    80107844 <alltraps>

80107f61 <vector17>:
.globl vector17
vector17:
  pushl $17
80107f61:	6a 11                	push   $0x11
  jmp alltraps
80107f63:	e9 dc f8 ff ff       	jmp    80107844 <alltraps>
...
80107f68:	6a 00                	push   $0x0
  pushl $18
80107f6a:	6a 12                	push   $0x12
  jmp alltraps
80107f6c:	e9 d3 f8 ff ff       	jmp    80107844 <alltraps>
...
80107f71:	6a 00                	push   $0x0
  pushl $19
80107f73:	6a 13                	push   $0x13
  jmp alltraps
80107f75:	e9 ca f8 ff ff       	jmp    80107844 <alltraps>
...
80107f7a:	6a 00                	push   $0x0
  pushl $20
80107f7c:	6a 14                	push   $0x14
  jmp alltraps
80107f7e:	e9 c1 f8 ff ff       	jmp    80107844 <alltraps>
...
80107f83:	6a 00                	push   $0x0
  pushl $21
80107f85:	6a 15                	push   $0x15
  jmp alltraps
80107f87:	e9 b8 f8 ff ff       	jmp    80107844 <alltraps>
...
80107f8c:	6a 00                	push   $0x0
  pushl $22
80107f8e:	6a 16                	push   $0x16
  jmp alltraps
80107f90:	e9 af f8 ff ff       	jmp    80107844 <alltraps>
...
80107f95:	6a 00                	push   $0x0
  pushl $23
80107f97:	6a 17                	push   $0x17
  jmp alltraps
80107f99:	e9 a6 f8 ff ff       	jmp    80107844 <alltraps>
...
80107f9e:	6a 00                	push   $0x0
  pushl $24
80107fa0:	6a 18                	push   $0x18
  jmp alltraps
80107fa2:	e9 9d f8 ff ff       	jmp    80107844 <alltraps>
...
80107fa7:	6a 00                	push   $0x0
  pushl $25
80107fa9:	6a 19                	push   $0x19
  jmp alltraps
80107fab:	e9 94 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fb0:	6a 00                	push   $0x0
  pushl $26
80107fb2:	6a 1a                	push   $0x1a
  jmp alltraps
80107fb4:	e9 8b f8 ff ff       	jmp    80107844 <alltraps>
...
80107fb9:	6a 00                	push   $0x0
  pushl $27
80107fbb:	6a 1b                	push   $0x1b
  jmp alltraps
80107fbd:	e9 82 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fc2:	6a 00                	push   $0x0
  pushl $28
80107fc4:	6a 1c                	push   $0x1c
  jmp alltraps
80107fc6:	e9 79 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fcb:	6a 00                	push   $0x0
  pushl $29
80107fcd:	6a 1d                	push   $0x1d
  jmp alltraps
80107fcf:	e9 70 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fd4:	6a 00                	push   $0x0
  pushl $30
80107fd6:	6a 1e                	push   $0x1e
  jmp alltraps
80107fd8:	e9 67 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fdd:	6a 00                	push   $0x0
  pushl $31
80107fdf:	6a 1f                	push   $0x1f
  jmp alltraps
80107fe1:	e9 5e f8 ff ff       	jmp    80107844 <alltraps>
...
80107fe6:	6a 00                	push   $0x0
  pushl $32
80107fe8:	6a 20                	push   $0x20
  jmp alltraps
80107fea:	e9 55 f8 ff ff       	jmp    80107844 <alltraps>
...
80107fef:	6a 00                	push   $0x0
  pushl $33
80107ff1:	6a 21                	push   $0x21
  jmp alltraps
80107ff3:	e9 4c f8 ff ff       	jmp    80107844 <alltraps>
...
80107ff8:	6a 00                	push   $0x0
  pushl $34
80107ffa:	6a 22                	push   $0x22
  jmp alltraps
80107ffc:	e9 43 f8 ff ff       	jmp    80107844 <alltraps>
...
80108001:	6a 00                	push   $0x0
  pushl $35
80108003:	6a 23                	push   $0x23
  jmp alltraps
80108005:	e9 3a f8 ff ff       	jmp    80107844 <alltraps>
...
8010800a:	6a 00                	push   $0x0
  pushl $36
8010800c:	6a 24                	push   $0x24
  jmp alltraps
8010800e:	e9 31 f8 ff ff       	jmp    80107844 <alltraps>
...
80108013:	6a 00                	push   $0x0
  pushl $37
80108015:	6a 25                	push   $0x25
  jmp alltraps
80108017:	e9 28 f8 ff ff       	jmp    80107844 <alltraps>
...
8010801c:	6a 00                	push   $0x0
  pushl $38
8010801e:	6a 26                	push   $0x26
  jmp alltraps
80108020:	e9 1f f8 ff ff       	jmp    80107844 <alltraps>
...
80108025:	6a 00                	push   $0x0
  pushl $39
80108027:	6a 27                	push   $0x27
  jmp alltraps
80108029:	e9 16 f8 ff ff       	jmp    80107844 <alltraps>
...
8010802e:	6a 00                	push   $0x0
  pushl $40
80108030:	6a 28                	push   $0x28
  jmp alltraps
80108032:	e9 0d f8 ff ff       	jmp    80107844 <alltraps>
...
80108037:	6a 00                	push   $0x0
  pushl $41
80108039:	6a 29                	push   $0x29
  jmp alltraps
8010803b:	e9 04 f8 ff ff       	jmp    80107844 <alltraps>
...
80108040:	6a 00                	push   $0x0
  pushl $42
80108042:	6a 2a                	push   $0x2a
  jmp alltraps
80108044:	e9 fb f7 ff ff       	jmp    80107844 <alltraps>
...
80108049:	6a 00                	push   $0x0
  pushl $43
8010804b:	6a 2b                	push   $0x2b
  jmp alltraps
8010804d:	e9 f2 f7 ff ff       	jmp    80107844 <alltraps>
...
80108052:	6a 00                	push   $0x0
  pushl $44
80108054:	6a 2c                	push   $0x2c
  jmp alltraps
80108056:	e9 e9 f7 ff ff       	jmp    80107844 <alltraps>
...
8010805b:	6a 00                	push   $0x0
  pushl $45
8010805d:	6a 2d                	push   $0x2d
  jmp alltraps
8010805f:	e9 e0 f7 ff ff       	jmp    80107844 <alltraps>
...
80108064:	6a 00                	push   $0x0
  pushl $46
80108066:	6a 2e                	push   $0x2e
  jmp alltraps
80108068:	e9 d7 f7 ff ff       	jmp    80107844 <alltraps>
...
8010806d:	6a 00                	push   $0x0
  pushl $47
8010806f:	6a 2f                	push   $0x2f
  jmp alltraps
80108071:	e9 ce f7 ff ff       	jmp    80107844 <alltraps>
...
80108076:	6a 00                	push   $0x0
  pushl $48
80108078:	6a 30                	push   $0x30
  jmp alltraps
8010807a:	e9 c5 f7 ff ff       	jmp    80107844 <alltraps>
...
8010807f:	6a 00                	push   $0x0
  pushl $49
80108081:	6a 31                	push   $0x31
  jmp alltraps
80108083:	e9 bc f7 ff ff       	jmp    80107844 <alltraps>
...
80108088:	6a 00                	push   $0x0
  pushl $50
8010808a:	6a 32                	push   $0x32
  jmp alltraps
8010808c:	e9 b3 f7 ff ff       	jmp    80107844 <alltraps>
...
80108091:	6a 00                	push   $0x0
  pushl $51
80108093:	6a 33                	push   $0x33
  jmp alltraps
80108095:	e9 aa f7 ff ff       	jmp    80107844 <alltraps>
...
8010809a:	6a 00                	push   $0x0
  pushl $52
8010809c:	6a 34                	push   $0x34
  jmp alltraps
8010809e:	e9 a1 f7 ff ff       	jmp    80107844 <alltraps>
...
801080a3:	6a 00                	push   $0x0
  pushl $53
801080a5:	6a 35                	push   $0x35
  jmp alltraps
801080a7:	e9 98 f7 ff ff       	jmp    80107844 <alltraps>
...
801080ac:	6a 00                	push   $0x0
  pushl $54
801080ae:	6a 36                	push   $0x36
  jmp alltraps
801080b0:	e9 8f f7 ff ff       	jmp    80107844 <alltraps>
...
801080b5:	6a 00                	push   $0x0
  pushl $55
801080b7:	6a 37                	push   $0x37
  jmp alltraps
801080b9:	e9 86 f7 ff ff       	jmp    80107844 <alltraps>
...
801080be:	6a 00                	push   $0x0
  pushl $56
801080c0:	6a 38                	push   $0x38
  jmp alltraps
801080c2:	e9 7d f7 ff ff       	jmp    80107844 <alltraps>
...
801080c7:	6a 00                	push   $0x0
  pushl $57
801080c9:	6a 39                	push   $0x39
  jmp alltraps
801080cb:	e9 74 f7 ff ff       	jmp    80107844 <alltraps>
...
801080d0:	6a 00                	push   $0x0
  pushl $58
801080d2:	6a 3a                	push   $0x3a
  jmp alltraps
801080d4:	e9 6b f7 ff ff       	jmp    80107844 <alltraps>
...
801080d9:	6a 00                	push   $0x0
  pushl $59
801080db:	6a 3b                	push   $0x3b
  jmp alltraps
801080dd:	e9 62 f7 ff ff       	jmp    80107844 <alltraps>
...
801080e2:	6a 00                	push   $0x0
  pushl $60
801080e4:	6a 3c                	push   $0x3c
  jmp alltraps
801080e6:	e9 59 f7 ff ff       	jmp    80107844 <alltraps>
...
801080eb:	6a 00                	push   $0x0
  pushl $61
801080ed:	6a 3d                	push   $0x3d
  jmp alltraps
801080ef:	e9 50 f7 ff ff       	jmp    80107844 <alltraps>
...
801080f4:	6a 00                	push   $0x0
  pushl $62
801080f6:	6a 3e                	push   $0x3e
  jmp alltraps
801080f8:	e9 47 f7 ff ff       	jmp    80107844 <alltraps>
...
801080fd:	6a 00                	push   $0x0
  pushl $63
801080ff:	6a 3f                	push   $0x3f
  jmp alltraps
80108101:	e9 3e f7 ff ff       	jmp    80107844 <alltraps>
...
80108106:	6a 00                	push   $0x0
  pushl $64
80108108:	6a 40                	push   $0x40
  jmp alltraps
8010810a:	e9 35 f7 ff ff       	jmp    80107844 <alltraps>
...
8010810f:	6a 00                	push   $0x0
  pushl $65
80108111:	6a 41                	push   $0x41
  jmp alltraps
80108113:	e9 2c f7 ff ff       	jmp    80107844 <alltraps>
...
80108118:	6a 00                	push   $0x0
  pushl $66
8010811a:	6a 42                	push   $0x42
  jmp alltraps
8010811c:	e9 23 f7 ff ff       	jmp    80107844 <alltraps>
...
80108121:	6a 00                	push   $0x0
  pushl $67
80108123:	6a 43                	push   $0x43
  jmp alltraps
80108125:	e9 1a f7 ff ff       	jmp    80107844 <alltraps>
...
8010812a:	6a 00                	push   $0x0
  pushl $68
8010812c:	6a 44                	push   $0x44
  jmp alltraps
8010812e:	e9 11 f7 ff ff       	jmp    80107844 <alltraps>
...
80108133:	6a 00                	push   $0x0
  pushl $69
80108135:	6a 45                	push   $0x45
  jmp alltraps
80108137:	e9 08 f7 ff ff       	jmp    80107844 <alltraps>
...
8010813c:	6a 00                	push   $0x0
  pushl $70
8010813e:	6a 46                	push   $0x46
  jmp alltraps
80108140:	e9 ff f6 ff ff       	jmp    80107844 <alltraps>
...
80108145:	6a 00                	push   $0x0
  pushl $71
80108147:	6a 47                	push   $0x47
  jmp alltraps
80108149:	e9 f6 f6 ff ff       	jmp    80107844 <alltraps>
...
8010814e:	6a 00                	push   $0x0
  pushl $72
80108150:	6a 48                	push   $0x48
  jmp alltraps
80108152:	e9 ed f6 ff ff       	jmp    80107844 <alltraps>
...
80108157:	6a 00                	push   $0x0
  pushl $73
80108159:	6a 49                	push   $0x49
  jmp alltraps
8010815b:	e9 e4 f6 ff ff       	jmp    80107844 <alltraps>
...
80108160:	6a 00                	push   $0x0
  pushl $74
80108162:	6a 4a                	push   $0x4a
  jmp alltraps
80108164:	e9 db f6 ff ff       	jmp    80107844 <alltraps>
...
80108169:	6a 00                	push   $0x0
  pushl $75
8010816b:	6a 4b                	push   $0x4b
  jmp alltraps
8010816d:	e9 d2 f6 ff ff       	jmp    80107844 <alltraps>
...
80108172:	6a 00                	push   $0x0
  pushl $76
80108174:	6a 4c                	push   $0x4c
  jmp alltraps
80108176:	e9 c9 f6 ff ff       	jmp    80107844 <alltraps>
...
8010817b:	6a 00                	push   $0x0
  pushl $77
8010817d:	6a 4d                	push   $0x4d
  jmp alltraps
8010817f:	e9 c0 f6 ff ff       	jmp    80107844 <alltraps>
...
80108184:	6a 00                	push   $0x0
  pushl $78
80108186:	6a 4e                	push   $0x4e
  jmp alltraps
80108188:	e9 b7 f6 ff ff       	jmp    80107844 <alltraps>
...
8010818d:	6a 00                	push   $0x0
  pushl $79
8010818f:	6a 4f                	push   $0x4f
  jmp alltraps
80108191:	e9 ae f6 ff ff       	jmp    80107844 <alltraps>
...
80108196:	6a 00                	push   $0x0
  pushl $80
80108198:	6a 50                	push   $0x50
  jmp alltraps
8010819a:	e9 a5 f6 ff ff       	jmp    80107844 <alltraps>
...
8010819f:	6a 00                	push   $0x0
  pushl $81
801081a1:	6a 51                	push   $0x51
  jmp alltraps
801081a3:	e9 9c f6 ff ff       	jmp    80107844 <alltraps>
...
801081a8:	6a 00                	push   $0x0
  pushl $82
801081aa:	6a 52                	push   $0x52
  jmp alltraps
801081ac:	e9 93 f6 ff ff       	jmp    80107844 <alltraps>
...
801081b1:	6a 00                	push   $0x0
  pushl $83
801081b3:	6a 53                	push   $0x53
  jmp alltraps
801081b5:	e9 8a f6 ff ff       	jmp    80107844 <alltraps>
...
801081ba:	6a 00                	push   $0x0
  pushl $84
801081bc:	6a 54                	push   $0x54
  jmp alltraps
801081be:	e9 81 f6 ff ff       	jmp    80107844 <alltraps>
...
801081c3:	6a 00                	push   $0x0
  pushl $85
801081c5:	6a 55                	push   $0x55
  jmp alltraps
801081c7:	e9 78 f6 ff ff       	jmp    80107844 <alltraps>
...
801081cc:	6a 00                	push   $0x0
  pushl $86
801081ce:	6a 56                	push   $0x56
  jmp alltraps
801081d0:	e9 6f f6 ff ff       	jmp    80107844 <alltraps>
...
801081d5:	6a 00                	push   $0x0
  pushl $87
801081d7:	6a 57                	push   $0x57
  jmp alltraps
801081d9:	e9 66 f6 ff ff       	jmp    80107844 <alltraps>
...
801081de:	6a 00                	push   $0x0
  pushl $88
801081e0:	6a 58                	push   $0x58
  jmp alltraps
801081e2:	e9 5d f6 ff ff       	jmp    80107844 <alltraps>
...
801081e7:	6a 00                	push   $0x0
  pushl $89
801081e9:	6a 59                	push   $0x59
  jmp alltraps
801081eb:	e9 54 f6 ff ff       	jmp    80107844 <alltraps>
...
801081f0:	6a 00                	push   $0x0
  pushl $90
801081f2:	6a 5a                	push   $0x5a
  jmp alltraps
801081f4:	e9 4b f6 ff ff       	jmp    80107844 <alltraps>
...
801081f9:	6a 00                	push   $0x0
  pushl $91
801081fb:	6a 5b                	push   $0x5b
  jmp alltraps
801081fd:	e9 42 f6 ff ff       	jmp    80107844 <alltraps>
...
80108202:	6a 00                	push   $0x0
  pushl $92
80108204:	6a 5c                	push   $0x5c
  jmp alltraps
80108206:	e9 39 f6 ff ff       	jmp    80107844 <alltraps>
...
8010820b:	6a 00                	push   $0x0
  pushl $93
8010820d:	6a 5d                	push   $0x5d
  jmp alltraps
8010820f:	e9 30 f6 ff ff       	jmp    80107844 <alltraps>
...
80108214:	6a 00                	push   $0x0
  pushl $94
80108216:	6a 5e                	push   $0x5e
  jmp alltraps
80108218:	e9 27 f6 ff ff       	jmp    80107844 <alltraps>
...
8010821d:	6a 00                	push   $0x0
  pushl $95
8010821f:	6a 5f                	push   $0x5f
  jmp alltraps
80108221:	e9 1e f6 ff ff       	jmp    80107844 <alltraps>
...
80108226:	6a 00                	push   $0x0
  pushl $96
80108228:	6a 60                	push   $0x60
  jmp alltraps
8010822a:	e9 15 f6 ff ff       	jmp    80107844 <alltraps>
...
8010822f:	6a 00                	push   $0x0
  pushl $97
80108231:	6a 61                	push   $0x61
  jmp alltraps
80108233:	e9 0c f6 ff ff       	jmp    80107844 <alltraps>
...
80108238:	6a 00                	push   $0x0
  pushl $98
8010823a:	6a 62                	push   $0x62
  jmp alltraps
8010823c:	e9 03 f6 ff ff       	jmp    80107844 <alltraps>
...
80108241:	6a 00                	push   $0x0
  pushl $99
80108243:	6a 63                	push   $0x63
  jmp alltraps
80108245:	e9 fa f5 ff ff       	jmp    80107844 <alltraps>
...
8010824a:	6a 00                	push   $0x0
  pushl $100
8010824c:	6a 64                	push   $0x64
  jmp alltraps
8010824e:	e9 f1 f5 ff ff       	jmp    80107844 <alltraps>
...
80108253:	6a 00                	push   $0x0
  pushl $101
80108255:	6a 65                	push   $0x65
  jmp alltraps
80108257:	e9 e8 f5 ff ff       	jmp    80107844 <alltraps>
...
8010825c:	6a 00                	push   $0x0
  pushl $102
8010825e:	6a 66                	push   $0x66
  jmp alltraps
80108260:	e9 df f5 ff ff       	jmp    80107844 <alltraps>
...
80108265:	6a 00                	push   $0x0
  pushl $103
80108267:	6a 67                	push   $0x67
  jmp alltraps
80108269:	e9 d6 f5 ff ff       	jmp    80107844 <alltraps>
...
8010826e:	6a 00                	push   $0x0
  pushl $104
80108270:	6a 68                	push   $0x68
  jmp alltraps
80108272:	e9 cd f5 ff ff       	jmp    80107844 <alltraps>
...
80108277:	6a 00                	push   $0x0
  pushl $105
80108279:	6a 69                	push   $0x69
  jmp alltraps
8010827b:	e9 c4 f5 ff ff       	jmp    80107844 <alltraps>
...
80108280:	6a 00                	push   $0x0
  pushl $106
80108282:	6a 6a                	push   $0x6a
  jmp alltraps
80108284:	e9 bb f5 ff ff       	jmp    80107844 <alltraps>
...
80108289:	6a 00                	push   $0x0
  pushl $107
8010828b:	6a 6b                	push   $0x6b
  jmp alltraps
8010828d:	e9 b2 f5 ff ff       	jmp    80107844 <alltraps>
...
80108292:	6a 00                	push   $0x0
  pushl $108
80108294:	6a 6c                	push   $0x6c
  jmp alltraps
80108296:	e9 a9 f5 ff ff       	jmp    80107844 <alltraps>
...
8010829b:	6a 00                	push   $0x0
  pushl $109
8010829d:	6a 6d                	push   $0x6d
  jmp alltraps
8010829f:	e9 a0 f5 ff ff       	jmp    80107844 <alltraps>
...
801082a4:	6a 00                	push   $0x0
  pushl $110
801082a6:	6a 6e                	push   $0x6e
  jmp alltraps
801082a8:	e9 97 f5 ff ff       	jmp    80107844 <alltraps>
...
801082ad:	6a 00                	push   $0x0
  pushl $111
801082af:	6a 6f                	push   $0x6f
  jmp alltraps
801082b1:	e9 8e f5 ff ff       	jmp    80107844 <alltraps>
...
801082b6:	6a 00                	push   $0x0
  pushl $112
801082b8:	6a 70                	push   $0x70
  jmp alltraps
801082ba:	e9 85 f5 ff ff       	jmp    80107844 <alltraps>
...
801082bf:	6a 00                	push   $0x0
  pushl $113
801082c1:	6a 71                	push   $0x71
  jmp alltraps
801082c3:	e9 7c f5 ff ff       	jmp    80107844 <alltraps>
...
801082c8:	6a 00                	push   $0x0
  pushl $114
801082ca:	6a 72                	push   $0x72
  jmp alltraps
801082cc:	e9 73 f5 ff ff       	jmp    80107844 <alltraps>
...
801082d1:	6a 00                	push   $0x0
  pushl $115
801082d3:	6a 73                	push   $0x73
  jmp alltraps
801082d5:	e9 6a f5 ff ff       	jmp    80107844 <alltraps>
...
801082da:	6a 00                	push   $0x0
  pushl $116
801082dc:	6a 74                	push   $0x74
  jmp alltraps
801082de:	e9 61 f5 ff ff       	jmp    80107844 <alltraps>
...
801082e3:	6a 00                	push   $0x0
  pushl $117
801082e5:	6a 75                	push   $0x75
  jmp alltraps
801082e7:	e9 58 f5 ff ff       	jmp    80107844 <alltraps>
...
801082ec:	6a 00                	push   $0x0
  pushl $118
801082ee:	6a 76                	push   $0x76
  jmp alltraps
801082f0:	e9 4f f5 ff ff       	jmp    80107844 <alltraps>
...
801082f5:	6a 00                	push   $0x0
  pushl $119
801082f7:	6a 77                	push   $0x77
  jmp alltraps
801082f9:	e9 46 f5 ff ff       	jmp    80107844 <alltraps>
...
801082fe:	6a 00                	push   $0x0
  pushl $120
80108300:	6a 78                	push   $0x78
  jmp alltraps
80108302:	e9 3d f5 ff ff       	jmp    80107844 <alltraps>
...
80108307:	6a 00                	push   $0x0
  pushl $121
80108309:	6a 79                	push   $0x79
  jmp alltraps
8010830b:	e9 34 f5 ff ff       	jmp    80107844 <alltraps>
...
80108310:	6a 00                	push   $0x0
  pushl $122
80108312:	6a 7a                	push   $0x7a
  jmp alltraps
80108314:	e9 2b f5 ff ff       	jmp    80107844 <alltraps>
...
80108319:	6a 00                	push   $0x0
  pushl $123
8010831b:	6a 7b                	push   $0x7b
  jmp alltraps
8010831d:	e9 22 f5 ff ff       	jmp    80107844 <alltraps>
...
80108322:	6a 00                	push   $0x0
  pushl $124
80108324:	6a 7c                	push   $0x7c
  jmp alltraps
80108326:	e9 19 f5 ff ff       	jmp    80107844 <alltraps>
...
8010832b:	6a 00                	push   $0x0
  pushl $125
8010832d:	6a 7d                	push   $0x7d
  jmp alltraps
8010832f:	e9 10 f5 ff ff       	jmp    80107844 <alltraps>
...
80108334:	6a 00                	push   $0x0
  pushl $126
80108336:	6a 7e                	push   $0x7e
  jmp alltraps
80108338:	e9 07 f5 ff ff       	jmp    80107844 <alltraps>
...
8010833d:	6a 00                	push   $0x0
  pushl $127
8010833f:	6a 7f                	push   $0x7f
  jmp alltraps
80108341:	e9 fe f4 ff ff       	jmp    80107844 <alltraps>
...
80108346:	6a 00                	push   $0x0
  pushl $128
80108348:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010834d:	e9 f2 f4 ff ff       	jmp    80107844 <alltraps>
...
80108352:	6a 00                	push   $0x0
  pushl $129
80108354:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80108359:	e9 e6 f4 ff ff       	jmp    80107844 <alltraps>
...
8010835e:	6a 00                	push   $0x0
  pushl $130
80108360:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80108365:	e9 da f4 ff ff       	jmp    80107844 <alltraps>
...
8010836a:	6a 00                	push   $0x0
  pushl $131
8010836c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80108371:	e9 ce f4 ff ff       	jmp    80107844 <alltraps>
...
80108376:	6a 00                	push   $0x0
  pushl $132
80108378:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010837d:	e9 c2 f4 ff ff       	jmp    80107844 <alltraps>
...
80108382:	6a 00                	push   $0x0
  pushl $133
80108384:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80108389:	e9 b6 f4 ff ff       	jmp    80107844 <alltraps>
...
8010838e:	6a 00                	push   $0x0
  pushl $134
80108390:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80108395:	e9 aa f4 ff ff       	jmp    80107844 <alltraps>
...
8010839a:	6a 00                	push   $0x0
  pushl $135
8010839c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801083a1:	e9 9e f4 ff ff       	jmp    80107844 <alltraps>
...
801083a6:	6a 00                	push   $0x0
  pushl $136
801083a8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801083ad:	e9 92 f4 ff ff       	jmp    80107844 <alltraps>
...
801083b2:	6a 00                	push   $0x0
  pushl $137
801083b4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801083b9:	e9 86 f4 ff ff       	jmp    80107844 <alltraps>
...
801083be:	6a 00                	push   $0x0
  pushl $138
801083c0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801083c5:	e9 7a f4 ff ff       	jmp    80107844 <alltraps>
...
801083ca:	6a 00                	push   $0x0
  pushl $139
801083cc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801083d1:	e9 6e f4 ff ff       	jmp    80107844 <alltraps>
...
801083d6:	6a 00                	push   $0x0
  pushl $140
801083d8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801083dd:	e9 62 f4 ff ff       	jmp    80107844 <alltraps>
...
801083e2:	6a 00                	push   $0x0
  pushl $141
801083e4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801083e9:	e9 56 f4 ff ff       	jmp    80107844 <alltraps>
...
801083ee:	6a 00                	push   $0x0
  pushl $142
801083f0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801083f5:	e9 4a f4 ff ff       	jmp    80107844 <alltraps>
...
801083fa:	6a 00                	push   $0x0
  pushl $143
801083fc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80108401:	e9 3e f4 ff ff       	jmp    80107844 <alltraps>
...
80108406:	6a 00                	push   $0x0
  pushl $144
80108408:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010840d:	e9 32 f4 ff ff       	jmp    80107844 <alltraps>
...
80108412:	6a 00                	push   $0x0
  pushl $145
80108414:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80108419:	e9 26 f4 ff ff       	jmp    80107844 <alltraps>
...
8010841e:	6a 00                	push   $0x0
  pushl $146
80108420:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80108425:	e9 1a f4 ff ff       	jmp    80107844 <alltraps>
...
8010842a:	6a 00                	push   $0x0
  pushl $147
8010842c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80108431:	e9 0e f4 ff ff       	jmp    80107844 <alltraps>
...
80108436:	6a 00                	push   $0x0
  pushl $148
80108438:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010843d:	e9 02 f4 ff ff       	jmp    80107844 <alltraps>
...
80108442:	6a 00                	push   $0x0
  pushl $149
80108444:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80108449:	e9 f6 f3 ff ff       	jmp    80107844 <alltraps>
...
8010844e:	6a 00                	push   $0x0
  pushl $150
80108450:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80108455:	e9 ea f3 ff ff       	jmp    80107844 <alltraps>
...
8010845a:	6a 00                	push   $0x0
  pushl $151
8010845c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80108461:	e9 de f3 ff ff       	jmp    80107844 <alltraps>
...
80108466:	6a 00                	push   $0x0
  pushl $152
80108468:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010846d:	e9 d2 f3 ff ff       	jmp    80107844 <alltraps>
...
80108472:	6a 00                	push   $0x0
  pushl $153
80108474:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80108479:	e9 c6 f3 ff ff       	jmp    80107844 <alltraps>
...
8010847e:	6a 00                	push   $0x0
  pushl $154
80108480:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80108485:	e9 ba f3 ff ff       	jmp    80107844 <alltraps>
...
8010848a:	6a 00                	push   $0x0
  pushl $155
8010848c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80108491:	e9 ae f3 ff ff       	jmp    80107844 <alltraps>
...
80108496:	6a 00                	push   $0x0
  pushl $156
80108498:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010849d:	e9 a2 f3 ff ff       	jmp    80107844 <alltraps>
...
801084a2:	6a 00                	push   $0x0
  pushl $157
801084a4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801084a9:	e9 96 f3 ff ff       	jmp    80107844 <alltraps>
...
801084ae:	6a 00                	push   $0x0
  pushl $158
801084b0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801084b5:	e9 8a f3 ff ff       	jmp    80107844 <alltraps>
...
801084ba:	6a 00                	push   $0x0
  pushl $159
801084bc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801084c1:	e9 7e f3 ff ff       	jmp    80107844 <alltraps>
...
801084c6:	6a 00                	push   $0x0
  pushl $160
801084c8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801084cd:	e9 72 f3 ff ff       	jmp    80107844 <alltraps>
...
801084d2:	6a 00                	push   $0x0
  pushl $161
801084d4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801084d9:	e9 66 f3 ff ff       	jmp    80107844 <alltraps>
...
801084de:	6a 00                	push   $0x0
  pushl $162
801084e0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801084e5:	e9 5a f3 ff ff       	jmp    80107844 <alltraps>
...
801084ea:	6a 00                	push   $0x0
  pushl $163
801084ec:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801084f1:	e9 4e f3 ff ff       	jmp    80107844 <alltraps>
...
801084f6:	6a 00                	push   $0x0
  pushl $164
801084f8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801084fd:	e9 42 f3 ff ff       	jmp    80107844 <alltraps>
...
80108502:	6a 00                	push   $0x0
  pushl $165
80108504:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80108509:	e9 36 f3 ff ff       	jmp    80107844 <alltraps>
...
8010850e:	6a 00                	push   $0x0
  pushl $166
80108510:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80108515:	e9 2a f3 ff ff       	jmp    80107844 <alltraps>
...
8010851a:	6a 00                	push   $0x0
  pushl $167
8010851c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80108521:	e9 1e f3 ff ff       	jmp    80107844 <alltraps>
...
80108526:	6a 00                	push   $0x0
  pushl $168
80108528:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010852d:	e9 12 f3 ff ff       	jmp    80107844 <alltraps>
...
80108532:	6a 00                	push   $0x0
  pushl $169
80108534:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80108539:	e9 06 f3 ff ff       	jmp    80107844 <alltraps>
...
8010853e:	6a 00                	push   $0x0
  pushl $170
80108540:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80108545:	e9 fa f2 ff ff       	jmp    80107844 <alltraps>
...
8010854a:	6a 00                	push   $0x0
  pushl $171
8010854c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80108551:	e9 ee f2 ff ff       	jmp    80107844 <alltraps>
...
80108556:	6a 00                	push   $0x0
  pushl $172
80108558:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010855d:	e9 e2 f2 ff ff       	jmp    80107844 <alltraps>
...
80108562:	6a 00                	push   $0x0
  pushl $173
80108564:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80108569:	e9 d6 f2 ff ff       	jmp    80107844 <alltraps>
...
8010856e:	6a 00                	push   $0x0
  pushl $174
80108570:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80108575:	e9 ca f2 ff ff       	jmp    80107844 <alltraps>
...
8010857a:	6a 00                	push   $0x0
  pushl $175
8010857c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80108581:	e9 be f2 ff ff       	jmp    80107844 <alltraps>
...
80108586:	6a 00                	push   $0x0
  pushl $176
80108588:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010858d:	e9 b2 f2 ff ff       	jmp    80107844 <alltraps>
...
80108592:	6a 00                	push   $0x0
  pushl $177
80108594:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80108599:	e9 a6 f2 ff ff       	jmp    80107844 <alltraps>
...
8010859e:	6a 00                	push   $0x0
  pushl $178
801085a0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801085a5:	e9 9a f2 ff ff       	jmp    80107844 <alltraps>
...
801085aa:	6a 00                	push   $0x0
  pushl $179
801085ac:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801085b1:	e9 8e f2 ff ff       	jmp    80107844 <alltraps>
...
801085b6:	6a 00                	push   $0x0
  pushl $180
801085b8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801085bd:	e9 82 f2 ff ff       	jmp    80107844 <alltraps>
...
801085c2:	6a 00                	push   $0x0
  pushl $181
801085c4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801085c9:	e9 76 f2 ff ff       	jmp    80107844 <alltraps>
...
801085ce:	6a 00                	push   $0x0
  pushl $182
801085d0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801085d5:	e9 6a f2 ff ff       	jmp    80107844 <alltraps>
...
801085da:	6a 00                	push   $0x0
  pushl $183
801085dc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801085e1:	e9 5e f2 ff ff       	jmp    80107844 <alltraps>
...
801085e6:	6a 00                	push   $0x0
  pushl $184
801085e8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801085ed:	e9 52 f2 ff ff       	jmp    80107844 <alltraps>
...
801085f2:	6a 00                	push   $0x0
  pushl $185
801085f4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801085f9:	e9 46 f2 ff ff       	jmp    80107844 <alltraps>
...
801085fe:	6a 00                	push   $0x0
  pushl $186
80108600:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80108605:	e9 3a f2 ff ff       	jmp    80107844 <alltraps>
...
8010860a:	6a 00                	push   $0x0
  pushl $187
8010860c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80108611:	e9 2e f2 ff ff       	jmp    80107844 <alltraps>
...
80108616:	6a 00                	push   $0x0
  pushl $188
80108618:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010861d:	e9 22 f2 ff ff       	jmp    80107844 <alltraps>
...
80108622:	6a 00                	push   $0x0
  pushl $189
80108624:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80108629:	e9 16 f2 ff ff       	jmp    80107844 <alltraps>
...
8010862e:	6a 00                	push   $0x0
  pushl $190
80108630:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80108635:	e9 0a f2 ff ff       	jmp    80107844 <alltraps>
...
8010863a:	6a 00                	push   $0x0
  pushl $191
8010863c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80108641:	e9 fe f1 ff ff       	jmp    80107844 <alltraps>
...
80108646:	6a 00                	push   $0x0
  pushl $192
80108648:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010864d:	e9 f2 f1 ff ff       	jmp    80107844 <alltraps>
...
80108652:	6a 00                	push   $0x0
  pushl $193
80108654:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80108659:	e9 e6 f1 ff ff       	jmp    80107844 <alltraps>
...
8010865e:	6a 00                	push   $0x0
  pushl $194
80108660:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80108665:	e9 da f1 ff ff       	jmp    80107844 <alltraps>
...
8010866a:	6a 00                	push   $0x0
  pushl $195
8010866c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80108671:	e9 ce f1 ff ff       	jmp    80107844 <alltraps>
...
80108676:	6a 00                	push   $0x0
  pushl $196
80108678:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010867d:	e9 c2 f1 ff ff       	jmp    80107844 <alltraps>
...
80108682:	6a 00                	push   $0x0
  pushl $197
80108684:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80108689:	e9 b6 f1 ff ff       	jmp    80107844 <alltraps>
...
8010868e:	6a 00                	push   $0x0
  pushl $198
80108690:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80108695:	e9 aa f1 ff ff       	jmp    80107844 <alltraps>
...
8010869a:	6a 00                	push   $0x0
  pushl $199
8010869c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801086a1:	e9 9e f1 ff ff       	jmp    80107844 <alltraps>
...
801086a6:	6a 00                	push   $0x0
  pushl $200
801086a8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801086ad:	e9 92 f1 ff ff       	jmp    80107844 <alltraps>
...
801086b2:	6a 00                	push   $0x0
  pushl $201
801086b4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801086b9:	e9 86 f1 ff ff       	jmp    80107844 <alltraps>
...
801086be:	6a 00                	push   $0x0
  pushl $202
801086c0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801086c5:	e9 7a f1 ff ff       	jmp    80107844 <alltraps>
...
801086ca:	6a 00                	push   $0x0
  pushl $203
801086cc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801086d1:	e9 6e f1 ff ff       	jmp    80107844 <alltraps>
...
801086d6:	6a 00                	push   $0x0
  pushl $204
801086d8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801086dd:	e9 62 f1 ff ff       	jmp    80107844 <alltraps>
...
801086e2:	6a 00                	push   $0x0
  pushl $205
801086e4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801086e9:	e9 56 f1 ff ff       	jmp    80107844 <alltraps>
...
801086ee:	6a 00                	push   $0x0
  pushl $206
801086f0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801086f5:	e9 4a f1 ff ff       	jmp    80107844 <alltraps>
...
801086fa:	6a 00                	push   $0x0
  pushl $207
801086fc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80108701:	e9 3e f1 ff ff       	jmp    80107844 <alltraps>
...
80108706:	6a 00                	push   $0x0
  pushl $208
80108708:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010870d:	e9 32 f1 ff ff       	jmp    80107844 <alltraps>
...
80108712:	6a 00                	push   $0x0
  pushl $209
80108714:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80108719:	e9 26 f1 ff ff       	jmp    80107844 <alltraps>
...
8010871e:	6a 00                	push   $0x0
  pushl $210
80108720:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80108725:	e9 1a f1 ff ff       	jmp    80107844 <alltraps>
...
8010872a:	6a 00                	push   $0x0
  pushl $211
8010872c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80108731:	e9 0e f1 ff ff       	jmp    80107844 <alltraps>
...
80108736:	6a 00                	push   $0x0
  pushl $212
80108738:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010873d:	e9 02 f1 ff ff       	jmp    80107844 <alltraps>
...
80108742:	6a 00                	push   $0x0
  pushl $213
80108744:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80108749:	e9 f6 f0 ff ff       	jmp    80107844 <alltraps>
...
8010874e:	6a 00                	push   $0x0
  pushl $214
80108750:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80108755:	e9 ea f0 ff ff       	jmp    80107844 <alltraps>
...
8010875a:	6a 00                	push   $0x0
  pushl $215
8010875c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80108761:	e9 de f0 ff ff       	jmp    80107844 <alltraps>
...
80108766:	6a 00                	push   $0x0
  pushl $216
80108768:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010876d:	e9 d2 f0 ff ff       	jmp    80107844 <alltraps>
...
80108772:	6a 00                	push   $0x0
  pushl $217
80108774:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80108779:	e9 c6 f0 ff ff       	jmp    80107844 <alltraps>
...
8010877e:	6a 00                	push   $0x0
  pushl $218
80108780:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80108785:	e9 ba f0 ff ff       	jmp    80107844 <alltraps>
...
8010878a:	6a 00                	push   $0x0
  pushl $219
8010878c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80108791:	e9 ae f0 ff ff       	jmp    80107844 <alltraps>
...
80108796:	6a 00                	push   $0x0
  pushl $220
80108798:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010879d:	e9 a2 f0 ff ff       	jmp    80107844 <alltraps>
...
801087a2:	6a 00                	push   $0x0
  pushl $221
801087a4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801087a9:	e9 96 f0 ff ff       	jmp    80107844 <alltraps>
...
801087ae:	6a 00                	push   $0x0
  pushl $222
801087b0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801087b5:	e9 8a f0 ff ff       	jmp    80107844 <alltraps>
...
801087ba:	6a 00                	push   $0x0
  pushl $223
801087bc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801087c1:	e9 7e f0 ff ff       	jmp    80107844 <alltraps>
...
801087c6:	6a 00                	push   $0x0
  pushl $224
801087c8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801087cd:	e9 72 f0 ff ff       	jmp    80107844 <alltraps>
...
801087d2:	6a 00                	push   $0x0
  pushl $225
801087d4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801087d9:	e9 66 f0 ff ff       	jmp    80107844 <alltraps>
...
801087de:	6a 00                	push   $0x0
  pushl $226
801087e0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801087e5:	e9 5a f0 ff ff       	jmp    80107844 <alltraps>
...
801087ea:	6a 00                	push   $0x0
  pushl $227
801087ec:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801087f1:	e9 4e f0 ff ff       	jmp    80107844 <alltraps>
...
801087f6:	6a 00                	push   $0x0
  pushl $228
801087f8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801087fd:	e9 42 f0 ff ff       	jmp    80107844 <alltraps>
...
80108802:	6a 00                	push   $0x0
  pushl $229
80108804:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80108809:	e9 36 f0 ff ff       	jmp    80107844 <alltraps>
...
8010880e:	6a 00                	push   $0x0
  pushl $230
80108810:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80108815:	e9 2a f0 ff ff       	jmp    80107844 <alltraps>
...
8010881a:	6a 00                	push   $0x0
  pushl $231
8010881c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80108821:	e9 1e f0 ff ff       	jmp    80107844 <alltraps>
...
80108826:	6a 00                	push   $0x0
  pushl $232
80108828:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010882d:	e9 12 f0 ff ff       	jmp    80107844 <alltraps>
...
80108832:	6a 00                	push   $0x0
  pushl $233
80108834:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80108839:	e9 06 f0 ff ff       	jmp    80107844 <alltraps>
...
8010883e:	6a 00                	push   $0x0
  pushl $234
80108840:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80108845:	e9 fa ef ff ff       	jmp    80107844 <alltraps>
...
8010884a:	6a 00                	push   $0x0
  pushl $235
8010884c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80108851:	e9 ee ef ff ff       	jmp    80107844 <alltraps>
...
80108856:	6a 00                	push   $0x0
  pushl $236
80108858:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010885d:	e9 e2 ef ff ff       	jmp    80107844 <alltraps>
...
80108862:	6a 00                	push   $0x0
  pushl $237
80108864:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80108869:	e9 d6 ef ff ff       	jmp    80107844 <alltraps>
...
8010886e:	6a 00                	push   $0x0
  pushl $238
80108870:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80108875:	e9 ca ef ff ff       	jmp    80107844 <alltraps>
...
8010887a:	6a 00                	push   $0x0
  pushl $239
8010887c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80108881:	e9 be ef ff ff       	jmp    80107844 <alltraps>
...
80108886:	6a 00                	push   $0x0
  pushl $240
80108888:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010888d:	e9 b2 ef ff ff       	jmp    80107844 <alltraps>
...
80108892:	6a 00                	push   $0x0
  pushl $241
80108894:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80108899:	e9 a6 ef ff ff       	jmp    80107844 <alltraps>
...
8010889e:	6a 00                	push   $0x0
  pushl $242
801088a0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801088a5:	e9 9a ef ff ff       	jmp    80107844 <alltraps>
...
801088aa:	6a 00                	push   $0x0
  pushl $243
801088ac:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801088b1:	e9 8e ef ff ff       	jmp    80107844 <alltraps>
...
801088b6:	6a 00                	push   $0x0
  pushl $244
801088b8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801088bd:	e9 82 ef ff ff       	jmp    80107844 <alltraps>
...
801088c2:	6a 00                	push   $0x0
  pushl $245
801088c4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801088c9:	e9 76 ef ff ff       	jmp    80107844 <alltraps>
...
801088ce:	6a 00                	push   $0x0
  pushl $246
801088d0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801088d5:	e9 6a ef ff ff       	jmp    80107844 <alltraps>
...
801088da:	6a 00                	push   $0x0
  pushl $247
801088dc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801088e1:	e9 5e ef ff ff       	jmp    80107844 <alltraps>
...
801088e6:	6a 00                	push   $0x0
  pushl $248
801088e8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801088ed:	e9 52 ef ff ff       	jmp    80107844 <alltraps>
...
801088f2:	6a 00                	push   $0x0
  pushl $249
801088f4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801088f9:	e9 46 ef ff ff       	jmp    80107844 <alltraps>
...
801088fe:	6a 00                	push   $0x0
  pushl $250
80108900:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80108905:	e9 3a ef ff ff       	jmp    80107844 <alltraps>
...
8010890a:	6a 00                	push   $0x0
  pushl $251
8010890c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80108911:	e9 2e ef ff ff       	jmp    80107844 <alltraps>
...
80108916:	6a 00                	push   $0x0
  pushl $252
80108918:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010891d:	e9 22 ef ff ff       	jmp    80107844 <alltraps>
...
80108922:	6a 00                	push   $0x0
  pushl $253
80108924:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80108929:	e9 16 ef ff ff       	jmp    80107844 <alltraps>
...
8010892e:	6a 00                	push   $0x0
  pushl $254
80108930:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80108935:	e9 0a ef ff ff       	jmp    80107844 <alltraps>
...
8010893a:	6a 00                	push   $0x0
  pushl $255
8010893c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80108941:	e9 fe ee ff ff       	jmp    80107844 <alltraps>
	...
...
8010894b:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
8010894e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108951:	83 e8 01             	sub    $0x1,%eax
80108954:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80108958:	8b 45 08             	mov    0x8(%ebp),%eax
8010895b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010895f:	8b 45 08             	mov    0x8(%ebp),%eax
80108962:	c1 e8 10             	shr    $0x10,%eax
80108965:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80108969:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010896c:	0f 01 10             	lgdtl  (%eax)
}
8010896f:	c9                   	leave  
80108970:	c3                   	ret    
...
8010897a:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
8010897e:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80108982:	0f 00 d8             	ltr    %ax
}
80108985:	c9                   	leave  
80108986:	c3                   	ret    
...
80108990:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80108994:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80108998:	8e e8                	mov    %eax,%gs
}
8010899a:	c9                   	leave  
8010899b:	c3                   	ret    
...
801089b7:	8b 45 08             	mov    0x8(%ebp),%eax
801089ba:	05 00 00 00 80       	add    $0x80000000,%eax
801089bf:	5d                   	pop    %ebp
801089c0:	c3                   	ret    
...
seginit(void)
{
801089c1:	55                   	push   %ebp
801089c2:	89 e5                	mov    %esp,%ebp
801089c4:	53                   	push   %ebx
801089c5:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801089c8:	e8 b4 a4 ff ff       	call   80102e81 <cpunum>
801089cd:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801089d3:	05 80 19 11 80       	add    $0x80111980,%eax
801089d8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801089db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089de:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801089e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089e7:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801089ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089f0:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801089f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089f7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801089fb:	83 e2 f0             	and    $0xfffffff0,%edx
801089fe:	83 ca 0a             	or     $0xa,%edx
80108a01:	88 50 7d             	mov    %dl,0x7d(%eax)
80108a04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a07:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108a0b:	83 ca 10             	or     $0x10,%edx
80108a0e:	88 50 7d             	mov    %dl,0x7d(%eax)
80108a11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a14:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108a18:	83 e2 9f             	and    $0xffffff9f,%edx
80108a1b:	88 50 7d             	mov    %dl,0x7d(%eax)
80108a1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a21:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108a25:	83 ca 80             	or     $0xffffff80,%edx
80108a28:	88 50 7d             	mov    %dl,0x7d(%eax)
80108a2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a2e:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a32:	83 ca 0f             	or     $0xf,%edx
80108a35:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a3b:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a3f:	83 e2 ef             	and    $0xffffffef,%edx
80108a42:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a48:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a4c:	83 e2 df             	and    $0xffffffdf,%edx
80108a4f:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a55:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a59:	83 ca 40             	or     $0x40,%edx
80108a5c:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a62:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a66:	83 ca 80             	or     $0xffffff80,%edx
80108a69:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a6f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108a73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a76:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80108a7d:	ff ff 
80108a7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a82:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80108a89:	00 00 
80108a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a8e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80108a95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a98:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108a9f:	83 e2 f0             	and    $0xfffffff0,%edx
80108aa2:	83 ca 02             	or     $0x2,%edx
80108aa5:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108aab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108aae:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108ab5:	83 ca 10             	or     $0x10,%edx
80108ab8:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108abe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ac1:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108ac8:	83 e2 9f             	and    $0xffffff9f,%edx
80108acb:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108ad1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ad4:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108adb:	83 ca 80             	or     $0xffffff80,%edx
80108ade:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108ae4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ae7:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108aee:	83 ca 0f             	or     $0xf,%edx
80108af1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108af7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108afa:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108b01:	83 e2 ef             	and    $0xffffffef,%edx
80108b04:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108b0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b0d:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108b14:	83 e2 df             	and    $0xffffffdf,%edx
80108b17:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108b1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b20:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108b27:	83 ca 40             	or     $0x40,%edx
80108b2a:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108b30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b33:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108b3a:	83 ca 80             	or     $0xffffff80,%edx
80108b3d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108b43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b46:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108b4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b50:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80108b57:	ff ff 
80108b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b5c:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108b63:	00 00 
80108b65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b68:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80108b6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b72:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b79:	83 e2 f0             	and    $0xfffffff0,%edx
80108b7c:	83 ca 0a             	or     $0xa,%edx
80108b7f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b88:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b8f:	83 ca 10             	or     $0x10,%edx
80108b92:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b9b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108ba2:	83 ca 60             	or     $0x60,%edx
80108ba5:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108bab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bae:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108bb5:	83 ca 80             	or     $0xffffff80,%edx
80108bb8:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108bbe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bc1:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108bc8:	83 ca 0f             	or     $0xf,%edx
80108bcb:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108bd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bd4:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108bdb:	83 e2 ef             	and    $0xffffffef,%edx
80108bde:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108be4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108be7:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108bee:	83 e2 df             	and    $0xffffffdf,%edx
80108bf1:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108bf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bfa:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108c01:	83 ca 40             	or     $0x40,%edx
80108c04:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108c0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c0d:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108c14:	83 ca 80             	or     $0xffffff80,%edx
80108c17:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c20:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108c27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c2a:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80108c31:	ff ff 
80108c33:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c36:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108c3d:	00 00 
80108c3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c42:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80108c49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c4c:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c53:	83 e2 f0             	and    $0xfffffff0,%edx
80108c56:	83 ca 02             	or     $0x2,%edx
80108c59:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c62:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c69:	83 ca 10             	or     $0x10,%edx
80108c6c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c75:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c7c:	83 ca 60             	or     $0x60,%edx
80108c7f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c88:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c8f:	83 ca 80             	or     $0xffffff80,%edx
80108c92:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c9b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108ca2:	83 ca 0f             	or     $0xf,%edx
80108ca5:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108cab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cae:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108cb5:	83 e2 ef             	and    $0xffffffef,%edx
80108cb8:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108cbe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cc1:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108cc8:	83 e2 df             	and    $0xffffffdf,%edx
80108ccb:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108cd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cd4:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108cdb:	83 ca 40             	or     $0x40,%edx
80108cde:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108ce4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ce7:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108cee:	83 ca 80             	or     $0xffffff80,%edx
80108cf1:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108cf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cfa:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80108d01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d04:	05 b4 00 00 00       	add    $0xb4,%eax
80108d09:	89 c3                	mov    %eax,%ebx
80108d0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d0e:	05 b4 00 00 00       	add    $0xb4,%eax
80108d13:	c1 e8 10             	shr    $0x10,%eax
80108d16:	89 c1                	mov    %eax,%ecx
80108d18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d1b:	05 b4 00 00 00       	add    $0xb4,%eax
80108d20:	c1 e8 18             	shr    $0x18,%eax
80108d23:	89 c2                	mov    %eax,%edx
80108d25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d28:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80108d2f:	00 00 
80108d31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d34:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80108d3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d3e:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108d44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d47:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d4e:	83 e1 f0             	and    $0xfffffff0,%ecx
80108d51:	83 c9 02             	or     $0x2,%ecx
80108d54:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d5d:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d64:	83 c9 10             	or     $0x10,%ecx
80108d67:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d70:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d77:	83 e1 9f             	and    $0xffffff9f,%ecx
80108d7a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d83:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d8a:	83 c9 80             	or     $0xffffff80,%ecx
80108d8d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d96:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d9d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108da0:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108da6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108da9:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108db0:	83 e1 ef             	and    $0xffffffef,%ecx
80108db3:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108db9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dbc:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108dc3:	83 e1 df             	and    $0xffffffdf,%ecx
80108dc6:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108dcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dcf:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108dd6:	83 c9 40             	or     $0x40,%ecx
80108dd9:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108ddf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108de2:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108de9:	83 c9 80             	or     $0xffffff80,%ecx
80108dec:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108df2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108df5:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108dfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dfe:	83 c0 70             	add    $0x70,%eax
80108e01:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108e08:	00 
80108e09:	89 04 24             	mov    %eax,(%esp)
80108e0c:	e8 37 fb ff ff       	call   80108948 <lgdt>
  loadgs(SEG_KCPU << 3);
80108e11:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108e18:	e8 6a fb ff ff       	call   80108987 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108e1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e20:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80108e26:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108e2d:	00 00 00 00 
}
80108e31:	83 c4 24             	add    $0x24,%esp
80108e34:	5b                   	pop    %ebx
80108e35:	5d                   	pop    %ebp
80108e36:	c3                   	ret    
...
80108e3a:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80108e3d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108e40:	c1 e8 16             	shr    $0x16,%eax
80108e43:	c1 e0 02             	shl    $0x2,%eax
80108e46:	03 45 08             	add    0x8(%ebp),%eax
80108e49:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80108e4c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108e4f:	8b 00                	mov    (%eax),%eax
80108e51:	83 e0 01             	and    $0x1,%eax
80108e54:	84 c0                	test   %al,%al
80108e56:	74 17                	je     80108e6f <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80108e58:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108e5b:	8b 00                	mov    (%eax),%eax
80108e5d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e62:	89 04 24             	mov    %eax,(%esp)
80108e65:	e8 4a fb ff ff       	call   801089b4 <p2v>
80108e6a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108e6d:	eb 4b                	jmp    80108eba <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108e6f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108e73:	74 0e                	je     80108e83 <walkpgdir+0x4c>
80108e75:	e8 79 9c ff ff       	call   80102af3 <kalloc>
80108e7a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108e7d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108e81:	75 07                	jne    80108e8a <walkpgdir+0x53>
      return 0;
80108e83:	b8 00 00 00 00       	mov    $0x0,%eax
80108e88:	eb 41                	jmp    80108ecb <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80108e8a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108e91:	00 
80108e92:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108e99:	00 
80108e9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e9d:	89 04 24             	mov    %eax,(%esp)
80108ea0:	e8 ad d3 ff ff       	call   80106252 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80108ea5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ea8:	89 04 24             	mov    %eax,(%esp)
80108eab:	e8 f7 fa ff ff       	call   801089a7 <v2p>
80108eb0:	89 c2                	mov    %eax,%edx
80108eb2:	83 ca 07             	or     $0x7,%edx
80108eb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108eb8:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80108eba:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ebd:	c1 e8 0c             	shr    $0xc,%eax
80108ec0:	25 ff 03 00 00       	and    $0x3ff,%eax
80108ec5:	c1 e0 02             	shl    $0x2,%eax
80108ec8:	03 45 f4             	add    -0xc(%ebp),%eax
}
80108ecb:	c9                   	leave  
80108ecc:	c3                   	ret    
...
80108ed0:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80108ed3:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ed6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108edb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80108ede:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ee1:	03 45 10             	add    0x10(%ebp),%eax
80108ee4:	83 e8 01             	sub    $0x1,%eax
80108ee7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108eec:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108eef:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108ef6:	00 
80108ef7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108efa:	89 44 24 04          	mov    %eax,0x4(%esp)
80108efe:	8b 45 08             	mov    0x8(%ebp),%eax
80108f01:	89 04 24             	mov    %eax,(%esp)
80108f04:	e8 2e ff ff ff       	call   80108e37 <walkpgdir>
80108f09:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108f0c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108f10:	75 07                	jne    80108f19 <mappages+0x4c>
      return -1;
80108f12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108f17:	eb 46                	jmp    80108f5f <mappages+0x92>
    if(*pte & PTE_P)
80108f19:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108f1c:	8b 00                	mov    (%eax),%eax
80108f1e:	83 e0 01             	and    $0x1,%eax
80108f21:	84 c0                	test   %al,%al
80108f23:	74 0c                	je     80108f31 <mappages+0x64>
      panic("remap");
80108f25:	c7 04 24 34 9f 10 80 	movl   $0x80109f34,(%esp)
80108f2c:	e8 0c 76 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80108f31:	8b 45 18             	mov    0x18(%ebp),%eax
80108f34:	0b 45 14             	or     0x14(%ebp),%eax
80108f37:	89 c2                	mov    %eax,%edx
80108f39:	83 ca 01             	or     $0x1,%edx
80108f3c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108f3f:	89 10                	mov    %edx,(%eax)
    if(a == last)
80108f41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f44:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108f47:	74 10                	je     80108f59 <mappages+0x8c>
      break;
    a += PGSIZE;
80108f49:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80108f50:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108f57:	eb 96                	jmp    80108eef <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108f64:	53                   	push   %ebx
80108f65:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108f68:	e8 86 9b ff ff       	call   80102af3 <kalloc>
80108f6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108f70:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108f74:	75 0a                	jne    80108f80 <setupkvm+0x1f>
    return 0;
80108f76:	b8 00 00 00 00       	mov    $0x0,%eax
80108f7b:	e9 98 00 00 00       	jmp    80109018 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80108f80:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108f87:	00 
80108f88:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108f8f:	00 
80108f90:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108f93:	89 04 24             	mov    %eax,(%esp)
80108f96:	e8 b7 d2 ff ff       	call   80106252 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108f9b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108fa2:	e8 0d fa ff ff       	call   801089b4 <p2v>
80108fa7:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108fac:	76 0c                	jbe    80108fba <setupkvm+0x59>
    panic("PHYSTOP too high");
80108fae:	c7 04 24 3a 9f 10 80 	movl   $0x80109f3a,(%esp)
80108fb5:	e8 83 75 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108fba:	c7 45 f4 00 d5 10 80 	movl   $0x8010d500,-0xc(%ebp)
80108fc1:	eb 49                	jmp    8010900c <setupkvm+0xab>
...
80108fc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108fc6:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108fc9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108fcc:	8b 50 04             	mov    0x4(%eax),%edx
80108fcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108fd2:	8b 58 08             	mov    0x8(%eax),%ebx
80108fd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108fd8:	8b 40 04             	mov    0x4(%eax),%eax
80108fdb:	29 c3                	sub    %eax,%ebx
80108fdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108fe0:	8b 00                	mov    (%eax),%eax
80108fe2:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108fe6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108fea:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108fee:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ff2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108ff5:	89 04 24             	mov    %eax,(%esp)
80108ff8:	e8 d0 fe ff ff       	call   80108ecd <mappages>
80108ffd:	85 c0                	test   %eax,%eax
80108fff:	79 07                	jns    80109008 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80109001:	b8 00 00 00 00       	mov    $0x0,%eax
80109006:	eb 10                	jmp    80109018 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80109008:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
8010900c:	81 7d f4 40 d5 10 80 	cmpl   $0x8010d540,-0xc(%ebp)
80109013:	72 ae                	jb     80108fc3 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80109018:	83 c4 34             	add    $0x34,%esp
8010901b:	5b                   	pop    %ebx
8010901c:	5d                   	pop    %ebp
8010901d:	c3                   	ret    
...
kvmalloc(void)
{
8010901e:	55                   	push   %ebp
8010901f:	89 e5                	mov    %esp,%ebp
80109021:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80109024:	e8 38 ff ff ff       	call   80108f61 <setupkvm>
80109029:	a3 98 6a 14 80       	mov    %eax,0x80146a98
  switchkvm();
8010902e:	e8 02 00 00 00       	call   80109035 <switchkvm>
}
80109033:	c9                   	leave  
80109034:	c3                   	ret    
...
8010903b:	a1 98 6a 14 80       	mov    0x80146a98,%eax
80109040:	89 04 24             	mov    %eax,(%esp)
80109043:	e8 5f f9 ff ff       	call   801089a7 <v2p>
80109048:	89 04 24             	mov    %eax,(%esp)
8010904b:	e8 4c f9 ff ff       	call   8010899c <lcr3>
}
80109050:	c9                   	leave  
80109051:	c3                   	ret    
...
80109055:	53                   	push   %ebx
80109056:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80109059:	e8 ef d0 ff ff       	call   8010614d <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010905e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109064:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010906b:	83 c2 08             	add    $0x8,%edx
8010906e:	89 d3                	mov    %edx,%ebx
80109070:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80109077:	83 c2 08             	add    $0x8,%edx
8010907a:	c1 ea 10             	shr    $0x10,%edx
8010907d:	89 d1                	mov    %edx,%ecx
8010907f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80109086:	83 c2 08             	add    $0x8,%edx
80109089:	c1 ea 18             	shr    $0x18,%edx
8010908c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80109093:	67 00 
80109095:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010909c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
801090a2:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801090a9:	83 e1 f0             	and    $0xfffffff0,%ecx
801090ac:	83 c9 09             	or     $0x9,%ecx
801090af:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801090b5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801090bc:	83 c9 10             	or     $0x10,%ecx
801090bf:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801090c5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801090cc:	83 e1 9f             	and    $0xffffff9f,%ecx
801090cf:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801090d5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801090dc:	83 c9 80             	or     $0xffffff80,%ecx
801090df:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801090e5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090ec:	83 e1 f0             	and    $0xfffffff0,%ecx
801090ef:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801090f5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090fc:	83 e1 ef             	and    $0xffffffef,%ecx
801090ff:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80109105:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010910c:	83 e1 df             	and    $0xffffffdf,%ecx
8010910f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80109115:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010911c:	83 c9 40             	or     $0x40,%ecx
8010911f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80109125:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010912c:	83 e1 7f             	and    $0x7f,%ecx
8010912f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80109135:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010913b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109141:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80109148:	83 e2 ef             	and    $0xffffffef,%edx
8010914b:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80109151:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109157:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010915d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109163:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010916a:	8b 52 08             	mov    0x8(%edx),%edx
8010916d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80109173:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80109176:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010917d:	e8 ef f7 ff ff       	call   80108971 <ltr>
  if(p->pgdir == 0)
80109182:	8b 45 08             	mov    0x8(%ebp),%eax
80109185:	8b 40 04             	mov    0x4(%eax),%eax
80109188:	85 c0                	test   %eax,%eax
8010918a:	75 0c                	jne    80109198 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010918c:	c7 04 24 4b 9f 10 80 	movl   $0x80109f4b,(%esp)
80109193:	e8 a5 73 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80109198:	8b 45 08             	mov    0x8(%ebp),%eax
8010919b:	8b 40 04             	mov    0x4(%eax),%eax
8010919e:	89 04 24             	mov    %eax,(%esp)
801091a1:	e8 01 f8 ff ff       	call   801089a7 <v2p>
801091a6:	89 04 24             	mov    %eax,(%esp)
801091a9:	e8 ee f7 ff ff       	call   8010899c <lcr3>
  popcli();
801091ae:	e8 e2 cf ff ff       	call   80106195 <popcli>
}
801091b3:	83 c4 14             	add    $0x14,%esp
801091b6:	5b                   	pop    %ebx
801091b7:	5d                   	pop    %ebp
801091b8:	c3                   	ret    
...
801091bc:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801091bf:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801091c6:	76 0c                	jbe    801091d4 <inituvm+0x1b>
    panic("inituvm: more than a page");
801091c8:	c7 04 24 5f 9f 10 80 	movl   $0x80109f5f,(%esp)
801091cf:	e8 69 73 ff ff       	call   8010053d <panic>
  mem = kalloc();
801091d4:	e8 1a 99 ff ff       	call   80102af3 <kalloc>
801091d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
801091dc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801091e3:	00 
801091e4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801091eb:	00 
801091ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091ef:	89 04 24             	mov    %eax,(%esp)
801091f2:	e8 5b d0 ff ff       	call   80106252 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801091f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091fa:	89 04 24             	mov    %eax,(%esp)
801091fd:	e8 a5 f7 ff ff       	call   801089a7 <v2p>
80109202:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80109209:	00 
8010920a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010920e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109215:	00 
80109216:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010921d:	00 
8010921e:	8b 45 08             	mov    0x8(%ebp),%eax
80109221:	89 04 24             	mov    %eax,(%esp)
80109224:	e8 a4 fc ff ff       	call   80108ecd <mappages>
  memmove(mem, init, sz);
80109229:	8b 45 10             	mov    0x10(%ebp),%eax
8010922c:	89 44 24 08          	mov    %eax,0x8(%esp)
80109230:	8b 45 0c             	mov    0xc(%ebp),%eax
80109233:	89 44 24 04          	mov    %eax,0x4(%esp)
80109237:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010923a:	89 04 24             	mov    %eax,(%esp)
8010923d:	e8 e3 d0 ff ff       	call   80106325 <memmove>
}
80109242:	c9                   	leave  
80109243:	c3                   	ret    
...
80109247:	53                   	push   %ebx
80109248:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010924b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010924e:	25 ff 0f 00 00       	and    $0xfff,%eax
80109253:	85 c0                	test   %eax,%eax
80109255:	74 0c                	je     80109263 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80109257:	c7 04 24 7c 9f 10 80 	movl   $0x80109f7c,(%esp)
8010925e:	e8 da 72 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80109263:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010926a:	e9 ad 00 00 00       	jmp    8010931c <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010926f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109272:	8b 55 0c             	mov    0xc(%ebp),%edx
80109275:	01 d0                	add    %edx,%eax
80109277:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010927e:	00 
8010927f:	89 44 24 04          	mov    %eax,0x4(%esp)
80109283:	8b 45 08             	mov    0x8(%ebp),%eax
80109286:	89 04 24             	mov    %eax,(%esp)
80109289:	e8 a9 fb ff ff       	call   80108e37 <walkpgdir>
8010928e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80109291:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80109295:	75 0c                	jne    801092a3 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80109297:	c7 04 24 9f 9f 10 80 	movl   $0x80109f9f,(%esp)
8010929e:	e8 9a 72 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801092a3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801092a6:	8b 00                	mov    (%eax),%eax
801092a8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801092ad:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
801092b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801092b3:	8b 55 18             	mov    0x18(%ebp),%edx
801092b6:	89 d1                	mov    %edx,%ecx
801092b8:	29 c1                	sub    %eax,%ecx
801092ba:	89 c8                	mov    %ecx,%eax
801092bc:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801092c1:	77 11                	ja     801092d4 <loaduvm+0x90>
      n = sz - i;
801092c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801092c6:	8b 55 18             	mov    0x18(%ebp),%edx
801092c9:	89 d1                	mov    %edx,%ecx
801092cb:	29 c1                	sub    %eax,%ecx
801092cd:	89 c8                	mov    %ecx,%eax
801092cf:	89 45 f0             	mov    %eax,-0x10(%ebp)
801092d2:	eb 07                	jmp    801092db <loaduvm+0x97>
    else
      n = PGSIZE;
801092d4:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801092db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801092de:	8b 55 14             	mov    0x14(%ebp),%edx
801092e1:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801092e4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801092e7:	89 04 24             	mov    %eax,(%esp)
801092ea:	e8 c5 f6 ff ff       	call   801089b4 <p2v>
801092ef:	8b 55 f0             	mov    -0x10(%ebp),%edx
801092f2:	89 54 24 0c          	mov    %edx,0xc(%esp)
801092f6:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801092fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801092fe:	8b 45 10             	mov    0x10(%ebp),%eax
80109301:	89 04 24             	mov    %eax,(%esp)
80109304:	e8 55 8a ff ff       	call   80101d5e <readi>
80109309:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010930c:	74 07                	je     80109315 <loaduvm+0xd1>
      return -1;
8010930e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80109313:	eb 18                	jmp    8010932d <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80109315:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010931c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010931f:	3b 45 18             	cmp    0x18(%ebp),%eax
80109322:	0f 82 47 ff ff ff    	jb     8010926f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
80109328:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010932d:	83 c4 24             	add    $0x24,%esp
80109330:	5b                   	pop    %ebx
80109331:	5d                   	pop    %ebp
80109332:	c3                   	ret    
...
80109336:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
80109339:	8b 45 10             	mov    0x10(%ebp),%eax
8010933c:	85 c0                	test   %eax,%eax
8010933e:	79 0a                	jns    8010934a <allocuvm+0x17>
    return 0;
80109340:	b8 00 00 00 00       	mov    $0x0,%eax
80109345:	e9 b5 00 00 00       	jmp    801093ff <allocuvm+0xcc>
  if(newsz < oldsz)
8010934a:	8b 45 10             	mov    0x10(%ebp),%eax
8010934d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80109350:	73 08                	jae    8010935a <allocuvm+0x27>
    return oldsz;
80109352:	8b 45 0c             	mov    0xc(%ebp),%eax
80109355:	e9 a5 00 00 00       	jmp    801093ff <allocuvm+0xcc>

  a = PGROUNDUP(oldsz);
8010935a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010935d:	05 ff 0f 00 00       	add    $0xfff,%eax
80109362:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109367:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010936a:	e9 81 00 00 00       	jmp    801093f0 <allocuvm+0xbd>
    mem = kalloc();
8010936f:	e8 7f 97 ff ff       	call   80102af3 <kalloc>
80109374:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80109377:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010937b:	75 20                	jne    8010939d <allocuvm+0x6a>
      //cprintf("allocuvm out of memory\n");
      deallocuvm(pgdir, newsz, oldsz);
8010937d:	8b 45 0c             	mov    0xc(%ebp),%eax
80109380:	89 44 24 08          	mov    %eax,0x8(%esp)
80109384:	8b 45 10             	mov    0x10(%ebp),%eax
80109387:	89 44 24 04          	mov    %eax,0x4(%esp)
8010938b:	8b 45 08             	mov    0x8(%ebp),%eax
8010938e:	89 04 24             	mov    %eax,(%esp)
80109391:	e8 6b 00 00 00       	call   80109401 <deallocuvm>
      return 0;
80109396:	b8 00 00 00 00       	mov    $0x0,%eax
8010939b:	eb 62                	jmp    801093ff <allocuvm+0xcc>
    }
    memset(mem, 0, PGSIZE);
8010939d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801093a4:	00 
801093a5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801093ac:	00 
801093ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801093b0:	89 04 24             	mov    %eax,(%esp)
801093b3:	e8 9a ce ff ff       	call   80106252 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801093b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801093bb:	89 04 24             	mov    %eax,(%esp)
801093be:	e8 e4 f5 ff ff       	call   801089a7 <v2p>
801093c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801093c6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801093cd:	00 
801093ce:	89 44 24 0c          	mov    %eax,0xc(%esp)
801093d2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801093d9:	00 
801093da:	89 54 24 04          	mov    %edx,0x4(%esp)
801093de:	8b 45 08             	mov    0x8(%ebp),%eax
801093e1:	89 04 24             	mov    %eax,(%esp)
801093e4:	e8 e4 fa ff ff       	call   80108ecd <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801093e9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801093f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801093f3:	3b 45 10             	cmp    0x10(%ebp),%eax
801093f6:	0f 82 73 ff ff ff    	jb     8010936f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
801093fc:	8b 45 10             	mov    0x10(%ebp),%eax
}
801093ff:	c9                   	leave  
80109400:	c3                   	ret    
...
80109404:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80109407:	8b 45 10             	mov    0x10(%ebp),%eax
8010940a:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010940d:	72 08                	jb     80109417 <deallocuvm+0x16>
    return oldsz;
8010940f:	8b 45 0c             	mov    0xc(%ebp),%eax
80109412:	e9 a4 00 00 00       	jmp    801094bb <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80109417:	8b 45 10             	mov    0x10(%ebp),%eax
8010941a:	05 ff 0f 00 00       	add    $0xfff,%eax
8010941f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109424:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80109427:	e9 80 00 00 00       	jmp    801094ac <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010942c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010942f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109436:	00 
80109437:	89 44 24 04          	mov    %eax,0x4(%esp)
8010943b:	8b 45 08             	mov    0x8(%ebp),%eax
8010943e:	89 04 24             	mov    %eax,(%esp)
80109441:	e8 f1 f9 ff ff       	call   80108e37 <walkpgdir>
80109446:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80109449:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010944d:	75 09                	jne    80109458 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010944f:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80109456:	eb 4d                	jmp    801094a5 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80109458:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010945b:	8b 00                	mov    (%eax),%eax
8010945d:	83 e0 01             	and    $0x1,%eax
80109460:	84 c0                	test   %al,%al
80109462:	74 41                	je     801094a5 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80109464:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109467:	8b 00                	mov    (%eax),%eax
80109469:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010946e:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80109471:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80109475:	75 0c                	jne    80109483 <deallocuvm+0x82>
        panic("kfree");
80109477:	c7 04 24 bd 9f 10 80 	movl   $0x80109fbd,(%esp)
8010947e:	e8 ba 70 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80109483:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109486:	89 04 24             	mov    %eax,(%esp)
80109489:	e8 26 f5 ff ff       	call   801089b4 <p2v>
8010948e:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80109491:	8b 45 e8             	mov    -0x18(%ebp),%eax
80109494:	89 04 24             	mov    %eax,(%esp)
80109497:	e8 be 95 ff ff       	call   80102a5a <kfree>
      *pte = 0;
8010949c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010949f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801094af:	3b 45 0c             	cmp    0xc(%ebp),%eax
801094b2:	0f 82 74 ff ff ff    	jb     8010942c <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
801094b8:	8b 45 10             	mov    0x10(%ebp),%eax
}
801094bb:	c9                   	leave  
801094bc:	c3                   	ret    
...
801094c0:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801094c3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801094c7:	75 0c                	jne    801094d5 <freevm+0x18>
    panic("freevm: no pgdir");
801094c9:	c7 04 24 c3 9f 10 80 	movl   $0x80109fc3,(%esp)
801094d0:	e8 68 70 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801094d5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801094dc:	00 
801094dd:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801094e4:	80 
801094e5:	8b 45 08             	mov    0x8(%ebp),%eax
801094e8:	89 04 24             	mov    %eax,(%esp)
801094eb:	e8 11 ff ff ff       	call   80109401 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801094f0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801094f7:	eb 3c                	jmp    80109535 <freevm+0x78>
    if(pgdir[i] & PTE_P){
801094f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801094fc:	c1 e0 02             	shl    $0x2,%eax
801094ff:	03 45 08             	add    0x8(%ebp),%eax
80109502:	8b 00                	mov    (%eax),%eax
80109504:	83 e0 01             	and    $0x1,%eax
80109507:	84 c0                	test   %al,%al
80109509:	74 26                	je     80109531 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010950b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010950e:	c1 e0 02             	shl    $0x2,%eax
80109511:	03 45 08             	add    0x8(%ebp),%eax
80109514:	8b 00                	mov    (%eax),%eax
80109516:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010951b:	89 04 24             	mov    %eax,(%esp)
8010951e:	e8 91 f4 ff ff       	call   801089b4 <p2v>
80109523:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80109526:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109529:	89 04 24             	mov    %eax,(%esp)
8010952c:	e8 29 95 ff ff       	call   80102a5a <kfree>
  uint i;
...
80109535:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
8010953c:	76 bb                	jbe    801094f9 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80109541:	89 04 24             	mov    %eax,(%esp)
80109544:	e8 11 95 ff ff       	call   80102a5a <kfree>
}
80109549:	c9                   	leave  
8010954a:	c3                   	ret    
...
8010954e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80109551:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109558:	00 
80109559:	8b 45 0c             	mov    0xc(%ebp),%eax
8010955c:	89 44 24 04          	mov    %eax,0x4(%esp)
80109560:	8b 45 08             	mov    0x8(%ebp),%eax
80109563:	89 04 24             	mov    %eax,(%esp)
80109566:	e8 cc f8 ff ff       	call   80108e37 <walkpgdir>
8010956b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010956e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80109572:	75 0c                	jne    80109580 <clearpteu+0x35>
    panic("clearpteu");
80109574:	c7 04 24 d4 9f 10 80 	movl   $0x80109fd4,(%esp)
8010957b:	e8 bd 6f ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80109580:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109583:	8b 00                	mov    (%eax),%eax
80109585:	89 c2                	mov    %eax,%edx
80109587:	83 e2 fb             	and    $0xfffffffb,%edx
8010958a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010958d:	89 10                	mov    %edx,(%eax)
}
8010958f:	c9                   	leave  
80109590:	c3                   	ret    
...
{
80109591:	55                   	push   %ebp
80109592:	89 e5                	mov    %esp,%ebp
80109594:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80109597:	e8 c5 f9 ff ff       	call   80108f61 <setupkvm>
8010959c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010959f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801095a3:	75 0a                	jne    801095af <copyuvm+0x1e>
    return 0;
801095a5:	b8 00 00 00 00       	mov    $0x0,%eax
801095aa:	e9 f1 00 00 00       	jmp    801096a0 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
801095af:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801095b6:	e9 c0 00 00 00       	jmp    8010967b <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801095bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801095be:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801095c5:	00 
801095c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801095ca:	8b 45 08             	mov    0x8(%ebp),%eax
801095cd:	89 04 24             	mov    %eax,(%esp)
801095d0:	e8 62 f8 ff ff       	call   80108e37 <walkpgdir>
801095d5:	89 45 ec             	mov    %eax,-0x14(%ebp)
801095d8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801095dc:	75 0c                	jne    801095ea <copyuvm+0x59>
      panic("copyuvm: pte should exist");
801095de:	c7 04 24 de 9f 10 80 	movl   $0x80109fde,(%esp)
801095e5:	e8 53 6f ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
801095ea:	8b 45 ec             	mov    -0x14(%ebp),%eax
801095ed:	8b 00                	mov    (%eax),%eax
801095ef:	83 e0 01             	and    $0x1,%eax
801095f2:	85 c0                	test   %eax,%eax
801095f4:	75 0c                	jne    80109602 <copyuvm+0x71>
      panic("copyuvm: page not present");
801095f6:	c7 04 24 f8 9f 10 80 	movl   $0x80109ff8,(%esp)
801095fd:	e8 3b 6f ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80109602:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109605:	8b 00                	mov    (%eax),%eax
80109607:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010960c:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
8010960f:	e8 df 94 ff ff       	call   80102af3 <kalloc>
80109614:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80109617:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
8010961b:	74 6f                	je     8010968c <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010961d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80109620:	89 04 24             	mov    %eax,(%esp)
80109623:	e8 8c f3 ff ff       	call   801089b4 <p2v>
80109628:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010962f:	00 
80109630:	89 44 24 04          	mov    %eax,0x4(%esp)
80109634:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80109637:	89 04 24             	mov    %eax,(%esp)
8010963a:	e8 e6 cc ff ff       	call   80106325 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
8010963f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80109642:	89 04 24             	mov    %eax,(%esp)
80109645:	e8 5d f3 ff ff       	call   801089a7 <v2p>
8010964a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010964d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80109654:	00 
80109655:	89 44 24 0c          	mov    %eax,0xc(%esp)
80109659:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109660:	00 
80109661:	89 54 24 04          	mov    %edx,0x4(%esp)
80109665:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109668:	89 04 24             	mov    %eax,(%esp)
8010966b:	e8 5d f8 ff ff       	call   80108ecd <mappages>
80109670:	85 c0                	test   %eax,%eax
80109672:	78 1b                	js     8010968f <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80109674:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010967b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010967e:	3b 45 0c             	cmp    0xc(%ebp),%eax
80109681:	0f 82 34 ff ff ff    	jb     801095bb <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
8010968a:	eb 14                	jmp    801096a0 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
8010968c:	90                   	nop
8010968d:	eb 01                	jmp    80109690 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
8010968f:	90                   	nop
...
80109693:	89 04 24             	mov    %eax,(%esp)
80109696:	e8 22 fe ff ff       	call   801094bd <freevm>
  return 0;
8010969b:	b8 00 00 00 00       	mov    $0x0,%eax
}
801096a0:	c9                   	leave  
801096a1:	c3                   	ret    
...
801096a5:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801096a8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801096af:	00 
...
801096bd:	e8 75 f7 ff ff       	call   80108e37 <walkpgdir>
801096c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
801096c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801096c8:	8b 00                	mov    (%eax),%eax
801096ca:	83 e0 01             	and    $0x1,%eax
801096cd:	85 c0                	test   %eax,%eax
801096cf:	75 07                	jne    801096d8 <uva2ka+0x36>
    return 0;
801096d1:	b8 00 00 00 00       	mov    $0x0,%eax
801096d6:	eb 25                	jmp    801096fd <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801096d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801096db:	8b 00                	mov    (%eax),%eax
801096dd:	83 e0 04             	and    $0x4,%eax
801096e0:	85 c0                	test   %eax,%eax
801096e2:	75 07                	jne    801096eb <uva2ka+0x49>
    return 0;
801096e4:	b8 00 00 00 00       	mov    $0x0,%eax
801096e9:	eb 12                	jmp    801096fd <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
801096eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801096ee:	8b 00                	mov    (%eax),%eax
801096f0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801096f5:	89 04 24             	mov    %eax,(%esp)
801096f8:	e8 b7 f2 ff ff       	call   801089b4 <p2v>
}
801096fd:	c9                   	leave  
801096fe:	c3                   	ret    
...
{
801096ff:	55                   	push   %ebp
80109700:	89 e5                	mov    %esp,%ebp
80109702:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
  buf = (char*)p;
80109705:	8b 45 10             	mov    0x10(%ebp),%eax
80109708:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010970b:	e9 8b 00 00 00       	jmp    8010979b <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80109710:	8b 45 0c             	mov    0xc(%ebp),%eax
80109713:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109718:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
8010971b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010971e:	89 44 24 04          	mov    %eax,0x4(%esp)
80109722:	8b 45 08             	mov    0x8(%ebp),%eax
80109725:	89 04 24             	mov    %eax,(%esp)
80109728:	e8 75 ff ff ff       	call   801096a2 <uva2ka>
8010972d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80109730:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80109734:	75 07                	jne    8010973d <copyout+0x3e>
      return -1;
80109736:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010973b:	eb 6d                	jmp    801097aa <copyout+0xab>
    n = PGSIZE - (va - va0);
8010973d:	8b 45 0c             	mov    0xc(%ebp),%eax
80109740:	8b 55 ec             	mov    -0x14(%ebp),%edx
80109743:	89 d1                	mov    %edx,%ecx
80109745:	29 c1                	sub    %eax,%ecx
80109747:	89 c8                	mov    %ecx,%eax
80109749:	05 00 10 00 00       	add    $0x1000,%eax
8010974e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80109751:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109754:	3b 45 14             	cmp    0x14(%ebp),%eax
80109757:	76 06                	jbe    8010975f <copyout+0x60>
      n = len;
80109759:	8b 45 14             	mov    0x14(%ebp),%eax
8010975c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010975f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109762:	8b 55 0c             	mov    0xc(%ebp),%edx
80109765:	89 d1                	mov    %edx,%ecx
80109767:	29 c1                	sub    %eax,%ecx
80109769:	89 c8                	mov    %ecx,%eax
8010976b:	03 45 e8             	add    -0x18(%ebp),%eax
8010976e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80109771:	89 54 24 08          	mov    %edx,0x8(%esp)
80109775:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109778:	89 54 24 04          	mov    %edx,0x4(%esp)
8010977c:	89 04 24             	mov    %eax,(%esp)
8010977f:	e8 a1 cb ff ff       	call   80106325 <memmove>
    len -= n;
80109784:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109787:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010978a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010978d:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80109790:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109793:	05 00 10 00 00       	add    $0x1000,%eax
80109798:	89 45 0c             	mov    %eax,0xc(%ebp)
copyout(pde_t *pgdir, uint va, void *p, uint len)
{
  char *buf, *pa0;
  uint n, va0;
  buf = (char*)p;
  while(len > 0){
8010979b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010979f:	0f 85 6b ff ff ff    	jne    80109710 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
801097a5:	b8 00 00 00 00       	mov    $0x0,%eax
}
801097aa:	c9                   	leave  
801097ab:	c3                   	ret    
