...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 7c 0d 00 	movl   $0xd7c,0x4(%esp)
  33:	00 
  ...
  92:	c7 44 24 04 8f 0d 00 	movl   $0xd8f,0x4(%esp)
  99:	00 
...
//    printf(fd, "%d\n", i);
 ...
 126:	e8 15 03 00 00       	call   440 <close>
  ...
  printf(1, "read\n");
 12b:	c7 44 24 04 99 0d 00 	movl   $0xd99,0x4(%esp)
 132:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 566:	0f b6 90 84 11 00 00 	movzbl 0x1184(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6c5:	75 27                	jne    6ee <printf+0x11f>
          s = "(null)";
 6c7:	c7 45 f4 9f 0d 00 00 	movl   $0xd9f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 793:	a1 a0 11 00 00       	mov    0x11a0,%eax
...
free(void *ap)
{
 ...
 854:	a3 a0 11 00 00       	mov    %eax,0x11a0
}
 859:	c9                   	leave  
 85a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a7:	e8 d8 fe ff ff       	call   784 <free>
  return freep;
 8ac:	a1 a0 11 00 00       	mov    0x11a0,%eax
}
 8b1:	c9                   	leave  
 8b2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8c8:	a1 a0 11 00 00       	mov    0x11a0,%eax
 8cd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8d0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d4:	75 23                	jne    8f9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d6:	c7 45 f0 98 11 00 00 	movl   $0x1198,-0x10(%ebp)
 8dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8e0:	a3 a0 11 00 00       	mov    %eax,0x11a0
 8e5:	a1 a0 11 00 00       	mov    0x11a0,%eax
 8ea:	a3 98 11 00 00       	mov    %eax,0x1198
    base.s.size = 0;
 8ef:	c7 05 9c 11 00 00 00 	movl   $0x0,0x119c
 8f6:	00 00 00 
  }
 ...
 94c:	a3 a0 11 00 00       	mov    %eax,0x11a0
      return (void*)(p + 1);
 ...
 957:	eb 38                	jmp    991 <malloc+0xde>
    ...
    if(p == freep)
 959:	a1 a0 11 00 00       	mov    0x11a0,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 9fa:	c7 44 24 04 a8 0d 00 	movl   $0xda8,0x4(%esp)
 a01:	00 
...
BB_create(int max_capacity){
 ...
 bd8:	c7 44 24 04 dc 0d 00 	movl   $0xddc,0x4(%esp)
 bdf:	00 
 ...
 bf2:	e8 47 01 00 00       	call   d3e <BB_free>
...
void* BB_pop(struct BB* bb)
{
 ...
 c77:	e8 bb fd ff ff       	call   a37 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 c7c:	8b 45 08             	mov    0x8(%ebp),%eax
 c7f:	8b 40 04             	mov    0x4(%eax),%eax
 c82:	89 04 24             	mov    %eax,(%esp)
 c85:	e8 5e f8 ff ff       	call   4e8 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
 c8a:	8b 45 08             	mov    0x8(%ebp),%eax
 c8d:	8b 40 1c             	mov    0x1c(%eax),%eax
 c90:	8b 00                	mov    (%eax),%eax
 c92:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
 c95:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 c99:	75 14                	jne    caf <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
 c9b:	c7 44 24 04 28 0e 00 	movl   $0xe28,0x4(%esp)
 ca2:	00 
 ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 caa:	e8 20 f9 ff ff       	call   5cf <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
 caf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 cb6:	eb 4b                	jmp    d03 <BB_pop+0x9b>
    if(i != (bb->count -1)){
 cb8:	8b 45 08             	mov    0x8(%ebp),%eax
 cbb:	8b 40 10             	mov    0x10(%eax),%eax
 cbe:	83 e8 01             	sub    $0x1,%eax
 cc1:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 cc4:	74 25                	je     ceb <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 cc6:	8b 45 08             	mov    0x8(%ebp),%eax
 cc9:	8b 40 1c             	mov    0x1c(%eax),%eax
 ccc:	8b 55 f4             	mov    -0xc(%ebp),%edx
 ccf:	c1 e2 02             	shl    $0x2,%edx
 cd2:	01 c2                	add    %eax,%edx
 cd4:	8b 45 08             	mov    0x8(%ebp),%eax
 cd7:	8b 40 1c             	mov    0x1c(%eax),%eax
 cda:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 cdd:	83 c1 01             	add    $0x1,%ecx
 ce0:	c1 e1 02             	shl    $0x2,%ecx
 ce3:	01 c8                	add    %ecx,%eax
 ce5:	8b 00                	mov    (%eax),%eax
 ce7:	89 02                	mov    %eax,(%edx)
 ce9:	eb 14                	jmp    cff <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 ceb:	8b 45 08             	mov    0x8(%ebp),%eax
 cee:	8b 40 1c             	mov    0x1c(%eax),%eax
 cf1:	8b 55 f4             	mov    -0xc(%ebp),%edx
 cf4:	c1 e2 02             	shl    $0x2,%edx
 cf7:	01 d0                	add    %edx,%eax
 cf9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"we have uninitialize element\n");
  }
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
 cff:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 d03:	8b 45 08             	mov    0x8(%ebp),%eax
 d06:	8b 40 10             	mov    0x10(%eax),%eax
 d09:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 d0c:	7f aa                	jg     cb8 <BB_pop+0x50>
     }
 ...
 d11:	8b 40 10             	mov    0x10(%eax),%eax
 d14:	8d 50 ff             	lea    -0x1(%eax),%edx
 d17:	8b 45 08             	mov    0x8(%ebp),%eax
 d1a:	89 50 10             	mov    %edx,0x10(%eax)
  
  binary_semaphore_up(bb->mutex);
 d1d:	8b 45 08             	mov    0x8(%ebp),%eax
 d20:	8b 40 04             	mov    0x4(%eax),%eax
 d23:	89 04 24             	mov    %eax,(%esp)
 d26:	e8 c5 f7 ff ff       	call   4f0 <binary_semaphore_up>
  semaphore_up(bb->empty);
 d2b:	8b 45 08             	mov    0x8(%ebp),%eax
 d2e:	8b 40 08             	mov    0x8(%eax),%eax
 d31:	89 04 24             	mov    %eax,(%esp)
 d34:	e8 55 fd ff ff       	call   a8e <semaphore_up>
