...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	0f b6 90 d0 0f 00 00 	movzbl 0xfd0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 535:	75 27                	jne    55e <printf+0x11f>
          s = "(null)";
 537:	c7 45 f4 ec 0b 00 00 	movl   $0xbec,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 603:	a1 ec 0f 00 00       	mov    0xfec,%eax
...
free(void *ap)
{
 ...
 6c4:	a3 ec 0f 00 00       	mov    %eax,0xfec
}
 6c9:	c9                   	leave  
 6ca:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 717:	e8 d8 fe ff ff       	call   5f4 <free>
  return freep;
 71c:	a1 ec 0f 00 00       	mov    0xfec,%eax
}
 721:	c9                   	leave  
 722:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 735:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 738:	a1 ec 0f 00 00       	mov    0xfec,%eax
 73d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 740:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 744:	75 23                	jne    769 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 746:	c7 45 f0 e4 0f 00 00 	movl   $0xfe4,-0x10(%ebp)
 74d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 750:	a3 ec 0f 00 00       	mov    %eax,0xfec
 755:	a1 ec 0f 00 00       	mov    0xfec,%eax
 75a:	a3 e4 0f 00 00       	mov    %eax,0xfe4
    base.s.size = 0;
 75f:	c7 05 e8 0f 00 00 00 	movl   $0x0,0xfe8
 766:	00 00 00 
  }
 ...
 7bc:	a3 ec 0f 00 00       	mov    %eax,0xfec
      return (void*)(p + 1);
 ...
 7c7:	eb 38                	jmp    801 <malloc+0xde>
    ...
    if(p == freep)
 7c9:	a1 ec 0f 00 00       	mov    0xfec,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 86a:	c7 44 24 04 f4 0b 00 	movl   $0xbf4,0x4(%esp)
 871:	00 
...
BB_create(int max_capacity){
 ...
 a48:	c7 44 24 04 28 0c 00 	movl   $0xc28,0x4(%esp)
 a4f:	00 
 ...
 a62:	e8 47 01 00 00       	call   bae <BB_free>
...
void* BB_pop(struct BB* bb)
{
 ...
 ae1:	8b 40 0c             	mov    0xc(%eax),%eax
 ae4:	89 04 24             	mov    %eax,(%esp)
 ae7:	e8 bb fd ff ff       	call   8a7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 aec:	8b 45 08             	mov    0x8(%ebp),%eax
 aef:	8b 40 04             	mov    0x4(%eax),%eax
 af2:	89 04 24             	mov    %eax,(%esp)
 af5:	e8 5e f8 ff ff       	call   358 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
 afa:	8b 45 08             	mov    0x8(%ebp),%eax
 afd:	8b 40 1c             	mov    0x1c(%eax),%eax
 b00:	8b 00                	mov    (%eax),%eax
 b02:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
 b05:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b09:	75 14                	jne    b1f <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
 b0b:	c7 44 24 04 74 0c 00 	movl   $0xc74,0x4(%esp)
 b12:	00 
 b13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b1a:	e8 20 f9 ff ff       	call   43f <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
 b1f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 b26:	eb 4b                	jmp    b73 <BB_pop+0x9b>
    if(i != (bb->count -1)){
 b28:	8b 45 08             	mov    0x8(%ebp),%eax
 b2b:	8b 40 10             	mov    0x10(%eax),%eax
 b2e:	83 e8 01             	sub    $0x1,%eax
 b31:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 b34:	74 25                	je     b5b <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 b36:	8b 45 08             	mov    0x8(%ebp),%eax
 b39:	8b 40 1c             	mov    0x1c(%eax),%eax
 b3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b3f:	c1 e2 02             	shl    $0x2,%edx
 b42:	01 c2                	add    %eax,%edx
 b44:	8b 45 08             	mov    0x8(%ebp),%eax
 b47:	8b 40 1c             	mov    0x1c(%eax),%eax
 b4a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 b4d:	83 c1 01             	add    $0x1,%ecx
 b50:	c1 e1 02             	shl    $0x2,%ecx
 b53:	01 c8                	add    %ecx,%eax
 b55:	8b 00                	mov    (%eax),%eax
 b57:	89 02                	mov    %eax,(%edx)
 b59:	eb 14                	jmp    b6f <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 b5b:	8b 45 08             	mov    0x8(%ebp),%eax
 b5e:	8b 40 1c             	mov    0x1c(%eax),%eax
 b61:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b64:	c1 e2 02             	shl    $0x2,%edx
 ...
 b69:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
 b6f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 b73:	8b 45 08             	mov    0x8(%ebp),%eax
 b76:	8b 40 10             	mov    0x10(%eax),%eax
 b79:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 b7c:	7f aa                	jg     b28 <BB_pop+0x50>
     }
 ...
 b81:	8b 40 10             	mov    0x10(%eax),%eax
 b84:	8d 50 ff             	lea    -0x1(%eax),%edx
 b87:	8b 45 08             	mov    0x8(%ebp),%eax
 b8a:	89 50 10             	mov    %edx,0x10(%eax)
  
  binary_semaphore_up(bb->mutex);
 b8d:	8b 45 08             	mov    0x8(%ebp),%eax
 b90:	8b 40 04             	mov    0x4(%eax),%eax
 b93:	89 04 24             	mov    %eax,(%esp)
 b96:	e8 c5 f7 ff ff       	call   360 <binary_semaphore_up>
  semaphore_up(bb->empty);
 b9b:	8b 45 08             	mov    0x8(%ebp),%eax
 b9e:	8b 40 08             	mov    0x8(%eax),%eax
 ba1:	89 04 24             	mov    %eax,(%esp)
 ba4:	e8 55 fd ff ff       	call   8fe <semaphore_up>
...
void BB_free(struct BB* bb){
 ...
 bbd:	e8 86 fd ff ff       	call   948 <semaphore_free>
  semaphore_free(bb->full);
 bc2:	8b 45 08             	mov    0x8(%ebp),%eax
 bc5:	8b 40 0c             	mov    0xc(%eax),%eax
 bc8:	89 04 24             	mov    %eax,(%esp)
 bcb:	e8 78 fd ff ff       	call   948 <semaphore_free>
  free(bb->pointer_to_elements);
 bd0:	8b 45 08             	mov    0x8(%ebp),%eax
 bd3:	8b 40 1c             	mov    0x1c(%eax),%eax
 bd6:	89 04 24             	mov    %eax,(%esp)
 bd9:	e8 16 fa ff ff       	call   5f4 <free>
  free(bb);
 bde:	8b 45 08             	mov    0x8(%ebp),%eax
 be1:	89 04 24             	mov    %eax,(%esp)
 be4:	e8 0b fa ff ff       	call   5f4 <free>
}
 be9:	c9                   	leave  
 bea:	c3                   	ret    
