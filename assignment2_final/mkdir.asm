...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 4c 0c 00 	movl   $0xc4c,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 63 0c 00 	movl   $0xc63,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	0f b6 90 64 10 00 00 	movzbl 0x1064(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 27                	jne    5be <printf+0x11f>
          s = "(null)";
 597:	c7 45 f4 7f 0c 00 00 	movl   $0xc7f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 80 10 00 00       	mov    0x1080,%eax
...
free(void *ap)
{
 ...
 724:	a3 80 10 00 00       	mov    %eax,0x1080
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 d8 fe ff ff       	call   654 <free>
  return freep;
 77c:	a1 80 10 00 00       	mov    0x1080,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 795:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 798:	a1 80 10 00 00       	mov    0x1080,%eax
 79d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a4:	75 23                	jne    7c9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 45 f0 78 10 00 00 	movl   $0x1078,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 80 10 00 00       	mov    %eax,0x1080
 7b5:	a1 80 10 00 00       	mov    0x1080,%eax
 7ba:	a3 78 10 00 00       	mov    %eax,0x1078
    base.s.size = 0;
 7bf:	c7 05 7c 10 00 00 00 	movl   $0x0,0x107c
 7c6:	00 00 00 
  }
 ...
 81c:	a3 80 10 00 00       	mov    %eax,0x1080
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 80 10 00 00       	mov    0x1080,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8ca:	c7 44 24 04 88 0c 00 	movl   $0xc88,0x4(%esp)
 8d1:	00 
...
BB_create(int max_capacity){
 ...
 aa8:	c7 44 24 04 bc 0c 00 	movl   $0xcbc,0x4(%esp)
 aaf:	00 
 ...
 ac2:	e8 47 01 00 00       	call   c0e <BB_free>
...
void* BB_pop(struct BB* bb)
{
 ...
 b86:	eb 4b                	jmp    bd3 <BB_pop+0x9b>
    if(i != (bb->count -1)){
 b88:	8b 45 08             	mov    0x8(%ebp),%eax
 b8b:	8b 40 10             	mov    0x10(%eax),%eax
 b8e:	83 e8 01             	sub    $0x1,%eax
 b91:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 b94:	74 25                	je     bbb <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 b96:	8b 45 08             	mov    0x8(%ebp),%eax
 b99:	8b 40 1c             	mov    0x1c(%eax),%eax
 b9c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b9f:	c1 e2 02             	shl    $0x2,%edx
 ba2:	01 c2                	add    %eax,%edx
 ba4:	8b 45 08             	mov    0x8(%ebp),%eax
 ba7:	8b 40 1c             	mov    0x1c(%eax),%eax
 baa:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 bad:	83 c1 01             	add    $0x1,%ecx
 bb0:	c1 e1 02             	shl    $0x2,%ecx
 bb3:	01 c8                	add    %ecx,%eax
 bb5:	8b 00                	mov    (%eax),%eax
 bb7:	89 02                	mov    %eax,(%edx)
 bb9:	eb 14                	jmp    bcf <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 bbb:	8b 45 08             	mov    0x8(%ebp),%eax
 bbe:	8b 40 1c             	mov    0x1c(%eax),%eax
 bc1:	8b 55 f4             	mov    -0xc(%ebp),%edx
 bc4:	c1 e2 02             	shl    $0x2,%edx
 bc7:	01 d0                	add    %edx,%eax
 bc9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"we have uninitialize element\n");
  }
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
 bcf:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 bd3:	8b 45 08             	mov    0x8(%ebp),%eax
 bd6:	8b 40 10             	mov    0x10(%eax),%eax
 bd9:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 bdc:	7f aa                	jg     b88 <BB_pop+0x50>
     }
