...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 b4 13 00 00 	movl   $0x13b4,(%esp)
  ...
  8a:	05 b4 13 00 00       	add    $0x13b4,%eax
  ...
  return buf;
  a3:	b8 b4 13 00 00       	mov    $0x13b4,%eax
}
...
ls(char *path)
{
  ...
  dd:	c7 44 24 04 1c 0f 00 	movl   $0xf1c,0x4(%esp)
  e4:	00 
 ...
 116:	c7 44 24 04 30 0f 00 	movl   $0xf30,0x4(%esp)
 11d:	00 
 ...
 181:	c7 44 24 04 44 0f 00 	movl   $0xf44,0x4(%esp)
 188:	00 
 ...
 1af:	c7 44 24 04 51 0f 00 	movl   $0xf51,0x4(%esp)
 1b6:	00 
 ...
 264:	c7 44 24 04 30 0f 00 	movl   $0xf30,0x4(%esp)
 26b:	00 
 ...
 2ae:	c7 44 24 04 44 0f 00 	movl   $0xf44,0x4(%esp)
 2b5:	00 
...
main(int argc, char *argv[])
{
 ...
 30f:	7f 11                	jg     322 <main+0x20>
    ls(".");
 311:	c7 04 24 64 0f 00 00 	movl   $0xf64,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 706:	0f b6 90 a0 13 00 00 	movzbl 0x13a0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 865:	75 27                	jne    88e <printf+0x11f>
          s = "(null)";
 867:	c7 45 f4 66 0f 00 00 	movl   $0xf66,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 933:	a1 cc 13 00 00       	mov    0x13cc,%eax
...
free(void *ap)
{
 ...
 9f4:	a3 cc 13 00 00       	mov    %eax,0x13cc
}
 9f9:	c9                   	leave  
 9fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a47:	e8 d8 fe ff ff       	call   924 <free>
  return freep;
 a4c:	a1 cc 13 00 00       	mov    0x13cc,%eax
}
 a51:	c9                   	leave  
 a52:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a65:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a68:	a1 cc 13 00 00       	mov    0x13cc,%eax
 a6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a70:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a74:	75 23                	jne    a99 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a76:	c7 45 f0 c4 13 00 00 	movl   $0x13c4,-0x10(%ebp)
 a7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a80:	a3 cc 13 00 00       	mov    %eax,0x13cc
 a85:	a1 cc 13 00 00       	mov    0x13cc,%eax
 a8a:	a3 c4 13 00 00       	mov    %eax,0x13c4
    base.s.size = 0;
 a8f:	c7 05 c8 13 00 00 00 	movl   $0x0,0x13c8
 a96:	00 00 00 
  }
 ...
 aec:	a3 cc 13 00 00       	mov    %eax,0x13cc
      return (void*)(p + 1);
 ...
 af7:	eb 38                	jmp    b31 <malloc+0xde>
    ...
    if(p == freep)
 af9:	a1 cc 13 00 00       	mov    0x13cc,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 b9a:	c7 44 24 04 70 0f 00 	movl   $0xf70,0x4(%esp)
 ba1:	00 
...
BB_create(int max_capacity){
 ...
 d78:	c7 44 24 04 a4 0f 00 	movl   $0xfa4,0x4(%esp)
 d7f:	00 
 ...
 d92:	e8 47 01 00 00       	call   ede <BB_free>
...
void* BB_pop(struct BB* bb)
{
 ...
 e11:	8b 40 0c             	mov    0xc(%eax),%eax
 e14:	89 04 24             	mov    %eax,(%esp)
 e17:	e8 bb fd ff ff       	call   bd7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 e1c:	8b 45 08             	mov    0x8(%ebp),%eax
 e1f:	8b 40 04             	mov    0x4(%eax),%eax
 e22:	89 04 24             	mov    %eax,(%esp)
 e25:	e8 5e f8 ff ff       	call   688 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
 e2a:	8b 45 08             	mov    0x8(%ebp),%eax
 e2d:	8b 40 1c             	mov    0x1c(%eax),%eax
 e30:	8b 00                	mov    (%eax),%eax
 e32:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
 e35:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e39:	75 14                	jne    e4f <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
 e3b:	c7 44 24 04 f0 0f 00 	movl   $0xff0,0x4(%esp)
 e42:	00 
 e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 e4a:	e8 20 f9 ff ff       	call   76f <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
 e4f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 e56:	eb 4b                	jmp    ea3 <BB_pop+0x9b>
    if(i != (bb->count -1)){
 e58:	8b 45 08             	mov    0x8(%ebp),%eax
 e5b:	8b 40 10             	mov    0x10(%eax),%eax
 e5e:	83 e8 01             	sub    $0x1,%eax
 e61:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 e64:	74 25                	je     e8b <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 e66:	8b 45 08             	mov    0x8(%ebp),%eax
 e69:	8b 40 1c             	mov    0x1c(%eax),%eax
 e6c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e6f:	c1 e2 02             	shl    $0x2,%edx
 e72:	01 c2                	add    %eax,%edx
 e74:	8b 45 08             	mov    0x8(%ebp),%eax
 e77:	8b 40 1c             	mov    0x1c(%eax),%eax
 e7a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 e7d:	83 c1 01             	add    $0x1,%ecx
 e80:	c1 e1 02             	shl    $0x2,%ecx
 e83:	01 c8                	add    %ecx,%eax
 e85:	8b 00                	mov    (%eax),%eax
 e87:	89 02                	mov    %eax,(%edx)
 e89:	eb 14                	jmp    e9f <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 e8b:	8b 45 08             	mov    0x8(%ebp),%eax
 e8e:	8b 40 1c             	mov    0x1c(%eax),%eax
 e91:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e94:	c1 e2 02             	shl    $0x2,%edx
 e97:	01 d0                	add    %edx,%eax
 e99:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"we have uninitialize element\n");
  }
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
 e9f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 ea3:	8b 45 08             	mov    0x8(%ebp),%eax
 ea6:	8b 40 10             	mov    0x10(%eax),%eax
 ea9:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 eac:	7f aa                	jg     e58 <BB_pop+0x50>
     }
 ...
 eb1:	8b 40 10             	mov    0x10(%eax),%eax
 eb4:	8d 50 ff             	lea    -0x1(%eax),%edx
 eb7:	8b 45 08             	mov    0x8(%ebp),%eax
 eba:	89 50 10             	mov    %edx,0x10(%eax)
  
  binary_semaphore_up(bb->mutex);
 ebd:	8b 45 08             	mov    0x8(%ebp),%eax
 ec0:	8b 40 04             	mov    0x4(%eax),%eax
 ec3:	89 04 24             	mov    %eax,(%esp)
 ec6:	e8 c5 f7 ff ff       	call   690 <binary_semaphore_up>
  semaphore_up(bb->empty);
 ecb:	8b 45 08             	mov    0x8(%ebp),%eax
 ece:	8b 40 08             	mov    0x8(%eax),%eax
 ed1:	89 04 24             	mov    %eax,(%esp)
 ed4:	e8 55 fd ff ff       	call   c2e <semaphore_up>
