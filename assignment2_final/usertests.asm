...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 84 64 00 00       	mov    0x6484,%eax
       b:	c7 44 24 04 a2 45 00 	movl   $0x45a2,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 8c 45 00 00 	movl   $0x458c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 84 64 00 00       	mov    0x6484,%eax
      3d:	c7 44 24 04 ad 45 00 	movl   $0x45ad,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 c0 45 00 00 	movl   $0x45c0,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 84 64 00 00       	mov    0x6484,%eax
      7f:	c7 44 24 04 cd 45 00 	movl   $0x45cd,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 84 64 00 00       	mov    0x6484,%eax
      99:	c7 44 24 04 eb 45 00 	movl   $0x45eb,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 84 64 00 00       	mov    0x6484,%eax
      b6:	c7 44 24 04 f9 45 00 	movl   $0x45f9,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 0a 46 00 00 	movl   $0x460a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 84 64 00 00       	mov    0x6484,%eax
      e8:	c7 44 24 04 10 46 00 	movl   $0x4610,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 84 64 00 00       	mov    0x6484,%eax
     109:	c7 44 24 04 2b 46 00 	movl   $0x462b,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 47 46 00 	movl   $0x4647,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 84 64 00 00       	mov    0x6484,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 54 46 00 	movl   $0x4654,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 84 64 00 00       	mov    0x6484,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 84 64 00 00       	mov    0x6484,%eax
     1b3:	c7 44 24 04 a8 46 00 	movl   $0x46a8,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 0a 46 00 00 	movl   $0x460a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 84 64 00 00       	mov    0x6484,%eax
     1f0:	c7 44 24 04 b3 46 00 	movl   $0x46b3,0x4(%esp)
     1f7:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 84 64 00 00       	mov    0x6484,%eax
     22e:	c7 44 24 04 cc 46 00 	movl   $0x46cc,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 84 64 00 00       	mov    0x6484,%eax
     248:	c7 44 24 04 e7 46 00 	movl   $0x46e7,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 0a 46 00 00 	movl   $0x460a,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 84 64 00 00       	mov    0x6484,%eax
     27a:	c7 44 24 04 fa 46 00 	movl   $0x46fa,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 84 64 00 00       	mov    0x6484,%eax
     294:	c7 44 24 04 07 47 00 	movl   $0x4707,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 84 64 00 00       	mov    0x6484,%eax
     2ae:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 84 64 00 00       	mov    0x6484,%eax
     2cb:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 40 47 00 00 	movl   $0x4740,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 84 64 00 00       	mov    0x6484,%eax
     2fd:	c7 44 24 04 44 47 00 	movl   $0x4744,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 84 64 00 00       	mov    0x6484,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 5e 47 00 	movl   $0x475e,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 40 47 00 00 	movl   $0x4740,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 84 64 00 00       	mov    0x6484,%eax
     3a3:	c7 44 24 04 7c 47 00 	movl   $0x477c,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 84 64 00 00       	mov    0x6484,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 95 47 00 	movl   $0x4795,0x4(%esp)
     403:	00 
     ...
     41a:	a1 84 64 00 00       	mov    0x6484,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 b2 47 00 	movl   $0x47b2,0x4(%esp)
     42d:	00 
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 40 47 00 00 	movl   $0x4740,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 84 64 00 00       	mov    0x6484,%eax
     49d:	c7 44 24 04 e4 47 00 	movl   $0x47e4,0x4(%esp)
     4a4:	00 
  ...
  printf(stdout, "big files ok\n");
     4b2:	a1 84 64 00 00       	mov    0x6484,%eax
     4b7:	c7 44 24 04 f7 47 00 	movl   $0x47f7,0x4(%esp)
     4be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 84 64 00 00       	mov    0x6484,%eax
     4d4:	c7 44 24 04 08 48 00 	movl   $0x4808,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 fb 38 00 00       	call   3ddf <printf>

  name[0] = 'a';
     4e4:	c6 05 60 ac 00 00 61 	movb   $0x61,0xac60
  name[2] = '\0';
     4eb:	c6 05 62 ac 00 00 00 	movb   $0x0,0xac62
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 61 ac 00 00       	mov    %al,0xac61
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 60 ac 00 00 	movl   $0xac60,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 60 ac 00 00 61 	movb   $0x61,0xac60
  name[2] = '\0';
     539:	c6 05 62 ac 00 00 00 	movb   $0x0,0xac62
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 61 ac 00 00       	mov    %al,0xac61
    unlink(name);
     554:	c7 04 24 60 ac 00 00 	movl   $0xac60,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 84 64 00 00       	mov    0x6484,%eax
     56f:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
     576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 84 64 00 00       	mov    0x6484,%eax
     58c:	c7 44 24 04 56 48 00 	movl   $0x4856,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 43 38 00 00       	call   3ddf <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 62 48 00 00 	movl   $0x4862,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 84 64 00 00       	mov    0x6484,%eax
     5b1:	c7 44 24 04 67 48 00 	movl   $0x4867,0x4(%esp)
     5b8:	00 
  ...
  if(chdir("dir0") < 0){
     5c6:	c7 04 24 62 48 00 00 	movl   $0x4862,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 84 64 00 00       	mov    0x6484,%eax
     5db:	c7 44 24 04 75 48 00 	movl   $0x4875,0x4(%esp)
     5e2:	00 
  ...
  if(chdir("..") < 0){
     5f0:	c7 04 24 88 48 00 00 	movl   $0x4888,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 84 64 00 00       	mov    0x6484,%eax
     605:	c7 44 24 04 8b 48 00 	movl   $0x488b,0x4(%esp)
     60c:	00 
  ...
  if(unlink("dir0") < 0){
     61a:	c7 04 24 62 48 00 00 	movl   $0x4862,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 84 64 00 00       	mov    0x6484,%eax
     62f:	c7 44 24 04 9c 48 00 	movl   $0x489c,0x4(%esp)
     636:	00 
  ...
  printf(stdout, "mkdir test\n");
     644:	a1 84 64 00 00       	mov    0x6484,%eax
     649:	c7 44 24 04 56 48 00 	movl   $0x4856,0x4(%esp)
     650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 84 64 00 00       	mov    0x6484,%eax
     666:	c7 44 24 04 b0 48 00 	movl   $0x48b0,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 69 37 00 00       	call   3ddf <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 70 64 00 	movl   $0x6470,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 8c 45 00 00 	movl   $0x458c,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 84 64 00 00       	mov    0x6484,%eax
     693:	c7 44 24 04 bb 48 00 	movl   $0x48bb,0x4(%esp)
     69a:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
     6c6:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	81 c2 60 8c 00 00    	add    $0x8c60,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     737:	00 
     738:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
     73f:	00 
     ...
     74f:	c7 44 24 04 dc 48 00 	movl   $0x48dc,0x4(%esp)
     756:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a8:	05 60 8c 00 00       	add    $0x8c60,%eax
     ...
     7c8:	c7 44 24 04 ea 48 00 	movl   $0x48ea,0x4(%esp)
     7cf:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     811:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
     818:	00 
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 f8 48 00 	movl   $0x48f8,0x4(%esp)
     845:	00 
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 0f 49 00 	movl   $0x490f,0x4(%esp)
     86e:	00 
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
     884:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 28 49 00 	movl   $0x4928,0x4(%esp)
     8a5:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 34 49 00 	movl   $0x4934,0x4(%esp)
     91d:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94c:	00 
     94d:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
     954:	00 
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 48 49 00 	movl   $0x4948,0x4(%esp)
     969:	00 
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 5b 49 00 	movl   $0x495b,0x4(%esp)
     98a:	00 
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 64 49 00 	movl   $0x4964,0x4(%esp)
     9bf:	00 
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 6d 49 00 	movl   $0x496d,0x4(%esp)
     9e2:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
     a15:	00 
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 86 49 00 	movl   $0x4986,0x4(%esp)
     a3b:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 96 49 00 	movl   $0x4996,0x4(%esp)
     a60:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 a3 49 00 	movl   $0x49a3,0x4(%esp)
     a7c:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b05:	c7 44 24 04 ad 49 00 	movl   $0x49ad,0x4(%esp)
     b0c:	00 
    ...
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 c7 49 00 	movl   $0x49c7,0x4(%esp)
     b3b:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
     b9e:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 14 4a 00 	movl   $0x4a14,0x4(%esp)
     c10:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 de 49 00 00 	movl   $0x49de,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 34 4a 00 	movl   $0x4a34,0x4(%esp)
     c6b:	00 
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 de 49 00 00 	movl   $0x49de,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 5f 4a 00 	movl   $0x4a5f,0x4(%esp)
     d16:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 6c 4a 00 	movl   $0x4a6c,0x4(%esp)
     d3a:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 81 4a 00 	movl   $0x4a81,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 77 30 00 00       	call   3ddf <printf>

  unlink("f1");
     d68:	c7 04 24 90 4a 00 00 	movl   $0x4a90,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 93 4a 00 00 	movl   $0x4a93,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
     d95:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 90 4a 00 00       	mov    $0x4a90,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 93 4a 00 00       	mov    $0x4a93,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 96 4a 00 	movl   $0x4a96,0x4(%esp)
     ddf:	00 
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0f:	c7 04 24 60 8c 00 00 	movl   $0x8c60,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e2b:	00 
     e2c:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
     e33:	00 
     ...
     e52:	c7 44 24 04 a5 4a 00 	movl   $0x4aa5,0x4(%esp)
     e59:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 90 4a 00 00       	mov    $0x4a90,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 93 4a 00 00       	mov    $0x4a93,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed6:	05 60 8c 00 00       	add    $0x8c60,%eax
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 b6 4a 00 	movl   $0x4ab6,0x4(%esp)
     efe:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f29:	00 
     f2a:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
     f31:	00 
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 c2 4a 00 	movl   $0x4ac2,0x4(%esp)
     f68:	00 
  ...
  unlink("f1");
     f88:	c7 04 24 90 4a 00 00 	movl   $0x4a90,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 93 4a 00 00 	movl   $0x4a93,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 d3 4a 00 	movl   $0x4ad3,0x4(%esp)
     fa7:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 e0 4a 00 	movl   $0x4ae0,0x4(%esp)
     fc3:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
     fe5:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 96 4a 00 	movl   $0x4a96,0x4(%esp)
    1048:	00 
    ...
    1096:	c7 44 24 04 f3 4a 00 	movl   $0x4af3,0x4(%esp)
    109d:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 04 4b 00 	movl   $0x4b04,0x4(%esp)
    111c:	00 
    ...
    1147:	c7 44 24 04 28 4b 00 	movl   $0x4b28,0x4(%esp)
    114e:	00 
    ...
    11ad:	c7 44 24 04 04 4b 00 	movl   $0x4b04,0x4(%esp)
    11b4:	00 
    ...
    11df:	c7 44 24 04 28 4b 00 	movl   $0x4b28,0x4(%esp)
    11e6:	00 
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 48 4b 00 	movl   $0x4b48,0x4(%esp)
    1258:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 59 4b 00 	movl   $0x4b59,0x4(%esp)
    1274:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1288:	00 
    1289:	c7 04 24 6a 4b 00 00 	movl   $0x4b6a,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 75 4b 00 	movl   $0x4b75,0x4(%esp)
    12a5:	00 
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 8f 4b 00 	movl   $0x4b8f,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 6a 4b 00 00 	movl   $0x4b6a,(%esp)
  ...
  if(fd < 0){
    ...
    12fa:	c7 44 24 04 95 4b 00 	movl   $0x4b95,0x4(%esp)
    1301:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1380:	00 
    1381:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    1388:	00 
    ...
    1399:	c7 44 24 04 cb 4b 00 	movl   $0x4bcb,0x4(%esp)
    13a0:	00 
  ...
  if(buf[0] != 'h'){
    13b2:	0f b6 05 60 8c 00 00 	movzbl 0x8c60,%eax
    13b9:	3c 68                	cmp    $0x68,%al
    13bb:	74 19                	je     13d6 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13bd:	c7 44 24 04 e2 4b 00 	movl   $0x4be2,0x4(%esp)
    13c4:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13dd:	00 
    13de:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    13e5:	00 
    ...
    13f6:	c7 44 24 04 f9 4b 00 	movl   $0x4bf9,0x4(%esp)
    13fd:	00 
  ...
  unlink("unlinkread");
    141a:	c7 04 24 6a 4b 00 00 	movl   $0x4b6a,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 12 4c 00 	movl   $0x4c12,0x4(%esp)
    142d:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 33 4c 00 	movl   $0x4c33,0x4(%esp)
    1492:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 8f 4b 00 	movl   $0x4b8f,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 46 4c 00 	movl   $0x4c46,0x4(%esp)
    14cb:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14e8:	c7 44 24 04 2f 4c 00 	movl   $0x4c2f,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 2b 4c 00 00 	movl   $0x4c2b,(%esp)
    14f7:	e8 8c 27 00 00       	call   3c88 <link>
    14fc:	85 c0                	test   %eax,%eax
    14fe:	79 19                	jns    1519 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1500:	c7 44 24 04 58 4c 00 	movl   $0x4c58,0x4(%esp)
    1507:	00 
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 95 4c 00 	movl   $0x4c95,0x4(%esp)
    157a:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1593:	00 
    1594:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    159b:	00 
    ...
    15ac:	c7 44 24 04 a6 4c 00 	movl   $0x4ca6,0x4(%esp)
    15b3:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 2f 4c 00 	movl   $0x4c2f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 b7 4c 00 	movl   $0x4cb7,0x4(%esp)
    15ef:	00 
  ...
  unlink("lf2");
    1601:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 2b 4c 00 	movl   $0x4c2b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 d8 4c 00 	movl   $0x4cd8,0x4(%esp)
    162c:	00 
  ...
  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 2b 4c 00 	movl   $0x4c2b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 fb 4c 00 00 	movl   $0x4cfb,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 fd 4c 00 	movl   $0x4cfd,0x4(%esp)
    165d:	00 
  ...
  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 19 4d 00 	movl   $0x4d19,0x4(%esp)
    1676:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 26 4d 00 	movl   $0x4d26,0x4(%esp)
    1692:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    ...
    1741:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    ...
    1772:	c7 44 24 04 39 4d 00 	movl   $0x4d39,0x4(%esp)
    1779:	00 
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 fb 4c 00 00 	movl   $0x4cfb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 55 4d 00 	movl   $0x4d55,0x4(%esp)
    183f:	00 
    ...
    1868:	c7 44 24 04 6e 4d 00 	movl   $0x4d6e,0x4(%esp)
    186f:	00 
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 8c 4d 00 	movl   $0x4d8c,0x4(%esp)
    18cb:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
    1907:	00 
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 bd 4d 00 	movl   $0x4dbd,0x4(%esp)
    1a27:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 cb 4d 00 	movl   $0x4dcb,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 8f 23 00 00       	call   3ddf <printf>

  unlink("x");
    1a50:	c7 04 24 32 49 00 00 	movl   $0x4932,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
    1a71:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 32 49 00 00 	movl   $0x4932,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 dc 4d 00 00 	movl   $0x4ddc,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 32 49 00 00 	movl   $0x4932,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 e0 4d 00 	movl   $0x4de0,0x4(%esp)
    1b4e:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 ff 4d 00 	movl   $0x4dff,0x4(%esp)
    1bac:	00 
  ...
  unlink("bd");
    1c43:	c7 04 24 fc 4d 00 00 	movl   $0x4dfc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 29 4e 00 	movl   $0x4e29,0x4(%esp)
    1ca2:	00 
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 3e 4e 00 	movl   $0x4e3e,0x4(%esp)
    1cc8:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 74 4e 00 00 	movl   $0x4e74,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 7a 4e 00 	movl   $0x4e7a,0x4(%esp)
    1d4a:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 56 4e 00 	movl   $0x4e56,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 d8 4e 00 00 	movl   $0x4ed8,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 e1 4e 00 	movl   $0x4ee1,0x4(%esp)
    1df8:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 f9 4e 00 	movl   $0x4ef9,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 fc 4e 00 00 	movl   $0x4efc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 08 4f 00 	movl   $0x4f08,0x4(%esp)
    1e54:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6d:	00 
    1e6e:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    1e75:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8a:	0f b6 05 60 8c 00 00 	movzbl 0x8c60,%eax
    1e91:	3c 66                	cmp    $0x66,%al
    1e93:	74 19                	je     1eae <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e95:	c7 44 24 04 21 4f 00 	movl   $0x4f21,0x4(%esp)
    1e9c:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eb9:	c7 44 24 04 3c 4f 00 	movl   $0x4f3c,0x4(%esp)
    1ec0:	00 
    1ec1:	c7 04 24 d8 4e 00 00 	movl   $0x4ed8,(%esp)
    1ec8:	e8 bb 1d 00 00       	call   3c88 <link>
    1ecd:	85 c0                	test   %eax,%eax
    1ecf:	74 19                	je     1eea <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed1:	c7 44 24 04 48 4f 00 	movl   $0x4f48,0x4(%esp)
    1ed8:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 3c 4f 00 00 	movl   $0x4f3c,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 06 50 00 	movl   $0x5006,0x4(%esp)
    200c:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2025:	00 
    2026:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    202d:	00 
    ...
    203e:	c7 44 24 04 1e 50 00 	movl   $0x501e,0x4(%esp)
    2045:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    207a:	c7 44 24 04 3c 50 00 	movl   $0x503c,0x4(%esp)
    2081:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2188:	c7 44 24 04 f5 50 00 	movl   $0x50f5,0x4(%esp)
    218f:	00 
    2190:	c7 04 24 61 50 00 00 	movl   $0x5061,(%esp)
    2197:	e8 ec 1a 00 00       	call   3c88 <link>
    219c:	85 c0                	test   %eax,%eax
    219e:	75 19                	jne    21b9 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a0:	c7 44 24 04 00 51 00 	movl   $0x5100,0x4(%esp)
    21a7:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21b9:	c7 44 24 04 f5 50 00 	movl   $0x50f5,0x4(%esp)
    21c0:	00 
    21c1:	c7 04 24 86 50 00 00 	movl   $0x5086,(%esp)
    21c8:	e8 bb 1a 00 00       	call   3c88 <link>
    21cd:	85 c0                	test   %eax,%eax
    21cf:	75 19                	jne    21ea <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d1:	c7 44 24 04 24 51 00 	movl   $0x5124,0x4(%esp)
    21d8:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21ea:	c7 44 24 04 3c 4f 00 	movl   $0x4f3c,0x4(%esp)
    21f1:	00 
    21f2:	c7 04 24 74 4e 00 00 	movl   $0x4e74,(%esp)
    21f9:	e8 8a 1a 00 00       	call   3c88 <link>
    21fe:	85 c0                	test   %eax,%eax
    2200:	75 19                	jne    221b <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2202:	c7 44 24 04 48 51 00 	movl   $0x5148,0x4(%esp)
    2209:	00 
  ...
  printf(1, "subdir ok\n");
    2407:	c7 44 24 04 8d 52 00 	movl   $0x528d,0x4(%esp)
    240e:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 98 52 00 	movl   $0x5298,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 a8 19 00 00       	call   3ddf <printf>

  unlink("bigwrite");
    2437:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
    ...
    246c:	c7 44 24 04 b0 52 00 	movl   $0x52b0,0x4(%esp)
    2473:	00 
    ...
    2495:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    249c:	00 
    ...
    24c1:	c7 44 24 04 c8 52 00 	movl   $0x52c8,0x4(%esp)
    24c8:	00 
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 da 52 00 	movl   $0x52da,0x4(%esp)
    2516:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 fd 52 00 	movl   $0x52fd,0x4(%esp)
    256f:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    2599:	c7 04 24 60 8c 00 00 	movl   $0x8c60,(%esp)
    25a0:	e8 de 14 00 00       	call   3a83 <memset>
    if(write(fd, buf, 600) != 600){
    25a5:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ac:	00 
    25ad:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    25b4:	00 
    ...
    25c7:	c7 44 24 04 13 53 00 	movl   $0x5313,0x4(%esp)
    25ce:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 f5 52 00 00 	movl   $0x52f5,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 29 53 00 	movl   $0x5329,0x4(%esp)
    2619:	00 
  ...
  for(i = 0; ; i++){
    ...
    2640:	00 
    2641:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    2648:	00 
    ...
    265d:	c7 44 24 04 3e 53 00 	movl   $0x533e,0x4(%esp)
    2664:	00 
    ...
    2685:	c7 44 24 04 53 53 00 	movl   $0x5353,0x4(%esp)
    268c:	00 
    ...
    269e:	0f b6 05 60 8c 00 00 	movzbl 0x8c60,%eax
    ...
    26b8:	0f b6 05 8b 8d 00 00 	movzbl 0x8d8b,%eax
    ...
    26d2:	c7 44 24 04 67 53 00 	movl   $0x5367,0x4(%esp)
    26d9:	00 
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 80 53 00 	movl   $0x5380,0x4(%esp)
    2716:	00 
  ...
  unlink("bigfile");
    2728:	c7 04 24 f5 52 00 00 	movl   $0x52f5,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 9a 53 00 	movl   $0x539a,0x4(%esp)
    273b:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 38 54 00 00 	movl   $0x5438,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 68 54 00 	movl   $0x5468,0x4(%esp)
    27da:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 a8 54 00 00 	movl   $0x54a8,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 d8 54 00 	movl   $0x54d8,0x4(%esp)
    281b:	00 
  ...
  printf(1, "fourteen ok\n");
    288a:	c7 44 24 04 b1 55 00 	movl   $0x55b1,0x4(%esp)
    2891:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a02:	c7 44 24 04 77 56 00 	movl   $0x5677,0x4(%esp)
    2a09:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 81 56 00 	movl   $0x5681,0x4(%esp)
    2a25:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a39:	00 
    2a3a:	c7 04 24 8e 56 00 00 	movl   $0x568e,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 96 56 00 	movl   $0x5696,0x4(%esp)
    2a56:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 c7 56 00 00 	movl   $0x56c7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 d2 56 00 	movl   $0x56d2,0x4(%esp)
    2ac0:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 c7 56 00 00 	movl   $0x56c7,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2aef:	c7 44 24 04 d2 56 00 	movl   $0x56d2,0x4(%esp)
    2af6:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b5a:	c7 44 24 04 c7 56 00 	movl   $0x56c7,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 2b 57 00 00 	movl   $0x572b,(%esp)
    2b69:	e8 1a 11 00 00       	call   3c88 <link>
    2b6e:	85 c0                	test   %eax,%eax
    2b70:	75 19                	jne    2b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b72:	c7 44 24 04 34 57 00 	movl   $0x5734,0x4(%esp)
    2b79:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 fb 4c 00 00 	movl   $0x4cfb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 6c 57 00 	movl   $0x576c,0x4(%esp)
    2bd8:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 8b 57 00 	movl   $0x578b,0x4(%esp)
    2c27:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 9f 57 00 	movl   $0x579f,0x4(%esp)
    2c4b:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 af 57 00 	movl   $0x57af,0x4(%esp)
    2c67:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd2:	c7 04 24 ee 57 00 00 	movl   $0x57ee,(%esp)
    2cd9:	e8 b2 0f 00 00       	call   3c90 <mkdir>
    link("README", "");
    2cde:	c7 44 24 04 ee 57 00 	movl   $0x57ee,0x4(%esp)
    2ce5:	00 
    2ce6:	c7 04 24 2b 57 00 00 	movl   $0x572b,(%esp)
    2ced:	e8 96 0f 00 00       	call   3c88 <link>
    fd = open("", O_CREATE);
    2cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 ee 57 00 00 	movl   $0x57ee,(%esp)
    ...
    2d21:	00 
    2d22:	c7 04 24 ef 57 00 00 	movl   $0x57ef,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 ef 57 00 00 	movl   $0x57ef,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 12 56 00 00 	movl   $0x5612,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 f2 57 00 	movl   $0x57f2,0x4(%esp)
    2d6f:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 06 58 00 	movl   $0x5806,0x4(%esp)
    2d8b:	00 
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 14 58 00 	movl   $0x5814,0x4(%esp)
    2dda:	00 
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 36 58 00 	movl   $0x5836,0x4(%esp)
    2dfc:	00 
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 4a 58 00 	movl   $0x584a,0x4(%esp)
    2e29:	00 
  ...
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 5d 58 00 	movl   $0x585d,0x4(%esp)
    2e42:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 84 64 00 00       	mov    0x6484,%eax
    2e60:	c7 44 24 04 6b 58 00 	movl   $0x586b,0x4(%esp)
    2e67:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 84 64 00 00       	mov    0x6484,%eax
    ...
    2ec8:	c7 44 24 04 76 58 00 	movl   $0x5876,0x4(%esp)
    2ecf:	00 
  ...
  if(pid < 0){
    ...
    2f07:	a1 84 64 00 00       	mov    0x6484,%eax
    2f0c:	c7 44 24 04 91 58 00 	movl   $0x5891,0x4(%esp)
    2f13:	00 
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 84 64 00 00       	mov    0x6484,%eax
    2f4f:	c7 44 24 04 a8 58 00 	movl   $0x58a8,0x4(%esp)
    2f56:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 84 64 00 00       	mov    0x6484,%eax
    2faf:	c7 44 24 04 c4 58 00 	movl   $0x58c4,0x4(%esp)
    2fb6:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 84 64 00 00       	mov    0x6484,%eax
    2ffa:	c7 44 24 04 02 59 00 	movl   $0x5902,0x4(%esp)
    3001:	00 
  ...
  if(c != a - 4096){
    ...
    302b:	a1 84 64 00 00       	mov    0x6484,%eax
    ...
    303e:	c7 44 24 04 20 59 00 	movl   $0x5920,0x4(%esp)
    3045:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 84 64 00 00       	mov    0x6484,%eax
    ...
    30a5:	c7 44 24 04 58 59 00 	movl   $0x5958,0x4(%esp)
    30ac:	00 
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 84 64 00 00       	mov    0x6484,%eax
    30c9:	c7 44 24 04 80 59 00 	movl   $0x5980,0x4(%esp)
    30d0:	00 
  ...
  if(c != a){
    ...
    3115:	a1 84 64 00 00       	mov    0x6484,%eax
    ...
    3128:	c7 44 24 04 b0 59 00 	movl   $0x59b0,0x4(%esp)
    312f:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 84 64 00 00       	mov    0x6484,%eax
    3161:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
    3168:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
    31e4:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 84 64 00 00       	mov    0x6484,%eax
    32e9:	c7 44 24 04 ea 59 00 	movl   $0x59ea,0x4(%esp)
    32f0:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 84 64 00 00       	mov    0x6484,%eax
    3331:	c7 44 24 04 05 5a 00 	movl   $0x5a05,0x4(%esp)
    3338:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 84 64 00 00       	mov    0x6484,%eax
    3380:	c7 44 24 04 13 5a 00 	movl   $0x5a13,0x4(%esp)
    3387:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 22 5a 00 00 	movl   $0x5a22,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 84 64 00 00       	mov    0x6484,%eax
    3403:	c7 44 24 04 2d 5a 00 	movl   $0x5a2d,0x4(%esp)
    340a:	00 
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 84 64 00 00       	mov    0x6484,%eax
    3430:	c7 44 24 04 46 5a 00 	movl   $0x5a46,0x4(%esp)
    3437:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 84 64 00 00       	mov    0x6484,%eax
    344d:	c7 44 24 04 53 5a 00 	movl   $0x5a53,0x4(%esp)
    3454:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3469:	05 40 65 00 00       	add    $0x6540,%eax
    346e:	0f b6 00             	movzbl (%eax),%eax
    3471:	84 c0                	test   %al,%al
    3473:	74 1a                	je     348f <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3475:	a1 84 64 00 00       	mov    0x6484,%eax
    347a:	c7 44 24 04 5d 5a 00 	movl   $0x5a5d,0x4(%esp)
    3481:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 84 64 00 00       	mov    0x6484,%eax
    34a2:	c7 44 24 04 6e 5a 00 	movl   $0x5a6e,0x4(%esp)
    34a9:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 7b 5a 00 00 	movl   $0x5a7b,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 a0 64 00 00 	movl   $0x5a88,0x64a0(,%eax,4)
    34eb:	88 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f7:	7e e8                	jle    34e1 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34f9:	c7 05 1c 65 00 00 00 	movl   $0x0,0x651c
    3500:	00 00 00 
    printf(stdout, "bigarg test\n");
    3503:	a1 84 64 00 00       	mov    0x6484,%eax
    3508:	c7 44 24 04 65 5b 00 	movl   $0x5b65,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 c7 08 00 00       	call   3ddf <printf>
    exec("echo", args);
    3518:	c7 44 24 04 a0 64 00 	movl   $0x64a0,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 8c 45 00 00 	movl   $0x458c,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 84 64 00 00       	mov    0x6484,%eax
    3531:	c7 44 24 04 72 5b 00 	movl   $0x5b72,0x4(%esp)
    3538:	00 
    ...
    3548:	00 
    3549:	c7 04 24 7b 5a 00 00 	movl   $0x5a7b,(%esp)
    ...
    356e:	a1 84 64 00 00       	mov    0x6484,%eax
    3573:	c7 44 24 04 82 5b 00 	movl   $0x5b82,0x4(%esp)
    357a:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 7b 5a 00 00 	movl   $0x5a7b,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 84 64 00 00       	mov    0x6484,%eax
    35af:	c7 44 24 04 9b 5b 00 	movl   $0x5b9b,0x4(%esp)
    35b6:	00 
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 7b 5a 00 00 	movl   $0x5a7b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 b0 5b 00 	movl   $0x5bb0,0x4(%esp)
    35f2:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 bd 5b 00 	movl   $0x5bbd,0x4(%esp)
    36e2:	00 
    ...
    3712:	c7 44 24 04 c9 5b 00 	movl   $0x5bc9,0x4(%esp)
    3719:	00 
    ...
    3736:	00 
    3737:	c7 44 24 04 60 8c 00 	movl   $0x8c60,0x4(%esp)
    373e:	00 
    ...
    376a:	c7 44 24 04 d9 5b 00 	movl   $0x5bd9,0x4(%esp)
    3771:	00 
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 e9 5b 00 	movl   $0x5be9,0x4(%esp)
    388c:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 88 64 00 00       	mov    0x6488,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 88 64 00 00       	mov    %eax,0x6488
  return randstate;
    38b7:	a1 88 64 00 00       	mov    0x6488,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38c7:	c7 44 24 04 ff 5b 00 	movl   $0x5bff,0x4(%esp)
    38ce:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 13 5c 00 00 	movl   $0x5c13,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d76:	0f b6 90 8c 64 00 00 	movzbl 0x648c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ed5:	75 27                	jne    3efe <printf+0x11f>
          s = "(null)";
    3ed7:	c7 45 f4 4e 5c 00 00 	movl   $0x5c4e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3fa3:	a1 28 65 00 00       	mov    0x6528,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    4064:	a3 28 65 00 00       	mov    %eax,0x6528
}
    4069:	c9                   	leave  
    406a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    40bc:	a1 28 65 00 00       	mov    0x6528,%eax
}
    40c1:	c9                   	leave  
    40c2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40d8:	a1 28 65 00 00       	mov    0x6528,%eax
    40dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40e4:	75 23                	jne    4109 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40e6:	c7 45 f0 20 65 00 00 	movl   $0x6520,-0x10(%ebp)
    40ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f0:	a3 28 65 00 00       	mov    %eax,0x6528
    40f5:	a1 28 65 00 00       	mov    0x6528,%eax
    40fa:	a3 20 65 00 00       	mov    %eax,0x6520
    base.s.size = 0;
    40ff:	c7 05 24 65 00 00 00 	movl   $0x0,0x6524
    4106:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    415c:	a3 28 65 00 00       	mov    %eax,0x6528
      return (void*)(p + 1);
    ...
    if(p == freep)
    4169:	a1 28 65 00 00       	mov    0x6528,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  if(sem->s1 == -1 || sem->s2 == -1){
    ...
    420a:	c7 44 24 04 58 5c 00 	movl   $0x5c58,0x4(%esp)
    4211:	00 
...
BB_create(int max_capacity){
  ...
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
   ...
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    43e8:	c7 44 24 04 8c 5c 00 	movl   $0x5c8c,0x4(%esp)
    43ef:	00 
   ...
   BB_free(buf);
    ...
    4402:	e8 47 01 00 00       	call   454e <BB_free>
...
{ 
  ...
  bb->pointer_to_elements[bb->count] = element;
    ...
    443e:	8b 40 10             	mov    0x10(%eax),%eax
...
void* BB_pop(struct BB* bb)
{
  ...
  semaphore_down(bb->full);
    ...
    4481:	8b 40 0c             	mov    0xc(%eax),%eax
    4484:	89 04 24             	mov    %eax,(%esp)
    4487:	e8 bb fd ff ff       	call   4247 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    448c:	8b 45 08             	mov    0x8(%ebp),%eax
    448f:	8b 40 04             	mov    0x4(%eax),%eax
    4492:	89 04 24             	mov    %eax,(%esp)
    4495:	e8 5e f8 ff ff       	call   3cf8 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
    449a:	8b 45 08             	mov    0x8(%ebp),%eax
    449d:	8b 40 1c             	mov    0x1c(%eax),%eax
    44a0:	8b 00                	mov    (%eax),%eax
    44a2:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
    44a5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    44a9:	75 14                	jne    44bf <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
    44ab:	c7 44 24 04 d8 5c 00 	movl   $0x5cd8,0x4(%esp)
    44b2:	00 
    44b3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    44ba:	e8 20 f9 ff ff       	call   3ddf <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
    44bf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    44c6:	eb 4b                	jmp    4513 <BB_pop+0x9b>
    if(i != (bb->count -1)){
    44c8:	8b 45 08             	mov    0x8(%ebp),%eax
    44cb:	8b 40 10             	mov    0x10(%eax),%eax
    44ce:	83 e8 01             	sub    $0x1,%eax
    44d1:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    44d4:	74 25                	je     44fb <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
    44d6:	8b 45 08             	mov    0x8(%ebp),%eax
    44d9:	8b 40 1c             	mov    0x1c(%eax),%eax
    44dc:	8b 55 f4             	mov    -0xc(%ebp),%edx
    44df:	c1 e2 02             	shl    $0x2,%edx
    44e2:	01 c2                	add    %eax,%edx
    44e4:	8b 45 08             	mov    0x8(%ebp),%eax
    44e7:	8b 40 1c             	mov    0x1c(%eax),%eax
    44ea:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    44ed:	83 c1 01             	add    $0x1,%ecx
    44f0:	c1 e1 02             	shl    $0x2,%ecx
    44f3:	01 c8                	add    %ecx,%eax
    44f5:	8b 00                	mov    (%eax),%eax
    44f7:	89 02                	mov    %eax,(%edx)
    44f9:	eb 14                	jmp    450f <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
    44fb:	8b 45 08             	mov    0x8(%ebp),%eax
    44fe:	8b 40 1c             	mov    0x1c(%eax),%eax
    4501:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4504:	c1 e2 02             	shl    $0x2,%edx
    4507:	01 d0                	add    %edx,%eax
    4509:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"we have uninitialize element\n");
  }
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
    450f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    4513:	8b 45 08             	mov    0x8(%ebp),%eax
    4516:	8b 40 10             	mov    0x10(%eax),%eax
    4519:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    451c:	7f aa                	jg     44c8 <BB_pop+0x50>
     }
  ...
  bb->count--;
    ...
    4521:	8b 40 10             	mov    0x10(%eax),%eax
    4524:	8d 50 ff             	lea    -0x1(%eax),%edx
    4527:	8b 45 08             	mov    0x8(%ebp),%eax
    452a:	89 50 10             	mov    %edx,0x10(%eax)
  
  binary_semaphore_up(bb->mutex);
    452d:	8b 45 08             	mov    0x8(%ebp),%eax
    4530:	8b 40 04             	mov    0x4(%eax),%eax
    4533:	89 04 24             	mov    %eax,(%esp)
    4536:	e8 c5 f7 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->empty);
    453b:	8b 45 08             	mov    0x8(%ebp),%eax
    453e:	8b 40 08             	mov    0x8(%eax),%eax
    4541:	89 04 24             	mov    %eax,(%esp)
    4544:	e8 55 fd ff ff       	call   429e <semaphore_up>
...
void BB_free(struct BB* bb){
  ...
  semaphore_free(bb->empty);
    ...
    4557:	8b 40 08             	mov    0x8(%eax),%eax
    455a:	89 04 24             	mov    %eax,(%esp)
    455d:	e8 86 fd ff ff       	call   42e8 <semaphore_free>
  semaphore_free(bb->full);
    4562:	8b 45 08             	mov    0x8(%ebp),%eax
    4565:	8b 40 0c             	mov    0xc(%eax),%eax
    4568:	89 04 24             	mov    %eax,(%esp)
    456b:	e8 78 fd ff ff       	call   42e8 <semaphore_free>
  free(bb->pointer_to_elements);
    4570:	8b 45 08             	mov    0x8(%ebp),%eax
    4573:	8b 40 1c             	mov    0x1c(%eax),%eax
    4576:	89 04 24             	mov    %eax,(%esp)
    4579:	e8 16 fa ff ff       	call   3f94 <free>
  free(bb);
    457e:	8b 45 08             	mov    0x8(%ebp),%eax
    4581:	89 04 24             	mov    %eax,(%esp)
    4584:	e8 0b fa ff ff       	call   3f94 <free>
}
    4589:	c9                   	leave  
    458a:	c3                   	ret    
