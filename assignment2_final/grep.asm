...
grep(char *pattern, int fd)
{
  ...
  8e:	75 91                	jne    21 <grep+0x21>
    ...
    if(p == buf)
  90:	81 7d f0 00 14 00 00 	cmpl   $0x1400,-0x10(%ebp)
  ...
  a4:	7e 2b                	jle    d1 <grep+0xd1>
      m -= p - buf;
  a6:	ba 00 14 00 00       	mov    $0x1400,%edx
  ...
  c5:	c7 04 24 00 14 00 00 	movl   $0x1400,(%esp)
  cc:	e8 9d 04 00 00       	call   56e <memmove>
{
  ...
  e2:	81 c2 00 14 00 00    	add    $0x1400,%edx
...
main(int argc, char *argv[])
{
 ...
 119:	c7 44 24 04 18 0f 00 	movl   $0xf18,0x4(%esp)
 120:	00 
 ...
 19c:	c7 44 24 04 38 0f 00 	movl   $0xf38,0x4(%esp)
 1a3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 702:	0f b6 90 b4 13 00 00 	movzbl 0x13b4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 861:	75 27                	jne    88a <printf+0x11f>
          s = "(null)";
 863:	c7 45 f4 4e 0f 00 00 	movl   $0xf4e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 92f:	a1 e8 13 00 00       	mov    0x13e8,%eax
...
free(void *ap)
{
 ...
 9f0:	a3 e8 13 00 00       	mov    %eax,0x13e8
}
 9f5:	c9                   	leave  
 9f6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a43:	e8 d8 fe ff ff       	call   920 <free>
  return freep;
 a48:	a1 e8 13 00 00       	mov    0x13e8,%eax
}
 a4d:	c9                   	leave  
 a4e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a61:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a64:	a1 e8 13 00 00       	mov    0x13e8,%eax
 a69:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a6c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a70:	75 23                	jne    a95 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a72:	c7 45 f0 e0 13 00 00 	movl   $0x13e0,-0x10(%ebp)
 a79:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a7c:	a3 e8 13 00 00       	mov    %eax,0x13e8
 a81:	a1 e8 13 00 00       	mov    0x13e8,%eax
 a86:	a3 e0 13 00 00       	mov    %eax,0x13e0
    base.s.size = 0;
 a8b:	c7 05 e4 13 00 00 00 	movl   $0x0,0x13e4
 a92:	00 00 00 
  }
 ...
 ae8:	a3 e8 13 00 00       	mov    %eax,0x13e8
      return (void*)(p + 1);
 ...
 af3:	eb 38                	jmp    b2d <malloc+0xde>
    ...
    if(p == freep)
 af5:	a1 e8 13 00 00       	mov    0x13e8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 b96:	c7 44 24 04 58 0f 00 	movl   $0xf58,0x4(%esp)
 b9d:	00 
...
BB_create(int max_capacity){
 ...
 d74:	c7 44 24 04 8c 0f 00 	movl   $0xf8c,0x4(%esp)
 d7b:	00 
 ...
 d8e:	e8 47 01 00 00       	call   eda <BB_free>
...
void* BB_pop(struct BB* bb)
{
 ...
 e07:	83 ec 28             	sub    $0x28,%esp
  
  void* element_to_pop;
  semaphore_down(bb->full);
 e0a:	8b 45 08             	mov    0x8(%ebp),%eax
 e0d:	8b 40 0c             	mov    0xc(%eax),%eax
 e10:	89 04 24             	mov    %eax,(%esp)
 e13:	e8 bb fd ff ff       	call   bd3 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 e18:	8b 45 08             	mov    0x8(%ebp),%eax
 e1b:	8b 40 04             	mov    0x4(%eax),%eax
 e1e:	89 04 24             	mov    %eax,(%esp)
 e21:	e8 5e f8 ff ff       	call   684 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
 e26:	8b 45 08             	mov    0x8(%ebp),%eax
 e29:	8b 40 1c             	mov    0x1c(%eax),%eax
 e2c:	8b 00                	mov    (%eax),%eax
 e2e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
 e31:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e35:	75 14                	jne    e4b <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
 e37:	c7 44 24 04 d8 0f 00 	movl   $0xfd8,0x4(%esp)
 e3e:	00 
 e3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 e46:	e8 20 f9 ff ff       	call   76b <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
 e4b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 e52:	eb 4b                	jmp    e9f <BB_pop+0x9b>
    if(i != (bb->count -1)){
 e54:	8b 45 08             	mov    0x8(%ebp),%eax
 e57:	8b 40 10             	mov    0x10(%eax),%eax
 e5a:	83 e8 01             	sub    $0x1,%eax
 e5d:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 e60:	74 25                	je     e87 <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 e62:	8b 45 08             	mov    0x8(%ebp),%eax
 e65:	8b 40 1c             	mov    0x1c(%eax),%eax
 e68:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e6b:	c1 e2 02             	shl    $0x2,%edx
 e6e:	01 c2                	add    %eax,%edx
 e70:	8b 45 08             	mov    0x8(%ebp),%eax
 e73:	8b 40 1c             	mov    0x1c(%eax),%eax
 e76:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 e79:	83 c1 01             	add    $0x1,%ecx
 e7c:	c1 e1 02             	shl    $0x2,%ecx
 e7f:	01 c8                	add    %ecx,%eax
 e81:	8b 00                	mov    (%eax),%eax
 e83:	89 02                	mov    %eax,(%edx)
 e85:	eb 14                	jmp    e9b <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 e87:	8b 45 08             	mov    0x8(%ebp),%eax
 e8a:	8b 40 1c             	mov    0x1c(%eax),%eax
 e8d:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e90:	c1 e2 02             	shl    $0x2,%edx
 ...
 e95:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
 e9b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 e9f:	8b 45 08             	mov    0x8(%ebp),%eax
 ea2:	8b 40 10             	mov    0x10(%eax),%eax
 ea5:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 ea8:	7f aa                	jg     e54 <BB_pop+0x50>
     }
 ...
 ec2:	e8 c5 f7 ff ff       	call   68c <binary_semaphore_up>
  semaphore_up(bb->empty);
 ec7:	8b 45 08             	mov    0x8(%ebp),%eax
 eca:	8b 40 08             	mov    0x8(%eax),%eax
 ecd:	89 04 24             	mov    %eax,(%esp)
 ed0:	e8 55 fd ff ff       	call   c2a <semaphore_up>
...
void BB_free(struct BB* bb){
 ...
 ee9:	e8 86 fd ff ff       	call   c74 <semaphore_free>
  semaphore_free(bb->full);
 eee:	8b 45 08             	mov    0x8(%ebp),%eax
 ef1:	8b 40 0c             	mov    0xc(%eax),%eax
 ef4:	89 04 24             	mov    %eax,(%esp)
 ef7:	e8 78 fd ff ff       	call   c74 <semaphore_free>
  free(bb->pointer_to_elements);
 efc:	8b 45 08             	mov    0x8(%ebp),%eax
 eff:	8b 40 1c             	mov    0x1c(%eax),%eax
 f02:	89 04 24             	mov    %eax,(%esp)
 f05:	e8 16 fa ff ff       	call   920 <free>
  free(bb);
 f0a:	8b 45 08             	mov    0x8(%ebp),%eax
 f0d:	89 04 24             	mov    %eax,(%esp)
 f10:	e8 0b fa ff ff       	call   920 <free>
}
 f15:	c9                   	leave  
 f16:	c3                   	ret    
