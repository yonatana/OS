...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 f0 18 00 00 	mov    0x18f0(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 c4 18 00 00 	movl   $0x18c4,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 cb 18 00 	movl   $0x18cb,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 db 18 00 	movl   $0x18db,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 eb 18 00 00 	movl   $0x18eb,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 08 19 00 	movl   $0x1908,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 0b 19 00 00 	movl   $0x190b,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 00 20 00 00 	movzbl 0x2000,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 01 20 00 00 	movzbl 0x2001,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 02 20 00 00 	movzbl 0x2002,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 00 20 00 00 00 	movb   $0x0,0x2000(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 03 20 00 00 	movl   $0x2003,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 03 20 00 	movl   $0x2003,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 13 19 00 	movl   $0x1913,0x4(%esp)
     305:	00 
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 21 19 00 	movl   $0x1921,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 25 19 00 00 	movl   $0x1925,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 d4 1f 00 00 	movl   $0x1fd4,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 d4 1f 00 00 	movl   $0x1fd4,(%esp)
     ...
     61e:	c7 04 24 da 1f 00 00 	movl   $0x1fda,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 d4 1f 00 00 	movl   $0x1fd4,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 d4 1f 00 00 	movl   $0x1fd4,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 2a 19 00 	movl   $0x192a,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 2b 19 00 	movl   $0x192b,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 b9 09 00 00       	call   1117 <printf>
    panic("syntax");
     75e:	c7 04 24 3a 19 00 00 	movl   $0x193a,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 41 19 00 	movl   $0x1941,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 43 19 00 	movl   $0x1943,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 45 19 00 	movl   $0x1945,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 47 19 00 00 	movl   $0x1947,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 64 19 00 	movl   $0x1964,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 67 19 00 	movl   $0x1967,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 69 19 00 00 	movl   $0x1969,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 74 19 00 	movl   $0x1974,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 76 19 00 00 	movl   $0x1976,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 67 19 00 	movl   $0x1967,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 3a 19 00 00 	movl   $0x193a,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 89 19 00 00 	movl   $0x1989,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 97 19 00 	movl   $0x1997,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 9c 19 00 00 	mov    0x199c(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10ae:	0f b6 90 e4 1f 00 00 	movzbl 0x1fe4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    120d:	75 27                	jne    1236 <printf+0x11f>
          s = "(null)";
    120f:	c7 45 f4 b4 19 00 00 	movl   $0x19b4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12db:	a1 6c 20 00 00       	mov    0x206c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    139c:	a3 6c 20 00 00       	mov    %eax,0x206c
}
    13a1:	c9                   	leave  
    13a2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13f4:	a1 6c 20 00 00       	mov    0x206c,%eax
}
    13f9:	c9                   	leave  
    13fa:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1410:	a1 6c 20 00 00       	mov    0x206c,%eax
    1415:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1418:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    141c:	75 23                	jne    1441 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    141e:	c7 45 f0 64 20 00 00 	movl   $0x2064,-0x10(%ebp)
    1425:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1428:	a3 6c 20 00 00       	mov    %eax,0x206c
    142d:	a1 6c 20 00 00       	mov    0x206c,%eax
    1432:	a3 64 20 00 00       	mov    %eax,0x2064
    base.s.size = 0;
    1437:	c7 05 68 20 00 00 00 	movl   $0x0,0x2068
    143e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1494:	a3 6c 20 00 00       	mov    %eax,0x206c
      return (void*)(p + 1);
    ...
    if(p == freep)
    14a1:	a1 6c 20 00 00       	mov    0x206c,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  if(sem->s1 == -1 || sem->s2 == -1){
    ...
    1542:	c7 44 24 04 bc 19 00 	movl   $0x19bc,0x4(%esp)
    1549:	00 
...
BB_create(int max_capacity){
  ...
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
   ...
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    1720:	c7 44 24 04 f0 19 00 	movl   $0x19f0,0x4(%esp)
    1727:	00 
   ...
   BB_free(buf);
    ...
    173a:	e8 47 01 00 00       	call   1886 <BB_free>
...
{ 
  ...
  bb->pointer_to_elements[bb->count] = element;
    ...
    1776:	8b 40 10             	mov    0x10(%eax),%eax
...
void* BB_pop(struct BB* bb)
{
    ...
    17b3:	83 ec 28             	sub    $0x28,%esp
  
  void* element_to_pop;
  semaphore_down(bb->full);
    17b6:	8b 45 08             	mov    0x8(%ebp),%eax
    17b9:	8b 40 0c             	mov    0xc(%eax),%eax
    17bc:	89 04 24             	mov    %eax,(%esp)
    17bf:	e8 bb fd ff ff       	call   157f <semaphore_down>
  binary_semaphore_down(bb->mutex);
    17c4:	8b 45 08             	mov    0x8(%ebp),%eax
    17c7:	8b 40 04             	mov    0x4(%eax),%eax
    17ca:	89 04 24             	mov    %eax,(%esp)
    17cd:	e8 5e f8 ff ff       	call   1030 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
    17d2:	8b 45 08             	mov    0x8(%ebp),%eax
    17d5:	8b 40 1c             	mov    0x1c(%eax),%eax
    17d8:	8b 00                	mov    (%eax),%eax
    17da:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
    17dd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    17e1:	75 14                	jne    17f7 <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
    17e3:	c7 44 24 04 3c 1a 00 	movl   $0x1a3c,0x4(%esp)
    17ea:	00 
    17eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17f2:	e8 20 f9 ff ff       	call   1117 <printf>
  }
  
  // shift left all elements at the array
  int i;
  for(i = 0; i < bb->count ; i++){
    17f7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    17fe:	eb 4b                	jmp    184b <BB_pop+0x9b>
    if(i != (bb->count -1)){
    1800:	8b 45 08             	mov    0x8(%ebp),%eax
    1803:	8b 40 10             	mov    0x10(%eax),%eax
    1806:	83 e8 01             	sub    $0x1,%eax
    1809:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    180c:	74 25                	je     1833 <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
    180e:	8b 45 08             	mov    0x8(%ebp),%eax
    1811:	8b 40 1c             	mov    0x1c(%eax),%eax
    1814:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1817:	c1 e2 02             	shl    $0x2,%edx
    181a:	01 c2                	add    %eax,%edx
    181c:	8b 45 08             	mov    0x8(%ebp),%eax
    181f:	8b 40 1c             	mov    0x1c(%eax),%eax
    1822:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    1825:	83 c1 01             	add    $0x1,%ecx
    1828:	c1 e1 02             	shl    $0x2,%ecx
    182b:	01 c8                	add    %ecx,%eax
    182d:	8b 00                	mov    (%eax),%eax
    182f:	89 02                	mov    %eax,(%edx)
    1831:	eb 14                	jmp    1847 <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
    1833:	8b 45 08             	mov    0x8(%ebp),%eax
    1836:	8b 40 1c             	mov    0x1c(%eax),%eax
    1839:	8b 55 f4             	mov    -0xc(%ebp),%edx
    183c:	c1 e2 02             	shl    $0x2,%edx
    183f:	01 d0                	add    %edx,%eax
    1841:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  printf(1,"we have uninitialize element\n");
  }
  ...
  int i;
  for(i = 0; i < bb->count ; i++){
    1847:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    184b:	8b 45 08             	mov    0x8(%ebp),%eax
    184e:	8b 40 10             	mov    0x10(%eax),%eax
    1851:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    1854:	7f aa                	jg     1800 <BB_pop+0x50>
     }
  ...
  bb->count--;
    ...
    1859:	8b 40 10             	mov    0x10(%eax),%eax
    185c:	8d 50 ff             	lea    -0x1(%eax),%edx
    185f:	8b 45 08             	mov    0x8(%ebp),%eax
    1862:	89 50 10             	mov    %edx,0x10(%eax)
  
  binary_semaphore_up(bb->mutex);
    1865:	8b 45 08             	mov    0x8(%ebp),%eax
    1868:	8b 40 04             	mov    0x4(%eax),%eax
    186b:	89 04 24             	mov    %eax,(%esp)
    186e:	e8 c5 f7 ff ff       	call   1038 <binary_semaphore_up>
  semaphore_up(bb->empty);
    1873:	8b 45 08             	mov    0x8(%ebp),%eax
    1876:	8b 40 08             	mov    0x8(%eax),%eax
    1879:	89 04 24             	mov    %eax,(%esp)
    187c:	e8 55 fd ff ff       	call   15d6 <semaphore_up>
