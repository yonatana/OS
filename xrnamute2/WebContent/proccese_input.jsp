...
<body>
	...
	<%
		...
		id = db.insertInput(email, windowMin, windowMax, temp, sequence);
		 /*if(!db.initTables())
			 linkMassage = "we encountered a problem while initializing the db, please try again.";
			adress = "index.jsp";*/
		if (id == 0) {
			...
			try {
				...
				e.printStackTrace();
				linkMassage = "we encountered a problem while using the algorithm, please try again.";
				adress = "index.jsp";
			}
		}
	%>
