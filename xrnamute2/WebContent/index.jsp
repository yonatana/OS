...
<title>RNAthermsw webserver</title>
	...
	<table
		...
		<tbody>
			<tr>
				<td>[<a href="http://www.cs.bgu.ac.il/~rnathemsw/RNAthemsw/">Home</a>|<a
					href="http://www.cs.bgu.ac.il/~rnathemsw/RNAthemsw/result.jsp?id=66" target="_blank">Help</a>]
				</td>
			</tr>
		</tbody>
	</table>
...
<form name="form" action="proccese_input.jsp"
	...
	<a1> <font color="navy"><p>
			...
			default (37 C).<br> After input is given and the "submit" button
			is pressed, a link will be shown to display the results when they are
			ready.<br> Please note that it may take a while for the
			algorithm to compute the necessary data, especially for long
	...
	<br /> <input type="button" onclick="insert_values(this)"
		value="Example"> <br>
	<blockquote>
		&nbsp;
...
<font size="2"> Created by Alexander Churkin, Yonatan Alexander,
	...
	<font /> <!-- 
		...
		function insert_values(thisform) {
			//alert("validWin");
			document.form.str.value = 'AGCGGGGGAGACAUAUAUCACAGCCUGUCUCGUGCCCGACCCCGC';
			document.form.min.value ='10';
			document.form.max.value = '15';
			document.form.temp.value = '42';
		}
	</script>
</html>
