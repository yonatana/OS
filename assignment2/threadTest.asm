...
void* printme2(){
  ...
  22:	c7 44 24 04 ec 0e 00 	movl   $0xeec,0x4(%esp)
  29:	00 
...
void* printme(){
  ...
  bd:	a1 44 14 00 00       	mov    0x1444,%eax
  ...
  e7:	c7 44 24 04 08 0f 00 	movl   $0xf08,0x4(%esp)
  ee:	00 
...
void* printme(){
 ...
 105:	a1 44 14 00 00       	mov    0x1444,%eax
...
void binary_semaphore_test(int num_of_threads){
 ...
 126:	a3 44 14 00 00       	mov    %eax,0x1444
...
void* printme3(){
 ...
 170:	83 ec 24             	sub    $0x24,%esp
  ...
  for(;;){
    semaphore_down(sem);
 173:	a1 40 14 00 00       	mov    0x1440,%eax
 ...
 19d:	c7 44 24 04 08 0f 00 	movl   $0xf08,0x4(%esp)
 1a4:	00 
...
void* printme3(){
 ...
 1b9:	7e ce                	jle    189 <printme3+0x1d>
    ...
    semaphore_up(sem);
 1bb:	a1 40 14 00 00       	mov    0x1440,%eax
...
void counting_semaphore_test(int num_of_threads){
 ...
 1dc:	a3 40 14 00 00       	mov    %eax,0x1440
  for(i = 0; i < num_of_threads; i++){
...
void* printme4(){
 ...
 228:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  for(;;){
    BB_put(buf,sheker);
 22f:	a1 48 14 00 00       	mov    0x1448,%eax
...
void* printme5(){
 ...
 248:	83 ec 18             	sub    $0x18,%esp
  for(;;){
    BB_pop(buf);
 24b:	a1 48 14 00 00       	mov    0x1448,%eax
 250:	89 04 24             	mov    %eax,(%esp)
 253:	e8 80 0b 00 00       	call   dd8 <BB_pop>
...
void bounded_buffer_test(int num_of_producers,int num_of_consumers){
 ...
 26c:	a3 48 14 00 00       	mov    %eax,0x1448
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	0f b6 90 20 14 00 00 	movzbl 0x1420(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 835:	75 27                	jne    85e <printf+0x11f>
          s = "(null)";
 837:	c7 45 f4 29 0f 00 00 	movl   $0xf29,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 903:	a1 3c 14 00 00       	mov    0x143c,%eax
...
free(void *ap)
{
 ...
 9c4:	a3 3c 14 00 00       	mov    %eax,0x143c
}
 9c9:	c9                   	leave  
 9ca:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a17:	e8 d8 fe ff ff       	call   8f4 <free>
  return freep;
 a1c:	a1 3c 14 00 00       	mov    0x143c,%eax
}
 a21:	c9                   	leave  
 a22:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a38:	a1 3c 14 00 00       	mov    0x143c,%eax
 a3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a44:	75 23                	jne    a69 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a46:	c7 45 f0 34 14 00 00 	movl   $0x1434,-0x10(%ebp)
 a4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a50:	a3 3c 14 00 00       	mov    %eax,0x143c
 a55:	a1 3c 14 00 00       	mov    0x143c,%eax
 a5a:	a3 34 14 00 00       	mov    %eax,0x1434
    base.s.size = 0;
 a5f:	c7 05 38 14 00 00 00 	movl   $0x0,0x1438
 a66:	00 00 00 
  }
 ...
 abc:	a3 3c 14 00 00       	mov    %eax,0x143c
      return (void*)(p + 1);
 ...
 ac7:	eb 38                	jmp    b01 <malloc+0xde>
    ...
    if(p == freep)
 ac9:	a1 3c 14 00 00       	mov    0x143c,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 b6a:	c7 44 24 04 30 0f 00 	movl   $0xf30,0x4(%esp)
 b71:	00 
...
BB_create(int max_capacity){
 ...
 d48:	c7 44 24 04 64 0f 00 	movl   $0xf64,0x4(%esp)
 d4f:	00 
 ...
 d62:	e8 47 01 00 00       	call   eae <BB_free>
...
{ 
 ...
 db7:	89 50 10             	mov    %edx,0x10(%eax)
  binary_semaphore_up(bb->mutex);
 dba:	8b 45 08             	mov    0x8(%ebp),%eax
 dbd:	8b 40 04             	mov    0x4(%eax),%eax
 dc0:	89 04 24             	mov    %eax,(%esp)
 dc3:	e8 98 f8 ff ff       	call   660 <binary_semaphore_up>
  semaphore_up(bb->full);
 dc8:	8b 45 08             	mov    0x8(%ebp),%eax
 dcb:	8b 40 0c             	mov    0xc(%eax),%eax
 dce:	89 04 24             	mov    %eax,(%esp)
 dd1:	e8 28 fe ff ff       	call   bfe <semaphore_up>
}
 dd6:	c9                   	leave  
 dd7:	c3                   	ret    
...
void* BB_pop(struct BB* bb)
{
 ...
 de1:	8b 40 0c             	mov    0xc(%eax),%eax
 de4:	89 04 24             	mov    %eax,(%esp)
 de7:	e8 bb fd ff ff       	call   ba7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 dec:	8b 45 08             	mov    0x8(%ebp),%eax
 def:	8b 40 04             	mov    0x4(%eax),%eax
 df2:	89 04 24             	mov    %eax,(%esp)
 df5:	e8 5e f8 ff ff       	call   658 <binary_semaphore_down>
  element_to_pop = bb->pointer_to_elements[0];
 dfa:	8b 45 08             	mov    0x8(%ebp),%eax
 dfd:	8b 40 1c             	mov    0x1c(%eax),%eax
 e00:	8b 00                	mov    (%eax),%eax
 e02:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  if(!element_to_pop){
 e05:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e09:	75 14                	jne    e1f <BB_pop+0x47>
  printf(1,"we have uninitialize element\n");
 e0b:	c7 44 24 04 b0 0f 00 	movl   $0xfb0,0x4(%esp)
 e12:	00 
 e13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 e1a:	e8 20 f9 ff ff       	call   73f <printf>
  }
 ...
 e26:	eb 4b                	jmp    e73 <BB_pop+0x9b>
    if(i != (bb->count -1)){
 e28:	8b 45 08             	mov    0x8(%ebp),%eax
 e2b:	8b 40 10             	mov    0x10(%eax),%eax
 e2e:	83 e8 01             	sub    $0x1,%eax
 e31:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 e34:	74 25                	je     e5b <BB_pop+0x83>
      bb->pointer_to_elements[i] = bb->pointer_to_elements[i+1];
 e36:	8b 45 08             	mov    0x8(%ebp),%eax
 e39:	8b 40 1c             	mov    0x1c(%eax),%eax
 e3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e3f:	c1 e2 02             	shl    $0x2,%edx
 e42:	01 c2                	add    %eax,%edx
 e44:	8b 45 08             	mov    0x8(%ebp),%eax
 e47:	8b 40 1c             	mov    0x1c(%eax),%eax
 e4a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 e4d:	83 c1 01             	add    $0x1,%ecx
 e50:	c1 e1 02             	shl    $0x2,%ecx
 e53:	01 c8                	add    %ecx,%eax
 e55:	8b 00                	mov    (%eax),%eax
 e57:	89 02                	mov    %eax,(%edx)
 e59:	eb 14                	jmp    e6f <BB_pop+0x97>
    }else{
      bb->pointer_to_elements[i] = 0;
 e5b:	8b 45 08             	mov    0x8(%ebp),%eax
 e5e:	8b 40 1c             	mov    0x1c(%eax),%eax
 e61:	8b 55 f4             	mov    -0xc(%ebp),%edx
 e64:	c1 e2 02             	shl    $0x2,%edx
 ...
 e76:	8b 40 10             	mov    0x10(%eax),%eax
 e79:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 e7c:	7f aa                	jg     e28 <BB_pop+0x50>
     }
...
void BB_free(struct BB* bb){
 ...
 eb7:	8b 40 08             	mov    0x8(%eax),%eax
 eba:	89 04 24             	mov    %eax,(%esp)
 ebd:	e8 86 fd ff ff       	call   c48 <semaphore_free>
  semaphore_free(bb->full);
 ec2:	8b 45 08             	mov    0x8(%ebp),%eax
 ec5:	8b 40 0c             	mov    0xc(%eax),%eax
 ec8:	89 04 24             	mov    %eax,(%esp)
 ecb:	e8 78 fd ff ff       	call   c48 <semaphore_free>
  free(bb->pointer_to_elements);
 ed0:	8b 45 08             	mov    0x8(%ebp),%eax
 ed3:	8b 40 1c             	mov    0x1c(%eax),%eax
 ed6:	89 04 24             	mov    %eax,(%esp)
 ed9:	e8 16 fa ff ff       	call   8f4 <free>
  free(bb);
 ede:	8b 45 08             	mov    0x8(%ebp),%eax
 ee1:	89 04 24             	mov    %eax,(%esp)
 ee4:	e8 0b fa ff ff       	call   8f4 <free>
}
 ee9:	c9                   	leave  
 eea:	c3                   	ret    
