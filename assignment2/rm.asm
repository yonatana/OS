...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 88 0c 00 	movl   $0xc88,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	0f b6 90 8c 10 00 00 	movzbl 0x108c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 27                	jne    5be <printf+0x11f>
          s = "(null)";
 597:	c7 45 f4 a1 0c 00 00 	movl   $0xca1,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 a8 10 00 00       	mov    0x10a8,%eax
...
free(void *ap)
{
 ...
 724:	a3 a8 10 00 00       	mov    %eax,0x10a8
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 d8 fe ff ff       	call   654 <free>
  return freep;
 77c:	a1 a8 10 00 00       	mov    0x10a8,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 795:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 798:	a1 a8 10 00 00       	mov    0x10a8,%eax
 79d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a4:	75 23                	jne    7c9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 45 f0 a0 10 00 00 	movl   $0x10a0,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 a8 10 00 00       	mov    %eax,0x10a8
 7b5:	a1 a8 10 00 00       	mov    0x10a8,%eax
 7ba:	a3 a0 10 00 00       	mov    %eax,0x10a0
    base.s.size = 0;
 7bf:	c7 05 a4 10 00 00 00 	movl   $0x0,0x10a4
 7c6:	00 00 00 
  }
 ...
 81c:	a3 a8 10 00 00       	mov    %eax,0x10a8
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 a8 10 00 00       	mov    0x10a8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8ca:	c7 44 24 04 a8 0c 00 	movl   $0xca8,0x4(%esp)
 8d1:	00 
...
BB_create(int max_capacity){
 ...
 aa8:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 aaf:	00 
...
int BB_size(struct BB* bb){
 ...
 c0b:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 c0e:	c7 44 24 04 28 0d 00 	movl   $0xd28,0x4(%esp)
 c15:	00 
