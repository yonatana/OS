...
void semaphore_down(struct semaphore* sem ){
 ...
 90a:	e8 a9 fa ff ff       	call   3b8 <binary_semaphore_down>
  sem->value--;	
 90f:	8b 45 08             	mov    0x8(%ebp),%eax
 912:	8b 40 08             	mov    0x8(%eax),%eax
 915:	8d 50 ff             	lea    -0x1(%eax),%edx
