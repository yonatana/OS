...
void semaphore_up(struct semaphore* sem ){
 ...
 9de:	e8 61 fa ff ff       	call   444 <binary_semaphore_down>
	sem->value++;	
 ...
 9f5:	8b 40 08             	mov    0x8(%eax),%eax
 9f8:	85 c0                	test   %eax,%eax
 9fa:	7f 10                	jg     a0c <semaphore_up+0x3c>
         binary_semaphore_up(sem->s2);
 9fc:	8b 45 08             	mov    0x8(%ebp),%eax
 9ff:	8b 40 04             	mov    0x4(%eax),%eax
 a02:	89 04 24             	mov    %eax,(%esp)
 a05:	e8 42 fa ff ff       	call   44c <binary_semaphore_up>
 a0a:	eb 0d                	jmp    a19 <semaphore_up+0x49>
