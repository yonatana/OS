...
wc(int fd, char *name)
{
  ...
  ed:	c7 44 24 04 a1 09 00 	movl   $0x9a1,0x4(%esp)
  f4:	00 
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 ae 09 00 	movl   $0x9ae,0x4(%esp)
 119:	00 
 ...
 16c:	c7 44 24 04 af 09 00 	movl   $0x9af,0x4(%esp)
 173:	00 
 174:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 17b:	e8 47 04 00 00       	call   5c7 <printf>
      exit();
...
printf(int fd, char *fmt, ...)
{
 ...
 6bd:	75 27                	jne    6e6 <printf+0x11f>
          s = "(null)";
 6bf:	c7 45 f4 c4 09 00 00 	movl   $0x9c4,-0xc(%ebp)
        while(*s != 0){
