...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 62 08 00 	movl   $0x862,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	0f b6 90 c4 0a 00 00 	movzbl 0xac4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 57d:	75 27                	jne    5a6 <printf+0x11f>
          s = "(null)";
 57f:	c7 45 f4 7e 08 00 00 	movl   $0x87e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 e0 0a 00 00       	mov    0xae0,%eax
