...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 a7 09 00 	movl   $0x9a7,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	0f b6 90 9c 0c 00 00 	movzbl 0xc9c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 27                	jne    5be <printf+0x11f>
          s = "(null)";
 597:	c7 45 f4 c3 09 00 00 	movl   $0x9c3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 b8 0c 00 00       	mov    0xcb8,%eax
...
free(void *ap)
{
 ...
 724:	a3 b8 0c 00 00       	mov    %eax,0xcb8
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 d8 fe ff ff       	call   654 <free>
  return freep;
 77c:	a1 b8 0c 00 00       	mov    0xcb8,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7a6:	c7 45 f0 b0 0c 00 00 	movl   $0xcb0,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 b8 0c 00 00       	mov    %eax,0xcb8
 7b5:	a1 b8 0c 00 00       	mov    0xcb8,%eax
 7ba:	a3 b0 0c 00 00       	mov    %eax,0xcb0
    base.s.size = 0;
 7bf:	c7 05 b4 0c 00 00 00 	movl   $0x0,0xcb4
 7c6:	00 00 00 
  }
 ...
 81c:	a3 b8 0c 00 00       	mov    %eax,0xcb8
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 b8 0c 00 00       	mov    0xcb8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8b1:	c7 44 24 04 cc 09 00 	movl   $0x9cc,0x4(%esp)
 8b8:	00 
