...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       ...
       b:	c7 44 24 04 ca 45 00 	movl   $0x45ca,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 b4 45 00 00 	movl   $0x45b4,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 b4 64 00 00       	mov    0x64b4,%eax
      3d:	c7 44 24 04 d5 45 00 	movl   $0x45d5,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 e8 45 00 00 	movl   $0x45e8,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 b4 64 00 00       	mov    0x64b4,%eax
      7f:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 b4 64 00 00       	mov    0x64b4,%eax
      99:	c7 44 24 04 13 46 00 	movl   $0x4613,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 b4 64 00 00       	mov    0x64b4,%eax
      b6:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 32 46 00 00 	movl   $0x4632,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 b4 64 00 00       	mov    0x64b4,%eax
      e8:	c7 44 24 04 38 46 00 	movl   $0x4638,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 b4 64 00 00       	mov    0x64b4,%eax
     109:	c7 44 24 04 53 46 00 	movl   $0x4653,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 6f 46 00 	movl   $0x466f,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 b4 64 00 00       	mov    0x64b4,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 7c 46 00 	movl   $0x467c,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 a0 46 00 	movl   $0x46a0,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 b4 64 00 00       	mov    0x64b4,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 ac 46 00 	movl   $0x46ac,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 b4 64 00 00       	mov    0x64b4,%eax
     1b3:	c7 44 24 04 d0 46 00 	movl   $0x46d0,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 32 46 00 00 	movl   $0x4632,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 b4 64 00 00       	mov    0x64b4,%eax
     1f0:	c7 44 24 04 db 46 00 	movl   $0x46db,0x4(%esp)
     1f7:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 b4 64 00 00       	mov    0x64b4,%eax
     22e:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 b4 64 00 00       	mov    0x64b4,%eax
     248:	c7 44 24 04 0f 47 00 	movl   $0x470f,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 32 46 00 00 	movl   $0x4632,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 b4 64 00 00       	mov    0x64b4,%eax
     27a:	c7 44 24 04 22 47 00 	movl   $0x4722,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 b4 64 00 00       	mov    0x64b4,%eax
     294:	c7 44 24 04 2f 47 00 	movl   $0x472f,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 b4 64 00 00       	mov    0x64b4,%eax
     2ae:	c7 44 24 04 44 47 00 	movl   $0x4744,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2cb:	c7 44 24 04 58 47 00 	movl   $0x4758,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 68 47 00 00 	movl   $0x4768,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 b4 64 00 00       	mov    0x64b4,%eax
     2fd:	c7 44 24 04 6c 47 00 	movl   $0x476c,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 b4 64 00 00       	mov    0x64b4,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 86 47 00 	movl   $0x4786,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 68 47 00 00 	movl   $0x4768,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 b4 64 00 00       	mov    0x64b4,%eax
     3a3:	c7 44 24 04 a4 47 00 	movl   $0x47a4,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3f0:	a1 b4 64 00 00       	mov    0x64b4,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 bd 47 00 	movl   $0x47bd,0x4(%esp)
     403:	00 
     ...
     41a:	a1 b4 64 00 00       	mov    0x64b4,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 da 47 00 	movl   $0x47da,0x4(%esp)
     42d:	00 
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 68 47 00 00 	movl   $0x4768,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 b4 64 00 00       	mov    0x64b4,%eax
     49d:	c7 44 24 04 0c 48 00 	movl   $0x480c,0x4(%esp)
     4a4:	00 
  ...
  printf(stdout, "big files ok\n");
     4b2:	a1 b4 64 00 00       	mov    0x64b4,%eax
     4b7:	c7 44 24 04 1f 48 00 	movl   $0x481f,0x4(%esp)
     4be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 b4 64 00 00       	mov    0x64b4,%eax
     4d4:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 fb 38 00 00       	call   3ddf <printf>

  name[0] = 'a';
     4e4:	c6 05 a0 ac 00 00 61 	movb   $0x61,0xaca0
  name[2] = '\0';
     4eb:	c6 05 a2 ac 00 00 00 	movb   $0x0,0xaca2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 a1 ac 00 00       	mov    %al,0xaca1
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 a0 ac 00 00 	movl   $0xaca0,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 a0 ac 00 00 61 	movb   $0x61,0xaca0
  name[2] = '\0';
     539:	c6 05 a2 ac 00 00 00 	movb   $0x0,0xaca2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 a1 ac 00 00       	mov    %al,0xaca1
    unlink(name);
     554:	c7 04 24 a0 ac 00 00 	movl   $0xaca0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 b4 64 00 00       	mov    0x64b4,%eax
     56f:	c7 44 24 04 58 48 00 	movl   $0x4858,0x4(%esp)
     576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 b4 64 00 00       	mov    0x64b4,%eax
     58c:	c7 44 24 04 7e 48 00 	movl   $0x487e,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 43 38 00 00       	call   3ddf <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 b4 64 00 00       	mov    0x64b4,%eax
     5b1:	c7 44 24 04 8f 48 00 	movl   $0x488f,0x4(%esp)
     5b8:	00 
  ...
  if(chdir("dir0") < 0){
     5c6:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 b4 64 00 00       	mov    0x64b4,%eax
     5db:	c7 44 24 04 9d 48 00 	movl   $0x489d,0x4(%esp)
     5e2:	00 
  ...
  if(chdir("..") < 0){
     5f0:	c7 04 24 b0 48 00 00 	movl   $0x48b0,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 b4 64 00 00       	mov    0x64b4,%eax
     605:	c7 44 24 04 b3 48 00 	movl   $0x48b3,0x4(%esp)
     60c:	00 
  ...
  if(unlink("dir0") < 0){
     61a:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 b4 64 00 00       	mov    0x64b4,%eax
     62f:	c7 44 24 04 c4 48 00 	movl   $0x48c4,0x4(%esp)
     636:	00 
  ...
  printf(stdout, "mkdir test\n");
     644:	a1 b4 64 00 00       	mov    0x64b4,%eax
     649:	c7 44 24 04 7e 48 00 	movl   $0x487e,0x4(%esp)
     650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 b4 64 00 00       	mov    0x64b4,%eax
     666:	c7 44 24 04 d8 48 00 	movl   $0x48d8,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 69 37 00 00       	call   3ddf <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 a0 64 00 	movl   $0x64a0,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 b4 45 00 00 	movl   $0x45b4,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 b4 64 00 00       	mov    0x64b4,%eax
     693:	c7 44 24 04 e3 48 00 	movl   $0x48e3,0x4(%esp)
     69a:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 f5 48 00 	movl   $0x48f5,0x4(%esp)
     6c6:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	81 c2 a0 8c 00 00    	add    $0x8ca0,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     737:	00 
     738:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     73f:	00 
     ...
     74f:	c7 44 24 04 04 49 00 	movl   $0x4904,0x4(%esp)
     756:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a8:	05 a0 8c 00 00       	add    $0x8ca0,%eax
     ...
     7c8:	c7 44 24 04 12 49 00 	movl   $0x4912,0x4(%esp)
     7cf:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     811:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     818:	00 
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 20 49 00 	movl   $0x4920,0x4(%esp)
     845:	00 
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 37 49 00 	movl   $0x4937,0x4(%esp)
     86e:	00 
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 41 49 00 	movl   $0x4941,0x4(%esp)
     884:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 50 49 00 	movl   $0x4950,0x4(%esp)
     8a5:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 5c 49 00 	movl   $0x495c,0x4(%esp)
     91d:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94c:	00 
     94d:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     954:	00 
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 70 49 00 	movl   $0x4970,0x4(%esp)
     969:	00 
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 83 49 00 	movl   $0x4983,0x4(%esp)
     98a:	00 
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 8c 49 00 	movl   $0x498c,0x4(%esp)
     9bf:	00 
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 95 49 00 	movl   $0x4995,0x4(%esp)
     9e2:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
     a15:	00 
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 ae 49 00 	movl   $0x49ae,0x4(%esp)
     a3b:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 be 49 00 	movl   $0x49be,0x4(%esp)
     a60:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
     a7c:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b05:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
     b0c:	00 
    ...
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 ef 49 00 	movl   $0x49ef,0x4(%esp)
     b3b:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 10 4a 00 	movl   $0x4a10,0x4(%esp)
     b9e:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 3c 4a 00 	movl   $0x4a3c,0x4(%esp)
     c10:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 06 4a 00 00 	movl   $0x4a06,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
     c6b:	00 
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 06 4a 00 00 	movl   $0x4a06,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 87 4a 00 	movl   $0x4a87,0x4(%esp)
     d16:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 94 4a 00 	movl   $0x4a94,0x4(%esp)
     d3a:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 a9 4a 00 	movl   $0x4aa9,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 77 30 00 00       	call   3ddf <printf>

  unlink("f1");
     d68:	c7 04 24 b8 4a 00 00 	movl   $0x4ab8,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 bb 4a 00 00 	movl   $0x4abb,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
     d95:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 b8 4a 00 00       	mov    $0x4ab8,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 bb 4a 00 00       	mov    $0x4abb,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 be 4a 00 	movl   $0x4abe,0x4(%esp)
     ddf:	00 
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0f:	c7 04 24 a0 8c 00 00 	movl   $0x8ca0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e2b:	00 
     e2c:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     e33:	00 
     ...
     e52:	c7 44 24 04 cd 4a 00 	movl   $0x4acd,0x4(%esp)
     e59:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 b8 4a 00 00       	mov    $0x4ab8,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 bb 4a 00 00       	mov    $0x4abb,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed6:	05 a0 8c 00 00       	add    $0x8ca0,%eax
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 de 4a 00 	movl   $0x4ade,0x4(%esp)
     efe:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f29:	00 
     f2a:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
     f31:	00 
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 ea 4a 00 	movl   $0x4aea,0x4(%esp)
     f68:	00 
  ...
  unlink("f1");
     f88:	c7 04 24 b8 4a 00 00 	movl   $0x4ab8,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 bb 4a 00 00 	movl   $0x4abb,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 fb 4a 00 	movl   $0x4afb,0x4(%esp)
     fa7:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 08 4b 00 	movl   $0x4b08,0x4(%esp)
     fc3:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
     fe5:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 be 4a 00 	movl   $0x4abe,0x4(%esp)
    1048:	00 
    ...
    1096:	c7 44 24 04 1b 4b 00 	movl   $0x4b1b,0x4(%esp)
    109d:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 2c 4b 00 	movl   $0x4b2c,0x4(%esp)
    111c:	00 
    ...
    1147:	c7 44 24 04 50 4b 00 	movl   $0x4b50,0x4(%esp)
    114e:	00 
    ...
    11ad:	c7 44 24 04 2c 4b 00 	movl   $0x4b2c,0x4(%esp)
    11b4:	00 
    ...
    11df:	c7 44 24 04 50 4b 00 	movl   $0x4b50,0x4(%esp)
    11e6:	00 
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 70 4b 00 	movl   $0x4b70,0x4(%esp)
    1258:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 81 4b 00 	movl   $0x4b81,0x4(%esp)
    1274:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1288:	00 
    1289:	c7 04 24 92 4b 00 00 	movl   $0x4b92,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 9d 4b 00 	movl   $0x4b9d,0x4(%esp)
    12a5:	00 
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 b7 4b 00 	movl   $0x4bb7,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 92 4b 00 00 	movl   $0x4b92,(%esp)
  ...
  if(fd < 0){
    ...
    12fa:	c7 44 24 04 bd 4b 00 	movl   $0x4bbd,0x4(%esp)
    1301:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1380:	00 
    1381:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    1388:	00 
    ...
    1399:	c7 44 24 04 f3 4b 00 	movl   $0x4bf3,0x4(%esp)
    13a0:	00 
  ...
  if(buf[0] != 'h'){
    13b2:	0f b6 05 a0 8c 00 00 	movzbl 0x8ca0,%eax
    13b9:	3c 68                	cmp    $0x68,%al
    13bb:	74 19                	je     13d6 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13bd:	c7 44 24 04 0a 4c 00 	movl   $0x4c0a,0x4(%esp)
    13c4:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13dd:	00 
    13de:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    13e5:	00 
    ...
    13f6:	c7 44 24 04 21 4c 00 	movl   $0x4c21,0x4(%esp)
    13fd:	00 
  ...
  unlink("unlinkread");
    141a:	c7 04 24 92 4b 00 00 	movl   $0x4b92,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 3a 4c 00 	movl   $0x4c3a,0x4(%esp)
    142d:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 5b 4c 00 	movl   $0x4c5b,0x4(%esp)
    1492:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 b7 4b 00 	movl   $0x4bb7,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 6e 4c 00 	movl   $0x4c6e,0x4(%esp)
    14cb:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14e8:	c7 44 24 04 57 4c 00 	movl   $0x4c57,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
    14f7:	e8 8c 27 00 00       	call   3c88 <link>
    14fc:	85 c0                	test   %eax,%eax
    14fe:	79 19                	jns    1519 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1500:	c7 44 24 04 80 4c 00 	movl   $0x4c80,0x4(%esp)
    1507:	00 
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 57 4c 00 00 	movl   $0x4c57,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 bd 4c 00 	movl   $0x4cbd,0x4(%esp)
    157a:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1593:	00 
    1594:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    159b:	00 
    ...
    15ac:	c7 44 24 04 ce 4c 00 	movl   $0x4cce,0x4(%esp)
    15b3:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 57 4c 00 	movl   $0x4c57,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 57 4c 00 00 	movl   $0x4c57,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 df 4c 00 	movl   $0x4cdf,0x4(%esp)
    15ef:	00 
  ...
  unlink("lf2");
    1601:	c7 04 24 57 4c 00 00 	movl   $0x4c57,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 57 4c 00 00 	movl   $0x4c57,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 00 4d 00 	movl   $0x4d00,0x4(%esp)
    162c:	00 
  ...
  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 23 4d 00 00 	movl   $0x4d23,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 25 4d 00 	movl   $0x4d25,0x4(%esp)
    165d:	00 
  ...
  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 41 4d 00 	movl   $0x4d41,0x4(%esp)
    1676:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 4e 4d 00 	movl   $0x4d4e,0x4(%esp)
    1692:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 5e 4d 00 00 	movl   $0x4d5e,(%esp)
    ...
    1741:	c7 04 24 5e 4d 00 00 	movl   $0x4d5e,(%esp)
    ...
    1772:	c7 44 24 04 61 4d 00 	movl   $0x4d61,0x4(%esp)
    1779:	00 
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 23 4d 00 00 	movl   $0x4d23,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 7d 4d 00 	movl   $0x4d7d,0x4(%esp)
    183f:	00 
    ...
    1868:	c7 44 24 04 96 4d 00 	movl   $0x4d96,0x4(%esp)
    186f:	00 
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 b4 4d 00 	movl   $0x4db4,0x4(%esp)
    18cb:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
    1907:	00 
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 e5 4d 00 	movl   $0x4de5,0x4(%esp)
    1a27:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 f3 4d 00 	movl   $0x4df3,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 8f 23 00 00       	call   3ddf <printf>

  unlink("x");
    1a50:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
    1a71:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 04 4e 00 00 	movl   $0x4e04,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 08 4e 00 	movl   $0x4e08,0x4(%esp)
    1b4e:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 27 4e 00 	movl   $0x4e27,0x4(%esp)
    1bac:	00 
  ...
  unlink("bd");
    1c43:	c7 04 24 24 4e 00 00 	movl   $0x4e24,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 51 4e 00 	movl   $0x4e51,0x4(%esp)
    1ca2:	00 
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 66 4e 00 	movl   $0x4e66,0x4(%esp)
    1cc8:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 9c 4e 00 00 	movl   $0x4e9c,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 a2 4e 00 	movl   $0x4ea2,0x4(%esp)
    1d4a:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 7e 4e 00 	movl   $0x4e7e,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 00 4f 00 00 	movl   $0x4f00,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 09 4f 00 	movl   $0x4f09,0x4(%esp)
    1df8:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 21 4f 00 	movl   $0x4f21,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 24 4f 00 00 	movl   $0x4f24,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 30 4f 00 	movl   $0x4f30,0x4(%esp)
    1e54:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6d:	00 
    1e6e:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    1e75:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8a:	0f b6 05 a0 8c 00 00 	movzbl 0x8ca0,%eax
    1e91:	3c 66                	cmp    $0x66,%al
    1e93:	74 19                	je     1eae <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e95:	c7 44 24 04 49 4f 00 	movl   $0x4f49,0x4(%esp)
    1e9c:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eb9:	c7 44 24 04 64 4f 00 	movl   $0x4f64,0x4(%esp)
    1ec0:	00 
    1ec1:	c7 04 24 00 4f 00 00 	movl   $0x4f00,(%esp)
    1ec8:	e8 bb 1d 00 00       	call   3c88 <link>
    1ecd:	85 c0                	test   %eax,%eax
    1ecf:	74 19                	je     1eea <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed1:	c7 44 24 04 70 4f 00 	movl   $0x4f70,0x4(%esp)
    1ed8:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 64 4f 00 00 	movl   $0x4f64,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 2e 50 00 	movl   $0x502e,0x4(%esp)
    200c:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2025:	00 
    2026:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    202d:	00 
    ...
    203e:	c7 44 24 04 46 50 00 	movl   $0x5046,0x4(%esp)
    2045:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2188:	c7 44 24 04 1d 51 00 	movl   $0x511d,0x4(%esp)
    218f:	00 
    2190:	c7 04 24 89 50 00 00 	movl   $0x5089,(%esp)
    2197:	e8 ec 1a 00 00       	call   3c88 <link>
    219c:	85 c0                	test   %eax,%eax
    219e:	75 19                	jne    21b9 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a0:	c7 44 24 04 28 51 00 	movl   $0x5128,0x4(%esp)
    21a7:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21b9:	c7 44 24 04 1d 51 00 	movl   $0x511d,0x4(%esp)
    21c0:	00 
    21c1:	c7 04 24 ae 50 00 00 	movl   $0x50ae,(%esp)
    21c8:	e8 bb 1a 00 00       	call   3c88 <link>
    21cd:	85 c0                	test   %eax,%eax
    21cf:	75 19                	jne    21ea <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d1:	c7 44 24 04 4c 51 00 	movl   $0x514c,0x4(%esp)
    21d8:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21ea:	c7 44 24 04 64 4f 00 	movl   $0x4f64,0x4(%esp)
    21f1:	00 
    21f2:	c7 04 24 9c 4e 00 00 	movl   $0x4e9c,(%esp)
    21f9:	e8 8a 1a 00 00       	call   3c88 <link>
    21fe:	85 c0                	test   %eax,%eax
    2200:	75 19                	jne    221b <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2202:	c7 44 24 04 70 51 00 	movl   $0x5170,0x4(%esp)
    2209:	00 
  ...
  printf(1, "subdir ok\n");
    2407:	c7 44 24 04 b5 52 00 	movl   $0x52b5,0x4(%esp)
    240e:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 c0 52 00 	movl   $0x52c0,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 a8 19 00 00       	call   3ddf <printf>

  unlink("bigwrite");
    2437:	c7 04 24 cf 52 00 00 	movl   $0x52cf,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 cf 52 00 00 	movl   $0x52cf,(%esp)
    ...
    246c:	c7 44 24 04 d8 52 00 	movl   $0x52d8,0x4(%esp)
    2473:	00 
    ...
    2495:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    249c:	00 
    ...
    24c1:	c7 44 24 04 f0 52 00 	movl   $0x52f0,0x4(%esp)
    24c8:	00 
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 cf 52 00 00 	movl   $0x52cf,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 02 53 00 	movl   $0x5302,0x4(%esp)
    2516:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 25 53 00 	movl   $0x5325,0x4(%esp)
    256f:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    2599:	c7 04 24 a0 8c 00 00 	movl   $0x8ca0,(%esp)
    25a0:	e8 de 14 00 00       	call   3a83 <memset>
    if(write(fd, buf, 600) != 600){
    25a5:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ac:	00 
    25ad:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    25b4:	00 
    ...
    25c7:	c7 44 24 04 3b 53 00 	movl   $0x533b,0x4(%esp)
    25ce:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 1d 53 00 00 	movl   $0x531d,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 51 53 00 	movl   $0x5351,0x4(%esp)
    2619:	00 
  ...
  for(i = 0; ; i++){
    ...
    2640:	00 
    2641:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    2648:	00 
    ...
    265d:	c7 44 24 04 66 53 00 	movl   $0x5366,0x4(%esp)
    2664:	00 
    ...
    2685:	c7 44 24 04 7b 53 00 	movl   $0x537b,0x4(%esp)
    268c:	00 
    ...
    269e:	0f b6 05 a0 8c 00 00 	movzbl 0x8ca0,%eax
    ...
    26b8:	0f b6 05 cb 8d 00 00 	movzbl 0x8dcb,%eax
    ...
    26d2:	c7 44 24 04 8f 53 00 	movl   $0x538f,0x4(%esp)
    26d9:	00 
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 a8 53 00 	movl   $0x53a8,0x4(%esp)
    2716:	00 
  ...
  unlink("bigfile");
    2728:	c7 04 24 1d 53 00 00 	movl   $0x531d,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 c2 53 00 	movl   $0x53c2,0x4(%esp)
    273b:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 60 54 00 00 	movl   $0x5460,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 90 54 00 	movl   $0x5490,0x4(%esp)
    27da:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 d0 54 00 00 	movl   $0x54d0,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 00 55 00 	movl   $0x5500,0x4(%esp)
    281b:	00 
  ...
  printf(1, "fourteen ok\n");
    288a:	c7 44 24 04 d9 55 00 	movl   $0x55d9,0x4(%esp)
    2891:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a02:	c7 44 24 04 9f 56 00 	movl   $0x569f,0x4(%esp)
    2a09:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 a9 56 00 	movl   $0x56a9,0x4(%esp)
    2a25:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a39:	00 
    2a3a:	c7 04 24 b6 56 00 00 	movl   $0x56b6,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 be 56 00 	movl   $0x56be,0x4(%esp)
    2a56:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 ef 56 00 00 	movl   $0x56ef,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 fa 56 00 	movl   $0x56fa,0x4(%esp)
    2ac0:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 ef 56 00 00 	movl   $0x56ef,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2aef:	c7 44 24 04 fa 56 00 	movl   $0x56fa,0x4(%esp)
    2af6:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b5a:	c7 44 24 04 ef 56 00 	movl   $0x56ef,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 53 57 00 00 	movl   $0x5753,(%esp)
    2b69:	e8 1a 11 00 00       	call   3c88 <link>
    2b6e:	85 c0                	test   %eax,%eax
    2b70:	75 19                	jne    2b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b72:	c7 44 24 04 5c 57 00 	movl   $0x575c,0x4(%esp)
    2b79:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 23 4d 00 00 	movl   $0x4d23,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    2bd8:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 b3 57 00 	movl   $0x57b3,0x4(%esp)
    2c27:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 c7 57 00 	movl   $0x57c7,0x4(%esp)
    2c4b:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 d7 57 00 	movl   $0x57d7,0x4(%esp)
    2c67:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd2:	c7 04 24 16 58 00 00 	movl   $0x5816,(%esp)
    2cd9:	e8 b2 0f 00 00       	call   3c90 <mkdir>
    link("README", "");
    2cde:	c7 44 24 04 16 58 00 	movl   $0x5816,0x4(%esp)
    2ce5:	00 
    2ce6:	c7 04 24 53 57 00 00 	movl   $0x5753,(%esp)
    2ced:	e8 96 0f 00 00       	call   3c88 <link>
    fd = open("", O_CREATE);
    2cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 16 58 00 00 	movl   $0x5816,(%esp)
    ...
    2d21:	00 
    2d22:	c7 04 24 17 58 00 00 	movl   $0x5817,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 17 58 00 00 	movl   $0x5817,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 3a 56 00 00 	movl   $0x563a,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 1a 58 00 	movl   $0x581a,0x4(%esp)
    2d6f:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 2e 58 00 	movl   $0x582e,0x4(%esp)
    2d8b:	00 
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 3c 58 00 	movl   $0x583c,0x4(%esp)
    2dda:	00 
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 5e 58 00 	movl   $0x585e,0x4(%esp)
    2dfc:	00 
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 72 58 00 	movl   $0x5872,0x4(%esp)
    2e29:	00 
  ...
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 85 58 00 	movl   $0x5885,0x4(%esp)
    2e42:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 b4 64 00 00       	mov    0x64b4,%eax
    2e60:	c7 44 24 04 93 58 00 	movl   $0x5893,0x4(%esp)
    2e67:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 b4 64 00 00       	mov    0x64b4,%eax
    ...
    2ec8:	c7 44 24 04 9e 58 00 	movl   $0x589e,0x4(%esp)
    2ecf:	00 
  ...
  if(pid < 0){
    ...
    2f07:	a1 b4 64 00 00       	mov    0x64b4,%eax
    2f0c:	c7 44 24 04 b9 58 00 	movl   $0x58b9,0x4(%esp)
    2f13:	00 
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 b4 64 00 00       	mov    0x64b4,%eax
    2f4f:	c7 44 24 04 d0 58 00 	movl   $0x58d0,0x4(%esp)
    2f56:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 b4 64 00 00       	mov    0x64b4,%eax
    2faf:	c7 44 24 04 ec 58 00 	movl   $0x58ec,0x4(%esp)
    2fb6:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 b4 64 00 00       	mov    0x64b4,%eax
    2ffa:	c7 44 24 04 2a 59 00 	movl   $0x592a,0x4(%esp)
    3001:	00 
  ...
  if(c != a - 4096){
    ...
    302b:	a1 b4 64 00 00       	mov    0x64b4,%eax
    ...
    303e:	c7 44 24 04 48 59 00 	movl   $0x5948,0x4(%esp)
    3045:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 b4 64 00 00       	mov    0x64b4,%eax
    ...
    30a5:	c7 44 24 04 80 59 00 	movl   $0x5980,0x4(%esp)
    30ac:	00 
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 b4 64 00 00       	mov    0x64b4,%eax
    30c9:	c7 44 24 04 a8 59 00 	movl   $0x59a8,0x4(%esp)
    30d0:	00 
  ...
  if(c != a){
    ...
    3115:	a1 b4 64 00 00       	mov    0x64b4,%eax
    ...
    3128:	c7 44 24 04 d8 59 00 	movl   $0x59d8,0x4(%esp)
    312f:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3161:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
    3168:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 f5 48 00 	movl   $0x48f5,0x4(%esp)
    31e4:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 b4 64 00 00       	mov    0x64b4,%eax
    32e9:	c7 44 24 04 12 5a 00 	movl   $0x5a12,0x4(%esp)
    32f0:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3331:	c7 44 24 04 2d 5a 00 	movl   $0x5a2d,0x4(%esp)
    3338:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3380:	c7 44 24 04 3b 5a 00 	movl   $0x5a3b,0x4(%esp)
    3387:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 4a 5a 00 00 	movl   $0x5a4a,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3403:	c7 44 24 04 55 5a 00 	movl   $0x5a55,0x4(%esp)
    340a:	00 
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3430:	c7 44 24 04 6e 5a 00 	movl   $0x5a6e,0x4(%esp)
    3437:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 b4 64 00 00       	mov    0x64b4,%eax
    344d:	c7 44 24 04 7b 5a 00 	movl   $0x5a7b,0x4(%esp)
    3454:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3469:	05 80 65 00 00       	add    $0x6580,%eax
    346e:	0f b6 00             	movzbl (%eax),%eax
    3471:	84 c0                	test   %al,%al
    3473:	74 1a                	je     348f <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3475:	a1 b4 64 00 00       	mov    0x64b4,%eax
    347a:	c7 44 24 04 85 5a 00 	movl   $0x5a85,0x4(%esp)
    3481:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 b4 64 00 00       	mov    0x64b4,%eax
    34a2:	c7 44 24 04 96 5a 00 	movl   $0x5a96,0x4(%esp)
    34a9:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 a3 5a 00 00 	movl   $0x5aa3,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 e0 64 00 00 	movl   $0x5ab0,0x64e0(,%eax,4)
    34eb:	b0 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f7:	7e e8                	jle    34e1 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34f9:	c7 05 5c 65 00 00 00 	movl   $0x0,0x655c
    3500:	00 00 00 
    printf(stdout, "bigarg test\n");
    3503:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3508:	c7 44 24 04 8d 5b 00 	movl   $0x5b8d,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 c7 08 00 00       	call   3ddf <printf>
    exec("echo", args);
    3518:	c7 44 24 04 e0 64 00 	movl   $0x64e0,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 b4 45 00 00 	movl   $0x45b4,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3531:	c7 44 24 04 9a 5b 00 	movl   $0x5b9a,0x4(%esp)
    3538:	00 
    ...
    3548:	00 
    3549:	c7 04 24 a3 5a 00 00 	movl   $0x5aa3,(%esp)
    ...
    356e:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3573:	c7 44 24 04 aa 5b 00 	movl   $0x5baa,0x4(%esp)
    357a:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 a3 5a 00 00 	movl   $0x5aa3,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 b4 64 00 00       	mov    0x64b4,%eax
    35af:	c7 44 24 04 c3 5b 00 	movl   $0x5bc3,0x4(%esp)
    35b6:	00 
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 a3 5a 00 00 	movl   $0x5aa3,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 d8 5b 00 	movl   $0x5bd8,0x4(%esp)
    35f2:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 e5 5b 00 	movl   $0x5be5,0x4(%esp)
    36e2:	00 
    ...
    3712:	c7 44 24 04 f1 5b 00 	movl   $0x5bf1,0x4(%esp)
    3719:	00 
    ...
    3736:	00 
    3737:	c7 44 24 04 a0 8c 00 	movl   $0x8ca0,0x4(%esp)
    373e:	00 
    ...
    376a:	c7 44 24 04 01 5c 00 	movl   $0x5c01,0x4(%esp)
    3771:	00 
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 11 5c 00 	movl   $0x5c11,0x4(%esp)
    388c:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 b8 64 00 00       	mov    0x64b8,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 b8 64 00 00       	mov    %eax,0x64b8
  return randstate;
    38b7:	a1 b8 64 00 00       	mov    0x64b8,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38c7:	c7 44 24 04 27 5c 00 	movl   $0x5c27,0x4(%esp)
    38ce:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 3b 5c 00 00 	movl   $0x5c3b,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d76:	0f b6 90 bc 64 00 00 	movzbl 0x64bc(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ed5:	75 27                	jne    3efe <printf+0x11f>
          s = "(null)";
    3ed7:	c7 45 f4 76 5c 00 00 	movl   $0x5c76,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3fa3:	a1 68 65 00 00       	mov    0x6568,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    4064:	a3 68 65 00 00       	mov    %eax,0x6568
}
    4069:	c9                   	leave  
    406a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    40bc:	a1 68 65 00 00       	mov    0x6568,%eax
}
    40c1:	c9                   	leave  
    40c2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40d8:	a1 68 65 00 00       	mov    0x6568,%eax
    40dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40e4:	75 23                	jne    4109 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40e6:	c7 45 f0 60 65 00 00 	movl   $0x6560,-0x10(%ebp)
    40ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f0:	a3 68 65 00 00       	mov    %eax,0x6568
    40f5:	a1 68 65 00 00       	mov    0x6568,%eax
    40fa:	a3 60 65 00 00       	mov    %eax,0x6560
    base.s.size = 0;
    40ff:	c7 05 64 65 00 00 00 	movl   $0x0,0x6564
    4106:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    415c:	a3 68 65 00 00       	mov    %eax,0x6568
      return (void*)(p + 1);
    ...
    if(p == freep)
    4169:	a1 68 65 00 00       	mov    0x6568,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  if(sem->s1 == -1 || sem->s2 == -1){
    ...
    420a:	c7 44 24 04 80 5c 00 	movl   $0x5c80,0x4(%esp)
    4211:	00 
...
BB_create(int max_capacity){
  ...
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
   ...
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    43e8:	c7 44 24 04 b4 5c 00 	movl   $0x5cb4,0x4(%esp)
    43ef:	00 
...
int BB_size(struct BB* bb){
  ...
  printf(1,"size\n");
    454e:	c7 44 24 04 00 5d 00 	movl   $0x5d00,0x4(%esp)
    4555:	00 
