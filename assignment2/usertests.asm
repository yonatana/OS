...
void semaphore_down(struct semaphore* sem ){
  ...
  binary_semaphore_down(sem->s2);
    ...
    4247:	89 04 24             	mov    %eax,(%esp)
    424a:	e8 a9 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value--;	
    424f:	8b 45 08             	mov    0x8(%ebp),%eax
    4252:	8b 40 08             	mov    0x8(%eax),%eax
    4255:	8d 50 ff             	lea    -0x1(%eax),%edx
    4258:	8b 45 08             	mov    0x8(%ebp),%eax
    425b:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value > 0){
    425e:	8b 45 08             	mov    0x8(%ebp),%eax
    4261:	8b 40 08             	mov    0x8(%eax),%eax
    4264:	85 c0                	test   %eax,%eax
    4266:	7e 0e                	jle    4276 <semaphore_down+0x48>
   binary_semaphore_up(sem->s2);
    4268:	8b 45 08             	mov    0x8(%ebp),%eax
    426b:	8b 40 04             	mov    0x4(%eax),%eax
    426e:	89 04 24             	mov    %eax,(%esp)
    4271:	e8 8a fa ff ff       	call   3d00 <binary_semaphore_up>
  }
  binary_semaphore_up(sem->s1); 
    4276:	8b 45 08             	mov    0x8(%ebp),%eax
    4279:	8b 00                	mov    (%eax),%eax
    427b:	89 04 24             	mov    %eax,(%esp)
    427e:	e8 7d fa ff ff       	call   3d00 <binary_semaphore_up>
}
    4283:	c9                   	leave  
    4284:	c3                   	ret    

00004285 <semaphore_up>:
void semaphore_up(struct semaphore* sem ){
    4285:	55                   	push   %ebp
    4286:	89 e5                	mov    %esp,%ebp
    4288:	83 ec 18             	sub    $0x18,%esp
  binary_semaphore_down(sem->s1);
    428b:	8b 45 08             	mov    0x8(%ebp),%eax
    428e:	8b 00                	mov    (%eax),%eax
    4290:	89 04 24             	mov    %eax,(%esp)
    4293:	e8 60 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value++;	
    4298:	8b 45 08             	mov    0x8(%ebp),%eax
    429b:	8b 40 08             	mov    0x8(%eax),%eax
    429e:	8d 50 01             	lea    0x1(%eax),%edx
    42a1:	8b 45 08             	mov    0x8(%ebp),%eax
    42a4:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value ==1){
    42a7:	8b 45 08             	mov    0x8(%ebp),%eax
    42aa:	8b 40 08             	mov    0x8(%eax),%eax
    42ad:	83 f8 01             	cmp    $0x1,%eax
    42b0:	75 0e                	jne    42c0 <semaphore_up+0x3b>
   binary_semaphore_up(sem->s2); 
    42b2:	8b 45 08             	mov    0x8(%ebp),%eax
    42b5:	8b 40 04             	mov    0x4(%eax),%eax
    42b8:	89 04 24             	mov    %eax,(%esp)
    42bb:	e8 40 fa ff ff       	call   3d00 <binary_semaphore_up>
   }
  binary_semaphore_up(sem->s1);
