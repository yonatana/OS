...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      ...
      16:	e8 ac 3d 00 00       	call   3dc7 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      ...
      48:	e8 7a 3d 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      ...
      8a:	e8 38 3d 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
      ...
      a4:	e8 1e 3d 00 00       	call   3dc7 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      ...
      c1:	e8 01 3d 00 00       	call   3dc7 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      ...
      f3:	e8 cf 3c 00 00       	call   3dc7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     114:	e8 ae 3c 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     155:	e8 6d 3c 00 00       	call   3dc7 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     196:	e8 2c 3c 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     1be:	e8 04 3c 00 00       	call   3dc7 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     1fb:	e8 c7 3b 00 00       	call   3dc7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     239:	e8 89 3b 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     253:	e8 6f 3b 00 00       	call   3dc7 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     285:	e8 3d 3b 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     29f:	e8 23 3b 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     2b9:	e8 09 3b 00 00       	call   3dc7 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2d6:	e8 ec 3a 00 00       	call   3dc7 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     308:	e8 ba 3a 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     35e:	e8 64 3a 00 00       	call   3dc7 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     3ae:	e8 14 3a 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     407:	e8 bb 39 00 00       	call   3dc7 <printf>
        exit();
     ...
     431:	e8 91 39 00 00       	call   3dc7 <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     469:	e8 59 39 00 00       	call   3dc7 <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(unlink("big") < 0){
    ...
    printf(stdout, "unlink big failed\n");
     ...
     4a8:	e8 1a 39 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     4c2:	e8 00 39 00 00       	call   3dc7 <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     4df:	e8 e3 38 00 00       	call   3dc7 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     57a:	e8 48 38 00 00       	call   3dc7 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     597:	e8 2b 38 00 00       	call   3dc7 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     ...
     5bc:	e8 06 38 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     5e6:	e8 dc 37 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     610:	e8 b2 37 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     63a:	e8 88 37 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(stdout, "mkdir test\n");
     ...
     654:	e8 6e 37 00 00       	call   3dc7 <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     671:	e8 51 37 00 00       	call   3dc7 <printf>
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     69e:	e8 24 37 00 00       	call   3dc7 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     6ce:	e8 f4 36 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     75e:	e8 64 36 00 00       	call   3dc7 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7d7:	e8 eb 35 00 00       	call   3dc7 <printf>
          return;
    ...
    if(total != 5 * 1033){
     ...
     84d:	e8 75 35 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     ...
     876:	e8 4c 35 00 00       	call   3dc7 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     88c:	e8 36 35 00 00       	call   3dc7 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     8ad:	e8 15 35 00 00       	call   3dc7 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     925:	e8 9d 34 00 00       	call   3dc7 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     971:	e8 51 34 00 00       	call   3dc7 <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     992:	e8 30 34 00 00       	call   3dc7 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     9c7:	e8 fb 33 00 00       	call   3dc7 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     9ea:	e8 d8 33 00 00       	call   3dc7 <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a1d:	e8 a5 33 00 00       	call   3dc7 <printf>
      return;
    ...
    if(pid){
     ...
     a43:	e8 7f 33 00 00       	call   3dc7 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     a68:	e8 5a 33 00 00       	call   3dc7 <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     a84:	e8 3e 33 00 00       	call   3dc7 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 e5 35 00 00       	call   40ab <malloc>
    ...
    while(m1){
     ...
     adf:	e8 98 34 00 00       	call   3f7c <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     af7:	e8 af 35 00 00       	call   40ab <malloc>
    ...
    if(m1 == 0){
     ...
     b14:	e8 ae 32 00 00       	call   3dc7 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     b69:	e8 59 32 00 00       	call   3dc7 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ba6:	e8 1c 32 00 00       	call   3dc7 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c18:	e8 aa 31 00 00       	call   3dc7 <printf>
      break;
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     c73:	e8 4f 31 00 00       	call   3dc7 <printf>
    return;
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 5f 46 00 	movl   $0x465f,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 a4 30 00 00       	call   3dc7 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 80 30 00 00       	call   3dc7 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 81 46 00 	movl   $0x4681,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 5f 30 00 00       	call   3dc7 <printf>

  unlink("f1");
     d68:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 25 30 00 00       	call   3dc7 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 90 46 00 00       	mov    $0x4690,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 93 46 00 00       	mov    $0x4693,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     ddf:	00 
     de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de7:	e8 db 2f 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e52:	c7 44 24 04 a5 46 00 	movl   $0x46a5,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 61 2f 00 00       	call   3dc7 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 90 46 00 00       	mov    $0x4690,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 93 46 00 00       	mov    $0x4693,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 b6 46 00 	movl   $0x46b6,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 bc 2e 00 00       	call   3dc7 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 c2 46 00 	movl   $0x46c2,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 52 2e 00 00       	call   3dc7 <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 13 2e 00 00       	call   3dc7 <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 f7 2d 00 00       	call   3dc7 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 d5 2d 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 72 2d 00 00       	call   3dc7 <printf>
      exit();
    ...
    1096:	c7 44 24 04 f3 46 00 	movl   $0x46f3,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 1d 2d 00 00       	call   3dc7 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 9e 2c 00 00       	call   3dc7 <printf>
      exit();
    ...
    1147:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 6c 2c 00 00       	call   3dc7 <printf>
      exit();
    ...
    11ad:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 06 2c 00 00       	call   3dc7 <printf>
      exit();
    ...
    11df:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 d4 2b 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 62 2b 00 00       	call   3dc7 <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 59 47 00 	movl   $0x4759,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 46 2b 00 00       	call   3dc7 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 75 47 00 	movl   $0x4775,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 15 2b 00 00       	call   3dc7 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1399:	c7 44 24 04 cb 47 00 	movl   $0x47cb,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 1a 2a 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 e2 47 00 	movl   $0x47e2,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 f6 29 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f6:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 bd 29 00 00       	call   3dc7 <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 8d 29 00 00       	call   3dc7 <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 71 29 00 00       	call   3dc7 <printf>

  unlink("lf1");
    1456:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 28 29 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 ef 28 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 95 48 00 	movl   $0x4895,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 40 28 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15ac:	c7 44 24 04 a6 48 00 	movl   $0x48a6,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 07 28 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 2f 48 00 	movl   $0x482f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 b7 48 00 	movl   $0x48b7,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 cb 27 00 00       	call   3dc7 <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 d8 48 00 	movl   $0x48d8,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 8e 27 00 00       	call   3dc7 <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 fd 48 00 	movl   $0x48fd,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 5d 27 00 00       	call   3dc7 <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 44 27 00 00       	call   3dc7 <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 26 49 00 	movl   $0x4926,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 28 27 00 00       	call   3dc7 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1741:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1772:	c7 44 24 04 39 49 00 	movl   $0x4939,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 41 26 00 00       	call   3dc7 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 55 49 00 	movl   $0x4955,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 7b 25 00 00       	call   3dc7 <printf>
        exit();
    ...
    1868:	c7 44 24 04 6e 49 00 	movl   $0x496e,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 4b 25 00 00       	call   3dc7 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 8c 49 00 	movl   $0x498c,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 ef 24 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 b3 24 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 bd 49 00 	movl   $0x49bd,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 93 23 00 00       	call   3dc7 <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 77 23 00 00       	call   3dc7 <printf>

  unlink("x");
    1a50:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 49 23 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 6c 22 00 00       	call   3dc7 <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 ef 49 00 	movl   $0x49ef,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 4b 22 00 00       	call   3dc7 <printf>
  unlink("bd");
    1b7c:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 ff 49 00 	movl   $0x49ff,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 0e 22 00 00       	call   3dc7 <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 18 21 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 3e 4a 00 	movl   $0x4a3e,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 f2 20 00 00       	call   3dc7 <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 49 4a 00 	movl   $0x4a49,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 d6 20 00 00       	call   3dc7 <printf>

  unlink("ff");
    1cf1:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 59 4a 00 00 	movl   $0x4a59,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 a6 20 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 74 4a 00 00 	movl   $0x4a74,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 7a 4a 00 	movl   $0x4a7a,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 70 20 00 00       	call   3dc7 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 d8 4a 00 00 	movl   $0x4ad8,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 c2 1f 00 00       	call   3dc7 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 fc 4a 00 00 	movl   $0x4afc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 08 4b 00 	movl   $0x4b08,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 66 1f 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 1e 1f 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 3c 4b 00 00 	movl   $0x4b3c,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 ae 1d 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203e:	c7 44 24 04 1e 4c 00 	movl   $0x4c1e,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 75 1d 00 00       	call   3dc7 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 98 4e 00 	movl   $0x4e98,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 90 19 00 00       	call   3dc7 <printf>

  unlink("bigwrite");
    2437:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
    ...
    246c:	c7 44 24 04 b0 4e 00 	movl   $0x4eb0,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 47 19 00 00       	call   3dc7 <printf>
      exit();
    ...
    24c1:	c7 44 24 04 c8 4e 00 	movl   $0x4ec8,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 f2 18 00 00       	call   3dc7 <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 da 4e 00 	movl   $0x4eda,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 a4 18 00 00       	call   3dc7 <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 e7 4e 00 	movl   $0x4ee7,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 88 18 00 00       	call   3dc7 <printf>

  unlink("bigfile");
    253f:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 fd 4e 00 	movl   $0x4efd,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 4b 18 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c7:	c7 44 24 04 13 4f 00 	movl   $0x4f13,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 ec 17 00 00       	call   3dc7 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 29 4f 00 	movl   $0x4f29,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 a1 17 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265d:	c7 44 24 04 3e 4f 00 	movl   $0x4f3e,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 56 17 00 00       	call   3dc7 <printf>
      exit();
    ...
    2685:	c7 44 24 04 53 4f 00 	movl   $0x4f53,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 2e 17 00 00       	call   3dc7 <printf>
      exit();
    ...
    26d2:	c7 44 24 04 67 4f 00 	movl   $0x4f67,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 e1 16 00 00       	call   3dc7 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 80 4f 00 	movl   $0x4f80,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 a4 16 00 00       	call   3dc7 <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 9a 4f 00 	movl   $0x4f9a,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 7f 16 00 00       	call   3dc7 <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 38 50 00 00 	movl   $0x5038,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 68 50 00 	movl   $0x5068,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 e0 15 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 a8 50 00 00 	movl   $0x50a8,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 d8 50 00 	movl   $0x50d8,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 9f 15 00 00       	call   3dc7 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 81 52 00 	movl   $0x5281,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 95 13 00 00       	call   3dc7 <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 8e 52 00 00 	movl   $0x528e,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 96 52 00 	movl   $0x5296,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 64 13 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 d2 52 00 	movl   $0x52d2,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 fa 12 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 e2 11 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 8b 53 00 	movl   $0x538b,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 93 11 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 9f 53 00 	movl   $0x539f,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 6f 11 00 00       	call   3dc7 <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 af 53 00 	movl   $0x53af,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 53 11 00 00       	call   3dc7 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 12 52 00 00 	movl   $0x5212,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 f2 53 00 	movl   $0x53f2,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 4b 10 00 00       	call   3dc7 <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 06 54 00 	movl   $0x5406,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 2f 10 00 00       	call   3dc7 <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 14 54 00 	movl   $0x5414,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 e0 0f 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 36 54 00 	movl   $0x5436,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 be 0f 00 00       	call   3dc7 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 4a 54 00 	movl   $0x544a,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 91 0f 00 00       	call   3dc7 <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 5d 54 00 	movl   $0x545d,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 78 0f 00 00       	call   3dc7 <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    2e60:	c7 44 24 04 6b 54 00 	movl   $0x546b,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 57 0f 00 00       	call   3dc7 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    ...
    2ec8:	c7 44 24 04 76 54 00 	movl   $0x5476,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 ef 0e 00 00       	call   3dc7 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    2f0c:	c7 44 24 04 91 54 00 	movl   $0x5491,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 ab 0e 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    2f4f:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 68 0e 00 00       	call   3dc7 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    2faf:	c7 44 24 04 c4 54 00 	movl   $0x54c4,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 08 0e 00 00       	call   3dc7 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    2ffa:	c7 44 24 04 02 55 00 	movl   $0x5502,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 bd 0d 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    ...
    303e:	c7 44 24 04 20 55 00 	movl   $0x5520,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 79 0d 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    ...
    30a5:	c7 44 24 04 58 55 00 	movl   $0x5558,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 12 0d 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    30c9:	c7 44 24 04 80 55 00 	movl   $0x5580,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 ee 0c 00 00       	call   3dc7 <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    ...
    3128:	c7 44 24 04 b0 55 00 	movl   $0x55b0,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 8f 0c 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3161:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 56 0c 00 00       	call   3dc7 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 d6 0b 00 00       	call   3dc7 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    32e9:	c7 44 24 04 ea 55 00 	movl   $0x55ea,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 ce 0a 00 00       	call   3dc7 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3331:	c7 44 24 04 05 56 00 	movl   $0x5605,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 86 0a 00 00       	call   3dc7 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3380:	c7 44 24 04 13 56 00 	movl   $0x5613,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 37 0a 00 00       	call   3dc7 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 22 56 00 00 	movl   $0x5622,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3403:	c7 44 24 04 2d 56 00 	movl   $0x562d,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 b4 09 00 00       	call   3dc7 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3430:	c7 44 24 04 46 56 00 	movl   $0x5646,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 87 09 00 00       	call   3dc7 <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    344d:	c7 44 24 04 53 56 00 	movl   $0x5653,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 6a 09 00 00       	call   3dc7 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    347a:	c7 44 24 04 5d 56 00 	movl   $0x565d,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 3d 09 00 00       	call   3dc7 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    34a2:	c7 44 24 04 6e 56 00 	movl   $0x566e,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 15 09 00 00       	call   3dc7 <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 00 5f 00 00 	movl   $0x5688,0x5f00(,%eax,4)
    34eb:	88 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3508:	c7 44 24 04 65 57 00 	movl   $0x5765,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 af 08 00 00       	call   3dc7 <printf>
    exec("echo", args);
    3518:	c7 44 24 04 00 5f 00 	movl   $0x5f00,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3531:	c7 44 24 04 72 57 00 	movl   $0x5772,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 86 08 00 00       	call   3dc7 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
    ...
    356e:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    3573:	c7 44 24 04 82 57 00 	movl   $0x5782,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 44 08 00 00       	call   3dc7 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    35af:	c7 44 24 04 9b 57 00 	movl   $0x579b,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 08 08 00 00       	call   3dc7 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 b0 57 00 	movl   $0x57b0,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 c8 07 00 00       	call   3dc7 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 bd 57 00 	movl   $0x57bd,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 d8 06 00 00       	call   3dc7 <printf>
    ...
    3712:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 a1 06 00 00       	call   3dc7 <printf>
      break;
    ...
    376a:	c7 44 24 04 d9 57 00 	movl   $0x57d9,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 49 06 00 00       	call   3dc7 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 e9 57 00 	movl   $0x57e9,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 2e 05 00 00       	call   3dc7 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 e8 5e 00 00       	mov    0x5ee8,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 e8 5e 00 00       	mov    %eax,0x5ee8
  return randstate;
    38b7:	a1 e8 5e 00 00       	mov    0x5ee8,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 13 58 00 00 	movl   $0x5813,(%esp)
...
putc(int fd, char c)
{
    ...
    3cf3:	83 ec 28             	sub    $0x28,%esp
    3cf6:	8b 45 0c             	mov    0xc(%ebp),%eax
    3cf9:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3cfc:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3d03:	00 
    3d04:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3d07:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d0b:	8b 45 08             	mov    0x8(%ebp),%eax
    3d0e:	89 04 24             	mov    %eax,(%esp)
    3d11:	e8 32 ff ff ff       	call   3c48 <write>
}
    3d16:	c9                   	leave  
    3d17:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d1e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d25:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d29:	74 17                	je     3d42 <printint+0x2a>
    3d2b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d2f:	79 11                	jns    3d42 <printint+0x2a>
    neg = 1;
    3d31:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d38:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d3b:	f7 d8                	neg    %eax
    3d3d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d40:	eb 06                	jmp    3d48 <printint+0x30>
  } else {
    x = xx;
    3d42:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d45:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3d48:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d4f:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d52:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d55:	ba 00 00 00 00       	mov    $0x0,%edx
    3d5a:	f7 f1                	div    %ecx
    3d5c:	89 d0                	mov    %edx,%eax
    3d5e:	0f b6 90 ec 5e 00 00 	movzbl 0x5eec(%eax),%edx
    3d65:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d68:	03 45 f4             	add    -0xc(%ebp),%eax
    3d6b:	88 10                	mov    %dl,(%eax)
    3d6d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d71:	8b 55 10             	mov    0x10(%ebp),%edx
    3d74:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d77:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d7a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d7f:	f7 75 d4             	divl   -0x2c(%ebp)
    3d82:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d85:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d89:	75 c4                	jne    3d4f <printint+0x37>
  if(neg)
    3d8b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d8f:	74 2a                	je     3dbb <printint+0xa3>
    buf[i++] = '-';
    3d91:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d94:	03 45 f4             	add    -0xc(%ebp),%eax
    3d97:	c6 00 2d             	movb   $0x2d,(%eax)
    3d9a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3d9e:	eb 1b                	jmp    3dbb <printint+0xa3>
    putc(fd, buf[i]);
    3da0:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3da3:	03 45 f4             	add    -0xc(%ebp),%eax
    3da6:	0f b6 00             	movzbl (%eax),%eax
    3da9:	0f be c0             	movsbl %al,%eax
    3dac:	89 44 24 04          	mov    %eax,0x4(%esp)
    3db0:	8b 45 08             	mov    0x8(%ebp),%eax
    3db3:	89 04 24             	mov    %eax,(%esp)
    3db6:	e8 35 ff ff ff       	call   3cf0 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dbb:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3dbf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3dc3:	79 db                	jns    3da0 <printint+0x88>
    putc(fd, buf[i]);
}
    3dc5:	c9                   	leave  
    3dc6:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3dca:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dcd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dd4:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dd7:	83 c0 04             	add    $0x4,%eax
    3dda:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3ddd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3de4:	e9 7d 01 00 00       	jmp    3f66 <printf+0x19f>
    c = fmt[i] & 0xff;
    3de9:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dec:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3def:	01 d0                	add    %edx,%eax
    3df1:	0f b6 00             	movzbl (%eax),%eax
    3df4:	0f be c0             	movsbl %al,%eax
    3df7:	25 ff 00 00 00       	and    $0xff,%eax
    3dfc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3dff:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3e03:	75 2c                	jne    3e31 <printf+0x6a>
      if(c == '%'){
    3e05:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3e09:	75 0c                	jne    3e17 <printf+0x50>
        state = '%';
    3e0b:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e12:	e9 4b 01 00 00       	jmp    3f62 <printf+0x19b>
      } else {
        putc(fd, c);
    3e17:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e1a:	0f be c0             	movsbl %al,%eax
    3e1d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e21:	8b 45 08             	mov    0x8(%ebp),%eax
    3e24:	89 04 24             	mov    %eax,(%esp)
    3e27:	e8 c4 fe ff ff       	call   3cf0 <putc>
    3e2c:	e9 31 01 00 00       	jmp    3f62 <printf+0x19b>
      }
    } else if(state == '%'){
    3e31:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e35:	0f 85 27 01 00 00    	jne    3f62 <printf+0x19b>
      if(c == 'd'){
    3e3b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e3f:	75 2d                	jne    3e6e <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e41:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e44:	8b 00                	mov    (%eax),%eax
    3e46:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e4d:	00 
    3e4e:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e55:	00 
    3e56:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e5a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e5d:	89 04 24             	mov    %eax,(%esp)
    3e60:	e8 b3 fe ff ff       	call   3d18 <printint>
        ap++;
    3e65:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e69:	e9 ed 00 00 00       	jmp    3f5b <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e6e:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e72:	74 06                	je     3e7a <printf+0xb3>
    3e74:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e78:	75 2d                	jne    3ea7 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e7a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e7d:	8b 00                	mov    (%eax),%eax
    3e7f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e86:	00 
    3e87:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e8e:	00 
    3e8f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e93:	8b 45 08             	mov    0x8(%ebp),%eax
    3e96:	89 04 24             	mov    %eax,(%esp)
    3e99:	e8 7a fe ff ff       	call   3d18 <printint>
        ap++;
    3e9e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3ea2:	e9 b4 00 00 00       	jmp    3f5b <printf+0x194>
      } else if(c == 's'){
    3ea7:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3eab:	75 46                	jne    3ef3 <printf+0x12c>
        s = (char*)*ap;
    3ead:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3eb0:	8b 00                	mov    (%eax),%eax
    3eb2:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3eb5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3eb9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ebd:	75 27                	jne    3ee6 <printf+0x11f>
          s = "(null)";
    3ebf:	c7 45 f4 4e 58 00 00 	movl   $0x584e,-0xc(%ebp)
        while(*s != 0){
    3ec6:	eb 1e                	jmp    3ee6 <printf+0x11f>
          putc(fd, *s);
    3ec8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ecb:	0f b6 00             	movzbl (%eax),%eax
    3ece:	0f be c0             	movsbl %al,%eax
    3ed1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ed5:	8b 45 08             	mov    0x8(%ebp),%eax
    3ed8:	89 04 24             	mov    %eax,(%esp)
    3edb:	e8 10 fe ff ff       	call   3cf0 <putc>
          s++;
    3ee0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3ee4:	eb 01                	jmp    3ee7 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3eef:	75 d7                	jne    3ec8 <printf+0x101>
    3ef1:	eb 68                	jmp    3f5b <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ef3:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ef7:	75 1d                	jne    3f16 <printf+0x14f>
        putc(fd, *ap);
    ...
    3f0b:	e8 e0 fd ff ff       	call   3cf0 <putc>
        ap++;
    3f10:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f14:	eb 45                	jmp    3f5b <printf+0x194>
      } else if(c == '%'){
    3f16:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f1a:	75 17                	jne    3f33 <printf+0x16c>
        putc(fd, c);
    ...
    3f2c:	e8 bf fd ff ff       	call   3cf0 <putc>
    3f31:	eb 28                	jmp    3f5b <printf+0x194>
      } else {
    ...
    3f41:	e8 aa fd ff ff       	call   3cf0 <putc>
        putc(fd, c);
    ...
    3f56:	e8 95 fd ff ff       	call   3cf0 <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3f73:	0f 85 70 fe ff ff    	jne    3de9 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f8b:	a1 88 5f 00 00       	mov    0x5f88,%eax
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    3fd1:	c1 e0 03             	shl    $0x3,%eax
    3fd4:	89 c2                	mov    %eax,%edx
    3fd6:	03 55 f8             	add    -0x8(%ebp),%edx
    3fd9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fdc:	8b 00                	mov    (%eax),%eax
    3fde:	39 c2                	cmp    %eax,%edx
    3fe0:	75 24                	jne    4006 <free+0x8a>
    bp->s.size += p->s.ptr->s.size;
    3fe2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fe5:	8b 50 04             	mov    0x4(%eax),%edx
    3fe8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3feb:	8b 00                	mov    (%eax),%eax
    3fed:	8b 40 04             	mov    0x4(%eax),%eax
    3ff0:	01 c2                	add    %eax,%edx
    3ff2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3ff5:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    3ff8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3ffb:	8b 00                	mov    (%eax),%eax
    3ffd:	8b 10                	mov    (%eax),%edx
    3fff:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4002:	89 10                	mov    %edx,(%eax)
    4004:	eb 0a                	jmp    4010 <free+0x94>
  } else
    bp->s.ptr = p->s.ptr;
    4006:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4009:	8b 10                	mov    (%eax),%edx
    400b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    400e:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4010:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4013:	8b 40 04             	mov    0x4(%eax),%eax
    4016:	c1 e0 03             	shl    $0x3,%eax
    4019:	03 45 fc             	add    -0x4(%ebp),%eax
    401c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    401f:	75 20                	jne    4041 <free+0xc5>
    p->s.size += bp->s.size;
    4021:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4024:	8b 50 04             	mov    0x4(%eax),%edx
    4027:	8b 45 f8             	mov    -0x8(%ebp),%eax
    402a:	8b 40 04             	mov    0x4(%eax),%eax
    402d:	01 c2                	add    %eax,%edx
    402f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4032:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4035:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4038:	8b 10                	mov    (%eax),%edx
    403a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    403d:	89 10                	mov    %edx,(%eax)
    403f:	eb 08                	jmp    4049 <free+0xcd>
  } else
    p->s.ptr = bp;
    4041:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4044:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4047:	89 10                	mov    %edx,(%eax)
  freep = p;
    4049:	8b 45 fc             	mov    -0x4(%ebp),%eax
    404c:	a3 88 5f 00 00       	mov    %eax,0x5f88
}
    4051:	c9                   	leave  
    4052:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    4059:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4060:	77 07                	ja     4069 <morecore+0x16>
    nu = 4096;
    4062:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4069:	8b 45 08             	mov    0x8(%ebp),%eax
    406c:	c1 e0 03             	shl    $0x3,%eax
    406f:	89 04 24             	mov    %eax,(%esp)
    4072:	e8 39 fc ff ff       	call   3cb0 <sbrk>
    4077:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    407a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    407e:	75 07                	jne    4087 <morecore+0x34>
    return 0;
    4080:	b8 00 00 00 00       	mov    $0x0,%eax
    4085:	eb 22                	jmp    40a9 <morecore+0x56>
  hp = (Header*)p;
    4087:	8b 45 f4             	mov    -0xc(%ebp),%eax
    408a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    408d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4090:	8b 55 08             	mov    0x8(%ebp),%edx
    4093:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4096:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4099:	83 c0 08             	add    $0x8,%eax
    409c:	89 04 24             	mov    %eax,(%esp)
    409f:	e8 d8 fe ff ff       	call   3f7c <free>
  return freep;
    40a4:	a1 88 5f 00 00       	mov    0x5f88,%eax
}
    40a9:	c9                   	leave  
    40aa:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    40ae:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40b1:	8b 45 08             	mov    0x8(%ebp),%eax
    40b4:	83 c0 07             	add    $0x7,%eax
    40b7:	c1 e8 03             	shr    $0x3,%eax
    40ba:	83 c0 01             	add    $0x1,%eax
    40bd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40c0:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40c5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40c8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40cc:	75 23                	jne    40f1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40ce:	c7 45 f0 80 5f 00 00 	movl   $0x5f80,-0x10(%ebp)
    40d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d8:	a3 88 5f 00 00       	mov    %eax,0x5f88
    40dd:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40e2:	a3 80 5f 00 00       	mov    %eax,0x5f80
    base.s.size = 0;
    40e7:	c7 05 84 5f 00 00 00 	movl   $0x0,0x5f84
    40ee:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f4:	8b 00                	mov    (%eax),%eax
    40f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    40f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40fc:	8b 40 04             	mov    0x4(%eax),%eax
    40ff:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4102:	72 4d                	jb     4151 <malloc+0xa6>
      if(p->s.size == nunits)
    4104:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4107:	8b 40 04             	mov    0x4(%eax),%eax
    410a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    410d:	75 0c                	jne    411b <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    410f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4112:	8b 10                	mov    (%eax),%edx
    4114:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4117:	89 10                	mov    %edx,(%eax)
    4119:	eb 26                	jmp    4141 <malloc+0x96>
      else {
        p->s.size -= nunits;
    411b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411e:	8b 40 04             	mov    0x4(%eax),%eax
    4121:	89 c2                	mov    %eax,%edx
    4123:	2b 55 ec             	sub    -0x14(%ebp),%edx
    4126:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4129:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    412c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412f:	8b 40 04             	mov    0x4(%eax),%eax
    4132:	c1 e0 03             	shl    $0x3,%eax
    4135:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4138:	8b 45 f4             	mov    -0xc(%ebp),%eax
    413b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    413e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4141:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4144:	a3 88 5f 00 00       	mov    %eax,0x5f88
      return (void*)(p + 1);
    4149:	8b 45 f4             	mov    -0xc(%ebp),%eax
    414c:	83 c0 08             	add    $0x8,%eax
    414f:	eb 38                	jmp    4189 <malloc+0xde>
    }
    if(p == freep)
    4151:	a1 88 5f 00 00       	mov    0x5f88,%eax
    4156:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4159:	75 1b                	jne    4176 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    415b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    415e:	89 04 24             	mov    %eax,(%esp)
    4161:	e8 ed fe ff ff       	call   4053 <morecore>
    4166:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4169:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    416d:	75 07                	jne    4176 <malloc+0xcb>
        return 0;
    416f:	b8 00 00 00 00       	mov    $0x0,%eax
    4174:	eb 13                	jmp    4189 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4176:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4179:	89 45 f0             	mov    %eax,-0x10(%ebp)
    417c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    417f:	8b 00                	mov    (%eax),%eax
    4181:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    4184:	e9 70 ff ff ff       	jmp    40f9 <malloc+0x4e>
}
    4189:	c9                   	leave  
    418a:	c3                   	ret    
