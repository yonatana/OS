...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 30 64 00 00       	mov    0x6430,%eax
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 58 45 00 00 	movl   $0x4558,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 30 64 00 00       	mov    0x6430,%eax
      3d:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 8c 45 00 00 	movl   $0x458c,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 30 64 00 00       	mov    0x6430,%eax
      7f:	c7 44 24 04 99 45 00 	movl   $0x4599,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 30 64 00 00       	mov    0x6430,%eax
      99:	c7 44 24 04 b7 45 00 	movl   $0x45b7,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 30 64 00 00       	mov    0x6430,%eax
      b6:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 d6 45 00 00 	movl   $0x45d6,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 30 64 00 00       	mov    0x6430,%eax
      e8:	c7 44 24 04 dc 45 00 	movl   $0x45dc,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 30 64 00 00       	mov    0x6430,%eax
     109:	c7 44 24 04 f7 45 00 	movl   $0x45f7,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 13 46 00 	movl   $0x4613,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 30 64 00 00       	mov    0x6430,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 20 46 00 	movl   $0x4620,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 30 64 00 00       	mov    0x6430,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 50 46 00 	movl   $0x4650,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 30 64 00 00       	mov    0x6430,%eax
     1b3:	c7 44 24 04 74 46 00 	movl   $0x4674,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 d6 45 00 00 	movl   $0x45d6,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 30 64 00 00       	mov    0x6430,%eax
     1f0:	c7 44 24 04 7f 46 00 	movl   $0x467f,0x4(%esp)
     1f7:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 30 64 00 00       	mov    0x6430,%eax
     22e:	c7 44 24 04 98 46 00 	movl   $0x4698,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 30 64 00 00       	mov    0x6430,%eax
     248:	c7 44 24 04 b3 46 00 	movl   $0x46b3,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 d6 45 00 00 	movl   $0x45d6,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 30 64 00 00       	mov    0x6430,%eax
     27a:	c7 44 24 04 c6 46 00 	movl   $0x46c6,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 30 64 00 00       	mov    0x6430,%eax
     294:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 30 64 00 00       	mov    0x6430,%eax
     2ae:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 30 64 00 00       	mov    0x6430,%eax
     2cb:	c7 44 24 04 fc 46 00 	movl   $0x46fc,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 0c 47 00 00 	movl   $0x470c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 30 64 00 00       	mov    0x6430,%eax
     2fd:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 30 64 00 00       	mov    0x6430,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 2a 47 00 	movl   $0x472a,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 0c 47 00 00 	movl   $0x470c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 30 64 00 00       	mov    0x6430,%eax
     3a3:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 30 64 00 00       	mov    0x6430,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 61 47 00 	movl   $0x4761,0x4(%esp)
     403:	00 
     ...
     41a:	a1 30 64 00 00       	mov    0x6430,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 7e 47 00 	movl   $0x477e,0x4(%esp)
     42d:	00 
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 0c 47 00 00 	movl   $0x470c,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 30 64 00 00       	mov    0x6430,%eax
     49d:	c7 44 24 04 b0 47 00 	movl   $0x47b0,0x4(%esp)
     4a4:	00 
  ...
  printf(stdout, "big files ok\n");
     4b2:	a1 30 64 00 00       	mov    0x6430,%eax
     4b7:	c7 44 24 04 c3 47 00 	movl   $0x47c3,0x4(%esp)
     4be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 30 64 00 00       	mov    0x6430,%eax
     4d4:	c7 44 24 04 d4 47 00 	movl   $0x47d4,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 fb 38 00 00       	call   3ddf <printf>

  name[0] = 'a';
     4e4:	c6 05 20 ac 00 00 61 	movb   $0x61,0xac20
  name[2] = '\0';
     4eb:	c6 05 22 ac 00 00 00 	movb   $0x0,0xac22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 21 ac 00 00       	mov    %al,0xac21
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 20 ac 00 00 	movl   $0xac20,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 20 ac 00 00 61 	movb   $0x61,0xac20
  name[2] = '\0';
     539:	c6 05 22 ac 00 00 00 	movb   $0x0,0xac22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 21 ac 00 00       	mov    %al,0xac21
    unlink(name);
     554:	c7 04 24 20 ac 00 00 	movl   $0xac20,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 30 64 00 00       	mov    0x6430,%eax
     56f:	c7 44 24 04 fc 47 00 	movl   $0x47fc,0x4(%esp)
     576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 30 64 00 00       	mov    0x6430,%eax
     58c:	c7 44 24 04 22 48 00 	movl   $0x4822,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 43 38 00 00       	call   3ddf <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 2e 48 00 00 	movl   $0x482e,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 30 64 00 00       	mov    0x6430,%eax
     5b1:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
     5b8:	00 
  ...
  if(chdir("dir0") < 0){
     5c6:	c7 04 24 2e 48 00 00 	movl   $0x482e,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 30 64 00 00       	mov    0x6430,%eax
     5db:	c7 44 24 04 41 48 00 	movl   $0x4841,0x4(%esp)
     5e2:	00 
  ...
  if(chdir("..") < 0){
     5f0:	c7 04 24 54 48 00 00 	movl   $0x4854,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 30 64 00 00       	mov    0x6430,%eax
     605:	c7 44 24 04 57 48 00 	movl   $0x4857,0x4(%esp)
     60c:	00 
  ...
  if(unlink("dir0") < 0){
     61a:	c7 04 24 2e 48 00 00 	movl   $0x482e,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 30 64 00 00       	mov    0x6430,%eax
     62f:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     636:	00 
  ...
  printf(stdout, "mkdir test\n");
     644:	a1 30 64 00 00       	mov    0x6430,%eax
     649:	c7 44 24 04 22 48 00 	movl   $0x4822,0x4(%esp)
     650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 30 64 00 00       	mov    0x6430,%eax
     666:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 69 37 00 00       	call   3ddf <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 1c 64 00 	movl   $0x641c,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 58 45 00 00 	movl   $0x4558,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 30 64 00 00       	mov    0x6430,%eax
     693:	c7 44 24 04 87 48 00 	movl   $0x4887,0x4(%esp)
     69a:	00 
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	81 c2 20 8c 00 00    	add    $0x8c20,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     737:	00 
     738:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
     73f:	00 
     ...
     74f:	c7 44 24 04 a8 48 00 	movl   $0x48a8,0x4(%esp)
     756:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a8:	05 20 8c 00 00       	add    $0x8c20,%eax
     ...
     7c8:	c7 44 24 04 b6 48 00 	movl   $0x48b6,0x4(%esp)
     7cf:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     811:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
     818:	00 
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 c4 48 00 	movl   $0x48c4,0x4(%esp)
     845:	00 
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 db 48 00 	movl   $0x48db,0x4(%esp)
     86e:	00 
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 e5 48 00 	movl   $0x48e5,0x4(%esp)
     884:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 f4 48 00 	movl   $0x48f4,0x4(%esp)
     8a5:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 fe 48 00 	movl   $0x48fe,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 00 49 00 	movl   $0x4900,0x4(%esp)
     91d:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94c:	00 
     94d:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
     954:	00 
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 14 49 00 	movl   $0x4914,0x4(%esp)
     969:	00 
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 27 49 00 	movl   $0x4927,0x4(%esp)
     98a:	00 
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 30 49 00 	movl   $0x4930,0x4(%esp)
     9bf:	00 
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 39 49 00 	movl   $0x4939,0x4(%esp)
     9e2:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
     a15:	00 
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 52 49 00 	movl   $0x4952,0x4(%esp)
     a3b:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 62 49 00 	movl   $0x4962,0x4(%esp)
     a60:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 6f 49 00 	movl   $0x496f,0x4(%esp)
     a7c:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b05:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
     b0c:	00 
    ...
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 93 49 00 	movl   $0x4993,0x4(%esp)
     b3b:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 b4 49 00 	movl   $0x49b4,0x4(%esp)
     b9e:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
     c10:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 00 4a 00 	movl   $0x4a00,0x4(%esp)
     c6b:	00 
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 2b 4a 00 	movl   $0x4a2b,0x4(%esp)
     d16:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
     d3a:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 77 30 00 00       	call   3ddf <printf>

  unlink("f1");
     d68:	c7 04 24 5c 4a 00 00 	movl   $0x4a5c,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 5f 4a 00 00 	movl   $0x4a5f,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
     d95:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 5c 4a 00 00       	mov    $0x4a5c,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 5f 4a 00 00       	mov    $0x4a5f,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 62 4a 00 	movl   $0x4a62,0x4(%esp)
     ddf:	00 
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0f:	c7 04 24 20 8c 00 00 	movl   $0x8c20,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e2b:	00 
     e2c:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
     e33:	00 
     ...
     e52:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
     e59:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 5c 4a 00 00       	mov    $0x4a5c,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 5f 4a 00 00       	mov    $0x4a5f,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed6:	05 20 8c 00 00       	add    $0x8c20,%eax
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 82 4a 00 	movl   $0x4a82,0x4(%esp)
     efe:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f29:	00 
     f2a:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
     f31:	00 
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 8e 4a 00 	movl   $0x4a8e,0x4(%esp)
     f68:	00 
  ...
  unlink("f1");
     f88:	c7 04 24 5c 4a 00 00 	movl   $0x4a5c,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 5f 4a 00 00 	movl   $0x4a5f,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 9f 4a 00 	movl   $0x4a9f,0x4(%esp)
     fa7:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 ac 4a 00 	movl   $0x4aac,0x4(%esp)
     fc3:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
     fe5:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 62 4a 00 	movl   $0x4a62,0x4(%esp)
    1048:	00 
    ...
    1096:	c7 44 24 04 bf 4a 00 	movl   $0x4abf,0x4(%esp)
    109d:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 d0 4a 00 	movl   $0x4ad0,0x4(%esp)
    111c:	00 
    ...
    1147:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    114e:	00 
    ...
    11ad:	c7 44 24 04 d0 4a 00 	movl   $0x4ad0,0x4(%esp)
    11b4:	00 
    ...
    11df:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    11e6:	00 
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 14 4b 00 	movl   $0x4b14,0x4(%esp)
    1258:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 25 4b 00 	movl   $0x4b25,0x4(%esp)
    1274:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1288:	00 
    1289:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 41 4b 00 	movl   $0x4b41,0x4(%esp)
    12a5:	00 
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 5b 4b 00 	movl   $0x4b5b,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
  ...
  if(fd < 0){
    ...
    12fa:	c7 44 24 04 61 4b 00 	movl   $0x4b61,0x4(%esp)
    1301:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1380:	00 
    1381:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    1388:	00 
    ...
    1399:	c7 44 24 04 97 4b 00 	movl   $0x4b97,0x4(%esp)
    13a0:	00 
  ...
  if(buf[0] != 'h'){
    13b2:	0f b6 05 20 8c 00 00 	movzbl 0x8c20,%eax
    13b9:	3c 68                	cmp    $0x68,%al
    13bb:	74 19                	je     13d6 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13bd:	c7 44 24 04 ae 4b 00 	movl   $0x4bae,0x4(%esp)
    13c4:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13dd:	00 
    13de:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    13e5:	00 
    ...
    13f6:	c7 44 24 04 c5 4b 00 	movl   $0x4bc5,0x4(%esp)
    13fd:	00 
  ...
  unlink("unlinkread");
    141a:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 de 4b 00 	movl   $0x4bde,0x4(%esp)
    142d:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 ff 4b 00 	movl   $0x4bff,0x4(%esp)
    1492:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 5b 4b 00 	movl   $0x4b5b,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 12 4c 00 	movl   $0x4c12,0x4(%esp)
    14cb:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14e8:	c7 44 24 04 fb 4b 00 	movl   $0x4bfb,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 f7 4b 00 00 	movl   $0x4bf7,(%esp)
    14f7:	e8 8c 27 00 00       	call   3c88 <link>
    14fc:	85 c0                	test   %eax,%eax
    14fe:	79 19                	jns    1519 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1500:	c7 44 24 04 24 4c 00 	movl   $0x4c24,0x4(%esp)
    1507:	00 
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 61 4c 00 	movl   $0x4c61,0x4(%esp)
    157a:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1593:	00 
    1594:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    159b:	00 
    ...
    15ac:	c7 44 24 04 72 4c 00 	movl   $0x4c72,0x4(%esp)
    15b3:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 fb 4b 00 	movl   $0x4bfb,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 83 4c 00 	movl   $0x4c83,0x4(%esp)
    15ef:	00 
  ...
  unlink("lf2");
    1601:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 a4 4c 00 	movl   $0x4ca4,0x4(%esp)
    162c:	00 
  ...
  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 c9 4c 00 	movl   $0x4cc9,0x4(%esp)
    165d:	00 
  ...
  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    1676:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 f2 4c 00 	movl   $0x4cf2,0x4(%esp)
    1692:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 02 4d 00 00 	movl   $0x4d02,(%esp)
    ...
    1741:	c7 04 24 02 4d 00 00 	movl   $0x4d02,(%esp)
    ...
    1772:	c7 44 24 04 05 4d 00 	movl   $0x4d05,0x4(%esp)
    1779:	00 
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 21 4d 00 	movl   $0x4d21,0x4(%esp)
    183f:	00 
    ...
    1868:	c7 44 24 04 3a 4d 00 	movl   $0x4d3a,0x4(%esp)
    186f:	00 
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 58 4d 00 	movl   $0x4d58,0x4(%esp)
    18cb:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
    1907:	00 
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 89 4d 00 	movl   $0x4d89,0x4(%esp)
    1a27:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 8f 23 00 00       	call   3ddf <printf>

  unlink("x");
    1a50:	c7 04 24 fe 48 00 00 	movl   $0x48fe,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
    1a71:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 fe 48 00 00 	movl   $0x48fe,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 fe 48 00 	movl   $0x48fe,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 fe 48 00 00 	movl   $0x48fe,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 ac 4d 00 	movl   $0x4dac,0x4(%esp)
    1b4e:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 cb 4d 00 	movl   $0x4dcb,0x4(%esp)
    1bac:	00 
  ...
  unlink("bd");
    1c43:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 f5 4d 00 	movl   $0x4df5,0x4(%esp)
    1ca2:	00 
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 0a 4e 00 	movl   $0x4e0a,0x4(%esp)
    1cc8:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 40 4e 00 00 	movl   $0x4e40,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 46 4e 00 	movl   $0x4e46,0x4(%esp)
    1d4a:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 22 4e 00 	movl   $0x4e22,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 a4 4e 00 00 	movl   $0x4ea4,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 ad 4e 00 	movl   $0x4ead,0x4(%esp)
    1df8:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 c5 4e 00 	movl   $0x4ec5,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 c8 4e 00 00 	movl   $0x4ec8,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 d4 4e 00 	movl   $0x4ed4,0x4(%esp)
    1e54:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6d:	00 
    1e6e:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    1e75:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8a:	0f b6 05 20 8c 00 00 	movzbl 0x8c20,%eax
    1e91:	3c 66                	cmp    $0x66,%al
    1e93:	74 19                	je     1eae <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e95:	c7 44 24 04 ed 4e 00 	movl   $0x4eed,0x4(%esp)
    1e9c:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eb9:	c7 44 24 04 08 4f 00 	movl   $0x4f08,0x4(%esp)
    1ec0:	00 
    1ec1:	c7 04 24 a4 4e 00 00 	movl   $0x4ea4,(%esp)
    1ec8:	e8 bb 1d 00 00       	call   3c88 <link>
    1ecd:	85 c0                	test   %eax,%eax
    1ecf:	74 19                	je     1eea <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed1:	c7 44 24 04 14 4f 00 	movl   $0x4f14,0x4(%esp)
    1ed8:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 08 4f 00 00 	movl   $0x4f08,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 d2 4f 00 	movl   $0x4fd2,0x4(%esp)
    200c:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2025:	00 
    2026:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    202d:	00 
    ...
    203e:	c7 44 24 04 ea 4f 00 	movl   $0x4fea,0x4(%esp)
    2045:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2188:	c7 44 24 04 c1 50 00 	movl   $0x50c1,0x4(%esp)
    218f:	00 
    2190:	c7 04 24 2d 50 00 00 	movl   $0x502d,(%esp)
    2197:	e8 ec 1a 00 00       	call   3c88 <link>
    219c:	85 c0                	test   %eax,%eax
    219e:	75 19                	jne    21b9 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a0:	c7 44 24 04 cc 50 00 	movl   $0x50cc,0x4(%esp)
    21a7:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21b9:	c7 44 24 04 c1 50 00 	movl   $0x50c1,0x4(%esp)
    21c0:	00 
    21c1:	c7 04 24 52 50 00 00 	movl   $0x5052,(%esp)
    21c8:	e8 bb 1a 00 00       	call   3c88 <link>
    21cd:	85 c0                	test   %eax,%eax
    21cf:	75 19                	jne    21ea <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d1:	c7 44 24 04 f0 50 00 	movl   $0x50f0,0x4(%esp)
    21d8:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21ea:	c7 44 24 04 08 4f 00 	movl   $0x4f08,0x4(%esp)
    21f1:	00 
    21f2:	c7 04 24 40 4e 00 00 	movl   $0x4e40,(%esp)
    21f9:	e8 8a 1a 00 00       	call   3c88 <link>
    21fe:	85 c0                	test   %eax,%eax
    2200:	75 19                	jne    221b <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2202:	c7 44 24 04 14 51 00 	movl   $0x5114,0x4(%esp)
    2209:	00 
  ...
  printf(1, "subdir ok\n");
    2407:	c7 44 24 04 59 52 00 	movl   $0x5259,0x4(%esp)
    240e:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 64 52 00 	movl   $0x5264,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 a8 19 00 00       	call   3ddf <printf>

  unlink("bigwrite");
    2437:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
    ...
    246c:	c7 44 24 04 7c 52 00 	movl   $0x527c,0x4(%esp)
    2473:	00 
    ...
    2495:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    249c:	00 
    ...
    24c1:	c7 44 24 04 94 52 00 	movl   $0x5294,0x4(%esp)
    24c8:	00 
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 a6 52 00 	movl   $0x52a6,0x4(%esp)
    2516:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 c9 52 00 	movl   $0x52c9,0x4(%esp)
    256f:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    2599:	c7 04 24 20 8c 00 00 	movl   $0x8c20,(%esp)
    25a0:	e8 de 14 00 00       	call   3a83 <memset>
    if(write(fd, buf, 600) != 600){
    25a5:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ac:	00 
    25ad:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    25b4:	00 
    ...
    25c7:	c7 44 24 04 df 52 00 	movl   $0x52df,0x4(%esp)
    25ce:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 f5 52 00 	movl   $0x52f5,0x4(%esp)
    2619:	00 
  ...
  for(i = 0; ; i++){
    ...
    2640:	00 
    2641:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    2648:	00 
    ...
    265d:	c7 44 24 04 0a 53 00 	movl   $0x530a,0x4(%esp)
    2664:	00 
    ...
    2685:	c7 44 24 04 1f 53 00 	movl   $0x531f,0x4(%esp)
    268c:	00 
    ...
    269e:	0f b6 05 20 8c 00 00 	movzbl 0x8c20,%eax
    ...
    26b8:	0f b6 05 4b 8d 00 00 	movzbl 0x8d4b,%eax
    ...
    26d2:	c7 44 24 04 33 53 00 	movl   $0x5333,0x4(%esp)
    26d9:	00 
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 4c 53 00 	movl   $0x534c,0x4(%esp)
    2716:	00 
  ...
  unlink("bigfile");
    2728:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 66 53 00 	movl   $0x5366,0x4(%esp)
    273b:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 04 54 00 00 	movl   $0x5404,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 34 54 00 	movl   $0x5434,0x4(%esp)
    27da:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 74 54 00 00 	movl   $0x5474,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 a4 54 00 	movl   $0x54a4,0x4(%esp)
    281b:	00 
  ...
  printf(1, "fourteen ok\n");
    288a:	c7 44 24 04 7d 55 00 	movl   $0x557d,0x4(%esp)
    2891:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a02:	c7 44 24 04 43 56 00 	movl   $0x5643,0x4(%esp)
    2a09:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 4d 56 00 	movl   $0x564d,0x4(%esp)
    2a25:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a39:	00 
    2a3a:	c7 04 24 5a 56 00 00 	movl   $0x565a,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 62 56 00 	movl   $0x5662,0x4(%esp)
    2a56:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 9e 56 00 	movl   $0x569e,0x4(%esp)
    2ac0:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 93 56 00 00 	movl   $0x5693,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2aef:	c7 44 24 04 9e 56 00 	movl   $0x569e,0x4(%esp)
    2af6:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b5a:	c7 44 24 04 93 56 00 	movl   $0x5693,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 f7 56 00 00 	movl   $0x56f7,(%esp)
    2b69:	e8 1a 11 00 00       	call   3c88 <link>
    2b6e:	85 c0                	test   %eax,%eax
    2b70:	75 19                	jne    2b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b72:	c7 44 24 04 00 57 00 	movl   $0x5700,0x4(%esp)
    2b79:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 38 57 00 	movl   $0x5738,0x4(%esp)
    2bd8:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 57 57 00 	movl   $0x5757,0x4(%esp)
    2c27:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 6b 57 00 	movl   $0x576b,0x4(%esp)
    2c4b:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 7b 57 00 	movl   $0x577b,0x4(%esp)
    2c67:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd2:	c7 04 24 ba 57 00 00 	movl   $0x57ba,(%esp)
    2cd9:	e8 b2 0f 00 00       	call   3c90 <mkdir>
    link("README", "");
    2cde:	c7 44 24 04 ba 57 00 	movl   $0x57ba,0x4(%esp)
    2ce5:	00 
    2ce6:	c7 04 24 f7 56 00 00 	movl   $0x56f7,(%esp)
    2ced:	e8 96 0f 00 00       	call   3c88 <link>
    fd = open("", O_CREATE);
    2cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 ba 57 00 00 	movl   $0x57ba,(%esp)
    ...
    2d21:	00 
    2d22:	c7 04 24 bb 57 00 00 	movl   $0x57bb,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 bb 57 00 00 	movl   $0x57bb,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 de 55 00 00 	movl   $0x55de,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 be 57 00 	movl   $0x57be,0x4(%esp)
    2d6f:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 d2 57 00 	movl   $0x57d2,0x4(%esp)
    2d8b:	00 
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 e0 57 00 	movl   $0x57e0,0x4(%esp)
    2dda:	00 
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 02 58 00 	movl   $0x5802,0x4(%esp)
    2dfc:	00 
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 16 58 00 	movl   $0x5816,0x4(%esp)
    2e29:	00 
  ...
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 29 58 00 	movl   $0x5829,0x4(%esp)
    2e42:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 30 64 00 00       	mov    0x6430,%eax
    2e60:	c7 44 24 04 37 58 00 	movl   $0x5837,0x4(%esp)
    2e67:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 30 64 00 00       	mov    0x6430,%eax
    ...
    2ec8:	c7 44 24 04 42 58 00 	movl   $0x5842,0x4(%esp)
    2ecf:	00 
  ...
  if(pid < 0){
    ...
    2f07:	a1 30 64 00 00       	mov    0x6430,%eax
    2f0c:	c7 44 24 04 5d 58 00 	movl   $0x585d,0x4(%esp)
    2f13:	00 
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 30 64 00 00       	mov    0x6430,%eax
    2f4f:	c7 44 24 04 74 58 00 	movl   $0x5874,0x4(%esp)
    2f56:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 30 64 00 00       	mov    0x6430,%eax
    2faf:	c7 44 24 04 90 58 00 	movl   $0x5890,0x4(%esp)
    2fb6:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 30 64 00 00       	mov    0x6430,%eax
    2ffa:	c7 44 24 04 ce 58 00 	movl   $0x58ce,0x4(%esp)
    3001:	00 
  ...
  if(c != a - 4096){
    ...
    302b:	a1 30 64 00 00       	mov    0x6430,%eax
    ...
    303e:	c7 44 24 04 ec 58 00 	movl   $0x58ec,0x4(%esp)
    3045:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 30 64 00 00       	mov    0x6430,%eax
    ...
    30a5:	c7 44 24 04 24 59 00 	movl   $0x5924,0x4(%esp)
    30ac:	00 
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 30 64 00 00       	mov    0x6430,%eax
    30c9:	c7 44 24 04 4c 59 00 	movl   $0x594c,0x4(%esp)
    30d0:	00 
  ...
  if(c != a){
    ...
    3115:	a1 30 64 00 00       	mov    0x6430,%eax
    ...
    3128:	c7 44 24 04 7c 59 00 	movl   $0x597c,0x4(%esp)
    312f:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 30 64 00 00       	mov    0x6430,%eax
    3161:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
    3168:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 99 48 00 	movl   $0x4899,0x4(%esp)
    31e4:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 fe 48 00 	movl   $0x48fe,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 30 64 00 00       	mov    0x6430,%eax
    32e9:	c7 44 24 04 b6 59 00 	movl   $0x59b6,0x4(%esp)
    32f0:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 30 64 00 00       	mov    0x6430,%eax
    3331:	c7 44 24 04 d1 59 00 	movl   $0x59d1,0x4(%esp)
    3338:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 30 64 00 00       	mov    0x6430,%eax
    3380:	c7 44 24 04 df 59 00 	movl   $0x59df,0x4(%esp)
    3387:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 ee 59 00 00 	movl   $0x59ee,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 30 64 00 00       	mov    0x6430,%eax
    3403:	c7 44 24 04 f9 59 00 	movl   $0x59f9,0x4(%esp)
    340a:	00 
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 30 64 00 00       	mov    0x6430,%eax
    3430:	c7 44 24 04 12 5a 00 	movl   $0x5a12,0x4(%esp)
    3437:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 30 64 00 00       	mov    0x6430,%eax
    344d:	c7 44 24 04 1f 5a 00 	movl   $0x5a1f,0x4(%esp)
    3454:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3469:	05 00 65 00 00       	add    $0x6500,%eax
    346e:	0f b6 00             	movzbl (%eax),%eax
    3471:	84 c0                	test   %al,%al
    3473:	74 1a                	je     348f <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3475:	a1 30 64 00 00       	mov    0x6430,%eax
    347a:	c7 44 24 04 29 5a 00 	movl   $0x5a29,0x4(%esp)
    3481:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 30 64 00 00       	mov    0x6430,%eax
    34a2:	c7 44 24 04 3a 5a 00 	movl   $0x5a3a,0x4(%esp)
    34a9:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 47 5a 00 00 	movl   $0x5a47,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 60 64 00 00 	movl   $0x5a54,0x6460(,%eax,4)
    34eb:	54 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f7:	7e e8                	jle    34e1 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34f9:	c7 05 dc 64 00 00 00 	movl   $0x0,0x64dc
    3500:	00 00 00 
    printf(stdout, "bigarg test\n");
    3503:	a1 30 64 00 00       	mov    0x6430,%eax
    3508:	c7 44 24 04 31 5b 00 	movl   $0x5b31,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 c7 08 00 00       	call   3ddf <printf>
    exec("echo", args);
    3518:	c7 44 24 04 60 64 00 	movl   $0x6460,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 58 45 00 00 	movl   $0x4558,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 30 64 00 00       	mov    0x6430,%eax
    3531:	c7 44 24 04 3e 5b 00 	movl   $0x5b3e,0x4(%esp)
    3538:	00 
    ...
    3548:	00 
    3549:	c7 04 24 47 5a 00 00 	movl   $0x5a47,(%esp)
    ...
    356e:	a1 30 64 00 00       	mov    0x6430,%eax
    3573:	c7 44 24 04 4e 5b 00 	movl   $0x5b4e,0x4(%esp)
    357a:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 47 5a 00 00 	movl   $0x5a47,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 30 64 00 00       	mov    0x6430,%eax
    35af:	c7 44 24 04 67 5b 00 	movl   $0x5b67,0x4(%esp)
    35b6:	00 
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 47 5a 00 00 	movl   $0x5a47,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 7c 5b 00 	movl   $0x5b7c,0x4(%esp)
    35f2:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 89 5b 00 	movl   $0x5b89,0x4(%esp)
    36e2:	00 
    ...
    3712:	c7 44 24 04 95 5b 00 	movl   $0x5b95,0x4(%esp)
    3719:	00 
    ...
    3736:	00 
    3737:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    373e:	00 
    ...
    376a:	c7 44 24 04 a5 5b 00 	movl   $0x5ba5,0x4(%esp)
    3771:	00 
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 b5 5b 00 	movl   $0x5bb5,0x4(%esp)
    388c:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 34 64 00 00       	mov    0x6434,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 34 64 00 00       	mov    %eax,0x6434
  return randstate;
    38b7:	a1 34 64 00 00       	mov    0x6434,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38c7:	c7 44 24 04 cb 5b 00 	movl   $0x5bcb,0x4(%esp)
    38ce:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 df 5b 00 00 	movl   $0x5bdf,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d76:	0f b6 90 38 64 00 00 	movzbl 0x6438(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ed5:	75 27                	jne    3efe <printf+0x11f>
          s = "(null)";
    3ed7:	c7 45 f4 1a 5c 00 00 	movl   $0x5c1a,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3fa3:	a1 e8 64 00 00       	mov    0x64e8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    4064:	a3 e8 64 00 00       	mov    %eax,0x64e8
}
    4069:	c9                   	leave  
    406a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    40bc:	a1 e8 64 00 00       	mov    0x64e8,%eax
}
    40c1:	c9                   	leave  
    40c2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40d8:	a1 e8 64 00 00       	mov    0x64e8,%eax
    40dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40e4:	75 23                	jne    4109 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40e6:	c7 45 f0 e0 64 00 00 	movl   $0x64e0,-0x10(%ebp)
    40ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f0:	a3 e8 64 00 00       	mov    %eax,0x64e8
    40f5:	a1 e8 64 00 00       	mov    0x64e8,%eax
    40fa:	a3 e0 64 00 00       	mov    %eax,0x64e0
    base.s.size = 0;
    40ff:	c7 05 e4 64 00 00 00 	movl   $0x0,0x64e4
    4106:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    415c:	a3 e8 64 00 00       	mov    %eax,0x64e8
      return (void*)(p + 1);
    ...
    if(p == freep)
    4169:	a1 e8 64 00 00       	mov    0x64e8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  if(sem->s1 == -1 || sem->s2 == -1){
    ...
    4208:	75 2d                	jne    4237 <semaphore_create+0x93>
     printf(1,"we had a probalem initialize in semaphore_create\n");
    420a:	c7 44 24 04 24 5c 00 	movl   $0x5c24,0x4(%esp)
    4211:	00 
    ...
    4224:	e8 6b fd ff ff       	call   3f94 <free>
     sem =0;
    4229:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
     return 0;
    4230:	b8 00 00 00 00       	mov    $0x0,%eax
    4235:	eb 0c                	jmp    4243 <semaphore_create+0x9f>
  }
  //initialize value
  sem->value = initial_semaphore_value;//dynamic
    4237:	8b 45 f4             	mov    -0xc(%ebp),%eax
    423a:	8b 55 08             	mov    0x8(%ebp),%edx
    423d:	89 50 08             	mov    %edx,0x8(%eax)
...
00004245 <semaphore_down>:
void semaphore_down(struct semaphore* sem ){
    4245:	55                   	push   %ebp
    4246:	89 e5                	mov    %esp,%ebp
    4248:	83 ec 18             	sub    $0x18,%esp
  binary_semaphore_down(sem->s2);
    424b:	8b 45 08             	mov    0x8(%ebp),%eax
    424e:	8b 40 04             	mov    0x4(%eax),%eax
    4251:	89 04 24             	mov    %eax,(%esp)
    4254:	e8 9f fa ff ff       	call   3cf8 <binary_semaphore_down>
  binary_semaphore_down(sem->s1);
    4259:	8b 45 08             	mov    0x8(%ebp),%eax
    425c:	8b 00                	mov    (%eax),%eax
    425e:	89 04 24             	mov    %eax,(%esp)
    4261:	e8 92 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value--;	
    4266:	8b 45 08             	mov    0x8(%ebp),%eax
    4269:	8b 40 08             	mov    0x8(%eax),%eax
    426c:	8d 50 ff             	lea    -0x1(%eax),%edx
    426f:	8b 45 08             	mov    0x8(%ebp),%eax
    4272:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value > 0){
    4275:	8b 45 08             	mov    0x8(%ebp),%eax
    4278:	8b 40 08             	mov    0x8(%eax),%eax
    427b:	85 c0                	test   %eax,%eax
    427d:	7e 0e                	jle    428d <semaphore_down+0x48>
   binary_semaphore_up(sem->s2);
    427f:	8b 45 08             	mov    0x8(%ebp),%eax
    4282:	8b 40 04             	mov    0x4(%eax),%eax
    4285:	89 04 24             	mov    %eax,(%esp)
    4288:	e8 73 fa ff ff       	call   3d00 <binary_semaphore_up>
  }
  binary_semaphore_up(sem->s1); 
    428d:	8b 45 08             	mov    0x8(%ebp),%eax
    4290:	8b 00                	mov    (%eax),%eax
    4292:	89 04 24             	mov    %eax,(%esp)
    4295:	e8 66 fa ff ff       	call   3d00 <binary_semaphore_up>
}
    429a:	c9                   	leave  
    429b:	c3                   	ret    

0000429c <semaphore_up>:
void semaphore_up(struct semaphore* sem ){
    429c:	55                   	push   %ebp
    429d:	89 e5                	mov    %esp,%ebp
    429f:	83 ec 18             	sub    $0x18,%esp
  binary_semaphore_down(sem->s1);
    42a2:	8b 45 08             	mov    0x8(%ebp),%eax
    42a5:	8b 00                	mov    (%eax),%eax
    42a7:	89 04 24             	mov    %eax,(%esp)
    42aa:	e8 49 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value++;	
    42af:	8b 45 08             	mov    0x8(%ebp),%eax
    42b2:	8b 40 08             	mov    0x8(%eax),%eax
    42b5:	8d 50 01             	lea    0x1(%eax),%edx
    42b8:	8b 45 08             	mov    0x8(%ebp),%eax
    42bb:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value ==1){
    42be:	8b 45 08             	mov    0x8(%ebp),%eax
    42c1:	8b 40 08             	mov    0x8(%eax),%eax
    42c4:	83 f8 01             	cmp    $0x1,%eax
    42c7:	75 0e                	jne    42d7 <semaphore_up+0x3b>
   binary_semaphore_up(sem->s2); 
    42c9:	8b 45 08             	mov    0x8(%ebp),%eax
    42cc:	8b 40 04             	mov    0x4(%eax),%eax
    42cf:	89 04 24             	mov    %eax,(%esp)
    42d2:	e8 29 fa ff ff       	call   3d00 <binary_semaphore_up>
   }
  binary_semaphore_up(sem->s1);
    42d7:	8b 45 08             	mov    0x8(%ebp),%eax
    42da:	8b 00                	mov    (%eax),%eax
    42dc:	89 04 24             	mov    %eax,(%esp)
    42df:	e8 1c fa ff ff       	call   3d00 <binary_semaphore_up>
}
    42e4:	c9                   	leave  
    42e5:	c3                   	ret    

000042e6 <semaphore_free>:

void semaphore_free(struct semaphore* sem){
    42e6:	55                   	push   %ebp
    42e7:	89 e5                	mov    %esp,%ebp
    42e9:	83 ec 18             	sub    $0x18,%esp
  free(sem);
    42ec:	8b 45 08             	mov    0x8(%ebp),%eax
    42ef:	89 04 24             	mov    %eax,(%esp)
    42f2:	e8 9d fc ff ff       	call   3f94 <free>
}
    42f7:	c9                   	leave  
    42f8:	c3                   	ret    
    42f9:	90                   	nop
...
BB_create(int max_capacity){
  ...
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
    ...
    43c8:	75 52                	jne    441c <BB_create+0x120>
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    43e8:	c7 44 24 04 58 5c 00 	movl   $0x5c58,0x4(%esp)
    43ef:	00 
   ...
   free(buf->pointer_to_elements);
    ...
    43ff:	8b 40 1c             	mov    0x1c(%eax),%eax
    4402:	89 04 24             	mov    %eax,(%esp)
    4405:	e8 8a fb ff ff       	call   3f94 <free>
   free(buf);
    440a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    440d:	89 04 24             	mov    %eax,(%esp)
    4410:	e8 7f fb ff ff       	call   3f94 <free>
   buf =0;  
    4415:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
{ 
  ...
  */
  semaphore_down(bb->empty);
    ...
    442a:	8b 40 08             	mov    0x8(%eax),%eax
    442d:	89 04 24             	mov    %eax,(%esp)
    4430:	e8 10 fe ff ff       	call   4245 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    4435:	8b 45 08             	mov    0x8(%ebp),%eax
    4438:	8b 40 04             	mov    0x4(%eax),%eax
    443b:	89 04 24             	mov    %eax,(%esp)
    443e:	e8 b5 f8 ff ff       	call   3cf8 <binary_semaphore_down>
   //insert item
  bb->pointer_to_elements[bb->end] = element;
    4443:	8b 45 08             	mov    0x8(%ebp),%eax
    4446:	8b 50 1c             	mov    0x1c(%eax),%edx
    4449:	8b 45 08             	mov    0x8(%ebp),%eax
    444c:	8b 40 18             	mov    0x18(%eax),%eax
    444f:	c1 e0 02             	shl    $0x2,%eax
    4452:	01 c2                	add    %eax,%edx
    4454:	8b 45 0c             	mov    0xc(%ebp),%eax
    4457:	89 02                	mov    %eax,(%edx)
  ++bb->end;
    4459:	8b 45 08             	mov    0x8(%ebp),%eax
    445c:	8b 40 18             	mov    0x18(%eax),%eax
    445f:	8d 50 01             	lea    0x1(%eax),%edx
    4462:	8b 45 08             	mov    0x8(%ebp),%eax
    4465:	89 50 18             	mov    %edx,0x18(%eax)
  bb->end = bb->end%bb->buffer_size;
    4468:	8b 45 08             	mov    0x8(%ebp),%eax
    446b:	8b 40 18             	mov    0x18(%eax),%eax
    446e:	8b 55 08             	mov    0x8(%ebp),%edx
    4471:	8b 0a                	mov    (%edx),%ecx
    4473:	89 c2                	mov    %eax,%edx
    4475:	c1 fa 1f             	sar    $0x1f,%edx
    4478:	f7 f9                	idiv   %ecx
    447a:	8b 45 08             	mov    0x8(%ebp),%eax
    447d:	89 50 18             	mov    %edx,0x18(%eax)
  binary_semaphore_up(bb->mutex);
    4480:	8b 45 08             	mov    0x8(%ebp),%eax
    4483:	8b 40 04             	mov    0x4(%eax),%eax
    4486:	89 04 24             	mov    %eax,(%esp)
    4489:	e8 72 f8 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->full);
    448e:	8b 45 08             	mov    0x8(%ebp),%eax
    4491:	8b 40 0c             	mov    0xc(%eax),%eax
    4494:	89 04 24             	mov    %eax,(%esp)
    4497:	e8 00 fe ff ff       	call   429c <semaphore_up>
...
{
    449e:	55                   	push   %ebp
    449f:	89 e5                	mov    %esp,%ebp
    44a1:	83 ec 28             	sub    $0x28,%esp
  
  void* element_to_pop;
  semaphore_down(bb->full);
    44a4:	8b 45 08             	mov    0x8(%ebp),%eax
    44a7:	8b 40 0c             	mov    0xc(%eax),%eax
    44aa:	89 04 24             	mov    %eax,(%esp)
    44ad:	e8 93 fd ff ff       	call   4245 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    44b2:	8b 45 08             	mov    0x8(%ebp),%eax
    44b5:	8b 40 04             	mov    0x4(%eax),%eax
    44b8:	89 04 24             	mov    %eax,(%esp)
    44bb:	e8 38 f8 ff ff       	call   3cf8 <binary_semaphore_down>
  element_to_pop = bb-> pointer_to_elements[bb->start];
    44c0:	8b 45 08             	mov    0x8(%ebp),%eax
    44c3:	8b 50 1c             	mov    0x1c(%eax),%edx
    44c6:	8b 45 08             	mov    0x8(%ebp),%eax
    44c9:	8b 40 14             	mov    0x14(%eax),%eax
    44cc:	c1 e0 02             	shl    $0x2,%eax
    44cf:	01 d0                	add    %edx,%eax
    44d1:	8b 00                	mov    (%eax),%eax
    44d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  bb->pointer_to_elements[bb->start] =0;
    44d6:	8b 45 08             	mov    0x8(%ebp),%eax
    44d9:	8b 50 1c             	mov    0x1c(%eax),%edx
    44dc:	8b 45 08             	mov    0x8(%ebp),%eax
    44df:	8b 40 14             	mov    0x14(%eax),%eax
    44e2:	c1 e0 02             	shl    $0x2,%eax
    44e5:	01 d0                	add    %edx,%eax
    44e7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ++bb->start;
    44ed:	8b 45 08             	mov    0x8(%ebp),%eax
    44f0:	8b 40 14             	mov    0x14(%eax),%eax
    44f3:	8d 50 01             	lea    0x1(%eax),%edx
    44f6:	8b 45 08             	mov    0x8(%ebp),%eax
    44f9:	89 50 14             	mov    %edx,0x14(%eax)
  bb->start = bb->start%bb->buffer_size;
    44fc:	8b 45 08             	mov    0x8(%ebp),%eax
    44ff:	8b 40 14             	mov    0x14(%eax),%eax
    4502:	8b 55 08             	mov    0x8(%ebp),%edx
    4505:	8b 0a                	mov    (%edx),%ecx
    4507:	89 c2                	mov    %eax,%edx
    4509:	c1 fa 1f             	sar    $0x1f,%edx
    450c:	f7 f9                	idiv   %ecx
    450e:	8b 45 08             	mov    0x8(%ebp),%eax
    4511:	89 50 14             	mov    %edx,0x14(%eax)
  binary_semaphore_up(bb->mutex);
    4514:	8b 45 08             	mov    0x8(%ebp),%eax
    4517:	8b 40 04             	mov    0x4(%eax),%eax
    451a:	89 04 24             	mov    %eax,(%esp)
    451d:	e8 de f7 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->empty);
    4522:	8b 45 08             	mov    0x8(%ebp),%eax
    4525:	8b 40 08             	mov    0x8(%eax),%eax
    4528:	89 04 24             	mov    %eax,(%esp)
    452b:	e8 6c fd ff ff       	call   429c <semaphore_up>
...
void BB_free(struct BB* bb){
    4535:	55                   	push   %ebp
    4536:	89 e5                	mov    %esp,%ebp
    4538:	83 ec 18             	sub    $0x18,%esp
  free(bb->pointer_to_elements);
    453b:	8b 45 08             	mov    0x8(%ebp),%eax
    453e:	8b 40 1c             	mov    0x1c(%eax),%eax
    4541:	89 04 24             	mov    %eax,(%esp)
    4544:	e8 4b fa ff ff       	call   3f94 <free>
  free(bb);
    4549:	8b 45 08             	mov    0x8(%ebp),%eax
    454c:	89 04 24             	mov    %eax,(%esp)
    454f:	e8 40 fa ff ff       	call   3f94 <free>
    4554:	c9                   	leave  
    4555:	c3                   	ret    
