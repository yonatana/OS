...
8010003a:	c7 44 24 04 58 8d 10 	movl   $0x80108d58,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 78 55 00 00       	call   801055c6 <initlock>
...
801000bd:	e8 25 55 00 00       	call   801055e7 <acquire>
...
80100104:	e8 40 55 00 00       	call   80105649 <release>
        return b;
...
8010011f:	e8 dd 51 00 00       	call   80105301 <sleep>
      goto loop;
...
8010017c:	e8 c8 54 00 00       	call   80105649 <release>
      return b;
...
80100198:	c7 04 24 5f 8d 10 80 	movl   $0x80108d5f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 70 8d 10 80 	movl   $0x80108d70,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 77 8d 10 80 	movl   $0x80108d77,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 a6 53 00 00       	call   801055e7 <acquire>
...
8010029d:	e8 3b 51 00 00       	call   801053dd <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 9b 53 00 00       	call   80105649 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 26 52 00 00       	call   801055e7 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 7e 8d 10 80 	movl   $0x80108d7e,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 87 8d 10 80 	movl   $0x80108d87,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 0e 51 00 00       	call   80105649 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 8e 8d 10 80 	movl   $0x80108d8e,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 9d 8d 10 80 	movl   $0x80108d9d,(%esp)
...
80100592:	e8 01 51 00 00       	call   80105698 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 9f 8d 10 80 	movl   $0x80108d9f,(%esp)
...
801006b2:	e8 52 52 00 00       	call   80105909 <memmove>
    pos -= 80;
...
801006e1:	e8 50 51 00 00       	call   80105836 <memset>
  }
...
80100776:	e8 42 6c 00 00       	call   801073bd <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 36 6c 00 00       	call   801073bd <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 2a 6c 00 00       	call   801073bd <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 1d 6c 00 00       	call   801073bd <uartputc>
  cgaputc(c);
...
801007ba:	e8 28 4e 00 00       	call   801055e7 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 94 4c 00 00       	call   80105483 <procdump>
      break;
...
801008f7:	e8 e1 4a 00 00       	call   801053dd <wakeup>
        }
      }
      break;
...
8010091e:	e8 26 4d 00 00       	call   80105649 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 9f 4c 00 00       	call   801055e7 <acquire>
  while(n > 0){
...
80100961:	e8 e3 4c 00 00       	call   80105649 <release>
        ilock(ip);
...
8010098a:	e8 72 49 00 00       	call   80105301 <sleep>
...
80100a08:	e8 3c 4c 00 00       	call   80105649 <release>
  ilock(ip);
...
80100a3e:	e8 a4 4b 00 00       	call   801055e7 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 cc 4b 00 00       	call   80105649 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 a3 8d 10 	movl   $0x80108da3,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 1f 4b 00 00       	call   801055c6 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 ab 8d 10 	movl   $0x80108dab,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 c0 ed 10 80 	movl   $0x8010edc0,(%esp)
80100ab6:	e8 0b 4b 00 00       	call   801055c6 <initlock>
...
80100b7b:	e8 81 79 00 00       	call   80108501 <setupkvm>
...
80100c14:	e8 ba 7c 00 00       	call   801088d3 <allocuvm>
...
80100c51:	e8 8e 7b 00 00       	call   801087e4 <loaduvm>
...
80100cbc:	e8 12 7c 00 00       	call   801088d3 <allocuvm>
...
80100ce0:	e8 12 7e 00 00       	call   80108af7 <clearpteu>
  sp = sz;
...
80100d0f:	e8 a0 4d 00 00       	call   80105ab4 <strlen>
...
80100d2d:	e8 82 4d 00 00       	call   80105ab4 <strlen>
...
80100d57:	e8 4f 7f 00 00       	call   80108cab <copyout>
...
80100df7:	e8 af 7e 00 00       	call   80108cab <copyout>
...
80100e4e:	e8 13 4c 00 00       	call   80105a66 <safestrcpy>
...
80100ea0:	e8 4d 77 00 00       	call   801085f2 <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 b9 7b 00 00       	call   80108a69 <freevm>
  return 0;
...
80100ee2:	e8 82 7b 00 00       	call   80108a69 <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 b1 8d 10 	movl   $0x80108db1,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80100f15:	e8 ac 46 00 00       	call   801055c6 <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 b9 46 00 00       	call   801055e7 <acquire>
...
80100f52:	e8 f2 46 00 00       	call   80105649 <release>
      return f;
...
80100f70:	e8 d4 46 00 00       	call   80105649 <release>
  return 0;
...
80100f89:	e8 59 46 00 00       	call   801055e7 <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 b8 8d 10 80 	movl   $0x80108db8,(%esp)
...
80100fba:	e8 8a 46 00 00       	call   80105649 <release>
  return f;
...
80100fd1:	e8 11 46 00 00       	call   801055e7 <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 c0 8d 10 80 	movl   $0x80108dc0,(%esp)
...
8010100c:	e8 38 46 00 00       	call   80105649 <release>
    return;
...
80101056:	e8 ee 45 00 00       	call   80105649 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 ca 8d 10 80 	movl   $0x80108dca,(%esp)
...
801012a3:	c7 04 24 d3 8d 10 80 	movl   $0x80108dd3,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 e3 8d 10 80 	movl   $0x80108de3,(%esp)
...
80101320:	e8 e4 45 00 00       	call   80105909 <memmove>
  brelse(bp);
...
80101366:	e8 cb 44 00 00       	call   80105836 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 ed 8d 10 80 	movl   $0x80108ded,(%esp)
...
80101565:	c7 04 24 03 8e 10 80 	movl   $0x80108e03,(%esp)
...
801015b9:	c7 44 24 04 16 8e 10 	movl   $0x80108e16,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801015c8:	e8 f9 3f 00 00       	call   801055c6 <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 e7 41 00 00       	call   80105836 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 1d 8e 10 80 	movl   $0x80108e1d,(%esp)
...
80101747:	e8 bd 41 00 00       	call   80105909 <memmove>
  log_write(bp);
...
80101771:	e8 71 3e 00 00       	call   801055e7 <acquire>
...
801017bb:	e8 89 3e 00 00       	call   80105649 <release>
      return ip;
...
801017ee:	c7 04 24 2f 8e 10 80 	movl   $0x80108e2f,(%esp)
...
8010182c:	e8 18 3e 00 00       	call   80105649 <release>
...
80101843:	e8 9f 3d 00 00       	call   801055e7 <acquire>
  ip->ref++;
...
8010185e:	e8 e6 3d 00 00       	call   80105649 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 3f 8e 10 80 	movl   $0x80108e3f,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101891:	e8 51 3d 00 00       	call   801055e7 <acquire>
...
801018a6:	e8 56 3a 00 00       	call   80105301 <sleep>
...
801018d0:	e8 74 3d 00 00       	call   80105649 <release>
...
8010197b:	e8 89 3f 00 00       	call   80105909 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 45 8e 10 80 	movl   $0x80108e45,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 54 8e 10 80 	movl   $0x80108e54,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801019ec:	e8 f6 3b 00 00       	call   801055e7 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 d0 39 00 00       	call   801053dd <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101a14:	e8 30 3c 00 00       	call   80105649 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 ba 3b 00 00       	call   801055e7 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 5c 8e 10 80 	movl   $0x80108e5c,(%esp)
...
80101a8a:	e8 ba 3b 00 00       	call   80105649 <release>
    itrunc(ip);
...
80101ab5:	e8 2d 3b 00 00       	call   801055e7 <acquire>
    ip->flags = 0;
...
80101aca:	e8 0e 39 00 00       	call   801053dd <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 5f 3b 00 00       	call   80105649 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 66 8e 10 80 	movl   $0x80108e66,(%esp)
...
80101e92:	e8 72 3a 00 00       	call   80105909 <memmove>
    brelse(bp);
...
80101ff8:	e8 0c 39 00 00       	call   80105909 <memmove>
    log_write(bp);
...
8010207a:	e8 2e 39 00 00       	call   801059ad <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 79 8e 10 80 	movl   $0x80108e79,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 8b 8e 10 80 	movl   $0x80108e8b,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 8b 8e 10 80 	movl   $0x80108e8b,(%esp)
...
801021fc:	e8 04 38 00 00       	call   80105a05 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 98 8e 10 80 	movl   $0x80108e98,(%esp)
...
801022b5:	e8 4f 36 00 00       	call   80105909 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 34 36 00 00       	call   80105909 <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 a0 8e 10 	movl   $0x80108ea0,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
8010253b:	e8 86 30 00 00       	call   801055c6 <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 a4 8e 10 80 	movl   $0x80108ea4,(%esp)
...
801026fe:	e8 e4 2e 00 00       	call   801055e7 <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 2c 2f 00 00       	call   80105649 <release>
...
8010278b:	e8 4d 2c 00 00       	call   801053dd <wakeup>
...
801027ad:	e8 97 2e 00 00       	call   80105649 <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 ad 8e 10 80 	movl   $0x80108ead,(%esp)
...
801027df:	c7 04 24 c1 8e 10 80 	movl   $0x80108ec1,(%esp)
...
8010286a:	e8 92 2a 00 00       	call   80105301 <sleep>
...
80102886:	e8 be 2d 00 00       	call   80105649 <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 f4 8e 10 80 	movl   $0x80108ef4,(%esp)
...
801029d7:	c7 44 24 04 26 8f 10 	movl   $0x80108f26,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
801029e6:	e8 db 2b 00 00       	call   801055c6 <initlock>
  kmem.use_lock = 0;
...
80102a78:	81 7d 08 5c 5c 11 80 	cmpl   $0x80115c5c,0x8(%ebp)
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 2b 8f 10 80 	movl   $0x80108f2b,(%esp)
...
80102ab5:	e8 7c 2d 00 00       	call   80105836 <memset>
...
80102aca:	e8 18 2b 00 00       	call   801055e7 <acquire>
  r = (struct run*)v;
...
80102af8:	e8 4c 2b 00 00       	call   80105649 <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 cd 2a 00 00       	call   801055e7 <acquire>
  r = kmem.freelist;
...
80102b42:	e8 02 2b 00 00       	call   80105649 <release>
  return (char*)r;
...
80102ebe:	c7 04 24 34 8f 10 80 	movl   $0x80108f34,(%esp)
...
80103016:	c7 44 24 04 60 8f 10 	movl   $0x80108f60,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103025:	e8 9c 25 00 00       	call   801055c6 <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 2c 28 00 00       	call   80105909 <memmove>
...
8010322a:	e8 b8 23 00 00       	call   801055e7 <acquire>
  while (log.busy) {
...
80103240:	e8 bc 20 00 00       	call   80105301 <sleep>
...
8010325f:	e8 e5 23 00 00       	call   80105649 <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
801032e0:	c7 04 24 64 8f 10 80 	movl   $0x80108f64,(%esp)
...
801032f5:	c7 04 24 7a 8f 10 80 	movl   $0x80108f7a,(%esp)
...
80103384:	e8 80 25 00 00       	call   80105909 <memmove>
  bwrite(lbuf);
...
80103417:	80 
80103418:	c7 04 24 5c 5c 11 80 	movl   $0x80115c5c,(%esp)
8010341f:	e8 ad f5 ff ff       	call   801029d1 <kinit1>
  kvmalloc();      // kernel page table
80103424:	e8 95 51 00 00       	call   801085be <kvmalloc>
...
8010343b:	e8 21 4b 00 00       	call   80107f61 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 91 8f 10 80 	movl   $0x80108f91,(%esp)
...
8010346b:	e8 3c 3e 00 00       	call   801072ac <uartinit>
  pinit();         // process table
80103470:	e8 96 0b 00 00       	call   8010400b <pinit>
  tvinit();        // trap vectors
80103475:	e8 d5 39 00 00       	call   80106e4f <tvinit>
  binit();         // buffer cache
...
80103497:	e8 f6 38 00 00       	call   80106d92 <timerinit>
...
801034b5:	e8 ce 0c 00 00       	call   80104188 <userinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 0b 51 00 00       	call   801085d5 <switchkvm>
  seginit();
801034ca:	e8 92 4a 00 00       	call   80107f61 <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 a8 8f 10 80 	movl   $0x80108fa8,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 bb 3a 00 00       	call   80106fc3 <idtinit>
...
80103523:	e8 2d 1c 00 00       	call   80105155 <scheduler>
...
80103555:	e8 af 23 00 00       	call   80105909 <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 bc 8f 10 	movl   $0x80108fbc,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 b6 21 00 00       	call   801058ad <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 c1 8f 10 	movl   $0x80108fc1,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 75 20 00 00       	call   801058ad <memcmp>
...
801038fe:	8b 04 85 04 90 10 80 	mov    -0x7fef6ffc(,%eax,4),%eax
...
80103937:	c7 04 24 c6 8f 10 80 	movl   $0x80108fc6,(%esp)
...
801039ca:	c7 04 24 e4 8f 10 80 	movl   $0x80108fe4,(%esp)
...
80103ccf:	c7 44 24 04 18 90 10 	movl   $0x80109018,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 e7 18 00 00       	call   801055c6 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 5b 18 00 00       	call   801055e7 <acquire>
  if(writable){
...
80103daa:	e8 2e 16 00 00       	call   801053dd <wakeup>
...
80103dc9:	e8 0f 16 00 00       	call   801053dd <wakeup>
  }
...
80103dee:	e8 56 18 00 00       	call   80105649 <release>
    kfree((char*)p);
...
80103e06:	e8 3e 18 00 00       	call   80105649 <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 c8 17 00 00       	call   801055e7 <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 f9 17 00 00       	call   80105649 <release>
        return -1;
...
80103e65:	e8 73 15 00 00       	call   801053dd <wakeup>
...
80103e7d:	e8 7f 14 00 00       	call   80105301 <sleep>
...
80103ee4:	e8 f4 14 00 00       	call   801053dd <wakeup>
  release(&p->lock);
80103ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eec:	89 04 24             	mov    %eax,(%esp)
80103eef:	e8 55 17 00 00       	call   80105649 <release>
  return n;
...
80103f0a:	e8 d8 16 00 00       	call   801055e7 <acquire>
...
80103f24:	e8 20 17 00 00       	call   80105649 <release>
      return -1;
...
80103f46:	e8 b6 13 00 00       	call   80105301 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fd6:	e8 02 14 00 00       	call   801053dd <wakeup>
  release(&p->lock);
80103fdb:	8b 45 08             	mov    0x8(%ebp),%eax
80103fde:	89 04 24             	mov    %eax,(%esp)
80103fe1:	e8 63 16 00 00       	call   80105649 <release>
  return i;
...
80104011:	c7 44 24 04 20 90 10 	movl   $0x80109020,0x4(%esp)
80104018:	80 
80104019:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104020:	e8 a1 15 00 00       	call   801055c6 <initlock>
  initlock(&sem_table.lock, "sem_table"); // initial sem_table lock
80104025:	c7 44 24 04 27 90 10 	movl   $0x80109027,0x4(%esp)
8010402c:	80 
8010402d:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104034:	e8 8d 15 00 00       	call   801055c6 <initlock>
  for(i = 0; i<NUM_OF_SEMAPHORES ; i++){	// initialize every semaphore lock in sem_table
80104039:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104040:	eb 25                	jmp    80104067 <pinit+0x5c>
      initlock(&sem_table.semaphore[i].lock,"semaphore");
80104042:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104045:	c1 e0 06             	shl    $0x6,%eax
80104048:	83 c0 30             	add    $0x30,%eax
8010404b:	05 40 0f 11 80       	add    $0x80110f40,%eax
80104050:	83 c0 08             	add    $0x8,%eax
80104053:	c7 44 24 04 31 90 10 	movl   $0x80109031,0x4(%esp)
8010405a:	80 
8010405b:	89 04 24             	mov    %eax,(%esp)
8010405e:	e8 63 15 00 00       	call   801055c6 <initlock>
pinit(void)
{
  int i;
  initlock(&ptable.lock, "ptable");
  initlock(&sem_table.lock, "sem_table"); // initial sem_table lock
  for(i = 0; i<NUM_OF_SEMAPHORES ; i++){	// initialize every semaphore lock in sem_table
80104063:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104067:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
8010406b:	7e d5                	jle    80104042 <pinit+0x37>
      initlock(&sem_table.semaphore[i].lock,"semaphore");
  }
}
8010406d:	c9                   	leave  
...
80104072:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104075:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010407c:	e8 66 15 00 00       	call   801055e7 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104081:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104088:	eb 11                	jmp    8010409b <allocproc+0x2c>
    if(p->state == UNUSED)
8010408a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010408d:	8b 40 0c             	mov    0xc(%eax),%eax
80104090:	85 c0                	test   %eax,%eax
80104092:	74 26                	je     801040ba <allocproc+0x4b>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104094:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
8010409b:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
801040a2:	72 e6                	jb     8010408a <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
801040a4:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801040ab:	e8 99 15 00 00       	call   80105649 <release>
  return 0;
801040b0:	b8 00 00 00 00       	mov    $0x0,%eax
801040b5:	e9 cc 00 00 00       	jmp    80104186 <allocproc+0x117>
  char *sp;
...
801040be:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
801040c5:	a1 04 c0 10 80       	mov    0x8010c004,%eax
801040ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
801040cd:	89 42 10             	mov    %eax,0x10(%edx)
801040d0:	83 c0 01             	add    $0x1,%eax
801040d3:	a3 04 c0 10 80       	mov    %eax,0x8010c004
  release(&ptable.lock);
801040d8:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801040df:	e8 65 15 00 00       	call   80105649 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
801040e4:	e8 16 ea ff ff       	call   80102aff <kalloc>
801040e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801040ec:	89 42 08             	mov    %eax,0x8(%edx)
801040ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040f2:	8b 40 08             	mov    0x8(%eax),%eax
801040f5:	85 c0                	test   %eax,%eax
801040f7:	75 11                	jne    8010410a <allocproc+0x9b>
    p->state = UNUSED;
801040f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040fc:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104103:	b8 00 00 00 00       	mov    $0x0,%eax
80104108:	eb 7c                	jmp    80104186 <allocproc+0x117>
  }
  sp = p->kstack + KSTACKSIZE;
8010410a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010410d:	8b 40 08             	mov    0x8(%eax),%eax
80104110:	05 00 10 00 00       	add    $0x1000,%eax
80104115:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104118:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
8010411c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010411f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104122:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104125:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
80104129:	ba 04 6e 10 80       	mov    $0x80106e04,%edx
8010412e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104131:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104133:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
80104137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010413a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010413d:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104140:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104143:	8b 40 1c             	mov    0x1c(%eax),%eax
80104146:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010414d:	00 
8010414e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104155:	00 
80104156:	89 04 24             	mov    %eax,(%esp)
80104159:	e8 d8 16 00 00       	call   80105836 <memset>
  p->context->eip = (uint)forkret;
8010415e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104161:	8b 40 1c             	mov    0x1c(%eax),%eax
80104164:	ba d5 52 10 80       	mov    $0x801052d5,%edx
80104169:	89 50 10             	mov    %edx,0x10(%eax)
  p->is_thread = 0;
8010416c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010416f:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
  p->thread_joined = -1;
80104176:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104179:	c7 80 80 00 00 00 ff 	movl   $0xffffffff,0x80(%eax)
80104180:	ff ff ff 
  return p;
...
8010418b:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
8010418e:	e8 dc fe ff ff       	call   8010406f <allocproc>
80104193:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
80104196:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104199:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  if((p->pgdir = setupkvm(kalloc)) == 0)
8010419e:	c7 04 24 ff 2a 10 80 	movl   $0x80102aff,(%esp)
801041a5:	e8 57 43 00 00       	call   80108501 <setupkvm>
801041aa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041ad:	89 42 04             	mov    %eax,0x4(%edx)
801041b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041b3:	8b 40 04             	mov    0x4(%eax),%eax
801041b6:	85 c0                	test   %eax,%eax
801041b8:	75 0c                	jne    801041c6 <userinit+0x3e>
    panic("userinit: out of memory?");
801041ba:	c7 04 24 3b 90 10 80 	movl   $0x8010903b,(%esp)
801041c1:	e8 77 c3 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801041c6:	ba 2c 00 00 00       	mov    $0x2c,%edx
801041cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041ce:	8b 40 04             	mov    0x4(%eax),%eax
801041d1:	89 54 24 08          	mov    %edx,0x8(%esp)
801041d5:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
801041dc:	80 
801041dd:	89 04 24             	mov    %eax,(%esp)
801041e0:	e8 74 45 00 00       	call   80108759 <inituvm>
  p->sz = PGSIZE;
801041e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041e8:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
801041ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041f1:	8b 40 18             	mov    0x18(%eax),%eax
801041f4:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
801041fb:	00 
801041fc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104203:	00 
80104204:	89 04 24             	mov    %eax,(%esp)
80104207:	e8 2a 16 00 00       	call   80105836 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010420c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010420f:	8b 40 18             	mov    0x18(%eax),%eax
80104212:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104218:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010421b:	8b 40 18             	mov    0x18(%eax),%eax
8010421e:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
...
80104234:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104238:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010423b:	8b 40 18             	mov    0x18(%eax),%eax
8010423e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104241:	8b 52 18             	mov    0x18(%edx),%edx
80104244:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104248:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010424c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010424f:	8b 40 18             	mov    0x18(%eax),%eax
80104252:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80104259:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010425c:	8b 40 18             	mov    0x18(%eax),%eax
8010425f:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104266:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104269:	8b 40 18             	mov    0x18(%eax),%eax
8010426c:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104273:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104276:	83 c0 6c             	add    $0x6c,%eax
80104279:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104280:	00 
80104281:	c7 44 24 04 54 90 10 	movl   $0x80109054,0x4(%esp)
80104288:	80 
80104289:	89 04 24             	mov    %eax,(%esp)
8010428c:	e8 d5 17 00 00       	call   80105a66 <safestrcpy>
  p->cwd = namei("/");
80104291:	c7 04 24 5d 90 10 80 	movl   $0x8010905d,(%esp)
80104298:	e8 6d e1 ff ff       	call   8010240a <namei>
8010429d:	8b 55 f4             	mov    -0xc(%ebp),%edx
801042a0:	89 42 68             	mov    %eax,0x68(%edx)
...
801042af <is_last_thread>:
 * check if this thread is the last thread
 * don't count itself
 * return 0 if it is the last thread
 */
int
...
801042b2:	83 ec 10             	sub    $0x10,%esp
  ...
  int thread_alive;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042b5:	c7 45 fc b4 2f 11 80 	movl   $0x80112fb4,-0x4(%ebp)
801042bc:	eb 2f                	jmp    801042ed <is_last_thread+0x3e>
    if(p->parent->pid == key && p->is_thread == 1){//fount a thread brother 
801042be:	8b 45 fc             	mov    -0x4(%ebp),%eax
801042c1:	8b 40 14             	mov    0x14(%eax),%eax
801042c4:	8b 40 10             	mov    0x10(%eax),%eax
801042c7:	3b 45 08             	cmp    0x8(%ebp),%eax
801042ca:	75 1a                	jne    801042e6 <is_last_thread+0x37>
801042cc:	8b 45 fc             	mov    -0x4(%ebp),%eax
801042cf:	8b 40 7c             	mov    0x7c(%eax),%eax
801042d2:	83 f8 01             	cmp    $0x1,%eax
801042d5:	75 0f                	jne    801042e6 <is_last_thread+0x37>
      if(p->state != ZOMBIE){
801042d7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801042da:	8b 40 0c             	mov    0xc(%eax),%eax
801042dd:	83 f8 05             	cmp    $0x5,%eax
801042e0:	74 04                	je     801042e6 <is_last_thread+0x37>
	thread_alive++;
801042e2:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
int
is_last_thread(int key){
  //acquire(&ptable.lock);
  struct proc* p;
  int thread_alive;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042e6:	81 45 fc 90 00 00 00 	addl   $0x90,-0x4(%ebp)
801042ed:	81 7d fc b4 53 11 80 	cmpl   $0x801153b4,-0x4(%ebp)
801042f4:	72 c8                	jb     801042be <is_last_thread+0xf>
	thread_alive++;
      }
    }  
  //release(&ptable.lock)
  ...
  return thread_alive;
801042f6:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
801042f9:	c9                   	leave  
801042fa:	c3                   	ret    
...
80104309:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
8010430c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104310:	7e 34                	jle    80104346 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104312:	8b 45 08             	mov    0x8(%ebp),%eax
80104315:	89 c2                	mov    %eax,%edx
80104317:	03 55 f4             	add    -0xc(%ebp),%edx
8010431a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104320:	8b 40 04             	mov    0x4(%eax),%eax
80104323:	89 54 24 08          	mov    %edx,0x8(%esp)
80104327:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010432a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010432e:	89 04 24             	mov    %eax,(%esp)
80104331:	e8 9d 45 00 00       	call   801088d3 <allocuvm>
80104336:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104339:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010433d:	75 41                	jne    80104380 <growproc+0x85>
      return -1;
8010433f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104344:	eb 58                	jmp    8010439e <growproc+0xa3>
  } else if(n < 0){
80104346:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010434a:	79 34                	jns    80104380 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
8010434c:	8b 45 08             	mov    0x8(%ebp),%eax
8010434f:	89 c2                	mov    %eax,%edx
80104351:	03 55 f4             	add    -0xc(%ebp),%edx
80104354:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010435a:	8b 40 04             	mov    0x4(%eax),%eax
8010435d:	89 54 24 08          	mov    %edx,0x8(%esp)
80104361:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104364:	89 54 24 04          	mov    %edx,0x4(%esp)
80104368:	89 04 24             	mov    %eax,(%esp)
8010436b:	e8 3d 46 00 00       	call   801089ad <deallocuvm>
80104370:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104373:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104377:	75 07                	jne    80104380 <growproc+0x85>
      return -1;
80104379:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010437e:	eb 1e                	jmp    8010439e <growproc+0xa3>
  }
  proc->sz = sz;
80104380:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104386:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104389:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
8010438b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104391:	89 04 24             	mov    %eax,(%esp)
80104394:	e8 59 42 00 00       	call   801085f2 <switchuvm>
  return 0;
...
801043a6:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
801043a9:	e8 c1 fc ff ff       	call   8010406f <allocproc>
801043ae:	89 45 e0             	mov    %eax,-0x20(%ebp)
801043b1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801043b5:	75 0a                	jne    801043c1 <fork+0x21>
    return -1;
801043b7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043bc:	e9 3a 01 00 00       	jmp    801044fb <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
801043c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043c7:	8b 10                	mov    (%eax),%edx
...
801043d9:	e8 5f 47 00 00       	call   80108b3d <copyuvm>
801043de:	8b 55 e0             	mov    -0x20(%ebp),%edx
801043e1:	89 42 04             	mov    %eax,0x4(%edx)
801043e4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043e7:	8b 40 04             	mov    0x4(%eax),%eax
801043ea:	85 c0                	test   %eax,%eax
801043ec:	75 2c                	jne    8010441a <fork+0x7a>
    kfree(np->kstack);
801043ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043f1:	8b 40 08             	mov    0x8(%eax),%eax
801043f4:	89 04 24             	mov    %eax,(%esp)
801043f7:	e8 6a e6 ff ff       	call   80102a66 <kfree>
    np->kstack = 0;
801043fc:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043ff:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
...
80104415:	e9 e1 00 00 00       	jmp    801044fb <fork+0x15b>
  }
  np->sz = proc->sz;
8010441a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104420:	8b 10                	mov    (%eax),%edx
80104422:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104425:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104427:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010442e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104431:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80104434:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104437:	8b 50 18             	mov    0x18(%eax),%edx
8010443a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104440:	8b 40 18             	mov    0x18(%eax),%eax
80104443:	89 c3                	mov    %eax,%ebx
80104445:	b8 13 00 00 00       	mov    $0x13,%eax
8010444a:	89 d7                	mov    %edx,%edi
8010444c:	89 de                	mov    %ebx,%esi
8010444e:	89 c1                	mov    %eax,%ecx
80104450:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80104452:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104455:	8b 40 18             	mov    0x18(%eax),%eax
80104458:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
8010445f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104466:	eb 3d                	jmp    801044a5 <fork+0x105>
    if(proc->ofile[i])
80104468:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010446e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104471:	83 c2 08             	add    $0x8,%edx
80104474:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104478:	85 c0                	test   %eax,%eax
8010447a:	74 25                	je     801044a1 <fork+0x101>
...
8010448f:	e8 e8 ca ff ff       	call   80100f7c <filedup>
80104494:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104497:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010449a:	83 c1 08             	add    $0x8,%ecx
8010449d:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801044a1:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801044a5:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801044a9:	7e bd                	jle    80104468 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
801044b7:	e8 7a d3 ff ff       	call   80101836 <idup>
801044bc:	8b 55 e0             	mov    -0x20(%ebp),%edx
801044bf:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
801044c2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801044c5:	8b 40 10             	mov    0x10(%eax),%eax
801044c8:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
...
801044f3:	e8 6e 15 00 00       	call   80105a66 <safestrcpy>
  return pid;
801044f8:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801044fb:	83 c4 2c             	add    $0x2c,%esp
801044fe:	5b                   	pop    %ebx
801044ff:	5e                   	pop    %esi
80104500:	5f                   	pop    %edi
80104501:	5d                   	pop    %ebp
...
80104509:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010450c:	e8 5e fb ff ff       	call   8010406f <allocproc>
80104511:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104514:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104518:	75 0a                	jne    80104524 <thread_create+0x21>
    return -1;
8010451a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010451f:	e9 77 02 00 00       	jmp    8010479b <thread_create+0x298>
  
  
  if(proc->is_thread==0){//a procces creating a thread
80104524:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010452a:	8b 40 7c             	mov    0x7c(%eax),%eax
8010452d:	85 c0                	test   %eax,%eax
8010452f:	0f 85 2b 01 00 00    	jne    80104660 <thread_create+0x15d>
    // Copy process state from p. 
    if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){//pgdir from father
80104535:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010453b:	8b 10                	mov    (%eax),%edx
8010453d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104543:	8b 40 04             	mov    0x4(%eax),%eax
80104546:	89 54 24 04          	mov    %edx,0x4(%esp)
8010454a:	89 04 24             	mov    %eax,(%esp)
8010454d:	e8 eb 45 00 00       	call   80108b3d <copyuvm>
80104552:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104555:	89 42 04             	mov    %eax,0x4(%edx)
80104558:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010455b:	8b 40 04             	mov    0x4(%eax),%eax
8010455e:	85 c0                	test   %eax,%eax
80104560:	75 2c                	jne    8010458e <thread_create+0x8b>
    //if((np->pgdir = proc->pgdir) == 0){
      kfree(np->kstack);
80104562:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104565:	8b 40 08             	mov    0x8(%eax),%eax
80104568:	89 04 24             	mov    %eax,(%esp)
8010456b:	e8 f6 e4 ff ff       	call   80102a66 <kfree>
      np->kstack = 0;//from function
80104570:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104573:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
      np->state = UNUSED;
...
80104589:	e9 0d 02 00 00       	jmp    8010479b <thread_create+0x298>
    }
    //np->kstack = stack;
    np->is_thread = 1;
8010458e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104591:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
//     if(proc->pid == 3){
//     cprintf("proc->sz %d\n",proc->sz); 
//     }
    np->sz = proc->sz;//third rgument
80104598:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010459e:	8b 10                	mov    (%eax),%edx
...
801045a5:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801045ac:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045af:	89 50 14             	mov    %edx,0x14(%eax)
    //}else{
...
801045b5:	8b 50 18             	mov    0x18(%eax),%edx
801045b8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045be:	8b 40 18             	mov    0x18(%eax),%eax
801045c1:	89 c3                	mov    %eax,%ebx
801045c3:	b8 13 00 00 00       	mov    $0x13,%eax
801045c8:	89 d7                	mov    %edx,%edi
801045ca:	89 de                	mov    %ebx,%esi
801045cc:	89 c1                	mov    %eax,%ecx
801045ce:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    np->tf->esp = (uint)stack+stack_size;
801045d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045d3:	8b 40 18             	mov    0x18(%eax),%eax
801045d6:	8b 55 0c             	mov    0xc(%ebp),%edx
801045d9:	03 55 10             	add    0x10(%ebp),%edx
801045dc:	89 50 44             	mov    %edx,0x44(%eax)
...
801045e8:	89 50 38             	mov    %edx,0x38(%eax)
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
801045eb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045ee:	8b 40 18             	mov    0x18(%eax),%eax
801045f1:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
    
    for(i = 0; i < NOFILE; i++){
801045f8:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801045ff:	eb 3d                	jmp    8010463e <thread_create+0x13b>
	if(proc->ofile[i]){
80104601:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104607:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010460a:	83 c2 08             	add    $0x8,%edx
8010460d:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104611:	85 c0                	test   %eax,%eax
80104613:	74 25                	je     8010463a <thread_create+0x137>
	  np->ofile[i] = filedup(proc->ofile[i]);//dup-> [i]
80104615:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010461b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010461e:	83 c2 08             	add    $0x8,%edx
80104621:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104625:	89 04 24             	mov    %eax,(%esp)
80104628:	e8 4f c9 ff ff       	call   80100f7c <filedup>
8010462d:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104630:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104633:	83 c1 08             	add    $0x8,%ecx
80104636:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
    np->tf->esp = (uint)stack+stack_size;
    np->tf->eip = (uint)start_func;
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
    ...
    for(i = 0; i < NOFILE; i++){
8010463a:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010463e:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104642:	7e bd                	jle    80104601 <thread_create+0xfe>
	if(proc->ofile[i]){
	  np->ofile[i] = filedup(proc->ofile[i]);//dup-> [i]
...
8010464a:	8b 40 68             	mov    0x68(%eax),%eax
8010464d:	89 04 24             	mov    %eax,(%esp)
80104650:	e8 e1 d1 ff ff       	call   80101836 <idup>
80104655:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104658:	89 42 68             	mov    %eax,0x68(%edx)
8010465b:	e9 02 01 00 00       	jmp    80104762 <thread_create+0x25f>
      //tid->join
  }
...
801046a0:	e9 f6 00 00 00       	jmp    8010479b <thread_create+0x298>
    }
   // np->kstack = stack;
    np->is_thread = 1;
801046a5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046a8:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
//     if(proc->pid == 3){
//     cprintf("proc->sz %d\n",proc->sz); 
//     }
   // np->sz = proc->sz;//third rgument
...
801046da:	b8 13 00 00 00       	mov    $0x13,%eax
801046df:	89 d7                	mov    %edx,%edi
801046e1:	89 de                	mov    %ebx,%esi
801046e3:	89 c1                	mov    %eax,%ecx
801046e5:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    np->tf->esp = (uint)stack+stack_size;
801046e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046ea:	8b 40 18             	mov    0x18(%eax),%eax
801046ed:	8b 55 0c             	mov    0xc(%ebp),%edx
801046f0:	03 55 10             	add    0x10(%ebp),%edx
801046f3:	89 50 44             	mov    %edx,0x44(%eax)
    np->tf->eip = (uint)start_func;
801046f6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046f9:	8b 40 18             	mov    0x18(%eax),%eax
801046fc:	8b 55 08             	mov    0x8(%ebp),%edx
801046ff:	89 50 38             	mov    %edx,0x38(%eax)
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
80104702:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104705:	8b 40 18             	mov    0x18(%eax),%eax
80104708:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
    
    //pss te file decriptor 
    for(i = 0; i < NOFILE; i++)
8010470f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104716:	eb 35                	jmp    8010474d <thread_create+0x24a>
      if(proc->ofile[i])
80104718:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010471e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104721:	83 c2 08             	add    $0x8,%edx
80104724:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104728:	85 c0                	test   %eax,%eax
8010472a:	74 1d                	je     80104749 <thread_create+0x246>
	np->ofile[i] = proc->ofile[i];
8010472c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104732:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104735:	83 c2 08             	add    $0x8,%edx
80104738:	8b 54 90 08          	mov    0x8(%eax,%edx,4),%edx
8010473c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010473f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104742:	83 c1 08             	add    $0x8,%ecx
80104745:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
    np->tf->eip = (uint)start_func;
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
    ...
    //pss te file decriptor 
    for(i = 0; i < NOFILE; i++)
80104749:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010474d:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104751:	7e c5                	jle    80104718 <thread_create+0x215>
      if(proc->ofile[i])
	np->ofile[i] = proc->ofile[i];
	//np->ofile[i] = filedup(proc->ofile[i]);//dup-> [i]
      //np->cwd = idup(proc->cwd);//no dup
...
80104759:	8b 50 68             	mov    0x68(%eax),%edx
8010475c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010475f:	89 50 68             	mov    %edx,0x68(%eax)
    
  }
  pid = np->pid;
80104762:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104765:	8b 40 10             	mov    0x10(%eax),%eax
80104768:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
...
80104793:	e8 ce 12 00 00       	call   80105a66 <safestrcpy>
  return pid; 
80104798:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
8010479b:	83 c4 2c             	add    $0x2c,%esp
8010479e:	5b                   	pop    %ebx
8010479f:	5e                   	pop    %esi
801047a0:	5f                   	pop    %edi
801047a1:	5d                   	pop    %ebp
...
801047ba:	8b 40 7c             	mov    0x7c(%eax),%eax
801047bd:	85 c0                	test   %eax,%eax
801047bf:	75 0b                	jne    801047cc <thread_getProcId+0x1b>
    return proc->pid;
801047c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047c7:	8b 40 10             	mov    0x10(%eax),%eax
801047ca:	eb 0c                	jmp    801047d8 <thread_getProcId+0x27>
  //else
  return proc->parent->pid;
801047cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047d2:	8b 40 14             	mov    0x14(%eax),%eax
801047d5:	8b 40 10             	mov    0x10(%eax),%eax
}
801047d8:	5d                   	pop    %ebp
801047d9:	c3                   	ret    

801047da <thread_join>:
...
801047e9:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  
  acquire(&ptable.lock);
801047ef:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801047f6:	e8 ec 0d 00 00       	call   801055e7 <acquire>
  for(;;){
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047fb:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104802:	e9 76 01 00 00       	jmp    8010497d <thread_join+0x1a3>
      if(p->thread_joined == thread_id){ //thread already joined by other thread
80104807:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010480a:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104810:	3b 45 08             	cmp    0x8(%ebp),%eax
80104813:	75 2c                	jne    80104841 <thread_join+0x67>
...
8010481f:	c7 04 24 60 90 10 80 	movl   $0x80109060,(%esp)
80104826:	e8 76 bb ff ff       	call   801003a1 <cprintf>
	  release(&ptable.lock);
8010482b:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104832:	e8 12 0e 00 00       	call   80105649 <release>
	  return -2;
80104837:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
8010483c:	e9 70 01 00 00       	jmp    801049b1 <thread_join+0x1d7>
	}
...
80104847:	3b 45 08             	cmp    0x8(%ebp),%eax
8010484a:	0f 85 26 01 00 00    	jne    80104976 <thread_join+0x19c>
	  if(p->state == ZOMBIE){// thread to joined already terminated(ZOMBIE)
80104850:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104853:	8b 40 0c             	mov    0xc(%eax),%eax
80104856:	83 f8 05             	cmp    $0x5,%eax
80104859:	0f 85 90 00 00 00    	jne    801048ef <thread_join+0x115>
	      // Found the thread we were looking for.
	    (*ret_val) = (void*)p->tf->eax; 
8010485f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104862:	8b 40 18             	mov    0x18(%eax),%eax
80104865:	8b 40 1c             	mov    0x1c(%eax),%eax
80104868:	89 c2                	mov    %eax,%edx
8010486a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010486d:	89 10                	mov    %edx,(%eax)
...
801048b7:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
	    p->parent = 0;
801048be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048c1:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
	    p->name[0] = 0;
801048c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048cb:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
	    p->killed = 0;
801048cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d2:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
	    release(&ptable.lock);
801048d9:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801048e0:	e8 64 0d 00 00       	call   80105649 <release>
	    return 0;
801048e5:	b8 00 00 00 00       	mov    $0x0,%eax
801048ea:	e9 c2 00 00 00       	jmp    801049b1 <thread_join+0x1d7>
	  }
...
801048f5:	3b 45 08             	cmp    0x8(%ebp),%eax
801048f8:	75 39                	jne    80104933 <thread_join+0x159>
801048fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048fd:	8b 50 14             	mov    0x14(%eax),%edx
80104900:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104906:	39 c2                	cmp    %eax,%edx
80104908:	74 29                	je     80104933 <thread_join+0x159>
	    release(&ptable.lock);
8010490a:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104911:	e8 33 0d 00 00       	call   80105649 <release>
	    cprintf("we tried to join thread %d was which had different parent", p->pid);
80104916:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104919:	8b 40 10             	mov    0x10(%eax),%eax
8010491c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104920:	c7 04 24 a0 90 10 80 	movl   $0x801090a0,(%esp)
80104927:	e8 75 ba ff ff       	call   801003a1 <cprintf>
	    return -1;
8010492c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104931:	eb 7e                	jmp    801049b1 <thread_join+0x1d7>
	  }
	  if(p->pid == thread_id){ // found a thread to join
80104933:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104936:	8b 40 10             	mov    0x10(%eax),%eax
80104939:	3b 45 08             	cmp    0x8(%ebp),%eax
8010493c:	75 38                	jne    80104976 <thread_join+0x19c>
	   (*ret_val) = (void*)p->tf->eax; 
8010493e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104941:	8b 40 18             	mov    0x18(%eax),%eax
80104944:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104954:	8b 50 10             	mov    0x10(%eax),%edx
...
80104966:	c7 44 24 04 80 2f 11 	movl   $0x80112f80,0x4(%esp)
8010496d:	80 
8010496e:	89 04 24             	mov    %eax,(%esp)
80104971:	e8 8b 09 00 00       	call   80105301 <sleep>
  struct proc *p;
  proc->thread_joined = thread_id;
  ...
  for(;;){
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104976:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
8010497d:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104984:	0f 82 7d fe ff ff    	jb     80104807 <thread_join+0x2d>
	    p->thread_joined = proc->pid;
	   sleep(proc, &ptable.lock);  //DOC: wait-sleep
	  }
	}
...
8010498d:	8b 40 10             	mov    0x10(%eax),%eax
80104990:	89 44 24 04          	mov    %eax,0x4(%esp)
80104994:	c7 04 24 dc 90 10 80 	movl   $0x801090dc,(%esp)
8010499b:	e8 01 ba ff ff       	call   801003a1 <cprintf>
    release(&ptable.lock);   
801049a0:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801049a7:	e8 9d 0c 00 00       	call   80105649 <release>
      return -1;
...
801049bf:	8b 40 7c             	mov    0x7c(%eax),%eax
801049c2:	83 f8 01             	cmp    $0x1,%eax
801049c5:	0f 85 7f 01 00 00    	jne    80104b4a <thread_exit+0x197>
    struct proc *p;
    int fd;

    if(proc == initproc)
801049cb:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801049d2:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801049d7:	39 c2                	cmp    %eax,%edx
801049d9:	75 0c                	jne    801049e7 <thread_exit+0x34>
      panic("init exiting");
801049db:	c7 04 24 0c 91 10 80 	movl   $0x8010910c,(%esp)
801049e2:	e8 56 bb ff ff       	call   8010053d <panic>
...
801049f6:	e8 b4 f8 ff ff       	call   801042af <is_last_thread>
801049fb:	85 c0                	test   %eax,%eax
801049fd:	74 53                	je     80104a52 <thread_exit+0x9f>
      // Close all open files.
      for(fd = 0; fd < NOFILE; fd++){
801049ff:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104a06:	eb 44                	jmp    80104a4c <thread_exit+0x99>
	if(proc->ofile[fd]){
80104a08:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a0e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a11:	83 c2 08             	add    $0x8,%edx
80104a14:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104a18:	85 c0                	test   %eax,%eax
80104a1a:	74 2c                	je     80104a48 <thread_exit+0x95>
...
80104a2f:	e8 90 c5 ff ff       	call   80100fc4 <fileclose>
	  proc->ofile[fd] = 0;
80104a34:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a3a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a3d:	83 c2 08             	add    $0x8,%edx
80104a40:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104a47:	00 
    if(proc == initproc)
      panic("init exiting");
     ...
     if(is_last_thread(proc->parent->pid)){//is this the last thread
      // Close all open files.
      for(fd = 0; fd < NOFILE; fd++){
80104a48:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104a4c:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104a50:	7e b6                	jle    80104a08 <thread_exit+0x55>
	  proc->ofile[fd] = 0;
	}
      }
    }
...
80104a58:	8b 40 68             	mov    0x68(%eax),%eax
80104a5b:	89 04 24             	mov    %eax,(%esp)
80104a5e:	e8 b8 cf ff ff       	call   80101a1b <iput>
    proc->cwd = 0;
80104a63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a69:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

    acquire(&ptable.lock);
80104a70:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104a77:	e8 6b 0b 00 00       	call   801055e7 <acquire>

    // Parent might be sleeping in wait().
    wakeup1(proc->parent);
80104a7c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a82:	8b 40 14             	mov    0x14(%eax),%eax
80104a85:	89 04 24             	mov    %eax,(%esp)
80104a88:	e8 0f 09 00 00       	call   8010539c <wakeup1>
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a8d:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104a94:	e9 86 00 00 00       	jmp    80104b1f <thread_exit+0x16c>
      //wake thread_join
      if(proc->thread_joined == p->pid && ret_val != 0){
80104a99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a9f:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104aa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aa8:	8b 40 10             	mov    0x10(%eax),%eax
80104aab:	39 c2                	cmp    %eax,%edx
80104aad:	75 1f                	jne    80104ace <thread_exit+0x11b>
80104aaf:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104ab3:	74 19                	je     80104ace <thread_exit+0x11b>
	ret_val = (void*)p->tf->eax;
80104ab5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ab8:	8b 40 18             	mov    0x18(%eax),%eax
80104abb:	8b 40 1c             	mov    0x1c(%eax),%eax
80104abe:	89 45 08             	mov    %eax,0x8(%ebp)
	wakeup1(p);
80104ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ac4:	89 04 24             	mov    %eax,(%esp)
80104ac7:	e8 d0 08 00 00       	call   8010539c <wakeup1>
80104acc:	eb 4a                	jmp    80104b18 <thread_exit+0x165>
      }
...
80104add:	8b 40 10             	mov    0x10(%eax),%eax
80104ae0:	39 c2                	cmp    %eax,%edx
80104ae2:	75 34                	jne    80104b18 <thread_exit+0x165>
80104ae4:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104ae8:	75 2e                	jne    80104b18 <thread_exit+0x165>
...
80104aed:	8b 50 10             	mov    0x10(%eax),%edx
80104af0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104af6:	8b 40 10             	mov    0x10(%eax),%eax
80104af9:	89 54 24 08          	mov    %edx,0x8(%esp)
80104afd:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b01:	c7 04 24 1c 91 10 80 	movl   $0x8010911c,(%esp)
80104b08:	e8 94 b8 ff ff       	call   801003a1 <cprintf>
	wakeup1(p);
80104b0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b10:	89 04 24             	mov    %eax,(%esp)
80104b13:	e8 84 08 00 00       	call   8010539c <wakeup1>
    ...
    // Pass abandoned children to init.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b18:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104b1f:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104b26:	0f 82 6d ff ff ff    	jb     80104a99 <thread_exit+0xe6>
	cprintf("we exitd thread: %d and waked thread %d but we didnt had any ret_val",proc->pid,p->pid); 
	wakeup1(p);
      }
    }
...
80104b32:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    sched();
80104b39:	e8 b3 06 00 00       	call   801051f1 <sched>
    panic("zombie exit");
80104b3e:	c7 04 24 61 91 10 80 	movl   $0x80109161,(%esp)
80104b45:	e8 f3 b9 ff ff       	call   8010053d <panic>
  }
  else{
...
80104b57:	c7 04 24 70 91 10 80 	movl   $0x80109170,(%esp)
80104b5e:	e8 3e b8 ff ff       	call   801003a1 <cprintf>
  }
}
80104b63:	c9                   	leave  
80104b64:	c3                   	ret    

80104b65 <binary_semaphore_create>:
//TODO cehck stuff
int binary_semaphore_create(int initial_value){
80104b65:	55                   	push   %ebp
80104b66:	89 e5                	mov    %esp,%ebp
80104b68:	83 ec 28             	sub    $0x28,%esp
  acquire(&sem_table.lock);
80104b6b:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104b72:	e8 70 0a 00 00       	call   801055e7 <acquire>
  //TODO acquire semaphore (just maybe)
  int ret_semaphore = sem_table.next_sem;
80104b77:	a1 74 0f 11 80       	mov    0x80110f74,%eax
80104b7c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  sem_table.semaphore[ret_semaphore].value = initial_value;
80104b7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b82:	c1 e0 06             	shl    $0x6,%eax
80104b85:	8d 90 a0 0f 11 80    	lea    -0x7feef060(%eax),%edx
80104b8b:	8b 45 08             	mov    0x8(%ebp),%eax
80104b8e:	89 42 0c             	mov    %eax,0xc(%edx)
  sem_table.semaphore[ret_semaphore].initialize = 1;
80104b91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b94:	c1 e0 06             	shl    $0x6,%eax
80104b97:	05 a0 0f 11 80       	add    $0x80110fa0,%eax
80104b9c:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)
  sem_table.semaphore[ret_semaphore].queue =0;
80104ba3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ba6:	c1 e0 06             	shl    $0x6,%eax
80104ba9:	05 a0 0f 11 80       	add    $0x80110fa0,%eax
80104bae:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  sem_table.next_sem++;
80104bb5:	a1 74 0f 11 80       	mov    0x80110f74,%eax
80104bba:	83 c0 01             	add    $0x1,%eax
80104bbd:	a3 74 0f 11 80       	mov    %eax,0x80110f74
  release(&sem_table.lock);
80104bc2:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104bc9:	e8 7b 0a 00 00       	call   80105649 <release>
...
80104bd3 <binary_semaphore_down>:
...
80104bd6:	83 ec 68             	sub    $0x68,%esp
  int ans = 0;
80104bd9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  //acuire the semaphore
  acquire(&sem_table.lock);
80104be0:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104be7:	e8 fb 09 00 00       	call   801055e7 <acquire>
  struct semaphore sem;
  acquire(&sem_table.semaphore[binary_semaphore_ID].lock);
80104bec:	8b 45 08             	mov    0x8(%ebp),%eax
80104bef:	c1 e0 06             	shl    $0x6,%eax
80104bf2:	83 c0 30             	add    $0x30,%eax
80104bf5:	05 40 0f 11 80       	add    $0x80110f40,%eax
80104bfa:	83 c0 08             	add    $0x8,%eax
80104bfd:	89 04 24             	mov    %eax,(%esp)
80104c00:	e8 e2 09 00 00       	call   801055e7 <acquire>
  sem = sem_table.semaphore[binary_semaphore_ID];
80104c05:	8b 45 08             	mov    0x8(%ebp),%eax
80104c08:	c1 e0 06             	shl    $0x6,%eax
80104c0b:	05 70 0f 11 80       	add    $0x80110f70,%eax
80104c10:	8b 50 08             	mov    0x8(%eax),%edx
80104c13:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80104c16:	8b 50 0c             	mov    0xc(%eax),%edx
80104c19:	89 55 b8             	mov    %edx,-0x48(%ebp)
80104c1c:	8b 50 10             	mov    0x10(%eax),%edx
80104c1f:	89 55 bc             	mov    %edx,-0x44(%ebp)
80104c22:	8b 50 14             	mov    0x14(%eax),%edx
80104c25:	89 55 c0             	mov    %edx,-0x40(%ebp)
80104c28:	8b 50 18             	mov    0x18(%eax),%edx
80104c2b:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104c2e:	8b 50 1c             	mov    0x1c(%eax),%edx
80104c31:	89 55 c8             	mov    %edx,-0x38(%ebp)
80104c34:	8b 50 20             	mov    0x20(%eax),%edx
80104c37:	89 55 cc             	mov    %edx,-0x34(%ebp)
80104c3a:	8b 50 24             	mov    0x24(%eax),%edx
80104c3d:	89 55 d0             	mov    %edx,-0x30(%ebp)
80104c40:	8b 50 28             	mov    0x28(%eax),%edx
80104c43:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104c46:	8b 50 2c             	mov    0x2c(%eax),%edx
80104c49:	89 55 d8             	mov    %edx,-0x28(%ebp)
80104c4c:	8b 50 30             	mov    0x30(%eax),%edx
80104c4f:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104c52:	8b 50 34             	mov    0x34(%eax),%edx
80104c55:	89 55 e0             	mov    %edx,-0x20(%ebp)
80104c58:	8b 50 38             	mov    0x38(%eax),%edx
80104c5b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104c5e:	8b 50 3c             	mov    0x3c(%eax),%edx
80104c61:	89 55 e8             	mov    %edx,-0x18(%ebp)
80104c64:	8b 50 40             	mov    0x40(%eax),%edx
80104c67:	89 55 ec             	mov    %edx,-0x14(%ebp)
80104c6a:	8b 40 44             	mov    0x44(%eax),%eax
80104c6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  release(&sem_table.lock);
80104c70:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104c77:	e8 cd 09 00 00       	call   80105649 <release>
  //cehck the resource & semaphore
  if(sem.initialize ==0){
80104c7c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c7f:	85 c0                	test   %eax,%eax
80104c81:	75 1a                	jne    80104c9d <binary_semaphore_down+0xca>
...
80104c8a:	c7 04 24 a8 91 10 80 	movl   $0x801091a8,(%esp)
80104c91:	e8 0b b7 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104c96:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }
  
  //do down
  if(sem.value <=0){//the process is blocked
80104c9d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104ca0:	85 c0                	test   %eax,%eax
80104ca2:	7f 3e                	jg     80104ce2 <binary_semaphore_down+0x10f>
    proc->wait_for_sem = binary_semaphore_ID;  
80104ca4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104caa:	8b 55 08             	mov    0x8(%ebp),%edx
80104cad:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    sem.queue++; 
...
80104cc2:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104cc5:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
    sleep(proc, &sem.lock);
80104ccb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cd1:	8d 55 b4             	lea    -0x4c(%ebp),%edx
80104cd4:	89 54 24 04          	mov    %edx,0x4(%esp)
80104cd8:	89 04 24             	mov    %eax,(%esp)
80104cdb:	e8 21 06 00 00       	call   80105301 <sleep>
80104ce0:	eb 09                	jmp    80104ceb <binary_semaphore_down+0x118>
  }else{
    sem.value--;
80104ce2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104ce5:	83 e8 01             	sub    $0x1,%eax
80104ce8:	89 45 e8             	mov    %eax,-0x18(%ebp)
  }
  release(&sem.lock);
80104ceb:	8d 45 b4             	lea    -0x4c(%ebp),%eax
80104cee:	89 04 24             	mov    %eax,(%esp)
80104cf1:	e8 53 09 00 00       	call   80105649 <release>
  return ans;
...
80104cfe:	83 ec 68             	sub    $0x68,%esp
  int ans = 0;
80104d01:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  struct proc *p;
  struct proc *proc_to_wake;
  //acuire the semaphore
  acquire(&sem_table.lock);
80104d08:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104d0f:	e8 d3 08 00 00       	call   801055e7 <acquire>
  struct semaphore sem;
  acquire(&sem_table.semaphore[binary_semaphore_ID].lock);
80104d14:	8b 45 08             	mov    0x8(%ebp),%eax
80104d17:	c1 e0 06             	shl    $0x6,%eax
80104d1a:	83 c0 30             	add    $0x30,%eax
80104d1d:	05 40 0f 11 80       	add    $0x80110f40,%eax
80104d22:	83 c0 08             	add    $0x8,%eax
80104d25:	89 04 24             	mov    %eax,(%esp)
80104d28:	e8 ba 08 00 00       	call   801055e7 <acquire>
  sem = sem_table.semaphore[binary_semaphore_ID];
80104d2d:	8b 45 08             	mov    0x8(%ebp),%eax
80104d30:	c1 e0 06             	shl    $0x6,%eax
80104d33:	05 70 0f 11 80       	add    $0x80110f70,%eax
80104d38:	8b 50 08             	mov    0x8(%eax),%edx
80104d3b:	89 55 ac             	mov    %edx,-0x54(%ebp)
80104d3e:	8b 50 0c             	mov    0xc(%eax),%edx
80104d41:	89 55 b0             	mov    %edx,-0x50(%ebp)
80104d44:	8b 50 10             	mov    0x10(%eax),%edx
80104d47:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80104d4a:	8b 50 14             	mov    0x14(%eax),%edx
80104d4d:	89 55 b8             	mov    %edx,-0x48(%ebp)
80104d50:	8b 50 18             	mov    0x18(%eax),%edx
80104d53:	89 55 bc             	mov    %edx,-0x44(%ebp)
80104d56:	8b 50 1c             	mov    0x1c(%eax),%edx
80104d59:	89 55 c0             	mov    %edx,-0x40(%ebp)
80104d5c:	8b 50 20             	mov    0x20(%eax),%edx
80104d5f:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104d62:	8b 50 24             	mov    0x24(%eax),%edx
80104d65:	89 55 c8             	mov    %edx,-0x38(%ebp)
80104d68:	8b 50 28             	mov    0x28(%eax),%edx
80104d6b:	89 55 cc             	mov    %edx,-0x34(%ebp)
80104d6e:	8b 50 2c             	mov    0x2c(%eax),%edx
80104d71:	89 55 d0             	mov    %edx,-0x30(%ebp)
80104d74:	8b 50 30             	mov    0x30(%eax),%edx
80104d77:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104d7a:	8b 50 34             	mov    0x34(%eax),%edx
80104d7d:	89 55 d8             	mov    %edx,-0x28(%ebp)
80104d80:	8b 50 38             	mov    0x38(%eax),%edx
80104d83:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104d86:	8b 50 3c             	mov    0x3c(%eax),%edx
80104d89:	89 55 e0             	mov    %edx,-0x20(%ebp)
80104d8c:	8b 50 40             	mov    0x40(%eax),%edx
80104d8f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104d92:	8b 40 44             	mov    0x44(%eax),%eax
80104d95:	89 45 e8             	mov    %eax,-0x18(%ebp)
  release(&sem_table.lock);
80104d98:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104d9f:	e8 a5 08 00 00       	call   80105649 <release>
  
  //cehck the resource & semaphore
  if(sem.initialize ==0){
80104da4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104da7:	85 c0                	test   %eax,%eax
80104da9:	75 1a                	jne    80104dc5 <binary_semaphore_up+0xca>
     cprintf("we are tring to use uninitialize semaphore%d.",binary_semaphore_ID);
80104dab:	8b 45 08             	mov    0x8(%ebp),%eax
80104dae:	89 44 24 04          	mov    %eax,0x4(%esp)
80104db2:	c7 04 24 a8 91 10 80 	movl   $0x801091a8,(%esp)
80104db9:	e8 e3 b5 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104dbe:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }
  if (sem.value <= 0) {
80104dc5:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104dc8:	85 c0                	test   %eax,%eax
80104dca:	7f 1a                	jg     80104de6 <binary_semaphore_up+0xeb>
...
80104dd3:	c7 04 24 d8 91 10 80 	movl   $0x801091d8,(%esp)
80104dda:	e8 c2 b5 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104ddf:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }  
  
  //do up
  if(sem.queue >0){//there are procecse waiting for this semaphore
80104de6:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104de9:	85 c0                	test   %eax,%eax
80104deb:	7e 6a                	jle    80104e57 <binary_semaphore_up+0x15c>
  acquire(&ptable.lock);
80104ded:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104df4:	e8 ee 07 00 00       	call   801055e7 <acquire>
    //find process to wakeup
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104df9:	c7 45 f0 b4 2f 11 80 	movl   $0x80112fb4,-0x10(%ebp)
80104e00:	eb 3e                	jmp    80104e40 <binary_semaphore_up+0x145>
      if(p->wait_for_sem == binary_semaphore_ID){ //this process is waiting for this semaphore
80104e02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e05:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104e0b:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e0e:	75 29                	jne    80104e39 <binary_semaphore_up+0x13e>
	if(p->place_in_queue ==1){
80104e10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e13:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104e19:	83 f8 01             	cmp    $0x1,%eax
80104e1c:	75 06                	jne    80104e24 <binary_semaphore_up+0x129>
	  proc_to_wake = p;
80104e1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e21:	89 45 ec             	mov    %eax,-0x14(%ebp)
	}
	p->place_in_queue=p->place_in_queue-1;//get every process to the next place inline
80104e24:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e27:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104e2d:	8d 50 ff             	lea    -0x1(%eax),%edx
80104e30:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e33:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
  ...
  acquire(&ptable.lock);
    //find process to wakeup
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e39:	81 45 f0 90 00 00 00 	addl   $0x90,-0x10(%ebp)
80104e40:	81 7d f0 b4 53 11 80 	cmpl   $0x801153b4,-0x10(%ebp)
80104e47:	72 b9                	jb     80104e02 <binary_semaphore_up+0x107>
	  proc_to_wake = p;
	}
	p->place_in_queue=p->place_in_queue-1;//get every process to the next place inline
      }
    ...
    release(&ptable.lock);
80104e49:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104e50:	e8 f4 07 00 00       	call   80105649 <release>
80104e55:	eb 09                	jmp    80104e60 <binary_semaphore_up+0x165>
  }else{
  sem.value++;  
80104e57:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104e5a:	83 c0 01             	add    $0x1,%eax
80104e5d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  }
  release(&sem.lock);
80104e60:	8d 45 ac             	lea    -0x54(%ebp),%eax
80104e63:	89 04 24             	mov    %eax,(%esp)
80104e66:	e8 de 07 00 00       	call   80105649 <release>
  //update the awaken proccees
  proc_to_wake->wait_for_sem =-1;//not waitng anymore
80104e6b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e6e:	c7 80 88 00 00 00 ff 	movl   $0xffffffff,0x88(%eax)
80104e75:	ff ff ff 
  wakeup1(proc_to_wake);
80104e78:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e7b:	89 04 24             	mov    %eax,(%esp)
80104e7e:	e8 19 05 00 00       	call   8010539c <wakeup1>
  return ans;
...
80104e95:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104e9a:	39 c2                	cmp    %eax,%edx
80104e9c:	75 0c                	jne    80104eaa <exit+0x22>
    panic("init exiting");
80104e9e:	c7 04 24 0c 91 10 80 	movl   $0x8010910c,(%esp)
80104ea5:	e8 93 b6 ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104eaa:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104eb1:	eb 44                	jmp    80104ef7 <exit+0x6f>
    if(proc->ofile[fd]){
80104eb3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104eb9:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ebc:	83 c2 08             	add    $0x8,%edx
80104ebf:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104ec3:	85 c0                	test   %eax,%eax
80104ec5:	74 2c                	je     80104ef3 <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104ec7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ecd:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ed0:	83 c2 08             	add    $0x8,%edx
80104ed3:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104ed7:	89 04 24             	mov    %eax,(%esp)
80104eda:	e8 e5 c0 ff ff       	call   80100fc4 <fileclose>
      proc->ofile[fd] = 0;
80104edf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ee5:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ee8:	83 c2 08             	add    $0x8,%edx
80104eeb:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104ef2:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104ef3:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104ef7:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104efb:	7e b6                	jle    80104eb3 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
80104f03:	8b 40 68             	mov    0x68(%eax),%eax
80104f06:	89 04 24             	mov    %eax,(%esp)
80104f09:	e8 0d cb ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
80104f0e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f14:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104f1b:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104f22:	e8 c0 06 00 00       	call   801055e7 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104f27:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f2d:	8b 40 14             	mov    0x14(%eax),%eax
80104f30:	89 04 24             	mov    %eax,(%esp)
80104f33:	e8 64 04 00 00       	call   8010539c <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f38:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104f3f:	eb 3b                	jmp    80104f7c <exit+0xf4>
    if(p->parent == proc){
80104f41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f44:	8b 50 14             	mov    0x14(%eax),%edx
80104f47:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f4d:	39 c2                	cmp    %eax,%edx
80104f4f:	75 24                	jne    80104f75 <exit+0xed>
      p->parent = initproc;
80104f51:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
80104f57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f5a:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
80104f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f60:	8b 40 0c             	mov    0xc(%eax),%eax
80104f63:	83 f8 05             	cmp    $0x5,%eax
80104f66:	75 0d                	jne    80104f75 <exit+0xed>
        wakeup1(initproc);
80104f68:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104f6d:	89 04 24             	mov    %eax,(%esp)
80104f70:	e8 27 04 00 00       	call   8010539c <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f75:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104f7c:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104f83:	72 bc                	jb     80104f41 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
80104f8b:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104f92:	e8 5a 02 00 00       	call   801051f1 <sched>
  panic("zombie exit");
80104f97:	c7 04 24 61 91 10 80 	movl   $0x80109161,(%esp)
...
80104fa6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104fa9:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104fb0:	e8 32 06 00 00       	call   801055e7 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104fb5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104fbc:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104fc3:	e9 9d 00 00 00       	jmp    80105065 <wait+0xc2>
      if(p->parent != proc)
80104fc8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fcb:	8b 50 14             	mov    0x14(%eax),%edx
80104fce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fd4:	39 c2                	cmp    %eax,%edx
80104fd6:	0f 85 81 00 00 00    	jne    8010505d <wait+0xba>
        continue;
      havekids = 1;
80104fdc:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104fe3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fe6:	8b 40 0c             	mov    0xc(%eax),%eax
80104fe9:	83 f8 05             	cmp    $0x5,%eax
80104fec:	75 70                	jne    8010505e <wait+0xbb>
	// Found one.
        pid = p->pid;
80104fee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ff1:	8b 40 10             	mov    0x10(%eax),%eax
80104ff4:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80104ff7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ffa:	8b 40 08             	mov    0x8(%eax),%eax
80104ffd:	89 04 24             	mov    %eax,(%esp)
80105000:	e8 61 da ff ff       	call   80102a66 <kfree>
        p->kstack = 0;
...
80105018:	e8 4c 3a 00 00       	call   80108a69 <freevm>
	p->state = UNUSED;
8010501d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105020:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80105027:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010502a:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80105031:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105034:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
8010503b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010503e:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80105042:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105045:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
8010504c:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105053:	e8 f1 05 00 00       	call   80105649 <release>
        return pid;
80105058:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010505b:	eb 56                	jmp    801050b3 <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010505d:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010505e:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80105065:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
8010506c:	0f 82 56 ff ff ff    	jb     80104fc8 <wait+0x25>
        return pid;
      }
...
80105072:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105076:	74 0d                	je     80105085 <wait+0xe2>
80105078:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010507e:	8b 40 24             	mov    0x24(%eax),%eax
80105081:	85 c0                	test   %eax,%eax
80105083:	74 13                	je     80105098 <wait+0xf5>
      release(&ptable.lock);
80105085:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010508c:	e8 b8 05 00 00       	call   80105649 <release>
      return -1;
80105091:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105096:	eb 1b                	jmp    801050b3 <wait+0x110>
    }
    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80105098:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010509e:	c7 44 24 04 80 2f 11 	movl   $0x80112f80,0x4(%esp)
801050a5:	80 
801050a6:	89 04 24             	mov    %eax,(%esp)
801050a9:	e8 53 02 00 00       	call   80105301 <sleep>
  }
801050ae:	e9 02 ff ff ff       	jmp    80104fb5 <wait+0x12>
}
801050b3:	c9                   	leave  
801050b4:	c3                   	ret    

801050b5 <register_handler>:
...
801050b8:	83 ec 28             	sub    $0x28,%esp
  char* addr = uva2ka(proc->pgdir, (char*)proc->tf->esp);
801050bb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050c1:	8b 40 18             	mov    0x18(%eax),%eax
801050c4:	8b 40 44             	mov    0x44(%eax),%eax
801050c7:	89 c2                	mov    %eax,%edx
801050c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050cf:	8b 40 04             	mov    0x4(%eax),%eax
801050d2:	89 54 24 04          	mov    %edx,0x4(%esp)
801050d6:	89 04 24             	mov    %eax,(%esp)
801050d9:	e8 70 3b 00 00       	call   80108c4e <uva2ka>
801050de:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
801050e1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050e7:	8b 40 18             	mov    0x18(%eax),%eax
801050ea:	8b 40 44             	mov    0x44(%eax),%eax
801050ed:	25 ff 0f 00 00       	and    $0xfff,%eax
801050f2:	85 c0                	test   %eax,%eax
801050f4:	75 0c                	jne    80105102 <register_handler+0x4d>
    panic("esp_offset == 0");
801050f6:	c7 04 24 0f 92 10 80 	movl   $0x8010920f,(%esp)
801050fd:	e8 3b b4 ff ff       	call   8010053d <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
80105102:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105108:	8b 40 18             	mov    0x18(%eax),%eax
8010510b:	8b 40 44             	mov    0x44(%eax),%eax
8010510e:	83 e8 04             	sub    $0x4,%eax
80105111:	25 ff 0f 00 00       	and    $0xfff,%eax
80105116:	03 45 f4             	add    -0xc(%ebp),%eax
          = proc->tf->eip;
80105119:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105120:	8b 52 18             	mov    0x18(%edx),%edx
80105123:	8b 52 38             	mov    0x38(%edx),%edx
...
80105138:	8b 52 18             	mov    0x18(%edx),%edx
8010513b:	8b 52 44             	mov    0x44(%edx),%edx
8010513e:	83 ea 04             	sub    $0x4,%edx
80105141:	89 50 44             	mov    %edx,0x44(%eax)
...
80105150:	89 50 38             	mov    %edx,0x38(%eax)
}
80105153:	c9                   	leave  
80105154:	c3                   	ret    
...
80105158:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  
  for(;;){
    // Enable interrupts on this processor.
    sti();
8010515b:	e8 a5 ee ff ff       	call   80104005 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80105160:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105167:	e8 7b 04 00 00       	call   801055e7 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010516c:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80105173:	eb 62                	jmp    801051d7 <scheduler+0x82>
      if(p->state != RUNNABLE)
80105175:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105178:	8b 40 0c             	mov    0xc(%eax),%eax
8010517b:	83 f8 03             	cmp    $0x3,%eax
8010517e:	75 4f                	jne    801051cf <scheduler+0x7a>
        continue;
...
80105183:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80105189:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010518c:	89 04 24             	mov    %eax,(%esp)
8010518f:	e8 5e 34 00 00       	call   801085f2 <switchuvm>
      p->state = RUNNING;
...
801051a4:	8b 40 1c             	mov    0x1c(%eax),%eax
801051a7:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801051ae:	83 c2 04             	add    $0x4,%edx
801051b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801051b5:	89 14 24             	mov    %edx,(%esp)
801051b8:	e8 1f 09 00 00       	call   80105adc <swtch>
      switchkvm();
801051bd:	e8 13 34 00 00       	call   801085d5 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801051c2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801051c9:	00 00 00 00 
801051cd:	eb 01                	jmp    801051d0 <scheduler+0x7b>
...
801051cf:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801051d0:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
801051d7:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
801051de:	72 95                	jb     80105175 <scheduler+0x20>
    ...
    release(&ptable.lock);
801051e0:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801051e7:	e8 5d 04 00 00       	call   80105649 <release>

  }
801051ec:	e9 6a ff ff ff       	jmp    8010515b <scheduler+0x6>
...
801051f4:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
801051f7:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801051fe:	e8 02 05 00 00       	call   80105705 <holding>
80105203:	85 c0                	test   %eax,%eax
80105205:	75 0c                	jne    80105213 <sched+0x22>
    panic("sched ptable.lock");
80105207:	c7 04 24 1f 92 10 80 	movl   $0x8010921f,(%esp)
8010520e:	e8 2a b3 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80105213:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105219:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010521f:	83 f8 01             	cmp    $0x1,%eax
80105222:	74 0c                	je     80105230 <sched+0x3f>
    panic("sched locks");
80105224:	c7 04 24 31 92 10 80 	movl   $0x80109231,(%esp)
8010522b:	e8 0d b3 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80105230:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105236:	8b 40 0c             	mov    0xc(%eax),%eax
80105239:	83 f8 04             	cmp    $0x4,%eax
8010523c:	75 0c                	jne    8010524a <sched+0x59>
    panic("sched running");
8010523e:	c7 04 24 3d 92 10 80 	movl   $0x8010923d,(%esp)
80105245:	e8 f3 b2 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
8010524a:	e8 a1 ed ff ff       	call   80103ff0 <readeflags>
8010524f:	25 00 02 00 00       	and    $0x200,%eax
80105254:	85 c0                	test   %eax,%eax
80105256:	74 0c                	je     80105264 <sched+0x73>
    panic("sched interruptible");
80105258:	c7 04 24 4b 92 10 80 	movl   $0x8010924b,(%esp)
8010525f:	e8 d9 b2 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80105264:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010526a:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105270:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80105273:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105279:	8b 40 04             	mov    0x4(%eax),%eax
8010527c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105283:	83 c2 1c             	add    $0x1c,%edx
80105286:	89 44 24 04          	mov    %eax,0x4(%esp)
8010528a:	89 14 24             	mov    %edx,(%esp)
8010528d:	e8 4a 08 00 00       	call   80105adc <swtch>
  cpu->intena = intena;
80105292:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105298:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010529b:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801052a1:	c9                   	leave  
801052a2:	c3                   	ret    
...
801052a9:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801052b0:	e8 32 03 00 00       	call   801055e7 <acquire>
  proc->state = RUNNABLE;
801052b5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052bb:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801052c2:	e8 2a ff ff ff       	call   801051f1 <sched>
  release(&ptable.lock);
801052c7:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801052ce:	e8 76 03 00 00       	call   80105649 <release>
}
801052d3:	c9                   	leave  
801052d4:	c3                   	ret    
...
801052d8:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801052db:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801052e2:	e8 62 03 00 00       	call   80105649 <release>

  if (first) {
801052e7:	a1 20 c0 10 80       	mov    0x8010c020,%eax
801052ec:	85 c0                	test   %eax,%eax
801052ee:	74 0f                	je     801052ff <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801052f0:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
801052f7:	00 00 00 
    initlog();
801052fa:	e8 11 dd ff ff       	call   80103010 <initlog>
  }
...
80105304:	83 ec 18             	sub    $0x18,%esp

  if(proc == 0)
80105307:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010530d:	85 c0                	test   %eax,%eax
8010530f:	75 0c                	jne    8010531d <sleep+0x1c>
    panic("sleep");
80105311:	c7 04 24 5f 92 10 80 	movl   $0x8010925f,(%esp)
80105318:	e8 20 b2 ff ff       	call   8010053d <panic>

  if(lk == 0)
8010531d:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105321:	75 0c                	jne    8010532f <sleep+0x2e>
    panic("sleep without lk");
80105323:	c7 04 24 65 92 10 80 	movl   $0x80109265,(%esp)
...
8010532f:	81 7d 0c 80 2f 11 80 	cmpl   $0x80112f80,0xc(%ebp)
80105336:	74 17                	je     8010534f <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105338:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010533f:	e8 a3 02 00 00       	call   801055e7 <acquire>
    release(lk);
80105344:	8b 45 0c             	mov    0xc(%ebp),%eax
80105347:	89 04 24             	mov    %eax,(%esp)
8010534a:	e8 fa 02 00 00       	call   80105649 <release>
  }
  // Go to sleep.
  proc->chan = chan;
8010534f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105355:	8b 55 08             	mov    0x8(%ebp),%edx
80105358:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
8010535b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105361:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80105368:	e8 84 fe ff ff       	call   801051f1 <sched>
  // Tidy up.
  proc->chan = 0;
8010536d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105373:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
  
  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
8010537a:	81 7d 0c 80 2f 11 80 	cmpl   $0x80112f80,0xc(%ebp)
80105381:	74 17                	je     8010539a <sleep+0x99>
    release(&ptable.lock);
80105383:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010538a:	e8 ba 02 00 00       	call   80105649 <release>
    acquire(lk);
8010538f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105392:	89 04 24             	mov    %eax,(%esp)
80105395:	e8 4d 02 00 00       	call   801055e7 <acquire>
  }
}
8010539a:	c9                   	leave  
8010539b:	c3                   	ret    
...
8010539f:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801053a2:	c7 45 fc b4 2f 11 80 	movl   $0x80112fb4,-0x4(%ebp)
801053a9:	eb 27                	jmp    801053d2 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
801053ab:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053ae:	8b 40 0c             	mov    0xc(%eax),%eax
801053b1:	83 f8 02             	cmp    $0x2,%eax
801053b4:	75 15                	jne    801053cb <wakeup1+0x2f>
801053b6:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053b9:	8b 40 20             	mov    0x20(%eax),%eax
801053bc:	3b 45 08             	cmp    0x8(%ebp),%eax
801053bf:	75 0a                	jne    801053cb <wakeup1+0x2f>
      p->state = RUNNABLE;
801053c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053c4:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801053cb:	81 45 fc 90 00 00 00 	addl   $0x90,-0x4(%ebp)
801053d2:	81 7d fc b4 53 11 80 	cmpl   $0x801153b4,-0x4(%ebp)
801053d9:	72 d0                	jb     801053ab <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
801053db:	c9                   	leave  
...
801053e0:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
801053e3:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801053ea:	e8 f8 01 00 00       	call   801055e7 <acquire>
  wakeup1(chan);
801053ef:	8b 45 08             	mov    0x8(%ebp),%eax
801053f2:	89 04 24             	mov    %eax,(%esp)
801053f5:	e8 a2 ff ff ff       	call   8010539c <wakeup1>
  release(&ptable.lock);
801053fa:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105401:	e8 43 02 00 00       	call   80105649 <release>
}
80105406:	c9                   	leave  
80105407:	c3                   	ret    
...
8010540b:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
8010540e:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105415:	e8 cd 01 00 00       	call   801055e7 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010541a:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80105421:	eb 44                	jmp    80105467 <kill+0x5f>
    if(p->pid == pid){
80105423:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105426:	8b 40 10             	mov    0x10(%eax),%eax
80105429:	3b 45 08             	cmp    0x8(%ebp),%eax
8010542c:	75 32                	jne    80105460 <kill+0x58>
      p->killed = 1;
8010542e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105431:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80105438:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010543b:	8b 40 0c             	mov    0xc(%eax),%eax
8010543e:	83 f8 02             	cmp    $0x2,%eax
80105441:	75 0a                	jne    8010544d <kill+0x45>
        p->state = RUNNABLE;
80105443:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105446:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
8010544d:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105454:	e8 f0 01 00 00       	call   80105649 <release>
      return 0;
80105459:	b8 00 00 00 00       	mov    $0x0,%eax
8010545e:	eb 21                	jmp    80105481 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105460:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80105467:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
8010546e:	72 b3                	jb     80105423 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80105470:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105477:	e8 cd 01 00 00       	call   80105649 <release>
  return -1;
...
80105486:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105489:	c7 45 f0 b4 2f 11 80 	movl   $0x80112fb4,-0x10(%ebp)
80105490:	e9 db 00 00 00       	jmp    80105570 <procdump+0xed>
    if(p->state == UNUSED)
80105495:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105498:	8b 40 0c             	mov    0xc(%eax),%eax
8010549b:	85 c0                	test   %eax,%eax
8010549d:	0f 84 c5 00 00 00    	je     80105568 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801054a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054a6:	8b 40 0c             	mov    0xc(%eax),%eax
801054a9:	83 f8 05             	cmp    $0x5,%eax
801054ac:	77 23                	ja     801054d1 <procdump+0x4e>
801054ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054b1:	8b 40 0c             	mov    0xc(%eax),%eax
801054b4:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801054bb:	85 c0                	test   %eax,%eax
801054bd:	74 12                	je     801054d1 <procdump+0x4e>
      state = states[p->state];
801054bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054c2:	8b 40 0c             	mov    0xc(%eax),%eax
801054c5:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801054cc:	89 45 ec             	mov    %eax,-0x14(%ebp)
801054cf:	eb 07                	jmp    801054d8 <procdump+0x55>
    else
      state = "???";
801054d1:	c7 45 ec 76 92 10 80 	movl   $0x80109276,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
801054d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054db:	8d 50 6c             	lea    0x6c(%eax),%edx
801054de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054e1:	8b 40 10             	mov    0x10(%eax),%eax
801054e4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801054e8:	8b 55 ec             	mov    -0x14(%ebp),%edx
801054eb:	89 54 24 08          	mov    %edx,0x8(%esp)
801054ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801054f3:	c7 04 24 7a 92 10 80 	movl   $0x8010927a,(%esp)
801054fa:	e8 a2 ae ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
801054ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105502:	8b 40 0c             	mov    0xc(%eax),%eax
80105505:	83 f8 02             	cmp    $0x2,%eax
80105508:	75 50                	jne    8010555a <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010550a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010550d:	8b 40 1c             	mov    0x1c(%eax),%eax
80105510:	8b 40 0c             	mov    0xc(%eax),%eax
80105513:	83 c0 08             	add    $0x8,%eax
80105516:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80105519:	89 54 24 04          	mov    %edx,0x4(%esp)
8010551d:	89 04 24             	mov    %eax,(%esp)
80105520:	e8 73 01 00 00       	call   80105698 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105525:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010552c:	eb 1b                	jmp    80105549 <procdump+0xc6>
        cprintf(" %p", pc[i]);
8010552e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105531:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105535:	89 44 24 04          	mov    %eax,0x4(%esp)
80105539:	c7 04 24 83 92 10 80 	movl   $0x80109283,(%esp)
80105540:	e8 5c ae ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80105545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105549:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
8010554d:	7f 0b                	jg     8010555a <procdump+0xd7>
8010554f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105552:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105556:	85 c0                	test   %eax,%eax
80105558:	75 d4                	jne    8010552e <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
8010555a:	c7 04 24 87 92 10 80 	movl   $0x80109287,(%esp)
80105561:	e8 3b ae ff ff       	call   801003a1 <cprintf>
80105566:	eb 01                	jmp    80105569 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80105568:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105569:	81 45 f0 90 00 00 00 	addl   $0x90,-0x10(%ebp)
80105570:	81 7d f0 b4 53 11 80 	cmpl   $0x801153b4,-0x10(%ebp)
80105577:	0f 82 18 ff ff ff    	jb     80105495 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
801055ab:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
801055ae:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
801055b8:	89 c3                	mov    %eax,%ebx
801055ba:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
801055cc:	8b 55 0c             	mov    0xc(%ebp),%edx
801055cf:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801055d2:	8b 45 08             	mov    0x8(%ebp),%eax
801055d5:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801055db:	8b 45 08             	mov    0x8(%ebp),%eax
801055de:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801055e5:	5d                   	pop    %ebp
801055e6:	c3                   	ret    
...
801055ed:	e8 3d 01 00 00       	call   8010572f <pushcli>
  if(holding(lk))
801055f2:	8b 45 08             	mov    0x8(%ebp),%eax
801055f5:	89 04 24             	mov    %eax,(%esp)
801055f8:	e8 08 01 00 00       	call   80105705 <holding>
801055fd:	85 c0                	test   %eax,%eax
801055ff:	74 0c                	je     8010560d <acquire+0x26>
    panic("acquire");
80105601:	c7 04 24 b3 92 10 80 	movl   $0x801092b3,(%esp)
80105608:	e8 30 af ff ff       	call   8010053d <panic>
...
80105611:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105618:	00 
80105619:	89 04 24             	mov    %eax,(%esp)
8010561c:	e8 80 ff ff ff       	call   801055a1 <xchg>
80105621:	85 c0                	test   %eax,%eax
80105623:	75 e9                	jne    8010560e <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105625:	8b 45 08             	mov    0x8(%ebp),%eax
80105628:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010562f:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105632:	8b 45 08             	mov    0x8(%ebp),%eax
80105635:	83 c0 0c             	add    $0xc,%eax
80105638:	89 44 24 04          	mov    %eax,0x4(%esp)
8010563c:	8d 45 08             	lea    0x8(%ebp),%eax
8010563f:	89 04 24             	mov    %eax,(%esp)
80105642:	e8 51 00 00 00       	call   80105698 <getcallerpcs>
}
80105647:	c9                   	leave  
80105648:	c3                   	ret    
...
80105655:	e8 ab 00 00 00       	call   80105705 <holding>
8010565a:	85 c0                	test   %eax,%eax
8010565c:	75 0c                	jne    8010566a <release+0x21>
    panic("release");
8010565e:	c7 04 24 bb 92 10 80 	movl   $0x801092bb,(%esp)
80105665:	e8 d3 ae ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
8010566a:	8b 45 08             	mov    0x8(%ebp),%eax
8010566d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105674:	8b 45 08             	mov    0x8(%ebp),%eax
80105677:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105681:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105688:	00 
80105689:	89 04 24             	mov    %eax,(%esp)
8010568c:	e8 10 ff ff ff       	call   801055a1 <xchg>

  popcli();
80105691:	e8 e1 00 00 00       	call   80105777 <popcli>
}
80105696:	c9                   	leave  
80105697:	c3                   	ret    

80105698 <getcallerpcs>:
...
8010569b:	83 ec 10             	sub    $0x10,%esp
  uint *ebp;
  int i;
  
  ebp = (uint*)v - 2;
8010569e:	8b 45 08             	mov    0x8(%ebp),%eax
801056a1:	83 e8 08             	sub    $0x8,%eax
801056a4:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801056a7:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
801056ae:	eb 32                	jmp    801056e2 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801056b0:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801056b4:	74 47                	je     801056fd <getcallerpcs+0x65>
801056b6:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801056bd:	76 3e                	jbe    801056fd <getcallerpcs+0x65>
801056bf:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801056c3:	74 38                	je     801056fd <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801056c5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056c8:	c1 e0 02             	shl    $0x2,%eax
801056cb:	03 45 0c             	add    0xc(%ebp),%eax
801056ce:	8b 55 fc             	mov    -0x4(%ebp),%edx
801056d1:	8b 52 04             	mov    0x4(%edx),%edx
801056d4:	89 10                	mov    %edx,(%eax)
...
801056db:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801056de:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801056e2:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801056e6:	7e c8                	jle    801056b0 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801056e8:	eb 13                	jmp    801056fd <getcallerpcs+0x65>
    pcs[i] = 0;
801056ea:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056ed:	c1 e0 02             	shl    $0x2,%eax
801056f0:	03 45 0c             	add    0xc(%ebp),%eax
...
801056fd:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105701:	7e e7                	jle    801056ea <getcallerpcs+0x52>
    pcs[i] = 0;
}
80105703:	c9                   	leave  
80105704:	c3                   	ret    
...
8010570f:	74 17                	je     80105728 <holding+0x23>
80105711:	8b 45 08             	mov    0x8(%ebp),%eax
80105714:	8b 50 08             	mov    0x8(%eax),%edx
80105717:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010571d:	39 c2                	cmp    %eax,%edx
8010571f:	75 07                	jne    80105728 <holding+0x23>
80105721:	b8 01 00 00 00       	mov    $0x1,%eax
80105726:	eb 05                	jmp    8010572d <holding+0x28>
...
80105732:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80105735:	e8 46 fe ff ff       	call   80105580 <readeflags>
8010573a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010573d:	e8 53 fe ff ff       	call   80105595 <cli>
  if(cpu->ncli++ == 0)
80105742:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105748:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010574e:	85 d2                	test   %edx,%edx
80105750:	0f 94 c1             	sete   %cl
80105753:	83 c2 01             	add    $0x1,%edx
80105756:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010575c:	84 c9                	test   %cl,%cl
8010575e:	74 15                	je     80105775 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105760:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105766:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105769:	81 e2 00 02 00 00    	and    $0x200,%edx
8010576f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105775:	c9                   	leave  
80105776:	c3                   	ret    
...
8010577a:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010577d:	e8 fe fd ff ff       	call   80105580 <readeflags>
80105782:	25 00 02 00 00       	and    $0x200,%eax
80105787:	85 c0                	test   %eax,%eax
80105789:	74 0c                	je     80105797 <popcli+0x20>
    panic("popcli - interruptible");
8010578b:	c7 04 24 c3 92 10 80 	movl   $0x801092c3,(%esp)
80105792:	e8 a6 ad ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105797:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010579d:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801057a3:	83 ea 01             	sub    $0x1,%edx
801057a6:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801057ac:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801057b2:	85 c0                	test   %eax,%eax
801057b4:	79 0c                	jns    801057c2 <popcli+0x4b>
    panic("popcli");
801057b6:	c7 04 24 da 92 10 80 	movl   $0x801092da,(%esp)
...
801057d0:	75 15                	jne    801057e7 <popcli+0x70>
801057d2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801057d8:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801057de:	85 c0                	test   %eax,%eax
801057e0:	74 05                	je     801057e7 <popcli+0x70>
    sti();
801057e2:	e8 b4 fd ff ff       	call   8010559b <sti>
}
801057e7:	c9                   	leave  
801057e8:	c3                   	ret    
801057e9:	00 00                	add    %al,(%eax)
	...
...
801057ef:	57                   	push   %edi
801057f0:	53                   	push   %ebx
  asm volatile("cld; rep stosb" :
801057f1:	8b 4d 08             	mov    0x8(%ebp),%ecx
801057f4:	8b 55 10             	mov    0x10(%ebp),%edx
801057f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801057fa:	89 cb                	mov    %ecx,%ebx
801057fc:	89 df                	mov    %ebx,%edi
801057fe:	89 d1                	mov    %edx,%ecx
80105800:	fc                   	cld    
80105801:	f3 aa                	rep stos %al,%es:(%edi)
80105803:	89 ca                	mov    %ecx,%edx
80105805:	89 fb                	mov    %edi,%ebx
80105807:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010580a:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105814:	57                   	push   %edi
80105815:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
80105816:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105819:	8b 55 10             	mov    0x10(%ebp),%edx
8010581c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010581f:	89 cb                	mov    %ecx,%ebx
80105821:	89 df                	mov    %ebx,%edi
80105823:	89 d1                	mov    %edx,%ecx
80105825:	fc                   	cld    
80105826:	f3 ab                	rep stos %eax,%es:(%edi)
80105828:	89 ca                	mov    %ecx,%edx
8010582a:	89 fb                	mov    %edi,%ebx
8010582c:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010582f:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
8010583f:	83 e0 03             	and    $0x3,%eax
80105842:	85 c0                	test   %eax,%eax
80105844:	75 49                	jne    8010588f <memset+0x59>
80105846:	8b 45 10             	mov    0x10(%ebp),%eax
80105849:	83 e0 03             	and    $0x3,%eax
8010584c:	85 c0                	test   %eax,%eax
8010584e:	75 3f                	jne    8010588f <memset+0x59>
    c &= 0xFF;
80105850:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105857:	8b 45 10             	mov    0x10(%ebp),%eax
8010585a:	c1 e8 02             	shr    $0x2,%eax
8010585d:	89 c2                	mov    %eax,%edx
8010585f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105862:	89 c1                	mov    %eax,%ecx
80105864:	c1 e1 18             	shl    $0x18,%ecx
80105867:	8b 45 0c             	mov    0xc(%ebp),%eax
8010586a:	c1 e0 10             	shl    $0x10,%eax
8010586d:	09 c1                	or     %eax,%ecx
8010586f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105872:	c1 e0 08             	shl    $0x8,%eax
80105875:	09 c8                	or     %ecx,%eax
80105877:	0b 45 0c             	or     0xc(%ebp),%eax
8010587a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010587e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105882:	8b 45 08             	mov    0x8(%ebp),%eax
80105885:	89 04 24             	mov    %eax,(%esp)
80105888:	e8 84 ff ff ff       	call   80105811 <stosl>
8010588d:	eb 19                	jmp    801058a8 <memset+0x72>
  } else
    stosb(dst, c, n);
8010588f:	8b 45 10             	mov    0x10(%ebp),%eax
80105892:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801058a3:	e8 44 ff ff ff       	call   801057ec <stosb>
  return dst;
...
801058b6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
801058b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801058bc:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801058bf:	eb 32                	jmp    801058f3 <memcmp+0x46>
    if(*s1 != *s2)
801058c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058c4:	0f b6 10             	movzbl (%eax),%edx
801058c7:	8b 45 f8             	mov    -0x8(%ebp),%eax
801058ca:	0f b6 00             	movzbl (%eax),%eax
801058cd:	38 c2                	cmp    %al,%dl
801058cf:	74 1a                	je     801058eb <memcmp+0x3e>
      return *s1 - *s2;
801058d1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058d4:	0f b6 00             	movzbl (%eax),%eax
801058d7:	0f b6 d0             	movzbl %al,%edx
801058da:	8b 45 f8             	mov    -0x8(%ebp),%eax
801058dd:	0f b6 00             	movzbl (%eax),%eax
801058e0:	0f b6 c0             	movzbl %al,%eax
801058e3:	89 d1                	mov    %edx,%ecx
801058e5:	29 c1                	sub    %eax,%ecx
801058e7:	89 c8                	mov    %ecx,%eax
801058e9:	eb 1c                	jmp    80105907 <memcmp+0x5a>
    s1++, s2++;
801058eb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801058f7:	0f 95 c0             	setne  %al
801058fa:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801058fe:	84 c0                	test   %al,%al
80105900:	75 bf                	jne    801058c1 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105912:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80105915:	8b 45 08             	mov    0x8(%ebp),%eax
80105918:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010591b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010591e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105921:	73 54                	jae    80105977 <memmove+0x6e>
80105923:	8b 45 10             	mov    0x10(%ebp),%eax
80105926:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105929:	01 d0                	add    %edx,%eax
8010592b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010592e:	76 47                	jbe    80105977 <memmove+0x6e>
    s += n;
80105930:	8b 45 10             	mov    0x10(%ebp),%eax
80105933:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105936:	8b 45 10             	mov    0x10(%ebp),%eax
80105939:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010593c:	eb 13                	jmp    80105951 <memmove+0x48>
      *--d = *--s;
8010593e:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105942:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105946:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105949:	0f b6 10             	movzbl (%eax),%edx
...
8010594f:	88 10                	mov    %dl,(%eax)
  ...
  if(s < d && s + n > d){
    ...
    d += n;
    while(n-- > 0)
80105951:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105955:	0f 95 c0             	setne  %al
80105958:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010595c:	84 c0                	test   %al,%al
8010595e:	75 de                	jne    8010593e <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105960:	eb 25                	jmp    80105987 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105965:	0f b6 10             	movzbl (%eax),%edx
80105968:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010596b:	88 10                	mov    %dl,(%eax)
8010596d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105971:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105975:	eb 01                	jmp    80105978 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105983:	84 c0                	test   %al,%al
80105985:	75 db                	jne    80105962 <memmove+0x59>
      *d++ = *s++;
...
801059a6:	e8 5e ff ff ff       	call   80105909 <memmove>
}
801059ab:	c9                   	leave  
801059ac:	c3                   	ret    
...
801059ae:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801059b0:	eb 0c                	jmp    801059be <strncmp+0x11>
    n--, p++, q++;
801059b2:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801059b6:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801059ba:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
801059be:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059c2:	74 1a                	je     801059de <strncmp+0x31>
801059c4:	8b 45 08             	mov    0x8(%ebp),%eax
801059c7:	0f b6 00             	movzbl (%eax),%eax
801059ca:	84 c0                	test   %al,%al
801059cc:	74 10                	je     801059de <strncmp+0x31>
801059ce:	8b 45 08             	mov    0x8(%ebp),%eax
801059d1:	0f b6 10             	movzbl (%eax),%edx
801059d4:	8b 45 0c             	mov    0xc(%ebp),%eax
801059d7:	0f b6 00             	movzbl (%eax),%eax
801059da:	38 c2                	cmp    %al,%dl
801059dc:	74 d4                	je     801059b2 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801059de:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059e2:	75 07                	jne    801059eb <strncmp+0x3e>
    return 0;
801059e4:	b8 00 00 00 00       	mov    $0x0,%eax
801059e9:	eb 18                	jmp    80105a03 <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
801059eb:	8b 45 08             	mov    0x8(%ebp),%eax
801059ee:	0f b6 00             	movzbl (%eax),%eax
801059f1:	0f b6 d0             	movzbl %al,%edx
801059f4:	8b 45 0c             	mov    0xc(%ebp),%eax
801059f7:	0f b6 00             	movzbl (%eax),%eax
801059fa:	0f b6 c0             	movzbl %al,%eax
801059fd:	89 d1                	mov    %edx,%ecx
801059ff:	29 c1                	sub    %eax,%ecx
80105a01:	89 c8                	mov    %ecx,%eax
}
80105a03:	5d                   	pop    %ebp
80105a04:	c3                   	ret    
...
80105a0e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105a11:	90                   	nop
80105a12:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a16:	0f 9f c0             	setg   %al
80105a19:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a1d:	84 c0                	test   %al,%al
80105a1f:	74 30                	je     80105a51 <strncpy+0x4c>
80105a21:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a24:	0f b6 10             	movzbl (%eax),%edx
80105a27:	8b 45 08             	mov    0x8(%ebp),%eax
80105a2a:	88 10                	mov    %dl,(%eax)
80105a2c:	8b 45 08             	mov    0x8(%ebp),%eax
80105a2f:	0f b6 00             	movzbl (%eax),%eax
80105a32:	84 c0                	test   %al,%al
80105a34:	0f 95 c0             	setne  %al
80105a37:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105a3b:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105a3f:	84 c0                	test   %al,%al
80105a41:	75 cf                	jne    80105a12 <strncpy+0xd>
    ;
  while(n-- > 0)
80105a43:	eb 0c                	jmp    80105a51 <strncpy+0x4c>
    *s++ = 0;
80105a45:	8b 45 08             	mov    0x8(%ebp),%eax
80105a48:	c6 00 00             	movb   $0x0,(%eax)
80105a4b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105a4f:	eb 01                	jmp    80105a52 <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
80105a51:	90                   	nop
80105a52:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a56:	0f 9f c0             	setg   %al
80105a59:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a5d:	84 c0                	test   %al,%al
80105a5f:	75 e4                	jne    80105a45 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105a6f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105a72:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a76:	7f 05                	jg     80105a7d <safestrcpy+0x17>
    return os;
80105a78:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a7b:	eb 35                	jmp    80105ab2 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105a7d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a81:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a85:	7e 22                	jle    80105aa9 <safestrcpy+0x43>
80105a87:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a8a:	0f b6 10             	movzbl (%eax),%edx
80105a8d:	8b 45 08             	mov    0x8(%ebp),%eax
80105a90:	88 10                	mov    %dl,(%eax)
80105a92:	8b 45 08             	mov    0x8(%ebp),%eax
80105a95:	0f b6 00             	movzbl (%eax),%eax
80105a98:	84 c0                	test   %al,%al
80105a9a:	0f 95 c0             	setne  %al
80105a9d:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105aa1:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105aa5:	84 c0                	test   %al,%al
80105aa7:	75 d4                	jne    80105a7d <safestrcpy+0x17>
    ;
  *s = 0;
...
80105ab7:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105aba:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105ac1:	eb 04                	jmp    80105ac7 <strlen+0x13>
80105ac3:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ac7:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105aca:	03 45 08             	add    0x8(%ebp),%eax
80105acd:	0f b6 00             	movzbl (%eax),%eax
80105ad0:	84 c0                	test   %al,%al
80105ad2:	75 ef                	jne    80105ac3 <strlen+0xf>
    ;
  return n;
80105ad4:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80105ad7:	c9                   	leave  
80105ad8:	c3                   	ret    
...
swtch:
  movl 4(%esp), %eax
80105adc:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105ae0:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105ae7:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105ae8:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105aea:	89 d4                	mov    %edx,%esp
...
80105afc:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105aff:	76 0f                	jbe    80105b10 <fetchint+0x1c>
80105b01:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b04:	8d 50 04             	lea    0x4(%eax),%edx
80105b07:	8b 45 08             	mov    0x8(%ebp),%eax
80105b0a:	8b 00                	mov    (%eax),%eax
80105b0c:	39 c2                	cmp    %eax,%edx
80105b0e:	76 07                	jbe    80105b17 <fetchint+0x23>
    return -1;
80105b10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b15:	eb 0f                	jmp    80105b26 <fetchint+0x32>
  *ip = *(int*)(addr);
80105b17:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b1a:	8b 10                	mov    (%eax),%edx
80105b1c:	8b 45 10             	mov    0x10(%ebp),%eax
80105b1f:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105b33:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105b36:	77 07                	ja     80105b3f <fetchstr+0x17>
    return -1;
80105b38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b3d:	eb 45                	jmp    80105b84 <fetchstr+0x5c>
  *pp = (char*)addr;
...
80105b4c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105b4f:	8b 45 10             	mov    0x10(%ebp),%eax
80105b52:	8b 00                	mov    (%eax),%eax
80105b54:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105b57:	eb 1e                	jmp    80105b77 <fetchstr+0x4f>
    if(*s == 0)
80105b59:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b5c:	0f b6 00             	movzbl (%eax),%eax
80105b5f:	84 c0                	test   %al,%al
80105b61:	75 10                	jne    80105b73 <fetchstr+0x4b>
      return s - *pp;
80105b63:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b66:	8b 45 10             	mov    0x10(%ebp),%eax
80105b69:	8b 00                	mov    (%eax),%eax
80105b6b:	89 d1                	mov    %edx,%ecx
80105b6d:	29 c1                	sub    %eax,%ecx
80105b6f:	89 c8                	mov    %ecx,%eax
80105b71:	eb 11                	jmp    80105b84 <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
80105b73:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105b77:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b7a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105b7d:	72 da                	jb     80105b59 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105b92:	8b 40 18             	mov    0x18(%eax),%eax
80105b95:	8b 50 44             	mov    0x44(%eax),%edx
80105b98:	8b 45 08             	mov    0x8(%ebp),%eax
80105b9b:	c1 e0 02             	shl    $0x2,%eax
80105b9e:	01 d0                	add    %edx,%eax
80105ba0:	8d 48 04             	lea    0x4(%eax),%ecx
80105ba3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ba9:	8b 55 0c             	mov    0xc(%ebp),%edx
80105bac:	89 54 24 08          	mov    %edx,0x8(%esp)
80105bb0:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105bb4:	89 04 24             	mov    %eax,(%esp)
80105bb7:	e8 38 ff ff ff       	call   80105af4 <fetchint>
}
80105bbc:	c9                   	leave  
80105bbd:	c3                   	ret    
...
80105bc1:	83 ec 18             	sub    $0x18,%esp
  ...
  if(argint(n, &i) < 0)
80105bc4:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105bc7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bcb:	8b 45 08             	mov    0x8(%ebp),%eax
80105bce:	89 04 24             	mov    %eax,(%esp)
80105bd1:	e8 b0 ff ff ff       	call   80105b86 <argint>
80105bd6:	85 c0                	test   %eax,%eax
80105bd8:	79 07                	jns    80105be1 <argptr+0x23>
    return -1;
80105bda:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bdf:	eb 3d                	jmp    80105c1e <argptr+0x60>
  if((uint)i >= proc->sz || (uint)i+size > proc->sz)
80105be1:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105be4:	89 c2                	mov    %eax,%edx
80105be6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bec:	8b 00                	mov    (%eax),%eax
80105bee:	39 c2                	cmp    %eax,%edx
80105bf0:	73 16                	jae    80105c08 <argptr+0x4a>
80105bf2:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105bf5:	89 c2                	mov    %eax,%edx
80105bf7:	8b 45 10             	mov    0x10(%ebp),%eax
80105bfa:	01 c2                	add    %eax,%edx
80105bfc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c02:	8b 00                	mov    (%eax),%eax
80105c04:	39 c2                	cmp    %eax,%edx
80105c06:	76 07                	jbe    80105c0f <argptr+0x51>
    return -1;
80105c08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c0d:	eb 0f                	jmp    80105c1e <argptr+0x60>
  *pp = (char*)i;
...
80105c23:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105c26:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105c29:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c2d:	8b 45 08             	mov    0x8(%ebp),%eax
80105c30:	89 04 24             	mov    %eax,(%esp)
80105c33:	e8 4e ff ff ff       	call   80105b86 <argint>
80105c38:	85 c0                	test   %eax,%eax
80105c3a:	79 07                	jns    80105c43 <argstr+0x23>
    return -1;
80105c3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c41:	eb 1e                	jmp    80105c61 <argstr+0x41>
  return fetchstr(proc, addr, pp);
80105c43:	8b 45 fc             	mov    -0x4(%ebp),%eax
...
80105c5c:	e8 c7 fe ff ff       	call   80105b28 <fetchstr>
}
80105c61:	c9                   	leave  
80105c62:	c3                   	ret    
...
80105c67:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105c6a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c70:	8b 40 18             	mov    0x18(%eax),%eax
80105c73:	8b 40 1c             	mov    0x1c(%eax),%eax
80105c76:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80105c79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c7d:	78 2e                	js     80105cad <syscall+0x4a>
80105c7f:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105c83:	7f 28                	jg     80105cad <syscall+0x4a>
80105c85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c88:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105c8f:	85 c0                	test   %eax,%eax
80105c91:	74 1a                	je     80105cad <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
80105c93:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c99:	8b 58 18             	mov    0x18(%eax),%ebx
80105c9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c9f:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105ca6:	ff d0                	call   *%eax
80105ca8:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105cab:	eb 73                	jmp    80105d20 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105cad:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105cb1:	7e 30                	jle    80105ce3 <syscall+0x80>
80105cb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cb6:	83 f8 1d             	cmp    $0x1d,%eax
80105cb9:	77 28                	ja     80105ce3 <syscall+0x80>
80105cbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cbe:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105cc5:	85 c0                	test   %eax,%eax
80105cc7:	74 1a                	je     80105ce3 <syscall+0x80>
    proc->tf->eax = syscalls[num]();
80105cc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ccf:	8b 58 18             	mov    0x18(%eax),%ebx
80105cd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd5:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105cdc:	ff d0                	call   *%eax
80105cde:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105ce1:	eb 3d                	jmp    80105d20 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105ce3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ce9:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105cec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105cf2:	8b 40 10             	mov    0x10(%eax),%eax
80105cf5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105cf8:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105cfc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105d00:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d04:	c7 04 24 e1 92 10 80 	movl   $0x801092e1,(%esp)
80105d0b:	e8 91 a6 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105d10:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d16:	8b 40 18             	mov    0x18(%eax),%eax
80105d19:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105d20:	83 c4 24             	add    $0x24,%esp
80105d23:	5b                   	pop    %ebx
80105d24:	5d                   	pop    %ebp
80105d25:	c3                   	ret    
	...
...
80105d35:	8b 45 08             	mov    0x8(%ebp),%eax
80105d38:	89 04 24             	mov    %eax,(%esp)
80105d3b:	e8 46 fe ff ff       	call   80105b86 <argint>
80105d40:	85 c0                	test   %eax,%eax
80105d42:	79 07                	jns    80105d4b <argfd+0x23>
    return -1;
80105d44:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d49:	eb 50                	jmp    80105d9b <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105d4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4e:	85 c0                	test   %eax,%eax
80105d50:	78 21                	js     80105d73 <argfd+0x4b>
80105d52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d55:	83 f8 0f             	cmp    $0xf,%eax
80105d58:	7f 19                	jg     80105d73 <argfd+0x4b>
80105d5a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d60:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105d63:	83 c2 08             	add    $0x8,%edx
80105d66:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105d6a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d6d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d71:	75 07                	jne    80105d7a <argfd+0x52>
    return -1;
80105d73:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d78:	eb 21                	jmp    80105d9b <argfd+0x73>
  if(pfd)
80105d7a:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105d7e:	74 08                	je     80105d88 <argfd+0x60>
    *pfd = fd;
80105d80:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105d83:	8b 45 0c             	mov    0xc(%ebp),%eax
80105d86:	89 10                	mov    %edx,(%eax)
  if(pf)
80105d88:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105d8c:	74 08                	je     80105d96 <argfd+0x6e>
    *pf = f;
80105d8e:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105da0:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105da3:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105daa:	eb 30                	jmp    80105ddc <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105dac:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105db2:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105db5:	83 c2 08             	add    $0x8,%edx
80105db8:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105dbc:	85 c0                	test   %eax,%eax
80105dbe:	75 18                	jne    80105dd8 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105dc0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105dc6:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105dc9:	8d 4a 08             	lea    0x8(%edx),%ecx
80105dcc:	8b 55 08             	mov    0x8(%ebp),%edx
80105dcf:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105dd3:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105dd6:	eb 0f                	jmp    80105de7 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105dd8:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ddc:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105de0:	7e ca                	jle    80105dac <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105e5c:	e8 c7 fe ff ff       	call   80105d28 <argfd>
80105e61:	85 c0                	test   %eax,%eax
80105e63:	78 35                	js     80105e9a <sys_read+0x5a>
80105e65:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e68:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e6c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105e73:	e8 0e fd ff ff       	call   80105b86 <argint>
80105e78:	85 c0                	test   %eax,%eax
80105e7a:	78 1e                	js     80105e9a <sys_read+0x5a>
...
80105e91:	e8 28 fd ff ff       	call   80105bbe <argptr>
80105e96:	85 c0                	test   %eax,%eax
80105e98:	79 07                	jns    80105ea1 <sys_read+0x61>
    return -1;
80105e9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e9f:	eb 19                	jmp    80105eba <sys_read+0x7a>
  return fileread(f, p, n);
80105ea1:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105ea4:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105ea7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eaa:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105eae:	89 54 24 04          	mov    %edx,0x4(%esp)
80105eb2:	89 04 24             	mov    %eax,(%esp)
80105eb5:	e8 2f b2 ff ff       	call   801010e9 <fileread>
}
80105eba:	c9                   	leave  
80105ebb:	c3                   	ret    
...
80105ec9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ed0:	00 
80105ed1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ed8:	e8 4b fe ff ff       	call   80105d28 <argfd>
80105edd:	85 c0                	test   %eax,%eax
80105edf:	78 35                	js     80105f16 <sys_write+0x5a>
80105ee1:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ee4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ee8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105eef:	e8 92 fc ff ff       	call   80105b86 <argint>
80105ef4:	85 c0                	test   %eax,%eax
80105ef6:	78 1e                	js     80105f16 <sys_write+0x5a>
80105ef8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105efb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eff:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105f02:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f0d:	e8 ac fc ff ff       	call   80105bbe <argptr>
80105f12:	85 c0                	test   %eax,%eax
80105f14:	79 07                	jns    80105f1d <sys_write+0x61>
    return -1;
80105f16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f1b:	eb 19                	jmp    80105f36 <sys_write+0x7a>
  return filewrite(f, p, n);
80105f1d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105f20:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105f23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f26:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105f2a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f2e:	89 04 24             	mov    %eax,(%esp)
80105f31:	e8 6f b2 ff ff       	call   801011a5 <filewrite>
}
80105f36:	c9                   	leave  
80105f37:	c3                   	ret    
...
80105f41:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f45:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105f48:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f4c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f53:	e8 d0 fd ff ff       	call   80105d28 <argfd>
80105f58:	85 c0                	test   %eax,%eax
80105f5a:	79 07                	jns    80105f63 <sys_close+0x2b>
    return -1;
80105f5c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f61:	eb 24                	jmp    80105f87 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105f63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105f69:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f6c:	83 c2 08             	add    $0x8,%edx
80105f6f:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105f76:	00 
  fileclose(f);
80105f77:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f7a:	89 04 24             	mov    %eax,(%esp)
80105f7d:	e8 42 b0 ff ff       	call   80100fc4 <fileclose>
  return 0;
80105f82:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105f87:	c9                   	leave  
80105f88:	c3                   	ret    
...
80105f8c:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
80105f96:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f9d:	00 
80105f9e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fa5:	e8 7e fd ff ff       	call   80105d28 <argfd>
80105faa:	85 c0                	test   %eax,%eax
80105fac:	78 1f                	js     80105fcd <sys_fstat+0x44>
80105fae:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105fb5:	00 
80105fb6:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105fb9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fc4:	e8 f5 fb ff ff       	call   80105bbe <argptr>
80105fc9:	85 c0                	test   %eax,%eax
80105fcb:	79 07                	jns    80105fd4 <sys_fstat+0x4b>
    return -1;
80105fcd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fd2:	eb 12                	jmp    80105fe6 <sys_fstat+0x5d>
  return filestat(f, st);
80105fd4:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105fd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fda:	89 54 24 04          	mov    %edx,0x4(%esp)
80105fde:	89 04 24             	mov    %eax,(%esp)
80105fe1:	e8 b4 b0 ff ff       	call   8010109a <filestat>
}
80105fe6:	c9                   	leave  
80105fe7:	c3                   	ret    
...
80105fee:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105ff1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ff5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ffc:	e8 1f fc ff ff       	call   80105c20 <argstr>
80106001:	85 c0                	test   %eax,%eax
80106003:	78 17                	js     8010601c <sys_link+0x34>
80106005:	8d 45 dc             	lea    -0x24(%ebp),%eax
80106008:	89 44 24 04          	mov    %eax,0x4(%esp)
8010600c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106013:	e8 08 fc ff ff       	call   80105c20 <argstr>
80106018:	85 c0                	test   %eax,%eax
8010601a:	79 0a                	jns    80106026 <sys_link+0x3e>
    return -1;
8010601c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106021:	e9 3c 01 00 00       	jmp    80106162 <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80106026:	8b 45 d8             	mov    -0x28(%ebp),%eax
80106029:	89 04 24             	mov    %eax,(%esp)
8010602c:	e8 d9 c3 ff ff       	call   8010240a <namei>
80106031:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106034:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106038:	75 0a                	jne    80106044 <sys_link+0x5c>
    return -1;
8010603a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010603f:	e9 1e 01 00 00       	jmp    80106162 <sys_link+0x17a>

  begin_trans();
80106044:	e8 d4 d1 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80106049:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010604c:	89 04 24             	mov    %eax,(%esp)
8010604f:	e8 14 b8 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80106054:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106057:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010605b:	66 83 f8 01          	cmp    $0x1,%ax
8010605f:	75 1a                	jne    8010607b <sys_link+0x93>
    iunlockput(ip);
80106061:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106064:	89 04 24             	mov    %eax,(%esp)
80106067:	e8 80 ba ff ff       	call   80101aec <iunlockput>
    commit_trans();
8010606c:	e8 f5 d1 ff ff       	call   80103266 <commit_trans>
    return -1;
80106071:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106076:	e9 e7 00 00 00       	jmp    80106162 <sys_link+0x17a>
  }

  ip->nlink++;
8010607b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010607e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80106092:	e8 15 b6 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80106097:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010609a:	89 04 24             	mov    %eax,(%esp)
8010609d:	e8 14 b9 ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801060a2:	8b 45 dc             	mov    -0x24(%ebp),%eax
801060a5:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801060a8:	89 54 24 04          	mov    %edx,0x4(%esp)
801060ac:	89 04 24             	mov    %eax,(%esp)
801060af:	e8 78 c3 ff ff       	call   8010242c <nameiparent>
801060b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060b7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060bb:	74 68                	je     80106125 <sys_link+0x13d>
    goto bad;
  ilock(dp);
801060bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060c0:	89 04 24             	mov    %eax,(%esp)
801060c3:	e8 a0 b7 ff ff       	call   80101868 <ilock>
...
801060d4:	75 20                	jne    801060f6 <sys_link+0x10e>
801060d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060d9:	8b 40 04             	mov    0x4(%eax),%eax
801060dc:	89 44 24 08          	mov    %eax,0x8(%esp)
801060e0:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801060e3:	89 44 24 04          	mov    %eax,0x4(%esp)
801060e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ea:	89 04 24             	mov    %eax,(%esp)
801060ed:	e8 57 c0 ff ff       	call   80102149 <dirlink>
801060f2:	85 c0                	test   %eax,%eax
801060f4:	79 0d                	jns    80106103 <sys_link+0x11b>
    iunlockput(dp);
801060f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f9:	89 04 24             	mov    %eax,(%esp)
801060fc:	e8 eb b9 ff ff       	call   80101aec <iunlockput>
    goto bad;
80106101:	eb 23                	jmp    80106126 <sys_link+0x13e>
  }
  iunlockput(dp);
80106103:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106106:	89 04 24             	mov    %eax,(%esp)
80106109:	e8 de b9 ff ff       	call   80101aec <iunlockput>
  iput(ip);
8010610e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106111:	89 04 24             	mov    %eax,(%esp)
80106114:	e8 02 b9 ff ff       	call   80101a1b <iput>

  commit_trans();
80106119:	e8 48 d1 ff ff       	call   80103266 <commit_trans>

  return 0;
8010611e:	b8 00 00 00 00       	mov    $0x0,%eax
80106123:	eb 3d                	jmp    80106162 <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
8010612c:	e8 37 b7 ff ff       	call   80101868 <ilock>
  ip->nlink--;
80106131:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106134:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106138:	8d 50 ff             	lea    -0x1(%eax),%edx
8010613b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613e:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106142:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106145:	89 04 24             	mov    %eax,(%esp)
80106148:	e8 5f b5 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
8010614d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106150:	89 04 24             	mov    %eax,(%esp)
80106153:	e8 94 b9 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106158:	e8 09 d1 ff ff       	call   80103266 <commit_trans>
  return -1;
...
8010616a:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106171:	eb 4b                	jmp    801061be <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106173:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106176:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010617d:	00 
...
8010618f:	e8 ca bb ff ff       	call   80101d5e <readi>
80106194:	83 f8 10             	cmp    $0x10,%eax
80106197:	74 0c                	je     801061a5 <isdirempty+0x41>
      panic("isdirempty: readi");
80106199:	c7 04 24 fd 92 10 80 	movl   $0x801092fd,(%esp)
801061a0:	e8 98 a3 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
801061a5:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801061a9:	66 85 c0             	test   %ax,%ax
801061ac:	74 07                	je     801061b5 <isdirempty+0x51>
      return 0;
801061ae:	b8 00 00 00 00       	mov    $0x0,%eax
801061b3:	eb 1b                	jmp    801061d0 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801061b8:	83 c0 10             	add    $0x10,%eax
801061bb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061be:	8b 55 f4             	mov    -0xc(%ebp),%edx
801061c1:	8b 45 08             	mov    0x8(%ebp),%eax
801061c4:	8b 40 18             	mov    0x18(%eax),%eax
801061c7:	39 c2                	cmp    %eax,%edx
801061c9:	72 a8                	jb     80106173 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
801061d5:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801061d8:	8d 45 cc             	lea    -0x34(%ebp),%eax
801061db:	89 44 24 04          	mov    %eax,0x4(%esp)
801061df:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061e6:	e8 35 fa ff ff       	call   80105c20 <argstr>
801061eb:	85 c0                	test   %eax,%eax
801061ed:	79 0a                	jns    801061f9 <sys_unlink+0x27>
    return -1;
801061ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061f4:	e9 aa 01 00 00       	jmp    801063a3 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
801061f9:	8b 45 cc             	mov    -0x34(%ebp),%eax
801061fc:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801061ff:	89 54 24 04          	mov    %edx,0x4(%esp)
80106203:	89 04 24             	mov    %eax,(%esp)
80106206:	e8 21 c2 ff ff       	call   8010242c <nameiparent>
8010620b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010620e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106212:	75 0a                	jne    8010621e <sys_unlink+0x4c>
    return -1;
80106214:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106219:	e9 85 01 00 00       	jmp    801063a3 <sys_unlink+0x1d1>

  begin_trans();
8010621e:	e8 fa cf ff ff       	call   8010321d <begin_trans>

  ilock(dp);
80106223:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106226:	89 04 24             	mov    %eax,(%esp)
80106229:	e8 3a b6 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010622e:	c7 44 24 04 0f 93 10 	movl   $0x8010930f,0x4(%esp)
80106235:	80 
80106236:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106239:	89 04 24             	mov    %eax,(%esp)
8010623c:	e8 1e be ff ff       	call   8010205f <namecmp>
80106241:	85 c0                	test   %eax,%eax
80106243:	0f 84 45 01 00 00    	je     8010638e <sys_unlink+0x1bc>
80106249:	c7 44 24 04 11 93 10 	movl   $0x80109311,0x4(%esp)
80106250:	80 
80106251:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106254:	89 04 24             	mov    %eax,(%esp)
80106257:	e8 03 be ff ff       	call   8010205f <namecmp>
8010625c:	85 c0                	test   %eax,%eax
8010625e:	0f 84 2a 01 00 00    	je     8010638e <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106264:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106267:	89 44 24 08          	mov    %eax,0x8(%esp)
8010626b:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010626e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106272:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106275:	89 04 24             	mov    %eax,(%esp)
80106278:	e8 04 be ff ff       	call   80102081 <dirlookup>
8010627d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106280:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106284:	0f 84 03 01 00 00    	je     8010638d <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
8010628a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010628d:	89 04 24             	mov    %eax,(%esp)
80106290:	e8 d3 b5 ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80106295:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106298:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010629c:	66 85 c0             	test   %ax,%ax
8010629f:	7f 0c                	jg     801062ad <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
801062a1:	c7 04 24 14 93 10 80 	movl   $0x80109314,(%esp)
801062a8:	e8 90 a2 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801062ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062b0:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062b4:	66 83 f8 01          	cmp    $0x1,%ax
801062b8:	75 1f                	jne    801062d9 <sys_unlink+0x107>
801062ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062bd:	89 04 24             	mov    %eax,(%esp)
801062c0:	e8 9f fe ff ff       	call   80106164 <isdirempty>
801062c5:	85 c0                	test   %eax,%eax
801062c7:	75 10                	jne    801062d9 <sys_unlink+0x107>
    iunlockput(ip);
801062c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062cc:	89 04 24             	mov    %eax,(%esp)
801062cf:	e8 18 b8 ff ff       	call   80101aec <iunlockput>
    goto bad;
801062d4:	e9 b5 00 00 00       	jmp    8010638e <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
801062d9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801062e0:	00 
801062e1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801062e8:	00 
801062e9:	8d 45 e0             	lea    -0x20(%ebp),%eax
801062ec:	89 04 24             	mov    %eax,(%esp)
801062ef:	e8 42 f5 ff ff       	call   80105836 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801062f4:	8b 45 c8             	mov    -0x38(%ebp),%eax
801062f7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801062fe:	00 
801062ff:	89 44 24 08          	mov    %eax,0x8(%esp)
80106303:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106306:	89 44 24 04          	mov    %eax,0x4(%esp)
8010630a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010630d:	89 04 24             	mov    %eax,(%esp)
80106310:	e8 b4 bb ff ff       	call   80101ec9 <writei>
80106315:	83 f8 10             	cmp    $0x10,%eax
80106318:	74 0c                	je     80106326 <sys_unlink+0x154>
    panic("unlink: writei");
8010631a:	c7 04 24 26 93 10 80 	movl   $0x80109326,(%esp)
80106321:	e8 17 a2 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106326:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106329:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010632d:	66 83 f8 01          	cmp    $0x1,%ax
80106331:	75 1c                	jne    8010634f <sys_unlink+0x17d>
    dp->nlink--;
80106333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106336:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010633a:	8d 50 ff             	lea    -0x1(%eax),%edx
8010633d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106340:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106344:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106347:	89 04 24             	mov    %eax,(%esp)
8010634a:	e8 5d b3 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
8010634f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106352:	89 04 24             	mov    %eax,(%esp)
80106355:	e8 92 b7 ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
8010635a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635d:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80106371:	e8 36 b3 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106376:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106379:	89 04 24             	mov    %eax,(%esp)
8010637c:	e8 6b b7 ff ff       	call   80101aec <iunlockput>

  commit_trans();
80106381:	e8 e0 ce ff ff       	call   80103266 <commit_trans>

  return 0;
80106386:	b8 00 00 00 00       	mov    $0x0,%eax
8010638b:	eb 16                	jmp    801063a3 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106394:	e8 53 b7 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106399:	e8 c8 ce ff ff       	call   80103266 <commit_trans>
  return -1;
...
801063a8:	83 ec 48             	sub    $0x48,%esp
801063ab:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801063ae:	8b 55 10             	mov    0x10(%ebp),%edx
801063b1:	8b 45 14             	mov    0x14(%ebp),%eax
801063b4:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801063b8:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801063bc:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801063c0:	8d 45 de             	lea    -0x22(%ebp),%eax
801063c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801063c7:	8b 45 08             	mov    0x8(%ebp),%eax
801063ca:	89 04 24             	mov    %eax,(%esp)
801063cd:	e8 5a c0 ff ff       	call   8010242c <nameiparent>
801063d2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801063d5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063d9:	75 0a                	jne    801063e5 <create+0x40>
    return 0;
801063db:	b8 00 00 00 00       	mov    $0x0,%eax
801063e0:	e9 7e 01 00 00       	jmp    80106563 <create+0x1be>
  ilock(dp);
801063e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e8:	89 04 24             	mov    %eax,(%esp)
801063eb:	e8 78 b4 ff ff       	call   80101868 <ilock>
...
80106404:	e8 78 bc ff ff       	call   80102081 <dirlookup>
80106409:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010640c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106410:	74 47                	je     80106459 <create+0xb4>
    iunlockput(dp);
80106412:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106415:	89 04 24             	mov    %eax,(%esp)
80106418:	e8 cf b6 ff ff       	call   80101aec <iunlockput>
    ilock(ip);
8010641d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106420:	89 04 24             	mov    %eax,(%esp)
80106423:	e8 40 b4 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106428:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010642d:	75 15                	jne    80106444 <create+0x9f>
8010642f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106432:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106436:	66 83 f8 02          	cmp    $0x2,%ax
8010643a:	75 08                	jne    80106444 <create+0x9f>
      return ip;
8010643c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010643f:	e9 1f 01 00 00       	jmp    80106563 <create+0x1be>
    iunlockput(ip);
80106444:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106447:	89 04 24             	mov    %eax,(%esp)
8010644a:	e8 9d b6 ff ff       	call   80101aec <iunlockput>
    return 0;
8010644f:	b8 00 00 00 00       	mov    $0x0,%eax
80106454:	e9 0a 01 00 00       	jmp    80106563 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106459:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80106469:	e8 61 b1 ff ff       	call   801015cf <ialloc>
8010646e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106471:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106475:	75 0c                	jne    80106483 <create+0xde>
    panic("create: ialloc");
80106477:	c7 04 24 35 93 10 80 	movl   $0x80109335,(%esp)
8010647e:	e8 ba a0 ff ff       	call   8010053d <panic>

  ilock(ip);
80106483:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106486:	89 04 24             	mov    %eax,(%esp)
80106489:	e8 da b3 ff ff       	call   80101868 <ilock>
  ip->major = major;
8010648e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106491:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106495:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106499:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010649c:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801064a0:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801064a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064a7:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801064ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064b0:	89 04 24             	mov    %eax,(%esp)
801064b3:	e8 f4 b1 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801064b8:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801064bd:	75 6a                	jne    80106529 <create+0x184>
    dp->nlink++;  // for ".."
801064bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064c2:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801064c6:	8d 50 01             	lea    0x1(%eax),%edx
...
801064d6:	e8 d1 b1 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801064db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064de:	8b 40 04             	mov    0x4(%eax),%eax
801064e1:	89 44 24 08          	mov    %eax,0x8(%esp)
801064e5:	c7 44 24 04 0f 93 10 	movl   $0x8010930f,0x4(%esp)
801064ec:	80 
801064ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064f0:	89 04 24             	mov    %eax,(%esp)
801064f3:	e8 51 bc ff ff       	call   80102149 <dirlink>
801064f8:	85 c0                	test   %eax,%eax
801064fa:	78 21                	js     8010651d <create+0x178>
801064fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ff:	8b 40 04             	mov    0x4(%eax),%eax
80106502:	89 44 24 08          	mov    %eax,0x8(%esp)
80106506:	c7 44 24 04 11 93 10 	movl   $0x80109311,0x4(%esp)
8010650d:	80 
...
8010651b:	79 0c                	jns    80106529 <create+0x184>
      panic("create dots");
8010651d:	c7 04 24 44 93 10 80 	movl   $0x80109344,(%esp)
80106524:	e8 14 a0 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106529:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010652c:	8b 40 04             	mov    0x4(%eax),%eax
8010652f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106533:	8d 45 de             	lea    -0x22(%ebp),%eax
80106536:	89 44 24 04          	mov    %eax,0x4(%esp)
8010653a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010653d:	89 04 24             	mov    %eax,(%esp)
80106540:	e8 04 bc ff ff       	call   80102149 <dirlink>
80106545:	85 c0                	test   %eax,%eax
80106547:	79 0c                	jns    80106555 <create+0x1b0>
    panic("create: dirlink");
80106549:	c7 04 24 50 93 10 80 	movl   $0x80109350,(%esp)
80106550:	e8 e8 9f ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106555:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106558:	89 04 24             	mov    %eax,(%esp)
8010655b:	e8 8c b5 ff ff       	call   80101aec <iunlockput>
...
80106568:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010656b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010656e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106572:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106579:	e8 a2 f6 ff ff       	call   80105c20 <argstr>
8010657e:	85 c0                	test   %eax,%eax
80106580:	78 17                	js     80106599 <sys_open+0x34>
80106582:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106585:	89 44 24 04          	mov    %eax,0x4(%esp)
80106589:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106590:	e8 f1 f5 ff ff       	call   80105b86 <argint>
80106595:	85 c0                	test   %eax,%eax
80106597:	79 0a                	jns    801065a3 <sys_open+0x3e>
    return -1;
80106599:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010659e:	e9 46 01 00 00       	jmp    801066e9 <sys_open+0x184>
  if(omode & O_CREATE){
801065a3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065a6:	25 00 02 00 00       	and    $0x200,%eax
801065ab:	85 c0                	test   %eax,%eax
801065ad:	74 40                	je     801065ef <sys_open+0x8a>
    begin_trans();
801065af:	e8 69 cc ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
801065b4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801065b7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801065be:	00 
801065bf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801065c6:	00 
801065c7:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801065ce:	00 
801065cf:	89 04 24             	mov    %eax,(%esp)
801065d2:	e8 ce fd ff ff       	call   801063a5 <create>
801065d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801065da:	e8 87 cc ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
801065df:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801065e3:	75 5c                	jne    80106641 <sys_open+0xdc>
      return -1;
801065e5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065ea:	e9 fa 00 00 00       	jmp    801066e9 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
801065ef:	8b 45 e8             	mov    -0x18(%ebp),%eax
801065f2:	89 04 24             	mov    %eax,(%esp)
801065f5:	e8 10 be ff ff       	call   8010240a <namei>
801065fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106601:	75 0a                	jne    8010660d <sys_open+0xa8>
      return -1;
80106603:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106608:	e9 dc 00 00 00       	jmp    801066e9 <sys_open+0x184>
    ilock(ip);
8010660d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106610:	89 04 24             	mov    %eax,(%esp)
80106613:	e8 50 b2 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106618:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010661f:	66 83 f8 01          	cmp    $0x1,%ax
80106623:	75 1c                	jne    80106641 <sys_open+0xdc>
80106625:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106628:	85 c0                	test   %eax,%eax
8010662a:	74 15                	je     80106641 <sys_open+0xdc>
      iunlockput(ip);
8010662c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010662f:	89 04 24             	mov    %eax,(%esp)
80106632:	e8 b5 b4 ff ff       	call   80101aec <iunlockput>
      return -1;
80106637:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010663c:	e9 a8 00 00 00       	jmp    801066e9 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106641:	e8 d6 a8 ff ff       	call   80100f1c <filealloc>
80106646:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106649:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010664d:	74 14                	je     80106663 <sys_open+0xfe>
8010664f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106652:	89 04 24             	mov    %eax,(%esp)
80106655:	e8 43 f7 ff ff       	call   80105d9d <fdalloc>
8010665a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010665d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106661:	79 23                	jns    80106686 <sys_open+0x121>
    if(f)
80106663:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106667:	74 0b                	je     80106674 <sys_open+0x10f>
      fileclose(f);
80106669:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010666c:	89 04 24             	mov    %eax,(%esp)
8010666f:	e8 50 a9 ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
...
80106684:	eb 63                	jmp    801066e9 <sys_open+0x184>
  }
  iunlock(ip);
...
80106694:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010669a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010669d:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066a0:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
801066a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066a6:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
801066ad:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066b0:	83 e0 01             	and    $0x1,%eax
801066b3:	85 c0                	test   %eax,%eax
801066b5:	0f 94 c2             	sete   %dl
801066b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066bb:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801066be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066c1:	83 e0 01             	and    $0x1,%eax
801066c4:	84 c0                	test   %al,%al
801066c6:	75 0a                	jne    801066d2 <sys_open+0x16d>
801066c8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066cb:	83 e0 02             	and    $0x2,%eax
801066ce:	85 c0                	test   %eax,%eax
801066d0:	74 07                	je     801066d9 <sys_open+0x174>
801066d2:	b8 01 00 00 00       	mov    $0x1,%eax
801066d7:	eb 05                	jmp    801066de <sys_open+0x179>
801066d9:	b8 00 00 00 00       	mov    $0x0,%eax
801066de:	89 c2                	mov    %eax,%edx
801066e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066e3:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
801066e6:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
801066e9:	c9                   	leave  
801066ea:	c3                   	ret    
...
801066ee:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
801066f1:	e8 27 cb ff ff       	call   8010321d <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801066f6:	8d 45 f0             	lea    -0x10(%ebp),%eax
801066f9:	89 44 24 04          	mov    %eax,0x4(%esp)
801066fd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106704:	e8 17 f5 ff ff       	call   80105c20 <argstr>
80106709:	85 c0                	test   %eax,%eax
8010670b:	78 2c                	js     80106739 <sys_mkdir+0x4e>
8010670d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106710:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106717:	00 
80106718:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010671f:	00 
80106720:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106727:	00 
80106728:	89 04 24             	mov    %eax,(%esp)
8010672b:	e8 75 fc ff ff       	call   801063a5 <create>
80106730:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106733:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106737:	75 0c                	jne    80106745 <sys_mkdir+0x5a>
    commit_trans();
80106739:	e8 28 cb ff ff       	call   80103266 <commit_trans>
    return -1;
8010673e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106743:	eb 15                	jmp    8010675a <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106745:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106748:	89 04 24             	mov    %eax,(%esp)
8010674b:	e8 9c b3 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106750:	e8 11 cb ff ff       	call   80103266 <commit_trans>
  return 0;
...
8010675f:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80106798:	78 47                	js     801067e1 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010679a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010679d:	89 44 24 04          	mov    %eax,0x4(%esp)
801067a1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801067a8:	e8 d9 f3 ff ff       	call   80105b86 <argint>
  int len;
  int major, minor;
...
801067af:	78 30                	js     801067e1 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801067b1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801067b4:	0f bf c8             	movswl %ax,%ecx
801067b7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801067ba:	0f bf d0             	movswl %ax,%edx
801067bd:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801067c0:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801067c4:	89 54 24 08          	mov    %edx,0x8(%esp)
801067c8:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801067cf:	00 
801067d0:	89 04 24             	mov    %eax,(%esp)
801067d3:	e8 cd fb ff ff       	call   801063a5 <create>
801067d8:	89 45 f0             	mov    %eax,-0x10(%ebp)
801067db:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801067df:	75 0c                	jne    801067ed <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801067e1:	e8 80 ca ff ff       	call   80103266 <commit_trans>
    return -1;
801067e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067eb:	eb 15                	jmp    80106802 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801067ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067f0:	89 04 24             	mov    %eax,(%esp)
801067f3:	e8 f4 b2 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801067f8:	e8 69 ca ff ff       	call   80103266 <commit_trans>
  return 0;
...
80106898:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801068a5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068ac:	e8 6f f3 ff ff       	call   80105c20 <argstr>
801068b1:	85 c0                	test   %eax,%eax
801068b3:	78 1a                	js     801068cf <sys_exec+0x3a>
801068b5:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801068bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801068bf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801068c6:	e8 bb f2 ff ff       	call   80105b86 <argint>
801068cb:	85 c0                	test   %eax,%eax
801068cd:	79 0a                	jns    801068d9 <sys_exec+0x44>
    return -1;
801068cf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068d4:	e9 e2 00 00 00       	jmp    801069bb <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
801068d9:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801068e0:	00 
801068e1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068e8:	00 
801068e9:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801068ef:	89 04 24             	mov    %eax,(%esp)
801068f2:	e8 3f ef ff ff       	call   80105836 <memset>
  for(i=0;; i++){
801068f7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801068fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106901:	83 f8 1f             	cmp    $0x1f,%eax
80106904:	76 0a                	jbe    80106910 <sys_exec+0x7b>
      return -1;
80106906:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010690b:	e9 ab 00 00 00       	jmp    801069bb <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
80106910:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106913:	c1 e0 02             	shl    $0x2,%eax
80106916:	89 c2                	mov    %eax,%edx
80106918:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010691e:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80106921:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106927:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
8010692d:	89 54 24 08          	mov    %edx,0x8(%esp)
80106931:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106935:	89 04 24             	mov    %eax,(%esp)
80106938:	e8 b7 f1 ff ff       	call   80105af4 <fetchint>
8010693d:	85 c0                	test   %eax,%eax
8010693f:	79 07                	jns    80106948 <sys_exec+0xb3>
      return -1;
80106941:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106946:	eb 73                	jmp    801069bb <sys_exec+0x126>
    if(uarg == 0){
80106948:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010694e:	85 c0                	test   %eax,%eax
80106950:	75 26                	jne    80106978 <sys_exec+0xe3>
      argv[i] = 0;
80106952:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106955:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010695c:	00 00 00 00 
      break;
80106960:	90                   	nop
    }
...
80106964:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010696a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010696e:	89 04 24             	mov    %eax,(%esp)
80106971:	e8 86 a1 ff ff       	call   80100afc <exec>
80106976:	eb 43                	jmp    801069bb <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010697b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106982:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106988:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
8010698b:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80106991:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106997:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010699b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010699f:	89 04 24             	mov    %eax,(%esp)
801069a2:	e8 81 f1 ff ff       	call   80105b28 <fetchstr>
801069a7:	85 c0                	test   %eax,%eax
801069a9:	79 07                	jns    801069b2 <sys_exec+0x11d>
      return -1;
801069ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069b0:	eb 09                	jmp    801069bb <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801069b2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
801069b6:	e9 43 ff ff ff       	jmp    801068fe <sys_exec+0x69>
  return exec(path, argv);
}
801069bb:	c9                   	leave  
801069bc:	c3                   	ret    
...
801069c0:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801069c3:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801069ca:	00 
801069cb:	8d 45 ec             	lea    -0x14(%ebp),%eax
801069ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069d9:	e8 e0 f1 ff ff       	call   80105bbe <argptr>
801069de:	85 c0                	test   %eax,%eax
801069e0:	79 0a                	jns    801069ec <sys_pipe+0x2f>
    return -1;
801069e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069e7:	e9 9b 00 00 00       	jmp    80106a87 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801069ec:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801069ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f3:	8d 45 e8             	lea    -0x18(%ebp),%eax
801069f6:	89 04 24             	mov    %eax,(%esp)
801069f9:	e8 3a d2 ff ff       	call   80103c38 <pipealloc>
801069fe:	85 c0                	test   %eax,%eax
80106a00:	79 07                	jns    80106a09 <sys_pipe+0x4c>
    return -1;
80106a02:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a07:	eb 7e                	jmp    80106a87 <sys_pipe+0xca>
  fd0 = -1;
80106a09:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106a10:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106a13:	89 04 24             	mov    %eax,(%esp)
80106a16:	e8 82 f3 ff ff       	call   80105d9d <fdalloc>
80106a1b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106a1e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106a22:	78 14                	js     80106a38 <sys_pipe+0x7b>
80106a24:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106a27:	89 04 24             	mov    %eax,(%esp)
80106a2a:	e8 6e f3 ff ff       	call   80105d9d <fdalloc>
80106a2f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106a32:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106a36:	79 37                	jns    80106a6f <sys_pipe+0xb2>
    if(fd0 >= 0)
80106a38:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106a3c:	78 14                	js     80106a52 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106a3e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a44:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106a47:	83 c2 08             	add    $0x8,%edx
80106a4a:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106a51:	00 
    fileclose(rf);
80106a52:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106a55:	89 04 24             	mov    %eax,(%esp)
80106a58:	e8 67 a5 ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
80106a5d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106a60:	89 04 24             	mov    %eax,(%esp)
80106a63:	e8 5c a5 ff ff       	call   80100fc4 <fileclose>
    return -1;
80106a68:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a6d:	eb 18                	jmp    80106a87 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106a6f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a72:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106a75:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106a77:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a7a:	8d 50 04             	lea    0x4(%eax),%edx
80106a7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a80:	89 02                	mov    %eax,(%edx)
  return 0;
80106a82:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106a87:	c9                   	leave  
80106a88:	c3                   	ret    
80106a89:	00 00                	add    %al,(%eax)
	...
...
80106a8f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106a92:	e8 09 d9 ff ff       	call   801043a0 <fork>
}
80106a97:	c9                   	leave  
80106a98:	c3                   	ret    
...
80106a9c:	83 ec 08             	sub    $0x8,%esp
  exit();
80106a9f:	e8 e4 e3 ff ff       	call   80104e88 <exit>
...
80106aae:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106ab1:	e8 ed e4 ff ff       	call   80104fa3 <wait>
}
80106ab6:	c9                   	leave  
80106ab7:	c3                   	ret    
...
80106acc:	e8 b5 f0 ff ff       	call   80105b86 <argint>
80106ad1:	85 c0                	test   %eax,%eax
80106ad3:	79 07                	jns    80106adc <sys_kill+0x24>
    return -1;
80106ad5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ada:	eb 0b                	jmp    80106ae7 <sys_kill+0x2f>
  return kill(pid);
80106adc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106adf:	89 04 24             	mov    %eax,(%esp)
80106ae2:	e8 21 e9 ff ff       	call   80105408 <kill>
}
80106ae7:	c9                   	leave  
80106ae8:	c3                   	ret    
...
80106af2:	8b 40 10             	mov    0x10(%eax),%eax
}
80106af5:	5d                   	pop    %ebp
80106af6:	c3                   	ret    
...
80106b0b:	e8 76 f0 ff ff       	call   80105b86 <argint>
80106b10:	85 c0                	test   %eax,%eax
80106b12:	79 07                	jns    80106b1b <sys_sbrk+0x24>
    return -1;
80106b14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b19:	eb 24                	jmp    80106b3f <sys_sbrk+0x48>
  addr = proc->sz;
80106b1b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b21:	8b 00                	mov    (%eax),%eax
80106b23:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106b26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b29:	89 04 24             	mov    %eax,(%esp)
80106b2c:	e8 ca d7 ff ff       	call   801042fb <growproc>
80106b31:	85 c0                	test   %eax,%eax
80106b33:	79 07                	jns    80106b3c <sys_sbrk+0x45>
    return -1;
80106b35:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b3a:	eb 03                	jmp    80106b3f <sys_sbrk+0x48>
  return addr;
...
80106b44:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
80106b47:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b4a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b4e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b55:	e8 2c f0 ff ff       	call   80105b86 <argint>
80106b5a:	85 c0                	test   %eax,%eax
80106b5c:	79 07                	jns    80106b65 <sys_sleep+0x24>
    return -1;
80106b5e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b63:	eb 6c                	jmp    80106bd1 <sys_sleep+0x90>
  acquire(&tickslock);
80106b65:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106b6c:	e8 76 ea ff ff       	call   801055e7 <acquire>
  ticks0 = ticks;
80106b71:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106b76:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106b79:	eb 34                	jmp    80106baf <sys_sleep+0x6e>
    if(proc->killed){
80106b7b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b81:	8b 40 24             	mov    0x24(%eax),%eax
80106b84:	85 c0                	test   %eax,%eax
80106b86:	74 13                	je     80106b9b <sys_sleep+0x5a>
      release(&tickslock);
80106b88:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106b8f:	e8 b5 ea ff ff       	call   80105649 <release>
      return -1;
80106b94:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b99:	eb 36                	jmp    80106bd1 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106b9b:	c7 44 24 04 c0 53 11 	movl   $0x801153c0,0x4(%esp)
80106ba2:	80 
80106ba3:	c7 04 24 00 5c 11 80 	movl   $0x80115c00,(%esp)
80106baa:	e8 52 e7 ff ff       	call   80105301 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106baf:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106bb4:	89 c2                	mov    %eax,%edx
80106bb6:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106bb9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bbc:	39 c2                	cmp    %eax,%edx
80106bbe:	72 bb                	jb     80106b7b <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106bc0:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106bc7:	e8 7d ea ff ff       	call   80105649 <release>
  return 0;
...
80106bd6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106bd9:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106be0:	e8 02 ea ff ff       	call   801055e7 <acquire>
  xticks = ticks;
80106be5:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106bea:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106bed:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106bf4:	e8 50 ea ff ff       	call   80105649 <release>
  return xticks;
...
80106c04:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106c0b:	00 
80106c0c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106c0f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c13:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c1a:	e8 9f ef ff ff       	call   80105bbe <argptr>
  argptr(1,&stack,sizeof(stack));
80106c1f:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106c26:	00 
80106c27:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c2a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106c35:	e8 84 ef ff ff       	call   80105bbe <argptr>
  argint(2,&stack_size);
80106c3a:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106c3d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c41:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106c48:	e8 39 ef ff ff       	call   80105b86 <argint>
...
80106c52:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106c55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c58:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106c5c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106c60:	89 04 24             	mov    %eax,(%esp)
80106c63:	e8 9b d8 ff ff       	call   80104503 <thread_create>
}
80106c68:	c9                   	leave  
80106c69:	c3                   	ret    

80106c6a <sys_thread_getId>:
...
80106c6d:	83 ec 08             	sub    $0x8,%esp
    return thread_getId();
80106c70:	e8 2e db ff ff       	call   801047a3 <thread_getId>
}
80106c75:	c9                   	leave  
80106c76:	c3                   	ret    

80106c77 <sys_thread_getProcId>:
...
80106c7d:	e8 2f db ff ff       	call   801047b1 <thread_getProcId>
}
80106c82:	c9                   	leave  
80106c83:	c3                   	ret    

80106c84 <sys_thread_join>:
...
80106c98:	e8 e9 ee ff ff       	call   80105b86 <argint>
  argptr(1,&ret_val,sizeof(ret_val));
80106c9d:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106ca4:	00 
80106ca5:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106ca8:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106cb3:	e8 06 ef ff ff       	call   80105bbe <argptr>
  return thread_join(thread_id,(void**)&ret_val);
80106cb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cbb:	8d 55 f0             	lea    -0x10(%ebp),%edx
80106cbe:	89 54 24 04          	mov    %edx,0x4(%esp)
80106cc2:	89 04 24             	mov    %eax,(%esp)
80106cc5:	e8 10 db ff ff       	call   801047da <thread_join>
}
80106cca:	c9                   	leave  
80106ccb:	c3                   	ret    

80106ccc <sys_thread_exit>:
...
80106ccf:	83 ec 28             	sub    $0x28,%esp
    char* ret_val;
    argptr(0,&ret_val,sizeof(ret_val));
80106cd2:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106cd9:	00 
80106cda:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106cdd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ce1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ce8:	e8 d1 ee ff ff       	call   80105bbe <argptr>
    thread_exit((void*)ret_val);
80106ced:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cf0:	89 04 24             	mov    %eax,(%esp)
80106cf3:	e8 bb dc ff ff       	call   801049b3 <thread_exit>
    return 0; // not reached
...
80106cff <sys_binary_semaphore_create>:
...
80106d05:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d08:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d0c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d13:	e8 6e ee ff ff       	call   80105b86 <argint>
  return binary_semaphore_create(initial_value);
80106d18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d1b:	89 04 24             	mov    %eax,(%esp)
80106d1e:	e8 42 de ff ff       	call   80104b65 <binary_semaphore_create>
}
80106d23:	c9                   	leave  
80106d24:	c3                   	ret    

80106d25 <sys_binary_semaphore_down>:
...
80106d2b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d32:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d39:	e8 48 ee ff ff       	call   80105b86 <argint>
  return binary_semaphore_down(binary_semaphore_ID);
80106d3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d41:	89 04 24             	mov    %eax,(%esp)
80106d44:	e8 8a de ff ff       	call   80104bd3 <binary_semaphore_down>
}
80106d49:	c9                   	leave  
80106d4a:	c3                   	ret    

80106d4b <sys_binary_semaphore_up>:
int 
...
80106d7a:	8b 55 08             	mov    0x8(%ebp),%edx
80106d7d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d80:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106d84:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106d87:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106d8b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106d8f:	ee                   	out    %al,(%dx)
}
80106d90:	c9                   	leave  
80106d91:	c3                   	ret    
...
80106d98:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106d9f:	00 
80106da0:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106da7:	e8 c8 ff ff ff       	call   80106d74 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106dac:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106db3:	00 
80106db4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106dbb:	e8 b4 ff ff ff       	call   80106d74 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106dc0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106dc7:	00 
80106dc8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106dcf:	e8 a0 ff ff ff       	call   80106d74 <outb>
  picenable(IRQ_TIMER);
80106dd4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ddb:	e8 e1 cc ff ff       	call   80103ac1 <picenable>
}
80106de0:	c9                   	leave  
80106de1:	c3                   	ret    
	...
...
80106de5:	06                   	push   %es
  pushl %fs
80106de6:	0f a0                	push   %fs
  pushl %gs
80106de8:	0f a8                	push   %gs
  pushal
80106dea:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106deb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106def:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106df1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106df3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106df7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106df9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106dfb:	54                   	push   %esp
  call trap
80106dfc:	e8 de 01 00 00       	call   80106fdf <trap>
  addl $4, %esp
80106e01:	83 c4 04             	add    $0x4,%esp
...
80106e04:	61                   	popa   
  popl %gs
80106e05:	0f a9                	pop    %gs
  popl %fs
80106e07:	0f a1                	pop    %fs
  popl %es
80106e09:	07                   	pop    %es
  popl %ds
80106e0a:	1f                   	pop    %ds
...
80106e13:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106e16:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e19:	83 e8 01             	sub    $0x1,%eax
80106e1c:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106e20:	8b 45 08             	mov    0x8(%ebp),%eax
80106e23:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106e27:	8b 45 08             	mov    0x8(%ebp),%eax
80106e2a:	c1 e8 10             	shr    $0x10,%eax
80106e2d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106e31:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106e34:	0f 01 18             	lidtl  (%eax)
}
80106e37:	c9                   	leave  
80106e38:	c3                   	ret    
...
80106e3c:	53                   	push   %ebx
80106e3d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106e40:	0f 20 d3             	mov    %cr2,%ebx
80106e43:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
...
80106e52:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106e55:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106e5c:	e9 c3 00 00 00       	jmp    80106f24 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106e61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e64:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106e6b:	89 c2                	mov    %eax,%edx
80106e6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e70:	66 89 14 c5 00 54 11 	mov    %dx,-0x7feeac00(,%eax,8)
80106e77:	80 
80106e78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e7b:	66 c7 04 c5 02 54 11 	movw   $0x8,-0x7feeabfe(,%eax,8)
80106e82:	80 08 00 
80106e85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e88:	0f b6 14 c5 04 54 11 	movzbl -0x7feeabfc(,%eax,8),%edx
80106e8f:	80 
80106e90:	83 e2 e0             	and    $0xffffffe0,%edx
80106e93:	88 14 c5 04 54 11 80 	mov    %dl,-0x7feeabfc(,%eax,8)
80106e9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e9d:	0f b6 14 c5 04 54 11 	movzbl -0x7feeabfc(,%eax,8),%edx
80106ea4:	80 
80106ea5:	83 e2 1f             	and    $0x1f,%edx
80106ea8:	88 14 c5 04 54 11 80 	mov    %dl,-0x7feeabfc(,%eax,8)
80106eaf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb2:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106eb9:	80 
80106eba:	83 e2 f0             	and    $0xfffffff0,%edx
80106ebd:	83 ca 0e             	or     $0xe,%edx
80106ec0:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106ec7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eca:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106ed1:	80 
80106ed2:	83 e2 ef             	and    $0xffffffef,%edx
80106ed5:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106edc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106edf:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106ee6:	80 
80106ee7:	83 e2 9f             	and    $0xffffff9f,%edx
80106eea:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106ef1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ef4:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106efb:	80 
80106efc:	83 ca 80             	or     $0xffffff80,%edx
80106eff:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106f06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f09:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106f10:	c1 e8 10             	shr    $0x10,%eax
80106f13:	89 c2                	mov    %eax,%edx
80106f15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f18:	66 89 14 c5 06 54 11 	mov    %dx,-0x7feeabfa(,%eax,8)
80106f1f:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106f20:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106f24:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106f2b:	0f 8e 30 ff ff ff    	jle    80106e61 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f31:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106f36:	66 a3 00 56 11 80    	mov    %ax,0x80115600
80106f3c:	66 c7 05 02 56 11 80 	movw   $0x8,0x80115602
80106f43:	08 00 
80106f45:	0f b6 05 04 56 11 80 	movzbl 0x80115604,%eax
80106f4c:	83 e0 e0             	and    $0xffffffe0,%eax
80106f4f:	a2 04 56 11 80       	mov    %al,0x80115604
80106f54:	0f b6 05 04 56 11 80 	movzbl 0x80115604,%eax
80106f5b:	83 e0 1f             	and    $0x1f,%eax
80106f5e:	a2 04 56 11 80       	mov    %al,0x80115604
80106f63:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106f6a:	83 c8 0f             	or     $0xf,%eax
80106f6d:	a2 05 56 11 80       	mov    %al,0x80115605
80106f72:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106f79:	83 e0 ef             	and    $0xffffffef,%eax
80106f7c:	a2 05 56 11 80       	mov    %al,0x80115605
80106f81:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106f88:	83 c8 60             	or     $0x60,%eax
80106f8b:	a2 05 56 11 80       	mov    %al,0x80115605
80106f90:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106f97:	83 c8 80             	or     $0xffffff80,%eax
80106f9a:	a2 05 56 11 80       	mov    %al,0x80115605
80106f9f:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106fa4:	c1 e8 10             	shr    $0x10,%eax
80106fa7:	66 a3 06 56 11 80    	mov    %ax,0x80115606
  
  initlock(&tickslock, "time");
80106fad:	c7 44 24 04 60 93 10 	movl   $0x80109360,0x4(%esp)
80106fb4:	80 
80106fb5:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106fbc:	e8 05 e6 ff ff       	call   801055c6 <initlock>
}
80106fc1:	c9                   	leave  
80106fc2:	c3                   	ret    
...
80106fc6:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106fc9:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106fd0:	00 
80106fd1:	c7 04 24 00 54 11 80 	movl   $0x80115400,(%esp)
80106fd8:	e8 33 fe ff ff       	call   80106e10 <lidt>
}
80106fdd:	c9                   	leave  
80106fde:	c3                   	ret    
...
80106fe5:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106fe8:	8b 45 08             	mov    0x8(%ebp),%eax
80106feb:	8b 40 30             	mov    0x30(%eax),%eax
80106fee:	83 f8 40             	cmp    $0x40,%eax
80106ff1:	75 3e                	jne    80107031 <trap+0x52>
    if(proc->killed)
80106ff3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ff9:	8b 40 24             	mov    0x24(%eax),%eax
80106ffc:	85 c0                	test   %eax,%eax
80106ffe:	74 05                	je     80107005 <trap+0x26>
      exit();
80107000:	e8 83 de ff ff       	call   80104e88 <exit>
    proc->tf = tf;
80107005:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010700b:	8b 55 08             	mov    0x8(%ebp),%edx
8010700e:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80107011:	e8 4d ec ff ff       	call   80105c63 <syscall>
    if(proc->killed)
80107016:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010701c:	8b 40 24             	mov    0x24(%eax),%eax
8010701f:	85 c0                	test   %eax,%eax
80107021:	0f 84 34 02 00 00    	je     8010725b <trap+0x27c>
      exit();
80107027:	e8 5c de ff ff       	call   80104e88 <exit>
    return;
8010702c:	e9 2a 02 00 00       	jmp    8010725b <trap+0x27c>
  }

  switch(tf->trapno){
80107031:	8b 45 08             	mov    0x8(%ebp),%eax
80107034:	8b 40 30             	mov    0x30(%eax),%eax
80107037:	83 e8 20             	sub    $0x20,%eax
8010703a:	83 f8 1f             	cmp    $0x1f,%eax
8010703d:	0f 87 bc 00 00 00    	ja     801070ff <trap+0x120>
80107043:	8b 04 85 08 94 10 80 	mov    -0x7fef6bf8(,%eax,4),%eax
8010704a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
8010704c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107052:	0f b6 00             	movzbl (%eax),%eax
80107055:	84 c0                	test   %al,%al
80107057:	75 31                	jne    8010708a <trap+0xab>
      acquire(&tickslock);
80107059:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80107060:	e8 82 e5 ff ff       	call   801055e7 <acquire>
      ticks++;
80107065:	a1 00 5c 11 80       	mov    0x80115c00,%eax
8010706a:	83 c0 01             	add    $0x1,%eax
8010706d:	a3 00 5c 11 80       	mov    %eax,0x80115c00
      wakeup(&ticks);
80107072:	c7 04 24 00 5c 11 80 	movl   $0x80115c00,(%esp)
80107079:	e8 5f e3 ff ff       	call   801053dd <wakeup>
      release(&tickslock);
8010707e:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80107085:	e8 bf e5 ff ff       	call   80105649 <release>
    }
    lapiceoi();
8010708a:	e8 5a be ff ff       	call   80102ee9 <lapiceoi>
    break;
8010708f:	e9 41 01 00 00       	jmp    801071d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107094:	e8 58 b6 ff ff       	call   801026f1 <ideintr>
    lapiceoi();
80107099:	e8 4b be ff ff       	call   80102ee9 <lapiceoi>
    break;
8010709e:	e9 32 01 00 00       	jmp    801071d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801070a3:	e8 1f bc ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
801070a8:	e8 3c be ff ff       	call   80102ee9 <lapiceoi>
    break;
801070ad:	e9 23 01 00 00       	jmp    801071d5 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801070b2:	e8 a9 03 00 00       	call   80107460 <uartintr>
    lapiceoi();
801070b7:	e8 2d be ff ff       	call   80102ee9 <lapiceoi>
    break;
801070bc:	e9 14 01 00 00       	jmp    801071d5 <trap+0x1f6>
  case T_IRQ0 + 7:
...
801070c1:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801070c4:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801070c7:	8b 45 08             	mov    0x8(%ebp),%eax
801070ca:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801070ce:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801070d1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801070d7:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
801070dd:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801070e1:	89 54 24 08          	mov    %edx,0x8(%esp)
801070e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801070e9:	c7 04 24 68 93 10 80 	movl   $0x80109368,(%esp)
801070f0:	e8 ac 92 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801070f5:	e8 ef bd ff ff       	call   80102ee9 <lapiceoi>
    break;
801070fa:	e9 d6 00 00 00       	jmp    801071d5 <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
801070ff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107105:	85 c0                	test   %eax,%eax
80107107:	74 11                	je     8010711a <trap+0x13b>
80107109:	8b 45 08             	mov    0x8(%ebp),%eax
8010710c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107110:	0f b7 c0             	movzwl %ax,%eax
80107113:	83 e0 03             	and    $0x3,%eax
80107116:	85 c0                	test   %eax,%eax
80107118:	75 46                	jne    80107160 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010711a:	e8 1a fd ff ff       	call   80106e39 <rcr2>
...
8010711f:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107122:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107125:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010712c:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010712f:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107132:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107135:	8b 52 30             	mov    0x30(%edx),%edx
80107138:	89 44 24 10          	mov    %eax,0x10(%esp)
8010713c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107140:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107144:	89 54 24 04          	mov    %edx,0x4(%esp)
80107148:	c7 04 24 8c 93 10 80 	movl   $0x8010938c,(%esp)
8010714f:	e8 4d 92 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80107154:	c7 04 24 be 93 10 80 	movl   $0x801093be,(%esp)
8010715b:	e8 dd 93 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107160:	e8 d4 fc ff ff       	call   80106e39 <rcr2>
...
80107167:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010716a:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010716d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107173:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107176:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107179:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010717c:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010717f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107182:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107185:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010718b:	83 c0 6c             	add    $0x6c,%eax
...
80107191:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107197:	8b 40 10             	mov    0x10(%eax),%eax
8010719a:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010719e:	89 7c 24 18          	mov    %edi,0x18(%esp)
801071a2:	89 74 24 14          	mov    %esi,0x14(%esp)
801071a6:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801071aa:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801071ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801071b1:	89 54 24 08          	mov    %edx,0x8(%esp)
801071b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801071b9:	c7 04 24 c4 93 10 80 	movl   $0x801093c4,(%esp)
801071c0:	e8 dc 91 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801071c5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071cb:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801071d2:	eb 01                	jmp    801071d5 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801071dd:	74 24                	je     80107203 <trap+0x224>
801071df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071e5:	8b 40 24             	mov    0x24(%eax),%eax
801071e8:	85 c0                	test   %eax,%eax
801071ea:	74 17                	je     80107203 <trap+0x224>
...
801071f9:	83 f8 03             	cmp    $0x3,%eax
801071fc:	75 05                	jne    80107203 <trap+0x224>
    exit();
801071fe:	e8 85 dc ff ff       	call   80104e88 <exit>
...
8010720b:	74 1e                	je     8010722b <trap+0x24c>
8010720d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107213:	8b 40 0c             	mov    0xc(%eax),%eax
80107216:	83 f8 04             	cmp    $0x4,%eax
80107219:	75 10                	jne    8010722b <trap+0x24c>
8010721b:	8b 45 08             	mov    0x8(%ebp),%eax
8010721e:	8b 40 30             	mov    0x30(%eax),%eax
80107221:	83 f8 20             	cmp    $0x20,%eax
80107224:	75 05                	jne    8010722b <trap+0x24c>
    yield();
80107226:	e8 78 e0 ff ff       	call   801052a3 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010722b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107231:	85 c0                	test   %eax,%eax
80107233:	74 27                	je     8010725c <trap+0x27d>
80107235:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010723b:	8b 40 24             	mov    0x24(%eax),%eax
8010723e:	85 c0                	test   %eax,%eax
80107240:	74 1a                	je     8010725c <trap+0x27d>
80107242:	8b 45 08             	mov    0x8(%ebp),%eax
80107245:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107249:	0f b7 c0             	movzwl %ax,%eax
8010724c:	83 e0 03             	and    $0x3,%eax
8010724f:	83 f8 03             	cmp    $0x3,%eax
80107252:	75 08                	jne    8010725c <trap+0x27d>
    exit();
80107254:	e8 2f dc ff ff       	call   80104e88 <exit>
80107259:	eb 01                	jmp    8010725c <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
8010725c:	83 c4 3c             	add    $0x3c,%esp
8010725f:	5b                   	pop    %ebx
80107260:	5e                   	pop    %esi
80107261:	5f                   	pop    %edi
80107262:	5d                   	pop    %ebp
...
80107268:	83 ec 14             	sub    $0x14,%esp
8010726b:	8b 45 08             	mov    0x8(%ebp),%eax
8010726e:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107272:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107276:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
8010727a:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010727e:	ec                   	in     (%dx),%al
8010727f:	89 c3                	mov    %eax,%ebx
80107281:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107284:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107288:	83 c4 14             	add    $0x14,%esp
8010728b:	5b                   	pop    %ebx
8010728c:	5d                   	pop    %ebp
8010728d:	c3                   	ret    
...
80107294:	8b 55 08             	mov    0x8(%ebp),%edx
80107297:	8b 45 0c             	mov    0xc(%ebp),%eax
8010729a:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010729e:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801072a1:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801072a5:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801072a9:	ee                   	out    %al,(%dx)
}
801072aa:	c9                   	leave  
801072ab:	c3                   	ret    
...
801072af:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
801072b9:	00 
801072ba:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801072c1:	e8 c8 ff ff ff       	call   8010728e <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801072c6:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801072cd:	00 
801072ce:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801072d5:	e8 b4 ff ff ff       	call   8010728e <outb>
  outb(COM1+0, 115200/9600);
801072da:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801072e1:	00 
801072e2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801072e9:	e8 a0 ff ff ff       	call   8010728e <outb>
  outb(COM1+1, 0);
801072ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072f5:	00 
801072f6:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801072fd:	e8 8c ff ff ff       	call   8010728e <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107302:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107309:	00 
8010730a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107311:	e8 78 ff ff ff       	call   8010728e <outb>
  outb(COM1+4, 0);
80107316:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010731d:	00 
8010731e:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107325:	e8 64 ff ff ff       	call   8010728e <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010732a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107331:	00 
80107332:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107339:	e8 50 ff ff ff       	call   8010728e <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010733e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107345:	e8 1a ff ff ff       	call   80107264 <inb>
8010734a:	3c ff                	cmp    $0xff,%al
8010734c:	74 6c                	je     801073ba <uartinit+0x10e>
    return;
  uart = 1;
8010734e:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107355:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107358:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010735f:	e8 00 ff ff ff       	call   80107264 <inb>
  inb(COM1+0);
80107364:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010736b:	e8 f4 fe ff ff       	call   80107264 <inb>
  picenable(IRQ_COM1);
80107370:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107377:	e8 45 c7 ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010737c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107383:	00 
80107384:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010738b:	e8 e6 b5 ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107390:	c7 45 f4 88 94 10 80 	movl   $0x80109488,-0xc(%ebp)
80107397:	eb 15                	jmp    801073ae <uartinit+0x102>
    uartputc(*p);
80107399:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010739c:	0f b6 00             	movzbl (%eax),%eax
8010739f:	0f be c0             	movsbl %al,%eax
801073a2:	89 04 24             	mov    %eax,(%esp)
801073a5:	e8 13 00 00 00       	call   801073bd <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
801073b1:	0f b6 00             	movzbl (%eax),%eax
801073b4:	84 c0                	test   %al,%al
801073b6:	75 e1                	jne    80107399 <uartinit+0xed>
801073b8:	eb 01                	jmp    801073bb <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801073c0:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
801073c3:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801073c8:	85 c0                	test   %eax,%eax
801073ca:	74 4d                	je     80107419 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801073cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801073d3:	eb 10                	jmp    801073e5 <uartputc+0x28>
    microdelay(10);
801073d5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801073dc:	e8 2d bb ff ff       	call   80102f0e <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801073e1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801073e5:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801073e9:	7f 16                	jg     80107401 <uartputc+0x44>
801073eb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801073f2:	e8 6d fe ff ff       	call   80107264 <inb>
801073f7:	0f b6 c0             	movzbl %al,%eax
801073fa:	83 e0 20             	and    $0x20,%eax
801073fd:	85 c0                	test   %eax,%eax
801073ff:	74 d4                	je     801073d5 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80107401:	8b 45 08             	mov    0x8(%ebp),%eax
80107404:	0f b6 c0             	movzbl %al,%eax
80107407:	89 44 24 04          	mov    %eax,0x4(%esp)
8010740b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107412:	e8 77 fe ff ff       	call   8010728e <outb>
80107417:	eb 01                	jmp    8010741a <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010741f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107422:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107427:	85 c0                	test   %eax,%eax
80107429:	75 07                	jne    80107432 <uartgetc+0x16>
    return -1;
8010742b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107430:	eb 2c                	jmp    8010745e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107432:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107439:	e8 26 fe ff ff       	call   80107264 <inb>
8010743e:	0f b6 c0             	movzbl %al,%eax
80107441:	83 e0 01             	and    $0x1,%eax
80107444:	85 c0                	test   %eax,%eax
80107446:	75 07                	jne    8010744f <uartgetc+0x33>
    return -1;
80107448:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010744d:	eb 0f                	jmp    8010745e <uartgetc+0x42>
  return inb(COM1+0);
8010744f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107456:	e8 09 fe ff ff       	call   80107264 <inb>
...
80107466:	c7 04 24 1c 74 10 80 	movl   $0x8010741c,(%esp)
8010746d:	e8 3b 93 ff ff       	call   801007ad <consoleintr>
}
80107472:	c9                   	leave  
80107473:	c3                   	ret    
...
80107476:	6a 00                	push   $0x0
  jmp alltraps
80107478:	e9 67 f9 ff ff       	jmp    80106de4 <alltraps>
...
8010747d:	6a 00                	push   $0x0
  pushl $1
8010747f:	6a 01                	push   $0x1
  jmp alltraps
80107481:	e9 5e f9 ff ff       	jmp    80106de4 <alltraps>
...
80107486:	6a 00                	push   $0x0
  pushl $2
80107488:	6a 02                	push   $0x2
  jmp alltraps
8010748a:	e9 55 f9 ff ff       	jmp    80106de4 <alltraps>
...
8010748f:	6a 00                	push   $0x0
  pushl $3
80107491:	6a 03                	push   $0x3
  jmp alltraps
80107493:	e9 4c f9 ff ff       	jmp    80106de4 <alltraps>
...
80107498:	6a 00                	push   $0x0
  pushl $4
8010749a:	6a 04                	push   $0x4
  jmp alltraps
8010749c:	e9 43 f9 ff ff       	jmp    80106de4 <alltraps>
...
801074a1:	6a 00                	push   $0x0
  pushl $5
801074a3:	6a 05                	push   $0x5
  jmp alltraps
801074a5:	e9 3a f9 ff ff       	jmp    80106de4 <alltraps>
...
801074aa:	6a 00                	push   $0x0
  pushl $6
801074ac:	6a 06                	push   $0x6
  jmp alltraps
801074ae:	e9 31 f9 ff ff       	jmp    80106de4 <alltraps>
...
801074b3:	6a 00                	push   $0x0
  pushl $7
801074b5:	6a 07                	push   $0x7
  jmp alltraps
801074b7:	e9 28 f9 ff ff       	jmp    80106de4 <alltraps>

801074bc <vector8>:
.globl vector8
vector8:
  pushl $8
801074bc:	6a 08                	push   $0x8
  jmp alltraps
801074be:	e9 21 f9 ff ff       	jmp    80106de4 <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $9
801074c5:	6a 09                	push   $0x9
  jmp alltraps
801074c7:	e9 18 f9 ff ff       	jmp    80106de4 <alltraps>

801074cc <vector10>:
.globl vector10
vector10:
  pushl $10
801074cc:	6a 0a                	push   $0xa
  jmp alltraps
801074ce:	e9 11 f9 ff ff       	jmp    80106de4 <alltraps>

801074d3 <vector11>:
.globl vector11
vector11:
  pushl $11
801074d3:	6a 0b                	push   $0xb
  jmp alltraps
801074d5:	e9 0a f9 ff ff       	jmp    80106de4 <alltraps>

801074da <vector12>:
.globl vector12
vector12:
  pushl $12
801074da:	6a 0c                	push   $0xc
  jmp alltraps
801074dc:	e9 03 f9 ff ff       	jmp    80106de4 <alltraps>

801074e1 <vector13>:
.globl vector13
vector13:
  pushl $13
801074e1:	6a 0d                	push   $0xd
  jmp alltraps
801074e3:	e9 fc f8 ff ff       	jmp    80106de4 <alltraps>

801074e8 <vector14>:
.globl vector14
vector14:
  pushl $14
801074e8:	6a 0e                	push   $0xe
  jmp alltraps
801074ea:	e9 f5 f8 ff ff       	jmp    80106de4 <alltraps>
...
801074ef:	6a 00                	push   $0x0
  pushl $15
801074f1:	6a 0f                	push   $0xf
  jmp alltraps
801074f3:	e9 ec f8 ff ff       	jmp    80106de4 <alltraps>
...
801074f8:	6a 00                	push   $0x0
  pushl $16
801074fa:	6a 10                	push   $0x10
  jmp alltraps
801074fc:	e9 e3 f8 ff ff       	jmp    80106de4 <alltraps>

80107501 <vector17>:
.globl vector17
vector17:
  pushl $17
80107501:	6a 11                	push   $0x11
  jmp alltraps
80107503:	e9 dc f8 ff ff       	jmp    80106de4 <alltraps>
...
80107508:	6a 00                	push   $0x0
  pushl $18
8010750a:	6a 12                	push   $0x12
  jmp alltraps
8010750c:	e9 d3 f8 ff ff       	jmp    80106de4 <alltraps>
...
80107511:	6a 00                	push   $0x0
  pushl $19
80107513:	6a 13                	push   $0x13
  jmp alltraps
80107515:	e9 ca f8 ff ff       	jmp    80106de4 <alltraps>
...
8010751a:	6a 00                	push   $0x0
  pushl $20
8010751c:	6a 14                	push   $0x14
  jmp alltraps
8010751e:	e9 c1 f8 ff ff       	jmp    80106de4 <alltraps>
...
80107523:	6a 00                	push   $0x0
  pushl $21
80107525:	6a 15                	push   $0x15
  jmp alltraps
80107527:	e9 b8 f8 ff ff       	jmp    80106de4 <alltraps>
...
8010752c:	6a 00                	push   $0x0
  pushl $22
8010752e:	6a 16                	push   $0x16
  jmp alltraps
80107530:	e9 af f8 ff ff       	jmp    80106de4 <alltraps>
...
80107535:	6a 00                	push   $0x0
  pushl $23
80107537:	6a 17                	push   $0x17
  jmp alltraps
80107539:	e9 a6 f8 ff ff       	jmp    80106de4 <alltraps>
...
8010753e:	6a 00                	push   $0x0
  pushl $24
80107540:	6a 18                	push   $0x18
  jmp alltraps
80107542:	e9 9d f8 ff ff       	jmp    80106de4 <alltraps>
...
80107547:	6a 00                	push   $0x0
  pushl $25
80107549:	6a 19                	push   $0x19
  jmp alltraps
8010754b:	e9 94 f8 ff ff       	jmp    80106de4 <alltraps>
...
80107550:	6a 00                	push   $0x0
  pushl $26
80107552:	6a 1a                	push   $0x1a
  jmp alltraps
80107554:	e9 8b f8 ff ff       	jmp    80106de4 <alltraps>
...
80107559:	6a 00                	push   $0x0
  pushl $27
8010755b:	6a 1b                	push   $0x1b
  jmp alltraps
8010755d:	e9 82 f8 ff ff       	jmp    80106de4 <alltraps>
...
80107562:	6a 00                	push   $0x0
  pushl $28
80107564:	6a 1c                	push   $0x1c
  jmp alltraps
80107566:	e9 79 f8 ff ff       	jmp    80106de4 <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $29
8010756d:	6a 1d                	push   $0x1d
  jmp alltraps
8010756f:	e9 70 f8 ff ff       	jmp    80106de4 <alltraps>
...
80107574:	6a 00                	push   $0x0
  pushl $30
80107576:	6a 1e                	push   $0x1e
  jmp alltraps
80107578:	e9 67 f8 ff ff       	jmp    80106de4 <alltraps>
...
8010757d:	6a 00                	push   $0x0
  pushl $31
8010757f:	6a 1f                	push   $0x1f
  jmp alltraps
80107581:	e9 5e f8 ff ff       	jmp    80106de4 <alltraps>
...
80107586:	6a 00                	push   $0x0
  pushl $32
80107588:	6a 20                	push   $0x20
  jmp alltraps
8010758a:	e9 55 f8 ff ff       	jmp    80106de4 <alltraps>
...
8010758f:	6a 00                	push   $0x0
  pushl $33
80107591:	6a 21                	push   $0x21
  jmp alltraps
80107593:	e9 4c f8 ff ff       	jmp    80106de4 <alltraps>
...
80107598:	6a 00                	push   $0x0
  pushl $34
8010759a:	6a 22                	push   $0x22
  jmp alltraps
8010759c:	e9 43 f8 ff ff       	jmp    80106de4 <alltraps>
...
801075a1:	6a 00                	push   $0x0
  pushl $35
801075a3:	6a 23                	push   $0x23
  jmp alltraps
801075a5:	e9 3a f8 ff ff       	jmp    80106de4 <alltraps>
...
801075aa:	6a 00                	push   $0x0
  pushl $36
801075ac:	6a 24                	push   $0x24
  jmp alltraps
801075ae:	e9 31 f8 ff ff       	jmp    80106de4 <alltraps>
...
801075b3:	6a 00                	push   $0x0
  pushl $37
801075b5:	6a 25                	push   $0x25
  jmp alltraps
801075b7:	e9 28 f8 ff ff       	jmp    80106de4 <alltraps>
...
801075bc:	6a 00                	push   $0x0
  pushl $38
801075be:	6a 26                	push   $0x26
  jmp alltraps
801075c0:	e9 1f f8 ff ff       	jmp    80106de4 <alltraps>
...
801075c5:	6a 00                	push   $0x0
  pushl $39
801075c7:	6a 27                	push   $0x27
  jmp alltraps
801075c9:	e9 16 f8 ff ff       	jmp    80106de4 <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $40
801075d0:	6a 28                	push   $0x28
  jmp alltraps
801075d2:	e9 0d f8 ff ff       	jmp    80106de4 <alltraps>
...
801075d7:	6a 00                	push   $0x0
  pushl $41
801075d9:	6a 29                	push   $0x29
  jmp alltraps
801075db:	e9 04 f8 ff ff       	jmp    80106de4 <alltraps>
...
801075e0:	6a 00                	push   $0x0
  pushl $42
801075e2:	6a 2a                	push   $0x2a
  jmp alltraps
801075e4:	e9 fb f7 ff ff       	jmp    80106de4 <alltraps>
...
801075e9:	6a 00                	push   $0x0
  pushl $43
801075eb:	6a 2b                	push   $0x2b
  jmp alltraps
801075ed:	e9 f2 f7 ff ff       	jmp    80106de4 <alltraps>
...
801075f2:	6a 00                	push   $0x0
  pushl $44
801075f4:	6a 2c                	push   $0x2c
  jmp alltraps
801075f6:	e9 e9 f7 ff ff       	jmp    80106de4 <alltraps>
...
801075fb:	6a 00                	push   $0x0
  pushl $45
801075fd:	6a 2d                	push   $0x2d
  jmp alltraps
801075ff:	e9 e0 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107604:	6a 00                	push   $0x0
  pushl $46
80107606:	6a 2e                	push   $0x2e
  jmp alltraps
80107608:	e9 d7 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010760d:	6a 00                	push   $0x0
  pushl $47
8010760f:	6a 2f                	push   $0x2f
  jmp alltraps
80107611:	e9 ce f7 ff ff       	jmp    80106de4 <alltraps>
...
80107616:	6a 00                	push   $0x0
  pushl $48
80107618:	6a 30                	push   $0x30
  jmp alltraps
8010761a:	e9 c5 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010761f:	6a 00                	push   $0x0
  pushl $49
80107621:	6a 31                	push   $0x31
  jmp alltraps
80107623:	e9 bc f7 ff ff       	jmp    80106de4 <alltraps>
...
80107628:	6a 00                	push   $0x0
  pushl $50
8010762a:	6a 32                	push   $0x32
  jmp alltraps
8010762c:	e9 b3 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107631:	6a 00                	push   $0x0
  pushl $51
80107633:	6a 33                	push   $0x33
  jmp alltraps
80107635:	e9 aa f7 ff ff       	jmp    80106de4 <alltraps>
...
8010763a:	6a 00                	push   $0x0
  pushl $52
8010763c:	6a 34                	push   $0x34
  jmp alltraps
8010763e:	e9 a1 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $53
80107645:	6a 35                	push   $0x35
  jmp alltraps
80107647:	e9 98 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010764c:	6a 00                	push   $0x0
  pushl $54
8010764e:	6a 36                	push   $0x36
  jmp alltraps
80107650:	e9 8f f7 ff ff       	jmp    80106de4 <alltraps>
...
80107655:	6a 00                	push   $0x0
  pushl $55
80107657:	6a 37                	push   $0x37
  jmp alltraps
80107659:	e9 86 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010765e:	6a 00                	push   $0x0
  pushl $56
80107660:	6a 38                	push   $0x38
  jmp alltraps
80107662:	e9 7d f7 ff ff       	jmp    80106de4 <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $57
80107669:	6a 39                	push   $0x39
  jmp alltraps
8010766b:	e9 74 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107670:	6a 00                	push   $0x0
  pushl $58
80107672:	6a 3a                	push   $0x3a
  jmp alltraps
80107674:	e9 6b f7 ff ff       	jmp    80106de4 <alltraps>
...
80107679:	6a 00                	push   $0x0
  pushl $59
8010767b:	6a 3b                	push   $0x3b
  jmp alltraps
8010767d:	e9 62 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107682:	6a 00                	push   $0x0
  pushl $60
80107684:	6a 3c                	push   $0x3c
  jmp alltraps
80107686:	e9 59 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $61
8010768d:	6a 3d                	push   $0x3d
  jmp alltraps
8010768f:	e9 50 f7 ff ff       	jmp    80106de4 <alltraps>
...
80107694:	6a 00                	push   $0x0
  pushl $62
80107696:	6a 3e                	push   $0x3e
  jmp alltraps
80107698:	e9 47 f7 ff ff       	jmp    80106de4 <alltraps>
...
8010769d:	6a 00                	push   $0x0
  pushl $63
8010769f:	6a 3f                	push   $0x3f
  jmp alltraps
801076a1:	e9 3e f7 ff ff       	jmp    80106de4 <alltraps>
...
801076a6:	6a 00                	push   $0x0
  pushl $64
801076a8:	6a 40                	push   $0x40
  jmp alltraps
801076aa:	e9 35 f7 ff ff       	jmp    80106de4 <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $65
801076b1:	6a 41                	push   $0x41
  jmp alltraps
801076b3:	e9 2c f7 ff ff       	jmp    80106de4 <alltraps>
...
801076b8:	6a 00                	push   $0x0
  pushl $66
801076ba:	6a 42                	push   $0x42
  jmp alltraps
801076bc:	e9 23 f7 ff ff       	jmp    80106de4 <alltraps>
...
801076c1:	6a 00                	push   $0x0
  pushl $67
801076c3:	6a 43                	push   $0x43
  jmp alltraps
801076c5:	e9 1a f7 ff ff       	jmp    80106de4 <alltraps>
...
801076ca:	6a 00                	push   $0x0
  pushl $68
801076cc:	6a 44                	push   $0x44
  jmp alltraps
801076ce:	e9 11 f7 ff ff       	jmp    80106de4 <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $69
801076d5:	6a 45                	push   $0x45
  jmp alltraps
801076d7:	e9 08 f7 ff ff       	jmp    80106de4 <alltraps>
...
801076dc:	6a 00                	push   $0x0
  pushl $70
801076de:	6a 46                	push   $0x46
  jmp alltraps
801076e0:	e9 ff f6 ff ff       	jmp    80106de4 <alltraps>
...
801076e5:	6a 00                	push   $0x0
  pushl $71
801076e7:	6a 47                	push   $0x47
  jmp alltraps
801076e9:	e9 f6 f6 ff ff       	jmp    80106de4 <alltraps>
...
801076ee:	6a 00                	push   $0x0
  pushl $72
801076f0:	6a 48                	push   $0x48
  jmp alltraps
801076f2:	e9 ed f6 ff ff       	jmp    80106de4 <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $73
801076f9:	6a 49                	push   $0x49
  jmp alltraps
801076fb:	e9 e4 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107700:	6a 00                	push   $0x0
  pushl $74
80107702:	6a 4a                	push   $0x4a
  jmp alltraps
80107704:	e9 db f6 ff ff       	jmp    80106de4 <alltraps>
...
80107709:	6a 00                	push   $0x0
  pushl $75
8010770b:	6a 4b                	push   $0x4b
  jmp alltraps
8010770d:	e9 d2 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107712:	6a 00                	push   $0x0
  pushl $76
80107714:	6a 4c                	push   $0x4c
  jmp alltraps
80107716:	e9 c9 f6 ff ff       	jmp    80106de4 <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $77
8010771d:	6a 4d                	push   $0x4d
  jmp alltraps
8010771f:	e9 c0 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107724:	6a 00                	push   $0x0
  pushl $78
80107726:	6a 4e                	push   $0x4e
  jmp alltraps
80107728:	e9 b7 f6 ff ff       	jmp    80106de4 <alltraps>
...
8010772d:	6a 00                	push   $0x0
  pushl $79
8010772f:	6a 4f                	push   $0x4f
  jmp alltraps
80107731:	e9 ae f6 ff ff       	jmp    80106de4 <alltraps>
...
80107736:	6a 00                	push   $0x0
  pushl $80
80107738:	6a 50                	push   $0x50
  jmp alltraps
8010773a:	e9 a5 f6 ff ff       	jmp    80106de4 <alltraps>
...
8010773f:	6a 00                	push   $0x0
  pushl $81
80107741:	6a 51                	push   $0x51
  jmp alltraps
80107743:	e9 9c f6 ff ff       	jmp    80106de4 <alltraps>
...
80107748:	6a 00                	push   $0x0
  pushl $82
8010774a:	6a 52                	push   $0x52
  jmp alltraps
8010774c:	e9 93 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107751:	6a 00                	push   $0x0
  pushl $83
80107753:	6a 53                	push   $0x53
  jmp alltraps
80107755:	e9 8a f6 ff ff       	jmp    80106de4 <alltraps>
...
8010775a:	6a 00                	push   $0x0
  pushl $84
8010775c:	6a 54                	push   $0x54
  jmp alltraps
8010775e:	e9 81 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107763:	6a 00                	push   $0x0
  pushl $85
80107765:	6a 55                	push   $0x55
  jmp alltraps
80107767:	e9 78 f6 ff ff       	jmp    80106de4 <alltraps>
...
8010776c:	6a 00                	push   $0x0
  pushl $86
8010776e:	6a 56                	push   $0x56
  jmp alltraps
80107770:	e9 6f f6 ff ff       	jmp    80106de4 <alltraps>
...
80107775:	6a 00                	push   $0x0
  pushl $87
80107777:	6a 57                	push   $0x57
  jmp alltraps
80107779:	e9 66 f6 ff ff       	jmp    80106de4 <alltraps>
...
8010777e:	6a 00                	push   $0x0
  pushl $88
80107780:	6a 58                	push   $0x58
  jmp alltraps
80107782:	e9 5d f6 ff ff       	jmp    80106de4 <alltraps>
...
80107787:	6a 00                	push   $0x0
  pushl $89
80107789:	6a 59                	push   $0x59
  jmp alltraps
8010778b:	e9 54 f6 ff ff       	jmp    80106de4 <alltraps>
...
80107790:	6a 00                	push   $0x0
  pushl $90
80107792:	6a 5a                	push   $0x5a
  jmp alltraps
80107794:	e9 4b f6 ff ff       	jmp    80106de4 <alltraps>
...
80107799:	6a 00                	push   $0x0
  pushl $91
8010779b:	6a 5b                	push   $0x5b
  jmp alltraps
8010779d:	e9 42 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077a2:	6a 00                	push   $0x0
  pushl $92
801077a4:	6a 5c                	push   $0x5c
  jmp alltraps
801077a6:	e9 39 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077ab:	6a 00                	push   $0x0
  pushl $93
801077ad:	6a 5d                	push   $0x5d
  jmp alltraps
801077af:	e9 30 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077b4:	6a 00                	push   $0x0
  pushl $94
801077b6:	6a 5e                	push   $0x5e
  jmp alltraps
801077b8:	e9 27 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077bd:	6a 00                	push   $0x0
  pushl $95
801077bf:	6a 5f                	push   $0x5f
  jmp alltraps
801077c1:	e9 1e f6 ff ff       	jmp    80106de4 <alltraps>
...
801077c6:	6a 00                	push   $0x0
  pushl $96
801077c8:	6a 60                	push   $0x60
  jmp alltraps
801077ca:	e9 15 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077cf:	6a 00                	push   $0x0
  pushl $97
801077d1:	6a 61                	push   $0x61
  jmp alltraps
801077d3:	e9 0c f6 ff ff       	jmp    80106de4 <alltraps>
...
801077d8:	6a 00                	push   $0x0
  pushl $98
801077da:	6a 62                	push   $0x62
  jmp alltraps
801077dc:	e9 03 f6 ff ff       	jmp    80106de4 <alltraps>
...
801077e1:	6a 00                	push   $0x0
  pushl $99
801077e3:	6a 63                	push   $0x63
  jmp alltraps
801077e5:	e9 fa f5 ff ff       	jmp    80106de4 <alltraps>
...
801077ea:	6a 00                	push   $0x0
  pushl $100
801077ec:	6a 64                	push   $0x64
  jmp alltraps
801077ee:	e9 f1 f5 ff ff       	jmp    80106de4 <alltraps>
...
801077f3:	6a 00                	push   $0x0
  pushl $101
801077f5:	6a 65                	push   $0x65
  jmp alltraps
801077f7:	e9 e8 f5 ff ff       	jmp    80106de4 <alltraps>
...
801077fc:	6a 00                	push   $0x0
  pushl $102
801077fe:	6a 66                	push   $0x66
  jmp alltraps
80107800:	e9 df f5 ff ff       	jmp    80106de4 <alltraps>
...
80107805:	6a 00                	push   $0x0
  pushl $103
80107807:	6a 67                	push   $0x67
  jmp alltraps
80107809:	e9 d6 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010780e:	6a 00                	push   $0x0
  pushl $104
80107810:	6a 68                	push   $0x68
  jmp alltraps
80107812:	e9 cd f5 ff ff       	jmp    80106de4 <alltraps>
...
80107817:	6a 00                	push   $0x0
  pushl $105
80107819:	6a 69                	push   $0x69
  jmp alltraps
8010781b:	e9 c4 f5 ff ff       	jmp    80106de4 <alltraps>
...
80107820:	6a 00                	push   $0x0
  pushl $106
80107822:	6a 6a                	push   $0x6a
  jmp alltraps
80107824:	e9 bb f5 ff ff       	jmp    80106de4 <alltraps>
...
80107829:	6a 00                	push   $0x0
  pushl $107
8010782b:	6a 6b                	push   $0x6b
  jmp alltraps
8010782d:	e9 b2 f5 ff ff       	jmp    80106de4 <alltraps>
...
80107832:	6a 00                	push   $0x0
  pushl $108
80107834:	6a 6c                	push   $0x6c
  jmp alltraps
80107836:	e9 a9 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010783b:	6a 00                	push   $0x0
  pushl $109
8010783d:	6a 6d                	push   $0x6d
  jmp alltraps
8010783f:	e9 a0 f5 ff ff       	jmp    80106de4 <alltraps>
...
80107844:	6a 00                	push   $0x0
  pushl $110
80107846:	6a 6e                	push   $0x6e
  jmp alltraps
80107848:	e9 97 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010784d:	6a 00                	push   $0x0
  pushl $111
8010784f:	6a 6f                	push   $0x6f
  jmp alltraps
80107851:	e9 8e f5 ff ff       	jmp    80106de4 <alltraps>
...
80107856:	6a 00                	push   $0x0
  pushl $112
80107858:	6a 70                	push   $0x70
  jmp alltraps
8010785a:	e9 85 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010785f:	6a 00                	push   $0x0
  pushl $113
80107861:	6a 71                	push   $0x71
  jmp alltraps
80107863:	e9 7c f5 ff ff       	jmp    80106de4 <alltraps>
...
80107868:	6a 00                	push   $0x0
  pushl $114
8010786a:	6a 72                	push   $0x72
  jmp alltraps
8010786c:	e9 73 f5 ff ff       	jmp    80106de4 <alltraps>
...
80107871:	6a 00                	push   $0x0
  pushl $115
80107873:	6a 73                	push   $0x73
  jmp alltraps
80107875:	e9 6a f5 ff ff       	jmp    80106de4 <alltraps>
...
8010787a:	6a 00                	push   $0x0
  pushl $116
8010787c:	6a 74                	push   $0x74
  jmp alltraps
8010787e:	e9 61 f5 ff ff       	jmp    80106de4 <alltraps>
...
80107883:	6a 00                	push   $0x0
  pushl $117
80107885:	6a 75                	push   $0x75
  jmp alltraps
80107887:	e9 58 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010788c:	6a 00                	push   $0x0
  pushl $118
8010788e:	6a 76                	push   $0x76
  jmp alltraps
80107890:	e9 4f f5 ff ff       	jmp    80106de4 <alltraps>
...
80107895:	6a 00                	push   $0x0
  pushl $119
80107897:	6a 77                	push   $0x77
  jmp alltraps
80107899:	e9 46 f5 ff ff       	jmp    80106de4 <alltraps>
...
8010789e:	6a 00                	push   $0x0
  pushl $120
801078a0:	6a 78                	push   $0x78
  jmp alltraps
801078a2:	e9 3d f5 ff ff       	jmp    80106de4 <alltraps>
...
801078a7:	6a 00                	push   $0x0
  pushl $121
801078a9:	6a 79                	push   $0x79
  jmp alltraps
801078ab:	e9 34 f5 ff ff       	jmp    80106de4 <alltraps>
...
801078b0:	6a 00                	push   $0x0
  pushl $122
801078b2:	6a 7a                	push   $0x7a
  jmp alltraps
801078b4:	e9 2b f5 ff ff       	jmp    80106de4 <alltraps>
...
801078b9:	6a 00                	push   $0x0
  pushl $123
801078bb:	6a 7b                	push   $0x7b
  jmp alltraps
801078bd:	e9 22 f5 ff ff       	jmp    80106de4 <alltraps>
...
801078c2:	6a 00                	push   $0x0
  pushl $124
801078c4:	6a 7c                	push   $0x7c
  jmp alltraps
801078c6:	e9 19 f5 ff ff       	jmp    80106de4 <alltraps>
...
801078cb:	6a 00                	push   $0x0
  pushl $125
801078cd:	6a 7d                	push   $0x7d
  jmp alltraps
801078cf:	e9 10 f5 ff ff       	jmp    80106de4 <alltraps>
...
801078d4:	6a 00                	push   $0x0
  pushl $126
801078d6:	6a 7e                	push   $0x7e
  jmp alltraps
801078d8:	e9 07 f5 ff ff       	jmp    80106de4 <alltraps>
...
801078dd:	6a 00                	push   $0x0
  pushl $127
801078df:	6a 7f                	push   $0x7f
  jmp alltraps
801078e1:	e9 fe f4 ff ff       	jmp    80106de4 <alltraps>
...
801078e6:	6a 00                	push   $0x0
  pushl $128
801078e8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801078ed:	e9 f2 f4 ff ff       	jmp    80106de4 <alltraps>
...
801078f2:	6a 00                	push   $0x0
  pushl $129
801078f4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801078f9:	e9 e6 f4 ff ff       	jmp    80106de4 <alltraps>
...
801078fe:	6a 00                	push   $0x0
  pushl $130
80107900:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107905:	e9 da f4 ff ff       	jmp    80106de4 <alltraps>
...
8010790a:	6a 00                	push   $0x0
  pushl $131
8010790c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107911:	e9 ce f4 ff ff       	jmp    80106de4 <alltraps>
...
80107916:	6a 00                	push   $0x0
  pushl $132
80107918:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010791d:	e9 c2 f4 ff ff       	jmp    80106de4 <alltraps>
...
80107922:	6a 00                	push   $0x0
  pushl $133
80107924:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107929:	e9 b6 f4 ff ff       	jmp    80106de4 <alltraps>
...
8010792e:	6a 00                	push   $0x0
  pushl $134
80107930:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107935:	e9 aa f4 ff ff       	jmp    80106de4 <alltraps>
...
8010793a:	6a 00                	push   $0x0
  pushl $135
8010793c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107941:	e9 9e f4 ff ff       	jmp    80106de4 <alltraps>
...
80107946:	6a 00                	push   $0x0
  pushl $136
80107948:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010794d:	e9 92 f4 ff ff       	jmp    80106de4 <alltraps>
...
80107952:	6a 00                	push   $0x0
  pushl $137
80107954:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107959:	e9 86 f4 ff ff       	jmp    80106de4 <alltraps>
...
8010795e:	6a 00                	push   $0x0
  pushl $138
80107960:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107965:	e9 7a f4 ff ff       	jmp    80106de4 <alltraps>
...
8010796a:	6a 00                	push   $0x0
  pushl $139
8010796c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107971:	e9 6e f4 ff ff       	jmp    80106de4 <alltraps>
...
80107976:	6a 00                	push   $0x0
  pushl $140
80107978:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010797d:	e9 62 f4 ff ff       	jmp    80106de4 <alltraps>
...
80107982:	6a 00                	push   $0x0
  pushl $141
80107984:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107989:	e9 56 f4 ff ff       	jmp    80106de4 <alltraps>
...
8010798e:	6a 00                	push   $0x0
  pushl $142
80107990:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107995:	e9 4a f4 ff ff       	jmp    80106de4 <alltraps>
...
8010799a:	6a 00                	push   $0x0
  pushl $143
8010799c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801079a1:	e9 3e f4 ff ff       	jmp    80106de4 <alltraps>
...
801079a6:	6a 00                	push   $0x0
  pushl $144
801079a8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801079ad:	e9 32 f4 ff ff       	jmp    80106de4 <alltraps>
...
801079b2:	6a 00                	push   $0x0
  pushl $145
801079b4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801079b9:	e9 26 f4 ff ff       	jmp    80106de4 <alltraps>
...
801079be:	6a 00                	push   $0x0
  pushl $146
801079c0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801079c5:	e9 1a f4 ff ff       	jmp    80106de4 <alltraps>
...
801079ca:	6a 00                	push   $0x0
  pushl $147
801079cc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801079d1:	e9 0e f4 ff ff       	jmp    80106de4 <alltraps>
...
801079d6:	6a 00                	push   $0x0
  pushl $148
801079d8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801079dd:	e9 02 f4 ff ff       	jmp    80106de4 <alltraps>
...
801079e2:	6a 00                	push   $0x0
  pushl $149
801079e4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801079e9:	e9 f6 f3 ff ff       	jmp    80106de4 <alltraps>
...
801079ee:	6a 00                	push   $0x0
  pushl $150
801079f0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801079f5:	e9 ea f3 ff ff       	jmp    80106de4 <alltraps>
...
801079fa:	6a 00                	push   $0x0
  pushl $151
801079fc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107a01:	e9 de f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a06:	6a 00                	push   $0x0
  pushl $152
80107a08:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107a0d:	e9 d2 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a12:	6a 00                	push   $0x0
  pushl $153
80107a14:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107a19:	e9 c6 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a1e:	6a 00                	push   $0x0
  pushl $154
80107a20:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107a25:	e9 ba f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a2a:	6a 00                	push   $0x0
  pushl $155
80107a2c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107a31:	e9 ae f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a36:	6a 00                	push   $0x0
  pushl $156
80107a38:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107a3d:	e9 a2 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a42:	6a 00                	push   $0x0
  pushl $157
80107a44:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107a49:	e9 96 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a4e:	6a 00                	push   $0x0
  pushl $158
80107a50:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107a55:	e9 8a f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a5a:	6a 00                	push   $0x0
  pushl $159
80107a5c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107a61:	e9 7e f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a66:	6a 00                	push   $0x0
  pushl $160
80107a68:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107a6d:	e9 72 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a72:	6a 00                	push   $0x0
  pushl $161
80107a74:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107a79:	e9 66 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a7e:	6a 00                	push   $0x0
  pushl $162
80107a80:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107a85:	e9 5a f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a8a:	6a 00                	push   $0x0
  pushl $163
80107a8c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107a91:	e9 4e f3 ff ff       	jmp    80106de4 <alltraps>
...
80107a96:	6a 00                	push   $0x0
  pushl $164
80107a98:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107a9d:	e9 42 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107aa2:	6a 00                	push   $0x0
  pushl $165
80107aa4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107aa9:	e9 36 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107aae:	6a 00                	push   $0x0
  pushl $166
80107ab0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107ab5:	e9 2a f3 ff ff       	jmp    80106de4 <alltraps>
...
80107aba:	6a 00                	push   $0x0
  pushl $167
80107abc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107ac1:	e9 1e f3 ff ff       	jmp    80106de4 <alltraps>
...
80107ac6:	6a 00                	push   $0x0
  pushl $168
80107ac8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107acd:	e9 12 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107ad2:	6a 00                	push   $0x0
  pushl $169
80107ad4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107ad9:	e9 06 f3 ff ff       	jmp    80106de4 <alltraps>
...
80107ade:	6a 00                	push   $0x0
  pushl $170
80107ae0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107ae5:	e9 fa f2 ff ff       	jmp    80106de4 <alltraps>
...
80107aea:	6a 00                	push   $0x0
  pushl $171
80107aec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107af1:	e9 ee f2 ff ff       	jmp    80106de4 <alltraps>
...
80107af6:	6a 00                	push   $0x0
  pushl $172
80107af8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107afd:	e9 e2 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b02:	6a 00                	push   $0x0
  pushl $173
80107b04:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107b09:	e9 d6 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b0e:	6a 00                	push   $0x0
  pushl $174
80107b10:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107b15:	e9 ca f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b1a:	6a 00                	push   $0x0
  pushl $175
80107b1c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107b21:	e9 be f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b26:	6a 00                	push   $0x0
  pushl $176
80107b28:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107b2d:	e9 b2 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b32:	6a 00                	push   $0x0
  pushl $177
80107b34:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107b39:	e9 a6 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b3e:	6a 00                	push   $0x0
  pushl $178
80107b40:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107b45:	e9 9a f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b4a:	6a 00                	push   $0x0
  pushl $179
80107b4c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107b51:	e9 8e f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b56:	6a 00                	push   $0x0
  pushl $180
80107b58:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107b5d:	e9 82 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b62:	6a 00                	push   $0x0
  pushl $181
80107b64:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107b69:	e9 76 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b6e:	6a 00                	push   $0x0
  pushl $182
80107b70:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107b75:	e9 6a f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b7a:	6a 00                	push   $0x0
  pushl $183
80107b7c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107b81:	e9 5e f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b86:	6a 00                	push   $0x0
  pushl $184
80107b88:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107b8d:	e9 52 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b92:	6a 00                	push   $0x0
  pushl $185
80107b94:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107b99:	e9 46 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107b9e:	6a 00                	push   $0x0
  pushl $186
80107ba0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107ba5:	e9 3a f2 ff ff       	jmp    80106de4 <alltraps>
...
80107baa:	6a 00                	push   $0x0
  pushl $187
80107bac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107bb1:	e9 2e f2 ff ff       	jmp    80106de4 <alltraps>
...
80107bb6:	6a 00                	push   $0x0
  pushl $188
80107bb8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107bbd:	e9 22 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107bc2:	6a 00                	push   $0x0
  pushl $189
80107bc4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107bc9:	e9 16 f2 ff ff       	jmp    80106de4 <alltraps>
...
80107bce:	6a 00                	push   $0x0
  pushl $190
80107bd0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107bd5:	e9 0a f2 ff ff       	jmp    80106de4 <alltraps>
...
80107bda:	6a 00                	push   $0x0
  pushl $191
80107bdc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107be1:	e9 fe f1 ff ff       	jmp    80106de4 <alltraps>
...
80107be6:	6a 00                	push   $0x0
  pushl $192
80107be8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107bed:	e9 f2 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107bf2:	6a 00                	push   $0x0
  pushl $193
80107bf4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107bf9:	e9 e6 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107bfe:	6a 00                	push   $0x0
  pushl $194
80107c00:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107c05:	e9 da f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c0a:	6a 00                	push   $0x0
  pushl $195
80107c0c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107c11:	e9 ce f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c16:	6a 00                	push   $0x0
  pushl $196
80107c18:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107c1d:	e9 c2 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c22:	6a 00                	push   $0x0
  pushl $197
80107c24:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107c29:	e9 b6 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c2e:	6a 00                	push   $0x0
  pushl $198
80107c30:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107c35:	e9 aa f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c3a:	6a 00                	push   $0x0
  pushl $199
80107c3c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107c41:	e9 9e f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c46:	6a 00                	push   $0x0
  pushl $200
80107c48:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107c4d:	e9 92 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c52:	6a 00                	push   $0x0
  pushl $201
80107c54:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107c59:	e9 86 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c5e:	6a 00                	push   $0x0
  pushl $202
80107c60:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107c65:	e9 7a f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c6a:	6a 00                	push   $0x0
  pushl $203
80107c6c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107c71:	e9 6e f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c76:	6a 00                	push   $0x0
  pushl $204
80107c78:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107c7d:	e9 62 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c82:	6a 00                	push   $0x0
  pushl $205
80107c84:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107c89:	e9 56 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c8e:	6a 00                	push   $0x0
  pushl $206
80107c90:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107c95:	e9 4a f1 ff ff       	jmp    80106de4 <alltraps>
...
80107c9a:	6a 00                	push   $0x0
  pushl $207
80107c9c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107ca1:	e9 3e f1 ff ff       	jmp    80106de4 <alltraps>
...
80107ca6:	6a 00                	push   $0x0
  pushl $208
80107ca8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107cad:	e9 32 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107cb2:	6a 00                	push   $0x0
  pushl $209
80107cb4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107cb9:	e9 26 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107cbe:	6a 00                	push   $0x0
  pushl $210
80107cc0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107cc5:	e9 1a f1 ff ff       	jmp    80106de4 <alltraps>
...
80107cca:	6a 00                	push   $0x0
  pushl $211
80107ccc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107cd1:	e9 0e f1 ff ff       	jmp    80106de4 <alltraps>
...
80107cd6:	6a 00                	push   $0x0
  pushl $212
80107cd8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107cdd:	e9 02 f1 ff ff       	jmp    80106de4 <alltraps>
...
80107ce2:	6a 00                	push   $0x0
  pushl $213
80107ce4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107ce9:	e9 f6 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107cee:	6a 00                	push   $0x0
  pushl $214
80107cf0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107cf5:	e9 ea f0 ff ff       	jmp    80106de4 <alltraps>
...
80107cfa:	6a 00                	push   $0x0
  pushl $215
80107cfc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107d01:	e9 de f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d06:	6a 00                	push   $0x0
  pushl $216
80107d08:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107d0d:	e9 d2 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d12:	6a 00                	push   $0x0
  pushl $217
80107d14:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107d19:	e9 c6 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d1e:	6a 00                	push   $0x0
  pushl $218
80107d20:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107d25:	e9 ba f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d2a:	6a 00                	push   $0x0
  pushl $219
80107d2c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107d31:	e9 ae f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d36:	6a 00                	push   $0x0
  pushl $220
80107d38:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107d3d:	e9 a2 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d42:	6a 00                	push   $0x0
  pushl $221
80107d44:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107d49:	e9 96 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d4e:	6a 00                	push   $0x0
  pushl $222
80107d50:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107d55:	e9 8a f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d5a:	6a 00                	push   $0x0
  pushl $223
80107d5c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107d61:	e9 7e f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d66:	6a 00                	push   $0x0
  pushl $224
80107d68:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107d6d:	e9 72 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d72:	6a 00                	push   $0x0
  pushl $225
80107d74:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107d79:	e9 66 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d7e:	6a 00                	push   $0x0
  pushl $226
80107d80:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107d85:	e9 5a f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d8a:	6a 00                	push   $0x0
  pushl $227
80107d8c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107d91:	e9 4e f0 ff ff       	jmp    80106de4 <alltraps>
...
80107d96:	6a 00                	push   $0x0
  pushl $228
80107d98:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107d9d:	e9 42 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107da2:	6a 00                	push   $0x0
  pushl $229
80107da4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107da9:	e9 36 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107dae:	6a 00                	push   $0x0
  pushl $230
80107db0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107db5:	e9 2a f0 ff ff       	jmp    80106de4 <alltraps>
...
80107dba:	6a 00                	push   $0x0
  pushl $231
80107dbc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107dc1:	e9 1e f0 ff ff       	jmp    80106de4 <alltraps>
...
80107dc6:	6a 00                	push   $0x0
  pushl $232
80107dc8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107dcd:	e9 12 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107dd2:	6a 00                	push   $0x0
  pushl $233
80107dd4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107dd9:	e9 06 f0 ff ff       	jmp    80106de4 <alltraps>
...
80107dde:	6a 00                	push   $0x0
  pushl $234
80107de0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107de5:	e9 fa ef ff ff       	jmp    80106de4 <alltraps>
...
80107dea:	6a 00                	push   $0x0
  pushl $235
80107dec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107df1:	e9 ee ef ff ff       	jmp    80106de4 <alltraps>
...
80107df6:	6a 00                	push   $0x0
  pushl $236
80107df8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107dfd:	e9 e2 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e02:	6a 00                	push   $0x0
  pushl $237
80107e04:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107e09:	e9 d6 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e0e:	6a 00                	push   $0x0
  pushl $238
80107e10:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107e15:	e9 ca ef ff ff       	jmp    80106de4 <alltraps>
...
80107e1a:	6a 00                	push   $0x0
  pushl $239
80107e1c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107e21:	e9 be ef ff ff       	jmp    80106de4 <alltraps>
...
80107e26:	6a 00                	push   $0x0
  pushl $240
80107e28:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107e2d:	e9 b2 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e32:	6a 00                	push   $0x0
  pushl $241
80107e34:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107e39:	e9 a6 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e3e:	6a 00                	push   $0x0
  pushl $242
80107e40:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107e45:	e9 9a ef ff ff       	jmp    80106de4 <alltraps>
...
80107e4a:	6a 00                	push   $0x0
  pushl $243
80107e4c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107e51:	e9 8e ef ff ff       	jmp    80106de4 <alltraps>
...
80107e56:	6a 00                	push   $0x0
  pushl $244
80107e58:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107e5d:	e9 82 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e62:	6a 00                	push   $0x0
  pushl $245
80107e64:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107e69:	e9 76 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e6e:	6a 00                	push   $0x0
  pushl $246
80107e70:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107e75:	e9 6a ef ff ff       	jmp    80106de4 <alltraps>
...
80107e7a:	6a 00                	push   $0x0
  pushl $247
80107e7c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107e81:	e9 5e ef ff ff       	jmp    80106de4 <alltraps>
...
80107e86:	6a 00                	push   $0x0
  pushl $248
80107e88:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107e8d:	e9 52 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e92:	6a 00                	push   $0x0
  pushl $249
80107e94:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107e99:	e9 46 ef ff ff       	jmp    80106de4 <alltraps>
...
80107e9e:	6a 00                	push   $0x0
  pushl $250
80107ea0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107ea5:	e9 3a ef ff ff       	jmp    80106de4 <alltraps>
...
80107eaa:	6a 00                	push   $0x0
  pushl $251
80107eac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107eb1:	e9 2e ef ff ff       	jmp    80106de4 <alltraps>
...
80107eb6:	6a 00                	push   $0x0
  pushl $252
80107eb8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107ebd:	e9 22 ef ff ff       	jmp    80106de4 <alltraps>
...
80107ec2:	6a 00                	push   $0x0
  pushl $253
80107ec4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107ec9:	e9 16 ef ff ff       	jmp    80106de4 <alltraps>
...
80107ece:	6a 00                	push   $0x0
  pushl $254
80107ed0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ed5:	e9 0a ef ff ff       	jmp    80106de4 <alltraps>
...
80107eda:	6a 00                	push   $0x0
  pushl $255
80107edc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107ee1:	e9 fe ee ff ff       	jmp    80106de4 <alltraps>
	...
...
80107eeb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107eee:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ef1:	83 e8 01             	sub    $0x1,%eax
80107ef4:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107ef8:	8b 45 08             	mov    0x8(%ebp),%eax
80107efb:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107eff:	8b 45 08             	mov    0x8(%ebp),%eax
80107f02:	c1 e8 10             	shr    $0x10,%eax
80107f05:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107f09:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107f0c:	0f 01 10             	lgdtl  (%eax)
}
80107f0f:	c9                   	leave  
80107f10:	c3                   	ret    
...
80107f17:	8b 45 08             	mov    0x8(%ebp),%eax
80107f1a:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107f1e:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107f22:	0f 00 d8             	ltr    %ax
}
80107f25:	c9                   	leave  
80107f26:	c3                   	ret    
...
80107f30:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107f34:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107f38:	8e e8                	mov    %eax,%gs
}
80107f3a:	c9                   	leave  
80107f3b:	c3                   	ret    
...
80107f4d:	05 00 00 00 80       	add    $0x80000000,%eax
80107f52:	5d                   	pop    %ebp
80107f53:	c3                   	ret    
...
80107f64:	53                   	push   %ebx
80107f65:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107f68:	e8 20 af ff ff       	call   80102e8d <cpunum>
80107f6d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107f73:	05 40 09 11 80       	add    $0x80110940,%eax
80107f78:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107f7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f7e:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107f84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f87:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107f8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f90:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107f94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f97:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f9b:	83 e2 f0             	and    $0xfffffff0,%edx
80107f9e:	83 ca 0a             	or     $0xa,%edx
80107fa1:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fa4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107fab:	83 ca 10             	or     $0x10,%edx
80107fae:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb4:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107fb8:	83 e2 9f             	and    $0xffffff9f,%edx
80107fbb:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fbe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc1:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107fc5:	83 ca 80             	or     $0xffffff80,%edx
80107fc8:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fce:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fd2:	83 ca 0f             	or     $0xf,%edx
80107fd5:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fdb:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fdf:	83 e2 ef             	and    $0xffffffef,%edx
80107fe2:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fe5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe8:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fec:	83 e2 df             	and    $0xffffffdf,%edx
80107fef:	88 50 7e             	mov    %dl,0x7e(%eax)
80107ff2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff5:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107ff9:	83 ca 40             	or     $0x40,%edx
80107ffc:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108002:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108006:	83 ca 80             	or     $0xffffff80,%edx
80108009:	88 50 7e             	mov    %dl,0x7e(%eax)
8010800c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108013:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108016:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010801d:	ff ff 
8010801f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108022:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80108029:	00 00 
8010802b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80108035:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108038:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010803f:	83 e2 f0             	and    $0xfffffff0,%edx
80108042:	83 ca 02             	or     $0x2,%edx
80108045:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010804b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108055:	83 ca 10             	or     $0x10,%edx
80108058:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010805e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108061:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108068:	83 e2 9f             	and    $0xffffff9f,%edx
8010806b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108071:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108074:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010807b:	83 ca 80             	or     $0xffffff80,%edx
8010807e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108084:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108087:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010808e:	83 ca 0f             	or     $0xf,%edx
80108091:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108097:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010809a:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801080a1:	83 e2 ef             	and    $0xffffffef,%edx
801080a4:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ad:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801080b4:	83 e2 df             	and    $0xffffffdf,%edx
801080b7:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c0:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801080c7:	83 ca 40             	or     $0x40,%edx
801080ca:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080d3:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801080da:	83 ca 80             	or     $0xffffff80,%edx
801080dd:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080e6:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801080ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080f0:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801080f7:	ff ff 
801080f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080fc:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108103:	00 00 
80108105:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108108:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010810f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108112:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108119:	83 e2 f0             	and    $0xfffffff0,%edx
8010811c:	83 ca 0a             	or     $0xa,%edx
8010811f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108125:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108128:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010812f:	83 ca 10             	or     $0x10,%edx
80108132:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108138:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108142:	83 ca 60             	or     $0x60,%edx
80108145:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010814b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010814e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108155:	83 ca 80             	or     $0xffffff80,%edx
80108158:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010815e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108161:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108168:	83 ca 0f             	or     $0xf,%edx
8010816b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108171:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108174:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010817b:	83 e2 ef             	and    $0xffffffef,%edx
8010817e:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108184:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108187:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010818e:	83 e2 df             	and    $0xffffffdf,%edx
80108191:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108197:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819a:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801081a1:	83 ca 40             	or     $0x40,%edx
801081a4:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ad:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801081b4:	83 ca 80             	or     $0xffffff80,%edx
801081b7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c0:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801081c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ca:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801081d1:	ff ff 
801081d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081d6:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801081dd:	00 00 
801081df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e2:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801081e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ec:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801081f3:	83 e2 f0             	and    $0xfffffff0,%edx
801081f6:	83 ca 02             	or     $0x2,%edx
801081f9:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801081ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108202:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108209:	83 ca 10             	or     $0x10,%edx
8010820c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108212:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108215:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010821c:	83 ca 60             	or     $0x60,%edx
8010821f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108225:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108228:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010822f:	83 ca 80             	or     $0xffffff80,%edx
80108232:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108238:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010823b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108242:	83 ca 0f             	or     $0xf,%edx
80108245:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010824b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010824e:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108255:	83 e2 ef             	and    $0xffffffef,%edx
80108258:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010825e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108261:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108268:	83 e2 df             	and    $0xffffffdf,%edx
8010826b:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108274:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010827b:	83 ca 40             	or     $0x40,%edx
8010827e:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108284:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108287:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010828e:	83 ca 80             	or     $0xffffff80,%edx
80108291:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108297:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010829a:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801082a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a4:	05 b4 00 00 00       	add    $0xb4,%eax
801082a9:	89 c3                	mov    %eax,%ebx
801082ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ae:	05 b4 00 00 00       	add    $0xb4,%eax
801082b3:	c1 e8 10             	shr    $0x10,%eax
801082b6:	89 c1                	mov    %eax,%ecx
801082b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082bb:	05 b4 00 00 00       	add    $0xb4,%eax
801082c0:	c1 e8 18             	shr    $0x18,%eax
801082c3:	89 c2                	mov    %eax,%edx
801082c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c8:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801082cf:	00 00 
801082d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d4:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801082db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082de:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801082e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082e7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801082ee:	83 e1 f0             	and    $0xfffffff0,%ecx
801082f1:	83 c9 02             	or     $0x2,%ecx
801082f4:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801082fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082fd:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108304:	83 c9 10             	or     $0x10,%ecx
80108307:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010830d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108310:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108317:	83 e1 9f             	and    $0xffffff9f,%ecx
8010831a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108320:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108323:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010832a:	83 c9 80             	or     $0xffffff80,%ecx
8010832d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108336:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010833d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108340:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108346:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108349:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108350:	83 e1 ef             	and    $0xffffffef,%ecx
80108353:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108359:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010835c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108363:	83 e1 df             	and    $0xffffffdf,%ecx
80108366:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010836c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010836f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108376:	83 c9 40             	or     $0x40,%ecx
80108379:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010837f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108382:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108389:	83 c9 80             	or     $0xffffff80,%ecx
8010838c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108392:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108395:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010839b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010839e:	83 c0 70             	add    $0x70,%eax
801083a1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801083a8:	00 
801083a9:	89 04 24             	mov    %eax,(%esp)
801083ac:	e8 37 fb ff ff       	call   80107ee8 <lgdt>
  loadgs(SEG_KCPU << 3);
801083b1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801083b8:	e8 6a fb ff ff       	call   80107f27 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801083bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083c0:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801083c6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801083cd:	00 00 00 00 
}
801083d1:	83 c4 24             	add    $0x24,%esp
801083d4:	5b                   	pop    %ebx
801083d5:	5d                   	pop    %ebp
801083d6:	c3                   	ret    
...
801083e0:	c1 e8 16             	shr    $0x16,%eax
801083e3:	c1 e0 02             	shl    $0x2,%eax
801083e6:	03 45 08             	add    0x8(%ebp),%eax
801083e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801083ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083ef:	8b 00                	mov    (%eax),%eax
801083f1:	83 e0 01             	and    $0x1,%eax
801083f4:	84 c0                	test   %al,%al
801083f6:	74 17                	je     8010840f <walkpgdir+0x38>
...
80108405:	e8 4a fb ff ff       	call   80107f54 <p2v>
8010840a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010840d:	eb 4b                	jmp    8010845a <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010840f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108413:	74 0e                	je     80108423 <walkpgdir+0x4c>
80108415:	e8 e5 a6 ff ff       	call   80102aff <kalloc>
8010841a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010841d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108421:	75 07                	jne    8010842a <walkpgdir+0x53>
      return 0;
80108423:	b8 00 00 00 00       	mov    $0x0,%eax
80108428:	eb 41                	jmp    8010846b <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010842a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108431:	00 
80108432:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108439:	00 
8010843a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010843d:	89 04 24             	mov    %eax,(%esp)
80108440:	e8 f1 d3 ff ff       	call   80105836 <memset>
...
8010844b:	e8 f7 fa ff ff       	call   80107f47 <v2p>
80108450:	89 c2                	mov    %eax,%edx
80108452:	83 ca 07             	or     $0x7,%edx
80108455:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108458:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010845a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010845d:	c1 e8 0c             	shr    $0xc,%eax
80108460:	25 ff 03 00 00       	and    $0x3ff,%eax
80108465:	c1 e0 02             	shl    $0x2,%eax
80108468:	03 45 f4             	add    -0xc(%ebp),%eax
}
8010846b:	c9                   	leave  
8010846c:	c3                   	ret    
...
8010847e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108481:	03 45 10             	add    0x10(%ebp),%eax
80108484:	83 e8 01             	sub    $0x1,%eax
80108487:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010848c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010848f:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108496:	00 
80108497:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010849a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010849e:	8b 45 08             	mov    0x8(%ebp),%eax
801084a1:	89 04 24             	mov    %eax,(%esp)
801084a4:	e8 2e ff ff ff       	call   801083d7 <walkpgdir>
801084a9:	89 45 ec             	mov    %eax,-0x14(%ebp)
801084ac:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801084b0:	75 07                	jne    801084b9 <mappages+0x4c>
      return -1;
801084b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084b7:	eb 46                	jmp    801084ff <mappages+0x92>
    if(*pte & PTE_P)
801084b9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084bc:	8b 00                	mov    (%eax),%eax
801084be:	83 e0 01             	and    $0x1,%eax
801084c1:	84 c0                	test   %al,%al
801084c3:	74 0c                	je     801084d1 <mappages+0x64>
      panic("remap");
801084c5:	c7 04 24 90 94 10 80 	movl   $0x80109490,(%esp)
801084cc:	e8 6c 80 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801084d1:	8b 45 18             	mov    0x18(%ebp),%eax
801084d4:	0b 45 14             	or     0x14(%ebp),%eax
801084d7:	89 c2                	mov    %eax,%edx
801084d9:	83 ca 01             	or     $0x1,%edx
801084dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084df:	89 10                	mov    %edx,(%eax)
    if(a == last)
801084e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e4:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801084e7:	74 10                	je     801084f9 <mappages+0x8c>
      break;
    a += PGSIZE;
801084e9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801084f0:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801084f7:	eb 96                	jmp    8010848f <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108505:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108508:	e8 f2 a5 ff ff       	call   80102aff <kalloc>
8010850d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108510:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108514:	75 0a                	jne    80108520 <setupkvm+0x1f>
    return 0;
80108516:	b8 00 00 00 00       	mov    $0x0,%eax
8010851b:	e9 98 00 00 00       	jmp    801085b8 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80108520:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108527:	00 
80108528:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010852f:	00 
80108530:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108533:	89 04 24             	mov    %eax,(%esp)
80108536:	e8 fb d2 ff ff       	call   80105836 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010853b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108542:	e8 0d fa ff ff       	call   80107f54 <p2v>
80108547:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010854c:	76 0c                	jbe    8010855a <setupkvm+0x59>
    panic("PHYSTOP too high");
8010854e:	c7 04 24 96 94 10 80 	movl   $0x80109496,(%esp)
80108555:	e8 e3 7f ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010855a:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108561:	eb 49                	jmp    801085ac <setupkvm+0xab>
...
80108563:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108566:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108569:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010856c:	8b 50 04             	mov    0x4(%eax),%edx
8010856f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108572:	8b 58 08             	mov    0x8(%eax),%ebx
80108575:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108578:	8b 40 04             	mov    0x4(%eax),%eax
8010857b:	29 c3                	sub    %eax,%ebx
8010857d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108580:	8b 00                	mov    (%eax),%eax
80108582:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108586:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010858a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010858e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108592:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108595:	89 04 24             	mov    %eax,(%esp)
80108598:	e8 d0 fe ff ff       	call   8010846d <mappages>
8010859d:	85 c0                	test   %eax,%eax
8010859f:	79 07                	jns    801085a8 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
801085a1:	b8 00 00 00 00       	mov    $0x0,%eax
801085a6:	eb 10                	jmp    801085b8 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801085a8:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801085ac:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
801085b3:	72 ae                	jb     80108563 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801085b8:	83 c4 34             	add    $0x34,%esp
801085bb:	5b                   	pop    %ebx
801085bc:	5d                   	pop    %ebp
801085bd:	c3                   	ret    
...
801085c1:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801085c4:	e8 38 ff ff ff       	call   80108501 <setupkvm>
801085c9:	a3 58 5c 11 80       	mov    %eax,0x80115c58
  switchkvm();
801085ce:	e8 02 00 00 00       	call   801085d5 <switchkvm>
}
801085d3:	c9                   	leave  
801085d4:	c3                   	ret    
...
801085db:	a1 58 5c 11 80       	mov    0x80115c58,%eax
801085e0:	89 04 24             	mov    %eax,(%esp)
801085e3:	e8 5f f9 ff ff       	call   80107f47 <v2p>
801085e8:	89 04 24             	mov    %eax,(%esp)
801085eb:	e8 4c f9 ff ff       	call   80107f3c <lcr3>
}
801085f0:	c9                   	leave  
801085f1:	c3                   	ret    
...
{
801085f2:	55                   	push   %ebp
801085f3:	89 e5                	mov    %esp,%ebp
801085f5:	53                   	push   %ebx
801085f6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801085f9:	e8 31 d1 ff ff       	call   8010572f <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801085fe:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108604:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010860b:	83 c2 08             	add    $0x8,%edx
8010860e:	89 d3                	mov    %edx,%ebx
80108610:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108617:	83 c2 08             	add    $0x8,%edx
8010861a:	c1 ea 10             	shr    $0x10,%edx
8010861d:	89 d1                	mov    %edx,%ecx
8010861f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108626:	83 c2 08             	add    $0x8,%edx
80108629:	c1 ea 18             	shr    $0x18,%edx
8010862c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108633:	67 00 
80108635:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010863c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108642:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108649:	83 e1 f0             	and    $0xfffffff0,%ecx
8010864c:	83 c9 09             	or     $0x9,%ecx
8010864f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108655:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010865c:	83 c9 10             	or     $0x10,%ecx
8010865f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108665:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010866c:	83 e1 9f             	and    $0xffffff9f,%ecx
8010866f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108675:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010867c:	83 c9 80             	or     $0xffffff80,%ecx
8010867f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108685:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010868c:	83 e1 f0             	and    $0xfffffff0,%ecx
8010868f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108695:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010869c:	83 e1 ef             	and    $0xffffffef,%ecx
8010869f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801086a5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801086ac:	83 e1 df             	and    $0xffffffdf,%ecx
801086af:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801086b5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801086bc:	83 c9 40             	or     $0x40,%ecx
801086bf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801086c5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801086cc:	83 e1 7f             	and    $0x7f,%ecx
801086cf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801086d5:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801086db:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086e1:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801086e8:	83 e2 ef             	and    $0xffffffef,%edx
801086eb:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801086f1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086f7:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801086fd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108703:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010870a:	8b 52 08             	mov    0x8(%edx),%edx
8010870d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108713:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108716:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010871d:	e8 ef f7 ff ff       	call   80107f11 <ltr>
  if(p->pgdir == 0)
80108722:	8b 45 08             	mov    0x8(%ebp),%eax
80108725:	8b 40 04             	mov    0x4(%eax),%eax
80108728:	85 c0                	test   %eax,%eax
8010872a:	75 0c                	jne    80108738 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010872c:	c7 04 24 a7 94 10 80 	movl   $0x801094a7,(%esp)
80108733:	e8 05 7e ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108738:	8b 45 08             	mov    0x8(%ebp),%eax
8010873b:	8b 40 04             	mov    0x4(%eax),%eax
8010873e:	89 04 24             	mov    %eax,(%esp)
80108741:	e8 01 f8 ff ff       	call   80107f47 <v2p>
80108746:	89 04 24             	mov    %eax,(%esp)
80108749:	e8 ee f7 ff ff       	call   80107f3c <lcr3>
  popcli();
8010874e:	e8 24 d0 ff ff       	call   80105777 <popcli>
}
80108753:	83 c4 14             	add    $0x14,%esp
80108756:	5b                   	pop    %ebx
80108757:	5d                   	pop    %ebp
80108758:	c3                   	ret    
...
8010875c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010875f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108766:	76 0c                	jbe    80108774 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108768:	c7 04 24 bb 94 10 80 	movl   $0x801094bb,(%esp)
8010876f:	e8 c9 7d ff ff       	call   8010053d <panic>
  mem = kalloc();
80108774:	e8 86 a3 ff ff       	call   80102aff <kalloc>
80108779:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010877c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108783:	00 
80108784:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010878b:	00 
8010878c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010878f:	89 04 24             	mov    %eax,(%esp)
80108792:	e8 9f d0 ff ff       	call   80105836 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108797:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010879a:	89 04 24             	mov    %eax,(%esp)
8010879d:	e8 a5 f7 ff ff       	call   80107f47 <v2p>
801087a2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801087a9:	00 
801087aa:	89 44 24 0c          	mov    %eax,0xc(%esp)
801087ae:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087b5:	00 
801087b6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801087bd:	00 
801087be:	8b 45 08             	mov    0x8(%ebp),%eax
801087c1:	89 04 24             	mov    %eax,(%esp)
801087c4:	e8 a4 fc ff ff       	call   8010846d <mappages>
  memmove(mem, init, sz);
801087c9:	8b 45 10             	mov    0x10(%ebp),%eax
801087cc:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801087dd:	e8 27 d1 ff ff       	call   80105909 <memmove>
}
801087e2:	c9                   	leave  
801087e3:	c3                   	ret    
...
801087e8:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801087eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801087ee:	25 ff 0f 00 00       	and    $0xfff,%eax
801087f3:	85 c0                	test   %eax,%eax
801087f5:	74 0c                	je     80108803 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801087f7:	c7 04 24 d8 94 10 80 	movl   $0x801094d8,(%esp)
801087fe:	e8 3a 7d ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108803:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010880a:	e9 ad 00 00 00       	jmp    801088bc <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010880f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108812:	8b 55 0c             	mov    0xc(%ebp),%edx
80108815:	01 d0                	add    %edx,%eax
...
80108829:	e8 a9 fb ff ff       	call   801083d7 <walkpgdir>
8010882e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108831:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108835:	75 0c                	jne    80108843 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108837:	c7 04 24 fb 94 10 80 	movl   $0x801094fb,(%esp)
8010883e:	e8 fa 7c ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80108843:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108846:	8b 00                	mov    (%eax),%eax
80108848:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010884d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108850:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108853:	8b 55 18             	mov    0x18(%ebp),%edx
80108856:	89 d1                	mov    %edx,%ecx
80108858:	29 c1                	sub    %eax,%ecx
8010885a:	89 c8                	mov    %ecx,%eax
8010885c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108861:	77 11                	ja     80108874 <loaduvm+0x90>
      n = sz - i;
80108863:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108866:	8b 55 18             	mov    0x18(%ebp),%edx
80108869:	89 d1                	mov    %edx,%ecx
8010886b:	29 c1                	sub    %eax,%ecx
8010886d:	89 c8                	mov    %ecx,%eax
8010886f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108872:	eb 07                	jmp    8010887b <loaduvm+0x97>
    else
      n = PGSIZE;
80108874:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010887b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010887e:	8b 55 14             	mov    0x14(%ebp),%edx
80108881:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108884:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108887:	89 04 24             	mov    %eax,(%esp)
8010888a:	e8 c5 f6 ff ff       	call   80107f54 <p2v>
8010888f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108892:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108896:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010889a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010889e:	8b 45 10             	mov    0x10(%ebp),%eax
801088a1:	89 04 24             	mov    %eax,(%esp)
801088a4:	e8 b5 94 ff ff       	call   80101d5e <readi>
801088a9:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801088ac:	74 07                	je     801088b5 <loaduvm+0xd1>
      return -1;
801088ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801088b3:	eb 18                	jmp    801088cd <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801088b5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801088bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088bf:	3b 45 18             	cmp    0x18(%ebp),%eax
801088c2:	0f 82 47 ff ff ff    	jb     8010880f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801088cd:	83 c4 24             	add    $0x24,%esp
801088d0:	5b                   	pop    %ebx
801088d1:	5d                   	pop    %ebp
801088d2:	c3                   	ret    
...
801088d6:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801088de:	79 0a                	jns    801088ea <allocuvm+0x17>
    return 0;
801088e0:	b8 00 00 00 00       	mov    $0x0,%eax
801088e5:	e9 c1 00 00 00       	jmp    801089ab <allocuvm+0xd8>
  if(newsz < oldsz)
801088ea:	8b 45 10             	mov    0x10(%ebp),%eax
801088ed:	3b 45 0c             	cmp    0xc(%ebp),%eax
801088f0:	73 08                	jae    801088fa <allocuvm+0x27>
    return oldsz;
801088f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801088f5:	e9 b1 00 00 00       	jmp    801089ab <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801088fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801088fd:	05 ff 0f 00 00       	add    $0xfff,%eax
80108902:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108907:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010890a:	e9 8d 00 00 00       	jmp    8010899c <allocuvm+0xc9>
    mem = kalloc();
8010890f:	e8 eb a1 ff ff       	call   80102aff <kalloc>
80108914:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108917:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010891b:	75 2c                	jne    80108949 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010891d:	c7 04 24 19 95 10 80 	movl   $0x80109519,(%esp)
80108924:	e8 78 7a ff ff       	call   801003a1 <cprintf>
...
8010893d:	e8 6b 00 00 00       	call   801089ad <deallocuvm>
      return 0;
80108942:	b8 00 00 00 00       	mov    $0x0,%eax
80108947:	eb 62                	jmp    801089ab <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108949:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108950:	00 
80108951:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108958:	00 
80108959:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010895c:	89 04 24             	mov    %eax,(%esp)
8010895f:	e8 d2 ce ff ff       	call   80105836 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108964:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108967:	89 04 24             	mov    %eax,(%esp)
8010896a:	e8 d8 f5 ff ff       	call   80107f47 <v2p>
8010896f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108972:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108979:	00 
8010897a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010897e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108985:	00 
80108986:	89 54 24 04          	mov    %edx,0x4(%esp)
8010898a:	8b 45 08             	mov    0x8(%ebp),%eax
8010898d:	89 04 24             	mov    %eax,(%esp)
80108990:	e8 d8 fa ff ff       	call   8010846d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108995:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010899c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010899f:	3b 45 10             	cmp    0x10(%ebp),%eax
801089a2:	0f 82 67 ff ff ff    	jb     8010890f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
801089a8:	8b 45 10             	mov    0x10(%ebp),%eax
}
801089ab:	c9                   	leave  
801089ac:	c3                   	ret    
...
801089b0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
801089b9:	72 08                	jb     801089c3 <deallocuvm+0x16>
    return oldsz;
801089bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801089be:	e9 a4 00 00 00       	jmp    80108a67 <deallocuvm+0xba>
...
801089d3:	e9 80 00 00 00       	jmp    80108a58 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801089d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089db:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089e2:	00 
801089e3:	89 44 24 04          	mov    %eax,0x4(%esp)
801089e7:	8b 45 08             	mov    0x8(%ebp),%eax
801089ea:	89 04 24             	mov    %eax,(%esp)
801089ed:	e8 e5 f9 ff ff       	call   801083d7 <walkpgdir>
801089f2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801089f5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801089f9:	75 09                	jne    80108a04 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801089fb:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108a02:	eb 4d                	jmp    80108a51 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108a04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a07:	8b 00                	mov    (%eax),%eax
80108a09:	83 e0 01             	and    $0x1,%eax
80108a0c:	84 c0                	test   %al,%al
80108a0e:	74 41                	je     80108a51 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108a10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a13:	8b 00                	mov    (%eax),%eax
80108a15:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a1a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108a1d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a21:	75 0c                	jne    80108a2f <deallocuvm+0x82>
        panic("kfree");
80108a23:	c7 04 24 31 95 10 80 	movl   $0x80109531,(%esp)
80108a2a:	e8 0e 7b ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108a2f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a32:	89 04 24             	mov    %eax,(%esp)
80108a35:	e8 1a f5 ff ff       	call   80107f54 <p2v>
80108a3a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108a3d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a40:	89 04 24             	mov    %eax,(%esp)
80108a43:	e8 1e a0 ff ff       	call   80102a66 <kfree>
      *pte = 0;
...
80108a5b:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a5e:	0f 82 74 ff ff ff    	jb     801089d8 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
80108a64:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108a67:	c9                   	leave  
80108a68:	c3                   	ret    
...
80108a6c:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108a6f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108a73:	75 0c                	jne    80108a81 <freevm+0x18>
    panic("freevm: no pgdir");
80108a75:	c7 04 24 37 95 10 80 	movl   $0x80109537,(%esp)
80108a7c:	e8 bc 7a ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108a81:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a88:	00 
80108a89:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108a90:	80 
80108a91:	8b 45 08             	mov    0x8(%ebp),%eax
80108a94:	89 04 24             	mov    %eax,(%esp)
80108a97:	e8 11 ff ff ff       	call   801089ad <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108a9c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108aa3:	eb 3c                	jmp    80108ae1 <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108aa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108aa8:	c1 e0 02             	shl    $0x2,%eax
80108aab:	03 45 08             	add    0x8(%ebp),%eax
80108aae:	8b 00                	mov    (%eax),%eax
80108ab0:	83 e0 01             	and    $0x1,%eax
80108ab3:	84 c0                	test   %al,%al
80108ab5:	74 26                	je     80108add <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108ab7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108aba:	c1 e0 02             	shl    $0x2,%eax
80108abd:	03 45 08             	add    0x8(%ebp),%eax
80108ac0:	8b 00                	mov    (%eax),%eax
80108ac2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108ac7:	89 04 24             	mov    %eax,(%esp)
80108aca:	e8 85 f4 ff ff       	call   80107f54 <p2v>
80108acf:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108ad2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108ad5:	89 04 24             	mov    %eax,(%esp)
80108ad8:	e8 89 9f ff ff       	call   80102a66 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108add:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108ae1:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108ae8:	76 bb                	jbe    80108aa5 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
80108aea:	8b 45 08             	mov    0x8(%ebp),%eax
80108aed:	89 04 24             	mov    %eax,(%esp)
80108af0:	e8 71 9f ff ff       	call   80102a66 <kfree>
}
80108af5:	c9                   	leave  
80108af6:	c3                   	ret    
...
80108b12:	e8 c0 f8 ff ff       	call   801083d7 <walkpgdir>
80108b17:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108b1a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108b1e:	75 0c                	jne    80108b2c <clearpteu+0x35>
    panic("clearpteu");
80108b20:	c7 04 24 48 95 10 80 	movl   $0x80109548,(%esp)
80108b27:	e8 11 7a ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108b2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b2f:	8b 00                	mov    (%eax),%eax
80108b31:	89 c2                	mov    %eax,%edx
80108b33:	83 e2 fb             	and    $0xfffffffb,%edx
80108b36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b39:	89 10                	mov    %edx,(%eax)
}
80108b3b:	c9                   	leave  
80108b3c:	c3                   	ret    
...
80108b40:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108b43:	e8 b9 f9 ff ff       	call   80108501 <setupkvm>
80108b48:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108b4b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108b4f:	75 0a                	jne    80108b5b <copyuvm+0x1e>
    return 0;
80108b51:	b8 00 00 00 00       	mov    $0x0,%eax
80108b56:	e9 f1 00 00 00       	jmp    80108c4c <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
80108b5b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108b62:	e9 c0 00 00 00       	jmp    80108c27 <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108b67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b6a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b71:	00 
80108b72:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b76:	8b 45 08             	mov    0x8(%ebp),%eax
80108b79:	89 04 24             	mov    %eax,(%esp)
80108b7c:	e8 56 f8 ff ff       	call   801083d7 <walkpgdir>
80108b81:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108b84:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108b88:	75 0c                	jne    80108b96 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108b8a:	c7 04 24 52 95 10 80 	movl   $0x80109552,(%esp)
80108b91:	e8 a7 79 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108b96:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b99:	8b 00                	mov    (%eax),%eax
80108b9b:	83 e0 01             	and    $0x1,%eax
80108b9e:	85 c0                	test   %eax,%eax
80108ba0:	75 0c                	jne    80108bae <copyuvm+0x71>
      panic("copyuvm: page not present");
80108ba2:	c7 04 24 6c 95 10 80 	movl   $0x8010956c,(%esp)
80108ba9:	e8 8f 79 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80108bae:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bb1:	8b 00                	mov    (%eax),%eax
80108bb3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108bb8:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
80108bbb:	e8 3f 9f ff ff       	call   80102aff <kalloc>
80108bc0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108bc3:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80108bc7:	74 6f                	je     80108c38 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108bc9:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108bcc:	89 04 24             	mov    %eax,(%esp)
80108bcf:	e8 80 f3 ff ff       	call   80107f54 <p2v>
80108bd4:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108bdb:	00 
80108bdc:	89 44 24 04          	mov    %eax,0x4(%esp)
80108be0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108be3:	89 04 24             	mov    %eax,(%esp)
80108be6:	e8 1e cd ff ff       	call   80105909 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
80108beb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108bee:	89 04 24             	mov    %eax,(%esp)
80108bf1:	e8 51 f3 ff ff       	call   80107f47 <v2p>
80108bf6:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108bf9:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108c00:	00 
80108c01:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108c05:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c0c:	00 
80108c0d:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c11:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c14:	89 04 24             	mov    %eax,(%esp)
80108c17:	e8 51 f8 ff ff       	call   8010846d <mappages>
80108c1c:	85 c0                	test   %eax,%eax
80108c1e:	78 1b                	js     80108c3b <copyuvm+0xfe>
  uint pa, i;
  char *mem;
...
80108c2a:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108c2d:	0f 82 34 ff ff ff    	jb     80108b67 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108c36:	eb 14                	jmp    80108c4c <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108c38:	90                   	nop
80108c39:	eb 01                	jmp    80108c3c <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108c3b:	90                   	nop
...
80108c42:	e8 22 fe ff ff       	call   80108a69 <freevm>
  return 0;
80108c47:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108c4c:	c9                   	leave  
80108c4d:	c3                   	ret    
...
{
80108c4e:	55                   	push   %ebp
80108c4f:	89 e5                	mov    %esp,%ebp
80108c51:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108c54:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108c5b:	00 
80108c5c:	8b 45 0c             	mov    0xc(%ebp),%eax
80108c5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c63:	8b 45 08             	mov    0x8(%ebp),%eax
80108c66:	89 04 24             	mov    %eax,(%esp)
80108c69:	e8 69 f7 ff ff       	call   801083d7 <walkpgdir>
80108c6e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108c71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c74:	8b 00                	mov    (%eax),%eax
80108c76:	83 e0 01             	and    $0x1,%eax
80108c79:	85 c0                	test   %eax,%eax
80108c7b:	75 07                	jne    80108c84 <uva2ka+0x36>
    return 0;
80108c7d:	b8 00 00 00 00       	mov    $0x0,%eax
80108c82:	eb 25                	jmp    80108ca9 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108c84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c87:	8b 00                	mov    (%eax),%eax
80108c89:	83 e0 04             	and    $0x4,%eax
80108c8c:	85 c0                	test   %eax,%eax
80108c8e:	75 07                	jne    80108c97 <uva2ka+0x49>
    return 0;
80108c90:	b8 00 00 00 00       	mov    $0x0,%eax
80108c95:	eb 12                	jmp    80108ca9 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108c97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c9a:	8b 00                	mov    (%eax),%eax
80108c9c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108ca1:	89 04 24             	mov    %eax,(%esp)
80108ca4:	e8 ab f2 ff ff       	call   80107f54 <p2v>
}
80108ca9:	c9                   	leave  
80108caa:	c3                   	ret    
...
80108cae:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108cb1:	8b 45 10             	mov    0x10(%ebp),%eax
80108cb4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108cb7:	e9 8b 00 00 00       	jmp    80108d47 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108cbc:	8b 45 0c             	mov    0xc(%ebp),%eax
80108cbf:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80108cd4:	e8 75 ff ff ff       	call   80108c4e <uva2ka>
80108cd9:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108cdc:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108ce0:	75 07                	jne    80108ce9 <copyout+0x3e>
      return -1;
80108ce2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108ce7:	eb 6d                	jmp    80108d56 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108ce9:	8b 45 0c             	mov    0xc(%ebp),%eax
80108cec:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108cef:	89 d1                	mov    %edx,%ecx
80108cf1:	29 c1                	sub    %eax,%ecx
80108cf3:	89 c8                	mov    %ecx,%eax
80108cf5:	05 00 10 00 00       	add    $0x1000,%eax
80108cfa:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108cfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d00:	3b 45 14             	cmp    0x14(%ebp),%eax
80108d03:	76 06                	jbe    80108d0b <copyout+0x60>
      n = len;
80108d05:	8b 45 14             	mov    0x14(%ebp),%eax
80108d08:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108d0b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d0e:	8b 55 0c             	mov    0xc(%ebp),%edx
80108d11:	89 d1                	mov    %edx,%ecx
80108d13:	29 c1                	sub    %eax,%ecx
80108d15:	89 c8                	mov    %ecx,%eax
80108d17:	03 45 e8             	add    -0x18(%ebp),%eax
80108d1a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108d1d:	89 54 24 08          	mov    %edx,0x8(%esp)
80108d21:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108d24:	89 54 24 04          	mov    %edx,0x4(%esp)
80108d28:	89 04 24             	mov    %eax,(%esp)
80108d2b:	e8 d9 cb ff ff       	call   80105909 <memmove>
    len -= n;
80108d30:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d33:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108d36:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d39:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108d3c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d3f:	05 00 10 00 00       	add    $0x1000,%eax
80108d44:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108d47:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108d4b:	0f 85 6b ff ff ff    	jne    80108cbc <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
80108d51:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108d56:	c9                   	leave  
80108d57:	c3                   	ret    
