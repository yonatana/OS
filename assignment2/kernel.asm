...
80100049:	e8 04 54 00 00       	call   80105452 <initlock>
...
801000bd:	e8 b1 53 00 00       	call   80105473 <acquire>
...
80100104:	e8 cc 53 00 00       	call   801054d5 <release>
        return b;
...
8010011f:	e8 68 50 00 00       	call   8010518c <sleep>
      goto loop;
...
8010017c:	e8 54 53 00 00       	call   801054d5 <release>
      return b;
...
8010023c:	e8 32 52 00 00       	call   80105473 <acquire>
...
8010029d:	e8 c6 4f 00 00       	call   80105268 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 27 52 00 00       	call   801054d5 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 b2 50 00 00       	call   80105473 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 0a 8c 10 80 	movl   $0x80108c0a,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 13 8c 10 80 	movl   $0x80108c13,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 9a 4f 00 00       	call   801054d5 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 1a 8c 10 80 	movl   $0x80108c1a,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 29 8c 10 80 	movl   $0x80108c29,(%esp)
...
80100592:	e8 8d 4f 00 00       	call   80105524 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 2b 8c 10 80 	movl   $0x80108c2b,(%esp)
...
801006b2:	e8 de 50 00 00       	call   80105795 <memmove>
    pos -= 80;
...
801006e1:	e8 dc 4f 00 00       	call   801056c2 <memset>
  }
...
80100776:	e8 ce 6a 00 00       	call   80107249 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 c2 6a 00 00       	call   80107249 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 b6 6a 00 00       	call   80107249 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 a9 6a 00 00       	call   80107249 <uartputc>
  cgaputc(c);
...
801007ba:	e8 b4 4c 00 00       	call   80105473 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 1f 4b 00 00       	call   8010530e <procdump>
      break;
...
801008f7:	e8 6c 49 00 00       	call   80105268 <wakeup>
        }
      }
      break;
...
8010091e:	e8 b2 4b 00 00       	call   801054d5 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 2b 4b 00 00       	call   80105473 <acquire>
  while(n > 0){
...
80100961:	e8 6f 4b 00 00       	call   801054d5 <release>
        ilock(ip);
...
8010098a:	e8 fd 47 00 00       	call   8010518c <sleep>
...
80100a08:	e8 c8 4a 00 00       	call   801054d5 <release>
  ilock(ip);
...
80100a3e:	e8 30 4a 00 00       	call   80105473 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 58 4a 00 00       	call   801054d5 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 2f 8c 10 	movl   $0x80108c2f,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 ab 49 00 00       	call   80105452 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 37 8c 10 	movl   $0x80108c37,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 c0 ed 10 80 	movl   $0x8010edc0,(%esp)
80100ab6:	e8 97 49 00 00       	call   80105452 <initlock>
...
80100b7b:	e8 0d 78 00 00       	call   8010838d <setupkvm>
...
80100c14:	e8 46 7b 00 00       	call   8010875f <allocuvm>
...
80100c51:	e8 1a 7a 00 00       	call   80108670 <loaduvm>
...
80100cbc:	e8 9e 7a 00 00       	call   8010875f <allocuvm>
...
80100ce0:	e8 9e 7c 00 00       	call   80108983 <clearpteu>
  sp = sz;
...
80100d0f:	e8 2c 4c 00 00       	call   80105940 <strlen>
...
80100d2d:	e8 0e 4c 00 00       	call   80105940 <strlen>
...
80100d57:	e8 db 7d 00 00       	call   80108b37 <copyout>
...
80100df7:	e8 3b 7d 00 00       	call   80108b37 <copyout>
...
80100e4e:	e8 9f 4a 00 00       	call   801058f2 <safestrcpy>
...
80100ea0:	e8 d9 75 00 00       	call   8010847e <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 45 7a 00 00       	call   801088f5 <freevm>
  return 0;
...
80100ee2:	e8 0e 7a 00 00       	call   801088f5 <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 3d 8c 10 	movl   $0x80108c3d,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80100f15:	e8 38 45 00 00       	call   80105452 <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 45 45 00 00       	call   80105473 <acquire>
...
80100f52:	e8 7e 45 00 00       	call   801054d5 <release>
      return f;
...
80100f70:	e8 60 45 00 00       	call   801054d5 <release>
  return 0;
...
80100f89:	e8 e5 44 00 00       	call   80105473 <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 44 8c 10 80 	movl   $0x80108c44,(%esp)
...
80100fba:	e8 16 45 00 00       	call   801054d5 <release>
  return f;
...
80100fd1:	e8 9d 44 00 00       	call   80105473 <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 4c 8c 10 80 	movl   $0x80108c4c,(%esp)
...
8010100c:	e8 c4 44 00 00       	call   801054d5 <release>
    return;
...
80101056:	e8 7a 44 00 00       	call   801054d5 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 56 8c 10 80 	movl   $0x80108c56,(%esp)
...
801012a3:	c7 04 24 5f 8c 10 80 	movl   $0x80108c5f,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 6f 8c 10 80 	movl   $0x80108c6f,(%esp)
...
80101320:	e8 70 44 00 00       	call   80105795 <memmove>
  brelse(bp);
...
80101366:	e8 57 43 00 00       	call   801056c2 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 79 8c 10 80 	movl   $0x80108c79,(%esp)
...
80101565:	c7 04 24 8f 8c 10 80 	movl   $0x80108c8f,(%esp)
...
801015b9:	c7 44 24 04 a2 8c 10 	movl   $0x80108ca2,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801015c8:	e8 85 3e 00 00       	call   80105452 <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 73 40 00 00       	call   801056c2 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 a9 8c 10 80 	movl   $0x80108ca9,(%esp)
...
80101747:	e8 49 40 00 00       	call   80105795 <memmove>
  log_write(bp);
...
80101771:	e8 fd 3c 00 00       	call   80105473 <acquire>
...
801017bb:	e8 15 3d 00 00       	call   801054d5 <release>
      return ip;
...
801017ee:	c7 04 24 bb 8c 10 80 	movl   $0x80108cbb,(%esp)
...
8010182c:	e8 a4 3c 00 00       	call   801054d5 <release>
...
80101843:	e8 2b 3c 00 00       	call   80105473 <acquire>
  ip->ref++;
...
8010185e:	e8 72 3c 00 00       	call   801054d5 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 cb 8c 10 80 	movl   $0x80108ccb,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101891:	e8 dd 3b 00 00       	call   80105473 <acquire>
...
801018a6:	e8 e1 38 00 00       	call   8010518c <sleep>
...
801018d0:	e8 00 3c 00 00       	call   801054d5 <release>
...
8010197b:	e8 15 3e 00 00       	call   80105795 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 d1 8c 10 80 	movl   $0x80108cd1,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 e0 8c 10 80 	movl   $0x80108ce0,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801019ec:	e8 82 3a 00 00       	call   80105473 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 5b 38 00 00       	call   80105268 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101a14:	e8 bc 3a 00 00       	call   801054d5 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 46 3a 00 00       	call   80105473 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 e8 8c 10 80 	movl   $0x80108ce8,(%esp)
...
80101a8a:	e8 46 3a 00 00       	call   801054d5 <release>
    itrunc(ip);
...
80101ab5:	e8 b9 39 00 00       	call   80105473 <acquire>
    ip->flags = 0;
...
80101aca:	e8 99 37 00 00       	call   80105268 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 eb 39 00 00       	call   801054d5 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 f2 8c 10 80 	movl   $0x80108cf2,(%esp)
...
80101e92:	e8 fe 38 00 00       	call   80105795 <memmove>
    brelse(bp);
...
80101ff8:	e8 98 37 00 00       	call   80105795 <memmove>
    log_write(bp);
...
8010207a:	e8 ba 37 00 00       	call   80105839 <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 05 8d 10 80 	movl   $0x80108d05,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 17 8d 10 80 	movl   $0x80108d17,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 17 8d 10 80 	movl   $0x80108d17,(%esp)
...
801021fc:	e8 90 36 00 00       	call   80105891 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 24 8d 10 80 	movl   $0x80108d24,(%esp)
...
801022b5:	e8 db 34 00 00       	call   80105795 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 c0 34 00 00       	call   80105795 <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 2c 8d 10 	movl   $0x80108d2c,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
8010253b:	e8 12 2f 00 00       	call   80105452 <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 30 8d 10 80 	movl   $0x80108d30,(%esp)
...
801026fe:	e8 70 2d 00 00       	call   80105473 <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 b8 2d 00 00       	call   801054d5 <release>
...
8010278b:	e8 d8 2a 00 00       	call   80105268 <wakeup>
...
801027ad:	e8 23 2d 00 00       	call   801054d5 <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 39 8d 10 80 	movl   $0x80108d39,(%esp)
...
801027df:	c7 04 24 4d 8d 10 80 	movl   $0x80108d4d,(%esp)
...
8010286a:	e8 1d 29 00 00       	call   8010518c <sleep>
...
80102886:	e8 4a 2c 00 00       	call   801054d5 <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 80 8d 10 80 	movl   $0x80108d80,(%esp)
...
801029d7:	c7 44 24 04 b2 8d 10 	movl   $0x80108db2,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
801029e6:	e8 67 2a 00 00       	call   80105452 <initlock>
  kmem.use_lock = 0;
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 b7 8d 10 80 	movl   $0x80108db7,(%esp)
...
80102ab5:	e8 08 2c 00 00       	call   801056c2 <memset>
...
80102aca:	e8 a4 29 00 00       	call   80105473 <acquire>
  r = (struct run*)v;
...
80102af8:	e8 d8 29 00 00       	call   801054d5 <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 59 29 00 00       	call   80105473 <acquire>
  r = kmem.freelist;
...
80102b42:	e8 8e 29 00 00       	call   801054d5 <release>
  return (char*)r;
...
80102ebe:	c7 04 24 c0 8d 10 80 	movl   $0x80108dc0,(%esp)
...
80103016:	c7 44 24 04 ec 8d 10 	movl   $0x80108dec,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103025:	e8 28 24 00 00       	call   80105452 <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 b8 26 00 00       	call   80105795 <memmove>
...
8010322a:	e8 44 22 00 00       	call   80105473 <acquire>
  while (log.busy) {
...
80103240:	e8 47 1f 00 00       	call   8010518c <sleep>
...
8010325f:	e8 71 22 00 00       	call   801054d5 <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
801032e0:	c7 04 24 f0 8d 10 80 	movl   $0x80108df0,(%esp)
...
801032f5:	c7 04 24 06 8e 10 80 	movl   $0x80108e06,(%esp)
...
80103384:	e8 0c 24 00 00       	call   80105795 <memmove>
  bwrite(lbuf);
...
80103424:	e8 21 50 00 00       	call   8010844a <kvmalloc>
...
8010343b:	e8 ad 49 00 00       	call   80107ded <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 1d 8e 10 80 	movl   $0x80108e1d,(%esp)
...
8010346b:	e8 c8 3c 00 00       	call   80107138 <uartinit>
  pinit();         // process table
80103470:	e8 96 0b 00 00       	call   8010400b <pinit>
  tvinit();        // trap vectors
80103475:	e8 61 38 00 00       	call   80106cdb <tvinit>
  binit();         // buffer cache
...
80103497:	e8 82 37 00 00       	call   80106c1e <timerinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 97 4f 00 00       	call   80108461 <switchkvm>
  seginit();
801034ca:	e8 1e 49 00 00       	call   80107ded <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 34 8e 10 80 	movl   $0x80108e34,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 47 39 00 00       	call   80106e4f <idtinit>
...
80103523:	e8 b8 1a 00 00       	call   80104fe0 <scheduler>
...
80103555:	e8 3b 22 00 00       	call   80105795 <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 48 8e 10 	movl   $0x80108e48,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 42 20 00 00       	call   80105739 <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 4d 8e 10 	movl   $0x80108e4d,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 01 1f 00 00       	call   80105739 <memcmp>
...
801038fe:	8b 04 85 90 8e 10 80 	mov    -0x7fef7170(,%eax,4),%eax
...
80103937:	c7 04 24 52 8e 10 80 	movl   $0x80108e52,(%esp)
...
801039ca:	c7 04 24 70 8e 10 80 	movl   $0x80108e70,(%esp)
...
80103ccf:	c7 44 24 04 a4 8e 10 	movl   $0x80108ea4,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 73 17 00 00       	call   80105452 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 e7 16 00 00       	call   80105473 <acquire>
  if(writable){
...
80103daa:	e8 b9 14 00 00       	call   80105268 <wakeup>
...
80103dc9:	e8 9a 14 00 00       	call   80105268 <wakeup>
  }
...
80103dee:	e8 e2 16 00 00       	call   801054d5 <release>
    kfree((char*)p);
...
80103e06:	e8 ca 16 00 00       	call   801054d5 <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 54 16 00 00       	call   80105473 <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 85 16 00 00       	call   801054d5 <release>
        return -1;
...
80103e65:	e8 fe 13 00 00       	call   80105268 <wakeup>
...
80103e7d:	e8 0a 13 00 00       	call   8010518c <sleep>
...
80103ee4:	e8 7f 13 00 00       	call   80105268 <wakeup>
  release(&p->lock);
80103ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eec:	89 04 24             	mov    %eax,(%esp)
80103eef:	e8 e1 15 00 00       	call   801054d5 <release>
  return n;
...
80103f0a:	e8 64 15 00 00       	call   80105473 <acquire>
...
80103f24:	e8 ac 15 00 00       	call   801054d5 <release>
      return -1;
...
80103f46:	e8 41 12 00 00       	call   8010518c <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fd6:	e8 8d 12 00 00       	call   80105268 <wakeup>
  release(&p->lock);
80103fdb:	8b 45 08             	mov    0x8(%ebp),%eax
80103fde:	89 04 24             	mov    %eax,(%esp)
80103fe1:	e8 ef 14 00 00       	call   801054d5 <release>
  return i;
...
80104011:	c7 44 24 04 ac 8e 10 	movl   $0x80108eac,0x4(%esp)
80104018:	80 
80104019:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104020:	e8 2d 14 00 00       	call   80105452 <initlock>
  initlock(&sem_table.lock, "sem_table"); // initial sem_table lock
80104025:	c7 44 24 04 b3 8e 10 	movl   $0x80108eb3,0x4(%esp)
8010402c:	80 
8010402d:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104034:	e8 19 14 00 00       	call   80105452 <initlock>
...
80104053:	c7 44 24 04 bd 8e 10 	movl   $0x80108ebd,0x4(%esp)
8010405a:	80 
8010405b:	89 04 24             	mov    %eax,(%esp)
8010405e:	e8 ef 13 00 00       	call   80105452 <initlock>
pinit(void)
{
  int i;
  initlock(&ptable.lock, "ptable");
...
8010407c:	e8 f2 13 00 00       	call   80105473 <acquire>
...
801040ab:	e8 25 14 00 00       	call   801054d5 <release>
  return 0;
...
801040df:	e8 f1 13 00 00       	call   801054d5 <release>
...
80104129:	ba 90 6c 10 80       	mov    $0x80106c90,%edx
...
80104159:	e8 64 15 00 00       	call   801056c2 <memset>
  p->context->eip = (uint)forkret;
8010415e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104161:	8b 40 1c             	mov    0x1c(%eax),%eax
80104164:	ba 60 51 10 80       	mov    $0x80105160,%edx
...
801041a5:	e8 e3 41 00 00       	call   8010838d <setupkvm>
...
801041ba:	c7 04 24 c7 8e 10 80 	movl   $0x80108ec7,(%esp)
...
801041e0:	e8 00 44 00 00       	call   801085e5 <inituvm>
  p->sz = PGSIZE;
...
80104207:	e8 b6 14 00 00       	call   801056c2 <memset>
...
80104280:	00 
80104281:	c7 44 24 04 e0 8e 10 	movl   $0x80108ee0,0x4(%esp)
80104288:	80 
80104289:	89 04 24             	mov    %eax,(%esp)
8010428c:	e8 61 16 00 00       	call   801058f2 <safestrcpy>
  p->cwd = namei("/");
80104291:	c7 04 24 e9 8e 10 80 	movl   $0x80108ee9,(%esp)
...
801042b2:	83 ec 28             	sub    $0x28,%esp
  ...
  sz = proc->sz;
801042b5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042bb:	8b 00                	mov    (%eax),%eax
801042bd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
801042c0:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801042c4:	7e 34                	jle    801042fa <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
801042c6:	8b 45 08             	mov    0x8(%ebp),%eax
801042c9:	89 c2                	mov    %eax,%edx
801042cb:	03 55 f4             	add    -0xc(%ebp),%edx
801042ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042d4:	8b 40 04             	mov    0x4(%eax),%eax
801042d7:	89 54 24 08          	mov    %edx,0x8(%esp)
801042db:	8b 55 f4             	mov    -0xc(%ebp),%edx
801042de:	89 54 24 04          	mov    %edx,0x4(%esp)
801042e2:	89 04 24             	mov    %eax,(%esp)
801042e5:	e8 75 44 00 00       	call   8010875f <allocuvm>
801042ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
801042ed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801042f1:	75 41                	jne    80104334 <growproc+0x85>
      return -1;
801042f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042f8:	eb 58                	jmp    80104352 <growproc+0xa3>
  } else if(n < 0){
801042fa:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801042fe:	79 34                	jns    80104334 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104300:	8b 45 08             	mov    0x8(%ebp),%eax
80104303:	89 c2                	mov    %eax,%edx
80104305:	03 55 f4             	add    -0xc(%ebp),%edx
...
80104318:	89 54 24 04          	mov    %edx,0x4(%esp)
8010431c:	89 04 24             	mov    %eax,(%esp)
8010431f:	e8 15 45 00 00       	call   80108839 <deallocuvm>
80104324:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104327:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010432b:	75 07                	jne    80104334 <growproc+0x85>
      return -1;
8010432d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104332:	eb 1e                	jmp    80104352 <growproc+0xa3>
  }
  proc->sz = sz;
...
80104348:	e8 31 41 00 00       	call   8010847e <switchuvm>
  return 0;
...
8010435a:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010435d:	e8 0d fd ff ff       	call   8010406f <allocproc>
80104362:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104365:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104369:	75 0a                	jne    80104375 <fork+0x21>
    return -1;
8010436b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104370:	e9 3a 01 00 00       	jmp    801044af <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
80104375:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010437b:	8b 10                	mov    (%eax),%edx
8010437d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104383:	8b 40 04             	mov    0x4(%eax),%eax
80104386:	89 54 24 04          	mov    %edx,0x4(%esp)
8010438a:	89 04 24             	mov    %eax,(%esp)
8010438d:	e8 37 46 00 00       	call   801089c9 <copyuvm>
80104392:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104395:	89 42 04             	mov    %eax,0x4(%edx)
80104398:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010439b:	8b 40 04             	mov    0x4(%eax),%eax
8010439e:	85 c0                	test   %eax,%eax
801043a0:	75 2c                	jne    801043ce <fork+0x7a>
    kfree(np->kstack);
801043a2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043a5:	8b 40 08             	mov    0x8(%eax),%eax
801043a8:	89 04 24             	mov    %eax,(%esp)
801043ab:	e8 b6 e6 ff ff       	call   80102a66 <kfree>
    np->kstack = 0;
801043b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043b3:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
...
801043c9:	e9 e1 00 00 00       	jmp    801044af <fork+0x15b>
  }
  np->sz = proc->sz;
801043ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043d4:	8b 10                	mov    (%eax),%edx
801043d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043d9:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
801043db:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801043e2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043e5:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
801043e8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043eb:	8b 50 18             	mov    0x18(%eax),%edx
801043ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043f4:	8b 40 18             	mov    0x18(%eax),%eax
801043f7:	89 c3                	mov    %eax,%ebx
801043f9:	b8 13 00 00 00       	mov    $0x13,%eax
801043fe:	89 d7                	mov    %edx,%edi
80104400:	89 de                	mov    %ebx,%esi
80104402:	89 c1                	mov    %eax,%ecx
80104404:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80104406:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104409:	8b 40 18             	mov    0x18(%eax),%eax
8010440c:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104413:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010441a:	eb 3d                	jmp    80104459 <fork+0x105>
    if(proc->ofile[i])
...
8010442e:	74 25                	je     80104455 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
80104430:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104436:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104439:	83 c2 08             	add    $0x8,%edx
8010443c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104440:	89 04 24             	mov    %eax,(%esp)
80104443:	e8 34 cb ff ff       	call   80100f7c <filedup>
80104448:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010444b:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010444e:	83 c1 08             	add    $0x8,%ecx
80104451:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
80104455:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104459:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
8010445d:	7e bd                	jle    8010441c <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
8010445f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104465:	8b 40 68             	mov    0x68(%eax),%eax
80104468:	89 04 24             	mov    %eax,(%esp)
8010446b:	e8 c6 d3 ff ff       	call   80101836 <idup>
80104470:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104473:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
80104476:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104479:	8b 40 10             	mov    0x10(%eax),%eax
8010447c:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
...
8010448f:	8d 50 6c             	lea    0x6c(%eax),%edx
80104492:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104495:	83 c0 6c             	add    $0x6c,%eax
80104498:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010449f:	00 
801044a0:	89 54 24 04          	mov    %edx,0x4(%esp)
801044a4:	89 04 24             	mov    %eax,(%esp)
801044a7:	e8 46 14 00 00       	call   801058f2 <safestrcpy>
  return pid;
801044ac:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801044af:	83 c4 2c             	add    $0x2c,%esp
801044b2:	5b                   	pop    %ebx
801044b3:	5e                   	pop    %esi
801044b4:	5f                   	pop    %edi
801044b5:	5d                   	pop    %ebp
...
801044bd:	83 ec 2c             	sub    $0x2c,%esp
  ...
  // Allocate process.
  if((np = allocproc()) == 0)
801044c0:	e8 aa fb ff ff       	call   8010406f <allocproc>
801044c5:	89 45 e0             	mov    %eax,-0x20(%ebp)
801044c8:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801044cc:	75 0a                	jne    801044d8 <thread_create+0x21>
    return -1;
801044ce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044d3:	e9 77 02 00 00       	jmp    8010474f <thread_create+0x298>
  
  
  if(proc->is_thread==0){//a procces creating a thread
801044d8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044de:	8b 40 7c             	mov    0x7c(%eax),%eax
801044e1:	85 c0                	test   %eax,%eax
801044e3:	0f 85 2b 01 00 00    	jne    80104614 <thread_create+0x15d>
    // Copy process state from p. 
...
801044f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044f7:	8b 40 04             	mov    0x4(%eax),%eax
801044fa:	89 54 24 04          	mov    %edx,0x4(%esp)
801044fe:	89 04 24             	mov    %eax,(%esp)
80104501:	e8 c3 44 00 00       	call   801089c9 <copyuvm>
80104506:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104509:	89 42 04             	mov    %eax,0x4(%edx)
8010450c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010450f:	8b 40 04             	mov    0x4(%eax),%eax
80104512:	85 c0                	test   %eax,%eax
80104514:	75 2c                	jne    80104542 <thread_create+0x8b>
    //if((np->pgdir = proc->pgdir) == 0){
      kfree(np->kstack);
80104516:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104519:	8b 40 08             	mov    0x8(%eax),%eax
8010451c:	89 04 24             	mov    %eax,(%esp)
8010451f:	e8 42 e5 ff ff       	call   80102a66 <kfree>
      np->kstack = 0;//from function
80104524:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104527:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
      np->state = UNUSED;
8010452e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104531:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
      return -1;
80104538:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010453d:	e9 0d 02 00 00       	jmp    8010474f <thread_create+0x298>
    }
    //np->kstack = stack;
    np->is_thread = 1;
80104542:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104545:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
//     if(proc->pid == 3){
//     cprintf("proc->sz %d\n",proc->sz); 
//     }
    np->sz = proc->sz;//third rgument
8010454c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104552:	8b 10                	mov    (%eax),%edx
80104554:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104557:	89 10                	mov    %edx,(%eax)
    //np->sz = stack_size;
  
    //if(proc->is_thread == 0){ // current process is not a thread
      np->parent = proc; // parent is current process
80104559:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104560:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104563:	89 50 14             	mov    %edx,0x14(%eax)
    //}else{
      //np->parent = proc->parent; //current "process" is a thread, pass is parent.
    //}
    
    *np->tf = *proc->tf;//from father
80104566:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104569:	8b 50 18             	mov    0x18(%eax),%edx
8010456c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104572:	8b 40 18             	mov    0x18(%eax),%eax
80104575:	89 c3                	mov    %eax,%ebx
80104577:	b8 13 00 00 00       	mov    $0x13,%eax
8010457c:	89 d7                	mov    %edx,%edi
8010457e:	89 de                	mov    %ebx,%esi
80104580:	89 c1                	mov    %eax,%ecx
80104582:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    np->tf->esp = (uint)stack+stack_size;
80104584:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104587:	8b 40 18             	mov    0x18(%eax),%eax
8010458a:	8b 55 0c             	mov    0xc(%ebp),%edx
8010458d:	03 55 10             	add    0x10(%ebp),%edx
80104590:	89 50 44             	mov    %edx,0x44(%eax)
    np->tf->eip = (uint)start_func;
80104593:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104596:	8b 40 18             	mov    0x18(%eax),%eax
80104599:	8b 55 08             	mov    0x8(%ebp),%edx
8010459c:	89 50 38             	mov    %edx,0x38(%eax)
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
...
801045b3:	eb 3d                	jmp    801045f2 <thread_create+0x13b>
	if(proc->ofile[i]){
...
801045c7:	74 25                	je     801045ee <thread_create+0x137>
...
801045f6:	7e bd                	jle    801045b5 <thread_create+0xfe>
	if(proc->ofile[i]){
	  np->ofile[i] = filedup(proc->ofile[i]);//dup-> [i]
...
8010460f:	e9 02 01 00 00       	jmp    80104716 <thread_create+0x25f>
      //tid->join
  }
...
80104654:	e9 f6 00 00 00       	jmp    8010474f <thread_create+0x298>
    }
   // np->kstack = stack;
    np->is_thread = 1;
80104659:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010465c:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
//     if(proc->pid == 3){
//     cprintf("proc->sz %d\n",proc->sz); 
//     }
   // np->sz = proc->sz;//third rgument
...
80104671:	8b 50 14             	mov    0x14(%eax),%edx
...
80104686:	8b 40 14             	mov    0x14(%eax),%eax
80104689:	8b 40 18             	mov    0x18(%eax),%eax
8010468c:	89 c3                	mov    %eax,%ebx
8010468e:	b8 13 00 00 00       	mov    $0x13,%eax
80104693:	89 d7                	mov    %edx,%edi
80104695:	89 de                	mov    %ebx,%esi
80104697:	89 c1                	mov    %eax,%ecx
80104699:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    np->tf->esp = (uint)stack+stack_size;
8010469b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010469e:	8b 40 18             	mov    0x18(%eax),%eax
801046a1:	8b 55 0c             	mov    0xc(%ebp),%edx
801046a4:	03 55 10             	add    0x10(%ebp),%edx
801046a7:	89 50 44             	mov    %edx,0x44(%eax)
    np->tf->eip = (uint)start_func;
801046aa:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046ad:	8b 40 18             	mov    0x18(%eax),%eax
801046b0:	8b 55 08             	mov    0x8(%ebp),%edx
801046b3:	89 50 38             	mov    %edx,0x38(%eax)
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
801046b6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046b9:	8b 40 18             	mov    0x18(%eax),%eax
801046bc:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
    
    for(i = 0; i < NOFILE; i++)
801046c3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801046ca:	eb 35                	jmp    80104701 <thread_create+0x24a>
      if(proc->ofile[i])
801046cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046d2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801046d5:	83 c2 08             	add    $0x8,%edx
801046d8:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801046dc:	85 c0                	test   %eax,%eax
801046de:	74 1d                	je     801046fd <thread_create+0x246>
	np->ofile[i] = proc->ofile[i];
801046e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046e6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801046e9:	83 c2 08             	add    $0x8,%edx
801046ec:	8b 54 90 08          	mov    0x8(%eax,%edx,4),%edx
801046f0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046f3:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801046f6:	83 c1 08             	add    $0x8,%ecx
801046f9:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
    np->tf->esp = (uint)stack+stack_size;
    np->tf->eip = (uint)start_func;
    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
    ...
    for(i = 0; i < NOFILE; i++)
801046fd:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104701:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104705:	7e c5                	jle    801046cc <thread_create+0x215>
      if(proc->ofile[i])
	np->ofile[i] = proc->ofile[i];
	//np->ofile[i] = filedup(proc->ofile[i]);//dup-> [i]
...
8010476e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104771:	85 c0                	test   %eax,%eax
80104773:	75 0b                	jne    80104780 <thread_getProcId+0x1b>
    return proc->pid;
80104775:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010477b:	8b 40 10             	mov    0x10(%eax),%eax
8010477e:	eb 0c                	jmp    8010478c <thread_getProcId+0x27>
  //else
  return proc->parent->pid;
80104780:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104786:	8b 40 14             	mov    0x14(%eax),%eax
80104789:	8b 40 10             	mov    0x10(%eax),%eax
}
8010478c:	5d                   	pop    %ebp
8010478d:	c3                   	ret    

8010478e <thread_join>:
...
80104791:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104794:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010479b:	e8 d3 0c 00 00       	call   80105473 <acquire>
  
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047a0:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
801047a7:	e9 96 00 00 00       	jmp    80104842 <thread_join+0xb4>
      if(p->thread_joined == thread_id){ //thread already joined by other thread
801047ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047af:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801047b5:	3b 45 08             	cmp    0x8(%ebp),%eax
801047b8:	75 16                	jne    801047d0 <thread_join+0x42>
	release(&ptable.lock);
801047ba:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801047c1:	e8 0f 0d 00 00       	call   801054d5 <release>
	return -2;
801047c6:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
801047cb:	e9 bc 00 00 00       	jmp    8010488c <thread_join+0xfe>
      }
      if(p->pid == thread_id && p->state == ZOMBIE){	// thread to joined already terminated(ZOMBIE)
801047d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047d3:	8b 40 10             	mov    0x10(%eax),%eax
801047d6:	3b 45 08             	cmp    0x8(%ebp),%eax
801047d9:	75 21                	jne    801047fc <thread_join+0x6e>
801047db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047de:	8b 40 0c             	mov    0xc(%eax),%eax
801047e1:	83 f8 05             	cmp    $0x5,%eax
801047e4:	75 16                	jne    801047fc <thread_join+0x6e>
	release(&ptable.lock);
801047e6:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801047ed:	e8 e3 0c 00 00       	call   801054d5 <release>
	return -1;
801047f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801047f7:	e9 90 00 00 00       	jmp    8010488c <thread_join+0xfe>
      }
...
801047ff:	8b 40 10             	mov    0x10(%eax),%eax
80104802:	3b 45 08             	cmp    0x8(%ebp),%eax
80104805:	75 23                	jne    8010482a <thread_join+0x9c>
...
80104815:	74 13                	je     8010482a <thread_join+0x9c>
	release(&ptable.lock);
80104817:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010481e:	e8 b2 0c 00 00       	call   801054d5 <release>
	return -1;
80104823:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104828:	eb 62                	jmp    8010488c <thread_join+0xfe>
      }
      if(p->pid == thread_id) // found a thread to join
8010482a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010482d:	8b 40 10             	mov    0x10(%eax),%eax
80104830:	3b 45 08             	cmp    0x8(%ebp),%eax
80104833:	75 06                	jne    8010483b <thread_join+0xad>
	thread_to_join = p;
...
80104838:	89 45 f0             	mov    %eax,-0x10(%ebp)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010483b:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104842:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104849:	0f 82 5d ff ff ff    	jb     801047ac <thread_join+0x1e>
	return -1;
      }
      if(p->pid == thread_id) // found a thread to join
	thread_to_join = p;
...
8010484f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104852:	8b 40 18             	mov    0x18(%eax),%eax
80104855:	8b 40 1c             	mov    0x1c(%eax),%eax
80104858:	89 c2                	mov    %eax,%edx
8010485a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010485d:	89 10                	mov    %edx,(%eax)
  release(&ptable.lock);
8010485f:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104866:	e8 6a 0c 00 00       	call   801054d5 <release>
...
80104880:	c7 40 0c 07 00 00 00 	movl   $0x7,0xc(%eax)
  return 0;
80104887:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010488c:	c9                   	leave  
8010488d:	c3                   	ret    

8010488e <thread_exit>:
...
8010489d:	83 f8 01             	cmp    $0x1,%eax
801048a0:	0f 85 48 01 00 00    	jne    801049ee <thread_exit+0x160>
    struct proc *p;
    int fd;

    if(proc == initproc)
801048a6:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801048ad:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801048b2:	39 c2                	cmp    %eax,%edx
801048b4:	75 0c                	jne    801048c2 <thread_exit+0x34>
      panic("init exiting");
801048b6:	c7 04 24 eb 8e 10 80 	movl   $0x80108eeb,(%esp)
801048bd:	e8 7b bc ff ff       	call   8010053d <panic>

    // Close all open files.
    for(fd = 0; fd < NOFILE; fd++){
801048c2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801048c9:	eb 44                	jmp    8010490f <thread_exit+0x81>
      if(proc->ofile[fd]){
...
801048dd:	74 2c                	je     8010490b <thread_exit+0x7d>
...
8010490a:	00 
    ...
    // Close all open files.
    for(fd = 0; fd < NOFILE; fd++){
8010490b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
8010490f:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104913:	7e b6                	jle    801048cb <thread_exit+0x3d>
	fileclose(proc->ofile[fd]);
	proc->ofile[fd] = 0;
      }
    }
...
8010491b:	8b 40 68             	mov    0x68(%eax),%eax
8010491e:	89 04 24             	mov    %eax,(%esp)
80104921:	e8 f5 d0 ff ff       	call   80101a1b <iput>
    proc->cwd = 0;
80104926:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010492c:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

    acquire(&ptable.lock);
80104933:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010493a:	e8 34 0b 00 00       	call   80105473 <acquire>

    // Parent might be sleeping in wait().
    wakeup1(proc->parent);
8010493f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104945:	8b 40 14             	mov    0x14(%eax),%eax
80104948:	89 04 24             	mov    %eax,(%esp)
8010494b:	e8 d7 08 00 00       	call   80105227 <wakeup1>
    
    // Pass abandoned children to init.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104950:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104957:	eb 6e                	jmp    801049c7 <thread_exit+0x139>
      if(p->parent == proc){
...
80104967:	75 24                	jne    8010498d <thread_exit+0xff>
	p->parent = initproc;
80104969:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
8010496f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104972:	89 50 14             	mov    %edx,0x14(%eax)
	if(p->state == ZOMBIE)
80104975:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104978:	8b 40 0c             	mov    0xc(%eax),%eax
8010497b:	83 f8 05             	cmp    $0x5,%eax
8010497e:	75 0d                	jne    8010498d <thread_exit+0xff>
	  wakeup1(initproc);
80104980:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104985:	89 04 24             	mov    %eax,(%esp)
80104988:	e8 9a 08 00 00       	call   80105227 <wakeup1>
      }
      //added to thread_join
      if(p->thread_joined == proc->pid && ret_val != 0){
8010498d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104990:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104996:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010499c:	8b 40 10             	mov    0x10(%eax),%eax
8010499f:	39 c2                	cmp    %eax,%edx
801049a1:	75 1d                	jne    801049c0 <thread_exit+0x132>
801049a3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801049a7:	74 17                	je     801049c0 <thread_exit+0x132>
...
801049b2:	89 45 08             	mov    %eax,0x8(%ebp)
	wakeup1(p);
801049b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b8:	89 04 24             	mov    %eax,(%esp)
801049bb:	e8 67 08 00 00       	call   80105227 <wakeup1>
    ...
    // Pass abandoned children to init.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049c0:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
801049c7:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
801049ce:	72 89                	jb     80104959 <thread_exit+0xcb>
	wakeup1(p);
      }
    }
...
801049d6:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    sched();
801049dd:	e8 9a 06 00 00       	call   8010507c <sched>
    panic("zombie exit");
801049e2:	c7 04 24 f8 8e 10 80 	movl   $0x80108ef8,(%esp)
801049e9:	e8 4f bb ff ff       	call   8010053d <panic>
  }
...
801049f0 <binary_semaphore_create>:
//TODO cehck stuff
...
801049f6:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
801049fd:	e8 71 0a 00 00       	call   80105473 <acquire>
  //TODO acquire semaphore (just maybe)
  int ret_semaphore = sem_table.next_sem;
80104a02:	a1 74 0f 11 80       	mov    0x80110f74,%eax
80104a07:	89 45 f4             	mov    %eax,-0xc(%ebp)
  sem_table.semaphore[ret_semaphore].value = initial_value;
80104a0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a0d:	c1 e0 06             	shl    $0x6,%eax
80104a10:	8d 90 a0 0f 11 80    	lea    -0x7feef060(%eax),%edx
80104a16:	8b 45 08             	mov    0x8(%ebp),%eax
80104a19:	89 42 0c             	mov    %eax,0xc(%edx)
  sem_table.semaphore[ret_semaphore].initialize = 1;
80104a1c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a1f:	c1 e0 06             	shl    $0x6,%eax
80104a22:	05 a0 0f 11 80       	add    $0x80110fa0,%eax
80104a27:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)
  sem_table.semaphore[ret_semaphore].queue =0;
80104a2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a31:	c1 e0 06             	shl    $0x6,%eax
80104a34:	05 a0 0f 11 80       	add    $0x80110fa0,%eax
80104a39:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  sem_table.next_sem++;
80104a40:	a1 74 0f 11 80       	mov    0x80110f74,%eax
80104a45:	83 c0 01             	add    $0x1,%eax
80104a48:	a3 74 0f 11 80       	mov    %eax,0x80110f74
  release(&sem_table.lock);
80104a4d:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104a54:	e8 7c 0a 00 00       	call   801054d5 <release>
...
80104a5e <binary_semaphore_down>:
...
80104a61:	83 ec 68             	sub    $0x68,%esp
  int ans = 0;
80104a64:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  //acuire the semaphore
  acquire(&sem_table.lock);
80104a6b:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104a72:	e8 fc 09 00 00       	call   80105473 <acquire>
  struct semaphore sem;
  acquire(&sem_table.semaphore[binary_semaphore_ID].lock);
80104a77:	8b 45 08             	mov    0x8(%ebp),%eax
80104a7a:	c1 e0 06             	shl    $0x6,%eax
80104a7d:	83 c0 30             	add    $0x30,%eax
80104a80:	05 40 0f 11 80       	add    $0x80110f40,%eax
80104a85:	83 c0 08             	add    $0x8,%eax
80104a88:	89 04 24             	mov    %eax,(%esp)
80104a8b:	e8 e3 09 00 00       	call   80105473 <acquire>
  sem = sem_table.semaphore[binary_semaphore_ID];
80104a90:	8b 45 08             	mov    0x8(%ebp),%eax
80104a93:	c1 e0 06             	shl    $0x6,%eax
80104a96:	05 70 0f 11 80       	add    $0x80110f70,%eax
80104a9b:	8b 50 08             	mov    0x8(%eax),%edx
80104a9e:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80104aa1:	8b 50 0c             	mov    0xc(%eax),%edx
80104aa4:	89 55 b8             	mov    %edx,-0x48(%ebp)
80104aa7:	8b 50 10             	mov    0x10(%eax),%edx
80104aaa:	89 55 bc             	mov    %edx,-0x44(%ebp)
80104aad:	8b 50 14             	mov    0x14(%eax),%edx
80104ab0:	89 55 c0             	mov    %edx,-0x40(%ebp)
80104ab3:	8b 50 18             	mov    0x18(%eax),%edx
80104ab6:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104ab9:	8b 50 1c             	mov    0x1c(%eax),%edx
80104abc:	89 55 c8             	mov    %edx,-0x38(%ebp)
80104abf:	8b 50 20             	mov    0x20(%eax),%edx
80104ac2:	89 55 cc             	mov    %edx,-0x34(%ebp)
80104ac5:	8b 50 24             	mov    0x24(%eax),%edx
80104ac8:	89 55 d0             	mov    %edx,-0x30(%ebp)
80104acb:	8b 50 28             	mov    0x28(%eax),%edx
80104ace:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104ad1:	8b 50 2c             	mov    0x2c(%eax),%edx
80104ad4:	89 55 d8             	mov    %edx,-0x28(%ebp)
80104ad7:	8b 50 30             	mov    0x30(%eax),%edx
80104ada:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104add:	8b 50 34             	mov    0x34(%eax),%edx
80104ae0:	89 55 e0             	mov    %edx,-0x20(%ebp)
80104ae3:	8b 50 38             	mov    0x38(%eax),%edx
80104ae6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104ae9:	8b 50 3c             	mov    0x3c(%eax),%edx
80104aec:	89 55 e8             	mov    %edx,-0x18(%ebp)
80104aef:	8b 50 40             	mov    0x40(%eax),%edx
80104af2:	89 55 ec             	mov    %edx,-0x14(%ebp)
80104af5:	8b 40 44             	mov    0x44(%eax),%eax
80104af8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  release(&sem_table.lock);
80104afb:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104b02:	e8 ce 09 00 00       	call   801054d5 <release>
  //cehck the resource & semaphore
  if(sem.initialize ==0){
80104b07:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b0a:	85 c0                	test   %eax,%eax
80104b0c:	75 1a                	jne    80104b28 <binary_semaphore_down+0xca>
...
80104b15:	c7 04 24 04 8f 10 80 	movl   $0x80108f04,(%esp)
80104b1c:	e8 80 b8 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104b21:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }
  
  //do down
  if(sem.value <=0){//the process is blocked
80104b28:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104b2b:	85 c0                	test   %eax,%eax
80104b2d:	7f 3e                	jg     80104b6d <binary_semaphore_down+0x10f>
    proc->wait_for_sem = binary_semaphore_ID;  
80104b2f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b35:	8b 55 08             	mov    0x8(%ebp),%edx
80104b38:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    sem.queue++; 
80104b3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b41:	83 c0 01             	add    $0x1,%eax
80104b44:	89 45 f0             	mov    %eax,-0x10(%ebp)
    proc->place_in_queue =sem.queue;
80104b47:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b4d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104b50:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
    sleep(proc, &sem.lock);
80104b56:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b5c:	8d 55 b4             	lea    -0x4c(%ebp),%edx
80104b5f:	89 54 24 04          	mov    %edx,0x4(%esp)
80104b63:	89 04 24             	mov    %eax,(%esp)
80104b66:	e8 21 06 00 00       	call   8010518c <sleep>
80104b6b:	eb 09                	jmp    80104b76 <binary_semaphore_down+0x118>
  }else{
    sem.value--;
80104b6d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104b70:	83 e8 01             	sub    $0x1,%eax
80104b73:	89 45 e8             	mov    %eax,-0x18(%ebp)
  }
  release(&sem.lock);
80104b76:	8d 45 b4             	lea    -0x4c(%ebp),%eax
80104b79:	89 04 24             	mov    %eax,(%esp)
80104b7c:	e8 54 09 00 00       	call   801054d5 <release>
  return ans;
...
80104b89:	83 ec 68             	sub    $0x68,%esp
  int ans = 0;
80104b8c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  struct proc *p;
  struct proc *proc_to_wake;
  //acuire the semaphore
  acquire(&sem_table.lock);
80104b93:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104b9a:	e8 d4 08 00 00       	call   80105473 <acquire>
  struct semaphore sem;
  acquire(&sem_table.semaphore[binary_semaphore_ID].lock);
80104b9f:	8b 45 08             	mov    0x8(%ebp),%eax
80104ba2:	c1 e0 06             	shl    $0x6,%eax
80104ba5:	83 c0 30             	add    $0x30,%eax
80104ba8:	05 40 0f 11 80       	add    $0x80110f40,%eax
80104bad:	83 c0 08             	add    $0x8,%eax
80104bb0:	89 04 24             	mov    %eax,(%esp)
80104bb3:	e8 bb 08 00 00       	call   80105473 <acquire>
  sem = sem_table.semaphore[binary_semaphore_ID];
80104bb8:	8b 45 08             	mov    0x8(%ebp),%eax
80104bbb:	c1 e0 06             	shl    $0x6,%eax
80104bbe:	05 70 0f 11 80       	add    $0x80110f70,%eax
80104bc3:	8b 50 08             	mov    0x8(%eax),%edx
80104bc6:	89 55 ac             	mov    %edx,-0x54(%ebp)
80104bc9:	8b 50 0c             	mov    0xc(%eax),%edx
80104bcc:	89 55 b0             	mov    %edx,-0x50(%ebp)
80104bcf:	8b 50 10             	mov    0x10(%eax),%edx
80104bd2:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80104bd5:	8b 50 14             	mov    0x14(%eax),%edx
80104bd8:	89 55 b8             	mov    %edx,-0x48(%ebp)
80104bdb:	8b 50 18             	mov    0x18(%eax),%edx
80104bde:	89 55 bc             	mov    %edx,-0x44(%ebp)
80104be1:	8b 50 1c             	mov    0x1c(%eax),%edx
80104be4:	89 55 c0             	mov    %edx,-0x40(%ebp)
80104be7:	8b 50 20             	mov    0x20(%eax),%edx
80104bea:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104bed:	8b 50 24             	mov    0x24(%eax),%edx
80104bf0:	89 55 c8             	mov    %edx,-0x38(%ebp)
80104bf3:	8b 50 28             	mov    0x28(%eax),%edx
80104bf6:	89 55 cc             	mov    %edx,-0x34(%ebp)
80104bf9:	8b 50 2c             	mov    0x2c(%eax),%edx
80104bfc:	89 55 d0             	mov    %edx,-0x30(%ebp)
80104bff:	8b 50 30             	mov    0x30(%eax),%edx
80104c02:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104c05:	8b 50 34             	mov    0x34(%eax),%edx
80104c08:	89 55 d8             	mov    %edx,-0x28(%ebp)
80104c0b:	8b 50 38             	mov    0x38(%eax),%edx
80104c0e:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104c11:	8b 50 3c             	mov    0x3c(%eax),%edx
80104c14:	89 55 e0             	mov    %edx,-0x20(%ebp)
80104c17:	8b 50 40             	mov    0x40(%eax),%edx
80104c1a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104c1d:	8b 40 44             	mov    0x44(%eax),%eax
80104c20:	89 45 e8             	mov    %eax,-0x18(%ebp)
  release(&sem_table.lock);
80104c23:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104c2a:	e8 a6 08 00 00       	call   801054d5 <release>
  
  //cehck the resource & semaphore
  if(sem.initialize ==0){
80104c2f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104c32:	85 c0                	test   %eax,%eax
80104c34:	75 1a                	jne    80104c50 <binary_semaphore_up+0xca>
     cprintf("we are tring to use uninitialize semaphore%d.",binary_semaphore_ID);
80104c36:	8b 45 08             	mov    0x8(%ebp),%eax
80104c39:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c3d:	c7 04 24 04 8f 10 80 	movl   $0x80108f04,(%esp)
80104c44:	e8 58 b7 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104c49:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }
  if (sem.value <= 0) {
80104c50:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104c53:	85 c0                	test   %eax,%eax
80104c55:	7f 1a                	jg     80104c71 <binary_semaphore_up+0xeb>
    cprintf("semaphoreID %d had realsed the already rleased resurs.",binary_semaphore_ID);
80104c57:	8b 45 08             	mov    0x8(%ebp),%eax
80104c5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c5e:	c7 04 24 34 8f 10 80 	movl   $0x80108f34,(%esp)
80104c65:	e8 37 b7 ff ff       	call   801003a1 <cprintf>
    ans =-1;
80104c6a:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  }  
  
  //do up
  if(sem.queue >0){//there are procecse waiting for this semaphore
80104c71:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104c74:	85 c0                	test   %eax,%eax
80104c76:	7e 6a                	jle    80104ce2 <binary_semaphore_up+0x15c>
  acquire(&ptable.lock);
80104c78:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104c7f:	e8 ef 07 00 00       	call   80105473 <acquire>
    //find process to wakeup
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c84:	c7 45 f0 b4 2f 11 80 	movl   $0x80112fb4,-0x10(%ebp)
80104c8b:	eb 3e                	jmp    80104ccb <binary_semaphore_up+0x145>
      if(p->wait_for_sem == binary_semaphore_ID){ //this process is waiting for this semaphore
80104c8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c90:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104c96:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c99:	75 29                	jne    80104cc4 <binary_semaphore_up+0x13e>
	if(p->place_in_queue ==1){
80104c9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c9e:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104ca4:	83 f8 01             	cmp    $0x1,%eax
80104ca7:	75 06                	jne    80104caf <binary_semaphore_up+0x129>
	  proc_to_wake = p;
80104ca9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cac:	89 45 ec             	mov    %eax,-0x14(%ebp)
	}
	p->place_in_queue=p->place_in_queue-1;//get every process to the next place inline
80104caf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb2:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104cb8:	8d 50 ff             	lea    -0x1(%eax),%edx
80104cbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cbe:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
  ...
  acquire(&ptable.lock);
    //find process to wakeup
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cc4:	81 45 f0 90 00 00 00 	addl   $0x90,-0x10(%ebp)
80104ccb:	81 7d f0 b4 53 11 80 	cmpl   $0x801153b4,-0x10(%ebp)
80104cd2:	72 b9                	jb     80104c8d <binary_semaphore_up+0x107>
	  proc_to_wake = p;
	}
	p->place_in_queue=p->place_in_queue-1;//get every process to the next place inline
      }
    ...
    release(&ptable.lock);
80104cd4:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104cdb:	e8 f5 07 00 00       	call   801054d5 <release>
80104ce0:	eb 09                	jmp    80104ceb <binary_semaphore_up+0x165>
  }else{
  sem.value++;  
80104ce2:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104ce5:	83 c0 01             	add    $0x1,%eax
80104ce8:	89 45 e0             	mov    %eax,-0x20(%ebp)
  }
  release(&sem.lock);
80104ceb:	8d 45 ac             	lea    -0x54(%ebp),%eax
80104cee:	89 04 24             	mov    %eax,(%esp)
80104cf1:	e8 df 07 00 00       	call   801054d5 <release>
  //update the awaken proccees
  proc_to_wake->wait_for_sem =-1;//not waitng anymore
80104cf6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104cf9:	c7 80 88 00 00 00 ff 	movl   $0xffffffff,0x88(%eax)
80104d00:	ff ff ff 
  wakeup1(proc_to_wake);
80104d03:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104d06:	89 04 24             	mov    %eax,(%esp)
80104d09:	e8 19 05 00 00       	call   80105227 <wakeup1>
  return ans;
...
80104d16:	83 ec 28             	sub    $0x28,%esp
  ...
  if(proc == initproc)
80104d19:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104d20:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104d25:	39 c2                	cmp    %eax,%edx
80104d27:	75 0c                	jne    80104d35 <exit+0x22>
    panic("init exiting");
80104d29:	c7 04 24 eb 8e 10 80 	movl   $0x80108eeb,(%esp)
80104d30:	e8 08 b8 ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104d35:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104d3c:	eb 44                	jmp    80104d82 <exit+0x6f>
    if(proc->ofile[fd]){
...
80104d7d:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104d7e:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104d82:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104d86:	7e b6                	jle    80104d3e <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
80104d8e:	8b 40 68             	mov    0x68(%eax),%eax
80104d91:	89 04 24             	mov    %eax,(%esp)
80104d94:	e8 82 cc ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
80104d99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d9f:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104da6:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104dad:	e8 c1 06 00 00       	call   80105473 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104db2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104db8:	8b 40 14             	mov    0x14(%eax),%eax
80104dbb:	89 04 24             	mov    %eax,(%esp)
80104dbe:	e8 64 04 00 00       	call   80105227 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104dc3:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104dca:	eb 3b                	jmp    80104e07 <exit+0xf4>
    if(p->parent == proc){
80104dcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dcf:	8b 50 14             	mov    0x14(%eax),%edx
80104dd2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104dd8:	39 c2                	cmp    %eax,%edx
80104dda:	75 24                	jne    80104e00 <exit+0xed>
      p->parent = initproc;
80104ddc:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
80104de2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104de5:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
80104de8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104deb:	8b 40 0c             	mov    0xc(%eax),%eax
80104dee:	83 f8 05             	cmp    $0x5,%eax
80104df1:	75 0d                	jne    80104e00 <exit+0xed>
        wakeup1(initproc);
80104df3:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104df8:	89 04 24             	mov    %eax,(%esp)
80104dfb:	e8 27 04 00 00       	call   80105227 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e00:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104e07:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104e0e:	72 bc                	jb     80104dcc <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
80104e16:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104e1d:	e8 5a 02 00 00       	call   8010507c <sched>
  panic("zombie exit");
80104e22:	c7 04 24 f8 8e 10 80 	movl   $0x80108ef8,(%esp)
80104e29:	e8 0f b7 ff ff       	call   8010053d <panic>
...
80104e31:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104e34:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104e3b:	e8 33 06 00 00       	call   80105473 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104e40:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e47:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104e4e:	e9 9d 00 00 00       	jmp    80104ef0 <wait+0xc2>
      if(p->parent != proc)
...
80104e61:	0f 85 81 00 00 00    	jne    80104ee8 <wait+0xba>
        continue;
      havekids = 1;
...
80104e77:	75 70                	jne    80104ee9 <wait+0xbb>
	// Found one.
        pid = p->pid;
...
80104e8b:	e8 d6 db ff ff       	call   80102a66 <kfree>
        p->kstack = 0;
...
80104ea3:	e8 4d 3a 00 00       	call   801088f5 <freevm>
	p->state = UNUSED;
80104ea8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eab:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104eb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eb5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104ebc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ebf:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104ec6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ec9:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104ecd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ed0:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104ed7:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104ede:	e8 f2 05 00 00       	call   801054d5 <release>
        return pid;
80104ee3:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ee6:	eb 56                	jmp    80104f3e <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104ee8:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ee9:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104ef0:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80104ef7:	0f 82 56 ff ff ff    	jb     80104e53 <wait+0x25>
        return pid;
      }
...
80104efd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104f01:	74 0d                	je     80104f10 <wait+0xe2>
80104f03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f09:	8b 40 24             	mov    0x24(%eax),%eax
80104f0c:	85 c0                	test   %eax,%eax
80104f0e:	74 13                	je     80104f23 <wait+0xf5>
      release(&ptable.lock);
80104f10:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104f17:	e8 b9 05 00 00       	call   801054d5 <release>
      return -1;
80104f1c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f21:	eb 1b                	jmp    80104f3e <wait+0x110>
    }
    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104f23:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f29:	c7 44 24 04 80 2f 11 	movl   $0x80112f80,0x4(%esp)
80104f30:	80 
80104f31:	89 04 24             	mov    %eax,(%esp)
80104f34:	e8 53 02 00 00       	call   8010518c <sleep>
  }
80104f39:	e9 02 ff ff ff       	jmp    80104e40 <wait+0x12>
}
80104f3e:	c9                   	leave  
80104f3f:	c3                   	ret    

80104f40 <register_handler>:
...
80104f4f:	8b 40 44             	mov    0x44(%eax),%eax
80104f52:	89 c2                	mov    %eax,%edx
80104f54:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f5a:	8b 40 04             	mov    0x4(%eax),%eax
80104f5d:	89 54 24 04          	mov    %edx,0x4(%esp)
80104f61:	89 04 24             	mov    %eax,(%esp)
80104f64:	e8 71 3b 00 00       	call   80108ada <uva2ka>
80104f69:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
80104f6c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f72:	8b 40 18             	mov    0x18(%eax),%eax
80104f75:	8b 40 44             	mov    0x44(%eax),%eax
80104f78:	25 ff 0f 00 00       	and    $0xfff,%eax
80104f7d:	85 c0                	test   %eax,%eax
80104f7f:	75 0c                	jne    80104f8d <register_handler+0x4d>
    panic("esp_offset == 0");
80104f81:	c7 04 24 6b 8f 10 80 	movl   $0x80108f6b,(%esp)
80104f88:	e8 b0 b5 ff ff       	call   8010053d <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
80104f8d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f93:	8b 40 18             	mov    0x18(%eax),%eax
80104f96:	8b 40 44             	mov    0x44(%eax),%eax
80104f99:	83 e8 04             	sub    $0x4,%eax
80104f9c:	25 ff 0f 00 00       	and    $0xfff,%eax
80104fa1:	03 45 f4             	add    -0xc(%ebp),%eax
          = proc->tf->eip;
80104fa4:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104fab:	8b 52 18             	mov    0x18(%edx),%edx
80104fae:	8b 52 38             	mov    0x38(%edx),%edx
80104fb1:	89 10                	mov    %edx,(%eax)
  proc->tf->esp -= 4;
80104fb3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fb9:	8b 40 18             	mov    0x18(%eax),%eax
80104fbc:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104fc3:	8b 52 18             	mov    0x18(%edx),%edx
80104fc6:	8b 52 44             	mov    0x44(%edx),%edx
80104fc9:	83 ea 04             	sub    $0x4,%edx
80104fcc:	89 50 44             	mov    %edx,0x44(%eax)
...
80104fdb:	89 50 38             	mov    %edx,0x38(%eax)
}
80104fde:	c9                   	leave  
80104fdf:	c3                   	ret    
...
80104fe3:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104fe6:	e8 1a f0 ff ff       	call   80104005 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104feb:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80104ff2:	e8 7c 04 00 00       	call   80105473 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ff7:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
80104ffe:	eb 62                	jmp    80105062 <scheduler+0x82>
      if(p->state != RUNNABLE)
80105000:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105003:	8b 40 0c             	mov    0xc(%eax),%eax
80105006:	83 f8 03             	cmp    $0x3,%eax
80105009:	75 4f                	jne    8010505a <scheduler+0x7a>
        continue;
...
8010500e:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80105014:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105017:	89 04 24             	mov    %eax,(%esp)
8010501a:	e8 5f 34 00 00       	call   8010847e <switchuvm>
      p->state = RUNNING;
8010501f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105022:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      
      swtch(&cpu->scheduler, proc->context);
80105029:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010502f:	8b 40 1c             	mov    0x1c(%eax),%eax
80105032:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105039:	83 c2 04             	add    $0x4,%edx
8010503c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105040:	89 14 24             	mov    %edx,(%esp)
80105043:	e8 20 09 00 00       	call   80105968 <swtch>
      switchkvm();
80105048:	e8 14 34 00 00       	call   80108461 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
8010504d:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80105054:	00 00 00 00 
80105058:	eb 01                	jmp    8010505b <scheduler+0x7b>
...
8010505a:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010505b:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80105062:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
80105069:	72 95                	jb     80105000 <scheduler+0x20>
    ...
    release(&ptable.lock);
8010506b:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105072:	e8 5e 04 00 00       	call   801054d5 <release>

  }
80105077:	e9 6a ff ff ff       	jmp    80104fe6 <scheduler+0x6>
...
8010507f:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80105082:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105089:	e8 03 05 00 00       	call   80105591 <holding>
8010508e:	85 c0                	test   %eax,%eax
80105090:	75 0c                	jne    8010509e <sched+0x22>
    panic("sched ptable.lock");
80105092:	c7 04 24 7b 8f 10 80 	movl   $0x80108f7b,(%esp)
80105099:	e8 9f b4 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
8010509e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050a4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050aa:	83 f8 01             	cmp    $0x1,%eax
801050ad:	74 0c                	je     801050bb <sched+0x3f>
    panic("sched locks");
801050af:	c7 04 24 8d 8f 10 80 	movl   $0x80108f8d,(%esp)
801050b6:	e8 82 b4 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
801050bb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050c1:	8b 40 0c             	mov    0xc(%eax),%eax
801050c4:	83 f8 04             	cmp    $0x4,%eax
801050c7:	75 0c                	jne    801050d5 <sched+0x59>
    panic("sched running");
801050c9:	c7 04 24 99 8f 10 80 	movl   $0x80108f99,(%esp)
801050d0:	e8 68 b4 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
801050d5:	e8 16 ef ff ff       	call   80103ff0 <readeflags>
801050da:	25 00 02 00 00       	and    $0x200,%eax
801050df:	85 c0                	test   %eax,%eax
801050e1:	74 0c                	je     801050ef <sched+0x73>
    panic("sched interruptible");
801050e3:	c7 04 24 a7 8f 10 80 	movl   $0x80108fa7,(%esp)
801050ea:	e8 4e b4 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
801050ef:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050f5:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801050fb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
801050fe:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105104:	8b 40 04             	mov    0x4(%eax),%eax
80105107:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010510e:	83 c2 1c             	add    $0x1c,%edx
80105111:	89 44 24 04          	mov    %eax,0x4(%esp)
80105115:	89 14 24             	mov    %edx,(%esp)
80105118:	e8 4b 08 00 00       	call   80105968 <swtch>
  cpu->intena = intena;
8010511d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105123:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105126:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010512c:	c9                   	leave  
8010512d:	c3                   	ret    
...
80105134:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010513b:	e8 33 03 00 00       	call   80105473 <acquire>
  proc->state = RUNNABLE;
80105140:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105146:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
8010514d:	e8 2a ff ff ff       	call   8010507c <sched>
  release(&ptable.lock);
80105152:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105159:	e8 77 03 00 00       	call   801054d5 <release>
}
8010515e:	c9                   	leave  
8010515f:	c3                   	ret    
...
80105163:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80105166:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010516d:	e8 63 03 00 00       	call   801054d5 <release>

  if (first) {
80105172:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80105177:	85 c0                	test   %eax,%eax
80105179:	74 0f                	je     8010518a <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
8010517b:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80105182:	00 00 00 
    initlog();
80105185:	e8 86 de ff ff       	call   80103010 <initlog>
  }
...
8010519a:	75 0c                	jne    801051a8 <sleep+0x1c>
    panic("sleep");
8010519c:	c7 04 24 bb 8f 10 80 	movl   $0x80108fbb,(%esp)
801051a3:	e8 95 b3 ff ff       	call   8010053d <panic>

  if(lk == 0)
801051a8:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801051ac:	75 0c                	jne    801051ba <sleep+0x2e>
    panic("sleep without lk");
801051ae:	c7 04 24 c1 8f 10 80 	movl   $0x80108fc1,(%esp)
801051b5:	e8 83 b3 ff ff       	call   8010053d <panic>
...
801051ba:	81 7d 0c 80 2f 11 80 	cmpl   $0x80112f80,0xc(%ebp)
801051c1:	74 17                	je     801051da <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
801051c3:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801051ca:	e8 a4 02 00 00       	call   80105473 <acquire>
    release(lk);
801051cf:	8b 45 0c             	mov    0xc(%ebp),%eax
801051d2:	89 04 24             	mov    %eax,(%esp)
801051d5:	e8 fb 02 00 00       	call   801054d5 <release>
  }
  // Go to sleep.
  proc->chan = chan;
801051da:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051e0:	8b 55 08             	mov    0x8(%ebp),%edx
801051e3:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
801051e6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051ec:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
801051f3:	e8 84 fe ff ff       	call   8010507c <sched>
  // Tidy up.
  proc->chan = 0;
801051f8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051fe:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
  
  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80105205:	81 7d 0c 80 2f 11 80 	cmpl   $0x80112f80,0xc(%ebp)
8010520c:	74 17                	je     80105225 <sleep+0x99>
    release(&ptable.lock);
8010520e:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105215:	e8 bb 02 00 00       	call   801054d5 <release>
    acquire(lk);
8010521a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010521d:	89 04 24             	mov    %eax,(%esp)
80105220:	e8 4e 02 00 00       	call   80105473 <acquire>
  }
}
80105225:	c9                   	leave  
80105226:	c3                   	ret    
...
8010522a:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010522d:	c7 45 fc b4 2f 11 80 	movl   $0x80112fb4,-0x4(%ebp)
80105234:	eb 27                	jmp    8010525d <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80105236:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105239:	8b 40 0c             	mov    0xc(%eax),%eax
8010523c:	83 f8 02             	cmp    $0x2,%eax
8010523f:	75 15                	jne    80105256 <wakeup1+0x2f>
80105241:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105244:	8b 40 20             	mov    0x20(%eax),%eax
80105247:	3b 45 08             	cmp    0x8(%ebp),%eax
8010524a:	75 0a                	jne    80105256 <wakeup1+0x2f>
      p->state = RUNNABLE;
8010524c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010524f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105256:	81 45 fc 90 00 00 00 	addl   $0x90,-0x4(%ebp)
8010525d:	81 7d fc b4 53 11 80 	cmpl   $0x801153b4,-0x4(%ebp)
80105264:	72 d0                	jb     80105236 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80105266:	c9                   	leave  
...
8010526b:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
8010526e:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105275:	e8 f9 01 00 00       	call   80105473 <acquire>
  wakeup1(chan);
8010527a:	8b 45 08             	mov    0x8(%ebp),%eax
8010527d:	89 04 24             	mov    %eax,(%esp)
80105280:	e8 a2 ff ff ff       	call   80105227 <wakeup1>
  release(&ptable.lock);
80105285:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
8010528c:	e8 44 02 00 00       	call   801054d5 <release>
}
80105291:	c9                   	leave  
80105292:	c3                   	ret    
...
80105296:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80105299:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801052a0:	e8 ce 01 00 00       	call   80105473 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801052a5:	c7 45 f4 b4 2f 11 80 	movl   $0x80112fb4,-0xc(%ebp)
801052ac:	eb 44                	jmp    801052f2 <kill+0x5f>
    if(p->pid == pid){
801052ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052b1:	8b 40 10             	mov    0x10(%eax),%eax
801052b4:	3b 45 08             	cmp    0x8(%ebp),%eax
801052b7:	75 32                	jne    801052eb <kill+0x58>
      p->killed = 1;
801052b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052bc:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801052c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052c6:	8b 40 0c             	mov    0xc(%eax),%eax
801052c9:	83 f8 02             	cmp    $0x2,%eax
801052cc:	75 0a                	jne    801052d8 <kill+0x45>
        p->state = RUNNABLE;
801052ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052d1:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
801052d8:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
801052df:	e8 f1 01 00 00       	call   801054d5 <release>
      return 0;
801052e4:	b8 00 00 00 00       	mov    $0x0,%eax
801052e9:	eb 21                	jmp    8010530c <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801052eb:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
801052f2:	81 7d f4 b4 53 11 80 	cmpl   $0x801153b4,-0xc(%ebp)
801052f9:	72 b3                	jb     801052ae <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801052fb:	c7 04 24 80 2f 11 80 	movl   $0x80112f80,(%esp)
80105302:	e8 ce 01 00 00       	call   801054d5 <release>
  return -1;
...
80105311:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105314:	c7 45 f0 b4 2f 11 80 	movl   $0x80112fb4,-0x10(%ebp)
8010531b:	e9 db 00 00 00       	jmp    801053fb <procdump+0xed>
    if(p->state == UNUSED)
80105320:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105323:	8b 40 0c             	mov    0xc(%eax),%eax
80105326:	85 c0                	test   %eax,%eax
80105328:	0f 84 c5 00 00 00    	je     801053f3 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010532e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105331:	8b 40 0c             	mov    0xc(%eax),%eax
80105334:	83 f8 05             	cmp    $0x5,%eax
80105337:	77 23                	ja     8010535c <procdump+0x4e>
80105339:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010533c:	8b 40 0c             	mov    0xc(%eax),%eax
8010533f:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105346:	85 c0                	test   %eax,%eax
80105348:	74 12                	je     8010535c <procdump+0x4e>
      state = states[p->state];
8010534a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010534d:	8b 40 0c             	mov    0xc(%eax),%eax
80105350:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105357:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010535a:	eb 07                	jmp    80105363 <procdump+0x55>
    else
      state = "???";
8010535c:	c7 45 ec d2 8f 10 80 	movl   $0x80108fd2,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80105363:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105366:	8d 50 6c             	lea    0x6c(%eax),%edx
80105369:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010536c:	8b 40 10             	mov    0x10(%eax),%eax
8010536f:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105373:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105376:	89 54 24 08          	mov    %edx,0x8(%esp)
8010537a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010537e:	c7 04 24 d6 8f 10 80 	movl   $0x80108fd6,(%esp)
80105385:	e8 17 b0 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
8010538a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010538d:	8b 40 0c             	mov    0xc(%eax),%eax
80105390:	83 f8 02             	cmp    $0x2,%eax
80105393:	75 50                	jne    801053e5 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105395:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105398:	8b 40 1c             	mov    0x1c(%eax),%eax
8010539b:	8b 40 0c             	mov    0xc(%eax),%eax
8010539e:	83 c0 08             	add    $0x8,%eax
801053a1:	8d 55 c4             	lea    -0x3c(%ebp),%edx
801053a4:	89 54 24 04          	mov    %edx,0x4(%esp)
801053a8:	89 04 24             	mov    %eax,(%esp)
801053ab:	e8 74 01 00 00       	call   80105524 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801053b0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801053b7:	eb 1b                	jmp    801053d4 <procdump+0xc6>
        cprintf(" %p", pc[i]);
801053b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053bc:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
801053c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801053c4:	c7 04 24 df 8f 10 80 	movl   $0x80108fdf,(%esp)
801053cb:	e8 d1 af ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
801053d0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801053d4:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
801053d8:	7f 0b                	jg     801053e5 <procdump+0xd7>
801053da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053dd:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
801053e1:	85 c0                	test   %eax,%eax
801053e3:	75 d4                	jne    801053b9 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
801053e5:	c7 04 24 e3 8f 10 80 	movl   $0x80108fe3,(%esp)
801053ec:	e8 b0 af ff ff       	call   801003a1 <cprintf>
801053f1:	eb 01                	jmp    801053f4 <procdump+0xe6>
  char *state;
  uint pc[10];
...
801053f3:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801053f4:	81 45 f0 90 00 00 00 	addl   $0x90,-0x10(%ebp)
801053fb:	81 7d f0 b4 53 11 80 	cmpl   $0x801153b4,-0x10(%ebp)
80105402:	0f 82 18 ff ff ff    	jb     80105320 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80105413:	9c                   	pushf  
80105414:	5b                   	pop    %ebx
80105415:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
8010543f:	89 d8                	mov    %ebx,%eax
80105441:	f0 87 02             	lock xchg %eax,(%edx)
...
80105458:	8b 55 0c             	mov    0xc(%ebp),%edx
8010545b:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
8010545e:	8b 45 08             	mov    0x8(%ebp),%eax
80105461:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80105467:	8b 45 08             	mov    0x8(%ebp),%eax
8010546a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105471:	5d                   	pop    %ebp
80105472:	c3                   	ret    
...
80105476:	83 ec 18             	sub    $0x18,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80105479:	e8 3d 01 00 00       	call   801055bb <pushcli>
  if(holding(lk))
8010547e:	8b 45 08             	mov    0x8(%ebp),%eax
80105481:	89 04 24             	mov    %eax,(%esp)
80105484:	e8 08 01 00 00       	call   80105591 <holding>
80105489:	85 c0                	test   %eax,%eax
8010548b:	74 0c                	je     80105499 <acquire+0x26>
    panic("acquire");
8010548d:	c7 04 24 0f 90 10 80 	movl   $0x8010900f,(%esp)
80105494:	e8 a4 b0 ff ff       	call   8010053d <panic>
...
8010549d:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801054a4:	00 
801054a5:	89 04 24             	mov    %eax,(%esp)
801054a8:	e8 80 ff ff ff       	call   8010542d <xchg>
801054ad:	85 c0                	test   %eax,%eax
801054af:	75 e9                	jne    8010549a <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801054b1:	8b 45 08             	mov    0x8(%ebp),%eax
801054b4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801054bb:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801054be:	8b 45 08             	mov    0x8(%ebp),%eax
801054c1:	83 c0 0c             	add    $0xc,%eax
801054c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801054c8:	8d 45 08             	lea    0x8(%ebp),%eax
801054cb:	89 04 24             	mov    %eax,(%esp)
801054ce:	e8 51 00 00 00       	call   80105524 <getcallerpcs>
}
801054d3:	c9                   	leave  
801054d4:	c3                   	ret    
...
801054e1:	e8 ab 00 00 00       	call   80105591 <holding>
801054e6:	85 c0                	test   %eax,%eax
801054e8:	75 0c                	jne    801054f6 <release+0x21>
    panic("release");
801054ea:	c7 04 24 17 90 10 80 	movl   $0x80109017,(%esp)
801054f1:	e8 47 b0 ff ff       	call   8010053d <panic>
...
80105518:	e8 10 ff ff ff       	call   8010542d <xchg>

  popcli();
8010551d:	e8 e1 00 00 00       	call   80105603 <popcli>
}
80105522:	c9                   	leave  
80105523:	c3                   	ret    

80105524 <getcallerpcs>:
...
8010552d:	83 e8 08             	sub    $0x8,%eax
80105530:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105533:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010553a:	eb 32                	jmp    8010556e <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010553c:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105540:	74 47                	je     80105589 <getcallerpcs+0x65>
80105542:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105549:	76 3e                	jbe    80105589 <getcallerpcs+0x65>
8010554b:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010554f:	74 38                	je     80105589 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105551:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105554:	c1 e0 02             	shl    $0x2,%eax
80105557:	03 45 0c             	add    0xc(%ebp),%eax
8010555a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010555d:	8b 52 04             	mov    0x4(%edx),%edx
80105560:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80105562:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105565:	8b 00                	mov    (%eax),%eax
80105567:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
8010556a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010556e:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105572:	7e c8                	jle    8010553c <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105574:	eb 13                	jmp    80105589 <getcallerpcs+0x65>
    pcs[i] = 0;
80105576:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105579:	c1 e0 02             	shl    $0x2,%eax
8010557c:	03 45 0c             	add    0xc(%ebp),%eax
8010557f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80105589:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010558d:	7e e7                	jle    80105576 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010558f:	c9                   	leave  
80105590:	c3                   	ret    
...
8010559b:	74 17                	je     801055b4 <holding+0x23>
8010559d:	8b 45 08             	mov    0x8(%ebp),%eax
801055a0:	8b 50 08             	mov    0x8(%eax),%edx
801055a3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055a9:	39 c2                	cmp    %eax,%edx
801055ab:	75 07                	jne    801055b4 <holding+0x23>
801055ad:	b8 01 00 00 00       	mov    $0x1,%eax
801055b2:	eb 05                	jmp    801055b9 <holding+0x28>
...
801055be:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801055c1:	e8 46 fe ff ff       	call   8010540c <readeflags>
801055c6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801055c9:	e8 53 fe ff ff       	call   80105421 <cli>
  if(cpu->ncli++ == 0)
801055ce:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055d4:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801055da:	85 d2                	test   %edx,%edx
801055dc:	0f 94 c1             	sete   %cl
801055df:	83 c2 01             	add    $0x1,%edx
801055e2:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801055e8:	84 c9                	test   %cl,%cl
801055ea:	74 15                	je     80105601 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
801055ec:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055f2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055f5:	81 e2 00 02 00 00    	and    $0x200,%edx
801055fb:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105601:	c9                   	leave  
80105602:	c3                   	ret    
...
80105606:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105609:	e8 fe fd ff ff       	call   8010540c <readeflags>
8010560e:	25 00 02 00 00       	and    $0x200,%eax
80105613:	85 c0                	test   %eax,%eax
80105615:	74 0c                	je     80105623 <popcli+0x20>
    panic("popcli - interruptible");
80105617:	c7 04 24 1f 90 10 80 	movl   $0x8010901f,(%esp)
8010561e:	e8 1a af ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105623:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105629:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010562f:	83 ea 01             	sub    $0x1,%edx
80105632:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105638:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010563e:	85 c0                	test   %eax,%eax
80105640:	79 0c                	jns    8010564e <popcli+0x4b>
    panic("popcli");
80105642:	c7 04 24 36 90 10 80 	movl   $0x80109036,(%esp)
80105649:	e8 ef ae ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010564e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105654:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010565a:	85 c0                	test   %eax,%eax
8010565c:	75 15                	jne    80105673 <popcli+0x70>
8010565e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105664:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010566a:	85 c0                	test   %eax,%eax
8010566c:	74 05                	je     80105673 <popcli+0x70>
    sti();
8010566e:	e8 b4 fd ff ff       	call   80105427 <sti>
}
80105673:	c9                   	leave  
80105674:	c3                   	ret    
...
801056ee:	89 c1                	mov    %eax,%ecx
801056f0:	c1 e1 18             	shl    $0x18,%ecx
...
80105783:	0f 95 c0             	setne  %al
80105786:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010578a:	84 c0                	test   %al,%al
8010578c:	75 bf                	jne    8010574d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801057aa:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801057ad:	73 54                	jae    80105803 <memmove+0x6e>
801057af:	8b 45 10             	mov    0x10(%ebp),%eax
801057b2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801057b5:	01 d0                	add    %edx,%eax
801057b7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801057ba:	76 47                	jbe    80105803 <memmove+0x6e>
    s += n;
801057bc:	8b 45 10             	mov    0x10(%ebp),%eax
801057bf:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801057c2:	8b 45 10             	mov    0x10(%ebp),%eax
801057c5:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801057c8:	eb 13                	jmp    801057dd <memmove+0x48>
      *--d = *--s;
801057ca:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801057ce:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
801057e1:	0f 95 c0             	setne  %al
801057e4:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057e8:	84 c0                	test   %al,%al
801057ea:	75 de                	jne    801057ca <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801057ec:	eb 25                	jmp    80105813 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
801057f9:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801057fd:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105801:	eb 01                	jmp    80105804 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105808:	0f 95 c0             	setne  %al
8010580b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010580f:	84 c0                	test   %al,%al
80105811:	75 db                	jne    801057ee <memmove+0x59>
      *d++ = *s++;
...
80105832:	e8 5e ff ff ff       	call   80105795 <memmove>
}
80105837:	c9                   	leave  
80105838:	c3                   	ret    
...
8010583a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
8010583c:	eb 0c                	jmp    8010584a <strncmp+0x11>
    n--, p++, q++;
8010583e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105842:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105846:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
8010584e:	74 1a                	je     8010586a <strncmp+0x31>
80105850:	8b 45 08             	mov    0x8(%ebp),%eax
80105853:	0f b6 00             	movzbl (%eax),%eax
80105856:	84 c0                	test   %al,%al
80105858:	74 10                	je     8010586a <strncmp+0x31>
8010585a:	8b 45 08             	mov    0x8(%ebp),%eax
8010585d:	0f b6 10             	movzbl (%eax),%edx
80105860:	8b 45 0c             	mov    0xc(%ebp),%eax
80105863:	0f b6 00             	movzbl (%eax),%eax
80105866:	38 c2                	cmp    %al,%dl
80105868:	74 d4                	je     8010583e <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
8010586a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010586e:	75 07                	jne    80105877 <strncmp+0x3e>
    return 0;
80105870:	b8 00 00 00 00       	mov    $0x0,%eax
80105875:	eb 18                	jmp    8010588f <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80105877:	8b 45 08             	mov    0x8(%ebp),%eax
8010587a:	0f b6 00             	movzbl (%eax),%eax
8010587d:	0f b6 d0             	movzbl %al,%edx
80105880:	8b 45 0c             	mov    0xc(%ebp),%eax
80105883:	0f b6 00             	movzbl (%eax),%eax
80105886:	0f b6 c0             	movzbl %al,%eax
80105889:	89 d1                	mov    %edx,%ecx
8010588b:	29 c1                	sub    %eax,%ecx
8010588d:	89 c8                	mov    %ecx,%eax
}
8010588f:	5d                   	pop    %ebp
80105890:	c3                   	ret    
...
801058a2:	0f 9f c0             	setg   %al
801058a5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801058a9:	84 c0                	test   %al,%al
801058ab:	74 30                	je     801058dd <strncpy+0x4c>
801058ad:	8b 45 0c             	mov    0xc(%ebp),%eax
801058b0:	0f b6 10             	movzbl (%eax),%edx
801058b3:	8b 45 08             	mov    0x8(%ebp),%eax
801058b6:	88 10                	mov    %dl,(%eax)
801058b8:	8b 45 08             	mov    0x8(%ebp),%eax
801058bb:	0f b6 00             	movzbl (%eax),%eax
801058be:	84 c0                	test   %al,%al
801058c0:	0f 95 c0             	setne  %al
801058c3:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801058c7:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801058cb:	84 c0                	test   %al,%al
801058cd:	75 cf                	jne    8010589e <strncpy+0xd>
    ;
  while(n-- > 0)
801058cf:	eb 0c                	jmp    801058dd <strncpy+0x4c>
    *s++ = 0;
801058d1:	8b 45 08             	mov    0x8(%ebp),%eax
801058d4:	c6 00 00             	movb   $0x0,(%eax)
801058d7:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801058db:	eb 01                	jmp    801058de <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
801058dd:	90                   	nop
801058de:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058e2:	0f 9f c0             	setg   %al
801058e5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801058e9:	84 c0                	test   %al,%al
801058eb:	75 e4                	jne    801058d1 <strncpy+0x40>
    *s++ = 0;
  return os;
801058ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801058f0:	c9                   	leave  
801058f1:	c3                   	ret    
...
801058fb:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801058fe:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105902:	7f 05                	jg     80105909 <safestrcpy+0x17>
    return os;
80105904:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105907:	eb 35                	jmp    8010593e <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105909:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010590d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105911:	7e 22                	jle    80105935 <safestrcpy+0x43>
80105913:	8b 45 0c             	mov    0xc(%ebp),%eax
80105916:	0f b6 10             	movzbl (%eax),%edx
80105919:	8b 45 08             	mov    0x8(%ebp),%eax
8010591c:	88 10                	mov    %dl,(%eax)
8010591e:	8b 45 08             	mov    0x8(%ebp),%eax
80105921:	0f b6 00             	movzbl (%eax),%eax
80105924:	84 c0                	test   %al,%al
80105926:	0f 95 c0             	setne  %al
80105929:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010592d:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105931:	84 c0                	test   %al,%al
80105933:	75 d4                	jne    80105909 <safestrcpy+0x17>
    ;
  *s = 0;
80105935:	8b 45 08             	mov    0x8(%ebp),%eax
80105938:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105943:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
80105946:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010594d:	eb 04                	jmp    80105953 <strlen+0x13>
8010594f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105953:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105956:	03 45 08             	add    0x8(%ebp),%eax
80105959:	0f b6 00             	movzbl (%eax),%eax
8010595c:	84 c0                	test   %al,%al
8010595e:	75 ef                	jne    8010594f <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105968:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
8010596c:	8b 54 24 08          	mov    0x8(%esp),%edx

  # Save old callee-save registers
  pushl %ebp
80105970:	55                   	push   %ebp
  pushl %ebx
80105971:	53                   	push   %ebx
  pushl %esi
...
80105973:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105974:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105976:	89 d4                	mov    %edx,%esp
...
80105988:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010598b:	76 0f                	jbe    8010599c <fetchint+0x1c>
8010598d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105990:	8d 50 04             	lea    0x4(%eax),%edx
80105993:	8b 45 08             	mov    0x8(%ebp),%eax
80105996:	8b 00                	mov    (%eax),%eax
80105998:	39 c2                	cmp    %eax,%edx
8010599a:	76 07                	jbe    801059a3 <fetchint+0x23>
    return -1;
8010599c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059a1:	eb 0f                	jmp    801059b2 <fetchint+0x32>
  *ip = *(int*)(addr);
801059a3:	8b 45 0c             	mov    0xc(%ebp),%eax
801059a6:	8b 10                	mov    (%eax),%edx
...
801059bf:	3b 45 0c             	cmp    0xc(%ebp),%eax
801059c2:	77 07                	ja     801059cb <fetchstr+0x17>
    return -1;
801059c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059c9:	eb 45                	jmp    80105a10 <fetchstr+0x5c>
  *pp = (char*)addr;
801059cb:	8b 55 0c             	mov    0xc(%ebp),%edx
801059ce:	8b 45 10             	mov    0x10(%ebp),%eax
...
801059d8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801059db:	8b 45 10             	mov    0x10(%ebp),%eax
801059de:	8b 00                	mov    (%eax),%eax
801059e0:	89 45 fc             	mov    %eax,-0x4(%ebp)
801059e3:	eb 1e                	jmp    80105a03 <fetchstr+0x4f>
    if(*s == 0)
801059e5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059e8:	0f b6 00             	movzbl (%eax),%eax
801059eb:	84 c0                	test   %al,%al
801059ed:	75 10                	jne    801059ff <fetchstr+0x4b>
      return s - *pp;
801059ef:	8b 55 fc             	mov    -0x4(%ebp),%edx
801059f2:	8b 45 10             	mov    0x10(%ebp),%eax
801059f5:	8b 00                	mov    (%eax),%eax
801059f7:	89 d1                	mov    %edx,%ecx
801059f9:	29 c1                	sub    %eax,%ecx
801059fb:	89 c8                	mov    %ecx,%eax
801059fd:	eb 11                	jmp    80105a10 <fetchstr+0x5c>
...
80105a06:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105a09:	72 da                	jb     801059e5 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105a21:	8b 50 44             	mov    0x44(%eax),%edx
80105a24:	8b 45 08             	mov    0x8(%ebp),%eax
80105a27:	c1 e0 02             	shl    $0x2,%eax
80105a2a:	01 d0                	add    %edx,%eax
80105a2c:	8d 48 04             	lea    0x4(%eax),%ecx
80105a2f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a35:	8b 55 0c             	mov    0xc(%ebp),%edx
80105a38:	89 54 24 08          	mov    %edx,0x8(%esp)
80105a3c:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105a40:	89 04 24             	mov    %eax,(%esp)
80105a43:	e8 38 ff ff ff       	call   80105980 <fetchint>
}
80105a48:	c9                   	leave  
80105a49:	c3                   	ret    
...
80105a92:	76 07                	jbe    80105a9b <argptr+0x51>
    return -1;
80105a94:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a99:	eb 0f                	jmp    80105aaa <argptr+0x60>
  *pp = (char*)i;
80105a9b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a9e:	89 c2                	mov    %eax,%edx
80105aa0:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80105aaf:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
...
80105abf:	e8 4e ff ff ff       	call   80105a12 <argint>
80105ac4:	85 c0                	test   %eax,%eax
80105ac6:	79 07                	jns    80105acf <argstr+0x23>
    return -1;
80105ac8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105acd:	eb 1e                	jmp    80105aed <argstr+0x41>
  return fetchstr(proc, addr, pp);
80105acf:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ad2:	89 c2                	mov    %eax,%edx
80105ad4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ada:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105add:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105ae1:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ae5:	89 04 24             	mov    %eax,(%esp)
80105ae8:	e8 c7 fe ff ff       	call   801059b4 <fetchstr>
}
80105aed:	c9                   	leave  
80105aee:	c3                   	ret    
...
80105af3:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105af6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105afc:	8b 40 18             	mov    0x18(%eax),%eax
80105aff:	8b 40 1c             	mov    0x1c(%eax),%eax
80105b02:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80105b05:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b09:	78 2e                	js     80105b39 <syscall+0x4a>
80105b0b:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105b0f:	7f 28                	jg     80105b39 <syscall+0x4a>
80105b11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b14:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b1b:	85 c0                	test   %eax,%eax
80105b1d:	74 1a                	je     80105b39 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
80105b1f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b25:	8b 58 18             	mov    0x18(%eax),%ebx
80105b28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b2b:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b32:	ff d0                	call   *%eax
80105b34:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105b37:	eb 73                	jmp    80105bac <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105b39:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105b3d:	7e 30                	jle    80105b6f <syscall+0x80>
80105b3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b42:	83 f8 1d             	cmp    $0x1d,%eax
80105b45:	77 28                	ja     80105b6f <syscall+0x80>
80105b47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b4a:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b51:	85 c0                	test   %eax,%eax
80105b53:	74 1a                	je     80105b6f <syscall+0x80>
    proc->tf->eax = syscalls[num]();
80105b55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b5b:	8b 58 18             	mov    0x18(%eax),%ebx
80105b5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b61:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b68:	ff d0                	call   *%eax
80105b6a:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105b6d:	eb 3d                	jmp    80105bac <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105b6f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b75:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105b78:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105b7e:	8b 40 10             	mov    0x10(%eax),%eax
80105b81:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b84:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105b88:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b90:	c7 04 24 3d 90 10 80 	movl   $0x8010903d,(%esp)
80105b97:	e8 05 a8 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105b9c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ba2:	8b 40 18             	mov    0x18(%eax),%eax
80105ba5:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105bac:	83 c4 24             	add    $0x24,%esp
80105baf:	5b                   	pop    %ebx
80105bb0:	5d                   	pop    %ebp
80105bb1:	c3                   	ret    
	...
...
80105bc7:	e8 46 fe ff ff       	call   80105a12 <argint>
80105bcc:	85 c0                	test   %eax,%eax
80105bce:	79 07                	jns    80105bd7 <argfd+0x23>
    return -1;
80105bd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bd5:	eb 50                	jmp    80105c27 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105bd7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bda:	85 c0                	test   %eax,%eax
80105bdc:	78 21                	js     80105bff <argfd+0x4b>
80105bde:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be1:	83 f8 0f             	cmp    $0xf,%eax
80105be4:	7f 19                	jg     80105bff <argfd+0x4b>
80105be6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bec:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105bef:	83 c2 08             	add    $0x8,%edx
80105bf2:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105bf6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bf9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bfd:	75 07                	jne    80105c06 <argfd+0x52>
    return -1;
80105bff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c04:	eb 21                	jmp    80105c27 <argfd+0x73>
  if(pfd)
80105c06:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105c0a:	74 08                	je     80105c14 <argfd+0x60>
    *pfd = fd;
...
80105c18:	74 08                	je     80105c22 <argfd+0x6e>
    *pf = f;
80105c1a:	8b 45 10             	mov    0x10(%ebp),%eax
80105c1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c20:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105c2c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c2f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105c36:	eb 30                	jmp    80105c68 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105c38:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c3e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c41:	83 c2 08             	add    $0x8,%edx
80105c44:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105c48:	85 c0                	test   %eax,%eax
80105c4a:	75 18                	jne    80105c64 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105c4c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c52:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c55:	8d 4a 08             	lea    0x8(%edx),%ecx
80105c58:	8b 55 08             	mov    0x8(%ebp),%edx
80105c5b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105c5f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c62:	eb 0f                	jmp    80105c73 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c64:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105c68:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105c6c:	7e ca                	jle    80105c38 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105c78:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
80105c82:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c89:	00 
80105c8a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c91:	e8 1e ff ff ff       	call   80105bb4 <argfd>
80105c96:	85 c0                	test   %eax,%eax
80105c98:	79 07                	jns    80105ca1 <sys_dup+0x2c>
    return -1;
80105c9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c9f:	eb 29                	jmp    80105cca <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105ca1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca4:	89 04 24             	mov    %eax,(%esp)
80105ca7:	e8 7d ff ff ff       	call   80105c29 <fdalloc>
80105cac:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105caf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105cb3:	79 07                	jns    80105cbc <sys_dup+0x47>
    return -1;
80105cb5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cba:	eb 0e                	jmp    80105cca <sys_dup+0x55>
  filedup(f);
80105cbc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cbf:	89 04 24             	mov    %eax,(%esp)
80105cc2:	e8 b5 b2 ff ff       	call   80100f7c <filedup>
  return fd;
...
80105ce8:	e8 c7 fe ff ff       	call   80105bb4 <argfd>
80105ced:	85 c0                	test   %eax,%eax
80105cef:	78 35                	js     80105d26 <sys_read+0x5a>
80105cf1:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105cf4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cf8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105cff:	e8 0e fd ff ff       	call   80105a12 <argint>
80105d04:	85 c0                	test   %eax,%eax
80105d06:	78 1e                	js     80105d26 <sys_read+0x5a>
80105d08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d0f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105d12:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d1d:	e8 28 fd ff ff       	call   80105a4a <argptr>
80105d22:	85 c0                	test   %eax,%eax
80105d24:	79 07                	jns    80105d2d <sys_read+0x61>
    return -1;
80105d26:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d2b:	eb 19                	jmp    80105d46 <sys_read+0x7a>
  return fileread(f, p, n);
80105d2d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105d30:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105d33:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d36:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105d3a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d3e:	89 04 24             	mov    %eax,(%esp)
80105d41:	e8 a3 b3 ff ff       	call   801010e9 <fileread>
}
80105d46:	c9                   	leave  
80105d47:	c3                   	ret    
...
80105d4b:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105d55:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d5c:	00 
80105d5d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d64:	e8 4b fe ff ff       	call   80105bb4 <argfd>
80105d69:	85 c0                	test   %eax,%eax
80105d6b:	78 35                	js     80105da2 <sys_write+0x5a>
80105d6d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d70:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d74:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d7b:	e8 92 fc ff ff       	call   80105a12 <argint>
80105d80:	85 c0                	test   %eax,%eax
80105d82:	78 1e                	js     80105da2 <sys_write+0x5a>
80105d84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d87:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d8b:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105d8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d92:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d99:	e8 ac fc ff ff       	call   80105a4a <argptr>
80105d9e:	85 c0                	test   %eax,%eax
80105da0:	79 07                	jns    80105da9 <sys_write+0x61>
    return -1;
80105da2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105da7:	eb 19                	jmp    80105dc2 <sys_write+0x7a>
  return filewrite(f, p, n);
80105da9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105dac:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105daf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105db2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105db6:	89 54 24 04          	mov    %edx,0x4(%esp)
80105dba:	89 04 24             	mov    %eax,(%esp)
80105dbd:	e8 e3 b3 ff ff       	call   801011a5 <filewrite>
}
80105dc2:	c9                   	leave  
80105dc3:	c3                   	ret    
...
80105dcd:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dd1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105dd4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dd8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ddf:	e8 d0 fd ff ff       	call   80105bb4 <argfd>
80105de4:	85 c0                	test   %eax,%eax
80105de6:	79 07                	jns    80105def <sys_close+0x2b>
    return -1;
80105de8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ded:	eb 24                	jmp    80105e13 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105def:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105df5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105df8:	83 c2 08             	add    $0x8,%edx
80105dfb:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105e02:	00 
  fileclose(f);
80105e03:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e06:	89 04 24             	mov    %eax,(%esp)
80105e09:	e8 b6 b1 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
80105e31:	e8 7e fd ff ff       	call   80105bb4 <argfd>
80105e36:	85 c0                	test   %eax,%eax
80105e38:	78 1f                	js     80105e59 <sys_fstat+0x44>
80105e3a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105e41:	00 
80105e42:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e45:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e50:	e8 f5 fb ff ff       	call   80105a4a <argptr>
80105e55:	85 c0                	test   %eax,%eax
80105e57:	79 07                	jns    80105e60 <sys_fstat+0x4b>
    return -1;
80105e59:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e5e:	eb 12                	jmp    80105e72 <sys_fstat+0x5d>
  return filestat(f, st);
80105e60:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105e63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e66:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e6a:	89 04 24             	mov    %eax,(%esp)
80105e6d:	e8 28 b2 ff ff       	call   8010109a <filestat>
}
80105e72:	c9                   	leave  
80105e73:	c3                   	ret    
...
80105e77:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105e7a:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105e7d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e81:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e88:	e8 1f fc ff ff       	call   80105aac <argstr>
80105e8d:	85 c0                	test   %eax,%eax
80105e8f:	78 17                	js     80105ea8 <sys_link+0x34>
80105e91:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105e94:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e9f:	e8 08 fc ff ff       	call   80105aac <argstr>
80105ea4:	85 c0                	test   %eax,%eax
80105ea6:	79 0a                	jns    80105eb2 <sys_link+0x3e>
    return -1;
80105ea8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ead:	e9 3c 01 00 00       	jmp    80105fee <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80105eb2:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105eb5:	89 04 24             	mov    %eax,(%esp)
80105eb8:	e8 4d c5 ff ff       	call   8010240a <namei>
80105ebd:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ec0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ec4:	75 0a                	jne    80105ed0 <sys_link+0x5c>
    return -1;
80105ec6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ecb:	e9 1e 01 00 00       	jmp    80105fee <sys_link+0x17a>

  begin_trans();
80105ed0:	e8 48 d3 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80105ed5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed8:	89 04 24             	mov    %eax,(%esp)
80105edb:	e8 88 b9 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105ee0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee3:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ee7:	66 83 f8 01          	cmp    $0x1,%ax
80105eeb:	75 1a                	jne    80105f07 <sys_link+0x93>
    iunlockput(ip);
80105eed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef0:	89 04 24             	mov    %eax,(%esp)
80105ef3:	e8 f4 bb ff ff       	call   80101aec <iunlockput>
    commit_trans();
80105ef8:	e8 69 d3 ff ff       	call   80103266 <commit_trans>
    return -1;
80105efd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f02:	e9 e7 00 00 00       	jmp    80105fee <sys_link+0x17a>
  }

  ip->nlink++;
80105f07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f0e:	8d 50 01             	lea    0x1(%eax),%edx
...
80105fb8:	e8 ab b8 ff ff       	call   80101868 <ilock>
  ip->nlink--;
80105fbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fc0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105fc4:	8d 50 ff             	lea    -0x1(%eax),%edx
80105fc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fca:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105fce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd1:	89 04 24             	mov    %eax,(%esp)
80105fd4:	e8 d3 b6 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105fd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fdc:	89 04 24             	mov    %eax,(%esp)
80105fdf:	e8 08 bb ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105fe4:	e8 7d d2 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80105ff3:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105ff6:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105ffd:	eb 4b                	jmp    8010604a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105fff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106002:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106009:	00 
8010600a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010600e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106011:	89 44 24 04          	mov    %eax,0x4(%esp)
80106015:	8b 45 08             	mov    0x8(%ebp),%eax
80106018:	89 04 24             	mov    %eax,(%esp)
8010601b:	e8 3e bd ff ff       	call   80101d5e <readi>
80106020:	83 f8 10             	cmp    $0x10,%eax
80106023:	74 0c                	je     80106031 <isdirempty+0x41>
      panic("isdirempty: readi");
80106025:	c7 04 24 59 90 10 80 	movl   $0x80109059,(%esp)
8010602c:	e8 0c a5 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80106031:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80106035:	66 85 c0             	test   %ax,%ax
80106038:	74 07                	je     80106041 <isdirempty+0x51>
      return 0;
8010603a:	b8 00 00 00 00       	mov    $0x0,%eax
8010603f:	eb 1b                	jmp    8010605c <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80106044:	83 c0 10             	add    $0x10,%eax
...
80106053:	39 c2                	cmp    %eax,%edx
80106055:	72 a8                	jb     80105fff <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80106061:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
...
80106072:	e8 35 fa ff ff       	call   80105aac <argstr>
80106077:	85 c0                	test   %eax,%eax
80106079:	79 0a                	jns    80106085 <sys_unlink+0x27>
    return -1;
8010607b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106080:	e9 aa 01 00 00       	jmp    8010622f <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80106085:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106088:	8d 55 d2             	lea    -0x2e(%ebp),%edx
8010608b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010608f:	89 04 24             	mov    %eax,(%esp)
80106092:	e8 95 c3 ff ff       	call   8010242c <nameiparent>
80106097:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010609a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010609e:	75 0a                	jne    801060aa <sys_unlink+0x4c>
    return -1;
801060a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060a5:	e9 85 01 00 00       	jmp    8010622f <sys_unlink+0x1d1>

  begin_trans();
801060aa:	e8 6e d1 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
801060af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060b2:	89 04 24             	mov    %eax,(%esp)
801060b5:	e8 ae b7 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801060ba:	c7 44 24 04 6b 90 10 	movl   $0x8010906b,0x4(%esp)
801060c1:	80 
801060c2:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801060c5:	89 04 24             	mov    %eax,(%esp)
801060c8:	e8 92 bf ff ff       	call   8010205f <namecmp>
801060cd:	85 c0                	test   %eax,%eax
801060cf:	0f 84 45 01 00 00    	je     8010621a <sys_unlink+0x1bc>
801060d5:	c7 44 24 04 6d 90 10 	movl   $0x8010906d,0x4(%esp)
801060dc:	80 
801060dd:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801060e0:	89 04 24             	mov    %eax,(%esp)
801060e3:	e8 77 bf ff ff       	call   8010205f <namecmp>
801060e8:	85 c0                	test   %eax,%eax
801060ea:	0f 84 2a 01 00 00    	je     8010621a <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801060f0:	8d 45 c8             	lea    -0x38(%ebp),%eax
801060f3:	89 44 24 08          	mov    %eax,0x8(%esp)
801060f7:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801060fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801060fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106101:	89 04 24             	mov    %eax,(%esp)
80106104:	e8 78 bf ff ff       	call   80102081 <dirlookup>
80106109:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010610c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106110:	0f 84 03 01 00 00    	je     80106219 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80106116:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106119:	89 04 24             	mov    %eax,(%esp)
8010611c:	e8 47 b7 ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80106121:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106124:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106128:	66 85 c0             	test   %ax,%ax
8010612b:	7f 0c                	jg     80106139 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
8010612d:	c7 04 24 70 90 10 80 	movl   $0x80109070,(%esp)
80106134:	e8 04 a4 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106139:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010613c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106140:	66 83 f8 01          	cmp    $0x1,%ax
80106144:	75 1f                	jne    80106165 <sys_unlink+0x107>
80106146:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106149:	89 04 24             	mov    %eax,(%esp)
8010614c:	e8 9f fe ff ff       	call   80105ff0 <isdirempty>
80106151:	85 c0                	test   %eax,%eax
80106153:	75 10                	jne    80106165 <sys_unlink+0x107>
    iunlockput(ip);
80106155:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106158:	89 04 24             	mov    %eax,(%esp)
8010615b:	e8 8c b9 ff ff       	call   80101aec <iunlockput>
    goto bad;
80106160:	e9 b5 00 00 00       	jmp    8010621a <sys_unlink+0x1bc>
  }
...
8010617b:	e8 42 f5 ff ff       	call   801056c2 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010619c:	e8 28 bd ff ff       	call   80101ec9 <writei>
801061a1:	83 f8 10             	cmp    $0x10,%eax
801061a4:	74 0c                	je     801061b2 <sys_unlink+0x154>
    panic("unlink: writei");
801061a6:	c7 04 24 82 90 10 80 	movl   $0x80109082,(%esp)
801061ad:	e8 8b a3 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801061b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b5:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801061b9:	66 83 f8 01          	cmp    $0x1,%ax
801061bd:	75 1c                	jne    801061db <sys_unlink+0x17d>
    dp->nlink--;
...
801061d6:	e8 d1 b4 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
801061db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061de:	89 04 24             	mov    %eax,(%esp)
801061e1:	e8 06 b9 ff ff       	call   80101aec <iunlockput>
...
801061fd:	e8 aa b4 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106202:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106205:	89 04 24             	mov    %eax,(%esp)
80106208:	e8 df b8 ff ff       	call   80101aec <iunlockput>

  commit_trans();
8010620d:	e8 54 d0 ff ff       	call   80103266 <commit_trans>

  return 0;
80106212:	b8 00 00 00 00       	mov    $0x0,%eax
80106217:	eb 16                	jmp    8010622f <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106220:	e8 c7 b8 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106225:	e8 3c d0 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80106234:	83 ec 48             	sub    $0x48,%esp
80106237:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010623a:	8b 55 10             	mov    0x10(%ebp),%edx
8010623d:	8b 45 14             	mov    0x14(%ebp),%eax
80106240:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106244:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106248:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010624c:	8d 45 de             	lea    -0x22(%ebp),%eax
8010624f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106253:	8b 45 08             	mov    0x8(%ebp),%eax
80106256:	89 04 24             	mov    %eax,(%esp)
80106259:	e8 ce c1 ff ff       	call   8010242c <nameiparent>
8010625e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106261:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106265:	75 0a                	jne    80106271 <create+0x40>
    return 0;
80106267:	b8 00 00 00 00       	mov    $0x0,%eax
8010626c:	e9 7e 01 00 00       	jmp    801063ef <create+0x1be>
  ilock(dp);
80106271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106274:	89 04 24             	mov    %eax,(%esp)
80106277:	e8 ec b5 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010627c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010627f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106283:	8d 45 de             	lea    -0x22(%ebp),%eax
80106286:	89 44 24 04          	mov    %eax,0x4(%esp)
8010628a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010628d:	89 04 24             	mov    %eax,(%esp)
80106290:	e8 ec bd ff ff       	call   80102081 <dirlookup>
80106295:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106298:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010629c:	74 47                	je     801062e5 <create+0xb4>
    iunlockput(dp);
8010629e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062a1:	89 04 24             	mov    %eax,(%esp)
801062a4:	e8 43 b8 ff ff       	call   80101aec <iunlockput>
    ilock(ip);
801062a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062ac:	89 04 24             	mov    %eax,(%esp)
801062af:	e8 b4 b5 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801062b4:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801062b9:	75 15                	jne    801062d0 <create+0x9f>
801062bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062be:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062c2:	66 83 f8 02          	cmp    $0x2,%ax
801062c6:	75 08                	jne    801062d0 <create+0x9f>
      return ip;
801062c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062cb:	e9 1f 01 00 00       	jmp    801063ef <create+0x1be>
    iunlockput(ip);
801062d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062d3:	89 04 24             	mov    %eax,(%esp)
801062d6:	e8 11 b8 ff ff       	call   80101aec <iunlockput>
    return 0;
801062db:	b8 00 00 00 00       	mov    $0x0,%eax
801062e0:	e9 0a 01 00 00       	jmp    801063ef <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
801062e5:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
801062e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062ec:	8b 00                	mov    (%eax),%eax
801062ee:	89 54 24 04          	mov    %edx,0x4(%esp)
801062f2:	89 04 24             	mov    %eax,(%esp)
801062f5:	e8 d5 b2 ff ff       	call   801015cf <ialloc>
801062fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106301:	75 0c                	jne    8010630f <create+0xde>
    panic("create: ialloc");
80106303:	c7 04 24 91 90 10 80 	movl   $0x80109091,(%esp)
8010630a:	e8 2e a2 ff ff       	call   8010053d <panic>

  ilock(ip);
8010630f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106312:	89 04 24             	mov    %eax,(%esp)
80106315:	e8 4e b5 ff ff       	call   80101868 <ilock>
  ip->major = major;
8010631a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010631d:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106321:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106325:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106328:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
8010632c:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106330:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106333:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106339:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010633c:	89 04 24             	mov    %eax,(%esp)
8010633f:	e8 68 b3 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106344:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106349:	75 6a                	jne    801063b5 <create+0x184>
    dp->nlink++;  // for ".."
8010634b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010634e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106352:	8d 50 01             	lea    0x1(%eax),%edx
80106355:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106358:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010635c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010635f:	89 04 24             	mov    %eax,(%esp)
80106362:	e8 45 b3 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106367:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010636a:	8b 40 04             	mov    0x4(%eax),%eax
8010636d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106371:	c7 44 24 04 6b 90 10 	movl   $0x8010906b,0x4(%esp)
80106378:	80 
80106379:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010637c:	89 04 24             	mov    %eax,(%esp)
8010637f:	e8 c5 bd ff ff       	call   80102149 <dirlink>
80106384:	85 c0                	test   %eax,%eax
80106386:	78 21                	js     801063a9 <create+0x178>
80106388:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010638b:	8b 40 04             	mov    0x4(%eax),%eax
8010638e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106392:	c7 44 24 04 6d 90 10 	movl   $0x8010906d,0x4(%esp)
80106399:	80 
8010639a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010639d:	89 04 24             	mov    %eax,(%esp)
801063a0:	e8 a4 bd ff ff       	call   80102149 <dirlink>
801063a5:	85 c0                	test   %eax,%eax
801063a7:	79 0c                	jns    801063b5 <create+0x184>
      panic("create dots");
801063a9:	c7 04 24 a0 90 10 80 	movl   $0x801090a0,(%esp)
801063b0:	e8 88 a1 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801063b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b8:	8b 40 04             	mov    0x4(%eax),%eax
801063bb:	89 44 24 08          	mov    %eax,0x8(%esp)
801063bf:	8d 45 de             	lea    -0x22(%ebp),%eax
...
801063d3:	79 0c                	jns    801063e1 <create+0x1b0>
    panic("create: dirlink");
801063d5:	c7 04 24 ac 90 10 80 	movl   $0x801090ac,(%esp)
801063dc:	e8 5c a1 ff ff       	call   8010053d <panic>

  iunlockput(dp);
801063e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e4:	89 04 24             	mov    %eax,(%esp)
801063e7:	e8 00 b7 ff ff       	call   80101aec <iunlockput>
...
801063f4:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106405:	e8 a2 f6 ff ff       	call   80105aac <argstr>
8010640a:	85 c0                	test   %eax,%eax
8010640c:	78 17                	js     80106425 <sys_open+0x34>
8010640e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106411:	89 44 24 04          	mov    %eax,0x4(%esp)
80106415:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010641c:	e8 f1 f5 ff ff       	call   80105a12 <argint>
80106421:	85 c0                	test   %eax,%eax
80106423:	79 0a                	jns    8010642f <sys_open+0x3e>
    return -1;
80106425:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010642a:	e9 46 01 00 00       	jmp    80106575 <sys_open+0x184>
  if(omode & O_CREATE){
8010642f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106432:	25 00 02 00 00       	and    $0x200,%eax
80106437:	85 c0                	test   %eax,%eax
80106439:	74 40                	je     8010647b <sys_open+0x8a>
    begin_trans();
8010643b:	e8 dd cd ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106440:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106443:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010644a:	00 
8010644b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106452:	00 
80106453:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010645a:	00 
8010645b:	89 04 24             	mov    %eax,(%esp)
8010645e:	e8 ce fd ff ff       	call   80106231 <create>
80106463:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80106466:	e8 fb cd ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
8010646b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010646f:	75 5c                	jne    801064cd <sys_open+0xdc>
      return -1;
80106471:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106476:	e9 fa 00 00 00       	jmp    80106575 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
8010647b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010647e:	89 04 24             	mov    %eax,(%esp)
80106481:	e8 84 bf ff ff       	call   8010240a <namei>
80106486:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106489:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010648d:	75 0a                	jne    80106499 <sys_open+0xa8>
      return -1;
8010648f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106494:	e9 dc 00 00 00       	jmp    80106575 <sys_open+0x184>
    ilock(ip);
80106499:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010649c:	89 04 24             	mov    %eax,(%esp)
8010649f:	e8 c4 b3 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801064a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801064ab:	66 83 f8 01          	cmp    $0x1,%ax
801064af:	75 1c                	jne    801064cd <sys_open+0xdc>
801064b1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064b4:	85 c0                	test   %eax,%eax
801064b6:	74 15                	je     801064cd <sys_open+0xdc>
      iunlockput(ip);
801064b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064bb:	89 04 24             	mov    %eax,(%esp)
801064be:	e8 29 b6 ff ff       	call   80101aec <iunlockput>
      return -1;
801064c3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064c8:	e9 a8 00 00 00       	jmp    80106575 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
801064cd:	e8 4a aa ff ff       	call   80100f1c <filealloc>
801064d2:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064d5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064d9:	74 14                	je     801064ef <sys_open+0xfe>
801064db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064de:	89 04 24             	mov    %eax,(%esp)
801064e1:	e8 43 f7 ff ff       	call   80105c29 <fdalloc>
801064e6:	89 45 ec             	mov    %eax,-0x14(%ebp)
801064e9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801064ed:	79 23                	jns    80106512 <sys_open+0x121>
    if(f)
801064ef:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064f3:	74 0b                	je     80106500 <sys_open+0x10f>
      fileclose(f);
801064f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064f8:	89 04 24             	mov    %eax,(%esp)
801064fb:	e8 c4 aa ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
80106500:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106503:	89 04 24             	mov    %eax,(%esp)
80106506:	e8 e1 b5 ff ff       	call   80101aec <iunlockput>
    return -1;
8010650b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106510:	eb 63                	jmp    80106575 <sys_open+0x184>
  }
  iunlock(ip);
80106512:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106515:	89 04 24             	mov    %eax,(%esp)
80106518:	e8 99 b4 ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
8010651d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106520:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106526:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106529:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010652c:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010652f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106532:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106539:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010653c:	83 e0 01             	and    $0x1,%eax
8010653f:	85 c0                	test   %eax,%eax
80106541:	0f 94 c2             	sete   %dl
80106544:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106547:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010654a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010654d:	83 e0 01             	and    $0x1,%eax
80106550:	84 c0                	test   %al,%al
80106552:	75 0a                	jne    8010655e <sys_open+0x16d>
80106554:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106557:	83 e0 02             	and    $0x2,%eax
8010655a:	85 c0                	test   %eax,%eax
8010655c:	74 07                	je     80106565 <sys_open+0x174>
8010655e:	b8 01 00 00 00       	mov    $0x1,%eax
80106563:	eb 05                	jmp    8010656a <sys_open+0x179>
80106565:	b8 00 00 00 00       	mov    $0x0,%eax
8010656a:	89 c2                	mov    %eax,%edx
8010656c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010656f:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80106572:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80106575:	c9                   	leave  
80106576:	c3                   	ret    
...
8010657a:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
8010657d:	e8 9b cc ff ff       	call   8010321d <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80106582:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106585:	89 44 24 04          	mov    %eax,0x4(%esp)
80106589:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106590:	e8 17 f5 ff ff       	call   80105aac <argstr>
80106595:	85 c0                	test   %eax,%eax
80106597:	78 2c                	js     801065c5 <sys_mkdir+0x4e>
80106599:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010659c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801065a3:	00 
801065a4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801065ab:	00 
801065ac:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801065b3:	00 
801065b4:	89 04 24             	mov    %eax,(%esp)
801065b7:	e8 75 fc ff ff       	call   80106231 <create>
801065bc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065bf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801065c3:	75 0c                	jne    801065d1 <sys_mkdir+0x5a>
    commit_trans();
801065c5:	e8 9c cc ff ff       	call   80103266 <commit_trans>
    return -1;
801065ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065cf:	eb 15                	jmp    801065e6 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
801065d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065d4:	89 04 24             	mov    %eax,(%esp)
801065d7:	e8 10 b5 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801065dc:	e8 85 cc ff ff       	call   80103266 <commit_trans>
  return 0;
...
801065eb:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_trans();
801065ee:	e8 2a cc ff ff       	call   8010321d <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
801065f3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801065f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801065fa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106601:	e8 a6 f4 ff ff       	call   80105aac <argstr>
80106606:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106609:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010660d:	78 5e                	js     8010666d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010660f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106612:	89 44 24 04          	mov    %eax,0x4(%esp)
80106616:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010661d:	e8 f0 f3 ff ff       	call   80105a12 <argint>
  char *path;
  int len;
  int major, minor;
...
80106624:	78 47                	js     8010666d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106626:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106629:	89 44 24 04          	mov    %eax,0x4(%esp)
8010662d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106634:	e8 d9 f3 ff ff       	call   80105a12 <argint>
  int len;
  int major, minor;
...
8010663b:	78 30                	js     8010666d <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010663d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106640:	0f bf c8             	movswl %ax,%ecx
80106643:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106646:	0f bf d0             	movswl %ax,%edx
80106649:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010664c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106650:	89 54 24 08          	mov    %edx,0x8(%esp)
80106654:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010665b:	00 
8010665c:	89 04 24             	mov    %eax,(%esp)
8010665f:	e8 cd fb ff ff       	call   80106231 <create>
80106664:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106667:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010666b:	75 0c                	jne    80106679 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
8010666d:	e8 f4 cb ff ff       	call   80103266 <commit_trans>
    return -1;
80106672:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106677:	eb 15                	jmp    8010668e <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106679:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010667c:	89 04 24             	mov    %eax,(%esp)
8010667f:	e8 68 b4 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106684:	e8 dd cb ff ff       	call   80103266 <commit_trans>
  return 0;
...
801066a4:	e8 03 f4 ff ff       	call   80105aac <argstr>
801066a9:	85 c0                	test   %eax,%eax
801066ab:	78 14                	js     801066c1 <sys_chdir+0x31>
801066ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066b0:	89 04 24             	mov    %eax,(%esp)
801066b3:	e8 52 bd ff ff       	call   8010240a <namei>
801066b8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066bb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066bf:	75 07                	jne    801066c8 <sys_chdir+0x38>
    return -1;
801066c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066c6:	eb 57                	jmp    8010671f <sys_chdir+0x8f>
  ilock(ip);
801066c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cb:	89 04 24             	mov    %eax,(%esp)
801066ce:	e8 95 b1 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
801066d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d6:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801066da:	66 83 f8 01          	cmp    $0x1,%ax
801066de:	74 12                	je     801066f2 <sys_chdir+0x62>
    iunlockput(ip);
801066e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e3:	89 04 24             	mov    %eax,(%esp)
801066e6:	e8 01 b4 ff ff       	call   80101aec <iunlockput>
    return -1;
801066eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066f0:	eb 2d                	jmp    8010671f <sys_chdir+0x8f>
  }
  iunlock(ip);
801066f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f5:	89 04 24             	mov    %eax,(%esp)
801066f8:	e8 b9 b2 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
801066fd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106703:	8b 40 68             	mov    0x68(%eax),%eax
80106706:	89 04 24             	mov    %eax,(%esp)
80106709:	e8 0d b3 ff ff       	call   80101a1b <iput>
  proc->cwd = ip;
8010670e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106714:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106717:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
8010671a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010671f:	c9                   	leave  
80106720:	c3                   	ret    
...
80106724:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010672a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010672d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106731:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106738:	e8 6f f3 ff ff       	call   80105aac <argstr>
8010673d:	85 c0                	test   %eax,%eax
8010673f:	78 1a                	js     8010675b <sys_exec+0x3a>
80106741:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106747:	89 44 24 04          	mov    %eax,0x4(%esp)
8010674b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106752:	e8 bb f2 ff ff       	call   80105a12 <argint>
80106757:	85 c0                	test   %eax,%eax
80106759:	79 0a                	jns    80106765 <sys_exec+0x44>
    return -1;
8010675b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106760:	e9 e2 00 00 00       	jmp    80106847 <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
80106765:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010676c:	00 
8010676d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106774:	00 
80106775:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010677b:	89 04 24             	mov    %eax,(%esp)
8010677e:	e8 3f ef ff ff       	call   801056c2 <memset>
  for(i=0;; i++){
80106783:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010678a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010678d:	83 f8 1f             	cmp    $0x1f,%eax
80106790:	76 0a                	jbe    8010679c <sys_exec+0x7b>
      return -1;
80106792:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106797:	e9 ab 00 00 00       	jmp    80106847 <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
8010679c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010679f:	c1 e0 02             	shl    $0x2,%eax
801067a2:	89 c2                	mov    %eax,%edx
801067a4:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801067aa:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801067ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067b3:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
801067b9:	89 54 24 08          	mov    %edx,0x8(%esp)
801067bd:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801067c1:	89 04 24             	mov    %eax,(%esp)
801067c4:	e8 b7 f1 ff ff       	call   80105980 <fetchint>
801067c9:	85 c0                	test   %eax,%eax
801067cb:	79 07                	jns    801067d4 <sys_exec+0xb3>
      return -1;
801067cd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067d2:	eb 73                	jmp    80106847 <sys_exec+0x126>
    if(uarg == 0){
801067d4:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801067da:	85 c0                	test   %eax,%eax
801067dc:	75 26                	jne    80106804 <sys_exec+0xe3>
      argv[i] = 0;
801067de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067e1:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801067e8:	00 00 00 00 
      break;
801067ec:	90                   	nop
    }
...
801067f0:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801067f6:	89 54 24 04          	mov    %edx,0x4(%esp)
801067fa:	89 04 24             	mov    %eax,(%esp)
801067fd:	e8 fa a2 ff ff       	call   80100afc <exec>
80106802:	eb 43                	jmp    80106847 <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106807:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010680e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106814:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80106817:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
8010681d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106823:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106827:	89 54 24 04          	mov    %edx,0x4(%esp)
8010682b:	89 04 24             	mov    %eax,(%esp)
8010682e:	e8 81 f1 ff ff       	call   801059b4 <fetchstr>
80106833:	85 c0                	test   %eax,%eax
80106835:	79 07                	jns    8010683e <sys_exec+0x11d>
      return -1;
80106837:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010683c:	eb 09                	jmp    80106847 <sys_exec+0x126>
...
80106842:	e9 43 ff ff ff       	jmp    8010678a <sys_exec+0x69>
  return exec(path, argv);
}
80106847:	c9                   	leave  
80106848:	c3                   	ret    
...
8010684c:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010684f:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106856:	00 
80106857:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010685a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010685e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106865:	e8 e0 f1 ff ff       	call   80105a4a <argptr>
8010686a:	85 c0                	test   %eax,%eax
8010686c:	79 0a                	jns    80106878 <sys_pipe+0x2f>
    return -1;
8010686e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106873:	e9 9b 00 00 00       	jmp    80106913 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106878:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010687b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010687f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106882:	89 04 24             	mov    %eax,(%esp)
80106885:	e8 ae d3 ff ff       	call   80103c38 <pipealloc>
8010688a:	85 c0                	test   %eax,%eax
8010688c:	79 07                	jns    80106895 <sys_pipe+0x4c>
    return -1;
8010688e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106893:	eb 7e                	jmp    80106913 <sys_pipe+0xca>
  fd0 = -1;
80106895:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010689c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010689f:	89 04 24             	mov    %eax,(%esp)
801068a2:	e8 82 f3 ff ff       	call   80105c29 <fdalloc>
801068a7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801068aa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801068ae:	78 14                	js     801068c4 <sys_pipe+0x7b>
801068b0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068b3:	89 04 24             	mov    %eax,(%esp)
801068b6:	e8 6e f3 ff ff       	call   80105c29 <fdalloc>
801068bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801068be:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801068c2:	79 37                	jns    801068fb <sys_pipe+0xb2>
    if(fd0 >= 0)
801068c4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801068c8:	78 14                	js     801068de <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801068ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068d0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801068d3:	83 c2 08             	add    $0x8,%edx
801068d6:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801068dd:	00 
    fileclose(rf);
801068de:	8b 45 e8             	mov    -0x18(%ebp),%eax
801068e1:	89 04 24             	mov    %eax,(%esp)
801068e4:	e8 db a6 ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
801068e9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068ec:	89 04 24             	mov    %eax,(%esp)
801068ef:	e8 d0 a6 ff ff       	call   80100fc4 <fileclose>
    return -1;
801068f4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068f9:	eb 18                	jmp    80106913 <sys_pipe+0xca>
  }
  fd[0] = fd0;
801068fb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801068fe:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106901:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106903:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106906:	8d 50 04             	lea    0x4(%eax),%edx
80106909:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010690c:	89 02                	mov    %eax,(%edx)
  return 0;
8010690e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106913:	c9                   	leave  
80106914:	c3                   	ret    
80106915:	00 00                	add    %al,(%eax)
	...
...
8010691b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010691e:	e8 31 da ff ff       	call   80104354 <fork>
}
80106923:	c9                   	leave  
80106924:	c3                   	ret    
...
80106928:	83 ec 08             	sub    $0x8,%esp
  exit();
8010692b:	e8 e3 e3 ff ff       	call   80104d13 <exit>
...
8010693a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010693d:	e8 ec e4 ff ff       	call   80104e2e <wait>
}
80106942:	c9                   	leave  
80106943:	c3                   	ret    
...
80106951:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106958:	e8 b5 f0 ff ff       	call   80105a12 <argint>
8010695d:	85 c0                	test   %eax,%eax
8010695f:	79 07                	jns    80106968 <sys_kill+0x24>
    return -1;
80106961:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106966:	eb 0b                	jmp    80106973 <sys_kill+0x2f>
  return kill(pid);
80106968:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010696b:	89 04 24             	mov    %eax,(%esp)
8010696e:	e8 20 e9 ff ff       	call   80105293 <kill>
}
80106973:	c9                   	leave  
80106974:	c3                   	ret    
...
8010697e:	8b 40 10             	mov    0x10(%eax),%eax
}
80106981:	5d                   	pop    %ebp
80106982:	c3                   	ret    
...
80106986:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80106989:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010698c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106990:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106997:	e8 76 f0 ff ff       	call   80105a12 <argint>
8010699c:	85 c0                	test   %eax,%eax
8010699e:	79 07                	jns    801069a7 <sys_sbrk+0x24>
    return -1;
801069a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069a5:	eb 24                	jmp    801069cb <sys_sbrk+0x48>
  addr = proc->sz;
801069a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069ad:	8b 00                	mov    (%eax),%eax
801069af:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
801069b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069b5:	89 04 24             	mov    %eax,(%esp)
801069b8:	e8 f2 d8 ff ff       	call   801042af <growproc>
801069bd:	85 c0                	test   %eax,%eax
801069bf:	79 07                	jns    801069c8 <sys_sbrk+0x45>
    return -1;
801069c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069c6:	eb 03                	jmp    801069cb <sys_sbrk+0x48>
  return addr;
...
801069d0:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
801069d3:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801069da:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069e1:	e8 2c f0 ff ff       	call   80105a12 <argint>
801069e6:	85 c0                	test   %eax,%eax
801069e8:	79 07                	jns    801069f1 <sys_sleep+0x24>
    return -1;
801069ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ef:	eb 6c                	jmp    80106a5d <sys_sleep+0x90>
  acquire(&tickslock);
801069f1:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
801069f8:	e8 76 ea ff ff       	call   80105473 <acquire>
  ticks0 = ticks;
801069fd:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106a02:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106a05:	eb 34                	jmp    80106a3b <sys_sleep+0x6e>
    if(proc->killed){
80106a07:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a0d:	8b 40 24             	mov    0x24(%eax),%eax
80106a10:	85 c0                	test   %eax,%eax
80106a12:	74 13                	je     80106a27 <sys_sleep+0x5a>
      release(&tickslock);
80106a14:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106a1b:	e8 b5 ea ff ff       	call   801054d5 <release>
      return -1;
80106a20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a25:	eb 36                	jmp    80106a5d <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106a27:	c7 44 24 04 c0 53 11 	movl   $0x801153c0,0x4(%esp)
80106a2e:	80 
80106a2f:	c7 04 24 00 5c 11 80 	movl   $0x80115c00,(%esp)
80106a36:	e8 51 e7 ff ff       	call   8010518c <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106a3b:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106a40:	89 c2                	mov    %eax,%edx
80106a42:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106a45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a48:	39 c2                	cmp    %eax,%edx
80106a4a:	72 bb                	jb     80106a07 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106a4c:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106a53:	e8 7d ea ff ff       	call   801054d5 <release>
  return 0;
...
80106a62:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106a65:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106a6c:	e8 02 ea ff ff       	call   80105473 <acquire>
  xticks = ticks;
80106a71:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106a76:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106a79:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106a80:	e8 50 ea ff ff       	call   801054d5 <release>
  return xticks;
...
80106aa6:	e8 9f ef ff ff       	call   80105a4a <argptr>
  argptr(1,&stack,sizeof(stack));
80106aab:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106ab2:	00 
80106ab3:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106ab6:	89 44 24 04          	mov    %eax,0x4(%esp)
80106aba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106ac1:	e8 84 ef ff ff       	call   80105a4a <argptr>
  argint(2,&stack_size);
80106ac6:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106ac9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106acd:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106ad4:	e8 39 ef ff ff       	call   80105a12 <argint>
  return thread_create((void*(*)())start_func,(void*)stack,(uint)stack_size);
80106ad9:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106adc:	89 c1                	mov    %eax,%ecx
80106ade:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106ae1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ae4:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106ae8:	89 54 24 04          	mov    %edx,0x4(%esp)
80106aec:	89 04 24             	mov    %eax,(%esp)
80106aef:	e8 c3 d9 ff ff       	call   801044b7 <thread_create>
}
80106af4:	c9                   	leave  
80106af5:	c3                   	ret    

80106af6 <sys_thread_getId>:
...
80106af9:	83 ec 08             	sub    $0x8,%esp
    return thread_getId();
80106afc:	e8 56 dc ff ff       	call   80104757 <thread_getId>
}
80106b01:	c9                   	leave  
80106b02:	c3                   	ret    

80106b03 <sys_thread_getProcId>:
...
80106b09:	e8 57 dc ff ff       	call   80104765 <thread_getProcId>
}
80106b0e:	c9                   	leave  
80106b0f:	c3                   	ret    

80106b10 <sys_thread_join>:
...
80106b24:	e8 e9 ee ff ff       	call   80105a12 <argint>
  argptr(1,&ret_val,sizeof(ret_val));
80106b29:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b30:	00 
80106b31:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b34:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b3f:	e8 06 ef ff ff       	call   80105a4a <argptr>
  return thread_join(thread_id,(void**)&ret_val);
80106b44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b47:	8d 55 f0             	lea    -0x10(%ebp),%edx
80106b4a:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b4e:	89 04 24             	mov    %eax,(%esp)
80106b51:	e8 38 dc ff ff       	call   8010478e <thread_join>
}
80106b56:	c9                   	leave  
80106b57:	c3                   	ret    

80106b58 <sys_thread_exit>:
...
80106b5b:	83 ec 28             	sub    $0x28,%esp
    char* ret_val;
    argptr(0,&ret_val,sizeof(ret_val));
80106b5e:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b65:	00 
80106b66:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b69:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b6d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b74:	e8 d1 ee ff ff       	call   80105a4a <argptr>
    thread_exit((void*)ret_val);
80106b79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b7c:	89 04 24             	mov    %eax,(%esp)
80106b7f:	e8 0a dd ff ff       	call   8010488e <thread_exit>
    return 0; // not reached
80106b84:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b89:	c9                   	leave  
80106b8a:	c3                   	ret    

80106b8b <sys_binary_semaphore_create>:
...
80106b91:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b94:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b98:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b9f:	e8 6e ee ff ff       	call   80105a12 <argint>
  return binary_semaphore_create(initial_value);
80106ba4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ba7:	89 04 24             	mov    %eax,(%esp)
80106baa:	e8 41 de ff ff       	call   801049f0 <binary_semaphore_create>
}
80106baf:	c9                   	leave  
80106bb0:	c3                   	ret    

80106bb1 <sys_binary_semaphore_down>:
...
80106bc5:	e8 48 ee ff ff       	call   80105a12 <argint>
  return binary_semaphore_down(binary_semaphore_ID);
80106bca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bcd:	89 04 24             	mov    %eax,(%esp)
80106bd0:	e8 89 de ff ff       	call   80104a5e <binary_semaphore_down>
}
80106bd5:	c9                   	leave  
80106bd6:	c3                   	ret    

80106bd7 <sys_binary_semaphore_up>:
int 
...
80106c0c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106c10:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106c13:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106c17:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106c1b:	ee                   	out    %al,(%dx)
}
80106c1c:	c9                   	leave  
80106c1d:	c3                   	ret    
...
80106c21:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106c24:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106c2b:	00 
80106c2c:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106c33:	e8 c8 ff ff ff       	call   80106c00 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106c38:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106c3f:	00 
80106c40:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106c47:	e8 b4 ff ff ff       	call   80106c00 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106c4c:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106c53:	00 
80106c54:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106c5b:	e8 a0 ff ff ff       	call   80106c00 <outb>
  picenable(IRQ_TIMER);
80106c60:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c67:	e8 55 ce ff ff       	call   80103ac1 <picenable>
}
80106c6c:	c9                   	leave  
80106c6d:	c3                   	ret    
	...
...
80106c71:	06                   	push   %es
  pushl %fs
80106c72:	0f a0                	push   %fs
  pushl %gs
80106c74:	0f a8                	push   %gs
  pushal
80106c76:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106c77:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106c7b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106c7d:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106c7f:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106c83:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106c85:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106c87:	54                   	push   %esp
  call trap
80106c88:	e8 de 01 00 00       	call   80106e6b <trap>
  addl $4, %esp
...
80106ca5:	83 e8 01             	sub    $0x1,%eax
80106ca8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106cac:	8b 45 08             	mov    0x8(%ebp),%eax
80106caf:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106cb3:	8b 45 08             	mov    0x8(%ebp),%eax
80106cb6:	c1 e8 10             	shr    $0x10,%eax
80106cb9:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106cbd:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106cc0:	0f 01 18             	lidtl  (%eax)
}
80106cc3:	c9                   	leave  
80106cc4:	c3                   	ret    
...
80106cc9:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106ccc:	0f 20 d3             	mov    %cr2,%ebx
80106ccf:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106cd2:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106cde:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106ce1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106ce8:	e9 c3 00 00 00       	jmp    80106db0 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106ced:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cf0:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106cf7:	89 c2                	mov    %eax,%edx
80106cf9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cfc:	66 89 14 c5 00 54 11 	mov    %dx,-0x7feeac00(,%eax,8)
80106d03:	80 
80106d04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d07:	66 c7 04 c5 02 54 11 	movw   $0x8,-0x7feeabfe(,%eax,8)
80106d0e:	80 08 00 
80106d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d14:	0f b6 14 c5 04 54 11 	movzbl -0x7feeabfc(,%eax,8),%edx
80106d1b:	80 
80106d1c:	83 e2 e0             	and    $0xffffffe0,%edx
80106d1f:	88 14 c5 04 54 11 80 	mov    %dl,-0x7feeabfc(,%eax,8)
80106d26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d29:	0f b6 14 c5 04 54 11 	movzbl -0x7feeabfc(,%eax,8),%edx
80106d30:	80 
80106d31:	83 e2 1f             	and    $0x1f,%edx
80106d34:	88 14 c5 04 54 11 80 	mov    %dl,-0x7feeabfc(,%eax,8)
80106d3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d3e:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106d45:	80 
80106d46:	83 e2 f0             	and    $0xfffffff0,%edx
80106d49:	83 ca 0e             	or     $0xe,%edx
80106d4c:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106d53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d56:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106d5d:	80 
80106d5e:	83 e2 ef             	and    $0xffffffef,%edx
80106d61:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106d68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d6b:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106d72:	80 
80106d73:	83 e2 9f             	and    $0xffffff9f,%edx
80106d76:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106d7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d80:	0f b6 14 c5 05 54 11 	movzbl -0x7feeabfb(,%eax,8),%edx
80106d87:	80 
80106d88:	83 ca 80             	or     $0xffffff80,%edx
80106d8b:	88 14 c5 05 54 11 80 	mov    %dl,-0x7feeabfb(,%eax,8)
80106d92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d95:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106d9c:	c1 e8 10             	shr    $0x10,%eax
80106d9f:	89 c2                	mov    %eax,%edx
80106da1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106da4:	66 89 14 c5 06 54 11 	mov    %dx,-0x7feeabfa(,%eax,8)
80106dab:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106dac:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106db0:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106db7:	0f 8e 30 ff ff ff    	jle    80106ced <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106dbd:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106dc2:	66 a3 00 56 11 80    	mov    %ax,0x80115600
80106dc8:	66 c7 05 02 56 11 80 	movw   $0x8,0x80115602
80106dcf:	08 00 
80106dd1:	0f b6 05 04 56 11 80 	movzbl 0x80115604,%eax
80106dd8:	83 e0 e0             	and    $0xffffffe0,%eax
80106ddb:	a2 04 56 11 80       	mov    %al,0x80115604
80106de0:	0f b6 05 04 56 11 80 	movzbl 0x80115604,%eax
80106de7:	83 e0 1f             	and    $0x1f,%eax
80106dea:	a2 04 56 11 80       	mov    %al,0x80115604
80106def:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106df6:	83 c8 0f             	or     $0xf,%eax
80106df9:	a2 05 56 11 80       	mov    %al,0x80115605
80106dfe:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106e05:	83 e0 ef             	and    $0xffffffef,%eax
80106e08:	a2 05 56 11 80       	mov    %al,0x80115605
80106e0d:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106e14:	83 c8 60             	or     $0x60,%eax
80106e17:	a2 05 56 11 80       	mov    %al,0x80115605
80106e1c:	0f b6 05 05 56 11 80 	movzbl 0x80115605,%eax
80106e23:	83 c8 80             	or     $0xffffff80,%eax
80106e26:	a2 05 56 11 80       	mov    %al,0x80115605
80106e2b:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106e30:	c1 e8 10             	shr    $0x10,%eax
80106e33:	66 a3 06 56 11 80    	mov    %ax,0x80115606
  
  initlock(&tickslock, "time");
80106e39:	c7 44 24 04 bc 90 10 	movl   $0x801090bc,0x4(%esp)
80106e40:	80 
80106e41:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106e48:	e8 05 e6 ff ff       	call   80105452 <initlock>
}
80106e4d:	c9                   	leave  
80106e4e:	c3                   	ret    
...
80106e52:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106e55:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106e5c:	00 
80106e5d:	c7 04 24 00 54 11 80 	movl   $0x80115400,(%esp)
80106e64:	e8 33 fe ff ff       	call   80106c9c <lidt>
}
80106e69:	c9                   	leave  
80106e6a:	c3                   	ret    
...
80106e6f:	56                   	push   %esi
80106e70:	53                   	push   %ebx
80106e71:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106e74:	8b 45 08             	mov    0x8(%ebp),%eax
80106e77:	8b 40 30             	mov    0x30(%eax),%eax
80106e7a:	83 f8 40             	cmp    $0x40,%eax
80106e7d:	75 3e                	jne    80106ebd <trap+0x52>
    if(proc->killed)
80106e7f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e85:	8b 40 24             	mov    0x24(%eax),%eax
80106e88:	85 c0                	test   %eax,%eax
80106e8a:	74 05                	je     80106e91 <trap+0x26>
      exit();
80106e8c:	e8 82 de ff ff       	call   80104d13 <exit>
    proc->tf = tf;
80106e91:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e97:	8b 55 08             	mov    0x8(%ebp),%edx
80106e9a:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106e9d:	e8 4d ec ff ff       	call   80105aef <syscall>
    if(proc->killed)
80106ea2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ea8:	8b 40 24             	mov    0x24(%eax),%eax
80106eab:	85 c0                	test   %eax,%eax
80106ead:	0f 84 34 02 00 00    	je     801070e7 <trap+0x27c>
      exit();
80106eb3:	e8 5b de ff ff       	call   80104d13 <exit>
    return;
80106eb8:	e9 2a 02 00 00       	jmp    801070e7 <trap+0x27c>
  }

  switch(tf->trapno){
80106ebd:	8b 45 08             	mov    0x8(%ebp),%eax
80106ec0:	8b 40 30             	mov    0x30(%eax),%eax
80106ec3:	83 e8 20             	sub    $0x20,%eax
80106ec6:	83 f8 1f             	cmp    $0x1f,%eax
80106ec9:	0f 87 bc 00 00 00    	ja     80106f8b <trap+0x120>
80106ecf:	8b 04 85 64 91 10 80 	mov    -0x7fef6e9c(,%eax,4),%eax
80106ed6:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106ed8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106ede:	0f b6 00             	movzbl (%eax),%eax
80106ee1:	84 c0                	test   %al,%al
80106ee3:	75 31                	jne    80106f16 <trap+0xab>
      acquire(&tickslock);
80106ee5:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106eec:	e8 82 e5 ff ff       	call   80105473 <acquire>
      ticks++;
80106ef1:	a1 00 5c 11 80       	mov    0x80115c00,%eax
80106ef6:	83 c0 01             	add    $0x1,%eax
80106ef9:	a3 00 5c 11 80       	mov    %eax,0x80115c00
      wakeup(&ticks);
80106efe:	c7 04 24 00 5c 11 80 	movl   $0x80115c00,(%esp)
80106f05:	e8 5e e3 ff ff       	call   80105268 <wakeup>
      release(&tickslock);
80106f0a:	c7 04 24 c0 53 11 80 	movl   $0x801153c0,(%esp)
80106f11:	e8 bf e5 ff ff       	call   801054d5 <release>
    }
    lapiceoi();
80106f16:	e8 ce bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106f1b:	e9 41 01 00 00       	jmp    80107061 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106f20:	e8 cc b7 ff ff       	call   801026f1 <ideintr>
    lapiceoi();
80106f25:	e8 bf bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106f2a:	e9 32 01 00 00       	jmp    80107061 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106f2f:	e8 93 bd ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
80106f34:	e8 b0 bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106f39:	e9 23 01 00 00       	jmp    80107061 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106f3e:	e8 a9 03 00 00       	call   801072ec <uartintr>
    lapiceoi();
80106f43:	e8 a1 bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106f48:	e9 14 01 00 00       	jmp    80107061 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106f4d:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106f50:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106f53:	8b 45 08             	mov    0x8(%ebp),%eax
80106f56:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106f5a:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106f63:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106f66:	0f b6 c0             	movzbl %al,%eax
80106f69:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106f6d:	89 54 24 08          	mov    %edx,0x8(%esp)
80106f71:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f75:	c7 04 24 c4 90 10 80 	movl   $0x801090c4,(%esp)
80106f7c:	e8 20 94 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106f81:	e8 63 bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106f86:	e9 d6 00 00 00       	jmp    80107061 <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80106f8b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f91:	85 c0                	test   %eax,%eax
80106f93:	74 11                	je     80106fa6 <trap+0x13b>
80106f95:	8b 45 08             	mov    0x8(%ebp),%eax
80106f98:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f9c:	0f b7 c0             	movzwl %ax,%eax
80106f9f:	83 e0 03             	and    $0x3,%eax
80106fa2:	85 c0                	test   %eax,%eax
80106fa4:	75 46                	jne    80106fec <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106fa6:	e8 1a fd ff ff       	call   80106cc5 <rcr2>
...
80106fab:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106fae:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106fb1:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106fb8:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106fbb:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106fbe:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106fc1:	8b 52 30             	mov    0x30(%edx),%edx
80106fc4:	89 44 24 10          	mov    %eax,0x10(%esp)
80106fc8:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106fcc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106fd0:	89 54 24 04          	mov    %edx,0x4(%esp)
80106fd4:	c7 04 24 e8 90 10 80 	movl   $0x801090e8,(%esp)
80106fdb:	e8 c1 93 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106fe0:	c7 04 24 1a 91 10 80 	movl   $0x8010911a,(%esp)
80106fe7:	e8 51 95 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106fec:	e8 d4 fc ff ff       	call   80106cc5 <rcr2>
80106ff1:	89 c2                	mov    %eax,%edx
...
80106ff3:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106ff6:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106ff9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106fff:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107002:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107005:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107008:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010700b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010700e:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107011:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107017:	83 c0 6c             	add    $0x6c,%eax
...
8010701d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107023:	8b 40 10             	mov    0x10(%eax),%eax
80107026:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010702a:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010702e:	89 74 24 14          	mov    %esi,0x14(%esp)
80107032:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107036:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010703a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010703d:	89 54 24 08          	mov    %edx,0x8(%esp)
80107041:	89 44 24 04          	mov    %eax,0x4(%esp)
80107045:	c7 04 24 20 91 10 80 	movl   $0x80109120,(%esp)
8010704c:	e8 50 93 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
8010705e:	eb 01                	jmp    80107061 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107069:	74 24                	je     8010708f <trap+0x224>
8010706b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107071:	8b 40 24             	mov    0x24(%eax),%eax
80107074:	85 c0                	test   %eax,%eax
80107076:	74 17                	je     8010708f <trap+0x224>
80107078:	8b 45 08             	mov    0x8(%ebp),%eax
8010707b:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010707f:	0f b7 c0             	movzwl %ax,%eax
80107082:	83 e0 03             	and    $0x3,%eax
80107085:	83 f8 03             	cmp    $0x3,%eax
80107088:	75 05                	jne    8010708f <trap+0x224>
    exit();
8010708a:	e8 84 dc ff ff       	call   80104d13 <exit>
...
80107097:	74 1e                	je     801070b7 <trap+0x24c>
80107099:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010709f:	8b 40 0c             	mov    0xc(%eax),%eax
801070a2:	83 f8 04             	cmp    $0x4,%eax
801070a5:	75 10                	jne    801070b7 <trap+0x24c>
801070a7:	8b 45 08             	mov    0x8(%ebp),%eax
801070aa:	8b 40 30             	mov    0x30(%eax),%eax
801070ad:	83 f8 20             	cmp    $0x20,%eax
801070b0:	75 05                	jne    801070b7 <trap+0x24c>
    yield();
801070b2:	e8 77 e0 ff ff       	call   8010512e <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801070b7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070bd:	85 c0                	test   %eax,%eax
801070bf:	74 27                	je     801070e8 <trap+0x27d>
801070c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070c7:	8b 40 24             	mov    0x24(%eax),%eax
801070ca:	85 c0                	test   %eax,%eax
801070cc:	74 1a                	je     801070e8 <trap+0x27d>
801070ce:	8b 45 08             	mov    0x8(%ebp),%eax
801070d1:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801070d5:	0f b7 c0             	movzwl %ax,%eax
801070d8:	83 e0 03             	and    $0x3,%eax
801070db:	83 f8 03             	cmp    $0x3,%eax
801070de:	75 08                	jne    801070e8 <trap+0x27d>
    exit();
801070e0:	e8 2e dc ff ff       	call   80104d13 <exit>
801070e5:	eb 01                	jmp    801070e8 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
801070e8:	83 c4 3c             	add    $0x3c,%esp
801070eb:	5b                   	pop    %ebx
801070ec:	5e                   	pop    %esi
801070ed:	5f                   	pop    %edi
801070ee:	5d                   	pop    %ebp
...
801070f4:	83 ec 14             	sub    $0x14,%esp
801070f7:	8b 45 08             	mov    0x8(%ebp),%eax
801070fa:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801070fe:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107102:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80107106:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010710a:	ec                   	in     (%dx),%al
8010710b:	89 c3                	mov    %eax,%ebx
8010710d:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107110:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107114:	83 c4 14             	add    $0x14,%esp
80107117:	5b                   	pop    %ebx
80107118:	5d                   	pop    %ebp
80107119:	c3                   	ret    
...
8010713b:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010713e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107145:	00 
80107146:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010714d:	e8 c8 ff ff ff       	call   8010711a <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107152:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107159:	00 
8010715a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107161:	e8 b4 ff ff ff       	call   8010711a <outb>
  outb(COM1+0, 115200/9600);
80107166:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
8010716d:	00 
8010716e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107175:	e8 a0 ff ff ff       	call   8010711a <outb>
  outb(COM1+1, 0);
8010717a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107181:	00 
80107182:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107189:	e8 8c ff ff ff       	call   8010711a <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
8010718e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107195:	00 
80107196:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
8010719d:	e8 78 ff ff ff       	call   8010711a <outb>
  outb(COM1+4, 0);
801071a2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801071a9:	00 
801071aa:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801071b1:	e8 64 ff ff ff       	call   8010711a <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801071b6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801071bd:	00 
801071be:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801071c5:	e8 50 ff ff ff       	call   8010711a <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801071ca:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801071d1:	e8 1a ff ff ff       	call   801070f0 <inb>
801071d6:	3c ff                	cmp    $0xff,%al
801071d8:	74 6c                	je     80107246 <uartinit+0x10e>
    return;
  uart = 1;
801071da:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
801071e1:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801071e4:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801071eb:	e8 00 ff ff ff       	call   801070f0 <inb>
  inb(COM1+0);
801071f0:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801071f7:	e8 f4 fe ff ff       	call   801070f0 <inb>
  picenable(IRQ_COM1);
801071fc:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107203:	e8 b9 c8 ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107208:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010720f:	00 
80107210:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107217:	e8 5a b7 ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010721c:	c7 45 f4 e4 91 10 80 	movl   $0x801091e4,-0xc(%ebp)
80107223:	eb 15                	jmp    8010723a <uartinit+0x102>
    uartputc(*p);
80107225:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107228:	0f b6 00             	movzbl (%eax),%eax
8010722b:	0f be c0             	movsbl %al,%eax
8010722e:	89 04 24             	mov    %eax,(%esp)
80107231:	e8 13 00 00 00       	call   80107249 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107236:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010723a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010723d:	0f b6 00             	movzbl (%eax),%eax
80107240:	84 c0                	test   %al,%al
80107242:	75 e1                	jne    80107225 <uartinit+0xed>
80107244:	eb 01                	jmp    80107247 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
8010724c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
8010724f:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107254:	85 c0                	test   %eax,%eax
80107256:	74 4d                	je     801072a5 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107258:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010725f:	eb 10                	jmp    80107271 <uartputc+0x28>
    microdelay(10);
80107261:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107268:	e8 a1 bc ff ff       	call   80102f0e <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010726d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107271:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107275:	7f 16                	jg     8010728d <uartputc+0x44>
80107277:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010727e:	e8 6d fe ff ff       	call   801070f0 <inb>
80107283:	0f b6 c0             	movzbl %al,%eax
80107286:	83 e0 20             	and    $0x20,%eax
80107289:	85 c0                	test   %eax,%eax
8010728b:	74 d4                	je     80107261 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
8010728d:	8b 45 08             	mov    0x8(%ebp),%eax
80107290:	0f b6 c0             	movzbl %al,%eax
80107293:	89 44 24 04          	mov    %eax,0x4(%esp)
80107297:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010729e:	e8 77 fe ff ff       	call   8010711a <outb>
801072a3:	eb 01                	jmp    801072a6 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
801072ab:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801072ae:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801072b3:	85 c0                	test   %eax,%eax
801072b5:	75 07                	jne    801072be <uartgetc+0x16>
    return -1;
801072b7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801072bc:	eb 2c                	jmp    801072ea <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801072be:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801072c5:	e8 26 fe ff ff       	call   801070f0 <inb>
801072ca:	0f b6 c0             	movzbl %al,%eax
801072cd:	83 e0 01             	and    $0x1,%eax
801072d0:	85 c0                	test   %eax,%eax
801072d2:	75 07                	jne    801072db <uartgetc+0x33>
    return -1;
801072d4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801072d9:	eb 0f                	jmp    801072ea <uartgetc+0x42>
  return inb(COM1+0);
801072db:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801072e2:	e8 09 fe ff ff       	call   801070f0 <inb>
801072e7:	0f b6 c0             	movzbl %al,%eax
}
801072ea:	c9                   	leave  
801072eb:	c3                   	ret    
...
801072ef:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801072f2:	c7 04 24 a8 72 10 80 	movl   $0x801072a8,(%esp)
801072f9:	e8 af 94 ff ff       	call   801007ad <consoleintr>
}
801072fe:	c9                   	leave  
801072ff:	c3                   	ret    
...
80107302:	6a 00                	push   $0x0
  jmp alltraps
80107304:	e9 67 f9 ff ff       	jmp    80106c70 <alltraps>
...
80107309:	6a 00                	push   $0x0
  pushl $1
8010730b:	6a 01                	push   $0x1
  jmp alltraps
8010730d:	e9 5e f9 ff ff       	jmp    80106c70 <alltraps>
...
80107312:	6a 00                	push   $0x0
  pushl $2
80107314:	6a 02                	push   $0x2
  jmp alltraps
80107316:	e9 55 f9 ff ff       	jmp    80106c70 <alltraps>
...
8010731b:	6a 00                	push   $0x0
  pushl $3
8010731d:	6a 03                	push   $0x3
  jmp alltraps
8010731f:	e9 4c f9 ff ff       	jmp    80106c70 <alltraps>
...
80107326:	6a 04                	push   $0x4
  jmp alltraps
80107328:	e9 43 f9 ff ff       	jmp    80106c70 <alltraps>
...
8010732d:	6a 00                	push   $0x0
  pushl $5
8010732f:	6a 05                	push   $0x5
  jmp alltraps
80107331:	e9 3a f9 ff ff       	jmp    80106c70 <alltraps>
...
80107338:	6a 06                	push   $0x6
  jmp alltraps
8010733a:	e9 31 f9 ff ff       	jmp    80106c70 <alltraps>
...
8010733f:	6a 00                	push   $0x0
  pushl $7
80107341:	6a 07                	push   $0x7
  jmp alltraps
80107343:	e9 28 f9 ff ff       	jmp    80106c70 <alltraps>

80107348 <vector8>:
.globl vector8
vector8:
  pushl $8
80107348:	6a 08                	push   $0x8
  jmp alltraps
8010734a:	e9 21 f9 ff ff       	jmp    80106c70 <alltraps>
...
8010734f:	6a 00                	push   $0x0
  pushl $9
80107351:	6a 09                	push   $0x9
  jmp alltraps
80107353:	e9 18 f9 ff ff       	jmp    80106c70 <alltraps>

80107358 <vector10>:
.globl vector10
vector10:
  pushl $10
80107358:	6a 0a                	push   $0xa
  jmp alltraps
8010735a:	e9 11 f9 ff ff       	jmp    80106c70 <alltraps>

8010735f <vector11>:
.globl vector11
vector11:
  pushl $11
8010735f:	6a 0b                	push   $0xb
  jmp alltraps
80107361:	e9 0a f9 ff ff       	jmp    80106c70 <alltraps>

80107366 <vector12>:
.globl vector12
vector12:
  pushl $12
80107366:	6a 0c                	push   $0xc
  jmp alltraps
80107368:	e9 03 f9 ff ff       	jmp    80106c70 <alltraps>

8010736d <vector13>:
.globl vector13
vector13:
  pushl $13
8010736d:	6a 0d                	push   $0xd
  jmp alltraps
8010736f:	e9 fc f8 ff ff       	jmp    80106c70 <alltraps>

80107374 <vector14>:
.globl vector14
vector14:
  pushl $14
80107374:	6a 0e                	push   $0xe
  jmp alltraps
80107376:	e9 f5 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010737b:	6a 00                	push   $0x0
  pushl $15
8010737d:	6a 0f                	push   $0xf
  jmp alltraps
8010737f:	e9 ec f8 ff ff       	jmp    80106c70 <alltraps>
...
80107384:	6a 00                	push   $0x0
  pushl $16
80107386:	6a 10                	push   $0x10
  jmp alltraps
80107388:	e9 e3 f8 ff ff       	jmp    80106c70 <alltraps>

8010738d <vector17>:
.globl vector17
vector17:
  pushl $17
8010738d:	6a 11                	push   $0x11
  jmp alltraps
8010738f:	e9 dc f8 ff ff       	jmp    80106c70 <alltraps>
...
80107394:	6a 00                	push   $0x0
  pushl $18
80107396:	6a 12                	push   $0x12
  jmp alltraps
80107398:	e9 d3 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010739d:	6a 00                	push   $0x0
  pushl $19
8010739f:	6a 13                	push   $0x13
  jmp alltraps
801073a1:	e9 ca f8 ff ff       	jmp    80106c70 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $20
801073a8:	6a 14                	push   $0x14
  jmp alltraps
801073aa:	e9 c1 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $21
801073b1:	6a 15                	push   $0x15
  jmp alltraps
801073b3:	e9 b8 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073b8:	6a 00                	push   $0x0
  pushl $22
801073ba:	6a 16                	push   $0x16
  jmp alltraps
801073bc:	e9 af f8 ff ff       	jmp    80106c70 <alltraps>
...
801073c1:	6a 00                	push   $0x0
  pushl $23
801073c3:	6a 17                	push   $0x17
  jmp alltraps
801073c5:	e9 a6 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $24
801073cc:	6a 18                	push   $0x18
  jmp alltraps
801073ce:	e9 9d f8 ff ff       	jmp    80106c70 <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $25
801073d5:	6a 19                	push   $0x19
  jmp alltraps
801073d7:	e9 94 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073dc:	6a 00                	push   $0x0
  pushl $26
801073de:	6a 1a                	push   $0x1a
  jmp alltraps
801073e0:	e9 8b f8 ff ff       	jmp    80106c70 <alltraps>
...
801073e5:	6a 00                	push   $0x0
  pushl $27
801073e7:	6a 1b                	push   $0x1b
  jmp alltraps
801073e9:	e9 82 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $28
801073f0:	6a 1c                	push   $0x1c
  jmp alltraps
801073f2:	e9 79 f8 ff ff       	jmp    80106c70 <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $29
801073f9:	6a 1d                	push   $0x1d
  jmp alltraps
801073fb:	e9 70 f8 ff ff       	jmp    80106c70 <alltraps>
...
80107400:	6a 00                	push   $0x0
  pushl $30
80107402:	6a 1e                	push   $0x1e
  jmp alltraps
80107404:	e9 67 f8 ff ff       	jmp    80106c70 <alltraps>
...
80107409:	6a 00                	push   $0x0
  pushl $31
8010740b:	6a 1f                	push   $0x1f
  jmp alltraps
8010740d:	e9 5e f8 ff ff       	jmp    80106c70 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $32
80107414:	6a 20                	push   $0x20
  jmp alltraps
80107416:	e9 55 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $33
8010741d:	6a 21                	push   $0x21
  jmp alltraps
8010741f:	e9 4c f8 ff ff       	jmp    80106c70 <alltraps>
...
80107424:	6a 00                	push   $0x0
  pushl $34
80107426:	6a 22                	push   $0x22
  jmp alltraps
80107428:	e9 43 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010742d:	6a 00                	push   $0x0
  pushl $35
8010742f:	6a 23                	push   $0x23
  jmp alltraps
80107431:	e9 3a f8 ff ff       	jmp    80106c70 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $36
80107438:	6a 24                	push   $0x24
  jmp alltraps
8010743a:	e9 31 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $37
80107441:	6a 25                	push   $0x25
  jmp alltraps
80107443:	e9 28 f8 ff ff       	jmp    80106c70 <alltraps>
...
80107448:	6a 00                	push   $0x0
  pushl $38
8010744a:	6a 26                	push   $0x26
  jmp alltraps
8010744c:	e9 1f f8 ff ff       	jmp    80106c70 <alltraps>
...
80107451:	6a 00                	push   $0x0
  pushl $39
80107453:	6a 27                	push   $0x27
  jmp alltraps
80107455:	e9 16 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $40
8010745c:	6a 28                	push   $0x28
  jmp alltraps
8010745e:	e9 0d f8 ff ff       	jmp    80106c70 <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $41
80107465:	6a 29                	push   $0x29
  jmp alltraps
80107467:	e9 04 f8 ff ff       	jmp    80106c70 <alltraps>
...
8010746c:	6a 00                	push   $0x0
  pushl $42
8010746e:	6a 2a                	push   $0x2a
  jmp alltraps
80107470:	e9 fb f7 ff ff       	jmp    80106c70 <alltraps>
...
80107475:	6a 00                	push   $0x0
  pushl $43
80107477:	6a 2b                	push   $0x2b
  jmp alltraps
80107479:	e9 f2 f7 ff ff       	jmp    80106c70 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $44
80107480:	6a 2c                	push   $0x2c
  jmp alltraps
80107482:	e9 e9 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $45
80107489:	6a 2d                	push   $0x2d
  jmp alltraps
8010748b:	e9 e0 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107490:	6a 00                	push   $0x0
  pushl $46
80107492:	6a 2e                	push   $0x2e
  jmp alltraps
80107494:	e9 d7 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107499:	6a 00                	push   $0x0
  pushl $47
8010749b:	6a 2f                	push   $0x2f
  jmp alltraps
8010749d:	e9 ce f7 ff ff       	jmp    80106c70 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $48
801074a4:	6a 30                	push   $0x30
  jmp alltraps
801074a6:	e9 c5 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $49
801074ad:	6a 31                	push   $0x31
  jmp alltraps
801074af:	e9 bc f7 ff ff       	jmp    80106c70 <alltraps>
...
801074b4:	6a 00                	push   $0x0
  pushl $50
801074b6:	6a 32                	push   $0x32
  jmp alltraps
801074b8:	e9 b3 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074bd:	6a 00                	push   $0x0
  pushl $51
801074bf:	6a 33                	push   $0x33
  jmp alltraps
801074c1:	e9 aa f7 ff ff       	jmp    80106c70 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $52
801074c8:	6a 34                	push   $0x34
  jmp alltraps
801074ca:	e9 a1 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $53
801074d1:	6a 35                	push   $0x35
  jmp alltraps
801074d3:	e9 98 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074d8:	6a 00                	push   $0x0
  pushl $54
801074da:	6a 36                	push   $0x36
  jmp alltraps
801074dc:	e9 8f f7 ff ff       	jmp    80106c70 <alltraps>
...
801074e1:	6a 00                	push   $0x0
  pushl $55
801074e3:	6a 37                	push   $0x37
  jmp alltraps
801074e5:	e9 86 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $56
801074ec:	6a 38                	push   $0x38
  jmp alltraps
801074ee:	e9 7d f7 ff ff       	jmp    80106c70 <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $57
801074f5:	6a 39                	push   $0x39
  jmp alltraps
801074f7:	e9 74 f7 ff ff       	jmp    80106c70 <alltraps>
...
801074fc:	6a 00                	push   $0x0
  pushl $58
801074fe:	6a 3a                	push   $0x3a
  jmp alltraps
80107500:	e9 6b f7 ff ff       	jmp    80106c70 <alltraps>
...
80107505:	6a 00                	push   $0x0
  pushl $59
80107507:	6a 3b                	push   $0x3b
  jmp alltraps
80107509:	e9 62 f7 ff ff       	jmp    80106c70 <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $60
80107510:	6a 3c                	push   $0x3c
  jmp alltraps
80107512:	e9 59 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $61
80107519:	6a 3d                	push   $0x3d
  jmp alltraps
8010751b:	e9 50 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107520:	6a 00                	push   $0x0
  pushl $62
80107522:	6a 3e                	push   $0x3e
  jmp alltraps
80107524:	e9 47 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107529:	6a 00                	push   $0x0
  pushl $63
8010752b:	6a 3f                	push   $0x3f
  jmp alltraps
8010752d:	e9 3e f7 ff ff       	jmp    80106c70 <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $64
80107534:	6a 40                	push   $0x40
  jmp alltraps
80107536:	e9 35 f7 ff ff       	jmp    80106c70 <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $65
8010753d:	6a 41                	push   $0x41
  jmp alltraps
8010753f:	e9 2c f7 ff ff       	jmp    80106c70 <alltraps>
...
80107544:	6a 00                	push   $0x0
  pushl $66
80107546:	6a 42                	push   $0x42
  jmp alltraps
80107548:	e9 23 f7 ff ff       	jmp    80106c70 <alltraps>
...
8010754d:	6a 00                	push   $0x0
  pushl $67
8010754f:	6a 43                	push   $0x43
  jmp alltraps
80107551:	e9 1a f7 ff ff       	jmp    80106c70 <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $68
80107558:	6a 44                	push   $0x44
  jmp alltraps
8010755a:	e9 11 f7 ff ff       	jmp    80106c70 <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $69
80107561:	6a 45                	push   $0x45
  jmp alltraps
80107563:	e9 08 f7 ff ff       	jmp    80106c70 <alltraps>
...
80107568:	6a 00                	push   $0x0
  pushl $70
8010756a:	6a 46                	push   $0x46
  jmp alltraps
8010756c:	e9 ff f6 ff ff       	jmp    80106c70 <alltraps>
...
80107571:	6a 00                	push   $0x0
  pushl $71
80107573:	6a 47                	push   $0x47
  jmp alltraps
80107575:	e9 f6 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $72
8010757c:	6a 48                	push   $0x48
  jmp alltraps
8010757e:	e9 ed f6 ff ff       	jmp    80106c70 <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $73
80107585:	6a 49                	push   $0x49
  jmp alltraps
80107587:	e9 e4 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010758c:	6a 00                	push   $0x0
  pushl $74
8010758e:	6a 4a                	push   $0x4a
  jmp alltraps
80107590:	e9 db f6 ff ff       	jmp    80106c70 <alltraps>
...
80107595:	6a 00                	push   $0x0
  pushl $75
80107597:	6a 4b                	push   $0x4b
  jmp alltraps
80107599:	e9 d2 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $76
801075a0:	6a 4c                	push   $0x4c
  jmp alltraps
801075a2:	e9 c9 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $77
801075a9:	6a 4d                	push   $0x4d
  jmp alltraps
801075ab:	e9 c0 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075b0:	6a 00                	push   $0x0
  pushl $78
801075b2:	6a 4e                	push   $0x4e
  jmp alltraps
801075b4:	e9 b7 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075b9:	6a 00                	push   $0x0
  pushl $79
801075bb:	6a 4f                	push   $0x4f
  jmp alltraps
801075bd:	e9 ae f6 ff ff       	jmp    80106c70 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $80
801075c4:	6a 50                	push   $0x50
  jmp alltraps
801075c6:	e9 a5 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $81
801075cd:	6a 51                	push   $0x51
  jmp alltraps
801075cf:	e9 9c f6 ff ff       	jmp    80106c70 <alltraps>
...
801075d4:	6a 00                	push   $0x0
  pushl $82
801075d6:	6a 52                	push   $0x52
  jmp alltraps
801075d8:	e9 93 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075dd:	6a 00                	push   $0x0
  pushl $83
801075df:	6a 53                	push   $0x53
  jmp alltraps
801075e1:	e9 8a f6 ff ff       	jmp    80106c70 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $84
801075e8:	6a 54                	push   $0x54
  jmp alltraps
801075ea:	e9 81 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $85
801075f1:	6a 55                	push   $0x55
  jmp alltraps
801075f3:	e9 78 f6 ff ff       	jmp    80106c70 <alltraps>
...
801075f8:	6a 00                	push   $0x0
  pushl $86
801075fa:	6a 56                	push   $0x56
  jmp alltraps
801075fc:	e9 6f f6 ff ff       	jmp    80106c70 <alltraps>
...
80107601:	6a 00                	push   $0x0
  pushl $87
80107603:	6a 57                	push   $0x57
  jmp alltraps
80107605:	e9 66 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $88
8010760c:	6a 58                	push   $0x58
  jmp alltraps
8010760e:	e9 5d f6 ff ff       	jmp    80106c70 <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $89
80107615:	6a 59                	push   $0x59
  jmp alltraps
80107617:	e9 54 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010761c:	6a 00                	push   $0x0
  pushl $90
8010761e:	6a 5a                	push   $0x5a
  jmp alltraps
80107620:	e9 4b f6 ff ff       	jmp    80106c70 <alltraps>
...
80107625:	6a 00                	push   $0x0
  pushl $91
80107627:	6a 5b                	push   $0x5b
  jmp alltraps
80107629:	e9 42 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $92
80107630:	6a 5c                	push   $0x5c
  jmp alltraps
80107632:	e9 39 f6 ff ff       	jmp    80106c70 <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $93
80107639:	6a 5d                	push   $0x5d
  jmp alltraps
8010763b:	e9 30 f6 ff ff       	jmp    80106c70 <alltraps>
...
80107640:	6a 00                	push   $0x0
  pushl $94
80107642:	6a 5e                	push   $0x5e
  jmp alltraps
80107644:	e9 27 f6 ff ff       	jmp    80106c70 <alltraps>
...
80107649:	6a 00                	push   $0x0
  pushl $95
8010764b:	6a 5f                	push   $0x5f
  jmp alltraps
8010764d:	e9 1e f6 ff ff       	jmp    80106c70 <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $96
80107654:	6a 60                	push   $0x60
  jmp alltraps
80107656:	e9 15 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $97
8010765d:	6a 61                	push   $0x61
  jmp alltraps
8010765f:	e9 0c f6 ff ff       	jmp    80106c70 <alltraps>
...
80107664:	6a 00                	push   $0x0
  pushl $98
80107666:	6a 62                	push   $0x62
  jmp alltraps
80107668:	e9 03 f6 ff ff       	jmp    80106c70 <alltraps>
...
8010766d:	6a 00                	push   $0x0
  pushl $99
8010766f:	6a 63                	push   $0x63
  jmp alltraps
80107671:	e9 fa f5 ff ff       	jmp    80106c70 <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $100
80107678:	6a 64                	push   $0x64
  jmp alltraps
8010767a:	e9 f1 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $101
80107681:	6a 65                	push   $0x65
  jmp alltraps
80107683:	e9 e8 f5 ff ff       	jmp    80106c70 <alltraps>
...
80107688:	6a 00                	push   $0x0
  pushl $102
8010768a:	6a 66                	push   $0x66
  jmp alltraps
8010768c:	e9 df f5 ff ff       	jmp    80106c70 <alltraps>
...
80107691:	6a 00                	push   $0x0
  pushl $103
80107693:	6a 67                	push   $0x67
  jmp alltraps
80107695:	e9 d6 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $104
8010769c:	6a 68                	push   $0x68
  jmp alltraps
8010769e:	e9 cd f5 ff ff       	jmp    80106c70 <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $105
801076a5:	6a 69                	push   $0x69
  jmp alltraps
801076a7:	e9 c4 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076ac:	6a 00                	push   $0x0
  pushl $106
801076ae:	6a 6a                	push   $0x6a
  jmp alltraps
801076b0:	e9 bb f5 ff ff       	jmp    80106c70 <alltraps>
...
801076b5:	6a 00                	push   $0x0
  pushl $107
801076b7:	6a 6b                	push   $0x6b
  jmp alltraps
801076b9:	e9 b2 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076be:	6a 00                	push   $0x0
  pushl $108
801076c0:	6a 6c                	push   $0x6c
  jmp alltraps
801076c2:	e9 a9 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $109
801076c9:	6a 6d                	push   $0x6d
  jmp alltraps
801076cb:	e9 a0 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076d0:	6a 00                	push   $0x0
  pushl $110
801076d2:	6a 6e                	push   $0x6e
  jmp alltraps
801076d4:	e9 97 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076d9:	6a 00                	push   $0x0
  pushl $111
801076db:	6a 6f                	push   $0x6f
  jmp alltraps
801076dd:	e9 8e f5 ff ff       	jmp    80106c70 <alltraps>
...
801076e2:	6a 00                	push   $0x0
  pushl $112
801076e4:	6a 70                	push   $0x70
  jmp alltraps
801076e6:	e9 85 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $113
801076ed:	6a 71                	push   $0x71
  jmp alltraps
801076ef:	e9 7c f5 ff ff       	jmp    80106c70 <alltraps>
...
801076f4:	6a 00                	push   $0x0
  pushl $114
801076f6:	6a 72                	push   $0x72
  jmp alltraps
801076f8:	e9 73 f5 ff ff       	jmp    80106c70 <alltraps>
...
801076fd:	6a 00                	push   $0x0
  pushl $115
801076ff:	6a 73                	push   $0x73
  jmp alltraps
80107701:	e9 6a f5 ff ff       	jmp    80106c70 <alltraps>
...
80107706:	6a 00                	push   $0x0
  pushl $116
80107708:	6a 74                	push   $0x74
  jmp alltraps
8010770a:	e9 61 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $117
80107711:	6a 75                	push   $0x75
  jmp alltraps
80107713:	e9 58 f5 ff ff       	jmp    80106c70 <alltraps>
...
80107718:	6a 00                	push   $0x0
  pushl $118
8010771a:	6a 76                	push   $0x76
  jmp alltraps
8010771c:	e9 4f f5 ff ff       	jmp    80106c70 <alltraps>
...
80107721:	6a 00                	push   $0x0
  pushl $119
80107723:	6a 77                	push   $0x77
  jmp alltraps
80107725:	e9 46 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010772a:	6a 00                	push   $0x0
  pushl $120
8010772c:	6a 78                	push   $0x78
  jmp alltraps
8010772e:	e9 3d f5 ff ff       	jmp    80106c70 <alltraps>
...
80107733:	6a 00                	push   $0x0
  pushl $121
80107735:	6a 79                	push   $0x79
  jmp alltraps
80107737:	e9 34 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010773c:	6a 00                	push   $0x0
  pushl $122
8010773e:	6a 7a                	push   $0x7a
  jmp alltraps
80107740:	e9 2b f5 ff ff       	jmp    80106c70 <alltraps>
...
80107745:	6a 00                	push   $0x0
  pushl $123
80107747:	6a 7b                	push   $0x7b
  jmp alltraps
80107749:	e9 22 f5 ff ff       	jmp    80106c70 <alltraps>
...
8010774e:	6a 00                	push   $0x0
  pushl $124
80107750:	6a 7c                	push   $0x7c
  jmp alltraps
80107752:	e9 19 f5 ff ff       	jmp    80106c70 <alltraps>
...
80107757:	6a 00                	push   $0x0
  pushl $125
80107759:	6a 7d                	push   $0x7d
  jmp alltraps
8010775b:	e9 10 f5 ff ff       	jmp    80106c70 <alltraps>
...
80107760:	6a 00                	push   $0x0
  pushl $126
80107762:	6a 7e                	push   $0x7e
  jmp alltraps
80107764:	e9 07 f5 ff ff       	jmp    80106c70 <alltraps>
...
80107769:	6a 00                	push   $0x0
  pushl $127
8010776b:	6a 7f                	push   $0x7f
  jmp alltraps
8010776d:	e9 fe f4 ff ff       	jmp    80106c70 <alltraps>
...
80107772:	6a 00                	push   $0x0
  pushl $128
80107774:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107779:	e9 f2 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010777e:	6a 00                	push   $0x0
  pushl $129
80107780:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107785:	e9 e6 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010778a:	6a 00                	push   $0x0
  pushl $130
8010778c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107791:	e9 da f4 ff ff       	jmp    80106c70 <alltraps>
...
80107796:	6a 00                	push   $0x0
  pushl $131
80107798:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010779d:	e9 ce f4 ff ff       	jmp    80106c70 <alltraps>
...
801077a2:	6a 00                	push   $0x0
  pushl $132
801077a4:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801077a9:	e9 c2 f4 ff ff       	jmp    80106c70 <alltraps>
...
801077ae:	6a 00                	push   $0x0
  pushl $133
801077b0:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801077b5:	e9 b6 f4 ff ff       	jmp    80106c70 <alltraps>
...
801077ba:	6a 00                	push   $0x0
  pushl $134
801077bc:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801077c1:	e9 aa f4 ff ff       	jmp    80106c70 <alltraps>
...
801077c6:	6a 00                	push   $0x0
  pushl $135
801077c8:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801077cd:	e9 9e f4 ff ff       	jmp    80106c70 <alltraps>
...
801077d2:	6a 00                	push   $0x0
  pushl $136
801077d4:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801077d9:	e9 92 f4 ff ff       	jmp    80106c70 <alltraps>
...
801077de:	6a 00                	push   $0x0
  pushl $137
801077e0:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801077e5:	e9 86 f4 ff ff       	jmp    80106c70 <alltraps>
...
801077ea:	6a 00                	push   $0x0
  pushl $138
801077ec:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801077f1:	e9 7a f4 ff ff       	jmp    80106c70 <alltraps>
...
801077f6:	6a 00                	push   $0x0
  pushl $139
801077f8:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801077fd:	e9 6e f4 ff ff       	jmp    80106c70 <alltraps>
...
80107802:	6a 00                	push   $0x0
  pushl $140
80107804:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107809:	e9 62 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010780e:	6a 00                	push   $0x0
  pushl $141
80107810:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107815:	e9 56 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010781a:	6a 00                	push   $0x0
  pushl $142
8010781c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107821:	e9 4a f4 ff ff       	jmp    80106c70 <alltraps>
...
80107826:	6a 00                	push   $0x0
  pushl $143
80107828:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010782d:	e9 3e f4 ff ff       	jmp    80106c70 <alltraps>
...
80107832:	6a 00                	push   $0x0
  pushl $144
80107834:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107839:	e9 32 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010783e:	6a 00                	push   $0x0
  pushl $145
80107840:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107845:	e9 26 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010784a:	6a 00                	push   $0x0
  pushl $146
8010784c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107851:	e9 1a f4 ff ff       	jmp    80106c70 <alltraps>
...
80107856:	6a 00                	push   $0x0
  pushl $147
80107858:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010785d:	e9 0e f4 ff ff       	jmp    80106c70 <alltraps>
...
80107862:	6a 00                	push   $0x0
  pushl $148
80107864:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107869:	e9 02 f4 ff ff       	jmp    80106c70 <alltraps>
...
8010786e:	6a 00                	push   $0x0
  pushl $149
80107870:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107875:	e9 f6 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010787a:	6a 00                	push   $0x0
  pushl $150
8010787c:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107881:	e9 ea f3 ff ff       	jmp    80106c70 <alltraps>
...
80107886:	6a 00                	push   $0x0
  pushl $151
80107888:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010788d:	e9 de f3 ff ff       	jmp    80106c70 <alltraps>
...
80107892:	6a 00                	push   $0x0
  pushl $152
80107894:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107899:	e9 d2 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010789e:	6a 00                	push   $0x0
  pushl $153
801078a0:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801078a5:	e9 c6 f3 ff ff       	jmp    80106c70 <alltraps>
...
801078aa:	6a 00                	push   $0x0
  pushl $154
801078ac:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801078b1:	e9 ba f3 ff ff       	jmp    80106c70 <alltraps>
...
801078b6:	6a 00                	push   $0x0
  pushl $155
801078b8:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801078bd:	e9 ae f3 ff ff       	jmp    80106c70 <alltraps>
...
801078c2:	6a 00                	push   $0x0
  pushl $156
801078c4:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801078c9:	e9 a2 f3 ff ff       	jmp    80106c70 <alltraps>
...
801078ce:	6a 00                	push   $0x0
  pushl $157
801078d0:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801078d5:	e9 96 f3 ff ff       	jmp    80106c70 <alltraps>
...
801078da:	6a 00                	push   $0x0
  pushl $158
801078dc:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801078e1:	e9 8a f3 ff ff       	jmp    80106c70 <alltraps>
...
801078e6:	6a 00                	push   $0x0
  pushl $159
801078e8:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801078ed:	e9 7e f3 ff ff       	jmp    80106c70 <alltraps>
...
801078f2:	6a 00                	push   $0x0
  pushl $160
801078f4:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801078f9:	e9 72 f3 ff ff       	jmp    80106c70 <alltraps>
...
801078fe:	6a 00                	push   $0x0
  pushl $161
80107900:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107905:	e9 66 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010790a:	6a 00                	push   $0x0
  pushl $162
8010790c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107911:	e9 5a f3 ff ff       	jmp    80106c70 <alltraps>
...
80107916:	6a 00                	push   $0x0
  pushl $163
80107918:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010791d:	e9 4e f3 ff ff       	jmp    80106c70 <alltraps>
...
80107922:	6a 00                	push   $0x0
  pushl $164
80107924:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107929:	e9 42 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010792e:	6a 00                	push   $0x0
  pushl $165
80107930:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107935:	e9 36 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010793a:	6a 00                	push   $0x0
  pushl $166
8010793c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107941:	e9 2a f3 ff ff       	jmp    80106c70 <alltraps>
...
80107946:	6a 00                	push   $0x0
  pushl $167
80107948:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010794d:	e9 1e f3 ff ff       	jmp    80106c70 <alltraps>
...
80107952:	6a 00                	push   $0x0
  pushl $168
80107954:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107959:	e9 12 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010795e:	6a 00                	push   $0x0
  pushl $169
80107960:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107965:	e9 06 f3 ff ff       	jmp    80106c70 <alltraps>
...
8010796a:	6a 00                	push   $0x0
  pushl $170
8010796c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107971:	e9 fa f2 ff ff       	jmp    80106c70 <alltraps>
...
80107976:	6a 00                	push   $0x0
  pushl $171
80107978:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010797d:	e9 ee f2 ff ff       	jmp    80106c70 <alltraps>
...
80107982:	6a 00                	push   $0x0
  pushl $172
80107984:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107989:	e9 e2 f2 ff ff       	jmp    80106c70 <alltraps>
...
8010798e:	6a 00                	push   $0x0
  pushl $173
80107990:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107995:	e9 d6 f2 ff ff       	jmp    80106c70 <alltraps>
...
8010799a:	6a 00                	push   $0x0
  pushl $174
8010799c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801079a1:	e9 ca f2 ff ff       	jmp    80106c70 <alltraps>
...
801079a6:	6a 00                	push   $0x0
  pushl $175
801079a8:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801079ad:	e9 be f2 ff ff       	jmp    80106c70 <alltraps>
...
801079b2:	6a 00                	push   $0x0
  pushl $176
801079b4:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801079b9:	e9 b2 f2 ff ff       	jmp    80106c70 <alltraps>
...
801079be:	6a 00                	push   $0x0
  pushl $177
801079c0:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801079c5:	e9 a6 f2 ff ff       	jmp    80106c70 <alltraps>
...
801079ca:	6a 00                	push   $0x0
  pushl $178
801079cc:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801079d1:	e9 9a f2 ff ff       	jmp    80106c70 <alltraps>
...
801079d6:	6a 00                	push   $0x0
  pushl $179
801079d8:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801079dd:	e9 8e f2 ff ff       	jmp    80106c70 <alltraps>
...
801079e2:	6a 00                	push   $0x0
  pushl $180
801079e4:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801079e9:	e9 82 f2 ff ff       	jmp    80106c70 <alltraps>
...
801079ee:	6a 00                	push   $0x0
  pushl $181
801079f0:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801079f5:	e9 76 f2 ff ff       	jmp    80106c70 <alltraps>
...
801079fa:	6a 00                	push   $0x0
  pushl $182
801079fc:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107a01:	e9 6a f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a06:	6a 00                	push   $0x0
  pushl $183
80107a08:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107a0d:	e9 5e f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a12:	6a 00                	push   $0x0
  pushl $184
80107a14:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107a19:	e9 52 f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a1e:	6a 00                	push   $0x0
  pushl $185
80107a20:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107a25:	e9 46 f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a2a:	6a 00                	push   $0x0
  pushl $186
80107a2c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107a31:	e9 3a f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a36:	6a 00                	push   $0x0
  pushl $187
80107a38:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107a3d:	e9 2e f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a42:	6a 00                	push   $0x0
  pushl $188
80107a44:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107a49:	e9 22 f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a4e:	6a 00                	push   $0x0
  pushl $189
80107a50:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107a55:	e9 16 f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a5a:	6a 00                	push   $0x0
  pushl $190
80107a5c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107a61:	e9 0a f2 ff ff       	jmp    80106c70 <alltraps>
...
80107a66:	6a 00                	push   $0x0
  pushl $191
80107a68:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107a6d:	e9 fe f1 ff ff       	jmp    80106c70 <alltraps>
...
80107a72:	6a 00                	push   $0x0
  pushl $192
80107a74:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107a79:	e9 f2 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107a7e:	6a 00                	push   $0x0
  pushl $193
80107a80:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107a85:	e9 e6 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107a8a:	6a 00                	push   $0x0
  pushl $194
80107a8c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107a91:	e9 da f1 ff ff       	jmp    80106c70 <alltraps>
...
80107a96:	6a 00                	push   $0x0
  pushl $195
80107a98:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107a9d:	e9 ce f1 ff ff       	jmp    80106c70 <alltraps>
...
80107aa2:	6a 00                	push   $0x0
  pushl $196
80107aa4:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107aa9:	e9 c2 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107aae:	6a 00                	push   $0x0
  pushl $197
80107ab0:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107ab5:	e9 b6 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107aba:	6a 00                	push   $0x0
  pushl $198
80107abc:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107ac1:	e9 aa f1 ff ff       	jmp    80106c70 <alltraps>
...
80107ac6:	6a 00                	push   $0x0
  pushl $199
80107ac8:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107acd:	e9 9e f1 ff ff       	jmp    80106c70 <alltraps>
...
80107ad2:	6a 00                	push   $0x0
  pushl $200
80107ad4:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107ad9:	e9 92 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107ade:	6a 00                	push   $0x0
  pushl $201
80107ae0:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107ae5:	e9 86 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107aea:	6a 00                	push   $0x0
  pushl $202
80107aec:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107af1:	e9 7a f1 ff ff       	jmp    80106c70 <alltraps>
...
80107af6:	6a 00                	push   $0x0
  pushl $203
80107af8:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107afd:	e9 6e f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b02:	6a 00                	push   $0x0
  pushl $204
80107b04:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107b09:	e9 62 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b0e:	6a 00                	push   $0x0
  pushl $205
80107b10:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107b15:	e9 56 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b1a:	6a 00                	push   $0x0
  pushl $206
80107b1c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107b21:	e9 4a f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b26:	6a 00                	push   $0x0
  pushl $207
80107b28:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107b2d:	e9 3e f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b32:	6a 00                	push   $0x0
  pushl $208
80107b34:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107b39:	e9 32 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b3e:	6a 00                	push   $0x0
  pushl $209
80107b40:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107b45:	e9 26 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b4a:	6a 00                	push   $0x0
  pushl $210
80107b4c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107b51:	e9 1a f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b56:	6a 00                	push   $0x0
  pushl $211
80107b58:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107b5d:	e9 0e f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b62:	6a 00                	push   $0x0
  pushl $212
80107b64:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107b69:	e9 02 f1 ff ff       	jmp    80106c70 <alltraps>
...
80107b6e:	6a 00                	push   $0x0
  pushl $213
80107b70:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107b75:	e9 f6 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107b7a:	6a 00                	push   $0x0
  pushl $214
80107b7c:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107b81:	e9 ea f0 ff ff       	jmp    80106c70 <alltraps>
...
80107b86:	6a 00                	push   $0x0
  pushl $215
80107b88:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107b8d:	e9 de f0 ff ff       	jmp    80106c70 <alltraps>
...
80107b92:	6a 00                	push   $0x0
  pushl $216
80107b94:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107b99:	e9 d2 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107b9e:	6a 00                	push   $0x0
  pushl $217
80107ba0:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107ba5:	e9 c6 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107baa:	6a 00                	push   $0x0
  pushl $218
80107bac:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107bb1:	e9 ba f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bb6:	6a 00                	push   $0x0
  pushl $219
80107bb8:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107bbd:	e9 ae f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bc2:	6a 00                	push   $0x0
  pushl $220
80107bc4:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107bc9:	e9 a2 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bce:	6a 00                	push   $0x0
  pushl $221
80107bd0:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107bd5:	e9 96 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bda:	6a 00                	push   $0x0
  pushl $222
80107bdc:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107be1:	e9 8a f0 ff ff       	jmp    80106c70 <alltraps>
...
80107be6:	6a 00                	push   $0x0
  pushl $223
80107be8:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107bed:	e9 7e f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bf2:	6a 00                	push   $0x0
  pushl $224
80107bf4:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107bf9:	e9 72 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107bfe:	6a 00                	push   $0x0
  pushl $225
80107c00:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107c05:	e9 66 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c0a:	6a 00                	push   $0x0
  pushl $226
80107c0c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107c11:	e9 5a f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c16:	6a 00                	push   $0x0
  pushl $227
80107c18:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107c1d:	e9 4e f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c22:	6a 00                	push   $0x0
  pushl $228
80107c24:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107c29:	e9 42 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c2e:	6a 00                	push   $0x0
  pushl $229
80107c30:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107c35:	e9 36 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c3a:	6a 00                	push   $0x0
  pushl $230
80107c3c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107c41:	e9 2a f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c46:	6a 00                	push   $0x0
  pushl $231
80107c48:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107c4d:	e9 1e f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c52:	6a 00                	push   $0x0
  pushl $232
80107c54:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107c59:	e9 12 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c5e:	6a 00                	push   $0x0
  pushl $233
80107c60:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107c65:	e9 06 f0 ff ff       	jmp    80106c70 <alltraps>
...
80107c6a:	6a 00                	push   $0x0
  pushl $234
80107c6c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107c71:	e9 fa ef ff ff       	jmp    80106c70 <alltraps>
...
80107c76:	6a 00                	push   $0x0
  pushl $235
80107c78:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107c7d:	e9 ee ef ff ff       	jmp    80106c70 <alltraps>
...
80107c82:	6a 00                	push   $0x0
  pushl $236
80107c84:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107c89:	e9 e2 ef ff ff       	jmp    80106c70 <alltraps>
...
80107c8e:	6a 00                	push   $0x0
  pushl $237
80107c90:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107c95:	e9 d6 ef ff ff       	jmp    80106c70 <alltraps>
...
80107c9a:	6a 00                	push   $0x0
  pushl $238
80107c9c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107ca1:	e9 ca ef ff ff       	jmp    80106c70 <alltraps>
...
80107ca6:	6a 00                	push   $0x0
  pushl $239
80107ca8:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107cad:	e9 be ef ff ff       	jmp    80106c70 <alltraps>
...
80107cb2:	6a 00                	push   $0x0
  pushl $240
80107cb4:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107cb9:	e9 b2 ef ff ff       	jmp    80106c70 <alltraps>
...
80107cbe:	6a 00                	push   $0x0
  pushl $241
80107cc0:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107cc5:	e9 a6 ef ff ff       	jmp    80106c70 <alltraps>
...
80107cca:	6a 00                	push   $0x0
  pushl $242
80107ccc:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107cd1:	e9 9a ef ff ff       	jmp    80106c70 <alltraps>
...
80107cd6:	6a 00                	push   $0x0
  pushl $243
80107cd8:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107cdd:	e9 8e ef ff ff       	jmp    80106c70 <alltraps>
...
80107ce2:	6a 00                	push   $0x0
  pushl $244
80107ce4:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107ce9:	e9 82 ef ff ff       	jmp    80106c70 <alltraps>
...
80107cee:	6a 00                	push   $0x0
  pushl $245
80107cf0:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107cf5:	e9 76 ef ff ff       	jmp    80106c70 <alltraps>
...
80107cfa:	6a 00                	push   $0x0
  pushl $246
80107cfc:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107d01:	e9 6a ef ff ff       	jmp    80106c70 <alltraps>
...
80107d06:	6a 00                	push   $0x0
  pushl $247
80107d08:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107d0d:	e9 5e ef ff ff       	jmp    80106c70 <alltraps>
...
80107d12:	6a 00                	push   $0x0
  pushl $248
80107d14:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107d19:	e9 52 ef ff ff       	jmp    80106c70 <alltraps>
...
80107d1e:	6a 00                	push   $0x0
  pushl $249
80107d20:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107d25:	e9 46 ef ff ff       	jmp    80106c70 <alltraps>
...
80107d2a:	6a 00                	push   $0x0
  pushl $250
80107d2c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107d31:	e9 3a ef ff ff       	jmp    80106c70 <alltraps>
...
80107d36:	6a 00                	push   $0x0
  pushl $251
80107d38:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107d3d:	e9 2e ef ff ff       	jmp    80106c70 <alltraps>
...
80107d42:	6a 00                	push   $0x0
  pushl $252
80107d44:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107d49:	e9 22 ef ff ff       	jmp    80106c70 <alltraps>
...
80107d4e:	6a 00                	push   $0x0
  pushl $253
80107d50:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107d55:	e9 16 ef ff ff       	jmp    80106c70 <alltraps>
...
80107d5a:	6a 00                	push   $0x0
  pushl $254
80107d5c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107d61:	e9 0a ef ff ff       	jmp    80106c70 <alltraps>
...
80107d66:	6a 00                	push   $0x0
  pushl $255
80107d68:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107d6d:	e9 fe ee ff ff       	jmp    80106c70 <alltraps>
	...
...
80107d77:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107d7a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d7d:	83 e8 01             	sub    $0x1,%eax
80107d80:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107d84:	8b 45 08             	mov    0x8(%ebp),%eax
80107d87:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107d8b:	8b 45 08             	mov    0x8(%ebp),%eax
80107d8e:	c1 e8 10             	shr    $0x10,%eax
80107d91:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107d95:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107d98:	0f 01 10             	lgdtl  (%eax)
}
80107d9b:	c9                   	leave  
80107d9c:	c3                   	ret    
...
80107da6:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107daa:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107dae:	0f 00 d8             	ltr    %ax
}
80107db1:	c9                   	leave  
80107db2:	c3                   	ret    
...
80107db6:	83 ec 04             	sub    $0x4,%esp
80107db9:	8b 45 08             	mov    0x8(%ebp),%eax
80107dbc:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107dc0:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107dc4:	8e e8                	mov    %eax,%gs
}
80107dc6:	c9                   	leave  
80107dc7:	c3                   	ret    
...
80107dd9:	05 00 00 00 80       	add    $0x80000000,%eax
80107dde:	5d                   	pop    %ebp
80107ddf:	c3                   	ret    
...
80107df1:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107df4:	e8 94 b0 ff ff       	call   80102e8d <cpunum>
80107df9:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107dff:	05 40 09 11 80       	add    $0x80110940,%eax
80107e04:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107e07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e0a:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107e10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e13:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107e19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e1c:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e23:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107e27:	83 e2 f0             	and    $0xfffffff0,%edx
80107e2a:	83 ca 0a             	or     $0xa,%edx
80107e2d:	88 50 7d             	mov    %dl,0x7d(%eax)
80107e30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e33:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107e37:	83 ca 10             	or     $0x10,%edx
80107e3a:	88 50 7d             	mov    %dl,0x7d(%eax)
80107e3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e40:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107e44:	83 e2 9f             	and    $0xffffff9f,%edx
80107e47:	88 50 7d             	mov    %dl,0x7d(%eax)
80107e4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e4d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107e51:	83 ca 80             	or     $0xffffff80,%edx
80107e54:	88 50 7d             	mov    %dl,0x7d(%eax)
80107e57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e5a:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107e5e:	83 ca 0f             	or     $0xf,%edx
80107e61:	88 50 7e             	mov    %dl,0x7e(%eax)
80107e64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e67:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107e6b:	83 e2 ef             	and    $0xffffffef,%edx
80107e6e:	88 50 7e             	mov    %dl,0x7e(%eax)
80107e71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e74:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107e78:	83 e2 df             	and    $0xffffffdf,%edx
80107e7b:	88 50 7e             	mov    %dl,0x7e(%eax)
80107e7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e81:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107e85:	83 ca 40             	or     $0x40,%edx
80107e88:	88 50 7e             	mov    %dl,0x7e(%eax)
80107e8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e8e:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107e92:	83 ca 80             	or     $0xffffff80,%edx
80107e95:	88 50 7e             	mov    %dl,0x7e(%eax)
80107e98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9b:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107e9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea2:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107ea9:	ff ff 
80107eab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eae:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107eb5:	00 00 
80107eb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eba:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107ec1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec4:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107ecb:	83 e2 f0             	and    $0xfffffff0,%edx
80107ece:	83 ca 02             	or     $0x2,%edx
80107ed1:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107ed7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eda:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107ee1:	83 ca 10             	or     $0x10,%edx
80107ee4:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107eea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eed:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107ef4:	83 e2 9f             	and    $0xffffff9f,%edx
80107ef7:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107efd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f00:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107f07:	83 ca 80             	or     $0xffffff80,%edx
80107f0a:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107f10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f13:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107f1a:	83 ca 0f             	or     $0xf,%edx
...
80107f2d:	83 e2 ef             	and    $0xffffffef,%edx
80107f30:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107f36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f39:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107f40:	83 e2 df             	and    $0xffffffdf,%edx
80107f43:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107f49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f4c:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107f53:	83 ca 40             	or     $0x40,%edx
80107f56:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
...
80107f72:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107f79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f7c:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107f83:	ff ff 
80107f85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f88:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107f8f:	00 00 
80107f91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f94:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107f9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
...
80107fb4:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107fbb:	83 ca 10             	or     $0x10,%edx
80107fbe:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107fc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc7:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107fce:	83 ca 60             	or     $0x60,%edx
80107fd1:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107fd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fda:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107fe1:	83 ca 80             	or     $0xffffff80,%edx
80107fe4:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107fea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fed:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107ff4:	83 ca 0f             	or     $0xf,%edx
...
80108007:	83 e2 ef             	and    $0xffffffef,%edx
8010800a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108010:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108013:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010801a:	83 e2 df             	and    $0xffffffdf,%edx
8010801d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108023:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108026:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010802d:	83 ca 40             	or     $0x40,%edx
80108030:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108039:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108040:	83 ca 80             	or     $0xffffff80,%edx
80108043:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108049:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804c:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108053:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108056:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
8010805d:	ff ff 
8010805f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108062:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108069:	00 00 
8010806b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806e:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80108075:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108078:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010807f:	83 e2 f0             	and    $0xfffffff0,%edx
80108082:	83 ca 02             	or     $0x2,%edx
80108085:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010808b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010808e:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108095:	83 ca 10             	or     $0x10,%edx
80108098:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010809e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a1:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801080a8:	83 ca 60             	or     $0x60,%edx
801080ab:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801080b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b4:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801080bb:	83 ca 80             	or     $0xffffff80,%edx
801080be:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801080c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c7:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801080ce:	83 ca 0f             	or     $0xf,%edx
...
801080e1:	83 e2 ef             	and    $0xffffffef,%edx
801080e4:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801080ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ed:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801080f4:	83 e2 df             	and    $0xffffffdf,%edx
801080f7:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801080fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108100:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108107:	83 ca 40             	or     $0x40,%edx
8010810a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108113:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010811a:	83 ca 80             	or     $0xffffff80,%edx
8010811d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108123:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108126:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010812d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108130:	05 b4 00 00 00       	add    $0xb4,%eax
80108135:	89 c3                	mov    %eax,%ebx
80108137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813a:	05 b4 00 00 00       	add    $0xb4,%eax
8010813f:	c1 e8 10             	shr    $0x10,%eax
80108142:	89 c1                	mov    %eax,%ecx
80108144:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108147:	05 b4 00 00 00       	add    $0xb4,%eax
8010814c:	c1 e8 18             	shr    $0x18,%eax
8010814f:	89 c2                	mov    %eax,%edx
80108151:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108154:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
8010815b:	00 00 
8010815d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108160:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80108167:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816a:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108170:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108173:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010817a:	83 e1 f0             	and    $0xfffffff0,%ecx
8010817d:	83 c9 02             	or     $0x2,%ecx
80108180:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108186:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108189:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108190:	83 c9 10             	or     $0x10,%ecx
80108193:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108199:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819c:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801081a3:	83 e1 9f             	and    $0xffffff9f,%ecx
801081a6:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801081ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081af:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801081b6:	83 c9 80             	or     $0xffffff80,%ecx
801081b9:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801081bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c2:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801081c9:	83 e1 f0             	and    $0xfffffff0,%ecx
...
801081e8:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801081ef:	83 e1 df             	and    $0xffffffdf,%ecx
801081f2:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801081f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081fb:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108202:	83 c9 40             	or     $0x40,%ecx
80108205:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010820b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010820e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108215:	83 c9 80             	or     $0xffffff80,%ecx
80108218:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010821e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108221:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108227:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010822a:	83 c0 70             	add    $0x70,%eax
8010822d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108234:	00 
80108235:	89 04 24             	mov    %eax,(%esp)
80108238:	e8 37 fb ff ff       	call   80107d74 <lgdt>
  loadgs(SEG_KCPU << 3);
8010823d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108244:	e8 6a fb ff ff       	call   80107db3 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108249:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010824c:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80108252:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108259:	00 00 00 00 
}
8010825d:	83 c4 24             	add    $0x24,%esp
80108260:	5b                   	pop    %ebx
80108261:	5d                   	pop    %ebp
80108262:	c3                   	ret    
...
80108266:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80108269:	8b 45 0c             	mov    0xc(%ebp),%eax
8010826c:	c1 e8 16             	shr    $0x16,%eax
8010826f:	c1 e0 02             	shl    $0x2,%eax
80108272:	03 45 08             	add    0x8(%ebp),%eax
...
80108280:	84 c0                	test   %al,%al
80108282:	74 17                	je     8010829b <walkpgdir+0x38>
...
80108291:	e8 4a fb ff ff       	call   80107de0 <p2v>
80108296:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108299:	eb 4b                	jmp    801082e6 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010829b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010829f:	74 0e                	je     801082af <walkpgdir+0x4c>
801082a1:	e8 59 a8 ff ff       	call   80102aff <kalloc>
801082a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801082a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801082ad:	75 07                	jne    801082b6 <walkpgdir+0x53>
      return 0;
801082af:	b8 00 00 00 00       	mov    $0x0,%eax
801082b4:	eb 41                	jmp    801082f7 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801082b6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082bd:	00 
801082be:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801082c5:	00 
801082c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c9:	89 04 24             	mov    %eax,(%esp)
801082cc:	e8 f1 d3 ff ff       	call   801056c2 <memset>
...
801082d7:	e8 f7 fa ff ff       	call   80107dd3 <v2p>
801082dc:	89 c2                	mov    %eax,%edx
801082de:	83 ca 07             	or     $0x7,%edx
801082e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082e4:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801082e6:	8b 45 0c             	mov    0xc(%ebp),%eax
801082e9:	c1 e8 0c             	shr    $0xc,%eax
801082ec:	25 ff 03 00 00       	and    $0x3ff,%eax
801082f1:	c1 e0 02             	shl    $0x2,%eax
801082f4:	03 45 f4             	add    -0xc(%ebp),%eax
}
801082f7:	c9                   	leave  
801082f8:	c3                   	ret    
...
8010830d:	03 45 10             	add    0x10(%ebp),%eax
80108310:	83 e8 01             	sub    $0x1,%eax
80108313:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108318:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010831b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108322:	00 
...
80108330:	e8 2e ff ff ff       	call   80108263 <walkpgdir>
80108335:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108338:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010833c:	75 07                	jne    80108345 <mappages+0x4c>
      return -1;
8010833e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108343:	eb 46                	jmp    8010838b <mappages+0x92>
    if(*pte & PTE_P)
80108345:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108348:	8b 00                	mov    (%eax),%eax
8010834a:	83 e0 01             	and    $0x1,%eax
8010834d:	84 c0                	test   %al,%al
8010834f:	74 0c                	je     8010835d <mappages+0x64>
      panic("remap");
80108351:	c7 04 24 ec 91 10 80 	movl   $0x801091ec,(%esp)
80108358:	e8 e0 81 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
8010835d:	8b 45 18             	mov    0x18(%ebp),%eax
80108360:	0b 45 14             	or     0x14(%ebp),%eax
80108363:	89 c2                	mov    %eax,%edx
80108365:	83 ca 01             	or     $0x1,%edx
80108368:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010836b:	89 10                	mov    %edx,(%eax)
    if(a == last)
8010836d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108370:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108373:	74 10                	je     80108385 <mappages+0x8c>
      break;
    a += PGSIZE;
80108375:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
8010837c:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108383:	eb 96                	jmp    8010831b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108391:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108394:	e8 66 a7 ff ff       	call   80102aff <kalloc>
80108399:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010839c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801083a0:	75 0a                	jne    801083ac <setupkvm+0x1f>
    return 0;
801083a2:	b8 00 00 00 00       	mov    $0x0,%eax
801083a7:	e9 98 00 00 00       	jmp    80108444 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801083ac:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083b3:	00 
801083b4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801083bb:	00 
801083bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083bf:	89 04 24             	mov    %eax,(%esp)
801083c2:	e8 fb d2 ff ff       	call   801056c2 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
801083c7:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
801083ce:	e8 0d fa ff ff       	call   80107de0 <p2v>
801083d3:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
801083d8:	76 0c                	jbe    801083e6 <setupkvm+0x59>
    panic("PHYSTOP too high");
801083da:	c7 04 24 f2 91 10 80 	movl   $0x801091f2,(%esp)
801083e1:	e8 57 81 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801083e6:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
801083ed:	eb 49                	jmp    80108438 <setupkvm+0xab>
...
801083ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801083f2:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
801083f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801083f8:	8b 50 04             	mov    0x4(%eax),%edx
801083fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fe:	8b 58 08             	mov    0x8(%eax),%ebx
80108401:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108404:	8b 40 04             	mov    0x4(%eax),%eax
80108407:	29 c3                	sub    %eax,%ebx
80108409:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010840c:	8b 00                	mov    (%eax),%eax
8010840e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108412:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108416:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010841a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010841e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108421:	89 04 24             	mov    %eax,(%esp)
80108424:	e8 d0 fe ff ff       	call   801082f9 <mappages>
80108429:	85 c0                	test   %eax,%eax
8010842b:	79 07                	jns    80108434 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010842d:	b8 00 00 00 00       	mov    $0x0,%eax
80108432:	eb 10                	jmp    80108444 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108434:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108438:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
8010843f:	72 ae                	jb     801083ef <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80108444:	83 c4 34             	add    $0x34,%esp
80108447:	5b                   	pop    %ebx
80108448:	5d                   	pop    %ebp
80108449:	c3                   	ret    
...
8010844d:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108450:	e8 38 ff ff ff       	call   8010838d <setupkvm>
80108455:	a3 58 5c 11 80       	mov    %eax,0x80115c58
  switchkvm();
8010845a:	e8 02 00 00 00       	call   80108461 <switchkvm>
}
8010845f:	c9                   	leave  
80108460:	c3                   	ret    
...
80108467:	a1 58 5c 11 80       	mov    0x80115c58,%eax
8010846c:	89 04 24             	mov    %eax,(%esp)
8010846f:	e8 5f f9 ff ff       	call   80107dd3 <v2p>
80108474:	89 04 24             	mov    %eax,(%esp)
80108477:	e8 4c f9 ff ff       	call   80107dc8 <lcr3>
}
8010847c:	c9                   	leave  
8010847d:	c3                   	ret    
...
80108482:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108485:	e8 31 d1 ff ff       	call   801055bb <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010848a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108490:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108497:	83 c2 08             	add    $0x8,%edx
8010849a:	89 d3                	mov    %edx,%ebx
8010849c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801084a3:	83 c2 08             	add    $0x8,%edx
801084a6:	c1 ea 10             	shr    $0x10,%edx
801084a9:	89 d1                	mov    %edx,%ecx
801084ab:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801084b2:	83 c2 08             	add    $0x8,%edx
801084b5:	c1 ea 18             	shr    $0x18,%edx
801084b8:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
801084bf:	67 00 
801084c1:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
801084c8:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
801084ce:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801084d5:	83 e1 f0             	and    $0xfffffff0,%ecx
801084d8:	83 c9 09             	or     $0x9,%ecx
801084db:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801084e1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801084e8:	83 c9 10             	or     $0x10,%ecx
801084eb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801084f1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801084f8:	83 e1 9f             	and    $0xffffff9f,%ecx
801084fb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108501:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108508:	83 c9 80             	or     $0xffffff80,%ecx
8010850b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108511:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108518:	83 e1 f0             	and    $0xfffffff0,%ecx
8010851b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108521:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108528:	83 e1 ef             	and    $0xffffffef,%ecx
8010852b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108531:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108538:	83 e1 df             	and    $0xffffffdf,%ecx
8010853b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108541:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108548:	83 c9 40             	or     $0x40,%ecx
8010854b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108551:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108558:	83 e1 7f             	and    $0x7f,%ecx
8010855b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108561:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80108567:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010856d:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80108574:	83 e2 ef             	and    $0xffffffef,%edx
80108577:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
8010857d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108583:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80108589:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010858f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80108596:	8b 52 08             	mov    0x8(%edx),%edx
80108599:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010859f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
801085a2:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801085a9:	e8 ef f7 ff ff       	call   80107d9d <ltr>
  if(p->pgdir == 0)
801085ae:	8b 45 08             	mov    0x8(%ebp),%eax
801085b1:	8b 40 04             	mov    0x4(%eax),%eax
801085b4:	85 c0                	test   %eax,%eax
801085b6:	75 0c                	jne    801085c4 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801085b8:	c7 04 24 03 92 10 80 	movl   $0x80109203,(%esp)
801085bf:	e8 79 7f ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
801085c4:	8b 45 08             	mov    0x8(%ebp),%eax
801085c7:	8b 40 04             	mov    0x4(%eax),%eax
801085ca:	89 04 24             	mov    %eax,(%esp)
801085cd:	e8 01 f8 ff ff       	call   80107dd3 <v2p>
801085d2:	89 04 24             	mov    %eax,(%esp)
801085d5:	e8 ee f7 ff ff       	call   80107dc8 <lcr3>
  popcli();
801085da:	e8 24 d0 ff ff       	call   80105603 <popcli>
}
801085df:	83 c4 14             	add    $0x14,%esp
801085e2:	5b                   	pop    %ebx
801085e3:	5d                   	pop    %ebp
801085e4:	c3                   	ret    
...
801085e8:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801085eb:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801085f2:	76 0c                	jbe    80108600 <inituvm+0x1b>
    panic("inituvm: more than a page");
801085f4:	c7 04 24 17 92 10 80 	movl   $0x80109217,(%esp)
801085fb:	e8 3d 7f ff ff       	call   8010053d <panic>
  mem = kalloc();
80108600:	e8 fa a4 ff ff       	call   80102aff <kalloc>
80108605:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
...
8010861e:	e8 9f d0 ff ff       	call   801056c2 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108623:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108626:	89 04 24             	mov    %eax,(%esp)
80108629:	e8 a5 f7 ff ff       	call   80107dd3 <v2p>
8010862e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108635:	00 
80108636:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010863a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108641:	00 
80108642:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108649:	00 
8010864a:	8b 45 08             	mov    0x8(%ebp),%eax
8010864d:	89 04 24             	mov    %eax,(%esp)
80108650:	e8 a4 fc ff ff       	call   801082f9 <mappages>
  memmove(mem, init, sz);
80108655:	8b 45 10             	mov    0x10(%ebp),%eax
...
80108669:	e8 27 d1 ff ff       	call   80105795 <memmove>
}
8010866e:	c9                   	leave  
8010866f:	c3                   	ret    
...
80108674:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80108677:	8b 45 0c             	mov    0xc(%ebp),%eax
8010867a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010867f:	85 c0                	test   %eax,%eax
80108681:	74 0c                	je     8010868f <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108683:	c7 04 24 34 92 10 80 	movl   $0x80109234,(%esp)
8010868a:	e8 ae 7e ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
8010868f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108696:	e9 ad 00 00 00       	jmp    80108748 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010869b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010869e:	8b 55 0c             	mov    0xc(%ebp),%edx
801086a1:	01 d0                	add    %edx,%eax
801086a3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801086aa:	00 
801086ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801086af:	8b 45 08             	mov    0x8(%ebp),%eax
801086b2:	89 04 24             	mov    %eax,(%esp)
801086b5:	e8 a9 fb ff ff       	call   80108263 <walkpgdir>
801086ba:	89 45 ec             	mov    %eax,-0x14(%ebp)
801086bd:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801086c1:	75 0c                	jne    801086cf <loaduvm+0x5f>
      panic("loaduvm: address should exist");
801086c3:	c7 04 24 57 92 10 80 	movl   $0x80109257,(%esp)
801086ca:	e8 6e 7e ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801086cf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801086d2:	8b 00                	mov    (%eax),%eax
801086d4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086d9:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
801086dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086df:	8b 55 18             	mov    0x18(%ebp),%edx
801086e2:	89 d1                	mov    %edx,%ecx
801086e4:	29 c1                	sub    %eax,%ecx
801086e6:	89 c8                	mov    %ecx,%eax
801086e8:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801086ed:	77 11                	ja     80108700 <loaduvm+0x90>
      n = sz - i;
801086ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086f2:	8b 55 18             	mov    0x18(%ebp),%edx
801086f5:	89 d1                	mov    %edx,%ecx
801086f7:	29 c1                	sub    %eax,%ecx
801086f9:	89 c8                	mov    %ecx,%eax
801086fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801086fe:	eb 07                	jmp    80108707 <loaduvm+0x97>
    else
      n = PGSIZE;
80108700:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108707:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010870a:	8b 55 14             	mov    0x14(%ebp),%edx
8010870d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108710:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108713:	89 04 24             	mov    %eax,(%esp)
80108716:	e8 c5 f6 ff ff       	call   80107de0 <p2v>
8010871b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010871e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108722:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108726:	89 44 24 04          	mov    %eax,0x4(%esp)
8010872a:	8b 45 10             	mov    0x10(%ebp),%eax
8010872d:	89 04 24             	mov    %eax,(%esp)
80108730:	e8 29 96 ff ff       	call   80101d5e <readi>
80108735:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108738:	74 07                	je     80108741 <loaduvm+0xd1>
      return -1;
8010873a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010873f:	eb 18                	jmp    80108759 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
8010874b:	3b 45 18             	cmp    0x18(%ebp),%eax
8010874e:	0f 82 47 ff ff ff    	jb     8010869b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108759:	83 c4 24             	add    $0x24,%esp
8010875c:	5b                   	pop    %ebx
8010875d:	5d                   	pop    %ebp
8010875e:	c3                   	ret    
...
8010876a:	79 0a                	jns    80108776 <allocuvm+0x17>
    return 0;
8010876c:	b8 00 00 00 00       	mov    $0x0,%eax
80108771:	e9 c1 00 00 00       	jmp    80108837 <allocuvm+0xd8>
  if(newsz < oldsz)
80108776:	8b 45 10             	mov    0x10(%ebp),%eax
80108779:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010877c:	73 08                	jae    80108786 <allocuvm+0x27>
    return oldsz;
8010877e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108781:	e9 b1 00 00 00       	jmp    80108837 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108786:	8b 45 0c             	mov    0xc(%ebp),%eax
80108789:	05 ff 0f 00 00       	add    $0xfff,%eax
8010878e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108793:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108796:	e9 8d 00 00 00       	jmp    80108828 <allocuvm+0xc9>
    mem = kalloc();
8010879b:	e8 5f a3 ff ff       	call   80102aff <kalloc>
801087a0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801087a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801087a7:	75 2c                	jne    801087d5 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801087a9:	c7 04 24 75 92 10 80 	movl   $0x80109275,(%esp)
801087b0:	e8 ec 7b ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801087b5:	8b 45 0c             	mov    0xc(%ebp),%eax
801087b8:	89 44 24 08          	mov    %eax,0x8(%esp)
801087bc:	8b 45 10             	mov    0x10(%ebp),%eax
801087bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801087c3:	8b 45 08             	mov    0x8(%ebp),%eax
801087c6:	89 04 24             	mov    %eax,(%esp)
801087c9:	e8 6b 00 00 00       	call   80108839 <deallocuvm>
      return 0;
801087ce:	b8 00 00 00 00       	mov    $0x0,%eax
801087d3:	eb 62                	jmp    80108837 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
801087d5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087dc:	00 
801087dd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801087e4:	00 
801087e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087e8:	89 04 24             	mov    %eax,(%esp)
801087eb:	e8 d2 ce ff ff       	call   801056c2 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801087f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087f3:	89 04 24             	mov    %eax,(%esp)
801087f6:	e8 d8 f5 ff ff       	call   80107dd3 <v2p>
801087fb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801087fe:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108805:	00 
80108806:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010880a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108811:	00 
80108812:	89 54 24 04          	mov    %edx,0x4(%esp)
80108816:	8b 45 08             	mov    0x8(%ebp),%eax
80108819:	89 04 24             	mov    %eax,(%esp)
8010881c:	e8 d8 fa ff ff       	call   801082f9 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
8010882b:	3b 45 10             	cmp    0x10(%ebp),%eax
8010882e:	0f 82 67 ff ff ff    	jb     8010879b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
80108834:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108837:	c9                   	leave  
80108838:	c3                   	ret    
...
8010883c:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80108845:	72 08                	jb     8010884f <deallocuvm+0x16>
    return oldsz;
80108847:	8b 45 0c             	mov    0xc(%ebp),%eax
8010884a:	e9 a4 00 00 00       	jmp    801088f3 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
8010884f:	8b 45 10             	mov    0x10(%ebp),%eax
80108852:	05 ff 0f 00 00       	add    $0xfff,%eax
80108857:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010885c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010885f:	e9 80 00 00 00       	jmp    801088e4 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108864:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108867:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010886e:	00 
8010886f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108873:	8b 45 08             	mov    0x8(%ebp),%eax
80108876:	89 04 24             	mov    %eax,(%esp)
80108879:	e8 e5 f9 ff ff       	call   80108263 <walkpgdir>
8010887e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108881:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108885:	75 09                	jne    80108890 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108887:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010888e:	eb 4d                	jmp    801088dd <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108890:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108893:	8b 00                	mov    (%eax),%eax
80108895:	83 e0 01             	and    $0x1,%eax
80108898:	84 c0                	test   %al,%al
8010889a:	74 41                	je     801088dd <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010889c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010889f:	8b 00                	mov    (%eax),%eax
801088a1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088a6:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801088a9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801088ad:	75 0c                	jne    801088bb <deallocuvm+0x82>
        panic("kfree");
801088af:	c7 04 24 8d 92 10 80 	movl   $0x8010928d,(%esp)
801088b6:	e8 82 7c ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
801088bb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801088be:	89 04 24             	mov    %eax,(%esp)
801088c1:	e8 1a f5 ff ff       	call   80107de0 <p2v>
801088c6:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801088c9:	8b 45 e8             	mov    -0x18(%ebp),%eax
801088cc:	89 04 24             	mov    %eax,(%esp)
801088cf:	e8 92 a1 ff ff       	call   80102a66 <kfree>
      *pte = 0;
...
801088d7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801088dd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801088e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088e7:	3b 45 0c             	cmp    0xc(%ebp),%eax
801088ea:	0f 82 74 ff ff ff    	jb     80108864 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801088f8:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801088fb:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801088ff:	75 0c                	jne    8010890d <freevm+0x18>
    panic("freevm: no pgdir");
80108901:	c7 04 24 93 92 10 80 	movl   $0x80109293,(%esp)
80108908:	e8 30 7c ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010890d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108914:	00 
80108915:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010891c:	80 
8010891d:	8b 45 08             	mov    0x8(%ebp),%eax
80108920:	89 04 24             	mov    %eax,(%esp)
80108923:	e8 11 ff ff ff       	call   80108839 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108928:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010892f:	eb 3c                	jmp    8010896d <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108931:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108934:	c1 e0 02             	shl    $0x2,%eax
80108937:	03 45 08             	add    0x8(%ebp),%eax
8010893a:	8b 00                	mov    (%eax),%eax
8010893c:	83 e0 01             	and    $0x1,%eax
8010893f:	84 c0                	test   %al,%al
80108941:	74 26                	je     80108969 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108943:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108946:	c1 e0 02             	shl    $0x2,%eax
80108949:	03 45 08             	add    0x8(%ebp),%eax
8010894c:	8b 00                	mov    (%eax),%eax
8010894e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108953:	89 04 24             	mov    %eax,(%esp)
80108956:	e8 85 f4 ff ff       	call   80107de0 <p2v>
8010895b:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010895e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108961:	89 04 24             	mov    %eax,(%esp)
80108964:	e8 fd a0 ff ff       	call   80102a66 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108969:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010896d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108974:	76 bb                	jbe    80108931 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010897c:	e8 e5 a0 ff ff       	call   80102a66 <kfree>
}
80108981:	c9                   	leave  
80108982:	c3                   	ret    
...
80108986:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108989:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108990:	00 
80108991:	8b 45 0c             	mov    0xc(%ebp),%eax
80108994:	89 44 24 04          	mov    %eax,0x4(%esp)
80108998:	8b 45 08             	mov    0x8(%ebp),%eax
8010899b:	89 04 24             	mov    %eax,(%esp)
8010899e:	e8 c0 f8 ff ff       	call   80108263 <walkpgdir>
801089a3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801089a6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801089aa:	75 0c                	jne    801089b8 <clearpteu+0x35>
    panic("clearpteu");
801089ac:	c7 04 24 a4 92 10 80 	movl   $0x801092a4,(%esp)
801089b3:	e8 85 7b ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
801089b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089bb:	8b 00                	mov    (%eax),%eax
801089bd:	89 c2                	mov    %eax,%edx
801089bf:	83 e2 fb             	and    $0xfffffffb,%edx
...
801089cc:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801089cf:	e8 b9 f9 ff ff       	call   8010838d <setupkvm>
801089d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801089d7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801089db:	75 0a                	jne    801089e7 <copyuvm+0x1e>
    return 0;
801089dd:	b8 00 00 00 00       	mov    $0x0,%eax
801089e2:	e9 f1 00 00 00       	jmp    80108ad8 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
801089e7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801089ee:	e9 c0 00 00 00       	jmp    80108ab3 <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801089f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089f6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089fd:	00 
801089fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a02:	8b 45 08             	mov    0x8(%ebp),%eax
80108a05:	89 04 24             	mov    %eax,(%esp)
80108a08:	e8 56 f8 ff ff       	call   80108263 <walkpgdir>
80108a0d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108a10:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a14:	75 0c                	jne    80108a22 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108a16:	c7 04 24 ae 92 10 80 	movl   $0x801092ae,(%esp)
...
80108a2c:	75 0c                	jne    80108a3a <copyuvm+0x71>
      panic("copyuvm: page not present");
80108a2e:	c7 04 24 c8 92 10 80 	movl   $0x801092c8,(%esp)
80108a35:	e8 03 7b ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80108a3a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a3d:	8b 00                	mov    (%eax),%eax
80108a3f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a44:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
80108a47:	e8 b3 a0 ff ff       	call   80102aff <kalloc>
80108a4c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108a4f:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80108a53:	74 6f                	je     80108ac4 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108a55:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a58:	89 04 24             	mov    %eax,(%esp)
80108a5b:	e8 80 f3 ff ff       	call   80107de0 <p2v>
80108a60:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a67:	00 
80108a68:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a6c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108a6f:	89 04 24             	mov    %eax,(%esp)
80108a72:	e8 1e cd ff ff       	call   80105795 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
80108a77:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108a7a:	89 04 24             	mov    %eax,(%esp)
80108a7d:	e8 51 f3 ff ff       	call   80107dd3 <v2p>
80108a82:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a85:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108a8c:	00 
80108a8d:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108a91:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a98:	00 
80108a99:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108aa0:	89 04 24             	mov    %eax,(%esp)
80108aa3:	e8 51 f8 ff ff       	call   801082f9 <mappages>
80108aa8:	85 c0                	test   %eax,%eax
80108aaa:	78 1b                	js     80108ac7 <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108aac:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108ab3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ab6:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108ab9:	0f 82 34 ff ff ff    	jb     801089f3 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108ac2:	eb 14                	jmp    80108ad8 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108ac4:	90                   	nop
80108ac5:	eb 01                	jmp    80108ac8 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108ac7:	90                   	nop
...
80108ace:	e8 22 fe ff ff       	call   801088f5 <freevm>
  return 0;
...
80108add:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108ae0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ae7:	00 
80108ae8:	8b 45 0c             	mov    0xc(%ebp),%eax
80108aeb:	89 44 24 04          	mov    %eax,0x4(%esp)
80108aef:	8b 45 08             	mov    0x8(%ebp),%eax
80108af2:	89 04 24             	mov    %eax,(%esp)
80108af5:	e8 69 f7 ff ff       	call   80108263 <walkpgdir>
80108afa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108afd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b00:	8b 00                	mov    (%eax),%eax
80108b02:	83 e0 01             	and    $0x1,%eax
80108b05:	85 c0                	test   %eax,%eax
80108b07:	75 07                	jne    80108b10 <uva2ka+0x36>
    return 0;
80108b09:	b8 00 00 00 00       	mov    $0x0,%eax
80108b0e:	eb 25                	jmp    80108b35 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108b10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b13:	8b 00                	mov    (%eax),%eax
80108b15:	83 e0 04             	and    $0x4,%eax
80108b18:	85 c0                	test   %eax,%eax
80108b1a:	75 07                	jne    80108b23 <uva2ka+0x49>
    return 0;
80108b1c:	b8 00 00 00 00       	mov    $0x0,%eax
80108b21:	eb 12                	jmp    80108b35 <uva2ka+0x5b>
...
80108b30:	e8 ab f2 ff ff       	call   80107de0 <p2v>
}
80108b35:	c9                   	leave  
80108b36:	c3                   	ret    
...
80108b3a:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108b40:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108b43:	e9 8b 00 00 00       	jmp    80108bd3 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108b48:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b4b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b50:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108b53:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b56:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b5a:	8b 45 08             	mov    0x8(%ebp),%eax
80108b5d:	89 04 24             	mov    %eax,(%esp)
80108b60:	e8 75 ff ff ff       	call   80108ada <uva2ka>
80108b65:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108b68:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108b6c:	75 07                	jne    80108b75 <copyout+0x3e>
      return -1;
80108b6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108b73:	eb 6d                	jmp    80108be2 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108b75:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b78:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108b7b:	89 d1                	mov    %edx,%ecx
80108b7d:	29 c1                	sub    %eax,%ecx
80108b7f:	89 c8                	mov    %ecx,%eax
80108b81:	05 00 10 00 00       	add    $0x1000,%eax
80108b86:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108b89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b8c:	3b 45 14             	cmp    0x14(%ebp),%eax
80108b8f:	76 06                	jbe    80108b97 <copyout+0x60>
      n = len;
80108b91:	8b 45 14             	mov    0x14(%ebp),%eax
80108b94:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108b97:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b9a:	8b 55 0c             	mov    0xc(%ebp),%edx
80108b9d:	89 d1                	mov    %edx,%ecx
80108b9f:	29 c1                	sub    %eax,%ecx
80108ba1:	89 c8                	mov    %ecx,%eax
80108ba3:	03 45 e8             	add    -0x18(%ebp),%eax
80108ba6:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108ba9:	89 54 24 08          	mov    %edx,0x8(%esp)
80108bad:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108bb0:	89 54 24 04          	mov    %edx,0x4(%esp)
80108bb4:	89 04 24             	mov    %eax,(%esp)
80108bb7:	e8 d9 cb ff ff       	call   80105795 <memmove>
    len -= n;
...
80108bd7:	0f 85 6b ff ff ff    	jne    80108b48 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
