...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 28 65 00 00       	mov    0x6528,%eax
       b:	c7 44 24 04 12 46 00 	movl   $0x4612,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 c4 3d 00 00       	call   3ddf <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 fc 45 00 00 	movl   $0x45fc,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 28 65 00 00       	mov    0x6528,%eax
      3d:	c7 44 24 04 1d 46 00 	movl   $0x461d,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 92 3d 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 30 46 00 00 	movl   $0x4630,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 28 65 00 00       	mov    0x6528,%eax
      7f:	c7 44 24 04 3d 46 00 	movl   $0x463d,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 50 3d 00 00       	call   3ddf <printf>
    exit();
      8f:	e8 94 3b 00 00       	call   3c28 <exit>
  }
  printf(stdout, "open test ok\n");
      94:	a1 28 65 00 00       	mov    0x6528,%eax
      99:	c7 44 24 04 5b 46 00 	movl   $0x465b,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 36 3d 00 00       	call   3ddf <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 28 65 00 00       	mov    0x6528,%eax
      b6:	c7 44 24 04 69 46 00 	movl   $0x4669,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 19 3d 00 00       	call   3ddf <printf>
  fd = open("small", O_CREATE|O_RDWR);
      c6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
      cd:	00 
      ce:	c7 04 24 7a 46 00 00 	movl   $0x467a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 28 65 00 00       	mov    0x6528,%eax
      e8:	c7 44 24 04 80 46 00 	movl   $0x4680,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 e7 3c 00 00       	call   3ddf <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 28 65 00 00       	mov    0x6528,%eax
     109:	c7 44 24 04 9b 46 00 	movl   $0x469b,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 c6 3c 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 b7 46 00 	movl   $0x46b7,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 28 65 00 00       	mov    0x6528,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 c4 46 00 	movl   $0x46c4,0x4(%esp)
     151:	00 
     152:	89 04 24             	mov    %eax,(%esp)
     155:	e8 85 3c 00 00       	call   3ddf <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 28 65 00 00       	mov    0x6528,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
     192:	00 
     193:	89 04 24             	mov    %eax,(%esp)
     196:	e8 44 3c 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 28 65 00 00       	mov    0x6528,%eax
     1b3:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 1c 3c 00 00       	call   3ddf <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 7a 46 00 00 	movl   $0x467a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 28 65 00 00       	mov    0x6528,%eax
     1f0:	c7 44 24 04 23 47 00 	movl   $0x4723,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 df 3b 00 00       	call   3ddf <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 28 65 00 00       	mov    0x6528,%eax
     22e:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 a1 3b 00 00       	call   3ddf <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 28 65 00 00       	mov    0x6528,%eax
     248:	c7 44 24 04 57 47 00 	movl   $0x4757,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 87 3b 00 00       	call   3ddf <printf>
  } else {
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 7a 46 00 00 	movl   $0x467a,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 28 65 00 00       	mov    0x6528,%eax
     27a:	c7 44 24 04 6a 47 00 	movl   $0x476a,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 55 3b 00 00       	call   3ddf <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 28 65 00 00       	mov    0x6528,%eax
     294:	c7 44 24 04 77 47 00 	movl   $0x4777,0x4(%esp)
     29b:	00 
     29c:	89 04 24             	mov    %eax,(%esp)
     29f:	e8 3b 3b 00 00       	call   3ddf <printf>
    exit();
     2a4:	e8 7f 39 00 00       	call   3c28 <exit>
  }
  printf(stdout, "small file test ok\n");
     2a9:	a1 28 65 00 00       	mov    0x6528,%eax
     2ae:	c7 44 24 04 8c 47 00 	movl   $0x478c,0x4(%esp)
     2b5:	00 
     2b6:	89 04 24             	mov    %eax,(%esp)
     2b9:	e8 21 3b 00 00       	call   3ddf <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 28 65 00 00       	mov    0x6528,%eax
     2cb:	c7 44 24 04 a0 47 00 	movl   $0x47a0,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 04 3b 00 00       	call   3ddf <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2db:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e2:	00 
     2e3:	c7 04 24 b0 47 00 00 	movl   $0x47b0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 28 65 00 00       	mov    0x6528,%eax
     2fd:	c7 44 24 04 b4 47 00 	movl   $0x47b4,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 d2 3a 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 28 65 00 00       	mov    0x6528,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 ce 47 00 	movl   $0x47ce,0x4(%esp)
     35a:	00 
     35b:	89 04 24             	mov    %eax,(%esp)
     35e:	e8 7c 3a 00 00       	call   3ddf <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 b0 47 00 00 	movl   $0x47b0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 28 65 00 00       	mov    0x6528,%eax
     3a3:	c7 44 24 04 ec 47 00 	movl   $0x47ec,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 2c 3a 00 00       	call   3ddf <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3f0:	a1 28 65 00 00       	mov    0x6528,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 05 48 00 	movl   $0x4805,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 d3 39 00 00       	call   3ddf <printf>
        exit();
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 b0 47 00 00 	movl   $0x47b0,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 28 65 00 00       	mov    0x6528,%eax
     49d:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 32 39 00 00       	call   3ddf <printf>
    exit();
     4ad:	e8 76 37 00 00       	call   3c28 <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 28 65 00 00       	mov    0x6528,%eax
     4b7:	c7 44 24 04 67 48 00 	movl   $0x4867,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 18 39 00 00       	call   3ddf <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 28 65 00 00       	mov    0x6528,%eax
     4d4:	c7 44 24 04 78 48 00 	movl   $0x4878,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 fb 38 00 00       	call   3ddf <printf>

  name[0] = 'a';
     4e4:	c6 05 20 ad 00 00 61 	movb   $0x61,0xad20
  name[2] = '\0';
     4eb:	c6 05 22 ad 00 00 00 	movb   $0x0,0xad22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 21 ad 00 00       	mov    %al,0xad21
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 20 ad 00 00 	movl   $0xad20,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 20 ad 00 00 61 	movb   $0x61,0xad20
  name[2] = '\0';
     539:	c6 05 22 ad 00 00 00 	movb   $0x0,0xad22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 21 ad 00 00       	mov    %al,0xad21
    unlink(name);
     554:	c7 04 24 20 ad 00 00 	movl   $0xad20,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 28 65 00 00       	mov    0x6528,%eax
     56f:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 60 38 00 00       	call   3ddf <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 28 65 00 00       	mov    0x6528,%eax
     58c:	c7 44 24 04 c6 48 00 	movl   $0x48c6,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 43 38 00 00       	call   3ddf <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 d2 48 00 00 	movl   $0x48d2,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 28 65 00 00       	mov    0x6528,%eax
     5b1:	c7 44 24 04 d7 48 00 	movl   $0x48d7,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 1e 38 00 00       	call   3ddf <printf>
    exit();
     5c1:	e8 62 36 00 00       	call   3c28 <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 d2 48 00 00 	movl   $0x48d2,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 28 65 00 00       	mov    0x6528,%eax
     5db:	c7 44 24 04 e5 48 00 	movl   $0x48e5,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 f4 37 00 00       	call   3ddf <printf>
    exit();
     5eb:	e8 38 36 00 00       	call   3c28 <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 f8 48 00 00 	movl   $0x48f8,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 28 65 00 00       	mov    0x6528,%eax
     605:	c7 44 24 04 fb 48 00 	movl   $0x48fb,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 ca 37 00 00       	call   3ddf <printf>
    exit();
     615:	e8 0e 36 00 00       	call   3c28 <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 d2 48 00 00 	movl   $0x48d2,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 28 65 00 00       	mov    0x6528,%eax
     62f:	c7 44 24 04 0c 49 00 	movl   $0x490c,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 a0 37 00 00       	call   3ddf <printf>
    exit();
     63f:	e8 e4 35 00 00       	call   3c28 <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 28 65 00 00       	mov    0x6528,%eax
     649:	c7 44 24 04 c6 48 00 	movl   $0x48c6,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 86 37 00 00       	call   3ddf <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 28 65 00 00       	mov    0x6528,%eax
     666:	c7 44 24 04 20 49 00 	movl   $0x4920,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 69 37 00 00       	call   3ddf <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 14 65 00 	movl   $0x6514,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 fc 45 00 00 	movl   $0x45fc,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 28 65 00 00       	mov    0x6528,%eax
     693:	c7 44 24 04 2b 49 00 	movl   $0x492b,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 3c 37 00 00       	call   3ddf <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 3d 49 00 	movl   $0x493d,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 0c 37 00 00       	call   3ddf <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	81 c2 20 8d 00 00    	add    $0x8d20,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     737:	00 
     738:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     73f:	00 
     ...
     74f:	c7 44 24 04 4c 49 00 	movl   $0x494c,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 7c 36 00 00       	call   3ddf <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a8:	05 20 8d 00 00       	add    $0x8d20,%eax
     ...
     7c8:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
     7cf:	00 
     7d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d7:	e8 03 36 00 00       	call   3ddf <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     811:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     818:	00 
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 68 49 00 	movl   $0x4968,0x4(%esp)
     845:	00 
     846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84d:	e8 8d 35 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 7f 49 00 	movl   $0x497f,0x4(%esp)
     86e:	00 
     86f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     876:	e8 64 35 00 00       	call   3ddf <printf>
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 89 49 00 	movl   $0x4989,0x4(%esp)
     884:	00 
     885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88c:	e8 4e 35 00 00       	call   3ddf <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 98 49 00 	movl   $0x4998,0x4(%esp)
     8a5:	00 
     8a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ad:	e8 2d 35 00 00       	call   3ddf <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 a2 49 00 	movl   $0x49a2,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 a4 49 00 	movl   $0x49a4,0x4(%esp)
     91d:	00 
     91e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     925:	e8 b5 34 00 00       	call   3ddf <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94c:	00 
     94d:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     954:	00 
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 b8 49 00 	movl   $0x49b8,0x4(%esp)
     969:	00 
     96a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     971:	e8 69 34 00 00       	call   3ddf <printf>
    return;
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 48 34 00 00       	call   3ddf <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 d4 49 00 	movl   $0x49d4,0x4(%esp)
     9bf:	00 
     9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c7:	e8 13 34 00 00       	call   3ddf <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 dd 49 00 	movl   $0x49dd,0x4(%esp)
     9e2:	00 
     9e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9ea:	e8 f0 33 00 00       	call   3ddf <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 bd 33 00 00       	call   3ddf <printf>
      return;
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 f6 49 00 	movl   $0x49f6,0x4(%esp)
     a3b:	00 
     a3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a43:	e8 97 33 00 00       	call   3ddf <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 06 4a 00 	movl   $0x4a06,0x4(%esp)
     a60:	00 
     a61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a68:	e8 72 33 00 00       	call   3ddf <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 13 4a 00 	movl   $0x4a13,0x4(%esp)
     a7c:	00 
     a7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a84:	e8 56 33 00 00       	call   3ddf <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 fd 35 00 00       	call   40c3 <malloc>
    ...
    while(m1){
     ...
     adf:	e8 b0 34 00 00       	call   3f94 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2f:	e8 60 34 00 00       	call   3f94 <free>
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 37 4a 00 	movl   $0x4a37,0x4(%esp)
     b3b:	00 
     b3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b43:	e8 97 32 00 00       	call   3ddf <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5a:	c7 44 24 04 3f 4a 00 	movl   $0x4a3f,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 71 32 00 00       	call   3ddf <printf>

  unlink("sharedfd");
     b6e:	c7 04 24 4e 4a 00 00 	movl   $0x4a4e,(%esp)
     b75:	e8 fe 30 00 00       	call   3c78 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b81:	00 
     b82:	c7 04 24 4e 4a 00 00 	movl   $0x4a4e,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 58 4a 00 	movl   $0x4a58,0x4(%esp)
     b9e:	00 
     b9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba6:	e8 34 32 00 00       	call   3ddf <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 84 4a 00 	movl   $0x4a84,0x4(%esp)
     c10:	00 
     c11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c18:	e8 c2 31 00 00       	call   3ddf <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 4e 4a 00 00 	movl   $0x4a4e,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 a4 4a 00 	movl   $0x4aa4,0x4(%esp)
     c6b:	00 
     c6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c73:	e8 67 31 00 00       	call   3ddf <printf>
    return;
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 4e 4a 00 00 	movl   $0x4a4e,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 cf 4a 00 	movl   $0x4acf,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 bc 30 00 00       	call   3ddf <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 dc 4a 00 	movl   $0x4adc,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 98 30 00 00       	call   3ddf <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 f1 4a 00 	movl   $0x4af1,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 77 30 00 00       	call   3ddf <printf>

  unlink("f1");
     d68:	c7 04 24 00 4b 00 00 	movl   $0x4b00,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 03 4b 00 00 	movl   $0x4b03,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 3d 30 00 00       	call   3ddf <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 00 4b 00 00       	mov    $0x4b00,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 03 4b 00 00       	mov    $0x4b03,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 06 4b 00 	movl   $0x4b06,0x4(%esp)
     ddf:	00 
     de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de7:	e8 f3 2f 00 00       	call   3ddf <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0f:	c7 04 24 20 8d 00 00 	movl   $0x8d20,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e2b:	00 
     e2c:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     e33:	00 
     ...
     e52:	c7 44 24 04 15 4b 00 	movl   $0x4b15,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 79 2f 00 00       	call   3ddf <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 00 4b 00 00       	mov    $0x4b00,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 03 4b 00 00       	mov    $0x4b03,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed6:	05 20 8d 00 00       	add    $0x8d20,%eax
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 26 4b 00 	movl   $0x4b26,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 d4 2e 00 00       	call   3ddf <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f29:	00 
     f2a:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
     f31:	00 
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 32 4b 00 	movl   $0x4b32,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 6a 2e 00 00       	call   3ddf <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 00 4b 00 00 	movl   $0x4b00,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 03 4b 00 00 	movl   $0x4b03,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 43 4b 00 	movl   $0x4b43,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 2b 2e 00 00       	call   3ddf <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 50 4b 00 	movl   $0x4b50,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 0f 2e 00 00       	call   3ddf <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 ed 2d 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 06 4b 00 	movl   $0x4b06,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 8a 2d 00 00       	call   3ddf <printf>
      exit();
    ...
    1096:	c7 44 24 04 63 4b 00 	movl   $0x4b63,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 35 2d 00 00       	call   3ddf <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 74 4b 00 	movl   $0x4b74,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 b6 2c 00 00       	call   3ddf <printf>
      exit();
    ...
    1147:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 84 2c 00 00       	call   3ddf <printf>
      exit();
    ...
    11ad:	c7 44 24 04 74 4b 00 	movl   $0x4b74,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 1e 2c 00 00       	call   3ddf <printf>
      exit();
    ...
    11df:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 ec 2b 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 b8 4b 00 	movl   $0x4bb8,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 7a 2b 00 00       	call   3ddf <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 c9 4b 00 	movl   $0x4bc9,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 5e 2b 00 00       	call   3ddf <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 da 4b 00 00 	movl   $0x4bda,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 e5 4b 00 	movl   $0x4be5,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 2d 2b 00 00       	call   3ddf <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 ff 4b 00 	movl   $0x4bff,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 da 4b 00 00 	movl   $0x4bda,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1380:	00 
    1381:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    1388:	00 
    ...
    1399:	c7 44 24 04 3b 4c 00 	movl   $0x4c3b,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 32 2a 00 00       	call   3ddf <printf>
    exit();
    13ad:	e8 76 28 00 00       	call   3c28 <exit>
  }
  if(buf[0] != 'h'){
    13b2:	0f b6 05 20 8d 00 00 	movzbl 0x8d20,%eax
    13b9:	3c 68                	cmp    $0x68,%al
    13bb:	74 19                	je     13d6 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13bd:	c7 44 24 04 52 4c 00 	movl   $0x4c52,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 0e 2a 00 00       	call   3ddf <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13dd:	00 
    13de:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    13e5:	00 
    ...
    13f6:	c7 44 24 04 69 4c 00 	movl   $0x4c69,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 d5 29 00 00       	call   3ddf <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 da 4b 00 00 	movl   $0x4bda,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 82 4c 00 	movl   $0x4c82,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 a5 29 00 00       	call   3ddf <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 91 4c 00 	movl   $0x4c91,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 89 29 00 00       	call   3ddf <printf>

  unlink("lf1");
    1456:	c7 04 24 9b 4c 00 00 	movl   $0x4c9b,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 9f 4c 00 00 	movl   $0x4c9f,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 9b 4c 00 00 	movl   $0x4c9b,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 a3 4c 00 	movl   $0x4ca3,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 40 29 00 00       	call   3ddf <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 ff 4b 00 	movl   $0x4bff,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 b6 4c 00 	movl   $0x4cb6,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 07 29 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 9f 4c 00 00 	movl   $0x4c9f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 05 4d 00 	movl   $0x4d05,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 58 28 00 00       	call   3ddf <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1593:	00 
    1594:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    159b:	00 
    ...
    15ac:	c7 44 24 04 16 4d 00 	movl   $0x4d16,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 1f 28 00 00       	call   3ddf <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 9f 4c 00 	movl   $0x4c9f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 9f 4c 00 00 	movl   $0x4c9f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 27 4d 00 	movl   $0x4d27,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 e3 27 00 00       	call   3ddf <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 9f 4c 00 00 	movl   $0x4c9f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 9b 4c 00 	movl   $0x4c9b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 9f 4c 00 00 	movl   $0x4c9f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 48 4d 00 	movl   $0x4d48,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 a6 27 00 00       	call   3ddf <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 9b 4c 00 	movl   $0x4c9b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 6b 4d 00 00 	movl   $0x4d6b,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 6d 4d 00 	movl   $0x4d6d,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 75 27 00 00       	call   3ddf <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 89 4d 00 	movl   $0x4d89,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 5c 27 00 00       	call   3ddf <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 96 4d 00 	movl   $0x4d96,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 40 27 00 00       	call   3ddf <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 a6 4d 00 00 	movl   $0x4da6,(%esp)
    ...
    1741:	c7 04 24 a6 4d 00 00 	movl   $0x4da6,(%esp)
    ...
    1772:	c7 44 24 04 a9 4d 00 	movl   $0x4da9,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 59 26 00 00       	call   3ddf <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 6b 4d 00 00 	movl   $0x4d6b,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 c5 4d 00 	movl   $0x4dc5,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 93 25 00 00       	call   3ddf <printf>
        exit();
    ...
    1868:	c7 44 24 04 de 4d 00 	movl   $0x4dde,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 63 25 00 00       	call   3ddf <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 fc 4d 00 	movl   $0x4dfc,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 07 25 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 cb 24 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 2d 4e 00 	movl   $0x4e2d,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 ab 23 00 00       	call   3ddf <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 3b 4e 00 	movl   $0x4e3b,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 8f 23 00 00       	call   3ddf <printf>

  unlink("x");
    1a50:	c7 04 24 a2 49 00 00 	movl   $0x49a2,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 61 23 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 a2 49 00 00 	movl   $0x49a2,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 a2 49 00 	movl   $0x49a2,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 4c 4e 00 00 	movl   $0x4e4c,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 a2 49 00 00 	movl   $0x49a2,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 50 4e 00 	movl   $0x4e50,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 84 22 00 00       	call   3ddf <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 5f 4e 00 	movl   $0x4e5f,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 63 22 00 00       	call   3ddf <printf>
  unlink("bd");
    1b7c:	c7 04 24 6c 4e 00 00 	movl   $0x4e6c,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 6c 4e 00 00 	movl   $0x4e6c,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 6f 4e 00 	movl   $0x4e6f,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 26 22 00 00       	call   3ddf <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 6c 4e 00 00 	movl   $0x4e6c,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 99 4e 00 	movl   $0x4e99,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 30 21 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 ae 4e 00 	movl   $0x4eae,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 0a 21 00 00       	call   3ddf <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 b9 4e 00 	movl   $0x4eb9,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 ee 20 00 00       	call   3ddf <printf>

  unlink("ff");
    1cf1:	c7 04 24 c6 4e 00 00 	movl   $0x4ec6,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 c9 4e 00 00 	movl   $0x4ec9,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 cc 4e 00 	movl   $0x4ecc,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 be 20 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 e4 4e 00 00 	movl   $0x4ee4,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 ea 4e 00 	movl   $0x4eea,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 88 20 00 00       	call   3ddf <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 c6 4e 00 	movl   $0x4ec6,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 51 4f 00 	movl   $0x4f51,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 da 1f 00 00       	call   3ddf <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 69 4f 00 	movl   $0x4f69,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 6c 4f 00 00 	movl   $0x4f6c,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 78 4f 00 	movl   $0x4f78,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 7e 1f 00 00       	call   3ddf <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6d:	00 
    1e6e:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    1e75:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8a:	0f b6 05 20 8d 00 00 	movzbl 0x8d20,%eax
    1e91:	3c 66                	cmp    $0x66,%al
    1e93:	74 19                	je     1eae <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e95:	c7 44 24 04 91 4f 00 	movl   $0x4f91,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 36 1f 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 76 50 00 	movl   $0x5076,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 c6 1d 00 00       	call   3ddf <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2025:	00 
    2026:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    202d:	00 
    ...
    203e:	c7 44 24 04 8e 50 00 	movl   $0x508e,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 8d 1d 00 00       	call   3ddf <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 08 53 00 	movl   $0x5308,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 a8 19 00 00       	call   3ddf <printf>

  unlink("bigwrite");
    2437:	c7 04 24 17 53 00 00 	movl   $0x5317,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 17 53 00 00 	movl   $0x5317,(%esp)
    ...
    246c:	c7 44 24 04 20 53 00 	movl   $0x5320,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 5f 19 00 00       	call   3ddf <printf>
      exit();
    ...
    2495:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    249c:	00 
    ...
    24c1:	c7 44 24 04 38 53 00 	movl   $0x5338,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 0a 19 00 00       	call   3ddf <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 17 53 00 00 	movl   $0x5317,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 4a 53 00 	movl   $0x534a,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 bc 18 00 00       	call   3ddf <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 57 53 00 	movl   $0x5357,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 a0 18 00 00       	call   3ddf <printf>

  unlink("bigfile");
    253f:	c7 04 24 65 53 00 00 	movl   $0x5365,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 65 53 00 00 	movl   $0x5365,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 6d 53 00 	movl   $0x536d,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 63 18 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2599:	c7 04 24 20 8d 00 00 	movl   $0x8d20,(%esp)
    25a0:	e8 de 14 00 00       	call   3a83 <memset>
    if(write(fd, buf, 600) != 600){
    25a5:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ac:	00 
    25ad:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    25b4:	00 
    ...
    25c7:	c7 44 24 04 83 53 00 	movl   $0x5383,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 04 18 00 00       	call   3ddf <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 65 53 00 00 	movl   $0x5365,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 99 53 00 	movl   $0x5399,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 b9 17 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2640:	00 
    2641:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    2648:	00 
    ...
    265d:	c7 44 24 04 ae 53 00 	movl   $0x53ae,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 6e 17 00 00       	call   3ddf <printf>
      exit();
    ...
    2685:	c7 44 24 04 c3 53 00 	movl   $0x53c3,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 46 17 00 00       	call   3ddf <printf>
      exit();
    2699:	e8 8a 15 00 00       	call   3c28 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    269e:	0f b6 05 20 8d 00 00 	movzbl 0x8d20,%eax
    ...
    26b8:	0f b6 05 4b 8e 00 00 	movzbl 0x8e4b,%eax
    ...
    26d2:	c7 44 24 04 d7 53 00 	movl   $0x53d7,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 f9 16 00 00       	call   3ddf <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 f0 53 00 	movl   $0x53f0,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 bc 16 00 00       	call   3ddf <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 65 53 00 00 	movl   $0x5365,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 0a 54 00 	movl   $0x540a,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 97 16 00 00       	call   3ddf <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 a8 54 00 00 	movl   $0x54a8,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 d8 54 00 	movl   $0x54d8,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 f8 15 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 18 55 00 00 	movl   $0x5518,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 48 55 00 	movl   $0x5548,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 b7 15 00 00       	call   3ddf <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 f1 56 00 	movl   $0x56f1,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 ad 13 00 00       	call   3ddf <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 fe 56 00 00 	movl   $0x56fe,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 06 57 00 	movl   $0x5706,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 7c 13 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 37 57 00 00 	movl   $0x5737,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 42 57 00 	movl   $0x5742,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 12 13 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 37 57 00 00 	movl   $0x5737,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 6b 4d 00 00 	movl   $0x4d6b,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 dc 57 00 	movl   $0x57dc,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 fa 11 00 00       	call   3ddf <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 fb 57 00 	movl   $0x57fb,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 ab 11 00 00       	call   3ddf <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 0f 58 00 	movl   $0x580f,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 87 11 00 00       	call   3ddf <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 1f 58 00 	movl   $0x581f,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 6b 11 00 00       	call   3ddf <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 5f 58 00 00 	movl   $0x585f,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 5f 58 00 00 	movl   $0x585f,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 82 56 00 00 	movl   $0x5682,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 62 58 00 	movl   $0x5862,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 63 10 00 00       	call   3ddf <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 76 58 00 	movl   $0x5876,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 47 10 00 00       	call   3ddf <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 84 58 00 	movl   $0x5884,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 f8 0f 00 00       	call   3ddf <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 a6 58 00 	movl   $0x58a6,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 d6 0f 00 00       	call   3ddf <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 ba 58 00 	movl   $0x58ba,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 a9 0f 00 00       	call   3ddf <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 cd 58 00 	movl   $0x58cd,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 90 0f 00 00       	call   3ddf <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 28 65 00 00       	mov    0x6528,%eax
    2e60:	c7 44 24 04 db 58 00 	movl   $0x58db,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 6f 0f 00 00       	call   3ddf <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 28 65 00 00       	mov    0x6528,%eax
    ...
    2ec8:	c7 44 24 04 e6 58 00 	movl   $0x58e6,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 07 0f 00 00       	call   3ddf <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 28 65 00 00       	mov    0x6528,%eax
    2f0c:	c7 44 24 04 01 59 00 	movl   $0x5901,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 c3 0e 00 00       	call   3ddf <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 28 65 00 00       	mov    0x6528,%eax
    2f4f:	c7 44 24 04 18 59 00 	movl   $0x5918,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 80 0e 00 00       	call   3ddf <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 28 65 00 00       	mov    0x6528,%eax
    2faf:	c7 44 24 04 34 59 00 	movl   $0x5934,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 20 0e 00 00       	call   3ddf <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 28 65 00 00       	mov    0x6528,%eax
    2ffa:	c7 44 24 04 72 59 00 	movl   $0x5972,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 d5 0d 00 00       	call   3ddf <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 28 65 00 00       	mov    0x6528,%eax
    ...
    303e:	c7 44 24 04 90 59 00 	movl   $0x5990,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 91 0d 00 00       	call   3ddf <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 28 65 00 00       	mov    0x6528,%eax
    ...
    30a5:	c7 44 24 04 c8 59 00 	movl   $0x59c8,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 2a 0d 00 00       	call   3ddf <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 28 65 00 00       	mov    0x6528,%eax
    30c9:	c7 44 24 04 f0 59 00 	movl   $0x59f0,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 06 0d 00 00       	call   3ddf <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 28 65 00 00       	mov    0x6528,%eax
    ...
    3128:	c7 44 24 04 20 5a 00 	movl   $0x5a20,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 a7 0c 00 00       	call   3ddf <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 28 65 00 00       	mov    0x6528,%eax
    3161:	c7 44 24 04 e9 49 00 	movl   $0x49e9,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 6e 0c 00 00       	call   3ddf <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 3d 49 00 	movl   $0x493d,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 ee 0b 00 00       	call   3ddf <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 a2 49 00 	movl   $0x49a2,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 28 65 00 00       	mov    0x6528,%eax
    32e9:	c7 44 24 04 5a 5a 00 	movl   $0x5a5a,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 e6 0a 00 00       	call   3ddf <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 28 65 00 00       	mov    0x6528,%eax
    3331:	c7 44 24 04 75 5a 00 	movl   $0x5a75,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 9e 0a 00 00       	call   3ddf <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 28 65 00 00       	mov    0x6528,%eax
    3380:	c7 44 24 04 83 5a 00 	movl   $0x5a83,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 4f 0a 00 00       	call   3ddf <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 92 5a 00 00 	movl   $0x5a92,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 28 65 00 00       	mov    0x6528,%eax
    3403:	c7 44 24 04 9d 5a 00 	movl   $0x5a9d,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 cc 09 00 00       	call   3ddf <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 28 65 00 00       	mov    0x6528,%eax
    3430:	c7 44 24 04 b6 5a 00 	movl   $0x5ab6,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 9f 09 00 00       	call   3ddf <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 28 65 00 00       	mov    0x6528,%eax
    344d:	c7 44 24 04 c3 5a 00 	movl   $0x5ac3,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 82 09 00 00       	call   3ddf <printf>
  for(i = 0; i < sizeof(uninit); i++){
    345d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3464:	eb 2d                	jmp    3493 <bsstest+0x51>
    if(uninit[i] != '\0'){
    3466:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3469:	05 00 66 00 00       	add    $0x6600,%eax
    346e:	0f b6 00             	movzbl (%eax),%eax
    3471:	84 c0                	test   %al,%al
    3473:	74 1a                	je     348f <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3475:	a1 28 65 00 00       	mov    0x6528,%eax
    347a:	c7 44 24 04 cd 5a 00 	movl   $0x5acd,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 55 09 00 00       	call   3ddf <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 28 65 00 00       	mov    0x6528,%eax
    34a2:	c7 44 24 04 de 5a 00 	movl   $0x5ade,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 2d 09 00 00       	call   3ddf <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 eb 5a 00 00 	movl   $0x5aeb,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 60 65 00 00 	movl   $0x5af8,0x6560(,%eax,4)
    34eb:	f8 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f7:	7e e8                	jle    34e1 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34f9:	c7 05 dc 65 00 00 00 	movl   $0x0,0x65dc
    3500:	00 00 00 
    printf(stdout, "bigarg test\n");
    3503:	a1 28 65 00 00       	mov    0x6528,%eax
    3508:	c7 44 24 04 d5 5b 00 	movl   $0x5bd5,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 c7 08 00 00       	call   3ddf <printf>
    exec("echo", args);
    3518:	c7 44 24 04 60 65 00 	movl   $0x6560,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 fc 45 00 00 	movl   $0x45fc,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 28 65 00 00       	mov    0x6528,%eax
    3531:	c7 44 24 04 e2 5b 00 	movl   $0x5be2,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 9e 08 00 00       	call   3ddf <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 eb 5a 00 00 	movl   $0x5aeb,(%esp)
    ...
    356e:	a1 28 65 00 00       	mov    0x6528,%eax
    3573:	c7 44 24 04 f2 5b 00 	movl   $0x5bf2,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 5c 08 00 00       	call   3ddf <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 eb 5a 00 00 	movl   $0x5aeb,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 28 65 00 00       	mov    0x6528,%eax
    35af:	c7 44 24 04 0b 5c 00 	movl   $0x5c0b,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 20 08 00 00       	call   3ddf <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 eb 5a 00 00 	movl   $0x5aeb,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 20 5c 00 	movl   $0x5c20,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 e0 07 00 00       	call   3ddf <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 2d 5c 00 	movl   $0x5c2d,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 f0 06 00 00       	call   3ddf <printf>
    ...
    3712:	c7 44 24 04 39 5c 00 	movl   $0x5c39,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 b9 06 00 00       	call   3ddf <printf>
      break;
    ...
    3736:	00 
    3737:	c7 44 24 04 20 8d 00 	movl   $0x8d20,0x4(%esp)
    373e:	00 
    ...
    376a:	c7 44 24 04 49 5c 00 	movl   $0x5c49,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 61 06 00 00       	call   3ddf <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 59 5c 00 	movl   $0x5c59,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 46 05 00 00       	call   3ddf <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 2c 65 00 00       	mov    0x652c,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 2c 65 00 00       	mov    %eax,0x652c
  return randstate;
    38b7:	a1 2c 65 00 00       	mov    0x652c,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 83 5c 00 00 	movl   $0x5c83,(%esp)
...
00003cc8 <thread_create>:
SYSCALL(thread_create)
    3cc8:	b8 16 00 00 00       	mov    $0x16,%eax
    3ccd:	cd 40                	int    $0x40
    3ccf:	c3                   	ret    

00003cd0 <thread_getId>:
SYSCALL(thread_getId)
    3cd0:	b8 17 00 00 00       	mov    $0x17,%eax
    3cd5:	cd 40                	int    $0x40
    3cd7:	c3                   	ret    

00003cd8 <thread_getProcId>:
SYSCALL(thread_getProcId)
    3cd8:	b8 18 00 00 00       	mov    $0x18,%eax
    3cdd:	cd 40                	int    $0x40
    3cdf:	c3                   	ret    

00003ce0 <thread_join>:
SYSCALL(thread_join)
    3ce0:	b8 19 00 00 00       	mov    $0x19,%eax
    3ce5:	cd 40                	int    $0x40
    3ce7:	c3                   	ret    

00003ce8 <thread_exit>:
SYSCALL(thread_exit)
    3ce8:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3ced:	cd 40                	int    $0x40
    3cef:	c3                   	ret    

00003cf0 <binary_semaphore_create>:
SYSCALL(binary_semaphore_create)
    3cf0:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3cf5:	cd 40                	int    $0x40
    3cf7:	c3                   	ret    

00003cf8 <binary_semaphore_down>:
SYSCALL(binary_semaphore_down)
    3cf8:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3cfd:	cd 40                	int    $0x40
    3cff:	c3                   	ret    

00003d00 <binary_semaphore_up>:
SYSCALL(binary_semaphore_up)
    3d00:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3d05:	cd 40                	int    $0x40
    3d07:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3d0b:	83 ec 28             	sub    $0x28,%esp
    3d0e:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d11:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3d14:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3d1b:	00 
    3d1c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3d1f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d23:	8b 45 08             	mov    0x8(%ebp),%eax
    3d26:	89 04 24             	mov    %eax,(%esp)
    3d29:	e8 1a ff ff ff       	call   3c48 <write>
}
    3d2e:	c9                   	leave  
    3d2f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d36:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d3d:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d41:	74 17                	je     3d5a <printint+0x2a>
    3d43:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d47:	79 11                	jns    3d5a <printint+0x2a>
    neg = 1;
    3d49:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d50:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d53:	f7 d8                	neg    %eax
    3d55:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d58:	eb 06                	jmp    3d60 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
    3d60:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d67:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d6a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d6d:	ba 00 00 00 00       	mov    $0x0,%edx
    3d72:	f7 f1                	div    %ecx
    3d74:	89 d0                	mov    %edx,%eax
    3d76:	0f b6 90 30 65 00 00 	movzbl 0x6530(%eax),%edx
    3d7d:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d80:	03 45 f4             	add    -0xc(%ebp),%eax
    3d83:	88 10                	mov    %dl,(%eax)
    3d85:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d89:	8b 55 10             	mov    0x10(%ebp),%edx
    3d8c:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d8f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d92:	ba 00 00 00 00       	mov    $0x0,%edx
    3d97:	f7 75 d4             	divl   -0x2c(%ebp)
    3d9a:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d9d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3da1:	75 c4                	jne    3d67 <printint+0x37>
  if(neg)
    3da3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3da7:	74 2a                	je     3dd3 <printint+0xa3>
    buf[i++] = '-';
    3da9:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3dac:	03 45 f4             	add    -0xc(%ebp),%eax
    3daf:	c6 00 2d             	movb   $0x2d,(%eax)
    3db2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3db6:	eb 1b                	jmp    3dd3 <printint+0xa3>
    putc(fd, buf[i]);
    3db8:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3dbb:	03 45 f4             	add    -0xc(%ebp),%eax
    3dbe:	0f b6 00             	movzbl (%eax),%eax
    3dc1:	0f be c0             	movsbl %al,%eax
    3dc4:	89 44 24 04          	mov    %eax,0x4(%esp)
    3dc8:	8b 45 08             	mov    0x8(%ebp),%eax
    3dcb:	89 04 24             	mov    %eax,(%esp)
    3dce:	e8 35 ff ff ff       	call   3d08 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dd3:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3dd7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ddb:	79 db                	jns    3db8 <printint+0x88>
    putc(fd, buf[i]);
}
    3ddd:	c9                   	leave  
    3dde:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3de2:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3de5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dec:	8d 45 0c             	lea    0xc(%ebp),%eax
    3def:	83 c0 04             	add    $0x4,%eax
    3df2:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3df5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dfc:	e9 7d 01 00 00       	jmp    3f7e <printf+0x19f>
    c = fmt[i] & 0xff;
    3e01:	8b 55 0c             	mov    0xc(%ebp),%edx
    3e04:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3e07:	01 d0                	add    %edx,%eax
    3e09:	0f b6 00             	movzbl (%eax),%eax
    3e0c:	0f be c0             	movsbl %al,%eax
    3e0f:	25 ff 00 00 00       	and    $0xff,%eax
    3e14:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3e17:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3e1b:	75 2c                	jne    3e49 <printf+0x6a>
      if(c == '%'){
    3e1d:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3e21:	75 0c                	jne    3e2f <printf+0x50>
        state = '%';
    3e23:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e2a:	e9 4b 01 00 00       	jmp    3f7a <printf+0x19b>
      } else {
        putc(fd, c);
    3e2f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e32:	0f be c0             	movsbl %al,%eax
    3e35:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e39:	8b 45 08             	mov    0x8(%ebp),%eax
    3e3c:	89 04 24             	mov    %eax,(%esp)
    3e3f:	e8 c4 fe ff ff       	call   3d08 <putc>
    3e44:	e9 31 01 00 00       	jmp    3f7a <printf+0x19b>
      }
    } else if(state == '%'){
    3e49:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e4d:	0f 85 27 01 00 00    	jne    3f7a <printf+0x19b>
      if(c == 'd'){
    3e53:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e57:	75 2d                	jne    3e86 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e59:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e5c:	8b 00                	mov    (%eax),%eax
    3e5e:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e65:	00 
    3e66:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e6d:	00 
    3e6e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e72:	8b 45 08             	mov    0x8(%ebp),%eax
    3e75:	89 04 24             	mov    %eax,(%esp)
    3e78:	e8 b3 fe ff ff       	call   3d30 <printint>
        ap++;
    3e7d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e81:	e9 ed 00 00 00       	jmp    3f73 <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e86:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e8a:	74 06                	je     3e92 <printf+0xb3>
    3e8c:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e90:	75 2d                	jne    3ebf <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e92:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e95:	8b 00                	mov    (%eax),%eax
    3e97:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e9e:	00 
    3e9f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3ea6:	00 
    3ea7:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eab:	8b 45 08             	mov    0x8(%ebp),%eax
    3eae:	89 04 24             	mov    %eax,(%esp)
    3eb1:	e8 7a fe ff ff       	call   3d30 <printint>
        ap++;
    3eb6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3eba:	e9 b4 00 00 00       	jmp    3f73 <printf+0x194>
      } else if(c == 's'){
    3ebf:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3ec3:	75 46                	jne    3f0b <printf+0x12c>
        s = (char*)*ap;
    ...
    3ecd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3ed1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ed5:	75 27                	jne    3efe <printf+0x11f>
          s = "(null)";
    3ed7:	c7 45 f4 be 5c 00 00 	movl   $0x5cbe,-0xc(%ebp)
        while(*s != 0){
    3ede:	eb 1e                	jmp    3efe <printf+0x11f>
          putc(fd, *s);
    3ee0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ee3:	0f b6 00             	movzbl (%eax),%eax
    3ee6:	0f be c0             	movsbl %al,%eax
    3ee9:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eed:	8b 45 08             	mov    0x8(%ebp),%eax
    3ef0:	89 04 24             	mov    %eax,(%esp)
    3ef3:	e8 10 fe ff ff       	call   3d08 <putc>
          s++;
    3ef8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3efc:	eb 01                	jmp    3eff <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
        ...
        while(*s != 0){
    3efe:	90                   	nop
    3eff:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3f02:	0f b6 00             	movzbl (%eax),%eax
    3f05:	84 c0                	test   %al,%al
    3f07:	75 d7                	jne    3ee0 <printf+0x101>
    3f09:	eb 68                	jmp    3f73 <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3f0b:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3f0f:	75 1d                	jne    3f2e <printf+0x14f>
        putc(fd, *ap);
    3f11:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f14:	8b 00                	mov    (%eax),%eax
    3f16:	0f be c0             	movsbl %al,%eax
    3f19:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f1d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f20:	89 04 24             	mov    %eax,(%esp)
    3f23:	e8 e0 fd ff ff       	call   3d08 <putc>
        ap++;
    3f28:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f2c:	eb 45                	jmp    3f73 <printf+0x194>
      } else if(c == '%'){
    3f2e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f32:	75 17                	jne    3f4b <printf+0x16c>
        putc(fd, c);
    3f34:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f37:	0f be c0             	movsbl %al,%eax
    3f3a:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f3e:	8b 45 08             	mov    0x8(%ebp),%eax
    3f41:	89 04 24             	mov    %eax,(%esp)
    3f44:	e8 bf fd ff ff       	call   3d08 <putc>
    3f49:	eb 28                	jmp    3f73 <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f4b:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f52:	00 
    3f53:	8b 45 08             	mov    0x8(%ebp),%eax
    3f56:	89 04 24             	mov    %eax,(%esp)
    3f59:	e8 aa fd ff ff       	call   3d08 <putc>
        putc(fd, c);
    3f5e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f61:	0f be c0             	movsbl %al,%eax
    3f64:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f68:	8b 45 08             	mov    0x8(%ebp),%eax
    3f6b:	89 04 24             	mov    %eax,(%esp)
    3f6e:	e8 95 fd ff ff       	call   3d08 <putc>
      }
      state = 0;
    3f73:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f7a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f7e:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f81:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f84:	01 d0                	add    %edx,%eax
    3f86:	0f b6 00             	movzbl (%eax),%eax
    3f89:	84 c0                	test   %al,%al
    3f8b:	0f 85 70 fe ff ff    	jne    3e01 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    3f97:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3f9a:	8b 45 08             	mov    0x8(%ebp),%eax
    3f9d:	83 e8 08             	sub    $0x8,%eax
    3fa0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3fa3:	a1 e8 65 00 00       	mov    0x65e8,%eax
    3fa8:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fab:	eb 24                	jmp    3fd1 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3fad:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fb0:	8b 00                	mov    (%eax),%eax
    3fb2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fb5:	77 12                	ja     3fc9 <free+0x35>
    3fb7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fba:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fbd:	77 24                	ja     3fe3 <free+0x4f>
    3fbf:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fc2:	8b 00                	mov    (%eax),%eax
    3fc4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fc7:	77 1a                	ja     3fe3 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3fce:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fd1:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fd4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fd7:	76 d4                	jbe    3fad <free+0x19>
    3fd9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fdc:	8b 00                	mov    (%eax),%eax
    3fde:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fe1:	76 ca                	jbe    3fad <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3fe3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fe6:	8b 40 04             	mov    0x4(%eax),%eax
    3fe9:	c1 e0 03             	shl    $0x3,%eax
    3fec:	89 c2                	mov    %eax,%edx
    3fee:	03 55 f8             	add    -0x8(%ebp),%edx
    3ff1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3ff4:	8b 00                	mov    (%eax),%eax
    3ff6:	39 c2                	cmp    %eax,%edx
    3ff8:	75 24                	jne    401e <free+0x8a>
    bp->s.size += p->s.ptr->s.size;
    3ffa:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3ffd:	8b 50 04             	mov    0x4(%eax),%edx
    4000:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4003:	8b 00                	mov    (%eax),%eax
    4005:	8b 40 04             	mov    0x4(%eax),%eax
    4008:	01 c2                	add    %eax,%edx
    400a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    400d:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    4010:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4013:	8b 00                	mov    (%eax),%eax
    4015:	8b 10                	mov    (%eax),%edx
    4017:	8b 45 f8             	mov    -0x8(%ebp),%eax
    401a:	89 10                	mov    %edx,(%eax)
    401c:	eb 0a                	jmp    4028 <free+0x94>
  } else
    bp->s.ptr = p->s.ptr;
    401e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4021:	8b 10                	mov    (%eax),%edx
    4023:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4026:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4028:	8b 45 fc             	mov    -0x4(%ebp),%eax
    402b:	8b 40 04             	mov    0x4(%eax),%eax
    402e:	c1 e0 03             	shl    $0x3,%eax
    4031:	03 45 fc             	add    -0x4(%ebp),%eax
    4034:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4037:	75 20                	jne    4059 <free+0xc5>
    p->s.size += bp->s.size;
    4039:	8b 45 fc             	mov    -0x4(%ebp),%eax
    403c:	8b 50 04             	mov    0x4(%eax),%edx
    403f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4042:	8b 40 04             	mov    0x4(%eax),%eax
    4045:	01 c2                	add    %eax,%edx
    4047:	8b 45 fc             	mov    -0x4(%ebp),%eax
    404a:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    404d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4050:	8b 10                	mov    (%eax),%edx
    4052:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4055:	89 10                	mov    %edx,(%eax)
    4057:	eb 08                	jmp    4061 <free+0xcd>
  } else
    p->s.ptr = bp;
    4059:	8b 45 fc             	mov    -0x4(%ebp),%eax
    405c:	8b 55 f8             	mov    -0x8(%ebp),%edx
    405f:	89 10                	mov    %edx,(%eax)
  freep = p;
    4061:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4064:	a3 e8 65 00 00       	mov    %eax,0x65e8
}
    4069:	c9                   	leave  
    406a:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    406e:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4071:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4078:	77 07                	ja     4081 <morecore+0x16>
    nu = 4096;
    407a:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4081:	8b 45 08             	mov    0x8(%ebp),%eax
    4084:	c1 e0 03             	shl    $0x3,%eax
    4087:	89 04 24             	mov    %eax,(%esp)
    408a:	e8 21 fc ff ff       	call   3cb0 <sbrk>
    408f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4092:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4096:	75 07                	jne    409f <morecore+0x34>
    return 0;
    4098:	b8 00 00 00 00       	mov    $0x0,%eax
    409d:	eb 22                	jmp    40c1 <morecore+0x56>
  hp = (Header*)p;
    409f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40a2:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    40a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a8:	8b 55 08             	mov    0x8(%ebp),%edx
    40ab:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    40ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40b1:	83 c0 08             	add    $0x8,%eax
    40b4:	89 04 24             	mov    %eax,(%esp)
    40b7:	e8 d8 fe ff ff       	call   3f94 <free>
  return freep;
    40bc:	a1 e8 65 00 00       	mov    0x65e8,%eax
}
    40c1:	c9                   	leave  
    40c2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    40cc:	83 c0 07             	add    $0x7,%eax
    40cf:	c1 e8 03             	shr    $0x3,%eax
    40d2:	83 c0 01             	add    $0x1,%eax
    40d5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40d8:	a1 e8 65 00 00       	mov    0x65e8,%eax
    40dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40e4:	75 23                	jne    4109 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40e6:	c7 45 f0 e0 65 00 00 	movl   $0x65e0,-0x10(%ebp)
    40ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f0:	a3 e8 65 00 00       	mov    %eax,0x65e8
    40f5:	a1 e8 65 00 00       	mov    0x65e8,%eax
    40fa:	a3 e0 65 00 00       	mov    %eax,0x65e0
    base.s.size = 0;
    40ff:	c7 05 e4 65 00 00 00 	movl   $0x0,0x65e4
    4106:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4109:	8b 45 f0             	mov    -0x10(%ebp),%eax
    410c:	8b 00                	mov    (%eax),%eax
    410e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4111:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4114:	8b 40 04             	mov    0x4(%eax),%eax
    4117:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    411a:	72 4d                	jb     4169 <malloc+0xa6>
      if(p->s.size == nunits)
    411c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411f:	8b 40 04             	mov    0x4(%eax),%eax
    4122:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4125:	75 0c                	jne    4133 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4127:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412a:	8b 10                	mov    (%eax),%edx
    412c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    412f:	89 10                	mov    %edx,(%eax)
    4131:	eb 26                	jmp    4159 <malloc+0x96>
      else {
        p->s.size -= nunits;
    4133:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4136:	8b 40 04             	mov    0x4(%eax),%eax
    4139:	89 c2                	mov    %eax,%edx
    413b:	2b 55 ec             	sub    -0x14(%ebp),%edx
    413e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4141:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4144:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4147:	8b 40 04             	mov    0x4(%eax),%eax
    414a:	c1 e0 03             	shl    $0x3,%eax
    414d:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4150:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4153:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4156:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4159:	8b 45 f0             	mov    -0x10(%ebp),%eax
    415c:	a3 e8 65 00 00       	mov    %eax,0x65e8
      return (void*)(p + 1);
    4161:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4164:	83 c0 08             	add    $0x8,%eax
    4167:	eb 38                	jmp    41a1 <malloc+0xde>
    }
    if(p == freep)
    4169:	a1 e8 65 00 00       	mov    0x65e8,%eax
    416e:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4171:	75 1b                	jne    418e <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4173:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4176:	89 04 24             	mov    %eax,(%esp)
    4179:	e8 ed fe ff ff       	call   406b <morecore>
    417e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4181:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4185:	75 07                	jne    418e <malloc+0xcb>
        return 0;
    4187:	b8 00 00 00 00       	mov    $0x0,%eax
    418c:	eb 13                	jmp    41a1 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4191:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4194:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4197:	8b 00                	mov    (%eax),%eax
    4199:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    419c:	e9 70 ff ff ff       	jmp    4111 <malloc+0x4e>
}
    41a1:	c9                   	leave  
    41a2:	c3                   	ret    
    41a3:	90                   	nop

000041a4 <semaphore_create>:
#include "semaphore.h"
#include "types.h"
#include "user.h"
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  struct semaphore* sem=malloc(sizeof(struct semaphore)); 
    41aa:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
    41b1:	e8 0d ff ff ff       	call   40c3 <malloc>
    41b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  // acquire semaphors
  sem->s1 = binary_semaphore_create(1);
    41b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    41c0:	e8 2b fb ff ff       	call   3cf0 <binary_semaphore_create>
    41c5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41c8:	89 02                	mov    %eax,(%edx)
  
  // s2 should be initialized with the min{1,initial_semaphore_value}
  if(initial_semaphore_value >= 1){
    41ca:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    41ce:	7e 14                	jle    41e4 <semaphore_create+0x40>
    sem->s2 = binary_semaphore_create(1);
    41d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    41d7:	e8 14 fb ff ff       	call   3cf0 <binary_semaphore_create>
    41dc:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41df:	89 42 04             	mov    %eax,0x4(%edx)
    41e2:	eb 11                	jmp    41f5 <semaphore_create+0x51>
  }else{
    sem->s2 = binary_semaphore_create(initial_semaphore_value);
    41e4:	8b 45 08             	mov    0x8(%ebp),%eax
    41e7:	89 04 24             	mov    %eax,(%esp)
    41ea:	e8 01 fb ff ff       	call   3cf0 <binary_semaphore_create>
    41ef:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41f2:	89 42 04             	mov    %eax,0x4(%edx)
  }
  
  if(sem->s1 == -1 || sem->s2 == -1){
    41f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41f8:	8b 00                	mov    (%eax),%eax
    41fa:	83 f8 ff             	cmp    $0xffffffff,%eax
    41fd:	74 0b                	je     420a <semaphore_create+0x66>
    41ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4202:	8b 40 04             	mov    0x4(%eax),%eax
    4205:	83 f8 ff             	cmp    $0xffffffff,%eax
    4208:	75 26                	jne    4230 <semaphore_create+0x8c>
     printf(1,"we had a probalem initialize in semaphore_create\n");
    420a:	c7 44 24 04 c8 5c 00 	movl   $0x5cc8,0x4(%esp)
    4211:	00 
    4212:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4219:	e8 c1 fb ff ff       	call   3ddf <printf>
     free(sem);
    421e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4221:	89 04 24             	mov    %eax,(%esp)
    4224:	e8 6b fd ff ff       	call   3f94 <free>
     return 0;
    4229:	b8 00 00 00 00       	mov    $0x0,%eax
    422e:	eb 15                	jmp    4245 <semaphore_create+0xa1>
  }
  //initialize value
  sem->value = initial_semaphore_value;//dynamic
    4230:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4233:	8b 55 08             	mov    0x8(%ebp),%edx
    4236:	89 50 08             	mov    %edx,0x8(%eax)
  sem->initial_value = initial_semaphore_value;//static
    4239:	8b 45 f4             	mov    -0xc(%ebp),%eax
    423c:	8b 55 08             	mov    0x8(%ebp),%edx
    423f:	89 50 0c             	mov    %edx,0xc(%eax)
  
  return sem;
    4242:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
    4245:	c9                   	leave  
    4246:	c3                   	ret    

00004247 <semaphore_down>:
void semaphore_down(struct semaphore* sem ){
    4247:	55                   	push   %ebp
    4248:	89 e5                	mov    %esp,%ebp
    424a:	83 ec 18             	sub    $0x18,%esp
  binary_semaphore_down(sem->s2);
    424d:	8b 45 08             	mov    0x8(%ebp),%eax
    4250:	8b 40 04             	mov    0x4(%eax),%eax
    4253:	89 04 24             	mov    %eax,(%esp)
    4256:	e8 9d fa ff ff       	call   3cf8 <binary_semaphore_down>
  binary_semaphore_down(sem->s1);
    425b:	8b 45 08             	mov    0x8(%ebp),%eax
    425e:	8b 00                	mov    (%eax),%eax
    4260:	89 04 24             	mov    %eax,(%esp)
    4263:	e8 90 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value--;	
    4268:	8b 45 08             	mov    0x8(%ebp),%eax
    426b:	8b 40 08             	mov    0x8(%eax),%eax
    426e:	8d 50 ff             	lea    -0x1(%eax),%edx
    4271:	8b 45 08             	mov    0x8(%ebp),%eax
    4274:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value > 0){
    4277:	8b 45 08             	mov    0x8(%ebp),%eax
    427a:	8b 40 08             	mov    0x8(%eax),%eax
    427d:	85 c0                	test   %eax,%eax
    427f:	7e 0e                	jle    428f <semaphore_down+0x48>
   binary_semaphore_up(sem->s2);
    4281:	8b 45 08             	mov    0x8(%ebp),%eax
    4284:	8b 40 04             	mov    0x4(%eax),%eax
    4287:	89 04 24             	mov    %eax,(%esp)
    428a:	e8 71 fa ff ff       	call   3d00 <binary_semaphore_up>
  }
  binary_semaphore_up(sem->s1); 
    428f:	8b 45 08             	mov    0x8(%ebp),%eax
    4292:	8b 00                	mov    (%eax),%eax
    4294:	89 04 24             	mov    %eax,(%esp)
    4297:	e8 64 fa ff ff       	call   3d00 <binary_semaphore_up>
}
    429c:	c9                   	leave  
    429d:	c3                   	ret    

0000429e <semaphore_up>:
void semaphore_up(struct semaphore* sem ){
    429e:	55                   	push   %ebp
    429f:	89 e5                	mov    %esp,%ebp
    42a1:	83 ec 18             	sub    $0x18,%esp
  binary_semaphore_down(sem->s1);
    42a4:	8b 45 08             	mov    0x8(%ebp),%eax
    42a7:	8b 00                	mov    (%eax),%eax
    42a9:	89 04 24             	mov    %eax,(%esp)
    42ac:	e8 47 fa ff ff       	call   3cf8 <binary_semaphore_down>
  sem->value++;	
    42b1:	8b 45 08             	mov    0x8(%ebp),%eax
    42b4:	8b 40 08             	mov    0x8(%eax),%eax
    42b7:	8d 50 01             	lea    0x1(%eax),%edx
    42ba:	8b 45 08             	mov    0x8(%ebp),%eax
    42bd:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value ==1){
    42c0:	8b 45 08             	mov    0x8(%ebp),%eax
    42c3:	8b 40 08             	mov    0x8(%eax),%eax
    42c6:	83 f8 01             	cmp    $0x1,%eax
    42c9:	75 0e                	jne    42d9 <semaphore_up+0x3b>
   binary_semaphore_up(sem->s2); 
    42cb:	8b 45 08             	mov    0x8(%ebp),%eax
    42ce:	8b 40 04             	mov    0x4(%eax),%eax
    42d1:	89 04 24             	mov    %eax,(%esp)
    42d4:	e8 27 fa ff ff       	call   3d00 <binary_semaphore_up>
   }
  binary_semaphore_up(sem->s1);
    42d9:	8b 45 08             	mov    0x8(%ebp),%eax
    42dc:	8b 00                	mov    (%eax),%eax
    42de:	89 04 24             	mov    %eax,(%esp)
    42e1:	e8 1a fa ff ff       	call   3d00 <binary_semaphore_up>
}
    42e6:	c9                   	leave  
    42e7:	c3                   	ret    

000042e8 <semaphore_free>:

void semaphore_free(struct semaphore* sem){
    42e8:	55                   	push   %ebp
    42e9:	89 e5                	mov    %esp,%ebp
    42eb:	83 ec 18             	sub    $0x18,%esp
  free(sem);
    42ee:	8b 45 08             	mov    0x8(%ebp),%eax
    42f1:	89 04 24             	mov    %eax,(%esp)
    42f4:	e8 9b fc ff ff       	call   3f94 <free>
}
    42f9:	c9                   	leave  
    42fa:	c3                   	ret    
    42fb:	90                   	nop
...
BB_create(int max_capacity){
    42fc:	55                   	push   %ebp
    42fd:	89 e5                	mov    %esp,%ebp
    42ff:	83 ec 38             	sub    $0x38,%esp
  //initialize
  struct BB* buf = malloc(sizeof(struct BB));
    4302:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
    4309:	e8 b5 fd ff ff       	call   40c3 <malloc>
    430e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(buf,0,sizeof(struct BB));
    4311:	c7 44 24 08 20 00 00 	movl   $0x20,0x8(%esp)
    4318:	00 
    4319:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    4320:	00 
    4321:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4324:	89 04 24             	mov    %eax,(%esp)
    4327:	e8 57 f7 ff ff       	call   3a83 <memset>
 
  buf->buffer_size = max_capacity;
    432c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    432f:	8b 55 08             	mov    0x8(%ebp),%edx
    4332:	89 10                	mov    %edx,(%eax)
  buf->mutex = binary_semaphore_create(1);  
    4334:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    433b:	e8 b0 f9 ff ff       	call   3cf0 <binary_semaphore_create>
    4340:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4343:	89 42 04             	mov    %eax,0x4(%edx)
  buf->empty = semaphore_create(max_capacity);
    4346:	8b 45 08             	mov    0x8(%ebp),%eax
    4349:	89 04 24             	mov    %eax,(%esp)
    434c:	e8 53 fe ff ff       	call   41a4 <semaphore_create>
    4351:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4354:	89 42 08             	mov    %eax,0x8(%edx)
  buf->full = semaphore_create(0);
    4357:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    435e:	e8 41 fe ff ff       	call   41a4 <semaphore_create>
    4363:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4366:	89 42 0c             	mov    %eax,0xc(%edx)
  buf->pointer_to_elements = malloc(sizeof(void*)*max_capacity);
    4369:	8b 45 08             	mov    0x8(%ebp),%eax
    436c:	c1 e0 02             	shl    $0x2,%eax
    436f:	89 04 24             	mov    %eax,(%esp)
    4372:	e8 4c fd ff ff       	call   40c3 <malloc>
    4377:	8b 55 f4             	mov    -0xc(%ebp),%edx
    437a:	89 42 1c             	mov    %eax,0x1c(%edx)
  memset(buf->pointer_to_elements,0,sizeof(void*)*max_capacity);
    437d:	8b 45 08             	mov    0x8(%ebp),%eax
    4380:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
    4387:	8b 45 f4             	mov    -0xc(%ebp),%eax
    438a:	8b 40 1c             	mov    0x1c(%eax),%eax
    438d:	89 54 24 08          	mov    %edx,0x8(%esp)
    4391:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    4398:	00 
    4399:	89 04 24             	mov    %eax,(%esp)
    439c:	e8 e2 f6 ff ff       	call   3a83 <memset>
  ...
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
    43ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43ae:	8b 40 04             	mov    0x4(%eax),%eax
    43b1:	83 f8 ff             	cmp    $0xffffffff,%eax
    43b4:	74 14                	je     43ca <BB_create+0xce>
    43b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43b9:	8b 40 08             	mov    0x8(%eax),%eax
    43bc:	85 c0                	test   %eax,%eax
    43be:	74 0a                	je     43ca <BB_create+0xce>
    43c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43c3:	8b 40 0c             	mov    0xc(%eax),%eax
    43c6:	85 c0                	test   %eax,%eax
    43c8:	75 44                	jne    440e <BB_create+0x112>
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    43cd:	8b 48 0c             	mov    0xc(%eax),%ecx
    43d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43d3:	8b 50 08             	mov    0x8(%eax),%edx
    43d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43d9:	8b 40 04             	mov    0x4(%eax),%eax
    43dc:	89 4c 24 10          	mov    %ecx,0x10(%esp)
    43e0:	89 54 24 0c          	mov    %edx,0xc(%esp)
    43e4:	89 44 24 08          	mov    %eax,0x8(%esp)
    43e8:	c7 44 24 04 fc 5c 00 	movl   $0x5cfc,0x4(%esp)
    43ef:	00 
    43f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    43f7:	e8 e3 f9 ff ff       	call   3ddf <printf>
   BB_free(buf);
    43fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43ff:	89 04 24             	mov    %eax,(%esp)
    4402:	e8 20 01 00 00       	call   4527 <BB_free>
   //free(buf->pointer_to_elements);//TODO remove
   //free(buf);
   buf =0;  
    4407:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
{ //TODO mix
    4413:	55                   	push   %ebp
    4414:	89 e5                	mov    %esp,%ebp
    4416:	83 ec 18             	sub    $0x18,%esp
  ...
  */
  semaphore_down(bb->empty);
    ...
    441c:	8b 40 08             	mov    0x8(%eax),%eax
    441f:	89 04 24             	mov    %eax,(%esp)
    4422:	e8 20 fe ff ff       	call   4247 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    4427:	8b 45 08             	mov    0x8(%ebp),%eax
    442a:	8b 40 04             	mov    0x4(%eax),%eax
    442d:	89 04 24             	mov    %eax,(%esp)
    4430:	e8 c3 f8 ff ff       	call   3cf8 <binary_semaphore_down>
   //insert item
  bb->pointer_to_elements[bb->end] = element;
    4435:	8b 45 08             	mov    0x8(%ebp),%eax
    4438:	8b 50 1c             	mov    0x1c(%eax),%edx
    443b:	8b 45 08             	mov    0x8(%ebp),%eax
    443e:	8b 40 18             	mov    0x18(%eax),%eax
    4441:	c1 e0 02             	shl    $0x2,%eax
    4444:	01 c2                	add    %eax,%edx
    4446:	8b 45 0c             	mov    0xc(%ebp),%eax
    4449:	89 02                	mov    %eax,(%edx)
  ++bb->end;
    444b:	8b 45 08             	mov    0x8(%ebp),%eax
    444e:	8b 40 18             	mov    0x18(%eax),%eax
    4451:	8d 50 01             	lea    0x1(%eax),%edx
    4454:	8b 45 08             	mov    0x8(%ebp),%eax
    4457:	89 50 18             	mov    %edx,0x18(%eax)
  bb->end = bb->end%bb->buffer_size;
    445a:	8b 45 08             	mov    0x8(%ebp),%eax
    445d:	8b 40 18             	mov    0x18(%eax),%eax
    4460:	8b 55 08             	mov    0x8(%ebp),%edx
    4463:	8b 0a                	mov    (%edx),%ecx
    4465:	89 c2                	mov    %eax,%edx
    4467:	c1 fa 1f             	sar    $0x1f,%edx
    446a:	f7 f9                	idiv   %ecx
    446c:	8b 45 08             	mov    0x8(%ebp),%eax
    446f:	89 50 18             	mov    %edx,0x18(%eax)
  binary_semaphore_up(bb->mutex);
    4472:	8b 45 08             	mov    0x8(%ebp),%eax
    4475:	8b 40 04             	mov    0x4(%eax),%eax
    4478:	89 04 24             	mov    %eax,(%esp)
    447b:	e8 80 f8 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->full);
    4480:	8b 45 08             	mov    0x8(%ebp),%eax
    4483:	8b 40 0c             	mov    0xc(%eax),%eax
    4486:	89 04 24             	mov    %eax,(%esp)
    4489:	e8 10 fe ff ff       	call   429e <semaphore_up>
...
{//TODO clean and mix
    ...
    4493:	83 ec 28             	sub    $0x28,%esp
  
  void* element_to_pop;
  semaphore_down(bb->full);
    4496:	8b 45 08             	mov    0x8(%ebp),%eax
    4499:	8b 40 0c             	mov    0xc(%eax),%eax
    449c:	89 04 24             	mov    %eax,(%esp)
    449f:	e8 a3 fd ff ff       	call   4247 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    44a4:	8b 45 08             	mov    0x8(%ebp),%eax
    44a7:	8b 40 04             	mov    0x4(%eax),%eax
    44aa:	89 04 24             	mov    %eax,(%esp)
    44ad:	e8 46 f8 ff ff       	call   3cf8 <binary_semaphore_down>
  element_to_pop = bb-> pointer_to_elements[bb->start];
    44b2:	8b 45 08             	mov    0x8(%ebp),%eax
    44b5:	8b 50 1c             	mov    0x1c(%eax),%edx
    44b8:	8b 45 08             	mov    0x8(%ebp),%eax
    44bb:	8b 40 14             	mov    0x14(%eax),%eax
    44be:	c1 e0 02             	shl    $0x2,%eax
    44c1:	01 d0                	add    %edx,%eax
    44c3:	8b 00                	mov    (%eax),%eax
    44c5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  bb->pointer_to_elements[bb->start] =0;
    44c8:	8b 45 08             	mov    0x8(%ebp),%eax
    44cb:	8b 50 1c             	mov    0x1c(%eax),%edx
    44ce:	8b 45 08             	mov    0x8(%ebp),%eax
    44d1:	8b 40 14             	mov    0x14(%eax),%eax
    44d4:	c1 e0 02             	shl    $0x2,%eax
    44d7:	01 d0                	add    %edx,%eax
    44d9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ++bb->start;
    44df:	8b 45 08             	mov    0x8(%ebp),%eax
    44e2:	8b 40 14             	mov    0x14(%eax),%eax
    44e5:	8d 50 01             	lea    0x1(%eax),%edx
    44e8:	8b 45 08             	mov    0x8(%ebp),%eax
    44eb:	89 50 14             	mov    %edx,0x14(%eax)
  bb->start = bb->start%bb->buffer_size;
    44ee:	8b 45 08             	mov    0x8(%ebp),%eax
    44f1:	8b 40 14             	mov    0x14(%eax),%eax
    44f4:	8b 55 08             	mov    0x8(%ebp),%edx
    44f7:	8b 0a                	mov    (%edx),%ecx
    44f9:	89 c2                	mov    %eax,%edx
    44fb:	c1 fa 1f             	sar    $0x1f,%edx
    44fe:	f7 f9                	idiv   %ecx
    4500:	8b 45 08             	mov    0x8(%ebp),%eax
    4503:	89 50 14             	mov    %edx,0x14(%eax)
  binary_semaphore_up(bb->mutex);
    4506:	8b 45 08             	mov    0x8(%ebp),%eax
    4509:	8b 40 04             	mov    0x4(%eax),%eax
    450c:	89 04 24             	mov    %eax,(%esp)
    450f:	e8 ec f7 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->empty);
    4514:	8b 45 08             	mov    0x8(%ebp),%eax
    4517:	8b 40 08             	mov    0x8(%eax),%eax
    451a:	89 04 24             	mov    %eax,(%esp)
    451d:	e8 7c fd ff ff       	call   429e <semaphore_up>
  return element_to_pop;
    4522:	8b 45 f4             	mov    -0xc(%ebp),%eax
...
void BB_free(struct BB* bb){
  ...
  free(bb->pointer_to_elements);
    ...
    4530:	8b 40 1c             	mov    0x1c(%eax),%eax
    4533:	89 04 24             	mov    %eax,(%esp)
    4536:	e8 59 fa ff ff       	call   3f94 <free>
  free(bb);
    453b:	8b 45 08             	mov    0x8(%ebp),%eax
    453e:	89 04 24             	mov    %eax,(%esp)
    4541:	e8 4e fa ff ff       	call   3f94 <free>
}
    4546:	c9                   	leave  
    4547:	c3                   	ret    
...
int BB_size(struct BB* bb){
    ...
    454b:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
    454e:	c7 44 24 04 48 5d 00 	movl   $0x5d48,0x4(%esp)
    4555:	00 
    4556:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    455d:	e8 7d f8 ff ff       	call   3ddf <printf>
  int ans =0;
    4562:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
    4569:	8b 45 08             	mov    0x8(%ebp),%eax
    456c:	8b 40 0c             	mov    0xc(%eax),%eax
    456f:	89 04 24             	mov    %eax,(%esp)
    4572:	e8 d0 fc ff ff       	call   4247 <semaphore_down>
  binary_semaphore_down(bb->mutex);
    4577:	8b 45 08             	mov    0x8(%ebp),%eax
    457a:	8b 40 04             	mov    0x4(%eax),%eax
    457d:	89 04 24             	mov    %eax,(%esp)
    4580:	e8 73 f7 ff ff       	call   3cf8 <binary_semaphore_down>
  ans = bb->full->value;
    4585:	8b 45 08             	mov    0x8(%ebp),%eax
    4588:	8b 40 0c             	mov    0xc(%eax),%eax
    458b:	8b 40 08             	mov    0x8(%eax),%eax
    458e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  binary_semaphore_up(bb->mutex);
    4591:	8b 45 08             	mov    0x8(%ebp),%eax
    4594:	8b 40 04             	mov    0x4(%eax),%eax
    4597:	89 04 24             	mov    %eax,(%esp)
    459a:	e8 61 f7 ff ff       	call   3d00 <binary_semaphore_up>
  semaphore_up(bb->empty);
    459f:	8b 45 08             	mov    0x8(%ebp),%eax
    45a2:	8b 40 08             	mov    0x8(%eax),%eax
    45a5:	89 04 24             	mov    %eax,(%esp)
    45a8:	e8 f1 fc ff ff       	call   429e <semaphore_up>
  return ans;
    45ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
    45b0:	c9                   	leave  
    45b1:	c3                   	ret    

000045b2 <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
    45b2:	55                   	push   %ebp
    45b3:	89 e5                	mov    %esp,%ebp
    45b5:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
    45b8:	c7 44 24 04 4e 5d 00 	movl   $0x5d4e,0x4(%esp)
    45bf:	00 
    45c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    45c7:	e8 13 f8 ff ff       	call   3ddf <printf>
  int ans =0;
    45cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  binary_semaphore_down(bb->mutex);
    45d3:	8b 45 08             	mov    0x8(%ebp),%eax
    45d6:	8b 40 04             	mov    0x4(%eax),%eax
    45d9:	89 04 24             	mov    %eax,(%esp)
    45dc:	e8 17 f7 ff ff       	call   3cf8 <binary_semaphore_down>
  ans = bb->buffer_size;
    45e1:	8b 45 08             	mov    0x8(%ebp),%eax
    45e4:	8b 00                	mov    (%eax),%eax
    45e6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  binary_semaphore_up(bb->mutex);
    45e9:	8b 45 08             	mov    0x8(%ebp),%eax
    45ec:	8b 40 04             	mov    0x4(%eax),%eax
    45ef:	89 04 24             	mov    %eax,(%esp)
    45f2:	e8 09 f7 ff ff       	call   3d00 <binary_semaphore_up>
  return ans;
    45f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45fa:	c9                   	leave  
    45fb:	c3                   	ret    
