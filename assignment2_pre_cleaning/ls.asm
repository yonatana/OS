...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 58 14 00 00 	movl   $0x1458,(%esp)
  ...
  8a:	05 58 14 00 00       	add    $0x1458,%eax
  ...
  return buf;
  a3:	b8 58 14 00 00       	mov    $0x1458,%eax
}
...
ls(char *path)
{
  ...
  dd:	c7 44 24 04 8c 0f 00 	movl   $0xf8c,0x4(%esp)
  e4:	00 
 ...
 116:	c7 44 24 04 a0 0f 00 	movl   $0xfa0,0x4(%esp)
 11d:	00 
 ...
 181:	c7 44 24 04 b4 0f 00 	movl   $0xfb4,0x4(%esp)
 188:	00 
 ...
 1af:	c7 44 24 04 c1 0f 00 	movl   $0xfc1,0x4(%esp)
 1b6:	00 
 ...
 264:	c7 44 24 04 a0 0f 00 	movl   $0xfa0,0x4(%esp)
 26b:	00 
 ...
 2ae:	c7 44 24 04 b4 0f 00 	movl   $0xfb4,0x4(%esp)
 2b5:	00 
...
main(int argc, char *argv[])
{
 ...
 30f:	7f 11                	jg     322 <main+0x20>
    ls(".");
 311:	c7 04 24 d4 0f 00 00 	movl   $0xfd4,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 706:	0f b6 90 44 14 00 00 	movzbl 0x1444(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 865:	75 27                	jne    88e <printf+0x11f>
          s = "(null)";
 867:	c7 45 f4 d6 0f 00 00 	movl   $0xfd6,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 933:	a1 70 14 00 00       	mov    0x1470,%eax
...
free(void *ap)
{
 ...
 9f4:	a3 70 14 00 00       	mov    %eax,0x1470
}
 9f9:	c9                   	leave  
 9fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a47:	e8 d8 fe ff ff       	call   924 <free>
  return freep;
 a4c:	a1 70 14 00 00       	mov    0x1470,%eax
}
 a51:	c9                   	leave  
 a52:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a65:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a68:	a1 70 14 00 00       	mov    0x1470,%eax
 a6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a70:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a74:	75 23                	jne    a99 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a76:	c7 45 f0 68 14 00 00 	movl   $0x1468,-0x10(%ebp)
 a7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a80:	a3 70 14 00 00       	mov    %eax,0x1470
 a85:	a1 70 14 00 00       	mov    0x1470,%eax
 a8a:	a3 68 14 00 00       	mov    %eax,0x1468
    base.s.size = 0;
 a8f:	c7 05 6c 14 00 00 00 	movl   $0x0,0x146c
 a96:	00 00 00 
  }
 ...
 aec:	a3 70 14 00 00       	mov    %eax,0x1470
      return (void*)(p + 1);
 ...
 af7:	eb 38                	jmp    b31 <malloc+0xde>
    ...
    if(p == freep)
 af9:	a1 70 14 00 00       	mov    0x1470,%eax
...
void semaphore_free(struct semaphore* sem){
 ...
 c84:	e8 9b fc ff ff       	call   924 <free>
}
 c89:	c9                   	leave  
 c8a:	c3                   	ret    
 c8b:	90                   	nop
...
BB_create(int max_capacity){
 ...
 d5d:	8b 48 0c             	mov    0xc(%eax),%ecx
 d60:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d63:	8b 50 08             	mov    0x8(%eax),%edx
 d66:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d69:	8b 40 04             	mov    0x4(%eax),%eax
 d6c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
 d70:	89 54 24 0c          	mov    %edx,0xc(%esp)
 d74:	89 44 24 08          	mov    %eax,0x8(%esp)
 d78:	c7 44 24 04 14 10 00 	movl   $0x1014,0x4(%esp)
 d7f:	00 
 d80:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 d87:	e8 e3 f9 ff ff       	call   76f <printf>
   BB_free(buf);
 d8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d8f:	89 04 24             	mov    %eax,(%esp)
 d92:	e8 20 01 00 00       	call   eb7 <BB_free>
   //free(buf->pointer_to_elements);//TODO remove
   //free(buf);
   buf =0;  
 d97:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
int BB_size(struct BB* bb){
 ...
 edb:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 ede:	c7 44 24 04 60 10 00 	movl   $0x1060,0x4(%esp)
 ee5:	00 
 ee6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 eed:	e8 7d f8 ff ff       	call   76f <printf>
  int ans =0;
 ef2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
 ef9:	8b 45 08             	mov    0x8(%ebp),%eax
 efc:	8b 40 0c             	mov    0xc(%eax),%eax
 eff:	89 04 24             	mov    %eax,(%esp)
 f02:	e8 d0 fc ff ff       	call   bd7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 f07:	8b 45 08             	mov    0x8(%ebp),%eax
 f0a:	8b 40 04             	mov    0x4(%eax),%eax
 f0d:	89 04 24             	mov    %eax,(%esp)
 f10:	e8 73 f7 ff ff       	call   688 <binary_semaphore_down>
  ans = bb->full->value;
 f15:	8b 45 08             	mov    0x8(%ebp),%eax
 f18:	8b 40 0c             	mov    0xc(%eax),%eax
 f1b:	8b 40 08             	mov    0x8(%eax),%eax
 f1e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  binary_semaphore_up(bb->mutex);
 f21:	8b 45 08             	mov    0x8(%ebp),%eax
 f24:	8b 40 04             	mov    0x4(%eax),%eax
 f27:	89 04 24             	mov    %eax,(%esp)
 f2a:	e8 61 f7 ff ff       	call   690 <binary_semaphore_up>
  semaphore_up(bb->empty);
 f2f:	8b 45 08             	mov    0x8(%ebp),%eax
 f32:	8b 40 08             	mov    0x8(%eax),%eax
 f35:	89 04 24             	mov    %eax,(%esp)
 f38:	e8 f1 fc ff ff       	call   c2e <semaphore_up>
  return ans;
...
00000f42 <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 f42:	55                   	push   %ebp
 f43:	89 e5                	mov    %esp,%ebp
 f45:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 f48:	c7 44 24 04 66 10 00 	movl   $0x1066,0x4(%esp)
 f4f:	00 
 f50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 f57:	e8 13 f8 ff ff       	call   76f <printf>
  int ans =0;
