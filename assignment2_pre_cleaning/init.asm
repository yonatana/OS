...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 4f 0d 00 00 	movl   $0xd4f,(%esp)
  ...
  30:	00 
  31:	c7 04 24 4f 0d 00 00 	movl   $0xd4f,(%esp)
  38:	e8 83 03 00 00       	call   3c0 <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 4f 0d 00 00 	movl   $0xd4f,(%esp)
  ...
  6c:	c7 44 24 04 57 0d 00 	movl   $0xd57,0x4(%esp)
  73:	00 
  ...
  90:	c7 44 24 04 6a 0d 00 	movl   $0xd6a,0x4(%esp)
  97:	00 
  ...
  ae:	75 41                	jne    f1 <main+0xf1>
      exec("sh", argv);
  b0:	c7 44 24 04 b4 11 00 	movl   $0x11b4,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 4c 0d 00 00 	movl   $0xd4c,(%esp)
  bf:	e8 ec 02 00 00       	call   3b0 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 7d 0d 00 	movl   $0xd7d,0x4(%esp)
  cb:	00 
  ...
  d8:	e8 9b 02 00 00       	call   378 <exit>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  dd:	c7 44 24 04 93 0d 00 	movl   $0xd93,0x4(%esp)
  e4:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c6:	0f b6 90 bc 11 00 00 	movzbl 0x11bc(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 625:	75 27                	jne    64e <printf+0x11f>
          s = "(null)";
 627:	c7 45 f4 9c 0d 00 00 	movl   $0xd9c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f3:	a1 d8 11 00 00       	mov    0x11d8,%eax
...
free(void *ap)
{
 ...
 7b4:	a3 d8 11 00 00       	mov    %eax,0x11d8
}
 7b9:	c9                   	leave  
 7ba:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 807:	e8 d8 fe ff ff       	call   6e4 <free>
  return freep;
 80c:	a1 d8 11 00 00       	mov    0x11d8,%eax
}
 811:	c9                   	leave  
 812:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 825:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 828:	a1 d8 11 00 00       	mov    0x11d8,%eax
 82d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 830:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 834:	75 23                	jne    859 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 836:	c7 45 f0 d0 11 00 00 	movl   $0x11d0,-0x10(%ebp)
 83d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 840:	a3 d8 11 00 00       	mov    %eax,0x11d8
 845:	a1 d8 11 00 00       	mov    0x11d8,%eax
 84a:	a3 d0 11 00 00       	mov    %eax,0x11d0
    base.s.size = 0;
 84f:	c7 05 d4 11 00 00 00 	movl   $0x0,0x11d4
 856:	00 00 00 
  }
 ...
 8ac:	a3 d8 11 00 00       	mov    %eax,0x11d8
      return (void*)(p + 1);
 ...
 8b7:	eb 38                	jmp    8f1 <malloc+0xde>
    ...
    if(p == freep)
 8b9:	a1 d8 11 00 00       	mov    0x11d8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 95a:	c7 44 24 04 a4 0d 00 	movl   $0xda4,0x4(%esp)
 961:	00 
...
BB_create(int max_capacity){
 ...
 b38:	c7 44 24 04 d8 0d 00 	movl   $0xdd8,0x4(%esp)
 b3f:	00 
 ...
 b52:	e8 20 01 00 00       	call   c77 <BB_free>
...
void BB_free(struct BB* bb){
 ...
 c80:	8b 40 1c             	mov    0x1c(%eax),%eax
 c83:	89 04 24             	mov    %eax,(%esp)
 c86:	e8 59 fa ff ff       	call   6e4 <free>
  free(bb);
 c8b:	8b 45 08             	mov    0x8(%ebp),%eax
 c8e:	89 04 24             	mov    %eax,(%esp)
 c91:	e8 4e fa ff ff       	call   6e4 <free>
}
 c96:	c9                   	leave  
 c97:	c3                   	ret    
...
int BB_size(struct BB* bb){
 ...
 c9b:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 c9e:	c7 44 24 04 24 0e 00 	movl   $0xe24,0x4(%esp)
 ca5:	00 
 ca6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 cad:	e8 7d f8 ff ff       	call   52f <printf>
  int ans =0;
 cb2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
 cb9:	8b 45 08             	mov    0x8(%ebp),%eax
 cbc:	8b 40 0c             	mov    0xc(%eax),%eax
 cbf:	89 04 24             	mov    %eax,(%esp)
 cc2:	e8 d0 fc ff ff       	call   997 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 cc7:	8b 45 08             	mov    0x8(%ebp),%eax
 cca:	8b 40 04             	mov    0x4(%eax),%eax
 ccd:	89 04 24             	mov    %eax,(%esp)
 cd0:	e8 73 f7 ff ff       	call   448 <binary_semaphore_down>
  ans = bb->full->value;
 ...
 cea:	e8 61 f7 ff ff       	call   450 <binary_semaphore_up>
  semaphore_up(bb->empty);
 cef:	8b 45 08             	mov    0x8(%ebp),%eax
 cf2:	8b 40 08             	mov    0x8(%eax),%eax
 cf5:	89 04 24             	mov    %eax,(%esp)
 cf8:	e8 f1 fc ff ff       	call   9ee <semaphore_up>
  return ans;
...
00000d02 <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 d02:	55                   	push   %ebp
 d03:	89 e5                	mov    %esp,%ebp
 d05:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 d08:	c7 44 24 04 2a 0e 00 	movl   $0xe2a,0x4(%esp)
 d0f:	00 
 d10:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 d17:	e8 13 f8 ff ff       	call   52f <printf>
  int ans =0;
 ...
 d2c:	e8 17 f7 ff ff       	call   448 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 d42:	e8 09 f7 ff ff       	call   450 <binary_semaphore_up>
  return ans;
