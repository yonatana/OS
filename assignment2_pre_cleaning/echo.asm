...
main(int argc, char *argv[])
{
  ...
  1f:	b8 a0 0c 00 00       	mov    $0xca0,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 a2 0c 00 00       	mov    $0xca2,%eax
  ...
  3f:	c7 44 24 04 a4 0c 00 	movl   $0xca4,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	0f b6 90 c0 10 00 00 	movzbl 0x10c0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 579:	75 27                	jne    5a2 <printf+0x11f>
          s = "(null)";
 57b:	c7 45 f4 a9 0c 00 00 	movl   $0xca9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 647:	a1 dc 10 00 00       	mov    0x10dc,%eax
...
free(void *ap)
{
 ...
 708:	a3 dc 10 00 00       	mov    %eax,0x10dc
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75b:	e8 d8 fe ff ff       	call   638 <free>
  return freep;
 760:	a1 dc 10 00 00       	mov    0x10dc,%eax
}
 765:	c9                   	leave  
 766:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 779:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 77c:	a1 dc 10 00 00       	mov    0x10dc,%eax
 781:	89 45 f0             	mov    %eax,-0x10(%ebp)
 784:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 788:	75 23                	jne    7ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78a:	c7 45 f0 d4 10 00 00 	movl   $0x10d4,-0x10(%ebp)
 791:	8b 45 f0             	mov    -0x10(%ebp),%eax
 794:	a3 dc 10 00 00       	mov    %eax,0x10dc
 799:	a1 dc 10 00 00       	mov    0x10dc,%eax
 79e:	a3 d4 10 00 00       	mov    %eax,0x10d4
    base.s.size = 0;
 7a3:	c7 05 d8 10 00 00 00 	movl   $0x0,0x10d8
 7aa:	00 00 00 
  }
 ...
 800:	a3 dc 10 00 00       	mov    %eax,0x10dc
      return (void*)(p + 1);
 ...
 80b:	eb 38                	jmp    845 <malloc+0xde>
    ...
    if(p == freep)
 80d:	a1 dc 10 00 00       	mov    0x10dc,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8ae:	c7 44 24 04 b0 0c 00 	movl   $0xcb0,0x4(%esp)
 8b5:	00 
...
BB_create(int max_capacity){
 ...
 a8c:	c7 44 24 04 e4 0c 00 	movl   $0xce4,0x4(%esp)
 a93:	00 
 ...
 aa6:	e8 20 01 00 00       	call   bcb <BB_free>
...
void BB_free(struct BB* bb){
 ...
 bd4:	8b 40 1c             	mov    0x1c(%eax),%eax
 bd7:	89 04 24             	mov    %eax,(%esp)
 bda:	e8 59 fa ff ff       	call   638 <free>
  free(bb);
 bdf:	8b 45 08             	mov    0x8(%ebp),%eax
 be2:	89 04 24             	mov    %eax,(%esp)
 be5:	e8 4e fa ff ff       	call   638 <free>
}
 bea:	c9                   	leave  
 beb:	c3                   	ret    
...
int BB_size(struct BB* bb){
 ...
 bef:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 bf2:	c7 44 24 04 30 0d 00 	movl   $0xd30,0x4(%esp)
 bf9:	00 
 bfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 c01:	e8 7d f8 ff ff       	call   483 <printf>
  int ans =0;
