...
cat(int fd)
{
  ...
  4d:	c7 44 24 04 48 0d 00 	movl   $0xd48,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  c9:	c7 44 24 04 59 0d 00 	movl   $0xd59,0x4(%esp)
  d0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c2:	0f b6 90 a8 11 00 00 	movzbl 0x11a8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 621:	75 27                	jne    64a <printf+0x11f>
          s = "(null)";
 623:	c7 45 f4 6e 0d 00 00 	movl   $0xd6e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ef:	a1 c8 11 00 00       	mov    0x11c8,%eax
...
free(void *ap)
{
 ...
 7b0:	a3 c8 11 00 00       	mov    %eax,0x11c8
}
 7b5:	c9                   	leave  
 7b6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 803:	e8 d8 fe ff ff       	call   6e0 <free>
  return freep;
 808:	a1 c8 11 00 00       	mov    0x11c8,%eax
}
 80d:	c9                   	leave  
 80e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 821:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 824:	a1 c8 11 00 00       	mov    0x11c8,%eax
 829:	89 45 f0             	mov    %eax,-0x10(%ebp)
 82c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 830:	75 23                	jne    855 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 832:	c7 45 f0 c0 11 00 00 	movl   $0x11c0,-0x10(%ebp)
 839:	8b 45 f0             	mov    -0x10(%ebp),%eax
 83c:	a3 c8 11 00 00       	mov    %eax,0x11c8
 841:	a1 c8 11 00 00       	mov    0x11c8,%eax
 846:	a3 c0 11 00 00       	mov    %eax,0x11c0
    base.s.size = 0;
 84b:	c7 05 c4 11 00 00 00 	movl   $0x0,0x11c4
 852:	00 00 00 
  }
 ...
 8a8:	a3 c8 11 00 00       	mov    %eax,0x11c8
      return (void*)(p + 1);
 ...
 8b3:	eb 38                	jmp    8ed <malloc+0xde>
    ...
    if(p == freep)
 8b5:	a1 c8 11 00 00       	mov    0x11c8,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 956:	c7 44 24 04 78 0d 00 	movl   $0xd78,0x4(%esp)
 95d:	00 
...
BB_create(int max_capacity){
 ...
 b34:	c7 44 24 04 ac 0d 00 	movl   $0xdac,0x4(%esp)
 b3b:	00 
 ...
 b4e:	e8 20 01 00 00       	call   c73 <BB_free>
...
00000cfe <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 cfe:	55                   	push   %ebp
 cff:	89 e5                	mov    %esp,%ebp
 d01:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 d04:	c7 44 24 04 fe 0d 00 	movl   $0xdfe,0x4(%esp)
 d0b:	00 
 d0c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 d13:	e8 13 f8 ff ff       	call   52b <printf>
  int ans =0;
 d18:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  binary_semaphore_down(bb->mutex);
 d1f:	8b 45 08             	mov    0x8(%ebp),%eax
 d22:	8b 40 04             	mov    0x4(%eax),%eax
 d25:	89 04 24             	mov    %eax,(%esp)
 d28:	e8 17 f7 ff ff       	call   444 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 d3e:	e8 09 f7 ff ff       	call   44c <binary_semaphore_up>
  return ans;
