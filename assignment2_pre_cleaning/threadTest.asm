...
void* printme2(){
  ...
  22:	c7 44 24 04 5c 0f 00 	movl   $0xf5c,0x4(%esp)
  29:	00 
...
void* printme(){
  ...
  bd:	a1 e8 14 00 00       	mov    0x14e8,%eax
  ...
  e7:	c7 44 24 04 78 0f 00 	movl   $0xf78,0x4(%esp)
  ee:	00 
...
void* printme(){
 ...
 105:	a1 e8 14 00 00       	mov    0x14e8,%eax
...
void binary_semaphore_test(int num_of_threads){
 ...
 126:	a3 e8 14 00 00       	mov    %eax,0x14e8
...
void* printme3(){
 ...
 170:	83 ec 24             	sub    $0x24,%esp
  ...
  for(;;){
    semaphore_down(sem);
 173:	a1 e4 14 00 00       	mov    0x14e4,%eax
 ...
 19d:	c7 44 24 04 78 0f 00 	movl   $0xf78,0x4(%esp)
 1a4:	00 
...
void* printme3(){
 ...
 1b9:	7e ce                	jle    189 <printme3+0x1d>
    ...
    semaphore_up(sem);
 1bb:	a1 e4 14 00 00       	mov    0x14e4,%eax
...
void counting_semaphore_test(int num_of_threads){
 ...
 1dc:	a3 e4 14 00 00       	mov    %eax,0x14e4
  for(i = 0; i < num_of_threads; i++){
...
void* printme5(){
 ...
 248:	83 ec 18             	sub    $0x18,%esp
  for(;;){
    BB_pop(buf);
 24b:	a1 ec 14 00 00       	mov    0x14ec,%eax
 250:	89 04 24             	mov    %eax,(%esp)
 253:	e8 98 0b 00 00       	call   df0 <BB_pop>
...
void bounded_buffer_test(int num_of_producers,int num_of_consumers){
 ...
 26c:	a3 ec 14 00 00       	mov    %eax,0x14ec
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	0f b6 90 c4 14 00 00 	movzbl 0x14c4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 835:	75 27                	jne    85e <printf+0x11f>
          s = "(null)";
 837:	c7 45 f4 99 0f 00 00 	movl   $0xf99,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 903:	a1 e0 14 00 00       	mov    0x14e0,%eax
...
free(void *ap)
{
 ...
 9c4:	a3 e0 14 00 00       	mov    %eax,0x14e0
}
 9c9:	c9                   	leave  
 9ca:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a17:	e8 d8 fe ff ff       	call   8f4 <free>
  return freep;
 a1c:	a1 e0 14 00 00       	mov    0x14e0,%eax
}
 a21:	c9                   	leave  
 a22:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a38:	a1 e0 14 00 00       	mov    0x14e0,%eax
 a3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a44:	75 23                	jne    a69 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a46:	c7 45 f0 d8 14 00 00 	movl   $0x14d8,-0x10(%ebp)
 a4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a50:	a3 e0 14 00 00       	mov    %eax,0x14e0
 a55:	a1 e0 14 00 00       	mov    0x14e0,%eax
 a5a:	a3 d8 14 00 00       	mov    %eax,0x14d8
    base.s.size = 0;
 a5f:	c7 05 dc 14 00 00 00 	movl   $0x0,0x14dc
 a66:	00 00 00 
  }
 ...
 abc:	a3 e0 14 00 00       	mov    %eax,0x14e0
      return (void*)(p + 1);
 ...
 ac7:	eb 38                	jmp    b01 <malloc+0xde>
    ...
    if(p == freep)
 ac9:	a1 e0 14 00 00       	mov    0x14e0,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 b6a:	c7 44 24 04 a0 0f 00 	movl   $0xfa0,0x4(%esp)
 b71:	00 
...
BB_create(int max_capacity){
 ...
 d28:	75 44                	jne    d6e <BB_create+0x112>
 ...
 d48:	c7 44 24 04 d4 0f 00 	movl   $0xfd4,0x4(%esp)
 d4f:	00 
 ...
 d62:	e8 20 01 00 00       	call   e87 <BB_free>
   //free(buf->pointer_to_elements);//TODO remove
   //free(buf);
   buf =0;  
 d67:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
void BB_free(struct BB* bb){
 ...
 e90:	8b 40 1c             	mov    0x1c(%eax),%eax
 e93:	89 04 24             	mov    %eax,(%esp)
 e96:	e8 59 fa ff ff       	call   8f4 <free>
  free(bb);
 e9b:	8b 45 08             	mov    0x8(%ebp),%eax
 e9e:	89 04 24             	mov    %eax,(%esp)
 ea1:	e8 4e fa ff ff       	call   8f4 <free>
}
 ea6:	c9                   	leave  
 ea7:	c3                   	ret    
...
int BB_size(struct BB* bb){
 ...
 eab:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 eae:	c7 44 24 04 20 10 00 	movl   $0x1020,0x4(%esp)
 eb5:	00 
 eb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 ebd:	e8 7d f8 ff ff       	call   73f <printf>
  int ans =0;
 ec2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
 ec9:	8b 45 08             	mov    0x8(%ebp),%eax
 ecc:	8b 40 0c             	mov    0xc(%eax),%eax
 ecf:	89 04 24             	mov    %eax,(%esp)
 ed2:	e8 d0 fc ff ff       	call   ba7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 ed7:	8b 45 08             	mov    0x8(%ebp),%eax
 eda:	8b 40 04             	mov    0x4(%eax),%eax
 edd:	89 04 24             	mov    %eax,(%esp)
 ee0:	e8 73 f7 ff ff       	call   658 <binary_semaphore_down>
  ans = bb->full->value;
 ee5:	8b 45 08             	mov    0x8(%ebp),%eax
 ee8:	8b 40 0c             	mov    0xc(%eax),%eax
 ...
 efa:	e8 61 f7 ff ff       	call   660 <binary_semaphore_up>
  semaphore_up(bb->empty);
 eff:	8b 45 08             	mov    0x8(%ebp),%eax
 f02:	8b 40 08             	mov    0x8(%eax),%eax
 f05:	89 04 24             	mov    %eax,(%esp)
 f08:	e8 f1 fc ff ff       	call   bfe <semaphore_up>
  return ans;
...
00000f12 <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 f12:	55                   	push   %ebp
 f13:	89 e5                	mov    %esp,%ebp
 f15:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 f18:	c7 44 24 04 26 10 00 	movl   $0x1026,0x4(%esp)
 f1f:	00 
 f20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 f27:	e8 13 f8 ff ff       	call   73f <printf>
  int ans =0;
 f2c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  binary_semaphore_down(bb->mutex);
 f33:	8b 45 08             	mov    0x8(%ebp),%eax
 f36:	8b 40 04             	mov    0x4(%eax),%eax
 f39:	89 04 24             	mov    %eax,(%esp)
 f3c:	e8 17 f7 ff ff       	call   658 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 f52:	e8 09 f7 ff ff       	call   660 <binary_semaphore_up>
  return ans;
