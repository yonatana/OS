...
putc(int fd, char c)
{
 ...
 389:	e8 1a ff ff ff       	call   2a8 <write>
}
 38e:	c9                   	leave  
 38f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	0f b6 90 74 10 00 00 	movzbl 0x1074(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 535:	75 27                	jne    55e <printf+0x11f>
          s = "(null)";
 537:	c7 45 f4 5c 0c 00 00 	movl   $0xc5c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 603:	a1 90 10 00 00       	mov    0x1090,%eax
...
free(void *ap)
{
 ...
 6c4:	a3 90 10 00 00       	mov    %eax,0x1090
}
 6c9:	c9                   	leave  
 6ca:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6ea:	e8 21 fc ff ff       	call   310 <sbrk>
 ...
 717:	e8 d8 fe ff ff       	call   5f4 <free>
  return freep;
 71c:	a1 90 10 00 00       	mov    0x1090,%eax
}
 721:	c9                   	leave  
 722:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 735:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 738:	a1 90 10 00 00       	mov    0x1090,%eax
 73d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 740:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 744:	75 23                	jne    769 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 746:	c7 45 f0 88 10 00 00 	movl   $0x1088,-0x10(%ebp)
 74d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 750:	a3 90 10 00 00       	mov    %eax,0x1090
 755:	a1 90 10 00 00       	mov    0x1090,%eax
 75a:	a3 88 10 00 00       	mov    %eax,0x1088
    base.s.size = 0;
 75f:	c7 05 8c 10 00 00 00 	movl   $0x0,0x108c
 766:	00 00 00 
  }
 ...
 7bc:	a3 90 10 00 00       	mov    %eax,0x1090
      return (void*)(p + 1);
 ...
 7c7:	eb 38                	jmp    801 <malloc+0xde>
    ...
    if(p == freep)
 7c9:	a1 90 10 00 00       	mov    0x1090,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 80a:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
 811:	e8 0d ff ff ff       	call   723 <malloc>
 816:	89 45 f4             	mov    %eax,-0xc(%ebp)
  // acquire semaphors
  sem->s1 = binary_semaphore_create(1);
 819:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 820:	e8 2b fb ff ff       	call   350 <binary_semaphore_create>
 825:	8b 55 f4             	mov    -0xc(%ebp),%edx
 828:	89 02                	mov    %eax,(%edx)
  
  // s2 should be initialized with the min{1,initial_semaphore_value}
  if(initial_semaphore_value >= 1){
 82a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 82e:	7e 14                	jle    844 <semaphore_create+0x40>
    sem->s2 = binary_semaphore_create(1);
 830:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 837:	e8 14 fb ff ff       	call   350 <binary_semaphore_create>
 83c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 83f:	89 42 04             	mov    %eax,0x4(%edx)
 842:	eb 11                	jmp    855 <semaphore_create+0x51>
  }else{
    sem->s2 = binary_semaphore_create(initial_semaphore_value);
 844:	8b 45 08             	mov    0x8(%ebp),%eax
 847:	89 04 24             	mov    %eax,(%esp)
 84a:	e8 01 fb ff ff       	call   350 <binary_semaphore_create>
 ...
 85a:	83 f8 ff             	cmp    $0xffffffff,%eax
 85d:	74 0b                	je     86a <semaphore_create+0x66>
 85f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 862:	8b 40 04             	mov    0x4(%eax),%eax
 865:	83 f8 ff             	cmp    $0xffffffff,%eax
 868:	75 26                	jne    890 <semaphore_create+0x8c>
     printf(1,"we had a probalem initialize in semaphore_create\n");
 86a:	c7 44 24 04 64 0c 00 	movl   $0xc64,0x4(%esp)
 871:	00 
 872:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 879:	e8 c1 fb ff ff       	call   43f <printf>
     free(sem);
 87e:	8b 45 f4             	mov    -0xc(%ebp),%eax
 881:	89 04 24             	mov    %eax,(%esp)
 884:	e8 6b fd ff ff       	call   5f4 <free>
     return 0;
 889:	b8 00 00 00 00       	mov    $0x0,%eax
 88e:	eb 15                	jmp    8a5 <semaphore_create+0xa1>
  }
  //initialize value
  sem->value = initial_semaphore_value;//dynamic
 890:	8b 45 f4             	mov    -0xc(%ebp),%eax
 893:	8b 55 08             	mov    0x8(%ebp),%edx
 896:	89 50 08             	mov    %edx,0x8(%eax)
...
void semaphore_up(struct semaphore* sem ){
 ...
 90c:	e8 47 fa ff ff       	call   358 <binary_semaphore_down>
  sem->value++;	
 911:	8b 45 08             	mov    0x8(%ebp),%eax
 914:	8b 40 08             	mov    0x8(%eax),%eax
 917:	8d 50 01             	lea    0x1(%eax),%edx
 91a:	8b 45 08             	mov    0x8(%ebp),%eax
 91d:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value ==1){
 920:	8b 45 08             	mov    0x8(%ebp),%eax
 923:	8b 40 08             	mov    0x8(%eax),%eax
 926:	83 f8 01             	cmp    $0x1,%eax
 929:	75 0e                	jne    939 <semaphore_up+0x3b>
   binary_semaphore_up(sem->s2); 
 92b:	8b 45 08             	mov    0x8(%ebp),%eax
 92e:	8b 40 04             	mov    0x4(%eax),%eax
 931:	89 04 24             	mov    %eax,(%esp)
 934:	e8 27 fa ff ff       	call   360 <binary_semaphore_up>
   }
  binary_semaphore_up(sem->s1);
 939:	8b 45 08             	mov    0x8(%ebp),%eax
 93c:	8b 00                	mov    (%eax),%eax
 93e:	89 04 24             	mov    %eax,(%esp)
 941:	e8 1a fa ff ff       	call   360 <binary_semaphore_up>
}
 946:	c9                   	leave  
 947:	c3                   	ret    

00000948 <semaphore_free>:
...
void semaphore_free(struct semaphore* sem){
 ...
 954:	e8 9b fc ff ff       	call   5f4 <free>
}
 959:	c9                   	leave  
 95a:	c3                   	ret    
 95b:	90                   	nop
...
BB_create(int max_capacity){
 ...
 95f:	83 ec 38             	sub    $0x38,%esp
  //initialize
  struct BB* buf = malloc(sizeof(struct BB));
 962:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
 969:	e8 b5 fd ff ff       	call   723 <malloc>
 96e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(buf,0,sizeof(struct BB));
 971:	c7 44 24 08 20 00 00 	movl   $0x20,0x8(%esp)
 978:	00 
 979:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
 980:	00 
 981:	8b 45 f4             	mov    -0xc(%ebp),%eax
 984:	89 04 24             	mov    %eax,(%esp)
 987:	e8 57 f7 ff ff       	call   e3 <memset>
 ...
 99b:	e8 b0 f9 ff ff       	call   350 <binary_semaphore_create>
 9a0:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9a3:	89 42 04             	mov    %eax,0x4(%edx)
  buf->empty = semaphore_create(max_capacity);
 9a6:	8b 45 08             	mov    0x8(%ebp),%eax
 9a9:	89 04 24             	mov    %eax,(%esp)
 9ac:	e8 53 fe ff ff       	call   804 <semaphore_create>
 9b1:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9b4:	89 42 08             	mov    %eax,0x8(%edx)
  buf->full = semaphore_create(0);
 9b7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 9be:	e8 41 fe ff ff       	call   804 <semaphore_create>
 9c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9c6:	89 42 0c             	mov    %eax,0xc(%edx)
 ...
 a2d:	8b 48 0c             	mov    0xc(%eax),%ecx
 a30:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a33:	8b 50 08             	mov    0x8(%eax),%edx
 a36:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a39:	8b 40 04             	mov    0x4(%eax),%eax
 a3c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
 a40:	89 54 24 0c          	mov    %edx,0xc(%esp)
 a44:	89 44 24 08          	mov    %eax,0x8(%esp)
 a48:	c7 44 24 04 98 0c 00 	movl   $0xc98,0x4(%esp)
 a4f:	00 
 a50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a57:	e8 e3 f9 ff ff       	call   43f <printf>
   BB_free(buf);
 a5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a5f:	89 04 24             	mov    %eax,(%esp)
 a62:	e8 20 01 00 00       	call   b87 <BB_free>
   //free(buf->pointer_to_elements);//TODO remove
   //free(buf);
   buf =0;  
 a67:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
int BB_size(struct BB* bb){
 ...
 bab:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 bae:	c7 44 24 04 e4 0c 00 	movl   $0xce4,0x4(%esp)
 bb5:	00 
 bb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 bbd:	e8 7d f8 ff ff       	call   43f <printf>
  int ans =0;
 bc2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
 bc9:	8b 45 08             	mov    0x8(%ebp),%eax
 bcc:	8b 40 0c             	mov    0xc(%eax),%eax
 bcf:	89 04 24             	mov    %eax,(%esp)
 bd2:	e8 d0 fc ff ff       	call   8a7 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 bd7:	8b 45 08             	mov    0x8(%ebp),%eax
 bda:	8b 40 04             	mov    0x4(%eax),%eax
 bdd:	89 04 24             	mov    %eax,(%esp)
 be0:	e8 73 f7 ff ff       	call   358 <binary_semaphore_down>
  ans = bb->full->value;
 be5:	8b 45 08             	mov    0x8(%ebp),%eax
 be8:	8b 40 0c             	mov    0xc(%eax),%eax
 ...
 bfa:	e8 61 f7 ff ff       	call   360 <binary_semaphore_up>
  semaphore_up(bb->empty);
 bff:	8b 45 08             	mov    0x8(%ebp),%eax
 c02:	8b 40 08             	mov    0x8(%eax),%eax
 c05:	89 04 24             	mov    %eax,(%esp)
 c08:	e8 f1 fc ff ff       	call   8fe <semaphore_up>
  return ans;
...
00000c12 <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 c12:	55                   	push   %ebp
 c13:	89 e5                	mov    %esp,%ebp
 c15:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 c18:	c7 44 24 04 ea 0c 00 	movl   $0xcea,0x4(%esp)
 c1f:	00 
 c20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 c27:	e8 13 f8 ff ff       	call   43f <printf>
  int ans =0;
 ...
 c3c:	e8 17 f7 ff ff       	call   358 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 c52:	e8 09 f7 ff ff       	call   360 <binary_semaphore_up>
  return ans;
