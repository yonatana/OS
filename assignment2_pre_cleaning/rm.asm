...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 bc 0c 00 	movl   $0xcbc,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 d0 0c 00 	movl   $0xcd0,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	0f b6 90 00 11 00 00 	movzbl 0x1100(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 27                	jne    5be <printf+0x11f>
          s = "(null)";
 597:	c7 45 f4 e9 0c 00 00 	movl   $0xce9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 663:	a1 1c 11 00 00       	mov    0x111c,%eax
...
free(void *ap)
{
 ...
 724:	a3 1c 11 00 00       	mov    %eax,0x111c
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 d8 fe ff ff       	call   654 <free>
  return freep;
 77c:	a1 1c 11 00 00       	mov    0x111c,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 795:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 798:	a1 1c 11 00 00       	mov    0x111c,%eax
 79d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a4:	75 23                	jne    7c9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 45 f0 14 11 00 00 	movl   $0x1114,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 1c 11 00 00       	mov    %eax,0x111c
 7b5:	a1 1c 11 00 00       	mov    0x111c,%eax
 7ba:	a3 14 11 00 00       	mov    %eax,0x1114
    base.s.size = 0;
 7bf:	c7 05 18 11 00 00 00 	movl   $0x0,0x1118
 7c6:	00 00 00 
  }
 ...
 81c:	a3 1c 11 00 00       	mov    %eax,0x111c
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 1c 11 00 00       	mov    0x111c,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8ca:	c7 44 24 04 f0 0c 00 	movl   $0xcf0,0x4(%esp)
 8d1:	00 
...
BB_create(int max_capacity){
 ...
 aa8:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 aaf:	00 
...
int BB_size(struct BB* bb){
 ...
 c0b:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 c0e:	c7 44 24 04 70 0d 00 	movl   $0xd70,0x4(%esp)
 c15:	00 
...
int BB_buffer_size(struct BB* bb){
 ...
 c9c:	e8 17 f7 ff ff       	call   3b8 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 cb2:	e8 09 f7 ff ff       	call   3c0 <binary_semaphore_up>
  return ans;
