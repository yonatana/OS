...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 ec 0d 00 	movl   $0xdec,0x4(%esp)
  33:	00 
  ...
  92:	c7 44 24 04 ff 0d 00 	movl   $0xdff,0x4(%esp)
  99:	00 
...
//    printf(fd, "%d\n", i);
 ...
 126:	e8 15 03 00 00       	call   440 <close>
  ...
  printf(1, "read\n");
 12b:	c7 44 24 04 09 0e 00 	movl   $0xe09,0x4(%esp)
 132:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 566:	0f b6 90 28 12 00 00 	movzbl 0x1228(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6c5:	75 27                	jne    6ee <printf+0x11f>
          s = "(null)";
 6c7:	c7 45 f4 0f 0e 00 00 	movl   $0xe0f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 793:	a1 44 12 00 00       	mov    0x1244,%eax
...
free(void *ap)
{
 ...
 854:	a3 44 12 00 00       	mov    %eax,0x1244
}
 859:	c9                   	leave  
 85a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a7:	e8 d8 fe ff ff       	call   784 <free>
  return freep;
 8ac:	a1 44 12 00 00       	mov    0x1244,%eax
}
 8b1:	c9                   	leave  
 8b2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8c8:	a1 44 12 00 00       	mov    0x1244,%eax
 8cd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8d0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d4:	75 23                	jne    8f9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d6:	c7 45 f0 3c 12 00 00 	movl   $0x123c,-0x10(%ebp)
 8dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8e0:	a3 44 12 00 00       	mov    %eax,0x1244
 8e5:	a1 44 12 00 00       	mov    0x1244,%eax
 8ea:	a3 3c 12 00 00       	mov    %eax,0x123c
    base.s.size = 0;
 8ef:	c7 05 40 12 00 00 00 	movl   $0x0,0x1240
 8f6:	00 00 00 
  }
 ...
 94c:	a3 44 12 00 00       	mov    %eax,0x1244
      return (void*)(p + 1);
 ...
 957:	eb 38                	jmp    991 <malloc+0xde>
    ...
    if(p == freep)
 959:	a1 44 12 00 00       	mov    0x1244,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 99a:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
 ...
 9ba:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 9be:	7e 14                	jle    9d4 <semaphore_create+0x40>
    sem->s2 = binary_semaphore_create(1);
 9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9c7:	e8 14 fb ff ff       	call   4e0 <binary_semaphore_create>
 9cc:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9cf:	89 42 04             	mov    %eax,0x4(%edx)
 9d2:	eb 11                	jmp    9e5 <semaphore_create+0x51>
  }else{
    sem->s2 = binary_semaphore_create(initial_semaphore_value);
 9d4:	8b 45 08             	mov    0x8(%ebp),%eax
 9d7:	89 04 24             	mov    %eax,(%esp)
 9da:	e8 01 fb ff ff       	call   4e0 <binary_semaphore_create>
 9df:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
void semaphore_free(struct semaphore* sem){
 ...
 ae4:	e8 9b fc ff ff       	call   784 <free>
}
 ae9:	c9                   	leave  
 aea:	c3                   	ret    
 aeb:	90                   	nop
...
BB_create(int max_capacity){
 ...
 aef:	83 ec 38             	sub    $0x38,%esp
  //initialize
  struct BB* buf = malloc(sizeof(struct BB));
 af2:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
 af9:	e8 b5 fd ff ff       	call   8b3 <malloc>
 afe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(buf,0,sizeof(struct BB));
 b01:	c7 44 24 08 20 00 00 	movl   $0x20,0x8(%esp)
 b08:	00 
 b09:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
 b10:	00 
 b11:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b14:	89 04 24             	mov    %eax,(%esp)
 b17:	e8 57 f7 ff ff       	call   273 <memset>
 ...
 bbd:	8b 48 0c             	mov    0xc(%eax),%ecx
 bc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bc3:	8b 50 08             	mov    0x8(%eax),%edx
 bc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bc9:	8b 40 04             	mov    0x4(%eax),%eax
 bcc:	89 4c 24 10          	mov    %ecx,0x10(%esp)
 bd0:	89 54 24 0c          	mov    %edx,0xc(%esp)
 bd4:	89 44 24 08          	mov    %eax,0x8(%esp)
 bd8:	c7 44 24 04 4c 0e 00 	movl   $0xe4c,0x4(%esp)
 bdf:	00 
 be0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 be7:	e8 e3 f9 ff ff       	call   5cf <printf>
   BB_free(buf);
 bec:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bef:	89 04 24             	mov    %eax,(%esp)
 bf2:	e8 20 01 00 00       	call   d17 <BB_free>
...
{ //TODO mix
 ...
 c6b:	e8 80 f8 ff ff       	call   4f0 <binary_semaphore_up>
  semaphore_up(bb->full);
 c70:	8b 45 08             	mov    0x8(%ebp),%eax
 c73:	8b 40 0c             	mov    0xc(%eax),%eax
 c76:	89 04 24             	mov    %eax,(%esp)
 c79:	e8 10 fe ff ff       	call   a8e <semaphore_up>
...
{//TODO clean and mix
 ...
 cbb:	8b 50 1c             	mov    0x1c(%eax),%edx
 cbe:	8b 45 08             	mov    0x8(%ebp),%eax
 cc1:	8b 40 14             	mov    0x14(%eax),%eax
 cc4:	c1 e0 02             	shl    $0x2,%eax
 cc7:	01 d0                	add    %edx,%eax
...
int BB_size(struct BB* bb){
 ...
 d3b:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 d3e:	c7 44 24 04 98 0e 00 	movl   $0xe98,0x4(%esp)
 d45:	00 
 d46:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 d4d:	e8 7d f8 ff ff       	call   5cf <printf>
  int ans =0;
 d52:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
 d59:	8b 45 08             	mov    0x8(%ebp),%eax
 d5c:	8b 40 0c             	mov    0xc(%eax),%eax
 d5f:	89 04 24             	mov    %eax,(%esp)
 d62:	e8 d0 fc ff ff       	call   a37 <semaphore_down>
  binary_semaphore_down(bb->mutex);
 d67:	8b 45 08             	mov    0x8(%ebp),%eax
 d6a:	8b 40 04             	mov    0x4(%eax),%eax
 d6d:	89 04 24             	mov    %eax,(%esp)
 d70:	e8 73 f7 ff ff       	call   4e8 <binary_semaphore_down>
  ans = bb->full->value;
 d75:	8b 45 08             	mov    0x8(%ebp),%eax
 d78:	8b 40 0c             	mov    0xc(%eax),%eax
 d7b:	8b 40 08             	mov    0x8(%eax),%eax
 d7e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  binary_semaphore_up(bb->mutex);
 d81:	8b 45 08             	mov    0x8(%ebp),%eax
 d84:	8b 40 04             	mov    0x4(%eax),%eax
 d87:	89 04 24             	mov    %eax,(%esp)
 d8a:	e8 61 f7 ff ff       	call   4f0 <binary_semaphore_up>
  semaphore_up(bb->empty);
 d8f:	8b 45 08             	mov    0x8(%ebp),%eax
 d92:	8b 40 08             	mov    0x8(%eax),%eax
 d95:	89 04 24             	mov    %eax,(%esp)
 d98:	e8 f1 fc ff ff       	call   a8e <semaphore_up>
  return ans;
...
int BB_buffer_size(struct BB* bb){
 ...
 de2:	e8 09 f7 ff ff       	call   4f0 <binary_semaphore_up>
  return ans;
