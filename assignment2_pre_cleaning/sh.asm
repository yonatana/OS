...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 60 19 00 00 	mov    0x1960(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 34 19 00 00 	movl   $0x1934,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 3b 19 00 	movl   $0x193b,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 4b 19 00 	movl   $0x194b,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 5b 19 00 00 	movl   $0x195b,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 78 19 00 	movl   $0x1978,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 7b 19 00 00 	movl   $0x197b,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 a0 20 00 00 	movzbl 0x20a0,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 a1 20 00 00 	movzbl 0x20a1,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 a2 20 00 00 	movzbl 0x20a2,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 a0 20 00 00 	movl   $0x20a0,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 a0 20 00 00 00 	movb   $0x0,0x20a0(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 a3 20 00 00 	movl   $0x20a3,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 a3 20 00 	movl   $0x20a3,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 83 19 00 	movl   $0x1983,0x4(%esp)
     305:	00 
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xca>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 a0 20 00 00 	movl   $0x20a0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 a0 20 00 00 	movl   $0x20a0,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 91 19 00 	movl   $0x1991,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 95 19 00 00 	movl   $0x1995,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 78 20 00 00 	movl   $0x2078,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 78 20 00 00 	movl   $0x2078,(%esp)
     ...
     61e:	c7 04 24 7e 20 00 00 	movl   $0x207e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 78 20 00 00 	movl   $0x2078,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 78 20 00 00 	movl   $0x2078,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 9a 19 00 	movl   $0x199a,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 9b 19 00 	movl   $0x199b,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 b9 09 00 00       	call   1117 <printf>
    panic("syntax");
     75e:	c7 04 24 aa 19 00 00 	movl   $0x19aa,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 b1 19 00 	movl   $0x19b1,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 b3 19 00 	movl   $0x19b3,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 b5 19 00 	movl   $0x19b5,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 b7 19 00 00 	movl   $0x19b7,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 d4 19 00 	movl   $0x19d4,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 d7 19 00 	movl   $0x19d7,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 d9 19 00 00 	movl   $0x19d9,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 e4 19 00 	movl   $0x19e4,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 e6 19 00 00 	movl   $0x19e6,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 d7 19 00 	movl   $0x19d7,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 aa 19 00 00 	movl   $0x19aa,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 f9 19 00 00 	movl   $0x19f9,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 07 1a 00 	movl   $0x1a07,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 0c 1a 00 00 	mov    0x1a0c(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10ae:	0f b6 90 88 20 00 00 	movzbl 0x2088(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    120d:	75 27                	jne    1236 <printf+0x11f>
          s = "(null)";
    120f:	c7 45 f4 24 1a 00 00 	movl   $0x1a24,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12db:	a1 0c 21 00 00       	mov    0x210c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    139c:	a3 0c 21 00 00       	mov    %eax,0x210c
}
    13a1:	c9                   	leave  
    13a2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13f4:	a1 0c 21 00 00       	mov    0x210c,%eax
}
    13f9:	c9                   	leave  
    13fa:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1410:	a1 0c 21 00 00       	mov    0x210c,%eax
    1415:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1418:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    141c:	75 23                	jne    1441 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    141e:	c7 45 f0 04 21 00 00 	movl   $0x2104,-0x10(%ebp)
    1425:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1428:	a3 0c 21 00 00       	mov    %eax,0x210c
    142d:	a1 0c 21 00 00       	mov    0x210c,%eax
    1432:	a3 04 21 00 00       	mov    %eax,0x2104
    base.s.size = 0;
    1437:	c7 05 08 21 00 00 00 	movl   $0x0,0x2108
    143e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1494:	a3 0c 21 00 00       	mov    %eax,0x210c
      return (void*)(p + 1);
    ...
    if(p == freep)
    14a1:	a1 0c 21 00 00       	mov    0x210c,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
  ...
  struct semaphore* sem=malloc(sizeof(struct semaphore)); 
    14e2:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
    14e9:	e8 0d ff ff ff       	call   13fb <malloc>
    14ee:	89 45 f4             	mov    %eax,-0xc(%ebp)
  // acquire semaphors
  sem->s1 = binary_semaphore_create(1);
    14f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f8:	e8 2b fb ff ff       	call   1028 <binary_semaphore_create>
    14fd:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1500:	89 02                	mov    %eax,(%edx)
  
  // s2 should be initialized with the min{1,initial_semaphore_value}
  if(initial_semaphore_value >= 1){
    1502:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    1506:	7e 14                	jle    151c <semaphore_create+0x40>
    sem->s2 = binary_semaphore_create(1);
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 14 fb ff ff       	call   1028 <binary_semaphore_create>
    1514:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1517:	89 42 04             	mov    %eax,0x4(%edx)
    151a:	eb 11                	jmp    152d <semaphore_create+0x51>
  }else{
    sem->s2 = binary_semaphore_create(initial_semaphore_value);
    151c:	8b 45 08             	mov    0x8(%ebp),%eax
    151f:	89 04 24             	mov    %eax,(%esp)
    1522:	e8 01 fb ff ff       	call   1028 <binary_semaphore_create>
    1527:	8b 55 f4             	mov    -0xc(%ebp),%edx
    152a:	89 42 04             	mov    %eax,0x4(%edx)
  }
  
  if(sem->s1 == -1 || sem->s2 == -1){
    152d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1530:	8b 00                	mov    (%eax),%eax
    1532:	83 f8 ff             	cmp    $0xffffffff,%eax
    1535:	74 0b                	je     1542 <semaphore_create+0x66>
    1537:	8b 45 f4             	mov    -0xc(%ebp),%eax
    153a:	8b 40 04             	mov    0x4(%eax),%eax
    153d:	83 f8 ff             	cmp    $0xffffffff,%eax
    1540:	75 26                	jne    1568 <semaphore_create+0x8c>
     printf(1,"we had a probalem initialize in semaphore_create\n");
    1542:	c7 44 24 04 2c 1a 00 	movl   $0x1a2c,0x4(%esp)
    1549:	00 
    154a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1551:	e8 c1 fb ff ff       	call   1117 <printf>
     free(sem);
    1556:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1559:	89 04 24             	mov    %eax,(%esp)
    155c:	e8 6b fd ff ff       	call   12cc <free>
     return 0;
    1561:	b8 00 00 00 00       	mov    $0x0,%eax
    1566:	eb 15                	jmp    157d <semaphore_create+0xa1>
  }
  //initialize value
  sem->value = initial_semaphore_value;//dynamic
    1568:	8b 45 f4             	mov    -0xc(%ebp),%eax
    156b:	8b 55 08             	mov    0x8(%ebp),%edx
    156e:	89 50 08             	mov    %edx,0x8(%eax)
  sem->initial_value = initial_semaphore_value;//static
    1571:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1574:	8b 55 08             	mov    0x8(%ebp),%edx
    1577:	89 50 0c             	mov    %edx,0xc(%eax)
...
void semaphore_up(struct semaphore* sem ){
  ...
  binary_semaphore_down(sem->s1);
    ...
    15e4:	e8 47 fa ff ff       	call   1030 <binary_semaphore_down>
  sem->value++;	
    15e9:	8b 45 08             	mov    0x8(%ebp),%eax
    15ec:	8b 40 08             	mov    0x8(%eax),%eax
    15ef:	8d 50 01             	lea    0x1(%eax),%edx
    15f2:	8b 45 08             	mov    0x8(%ebp),%eax
    15f5:	89 50 08             	mov    %edx,0x8(%eax)
  if(sem->value ==1){
    15f8:	8b 45 08             	mov    0x8(%ebp),%eax
    15fb:	8b 40 08             	mov    0x8(%eax),%eax
    15fe:	83 f8 01             	cmp    $0x1,%eax
    1601:	75 0e                	jne    1611 <semaphore_up+0x3b>
   binary_semaphore_up(sem->s2); 
    1603:	8b 45 08             	mov    0x8(%ebp),%eax
    1606:	8b 40 04             	mov    0x4(%eax),%eax
    1609:	89 04 24             	mov    %eax,(%esp)
    160c:	e8 27 fa ff ff       	call   1038 <binary_semaphore_up>
   }
  binary_semaphore_up(sem->s1);
    1611:	8b 45 08             	mov    0x8(%ebp),%eax
    1614:	8b 00                	mov    (%eax),%eax
    1616:	89 04 24             	mov    %eax,(%esp)
    1619:	e8 1a fa ff ff       	call   1038 <binary_semaphore_up>
}
    161e:	c9                   	leave  
    161f:	c3                   	ret    

00001620 <semaphore_free>:
...
void semaphore_free(struct semaphore* sem){
  ...
  free(sem);
    ...
    162c:	e8 9b fc ff ff       	call   12cc <free>
}
    1631:	c9                   	leave  
    1632:	c3                   	ret    
    1633:	90                   	nop
...
BB_create(int max_capacity){
    ...
    1637:	83 ec 38             	sub    $0x38,%esp
  //initialize
  struct BB* buf = malloc(sizeof(struct BB));
    163a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
    1641:	e8 b5 fd ff ff       	call   13fb <malloc>
    1646:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(buf,0,sizeof(struct BB));
    1649:	c7 44 24 08 20 00 00 	movl   $0x20,0x8(%esp)
    1650:	00 
    1651:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1658:	00 
    1659:	8b 45 f4             	mov    -0xc(%ebp),%eax
    165c:	89 04 24             	mov    %eax,(%esp)
    165f:	e8 57 f7 ff ff       	call   dbb <memset>
 
  buf->buffer_size = max_capacity;
    1664:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1667:	8b 55 08             	mov    0x8(%ebp),%edx
    166a:	89 10                	mov    %edx,(%eax)
  buf->mutex = binary_semaphore_create(1);  
    166c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1673:	e8 b0 f9 ff ff       	call   1028 <binary_semaphore_create>
    1678:	8b 55 f4             	mov    -0xc(%ebp),%edx
    167b:	89 42 04             	mov    %eax,0x4(%edx)
  buf->empty = semaphore_create(max_capacity);
    167e:	8b 45 08             	mov    0x8(%ebp),%eax
    1681:	89 04 24             	mov    %eax,(%esp)
    1684:	e8 53 fe ff ff       	call   14dc <semaphore_create>
    1689:	8b 55 f4             	mov    -0xc(%ebp),%edx
    168c:	89 42 08             	mov    %eax,0x8(%edx)
  buf->full = semaphore_create(0);
    168f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    1696:	e8 41 fe ff ff       	call   14dc <semaphore_create>
    169b:	8b 55 f4             	mov    -0xc(%ebp),%edx
    169e:	89 42 0c             	mov    %eax,0xc(%edx)
  buf->pointer_to_elements = malloc(sizeof(void*)*max_capacity);
    16a1:	8b 45 08             	mov    0x8(%ebp),%eax
    16a4:	c1 e0 02             	shl    $0x2,%eax
    16a7:	89 04 24             	mov    %eax,(%esp)
    16aa:	e8 4c fd ff ff       	call   13fb <malloc>
    16af:	8b 55 f4             	mov    -0xc(%ebp),%edx
    16b2:	89 42 1c             	mov    %eax,0x1c(%edx)
  memset(buf->pointer_to_elements,0,sizeof(void*)*max_capacity);
    16b5:	8b 45 08             	mov    0x8(%ebp),%eax
    16b8:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
    16bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16c2:	8b 40 1c             	mov    0x1c(%eax),%eax
    16c5:	89 54 24 08          	mov    %edx,0x8(%esp)
    16c9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    16d0:	00 
    16d1:	89 04 24             	mov    %eax,(%esp)
    16d4:	e8 e2 f6 ff ff       	call   dbb <memset>
  buf->count = 0;//TODO remove or not
    16d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16dc:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
  //check the semaphorses
  if(buf->mutex == -1 || buf->empty == 0 || buf->full == 0){
    16e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16e6:	8b 40 04             	mov    0x4(%eax),%eax
    16e9:	83 f8 ff             	cmp    $0xffffffff,%eax
    16ec:	74 14                	je     1702 <BB_create+0xce>
    16ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16f1:	8b 40 08             	mov    0x8(%eax),%eax
    16f4:	85 c0                	test   %eax,%eax
    16f6:	74 0a                	je     1702 <BB_create+0xce>
    16f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16fb:	8b 40 0c             	mov    0xc(%eax),%eax
    16fe:	85 c0                	test   %eax,%eax
    1700:	75 44                	jne    1746 <BB_create+0x112>
   printf(1,"we had a problam getting semaphores at BB create mutex %d empty %d full %d\n",buf->mutex,buf->empty,buf->full);
    ...
    1705:	8b 48 0c             	mov    0xc(%eax),%ecx
    1708:	8b 45 f4             	mov    -0xc(%ebp),%eax
    170b:	8b 50 08             	mov    0x8(%eax),%edx
    170e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1711:	8b 40 04             	mov    0x4(%eax),%eax
    1714:	89 4c 24 10          	mov    %ecx,0x10(%esp)
    1718:	89 54 24 0c          	mov    %edx,0xc(%esp)
    171c:	89 44 24 08          	mov    %eax,0x8(%esp)
    1720:	c7 44 24 04 60 1a 00 	movl   $0x1a60,0x4(%esp)
    1727:	00 
    1728:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172f:	e8 e3 f9 ff ff       	call   1117 <printf>
   BB_free(buf);
    1734:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1737:	89 04 24             	mov    %eax,(%esp)
    173a:	e8 20 01 00 00       	call   185f <BB_free>
   //free(buf->pointer_to_elements);//TODO remove
   //free(buf);
   buf =0;  
    173f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  }
  return buf;
...
int BB_size(struct BB* bb){
    ...
    1883:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
    1886:	c7 44 24 04 ac 1a 00 	movl   $0x1aac,0x4(%esp)
    188d:	00 
    188e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1895:	e8 7d f8 ff ff       	call   1117 <printf>
  int ans =0;
    189a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  semaphore_down(bb->full);
    18a1:	8b 45 08             	mov    0x8(%ebp),%eax
    18a4:	8b 40 0c             	mov    0xc(%eax),%eax
    18a7:	89 04 24             	mov    %eax,(%esp)
    18aa:	e8 d0 fc ff ff       	call   157f <semaphore_down>
  binary_semaphore_down(bb->mutex);
    18af:	8b 45 08             	mov    0x8(%ebp),%eax
    18b2:	8b 40 04             	mov    0x4(%eax),%eax
    18b5:	89 04 24             	mov    %eax,(%esp)
    18b8:	e8 73 f7 ff ff       	call   1030 <binary_semaphore_down>
  ans = bb->full->value;
    18bd:	8b 45 08             	mov    0x8(%ebp),%eax
    18c0:	8b 40 0c             	mov    0xc(%eax),%eax
    18c3:	8b 40 08             	mov    0x8(%eax),%eax
    18c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  binary_semaphore_up(bb->mutex);
    18c9:	8b 45 08             	mov    0x8(%ebp),%eax
    18cc:	8b 40 04             	mov    0x4(%eax),%eax
    18cf:	89 04 24             	mov    %eax,(%esp)
    18d2:	e8 61 f7 ff ff       	call   1038 <binary_semaphore_up>
  semaphore_up(bb->empty);
    18d7:	8b 45 08             	mov    0x8(%ebp),%eax
    18da:	8b 40 08             	mov    0x8(%eax),%eax
    18dd:	89 04 24             	mov    %eax,(%esp)
    18e0:	e8 f1 fc ff ff       	call   15d6 <semaphore_up>
  return ans;
...
int BB_buffer_size(struct BB* bb){
  ...
  binary_semaphore_up(bb->mutex);
    ...
    192a:	e8 09 f7 ff ff       	call   1038 <binary_semaphore_up>
  return ans;
