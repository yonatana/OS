...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 b4 0c 00 	movl   $0xcb4,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 c7 0c 00 	movl   $0xcc7,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	0f b6 90 f4 10 00 00 	movzbl 0x10f4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 58d:	75 27                	jne    5b6 <printf+0x11f>
          s = "(null)";
 58f:	c7 45 f4 db 0c 00 00 	movl   $0xcdb,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 65b:	a1 10 11 00 00       	mov    0x1110,%eax
...
free(void *ap)
{
 ...
 71c:	a3 10 11 00 00       	mov    %eax,0x1110
}
 721:	c9                   	leave  
 722:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 76f:	e8 d8 fe ff ff       	call   64c <free>
  return freep;
 774:	a1 10 11 00 00       	mov    0x1110,%eax
}
 779:	c9                   	leave  
 77a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 78d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 790:	a1 10 11 00 00       	mov    0x1110,%eax
 795:	89 45 f0             	mov    %eax,-0x10(%ebp)
 798:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 79c:	75 23                	jne    7c1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 79e:	c7 45 f0 08 11 00 00 	movl   $0x1108,-0x10(%ebp)
 7a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a8:	a3 10 11 00 00       	mov    %eax,0x1110
 7ad:	a1 10 11 00 00       	mov    0x1110,%eax
 7b2:	a3 08 11 00 00       	mov    %eax,0x1108
    base.s.size = 0;
 7b7:	c7 05 0c 11 00 00 00 	movl   $0x0,0x110c
 7be:	00 00 00 
  }
 ...
 814:	a3 10 11 00 00       	mov    %eax,0x1110
      return (void*)(p + 1);
 ...
 81f:	eb 38                	jmp    859 <malloc+0xde>
    ...
    if(p == freep)
 821:	a1 10 11 00 00       	mov    0x1110,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value){
 ...
 8c2:	c7 44 24 04 e4 0c 00 	movl   $0xce4,0x4(%esp)
 8c9:	00 
...
BB_create(int max_capacity){
 ...
 aa0:	c7 44 24 04 18 0d 00 	movl   $0xd18,0x4(%esp)
 aa7:	00 
 ...
 aba:	e8 20 01 00 00       	call   bdf <BB_free>
...
void BB_free(struct BB* bb){
 ...
 be8:	8b 40 1c             	mov    0x1c(%eax),%eax
 beb:	89 04 24             	mov    %eax,(%esp)
 bee:	e8 59 fa ff ff       	call   64c <free>
  free(bb);
 bf3:	8b 45 08             	mov    0x8(%ebp),%eax
 bf6:	89 04 24             	mov    %eax,(%esp)
 bf9:	e8 4e fa ff ff       	call   64c <free>
}
 bfe:	c9                   	leave  
 bff:	c3                   	ret    
...
int BB_size(struct BB* bb){
 ...
 c03:	83 ec 28             	sub    $0x28,%esp
  printf(1,"size\n");
 c06:	c7 44 24 04 64 0d 00 	movl   $0xd64,0x4(%esp)
 c0d:	00 
 c0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 c15:	e8 7d f8 ff ff       	call   497 <printf>
  int ans =0;
...
00000c6a <BB_buffer_size>:
int BB_buffer_size(struct BB* bb){
 c6a:	55                   	push   %ebp
 c6b:	89 e5                	mov    %esp,%ebp
 c6d:	83 ec 28             	sub    $0x28,%esp
  printf(1,"buffer_size\n");
 c70:	c7 44 24 04 6a 0d 00 	movl   $0xd6a,0x4(%esp)
 c77:	00 
 c78:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 c7f:	e8 13 f8 ff ff       	call   497 <printf>
  int ans =0;
 c84:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  binary_semaphore_down(bb->mutex);
 c8b:	8b 45 08             	mov    0x8(%ebp),%eax
 c8e:	8b 40 04             	mov    0x4(%eax),%eax
 c91:	89 04 24             	mov    %eax,(%esp)
 c94:	e8 17 f7 ff ff       	call   3b0 <binary_semaphore_down>
  ans = bb->buffer_size;
 ...
 caa:	e8 09 f7 ff ff       	call   3b8 <binary_semaphore_up>
  return ans;
